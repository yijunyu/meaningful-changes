...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.runtime.notation.RelativeBendpoints} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelativeBendpointsItemProvider
	 ...
	 * @generated
	 */
	public RelativeBendpointsItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelativeBendpoints_points_feature"), //$NON-NLS-1$
    ...
    /**
	 * This returns RelativeBendpoints.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_RelativeBendpoints_type") : //$NON-NLS-1$
			getString("_UI_RelativeBendpoints_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RelativeBendpoints.class)) {

...
public class GenTopLevelNodeImpl extends GenNodeImpl implements GenTopLevelNode {
	...
	public void setDiagram(GenDiagram newDiagram) {
		if (newDiagram != eInternalContainer() || (eContainerFeatureID != GMFGenPackage.GEN_TOP_LEVEL_NODE__DIAGRAM && newDiagram != null)) {
			...
			if (newDiagram != null)
				msgs = ((InternalEObject)newDiagram).eInverseAdd(this, GMFGenPackage.GEN_DIAGRAM__TOP_LEVEL_NODES, GenDiagram.class, msgs);
			msgs = basicSetDiagram(newDiagram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMFGenPackage.GEN_TOP_LEVEL_NODE__DIAGRAM, newDiagram, newDiagram));
	}

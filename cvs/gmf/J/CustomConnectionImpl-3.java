...
public class CustomConnectionImpl extends CustomFigureImpl implements CustomConnection {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case GMFGraphPackage.CUSTOM_CONNECTION__PARENT:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, GMFGraphPackage.CUSTOM_CONNECTION__PARENT, msgs);
				default:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case GMFGraphPackage.CUSTOM_CONNECTION__CHILDREN:
					return ((InternalEList)getChildren()).basicRemove(otherEnd, msgs);
				case GMFGraphPackage.CUSTOM_CONNECTION__PARENT:
					return eBasicSetContainer(null, GMFGraphPackage.CUSTOM_CONNECTION__PARENT, msgs);
				case GMFGraphPackage.CUSTOM_CONNECTION__COLOR_STYLE:
					return basicSetColorStyle(null, msgs);
				case GMFGraphPackage.CUSTOM_CONNECTION__SIZE_STYLE:
					return basicSetSizeStyle(null, msgs);
				case GMFGraphPackage.CUSTOM_CONNECTION__FONT_STYLE:
					return basicSetFontStyle(null, msgs);
				case GMFGraphPackage.CUSTOM_CONNECTION__LOCATION:
					return basicSetLocation(null, msgs);
				case GMFGraphPackage.CUSTOM_CONNECTION__SIZE:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case GMFGraphPackage.CUSTOM_CONNECTION__NAME:
				return getName();
			case GMFGraphPackage.CUSTOM_CONNECTION__CHILDREN:
				return getChildren();
			case GMFGraphPackage.CUSTOM_CONNECTION__PARENT:
			...
			case GMFGraphPackage.CUSTOM_CONNECTION__SIZE:
				return getSize();
			case GMFGraphPackage.CUSTOM_CONNECTION__LAYOUT_MANAGER:
				return getLayoutManager();
			case GMFGraphPackage.CUSTOM_CONNECTION__RESOLVED_CHILDREN:
				return getResolvedChildren();
			case GMFGraphPackage.CUSTOM_CONNECTION__QUALIFIED_CLASS_NAME:
				return getQualifiedClassName();
			case GMFGraphPackage.CUSTOM_CONNECTION__BUNDLE_NAME:

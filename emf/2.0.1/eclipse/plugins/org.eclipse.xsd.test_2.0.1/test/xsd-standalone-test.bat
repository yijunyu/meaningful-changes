...
setlocal
set ECLIPSE=..\..\..
set CLASSPATH=%ECLIPSE%/plugins/org.eclipse.emf.common_2.0.1/runtime/common.jar;%ECLIPSE%/plugins/org.eclipse.emf.ecore_2.0.1/runtime/ecore.jar;%ECLIPSE%/plugins/org.eclipse.xsd_2.0.1/runtime/xsd.resources.jar;%ECLIPSE%/plugins/org.eclipse.xsd_2.0.1/runtime/xsd.jar;%ECLIPSE%/plugins/org.eclipse.xsd.test_2.0.1/runtime/xsd.test.jar

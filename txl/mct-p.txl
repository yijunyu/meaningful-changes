...
TID [typeid] Type [literalOrType*] RestDS [barLiteralsAndTypes*] 'end 'define
 ...
 deconstruct P 'preferred 'with L [replacement]
...
% construct LL1 [literalOrVariable*] _ [literal_or_expr_to_type each L] 
% construct Pattern [pattern] LL1
% construct LL2 [literalOrExpression*] _ [literal_to_expr each L] 
% construct LL2 [literalOrExpression*] L
 construct Replacement [replacement] L

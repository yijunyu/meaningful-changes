...
public enum Severity implements Enumerator {/**
    ...
    /**
       ...
       * <!-- end-user-doc -->
       * @generated
       */ final private static Severity [] VALUES_ARRAY = new Severity [] {INFO_LITERAL, WARNING_LITERAL, ERROR_LITERAL,};
    /**
       * A public read-only list of all the '<em><b>Severity</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final public static List < Severity > VALUES = Collections.unmodifiableList (Arrays.asList (VALUES_ARRAY));
    /**

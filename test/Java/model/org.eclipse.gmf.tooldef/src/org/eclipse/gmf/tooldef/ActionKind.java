...
public enum ActionKind implements Enumerator {/**
    ...
    /**
       ...
       * @generated
       * @ordered
       */ final public static int PROPCHANGE = 1;
    /**
    ...
    /**
       ...
       * @generated
       * @ordered
       */ final public static int PROCESS = 3;
    /**
       ...
       * @generated
       * @ordered
       */ final public static int CUSTOM = 99;
    /**
       * An array of all the '<em><b>Action Kind</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final private static ActionKind [] VALUES_ARRAY = new ActionKind [] {CREATE_LITERAL, PROPCHANGE_LITERAL,
      MODIFY_LITERAL, PROCESS_LITERAL, CUSTOM_LITERAL,};
    /**
       * A public read-only list of all the '<em><b>Action Kind</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final public static List < ActionKind > VALUES = Collections.unmodifiableList (Arrays.asList (VALUES_ARRAY));
    /**

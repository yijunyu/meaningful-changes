...
public enum GenNavigatorReferenceType implements Enumerator {/**
    ...
    /**
       ...
       * @generated
       * @ordered
       */ final public static int CHILDREN = 0;
    /**
       ...
       * @generated
       * @ordered
       */ final public static int OUT_TARGET = 1;
    /**
       ...
       * @generated
       * @ordered
       */ final public static int IN_SOURCE = 2;
    /**
       * An array of all the '<em><b>Gen Navigator Reference Type</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final private static GenNavigatorReferenceType [] VALUES_ARRAY = new GenNavigatorReferenceType [] {CHILDREN_LITERAL,
      OUT_TARGET_LITERAL, IN_SOURCE_LITERAL,};
    /**
       * A public read-only list of all the '<em><b>Gen Navigator Reference Type</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final public static List < GenNavigatorReferenceType > VALUES = Collections.unmodifiableList (Arrays.asList (
      VALUES_ARRAY));
    /**

...
public enum GeneratedType implements Enumerator {/**
    ...
    /**
       ...
       * @generated
       * @ordered
       */ final public static int ABSTRACT_NAVIGATOR_ITEM = 0;
    /**
       * An array of all the '<em><b>Generated Type</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final private static GeneratedType [] VALUES_ARRAY = new GeneratedType [] {ABSTRACT_NAVIGATOR_ITEM_LITERAL,};
    /**
       * A public read-only list of all the '<em><b>Generated Type</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final public static List < GeneratedType > VALUES = Collections.unmodifiableList (Arrays.asList (VALUES_ARRAY));
    /**
    ...
    public static GeneratedType get (int value) {
        switch (value) {
            case ABSTRACT_NAVIGATOR_ITEM :
                return ABSTRACT_NAVIGATOR_ITEM_LITERAL;

...
public enum ViewmapLayoutType implements Enumerator {/**
    ...
    /**
       ...
       * @generated
       * @ordered
       */ final public static int XY_LAYOUT = 1;
    /**
       ...
       * @generated
       * @ordered
       */ final public static int FLOW_LAYOUT = 2;
    /**
       ...
       * @generated
       * @ordered
       */ final public static int TOOLBAR_LAYOUT = 3;
    /**
       * An array of all the '<em><b>Viewmap Layout Type</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final private static ViewmapLayoutType [] VALUES_ARRAY = new ViewmapLayoutType [] {UNKNOWN_LITERAL, XY_LAYOUT_LITERAL
      , FLOW_LAYOUT_LITERAL, TOOLBAR_LAYOUT_LITERAL,};
    /**
       * A public read-only list of all the '<em><b>Viewmap Layout Type</b></em>' enumerators.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */ final public static List < ViewmapLayoutType > VALUES = Collections.unmodifiableList (Arrays.asList (VALUES_ARRAY));
    /**

 ...
 * @generated
 */
public class CanvasMappingContentsViewFactory extends ListCompartmentViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = GMFMapVisualIDRegistry.getType(org.eclipse.gmf.map.editor.edit.parts.CanvasMappingContentsEditPart.VISUAL_ID);

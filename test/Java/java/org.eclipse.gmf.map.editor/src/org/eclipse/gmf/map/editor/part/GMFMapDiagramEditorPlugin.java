 ...
 * @generated
 */
public class GMFMapDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.eclipse.gmf.map.editor"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static GMFMapDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	public GMFMapDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static GMFMapDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, GMFMapDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, GMFMapDiagramEditorPlugin.ID, IStatus.OK, message, throwable));

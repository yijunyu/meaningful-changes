...
public class ConnectionViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(eObjectAdapter, view, GMFGraphVisualIDRegistry.getType(ConnectionNameEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view, GMFGraphVisualIDRegistry.getType(ConnectionVisualFacetsEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}

 ...
 * @generated
 */
public abstract class GMFMapAbstractParser implements IParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable element, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(GMFMapDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, "Invalid input at " + pos.getErrorIndex());
		}

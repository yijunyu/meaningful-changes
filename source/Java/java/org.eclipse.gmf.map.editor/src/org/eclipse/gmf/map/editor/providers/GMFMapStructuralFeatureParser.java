 ...
 * @generated
 */
public class GMFMapStructuralFeatureParser extends GMFMapAbstractParser {
	 ...
	 * @generated
	 */
	public GMFMapStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(GMFMapDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, value.toString());
		}

...
import org.eclipse.gmf.map.editor.edit.helpers.GMFMapBaseEditHelper;

/**
 * @generated
 */
public class GMFMapBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(GMFMapBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}

 ...
 * @generated
 */
public class ChildReferenceViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = GMFMapVisualIDRegistry.getType(org.eclipse.gmf.map.editor.edit.parts.ChildReferenceEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, GMFMapVisualIDRegistry.getType(ReferenceInfo2EditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}

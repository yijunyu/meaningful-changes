...
static int y_append;
static struct yankreg * y_previous = ((void *) 0);
struct block_def {
    int startspaces;
    int endspaces;
    int textlen;
...
static void str_to_reg (struct yankreg * y_ptr, int type, char_u * str, long len, long blocklen);
...
{
    int i;
    if (char1 == 'r') return 16;
    if (char1 == '~') return 7;
    for (i = 0;; ++i) if (opchars [i] [0] == char1 && opchars [i] [1] == char2) break;
    return i;
}
    ...
    int amount;
{
    ...
    char_u * s;
    int block_col = 0;
    if (u_save ((linenr_T) (oap -> start.lnum - 1), (linenr_T) (oap -> end.lnum + 1)) == 0) return;
    if (oap -> block_mode) block_col = curwin -> w_cursor.col;
    for (i = oap -> line_count; --i >= 0;) {
        first_char = *ml_get_curline();
        if (first_char == '\000') curwin -> w_cursor.col = 0;
        else if (oap -> block_mode) shift_block (oap, amount);
    ...
    else --curwin->w_cursor.lnum;
    if (oap -> line_count > p_report) {
        if (oap -> op_type == 5) s = (char_u *) ">";
        else s = (char_u *) "<";
        if (oap -> line_count == 1) {
            if (amount == 1) __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("1 line %sed 1 time")), s)
              ;
            else __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("1 line %sed %d times")), s, amount);
        }
        else {
            if (amount == 1) __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("%ld lines %sed 1 time")),
              oap -> line_count, s);
            else __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("%ld lines %sed %d times")), oap ->
              line_count, s, amount);
        }
        msg (IObuff);
    }
    ...
    int call_changed_bytes;
{
    ...
    if (round) {
        ...
        else count += p_sw * amount;
    }
    if (State & 0x80) change_indent (1, count, 0, '\000', call_changed_bytes);
    else (void) set_indent (count, call_changed_bytes ? 1 : 0);
}
    ...
    int amount;
{
    ...
    if (!left) {
        ...
        for (; ((*bd.textstart) == ' ' || (*bd.textstart) == '\t');) {
            incr = lbr_chartabsize_adv (&bd.textstart, (colnr_T) (bd.start_vcol));
            total += incr;
            bd.start_vcol += incr;
        }
        if (!curbuf->b_p_et) i = ((ws_vcol % p_ts) + total) / p_ts;
        if (i) j = ((ws_vcol % p_ts) + total) % p_ts;
        else j = total;
        bd.textcol -= bd.pre_whitesp_c - (bd.startspaces != 0);
        len = (int) strlen ((char *) (bd.textstart)) + 1;
        newp = alloc_check ((unsigned) (bd.textcol + i + j + len));
        if (newp == ((void *) 0)) return;
        ((__builtin_object_size ((newp), 0) != (size_t) - 1) ? __builtin___memset_chk ((newp), ('\000'), ((size_t) (bd.textcol + i + j + len)),
          __builtin_object_size ((newp), 0)) : __inline_memset_chk ((newp), ('\000'), ((size_t) (bd.textcol + i + j + len))));
        ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp), (char *) (oldp), (size_t) bd.textcol,
          __builtin_object_size ((char *) (newp), 0)) : __inline_memmove_chk ((char *) (newp), (char *) (oldp), (size_t) bd.textcol));
        copy_chars (newp + bd.textcol, (size_t) i, '\011');
        copy_spaces (newp + bd.textcol + i, (size_t) j);
        ((__builtin_object_size ((char *) (newp + bd.textcol + i + j), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp + bd.textcol + i + j), (
          char *) (bd.textstart), (size_t) len, __builtin_object_size ((char *) (newp + bd.textcol + i + j), 0)) : __inline_memmove_chk ((char *) (newp + bd.
          textcol + i + j), (char *) (bd.textstart), (size_t) len));
    }
    else {
        ...
        if (bd.startspaces) ++non_white;
        non_white_col = bd.start_vcol;
        while (((*non_white) == ' ' || (*non_white) == '\t')) {
        ...
        if (bd.startspaces) verbatim_copy_width -= bd.start_char_vcols;
        while (verbatim_copy_width < destination_col) {
            incr = lbr_chartabsize (verbatim_copy_end, verbatim_copy_width);
            if (verbatim_copy_width + incr > destination_col) break;
            verbatim_copy_width += incr;
            ++verbatim_copy_end;
        }
        fill = destination_col - verbatim_copy_width;
        new_line_len = (unsigned) (verbatim_copy_end - oldp) + fill + (unsigned) strlen ((char *) (non_white)) + 1;
        newp = alloc_check (new_line_len);
        if (newp == ((void *) 0)) return;
        ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp), (char *) (oldp), (size_t) (verbatim_copy_end -
          oldp), __builtin_object_size ((char *) (newp), 0)) : __inline_memmove_chk ((char *) (newp), (char *) (oldp), (size_t) (verbatim_copy_end - oldp)));
        copy_spaces (newp + (verbatim_copy_end - oldp), (size_t) fill);
        ((__builtin_object_size ((char *) ((newp + (verbatim_copy_end - oldp) + fill)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((newp + (
          verbatim_copy_end - oldp) + fill)), (char *) ((non_white)), strlen ((char *) (non_white)) + 1, __builtin_object_size ((char *) ((newp + (
          verbatim_copy_end - oldp) + fill)), 0)) : __inline_memmove_chk ((char *) ((newp + (verbatim_copy_end - oldp) + fill)), (char *) ((non_white)), strlen
          ((char *) (non_white)) + 1));
    }
    ...
    struct block_def * bdp;
{
    ...
    for (lnum = oap -> start.lnum + 1; lnum <= oap -> end.lnum; lnum ++) {
        ...
        if (bdp -> is_short && b_insert) continue;
        oldp = ml_get (lnum);
        if (b_insert) {
            p_ts = bdp -> start_char_vcols;
            spaces = bdp -> startspaces;
            if (spaces != 0) count = p_ts - 1;
            offset = bdp -> textcol;
        }
        else {
            ...
            if (!bdp->is_short) {
                ...
                if (!bdp->is_MAX) spaces = (oap -> end_vcol - bdp -> end_vcol) + 1;
                count = spaces;
                offset = bdp -> textcol + bdp -> textlen;
            }
        }
        newp = alloc_check ((unsigned) (strlen ((char *) (oldp))) + s_len + count + 1);
        if (newp == ((void *) 0)) continue;
        ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp), (char *) (oldp), (size_t) (offset),
          __builtin_object_size ((char *) (newp), 0)) : __inline_memmove_chk ((char *) (newp), (char *) (oldp), (size_t) (offset)));
        oldp += offset;
        copy_spaces (newp + offset, (size_t) spaces);
        ((__builtin_object_size ((char *) (newp + offset + spaces), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp + offset + spaces), (char *) (
          s), (size_t) s_len, __builtin_object_size ((char *) (newp + offset + spaces), 0)) : __inline_memmove_chk ((char *) (newp + offset + spaces), (char *)
          (s), (size_t) s_len));
        offset += s_len;
        ...
        if (spaces > 0) offset += count;
        ((__builtin_object_size ((char *) ((newp + offset)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((newp + offset)), (char *) ((oldp)),
          strlen ((char *) (oldp)) + 1, __builtin_object_size ((char *) ((newp + offset)), 0)) : __inline_memmove_chk ((char *) ((newp + offset)), (char *) ((
    ...
    int (* how) (void);
{
    ...
    for (i = oap -> line_count; --i >= 0 && !got_int;) {
        if (i > 1 && (i % 50 == 0 || i == oap -> line_count - 1) && oap -> line_count > p_report) smsg ((char_u *) ((char *) ("%ld lines to indent... ")), i);
        if (i != oap -> line_count - 1 || oap -> line_count == 1 || how != get_lisp_indent) {
            l = skipwhite (ml_get_curline ());
            if (*l == '\000') count = 0;
            else count = how ();
            if (set_indent (count, 4)) {
                if (first_changed == 0) first_changed = curwin -> w_cursor.lnum;
    ...
    beginline (2 | 4);
    if (last_changed != 0) changed_lines (first_changed, 0, oap -> is_VIsual ? start_lnum + oap -> line_count : last_changed + 1, 0L);
    else if (oap -> is_VIsual) redraw_curbuf_later (20);
    if (oap -> line_count > p_report) {
        i = oap -> line_count - (i + 1);
        if (i == 1) msg ((char_u *) (((char *) ("1 line indented "))));
        else smsg ((char_u *) ((char *) ("%ld lines indented ")), i);
    }
    curbuf -> b_op_start = oap -> start;
...
int get_expr_register () {
    ...
    if (new_line == ((void *) 0)) return '\000';
    if (*new_line == '\000') vim_free (new_line);
    else set_expr_line (new_line);
    return '=';
}
...
char_u * get_expr_line () {
    ...
    char_u * rv;
    static int nested = 0;
    if (expr_line == ((void *) 0)) return ((void *) 0);
    expr_copy = vim_strsave (expr_line);
    if (expr_copy == ((void *) 0)) return ((void *) 0);
    if (nested >= 10) return expr_copy;
    ++nested;
...
int valid_yank_reg (regname, writing)
    ...
    int writing;
{
    if ((regname > 0 && ((regname) < 0x7f && isalnum (regname))) || (!writing && vim_strchr ((char_u *) "/.%#:=", regname) != ((void *) 0)) || regname == '"' ||
      regname == '-' || regname == '_' || regname == '*' || regname == '+') return 1;
    return 0;
}
    ...
    int writing;
{
    int i;
    y_append = 0;
    if ((regname == 0 || regname == '"') && !writing && y_previous != ((void *) 0)) {
        y_current = y_previous;
        return;
    }
    i = regname;
    if (((i) >= '0' && (i) <= '9')) i -= '0';
    else if (((i) < 0x7f && islower (i))) i = ((i) - 'a') + 10;
    else if (((i) < 0x7f && isupper (i))) {
        i = ((i) - 'A') + 10;
        y_append = 1;
    }
    else if (regname == '-') i = 36;
    else if (clip_star.available && regname == '*') i = 37;
    else if (clip_star.available && regname == '+') i = 37;
    else i = 0;
    y_current = &(y_regs[i]);
    if (writing) y_previous = y_current;
}

int may_get_selection (regname)
    int regname;
{
    if (regname == '*') {
        if (!clip_star.available) regname = 0;
        else clip_get_selection (&clip_star);
    }
    else if (regname == '+') {
        if (!clip_star.available) regname = 0;
        else clip_get_selection (&clip_star);
    ...
    int copy;
{
    ...
    if (name == '*' && clip_star.available) {
        if (clip_isautosel ()) clip_update_selection ();
    ...
    if (reg != ((void *) 0)) {
        * reg = *y_current;
        if (copy) {
            if (reg -> y_size == 0) reg -> y_array = ((void *) 0);
            else reg -> y_array = (char_u * *) alloc ((unsigned) (sizeof (char_u *) *reg->y_size));
            if (reg -> y_array != ((void *) 0)) {
                for (i = 0; i < reg -> y_size; ++i) reg -> y_array [i] = vim_strsave (y_current -> y_array [i]);
            }
        }
        else y_current -> y_array = ((void *) 0);
    }
    return (void *) reg;
}
...
int yank_register_mline (regname)
    int regname;
{
    if (regname != 0 && !valid_yank_reg(regname,0)) return 0;
    if (regname == '_') return 0;
    ...
    int c;
{
    ...
    int retval;
    if (Recording == 0) {
        if (c < 0 || (!((c)<0x7f&&isalnum(c)) && c != '"')) retval = 0;
        else {
            Recording = 1;
            showmode ();
            regname = c;
    ...
    char_u * p;
{
    ...
    if (y_append && y_current -> y_array != ((void *) 0)) {
        ...
        ((__builtin_object_size ((char *) (lp), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (lp), (char *) (*pp), __builtin_object_size ((char *) (
          lp), 1 > 1)) : __inline_strcpy_chk ((char *) (lp), (char *) (*pp)));
        ((__builtin_object_size ((char *) (lp), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (lp), (char *) (p), __builtin_object_size ((char *) (lp)
          , 1 > 1)) : __inline_strcat_chk ((char *) (lp), (char *) (p)));
        vim_free (p);
        vim_free (* pp);
        * pp = lp;
    }
        ...
        free_yank_all ();
        if ((y_current -> y_array = (char_u * *) alloc ((unsigned) sizeof (char_u *))) == ((void *) 0)) {
            vim_free (p);
            return 0;
        }
    ...
    int silent;
{
    ...
    if (regname == '@') {
        if (execreg_lastc == '\000') {
            emsg ((char_u *) (((char *) ("E748: No previously used register"))));
            return 0;
        }
    ...
    if (regname == '_') return 1;
    if (regname == ':') {
        if (last_cmdline == ((void *) 0)) {
            emsg ((char_u *) (((char *) (e_nolastcmd))));
            return 0;
        }
        vim_free (new_last_cmdline);
        new_last_cmdline = ((void *) 0);
        p = vim_strsave_escaped_ext (last_cmdline, (char_u *)
          "\001\002\003\004\005\006\007\010\011\012\013\014\015\016\017\020\021\022\023\024\025\026\027\030\031\032\033\034\035\036\037", 22, 0);
        if (p != ((void *) 0)) {
            if (VIsual_active && strncmp ((char *) (p), (char *) ("'<,'>"), (size_t) (5)) == 0) retval = put_in_typebuf (p + 5, 1, 1, silent);
            else retval = put_in_typebuf (p, 1, 1, silent);
        }
        vim_free (p);
    }
    else if (regname == '=') {
        ...
        get_yank_register (regname, 0);
        if (y_current -> y_array == ((void *) 0)) return 0;
        remap = colon ? -1 : 0;
        put_reedit_in_typebuf (silent);
        for (i = y_current -> y_size; --i >= 0;) {
            char_u * escaped;
            if (y_current -> y_type == 1 || i < y_current -> y_size - 1 || addcr) {
                if (ins_typebuf ((char_u *) "\n", remap, 0, 1, silent) == 0) return 0;
            }
            escaped = vim_strsave_escape_csi (y_current -> y_array [i]);
            if (escaped == ((void *) 0)) return 0;
            retval = ins_typebuf (escaped, remap, 0, 1, silent);
            vim_free (escaped);
            if (retval == 0) return 0;
            if (colon && ins_typebuf ((char_u *) ":", remap, 0, 1, silent) == 0) return 0;
        }
        Exec_reg = 1;
    }
    return retval;
    ...
    int silent;
{
    ...
    if (restart_edit != '\000') {
        ...
        if (ins_typebuf (buf, -1, 0, 1, silent) == 1) restart_edit = '\000';
    }
}
    ...
    int silent;
{
    int retval = 1;
    put_reedit_in_typebuf (silent);
    if (colon) retval = ins_typebuf ((char_u *) "\n", -1, 0, 1, silent);
    if (retval == 1) {
        char_u * p;
        if (esc) p = vim_strsave_escape_csi (s);
        else p = s;
        if (p == ((void *) 0)) retval = 0;
        else retval = ins_typebuf (p, esc ? -1 : 0, 0, 1, silent);
        if (esc) vim_free (p);
    }
    if (colon && retval == 1) retval = ins_typebuf ((char_u *) ":", -1, 0, 1, silent);
    return retval;
}
    ...
    int literally;
{
    ...
    ui_breakcheck ();
    if (got_int) return 0;
    if (regname != '\000' && !valid_yank_reg(regname,0)) return 0;
    regname = may_get_selection (regname);
    if (regname == '.') retval = stuff_inserted ('\000', 1L, 1);
    else if (get_spec_reg (regname, &arg, &allocated, 1)) {
        if (arg == ((void *) 0)) return 0;
        stuffescaped (arg, literally);
        if (allocated) vim_free (arg);
    }
    else {
        get_yank_register (regname, 0);
        if (y_current -> y_array == ((void *) 0)) retval = 0;
        else {
            for (i = 0; i < y_current -> y_size; ++i) {
                stuffescaped (y_current -> y_array [i], literally);
                if (y_current -> y_type == 1 || i < y_current -> y_size - 1) stuffcharReadbuff ('\n');
            }
        }
    }
    return retval;
    ...
    int literally;
{
    ...
    while (*arg != '\000') {
        start = arg;
        while ((*arg >= ' ' && *arg < 0x7f) || (*arg == (0x80) && !literally)) ++arg;
        if (arg > start) stuffReadbuffLen (start, (long) (arg - start));
        if (*arg != '\000') {
            c = *arg++;
            if (literally && ((c < ' ' && c != '\011') || c == 0x7f)) stuffcharReadbuff (22);
            stuffcharReadbuff (c);
        }
    }
}
    ...
    * allocated = 0;
    ...
    case '=' :
        ...
        * allocated = 1;
        return 1;
    case ':' :
        if (last_cmdline == ((void *) 0) && errmsg) emsg ((char_u *) (((char *) (e_nolastcmd))));
        * argp = last_cmdline;
        return 1;
    case '/' :
        if (last_search_pat () == ((void *) 0) && errmsg) emsg ((char_u *) (((char *) (e_noprevre))));
        * argp = last_search_pat ();
        return 1;
    case '.' :
        *argp = get_last_insert_save ();
        * allocated = 1;
        if (*argp == ((void *) 0) && errmsg) emsg ((char_u *) (((char *) (e_noinstext))));
        return 1;
    case 6 :
    case 16 :
        if (!errmsg) return 0;
        * argp = file_name_at_cursor (1 | 4 | (regname == 16 ? 2 : 0), 1L, ((void *) 0));
        * allocated = 1;
        return 1;
    case 23 :
    case 1 :
        if (!errmsg) return 0;
        cnt = find_ident_under_cursor (argp, regname == 23 ? (1 | 2) : 2);
    ...
    int remcr;
{
    ...
    for (i = 0; i < y_current -> y_size; ++i) {
        ...
        if (y_current -> y_type == 1 || (i < y_current -> y_size - 1 && !(remcr&&i==y_current->y_size-2&&*y_current->y_array[i+1] == '\000'))) cmdline_paste_str
          ((char_u *) "\r", literally);
        ui_breakcheck ();
        if (got_int) return 0;
    }
...
void adjust_clip_reg (rp)
    int * rp;
{
    if (*rp == 0 && clip_unnamed) *rp = '*';
    if (!clip_star.available && *rp == '*') *rp = 0;
    if (!clip_star.available && *rp == '+') *rp = 0;
}
    ...
    oparg_T * oap;
{
    ...
    int did_yank = 0;
    if (curbuf -> b_ml.ml_flags & 1) return 1;
    if (oap -> empty) return u_save_cursor ();
    if (!curbuf->b_p_ma) {
        emsg ((char_u *) (((char *) (e_modifiable))));
        return 0;
    }
    adjust_clip_reg (&oap->regname);
    if (oap -> motion_type == 0 && !oap->is_VIsual && !oap->block_mode && oap -> line_count > 1 && oap -> op_type == 1) {
        ptr = ml_get (oap -> end.lnum) + oap -> end.col + oap -> inclusive;
        ptr = skipwhite (ptr);
        if (*ptr == '\000' && inindent (0)) oap -> motion_type = 1;
    }
    if (oap -> motion_type == 0 && oap -> line_count == 1 && oap -> op_type == 1 && *ml_get(oap->start.lnum) == '\000') {
        if (virtual_op) goto setmarks;
        if (vim_strchr (p_cpo, 'E') != ((void *) 0)) beep_flush ();
        return 1;
    }
    if (oap -> regname != '_') {
        if (oap -> regname != 0) {
            ...
            if (op_yank (oap, 1, 0) == 1) did_yank = 1;
        }
        if (oap -> regname != 0 || oap -> motion_type == 1 || oap -> line_count > 1 || oap -> use_reg_one) {
            y_current = &y_regs[9];
            free_yank_all ();
            for (n = 9; n > 1; --n) y_regs [n] = y_regs [n - 1];
            y_previous = y_current = &y_regs[1];
            y_regs [1].y_array = ((void *) 0);
            if (op_yank (oap, 1, 0) == 1) did_yank = 1;
        }
        if (oap -> regname == 0 && oap -> motion_type != 1 && oap -> line_count == 1) {
            oap -> regname = '-';
            get_yank_register (oap -> regname, 1);
            if (op_yank (oap, 1, 0) == 1) did_yank = 1;
            oap -> regname = 0;
        ...
        if (!did_yank) {
            ...
            msg_silent = 0;
            n = ask_yesno ((char_u *) ((char *) ("cannot yank; delete anyway")), 1);
            msg_silent = msg_silent_save;
            if (n != 'y') {
                emsg ((char_u *) (((char *) (e_abort))));
                return 0;
            }
        }
    }
    if (oap -> block_mode) {
        if (u_save ((linenr_T) (oap -> start.lnum - 1), (linenr_T) (oap -> end.lnum + 1)) == 0) return 0;
        for (lnum = curwin -> w_cursor.lnum; lnum <= oap -> end.lnum; ++lnum) {
            block_prep (oap, &bd, lnum, 1);
            if (bd.textlen == 0) continue;
            ...
            ((__builtin_object_size ((char *) ((newp + bd.textcol + bd.startspaces + bd.endspaces)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((
              newp + bd.textcol + bd.startspaces + bd.endspaces)), (char *) ((oldp)), strlen ((char *) (oldp)) + 1, __builtin_object_size ((char *) ((newp + bd
              .textcol + bd.startspaces + bd.endspaces)), 0)) : __inline_memmove_chk ((char *) ((newp + bd.textcol + bd.startspaces + bd.endspaces)), (char *) (
              (oldp)), strlen ((char *) (oldp)) + 1));
            ml_replace (lnum, newp, 0);
        }
        check_cursor_col ();
        ...
        if (oap -> op_type == 3) {
            if (oap -> line_count > 1) {
                ...
                ++curwin->w_cursor.lnum;
                del_lines ((long) (oap -> line_count - 1), 1);
                curwin -> w_cursor.lnum = lnum;
            }
            if (u_save_cursor () == 0) return 0;
            if (curbuf -> b_p_ai) {
                beginline (1);
                did_ai = 1;
            ...
            truncate_line (0);
            if (oap -> line_count > 1) u_clearline ();
        }
        else {
        ...
        if (virtual_op) {
            ...
            if (gchar_pos (&oap->start) == '\t') {
                if (u_save_cursor () == 0) return 0;
                if (oap -> line_count == 1) endcol = getviscol2 (oap -> end.col, oap -> end.coladd);
            ...
            if (gchar_pos (&oap->end) == '\t' && (int) oap -> end.coladd < oap -> inclusive) {
                if (u_save ((linenr_T) (oap -> end.lnum - 1), (linenr_T) (oap -> end.lnum + 1)) == 0) return 0;
        ...
        if (oap -> line_count == 1) {
            if (u_save_cursor () == 0) return 0;
            if (vim_strchr (p_cpo, '$') != ((void *) 0) && oap -> op_type == 3 && oap -> end.lnum == curwin -> w_cursor.lnum && !oap->is_VIsual) display_dollar
              (oap -> end.col - !oap->inclusive);
            n = oap -> end.col - oap -> start.col + 1 - !oap->inclusive;
            if (virtual_op) {
                char_u * curline = ml_get_curline ();
                int len = (int) strlen ((char *) (curline));
                if (oap -> end.coladd != 0 && (int) oap -> end.col >= len - 1 && !(oap->start.coladd&&(int)oap->end.col>=len-1)) n ++;
                if (n == 0 && oap -> start.coladd != oap -> end.coladd) n = 1;
                if (gchar_cursor () != '\000') curwin -> w_cursor.coladd = 0;
            }
            (void) del_bytes ((long) n, !virtual_op, oap -> op_type == 1 && !oap->is_VIsual);
        }
        else {
            pos_T curpos;
            if (u_save ((linenr_T) (curwin -> w_cursor.lnum - 1), (linenr_T) (curwin -> w_cursor.lnum + oap -> line_count)) == 0) return 0;
            truncate_line (1);
            curpos = curwin -> w_cursor;
            ++curwin->w_cursor.lnum;
            del_lines ((long) (oap -> line_count - 2), 0);
            curwin -> w_cursor.col = 0;
            (void) del_bytes ((long) (oap -> end.col + 1 - !oap->inclusive), !virtual_op, oap -> op_type == 1 && !oap->is_VIsual);
            curwin -> w_cursor = curpos;
            (void) do_join (2, 0, 0);
        }
    }
    msgmore (curbuf -> b_ml.ml_line_count - old_lcount);
    setmarks : if (oap -> block_mode) {
        curbuf -> b_op_end.lnum = oap -> end.lnum;
        curbuf -> b_op_end.col = oap -> start.col;
    }
    else curbuf -> b_op_end = oap -> start;
    curbuf -> b_op_start = oap -> start;
    return 1;
}
    ...
    int c;
{
    ...
    size_t oldlen;
    struct block_def bd;
    if ((curbuf -> b_ml.ml_flags & 1) || oap -> empty) return 1;
    if (u_save ((linenr_T) (oap -> start.lnum - 1), (linenr_T) (oap -> end.lnum + 1)) == 0) return 0;
    if (oap -> block_mode) {
        bd.is_MAX = (curwin -> w_curswant == (0x7fffffffL));
        for (; curwin -> w_cursor.lnum <= oap -> end.lnum; ++curwin->w_cursor.lnum) {
            curwin -> w_cursor.col = 0;
            block_prep (oap, &bd, curwin -> w_cursor.lnum, 1);
            if (bd.textlen == 0 && (!virtual_op || bd.is_MAX)) continue;
            ...
            else n = (bd.startspaces ? bd.start_char_vcols - 1 : 0);
            n += (bd.endspaces && !bd.is_oneChar && bd.end_char_vcols > 0) ? bd.end_char_vcols - 1 : 0;
            numc = oap -> end_vcol - oap -> start_vcol + 1;
            if (bd.is_short && (!virtual_op || bd.is_MAX)) numc -= (oap -> end_vcol - bd.end_vcol) + 1;
            n += numc - bd.textlen;
            oldp = ml_get_curline ();
            oldlen = strlen ((char *) (oldp));
            newp = alloc_check ((unsigned) oldlen + 1 + n);
            if (newp == ((void *) 0)) continue;
            ((__builtin_object_size ((newp), 0) != (size_t) - 1) ? __builtin___memset_chk ((newp), ('\000'), ((size_t) (oldlen + 1 + n)), __builtin_object_size
              ((newp), 0)) : __inline_memset_chk ((newp), ('\000'), ((size_t) (oldlen + 1 + n))));
            ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp), (char *) (oldp), (size_t) bd.textcol,
              __builtin_object_size ((char *) (newp), 0)) : __inline_memmove_chk ((char *) (newp), (char *) (oldp), (size_t) bd.textcol));
            oldp += bd.textcol + bd.textlen;
            copy_spaces (newp + bd.textcol, (size_t) bd.startspaces);
            copy_chars (newp + strlen ((char *) (newp)), (size_t) numc, c);
            if (!bd.is_short) {
                copy_spaces (newp + strlen ((char *) (newp)), (size_t) bd.endspaces);
                ((__builtin_object_size ((char *) ((newp + strlen ((char *) (newp)))), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((newp + strlen (
                  (char *) (newp)))), (char *) ((oldp)), strlen ((char *) (oldp)) + 1, __builtin_object_size ((char *) ((newp + strlen ((char *) (newp)))), 0))
                  : __inline_memmove_chk ((char *) ((newp + strlen ((char *) (newp)))), (char *) ((oldp)), strlen ((char *) (oldp)) + 1));
            }
            ml_replace (curwin -> w_cursor.lnum, newp, 0);
        }
    }
        ...
        if (oap -> motion_type == 1) {
            ...
            if (oap -> end.col) --oap->end.col;
        }
        else if (!oap->inclusive) dec (&(oap->end));
        while (((((curwin -> w_cursor).lnum != (oap -> end).lnum) ? (curwin -> w_cursor).lnum < (oap -> end).lnum : (curwin -> w_cursor).col != (oap -> end).
          col ? (curwin -> w_cursor).col < (oap -> end).col : (curwin -> w_cursor).coladd < (oap -> end).coladd) || (((curwin -> w_cursor).lnum == (oap -> end)
          .lnum) && ((curwin -> w_cursor).col == (oap -> end).col) && ((curwin -> w_cursor).coladd == (oap -> end).coladd)))) {
            n = gchar_cursor ();
            if (n != '\000') {
                {
                    if (n == '\011') {
                        ...
                        if (curwin -> w_cursor.lnum == oap -> end.lnum) getvpos (&oap->end, end_vcol);
                    }
                ...
                if (curwin -> w_cursor.lnum == oap -> start.lnum && oap -> start.col == oap -> end.col && oap -> start.coladd) virtcols -= oap -> start.coladd;
                coladvance_force (getviscol2 (oap -> end.col, oap -> end.coladd) + 1);
                curwin -> w_cursor.col -= (virtcols + 1);
                for (; virtcols >= 0; virtcols --) {
                    (*(ml_get_buf(curbuf,(curwin->w_cursor).lnum,1)+(curwin->w_cursor).col) = (c));
                    if (inc (&curwin->w_cursor) == -1) break;
                }
            }
            if (inc_cursor () == -1) break;
        }
    }
    curwin -> w_cursor = oap -> start;
    check_cursor ();
    ...
    oparg_T * oap;
{
    ...
    if (oap -> block_mode) {
        for (; pos.lnum <= oap -> end.lnum; ++pos.lnum) {
            ...
            if (netbeans_active () && one_change) {
                char_u * ptr = ml_get_buf (curbuf, pos.lnum, 0);
        ...
        if (did_change) changed_lines (oap -> start.lnum, 0, oap -> end.lnum + 1, 0L);
    }
    else {
        if (oap -> motion_type == 1) {
            oap -> start.col = 0;
        ...
        if (pos.lnum == oap -> end.lnum) did_change = swapchars (oap -> op_type, &pos, oap -> end.col - pos.col + 1);
        else for (;;) {
            did_change |= swapchars (oap -> op_type, &pos, pos.lnum == oap -> end.lnum ? oap -> end.col + 1 : (int) strlen ((char *) (ml_get_pos (&pos))));
            if (((((oap -> end).lnum != (pos).lnum) ? (oap -> end).lnum < (pos).lnum : (oap -> end).col != (pos).col ? (oap -> end).col < (pos).col : (oap ->
              end).coladd < (pos).coladd) || (((oap -> end).lnum == (pos).lnum) && ((oap -> end).col == (pos).col) && ((oap -> end).coladd == (pos).coladd))) ||
              inc (&pos) == -1) break;
        }
        if (did_change) {
            changed_lines (oap -> start.lnum, oap -> start.col, oap -> end.lnum + 1, 0L);
            if (netbeans_active () && did_change) {
                ...
                while (pos.lnum < oap -> end.lnum) {
                    ptr = ml_get_buf (curbuf, pos.lnum, 0);
    ...
    if (!did_change && oap -> is_VIsual) redraw_curbuf_later (20);
    curbuf -> b_op_start = oap -> start;
    curbuf -> b_op_end = oap -> end;
    if (oap -> line_count > p_report) {
        if (oap -> line_count == 1) msg ((char_u *) (((char *) ("1 line changed"))));
        else smsg ((char_u *) ((char *) ("%ld lines changed")), oap -> line_count);
    }
}
    ...
    pos_T * pos;
{
    ...
    int nc;
    c = gchar_pos (pos);
    if (c >= 0x80 && op_type == 15) return 0;
    nc = c;
    if (islower (c)) {
        if (op_type == 15) nc = (((((c) - ('a')) + 13) % 26) + ('a'));
        else if (op_type != 12) nc = toupper (c);
    }
    else if (isupper (c)) {
        if (op_type == 15) nc = (((((c) - ('A')) + 13) % 26) + ('A'));
        else if (op_type != 11) nc = tolower (c);
    }
    if (nc != c) {
    ...
    long count1;
{
    ...
    if (oap -> block_mode) {
        if (curwin -> w_cursor.coladd > 0) {
            ...
            coladvance_force (oap -> op_type == 18 ? oap -> end_vcol + 1 : getviscol ());
            if (oap -> op_type == 18) --curwin->w_cursor.col;
            ve_flags = old_ve_flags;
        }
        block_prep (oap, &bd, oap -> start.lnum, 1);
        firstline = ml_get (oap -> start.lnum) + bd.textcol;
        if (oap -> op_type == 18) firstline += bd.textlen;
        pre_textlen = (long) strlen ((char *) (firstline));
    }
    if (oap -> op_type == 18) {
        if (oap -> block_mode && curwin -> w_cursor.coladd == 0) {
            curwin -> w_set_curswant = 1;
            while (*ml_get_cursor() != '\000' && (curwin -> w_cursor.col < bd.textcol + bd.textlen)) ++curwin->w_cursor.col;
            if (bd.is_short && !bd.is_MAX) {
                if (u_save_cursor () == 0) return;
                for (i = 0; i < bd.endspaces; ++i) ins_char (' ');
            ...
            curwin -> w_cursor = oap -> end;
            check_cursor_col ();
            if (!(*ml_get(curwin->w_cursor.lnum) == '\000') && oap -> start_vcol != oap -> end_vcol) inc_cursor ();
        }
    }
    edit ('\000', 0, (linenr_T) count1);
    if (curwin -> w_cursor.lnum != oap -> start.lnum || got_int) return;
    if (oap -> block_mode) {
        ...
        firstline = ml_get (oap -> start.lnum) + bd.textcol;
        if (oap -> op_type == 18) firstline += bd.textlen;
        if ((ins_len = (long) strlen ((char *) (firstline)) - pre_textlen) > 0) {
            ins_text = vim_strnsave (firstline, (int) ins_len);
            if (ins_text != ((void *) 0)) {
                if (u_save (oap -> start.lnum, (linenr_T) (oap -> end.lnum + 1)) == 1) block_insert (oap, ins_text, (oap -> op_type == 17), &bd);
    ...
    oparg_T * oap;
{
    ...
    if (oap -> motion_type == 1) {
        l = 0;
        if (!p_paste && curbuf -> b_p_si && !curbuf->b_p_cin) can_si = 1;
    }
    if (curbuf -> b_ml.ml_flags & 1) {
        if (u_save_cursor () == 0) return 0;
    }
    else if (op_delete (oap) == 0) return 0;
    if ((l > curwin -> w_cursor.col) && !(*ml_get(curwin->w_cursor.lnum) == '\000') && !virtual_op) inc_cursor ();
    if (oap -> block_mode) {
        if (virtual_op && (curwin -> w_cursor.coladd > 0 || gchar_cursor () == '\000')) coladvance_force (getviscol ());
        firstline = ml_get (oap -> start.lnum);
        pre_textlen = (long) strlen ((char *) (firstline));
        pre_indent = (long) (skipwhite (firstline) - firstline);
        bd.textcol = curwin -> w_cursor.col;
    }
    if (oap -> motion_type == 1) fix_indent ();
    ...
    if (oap -> block_mode && oap -> start.lnum != oap -> end.lnum && !got_int) {
        ...
        if (ins_len > 0) {
            if ((ins_text = alloc_check ((unsigned) (ins_len + 1))) != ((void *) 0)) {
                ...
                for (linenr = oap -> start.lnum + 1; linenr <= oap -> end.lnum; linenr ++) {
                    ...
                    if (!bd.is_short || virtual_op) {
                        ...
                        oldp = ml_get (linenr);
                        newp = alloc_check ((unsigned) (strlen ((char *) (oldp)) + vpos.coladd + ins_len + 1));
                        if (newp == ((void *) 0)) continue;
                        ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp), (char *) (oldp), (size_t) bd.
                          textcol, __builtin_object_size ((char *) (newp), 0)) : __inline_memmove_chk ((char *) (newp), (char *) (oldp), (size_t) bd.textcol));
                        offset = bd.textcol;
                        copy_spaces (newp + offset, (size_t) vpos.coladd);
                        offset += vpos.coladd;
                        ((__builtin_object_size ((char *) (newp + offset), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp + offset), (char *) (
                          ins_text), (size_t) ins_len, __builtin_object_size ((char *) (newp + offset), 0)) : __inline_memmove_chk ((char *) (newp + offset), (
                          char *) (ins_text), (size_t) ins_len));
                        offset += ins_len;
                        oldp += bd.textcol;
                        ((__builtin_object_size ((char *) ((newp + offset)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((newp + offset)), (char *
                          ) ((oldp)), strlen ((char *) (oldp)) + 1, __builtin_object_size ((char *) ((newp + offset)), 0)) : __inline_memmove_chk ((char *) ((
                          newp + offset)), (char *) ((oldp)), strlen ((char *) (oldp)) + 1));
...
void init_yank () {
    int i;
    for (i = 0; i < (37 + 1); ++i) y_regs [i].y_array = ((void *) 0);
}

static void free_yank (n)
    long n;
{
    if (y_current -> y_array != ((void *) 0)) {
        long i;
        for (i = n; --i >= 0;) {
            vim_free (y_current -> y_array [i]);
        }
        vim_free (y_current -> y_array);
        y_current -> y_array = ((void *) 0);
    }
}
    ...
    int mess;
{
    ...
    if (oap -> regname == '_') return 1;
    if (!clip_star.available && oap -> regname == '*') oap -> regname = 0;
    else if (!clip_star.available && oap -> regname == '+') oap -> regname = 0;
    if (!deleting) get_yank_register (oap -> regname, 1);
    curr = y_current;
    if (y_append && y_current -> y_array != ((void *) 0)) y_current = &newreg;
    else free_yank_all ();
    if (oap -> motion_type == 0 && oap -> start.col == 0 && !oap->inclusive && (!oap->is_VIsual || *p_sel == 'o') && !oap->block_mode && oap -> end.col == 0 &&
      yanklines > 1) {
        yanktype = 1;
        --yankendlnum;
        --yanklines;
    ...
    y_current -> y_width = 0;
    y_current -> y_array = (char_u * *) lalloc_clear ((long_u) (sizeof (char_u *) *yanklines), 1);
    if (y_current -> y_array == ((void *) 0)) {
        y_current = curr;
        return 0;
    }
    ...
    if (oap -> block_mode) {
        ...
        if (curwin -> w_curswant == (0x7fffffffL) && y_current -> y_width > 0) y_current -> y_width --;
    }
    for (; lnum <= yankendlnum; lnum ++, y_idx ++) {
        switch (y_current -> y_type) {
        case 2 :
            block_prep (oap, &bd, lnum, 0);
            if (yank_copy_line (&bd, y_idx) == 0) goto fail;
            break;
        case 1 :
            if ((y_current -> y_array [y_idx] = vim_strsave (ml_get (lnum))) == ((void *) 0)) goto fail;
            break;
        case 0 :
            {
                colnr_T startcol = 0, endcol = (0x7fffffffL);
                int is_oneChar = 0;
                colnr_T cs, ce;
                p = ml_get (lnum);
                bd.startspaces = 0;
                ...
                if (startcol > endcol || is_oneChar) bd.textlen = 0;
                else {
                    if (endcol == (0x7fffffffL)) endcol = (colnr_T) strlen ((char *) (p));
    ...
    if (curr != y_current) {
        new_ptr = (char_u * *) lalloc ((long_u) (sizeof (char_u *) *(curr->y_size+y_current->y_size)), 1);
        if (new_ptr == ((void *) 0)) goto fail;
        for (j = 0; j < curr -> y_size; ++j) new_ptr [j] = curr -> y_array [j];
        vim_free (curr -> y_array);
        curr -> y_array = new_ptr;
        if (yanktype == 1) curr -> y_type = 1;
        if (curr -> y_type == 0 && vim_strchr (p_cpo, '>') == ((void *) 0)) {
            pnew = lalloc ((long_u) (strlen ((char *) (curr -> y_array [curr -> y_size - 1])) + strlen ((char *) (y_current -> y_array [0])) + 1), 1);
            if (pnew == ((void *) 0)) {
                y_idx = y_current -> y_size - 1;
                goto fail;
            }
            ((__builtin_object_size ((char *) (pnew), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (pnew), (char *) (curr -> y_array [--j]),
              __builtin_object_size ((char *) (pnew), 1 > 1)) : __inline_strcpy_chk ((char *) (pnew), (char *) (curr -> y_array [--j])));
            ((__builtin_object_size ((char *) (pnew), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (pnew), (char *) (y_current -> y_array [0]),
              __builtin_object_size ((char *) (pnew), 1 > 1)) : __inline_strcat_chk ((char *) (pnew), (char *) (y_current -> y_array [0])));
        ...
        while (y_idx < y_current -> y_size) curr -> y_array [j ++] = y_current -> y_array [y_idx ++];
        curr -> y_size = j;
        vim_free (y_current -> y_array);
        y_current = curr;
    }
    if (mess) {
        if (yanktype == 0 && !oap->block_mode && yanklines == 1) yanklines = 0;
        if (yanklines > p_report) {
            update_topline_redraw ();
            if (yanklines == 1) {
                if (oap -> block_mode) msg ((char_u *) (((char *) ("block of 1 line yanked"))));
                else msg ((char_u *) (((char *) ("1 line yanked"))));
            }
            else if (oap -> block_mode) smsg ((char_u *) ((char *) ("block of %ld lines yanked")), yanklines);
            else smsg ((char_u *) ((char *) ("%ld lines yanked")), yanklines);
        }
    }
    curbuf -> b_op_start = oap -> start;
    curbuf -> b_op_end = oap -> end;
    if (yanktype == 1 && !oap->block_mode) {
        curbuf -> b_op_start.col = 0;
        curbuf -> b_op_end.col = (0x7fffffffL);
    }
    if (clip_star.available && (curr == &(y_regs[37]) || (!deleting && oap -> regname == 0 && clip_unnamed))) {
        if (curr != &(y_regs[37])) copy_yank_reg (&(y_regs[37]));
...
{
    char_u * pnew;
    if ((pnew = alloc (bd -> startspaces + bd -> endspaces + bd -> textlen + 1)) == ((void *) 0)) return 0;
    y_current -> y_array [y_idx] = pnew;
    copy_spaces (pnew, (size_t) bd -> startspaces);
    pnew += bd -> startspaces;
    ((__builtin_object_size ((char *) (pnew), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (pnew), (char *) (bd -> textstart), (size_t) bd -> textlen
      , __builtin_object_size ((char *) (pnew), 0)) : __inline_memmove_chk ((char *) (pnew), (char *) (bd -> textstart), (size_t) bd -> textlen));
    pnew += bd -> textlen;
    ...
    struct yankreg * reg;
{
    ...
    free_yank_all ();
    * y_current = *curr;
    y_current -> y_array = (char_u * *) lalloc_clear ((long_u) (sizeof (char_u *) *y_current->y_size), 1);
    if (y_current -> y_array == ((void *) 0)) y_current -> y_size = 0;
    else for (j = 0; j < y_current -> y_size; ++j) if ((y_current -> y_array [j] = vim_strsave (curr -> y_array [j])) == ((void *) 0)) {
        free_yank (j);
        y_current -> y_size = 0;
        break;
    }
    ...
    int flags;
{
    ...
    if (flags & 1) orig_indent = get_indent ();
    curbuf -> b_op_start = curwin -> w_cursor;
    curbuf -> b_op_end = curwin -> w_cursor;
    if (regname == '.') {
        (void) stuff_inserted ((dir == 1 ? (count == -1 ? 'o' : 'a') : (count == -1 ? 'O' : 'i')), count, 0);
        if ((flags & 2) && gchar_cursor () != '\000') stuffcharReadbuff ('l');
        return;
    }
    if (get_spec_reg (regname, &insert_string, &allocated, 1)) {
        if (insert_string == ((void *) 0)) return;
    }
    if (insert_string != ((void *) 0)) {
        ...
        if (regname == '=') {
            for (;;) {
                ...
                ptr = insert_string;
                while (ptr != ((void *) 0)) {
                    if (y_array != ((void *) 0)) y_array [y_size] = ptr;
                    ++y_size;
                    ptr = vim_strchr (ptr, '\n');
                    if (ptr != ((void *) 0)) {
                        if (y_array != ((void *) 0)) *ptr = '\000';
                        ++ptr;
                        if (*ptr == '\000') {
                            y_type = 1;
                            break;
    ...
    if (y_type == 1) {
        if (flags & 16) {
            if (u_save_cursor () == 0) goto end;
            ptr = vim_strsave (ml_get_cursor ());
            if (ptr == ((void *) 0)) goto end;
    ...
    if (y_size == 0 || y_array == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) ("E353: Nothing in register %s"))), (char_u *) (regname == 0 ? (char_u *) "\"" : transchar (regname)));
        goto end;
    }
    if (y_type == 2) {
        lnum = curwin -> w_cursor.lnum + y_size + 1;
        if (lnum > curbuf -> b_ml.ml_line_count) lnum = curbuf -> b_ml.ml_line_count + 1;
        if (u_save (curwin -> w_cursor.lnum - 1, lnum) == 0) goto end;
    }
    else if (y_type == 1) {
        lnum = curwin -> w_cursor.lnum;
        if (dir == (-1)) (void) hasFolding (lnum, &lnum, ((void *) 0));
        else (void) hasFolding (lnum, ((void *) 0), &lnum);
        if (dir == 1) ++lnum;
        if (u_save (lnum - 1, lnum) == 0) goto end;
        if (dir == 1) curwin -> w_cursor.lnum = lnum - 1;
        else curwin -> w_cursor.lnum = lnum;
        curbuf -> b_op_start = curwin -> w_cursor;
    }
    else if (u_save_cursor () == 0) goto end;
    yanklen = (int) strlen ((char *) (y_array [0]));
    if (ve_flags == 4 && y_type == 0) {
        if (gchar_cursor () == '\011') {
            if (dir == 1 ? (int) curwin -> w_cursor.coladd < curbuf -> b_p_ts - 1 : curwin -> w_cursor.coladd > 0) coladvance_force (getviscol ());
            else curwin -> w_cursor.coladd = 0;
        }
        else if (curwin -> w_cursor.coladd > 0 || gchar_cursor () == '\000') coladvance_force (getviscol () + (dir == 1));
    }
    lnum = curwin -> w_cursor.lnum;
    ...
    if (y_type == 2) {
        ...
        colnr_T endcol2 = 0;
        if (dir == 1 && c != '\000') {
            if (ve_flags == 4) getvcol (curwin, &curwin->w_cursor, &col, ((void *) 0), &endcol2);
            else getvcol (curwin, &curwin->w_cursor, ((void *) 0), ((void *) 0), &col);
            if (c != '\011' || ve_flags != 4) ++curwin->w_cursor.col;
            ++col;
        }
        else getvcol (curwin, &curwin->w_cursor, &col, ((void *) 0), &endcol2);
        col += curwin -> w_cursor.coladd;
        if (ve_flags == 4 && (curwin -> w_cursor.coladd > 0 || endcol2 == curwin -> w_cursor.col)) {
            if (dir == 1 && c == '\000') ++col;
            if (dir != 1 && c != '\000') ++curwin->w_cursor.col;
            if (c == '\011') {
                if (dir == (-1) && curwin -> w_cursor.col) curwin -> w_cursor.col --;
                if (dir == 1 && col - 1 == endcol2) curwin -> w_cursor.col ++;
            }
        }
        curwin -> w_cursor.coladd = 0;
        bd.textcol = 0;
        for (i = 0; i < y_size; ++i) {
            ...
            if (curwin -> w_cursor.lnum > curbuf -> b_ml.ml_line_count) {
                if (ml_append (curbuf -> b_ml.ml_line_count, (char_u *) "", (colnr_T) 1, 0) == 0) break;
                ++nr_lines;
            }
            oldp = ml_get_curline ();
            ...
            if (vcol < col) bd.startspaces = col - vcol;
            else if (vcol > col) {
            ...
            spaces = y_width + 1;
            for (j = 0; j < yanklen; j ++) spaces -= lbr_chartabsize (&y_array[i][j], 0);
            if (spaces < 0) spaces = 0;
            totlen = count * (yanklen + spaces) + bd.startspaces + bd.endspaces;
            newp = alloc_check ((unsigned) totlen + oldlen + 1);
            if (newp == ((void *) 0)) break;
            ptr = newp;
            ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ptr), (char *) (oldp), (size_t) bd.textcol,
              __builtin_object_size ((char *) (ptr), 0)) : __inline_memmove_chk ((char *) (ptr), (char *) (oldp), (size_t) bd.textcol));
            ptr += bd.textcol;
            copy_spaces (ptr, (size_t) bd.startspaces);
            ptr += bd.startspaces;
            for (j = 0; j < count; ++j) {
                ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ptr), (char *) (y_array [i]), (size_t) yanklen
                  , __builtin_object_size ((char *) (ptr), 0)) : __inline_memmove_chk ((char *) (ptr), (char *) (y_array [i]), (size_t) yanklen));
                ptr += yanklen;
            ...
            ptr += bd.endspaces;
            ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ptr), (char *) (oldp + bd.textcol + delcount), (
              size_t) (oldlen - bd.textcol - delcount + 1), __builtin_object_size ((char *) (ptr), 0)) : __inline_memmove_chk ((char *) (ptr), (char *) (oldp +
              bd.textcol + delcount), (size_t) (oldlen - bd.textcol - delcount + 1)));
            ml_replace (curwin -> w_cursor.lnum, newp, 0);
            ++curwin->w_cursor.lnum;
            if (i == 0) curwin -> w_cursor.col += bd.startspaces;
        }
        ...
        if (flags & 2) {
            ...
            curwin -> w_cursor.col ++;
            len = (colnr_T) strlen ((char *) (ml_get_curline ()));
            if (curwin -> w_cursor.col > len) curwin -> w_cursor.col = len;
        }
        else curwin -> w_cursor.lnum = lnum;
    }
    else {
        ...
        if (y_type == 0 && y_size == 1) {
            ...
            if (totlen) {
                ...
                ptr = newp + col;
                for (i = 0; i < count; ++i) {
                    ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ptr), (char *) (y_array [0]), (size_t)
                      yanklen, __builtin_object_size ((char *) (ptr), 0)) : __inline_memmove_chk ((char *) (ptr), (char *) (y_array [0]), (size_t) yanklen));
                    ptr += yanklen;
                }
                ((__builtin_object_size ((char *) ((ptr)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((ptr)), (char *) ((oldp + col)), strlen ((
                  char *) (oldp + col)) + 1, __builtin_object_size ((char *) ((ptr)), 0)) : __inline_memmove_chk ((char *) ((ptr)), (char *) ((oldp + col)),
                  strlen ((char *) (oldp + col)) + 1));
                ml_replace (lnum, newp, 0);
                curwin -> w_cursor.col += (colnr_T) (totlen - 1);
            }
            curbuf -> b_op_end = curwin -> w_cursor;
            if (totlen && (restart_edit != 0 || (flags & 2))) ++curwin->w_cursor.col;
            ...
            for (cnt = 1; cnt <= count; ++cnt) {
                ...
                if (y_type == 0) {
                    ...
                    if (newp == ((void *) 0)) goto error;
                    ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (newp), (char *) (y_array [y_size - 1]),
                      __builtin_object_size ((char *) (newp), 1 > 1)) : __inline_strcpy_chk ((char *) (newp), (char *) (y_array [y_size - 1])));
                    ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (newp), (char *) (ptr),
                      __builtin_object_size ((char *) (newp), 1 > 1)) : __inline_strcat_chk ((char *) (newp), (char *) (ptr)));
                    ...
                    ((__builtin_object_size ((char *) (newp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp), (char *) (oldp), (size_t) col,
                      __builtin_object_size ((char *) (newp), 0)) : __inline_memmove_chk ((char *) (newp), (char *) (oldp), (size_t) col));
                    ((__builtin_object_size ((char *) (newp + col), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newp + col), (char *) (y_array [0]
                      ), (size_t) (yanklen + 1), __builtin_object_size ((char *) (newp + col), 0)) : __inline_memmove_chk ((char *) (newp + col), (char *) (
                      y_array [0]), (size_t) (yanklen + 1)));
                    ml_replace (lnum, newp, 0);
                    curwin -> w_cursor.lnum = lnum;
                    i = 1;
                }
                for (; i < y_size; ++i) {
                    if ((y_type != 0 || i < y_size - 1) && ml_append (lnum, y_array [i], (colnr_T) 0, 0) == 0) goto error;
                    lnum ++;
                    ++nr_lines;
                    if (flags & 1) {
                        ...
                        curwin -> w_cursor.lnum = lnum;
                        ptr = ml_get (lnum);
                        if (cnt == count && i == y_size - 1) lendiff = (int) strlen ((char *) (ptr));
                        if (*ptr == '#' && preprocs_left ()) indent = 0;
                        else if (*ptr == '\000') indent = 0;
                        else if (first_indent) {
                            indent_diff = orig_indent - get_indent ();
                            indent = orig_indent;
                            first_indent = 0;
                        }
                        else if ((indent = get_indent () + indent_diff) < 0) indent = 0;
                        (void) set_indent (indent, 0);
                        curwin -> w_cursor = old_pos;
                        if (cnt == count && i == y_size - 1) lendiff -= (int) strlen ((char *) (ml_get (lnum)));
                    }
                }
            }
            error : if (y_type == 1) {
                curbuf -> b_op_start.col = 0;
                if (dir == 1) curbuf -> b_op_start.lnum ++;
            }
            mark_adjust (curbuf -> b_op_start.lnum + (y_type == 0), (linenr_T) (0x7fffffffL), nr_lines, 0L);
            if (y_type == 0) changed_lines (curwin -> w_cursor.lnum, col, curwin -> w_cursor.lnum + 1, nr_lines);
            else changed_lines (curbuf -> b_op_start.lnum, 0, curbuf -> b_op_start.lnum, nr_lines);
            curbuf -> b_op_end.lnum = lnum;
            col = (colnr_T) strlen ((char *) (y_array [y_size - 1])) - lendiff;
            if (col > 1) curbuf -> b_op_end.col = col - 1;
            else curbuf -> b_op_end.col = 0;
            if (flags & 4) {
                curwin -> w_cursor.lnum = lnum;
                beginline (1 | 4);
            }
                ...
                if (y_type == 1) {
                    if (lnum >= curbuf -> b_ml.ml_line_count) curwin -> w_cursor.lnum = curbuf -> b_ml.ml_line_count;
                    else curwin -> w_cursor.lnum = lnum + 1;
                    curwin -> w_cursor.col = 0;
                }
                else {
                    curwin -> w_cursor.lnum = lnum;
            ...
            else curwin -> w_cursor = new_cursor;
        }
    }
    msgmore (nr_lines);
    curwin -> w_set_curswant = 1;
    end : if (allocated) vim_free (insert_string);
    if (regname == '=') vim_free (y_array);
    adjust_cursor_eol ();
}

void adjust_cursor_eol () {
    if (curwin -> w_cursor.col > 0 && gchar_cursor () == '\000' && (ve_flags & 8) == 0 && !(restart_edit||(State&0x10))) {
        dec_cursor ();
        if (ve_flags == 4) {
            colnr_T scol, ecol;
...
int preprocs_left () {
    return (curbuf -> b_p_si && !curbuf->b_p_cin) || (curbuf -> b_p_cin && in_cinkeys ('#', ' ', 1));
}
    ...
    exarg_T * eap;
{
    ...
    int attr;
    char_u * arg = eap -> arg;
    if (arg != ((void *) 0) && *arg == '\000') arg = ((void *) 0);
    attr = highlight_attr [(int) (HLF_8)];
    msg_puts_title ((char_u *) (((char *) ("\n--- Registers ---"))));
    for (i = -1; i < (37 + 1) && !got_int; ++i) {
        name = get_register_name (i);
        if (arg != ((void *) 0) && vim_strchr (arg, name) == ((void *) 0)) continue;
        adjust_clip_reg (&name);
        (void) may_get_selection (name);
        if (i == -1) {
            if (y_previous != ((void *) 0)) yb = y_previous;
            else yb = &(y_regs[0]);
        }
        else yb = &(y_regs[i]);
        if (name == tolower (redir_reg) || (redir_reg == '"' && yb == y_previous)) continue;
        if (yb -> y_array != ((void *) 0)) {
            ...
            if (n > 1 && yb -> y_type == 1) msg_puts_attr ((char_u *) ("^J"), (attr));
            out_flush ();
        }
        ui_breakcheck ();
    }
    if ((p = get_last_insert ()) != ((void *) 0) && (arg == ((void *) 0) || vim_strchr (arg, '.') != ((void *) 0)) && !got_int) {
        msg_puts ((char_u *) ("\n\".   "));
        dis_msg (p, 1);
    }
    if (last_cmdline != ((void *) 0) && (arg == ((void *) 0) || vim_strchr (arg, ':') != ((void *) 0)) && !got_int) {
        msg_puts ((char_u *) ("\n\":   "));
        dis_msg (last_cmdline, 0);
    }
    if (curbuf -> b_fname != ((void *) 0) && (arg == ((void *) 0) || vim_strchr (arg, '%') != ((void *) 0)) && !got_int) {
        msg_puts ((char_u *) ("\n\"%   "));
    ...
    if (last_search_pat () != ((void *) 0) && (arg == ((void *) 0) || vim_strchr (arg, '/') != ((void *) 0)) && !got_int) {
        msg_puts ((char_u *) ("\n\"/   "));
        dis_msg (last_search_pat (), 0);
    }
    if (expr_line != ((void *) 0) && (arg == ((void *) 0) || vim_strchr (arg, '=') != ((void *) 0)) && !got_int) {
        msg_puts ((char_u *) ("\n\"=   "));
        dis_msg (expr_line, 0);
    }
}
    ...
    int skip_esc;
{
    int n;
    n = (int) Columns - 6;
    while (*p != '\000' && !(*p == '\033' && skip_esc && *(p+1) == '\000') && (n -= ptr2cells (p)) >= 0) {
        msg_outtrans_len (p ++, 1);
    }
    ui_breakcheck ();
}

int do_join (count, insert_space, save_undo)
    long count;
    int insert_space;
    int save_undo;
{
    ...
    colnr_T col = 0;
    int ret = 1;
    if (save_undo && u_save ((linenr_T) (curwin -> w_cursor.lnum - 1), (linenr_T) (curwin -> w_cursor.lnum + count)) == 0) return 0;
    spaces = lalloc_clear ((long_u) count, 1);
    if (spaces == ((void *) 0)) return 0;
    for (t = 0; t < count; ++t) {
        ...
        if (insert_space && t > 0) {
            ...
            if (*curr != ')' && currsize != 0 && endcurr1 != '\011') {
                ...
                if (p_js && (endcurr1 == '.' || (vim_strchr (p_cpo, 'j') == ((void *) 0) && (endcurr1 == '?' || endcurr1 == '!')))) ++spaces[t];
            }
        }
    ...
    * cend = 0;
    for (t = count - 1;; --t) {
        cend -= currsize;
        ((__builtin_object_size ((char *) (cend), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (cend), (char *) (curr), (size_t) currsize,
          __builtin_object_size ((char *) (cend), 0)) : __inline_memmove_chk ((char *) (cend), (char *) (curr), (size_t) currsize));
        if (spaces [t] > 0) {
            cend -= spaces [t];
            copy_spaces (cend, (size_t) (spaces [t]));
        }
        mark_col_adjust (curwin -> w_cursor.lnum + t, (colnr_T) 0, (linenr_T) - t, (long) (cend - newp + spaces [t]));
        if (t == 0) break;
        curr = ml_get ((linenr_T) (curwin -> w_cursor.lnum + t - 1));
        if (insert_space && t > 1) curr = skipwhite (curr);
        currsize = (int) strlen ((char *) (curr));
    }
    ml_replace (curwin -> w_cursor.lnum, newp, 0);
    ...
    curwin -> w_cursor.col = (vim_strchr (p_cpo, 'q') != ((void *) 0) ? currsize : col);
    check_cursor_col ();
    curwin -> w_cursor.coladd = 0;
    curwin -> w_set_curswant = 1;
    theend : vim_free (spaces);
    return ret;
}

static int same_leader (lnum, leader1_len, leader1_flags, leader2_len, leader2_flags)
    linenr_T lnum;
    int leader1_len;
    ...
    char_u * leader2_flags;
{
    ...
    char_u * line1;
    char_u * line2;
    if (leader1_len == 0) return (leader2_len == 0);
    if (leader1_flags != ((void *) 0)) {
        for (p = leader1_flags; *p && *p != ':'; ++p) {
            if (*p == 'f') return (leader2_len == 0);
            if (*p == 'e') return 0;
            if (*p == 's') {
                if (*(ml_get(lnum)+leader1_len) == '\000') return 0;
                if (leader2_flags == ((void *) 0) || leader2_len == 0) return 0;
                for (p = leader2_flags; *p && *p != ':'; ++p) if (*p == 'm') return 1;
                return 0;
            }
        }
    }
    ...
    if (line1 != ((void *) 0)) {
        ...
        for (idx2 = 0; idx2 < leader2_len; ++idx2) {
            ...
            else while (((line1 [idx1]) == ' ' || (line1 [idx1]) == '\t')) ++idx1;
        }
        vim_free (line1);
    }
    ...
    int keep_cursor;
{
    ...
    if (u_save ((linenr_T) (oap -> start.lnum - 1), (linenr_T) (oap -> end.lnum + 1)) == 0) return;
    curwin -> w_cursor = oap -> start;
    if (oap -> is_VIsual) redraw_curbuf_later (20);
    curbuf -> b_op_start = oap -> start;
    if (keep_cursor) saved_cursor = oap -> cursor_start;
    format_lines (oap -> line_count, keep_cursor);
    if (oap -> end_adjusted && curwin -> w_cursor.lnum < curbuf -> b_ml.ml_line_count) ++curwin->w_cursor.lnum;
    beginline (1 | 4);
    ...
    if (oap -> is_VIsual) {
        ...
        for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) {
            if (wp -> w_old_cursor_lnum != 0) {
                if (wp -> w_old_cursor_lnum > wp -> w_old_visual_lnum) wp -> w_old_cursor_lnum += old_line_count;
                else wp -> w_old_visual_lnum += old_line_count;
            }
        }
    }
}
...
{
    if (oap -> is_VIsual) redraw_curbuf_later (20);
    if (fex_format (oap -> start.lnum, oap -> line_count, '\000') != 0) op_format (oap, 0);
}
...
int fex_format (lnum, count, c)
    ...
    int c;
{
    int use_sandbox = was_set_insecurely ((char_u *) "formatexpr", 4);
    int r;
    set_vim_var_nr (9, lnum);
    set_vim_var_nr (0, count);
    set_vim_var_char (c);
    if (use_sandbox) ++sandbox;
    r = eval_to_number (curbuf -> b_p_fex);
    if (use_sandbox) --sandbox;
    set_vim_var_string (48, ((void *) 0), -1);
    return r;
}
    ...
    int avoid_fex;
{
    ...
    if (curwin -> w_cursor.lnum > 1) is_not_par = fmt_check_par (curwin -> w_cursor.lnum - 1, &leader_len, &leader_flags, do_comments);
    else is_not_par = 1;
    next_is_not_par = fmt_check_par (curwin -> w_cursor.lnum, &next_leader_len, &next_leader_flags, do_comments);
    is_end_par = (is_not_par || next_is_not_par);
    if (!is_end_par && do_trail_white) is_end_par = !ends_in_white(curwin->w_cursor.lnum-1);
    curwin -> w_cursor.lnum --;
    for (count = line_count; count != 0 && !got_int; --count) {
        ...
        if (count == 1 || curwin -> w_cursor.lnum == curbuf -> b_ml.ml_line_count) {
            ...
            if (do_number_indent) next_is_start_par = (get_number_indent (curwin -> w_cursor.lnum + 1) > 0);
        }
        advance = 1;
        is_end_par = (is_not_par || next_is_not_par || next_is_start_par);
        if (!is_end_par && do_trail_white) is_end_par = !ends_in_white(curwin->w_cursor.lnum);
        if (is_not_par) {
            ...
            if (first_par_line && (do_second_indent || do_number_indent) && prev_is_end_par && curwin -> w_cursor.lnum < curbuf -> b_ml.ml_line_count &&
              leader_len == 0 && next_leader_len == 0) {
                if (do_second_indent && !(*ml_get(curwin->w_cursor.lnum+1) == '\000')) second_indent = get_indent_lnum (curwin -> w_cursor.lnum + 1);
                else if (do_number_indent) second_indent = get_number_indent (curwin -> w_cursor.lnum);
            }
            if (curwin -> w_cursor.lnum >= curbuf -> b_ml.ml_line_count || !same_leader(curwin->w_cursor.lnum,leader_len,leader_flags,next_leader_len,
              next_leader_flags)) is_end_par = 1;
            if (is_end_par || force_format) {
                if (need_set_indent) (void) set_indent (get_indent (), 1);
                State = 0x01;
                coladvance ((colnr_T) (0x7fffffffL));
                while (curwin -> w_cursor.col && vim_isspace (gchar_cursor ())) dec_cursor ();
                State = 0x10;
                smd_save = p_smd;
                p_smd = 0;
                insertchar ('\000', 1 + (do_comments ? 2 : 0) + (avoid_fex ? 8 : 0), second_indent);
                State = old_State;
                p_smd = smd_save;
                second_indent = -1;
            ...
            if (!is_end_par) {
                ...
                curwin -> w_cursor.lnum ++;
                curwin -> w_cursor.col = 0;
                if (line_count < 0 && u_save_cursor () == 0) break;
                (void) del_bytes ((long) next_leader_len, 0, 0);
                if (next_leader_len > 0) mark_col_adjust (curwin -> w_cursor.lnum, (colnr_T) 0, 0L, (long) -next_leader_len);
                curwin -> w_cursor.lnum --;
                if (do_join (2, 1, 0) == 0) {
                    beep_flush ();
                    break;
                ...
                first_par_line = 0;
                if (strlen ((char *) (ml_get_curline ())) > (size_t) max_len) force_format = 1;
                else force_format = 0;
            }
        }
        line_breakcheck ();
    ...
    int do_comments;
{
    ...
    char_u * ptr;
    ptr = ml_get (lnum);
    if (do_comments) *leader_len = get_leader_len (ptr, leader_flags, 0);
    else *leader_len = 0;
    if (*leader_len > 0) {
        flags = *leader_flags;
        while (*flags && *flags != ':' && *flags != 'e') ++flags;
    }
    return (*skipwhite(ptr+*leader_len) == '\000' || (*leader_len > 0 && *flags == 'e') || startPS (lnum, '\000', 0));
}
    ...
    linenr_T lnum;
{
    ...
    if (*p == '\000') return 1;
    do_comments = has_format_option ('q');
    if (fmt_check_par (lnum - 1, &leader_len, &leader_flags, do_comments)) return 1;
    if (fmt_check_par (lnum, &next_leader_len, &next_leader_flags, do_comments)) return 1;
    if (has_format_option ('w') && !ends_in_white(lnum-1)) return 1;
    if (has_format_option ('n') && (get_number_indent (lnum) > 0)) return 1;
    if (!same_leader(lnum-1,leader_len,leader_flags,next_leader_len,next_leader_flags)) return 1;
    return 0;
}
    ...
    int is_del;
{
    ...
    if (bdp -> start_vcol < oap -> start_vcol) {
        ...
        bdp -> is_short = 1;
        if (!is_del || oap -> op_type == 18) bdp -> endspaces = oap -> end_vcol - oap -> start_vcol + 1;
    }
    else {
        bdp -> startspaces = bdp -> start_vcol - oap -> start_vcol;
        if (is_del && bdp -> startspaces) bdp -> startspaces = bdp -> start_char_vcols - bdp -> startspaces;
        pend = pstart;
        bdp -> end_vcol = bdp -> start_vcol;
        if (bdp -> end_vcol > oap -> end_vcol) {
            bdp -> is_oneChar = 1;
            if (oap -> op_type == 17) bdp -> endspaces = bdp -> start_char_vcols - bdp -> startspaces;
            ...
            if (bdp -> end_vcol <= oap -> end_vcol && (!is_del || oap -> op_type == 18 || oap -> op_type == 16)) {
                bdp -> is_short = 1;
                if (oap -> op_type == 18 || virtual_op) bdp -> endspaces = oap -> end_vcol - bdp -> end_vcol + oap -> inclusive;
                else bdp -> endspaces = 0;
            }
            else if (bdp -> end_vcol > oap -> end_vcol) {
                bdp -> endspaces = bdp -> end_vcol - oap -> end_vcol - 1;
                if (!is_del && bdp -> endspaces) {
                    bdp -> endspaces = incr - bdp -> endspaces;
                    if (pend != pstart) pend = prev_pend;
                }
            }
        }
        bdp -> end_char_vcols = incr;
        if (is_del && bdp -> startspaces) pstart = prev_pstart;
    ...
    linenr_T Prenum1;
{
    ...
    ;
    col = curwin -> w_cursor.col;
    if (dohex) while (col > 0 && vim_isxdigit (ptr [col])) --col;
    if (dohex && col > 0 && (ptr [col] == 'X' || ptr [col] == 'x') && ptr [col - 1] == '0' && vim_isxdigit (ptr [col + 1])) {
        --col;
    }
    else {
        col = curwin -> w_cursor.col;
        while (ptr [col] != '\000' && !vim_isdigit(ptr[col]) && !(doalp&&((ptr[col])<0x7f&&isalpha(ptr[col])))) ++col;
        while (col > 0 && vim_isdigit (ptr [col - 1]) && !(doalp&&((ptr[col])<0x7f&&isalpha(ptr[col])))) --col;
    }
    firstdigit = ptr [col];
    ;
    if ((!((firstdigit)>='0'&&(firstdigit)<='9') && !(doalp&&((firstdigit)<0x7f&&isalpha(firstdigit)))) || u_save_cursor () != 1) {
        beep_flush ();
        return 0;
    }
    ptr = ml_get_curline ();
    ;
    if (doalp && ((firstdigit) < 0x7f && isalpha (firstdigit))) {
        if (command == 24) {
            if (((firstdigit) < 'a' ? (firstdigit) - 'A' : (firstdigit) - 'a') < Prenum1) {
                if (isupper (firstdigit)) firstdigit = 'A';
                else firstdigit = 'a';
            }
            else firstdigit -= Prenum1;
        }
        else {
            if (26 - ((firstdigit) < 'a' ? (firstdigit) - 'A' : (firstdigit) - 'a') - 1 < Prenum1) {
                if (isupper (firstdigit)) firstdigit = 'Z';
                else firstdigit = 'z';
            }
            else firstdigit += Prenum1;
        }
        ...
        subtract = 0;
        if (command == 24) subtract ^= 1;
        if (negative) subtract ^= 1;
        oldn = n;
        if (subtract) n -= (unsigned long) Prenum1;
        else n += (unsigned long) Prenum1;
        if (!hex) {
            if (subtract) {
                if (n > oldn) {
        ...
        while (todel -- > 0) {
            if (c < 0x100 && isalpha (c)) {
                if (isupper (c)) hexupper = 1;
                else hexupper = 0;
            }
            (void) del_char (0);
            c = gchar_cursor ();
        }
        buf1 = alloc ((unsigned) length + 30);
        if (buf1 == ((void *) 0)) return 0;
        ptr = buf1;
        if (negative) {
            *ptr++ = '-';
        }
        ...
        if (hex == 0) __builtin___sprintf_chk ((char *) buf2, 0, __builtin_object_size ((char *) buf2, 1 > 1), "%lu", n);
        else if (hex == '0') __builtin___sprintf_chk ((char *) buf2, 0, __builtin_object_size ((char *) buf2, 1 > 1), "%lo", n);
        else if (hex && hexupper) __builtin___sprintf_chk ((char *) buf2, 0, __builtin_object_size ((char *) buf2, 1 > 1), "%lX", n);
        else __builtin___sprintf_chk ((char *) buf2, 0, __builtin_object_size ((char *) buf2, 1 > 1), "%lx", n);
        length -= (int) strlen ((char *) (buf2));
        if (firstdigit == '0' && !(dooct&&hex==0)) while (length -- > 0) *ptr++ = '0';
        * ptr = '\000';
        ((__builtin_object_size ((char *) (buf1), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buf1), (char *) (buf2), __builtin_object_size ((char *
          ) (buf1), 1 > 1)) : __inline_strcat_chk ((char *) (buf1), (char *) (buf2)));
        ins_str (buf1);
        vim_free (buf1);
    }
    --curwin->w_cursor.col;
    ...
    int force;
{
    ...
    if (!((*str) < 0x7f && isalnum (*str)) && *str != '-') {
        if (viminfo_error ("E577: ", ((char *) ("Illegal register name")), virp -> vir_line)) return 1;
        do_it = 0;
    }
    get_yank_register (*str++, 0);
    if (!force && y_current -> y_array != ((void *) 0)) do_it = 0;
    if (*str == '@') {
        if (force || execreg_lastc == '\000') execreg_lastc = str [-1];
    }
    size = 0;
    limit = 100;
    if (do_it) {
        if (set_prev) y_previous = y_current;
        vim_free (y_current -> y_array);
        array = y_current -> y_array = (char_u * *) alloc ((unsigned) (limit * sizeof (char_u *)));
        str = skipwhite (skiptowhite (str));
        if (strncmp ((char *) (str), (char *) ("CHAR"), (size_t) (4)) == 0) y_current -> y_type = 0;
        else if (strncmp ((char *) (str), (char *) ("BLOCK"), (size_t) (5)) == 0) y_current -> y_type = 2;
        else y_current -> y_type = 1;
        str = skipwhite (skiptowhite (str));
        y_current -> y_width = getdigits (&str);
    }
    while (!(eof=viminfo_readline(virp)) && (virp -> vir_line [0] == '\011' || virp -> vir_line [0] == '<')) {
        if (do_it) {
            if (size >= limit) {
                y_current -> y_array = (char_u * *) alloc ((unsigned) (limit * 2 * sizeof (char_u *)));
                for (i = 0; i < limit; i ++) y_current -> y_array [i] = array [i];
                vim_free (array);
                limit *= 2;
                array = y_current -> y_array;
            }
            str = viminfo_readstring (virp, 1, 1);
            if (str != ((void *) 0)) array [size ++] = str;
            else do_it = 0;
        }
    }
    if (do_it) {
        if (size == 0) {
            ...
            for (i = 0; i < size; i ++) y_current -> y_array [i] = array [i];
            vim_free (array);
        }
    ...
    FILE * fp;
{
    ...
    if (max_num_lines < 0) max_num_lines = get_viminfo_parameter ('"');
    if (max_num_lines == 0) return;
    max_kbyte = get_viminfo_parameter ('s');
    if (max_kbyte == 0) return;
    for (i = 0; i < (37 + 1); i ++) {
        if (y_regs [i].y_array == ((void *) 0)) continue;
        if (i == 37 || i == 37) continue;
        num_lines = y_regs [i].y_size;
        if (num_lines == 0 || (num_lines == 1 && y_regs [i].y_type == 0 && *y_regs[i].y_array[0] == '\000')) continue;
        if (max_kbyte > 0) {
            len = 0;
            for (j = 0; j < num_lines; j ++) len += (long) strlen ((char *) (y_regs [i].y_array [j])) + 1L;
            if (len > (long) max_kbyte * 1024L) continue;
        }
        ...
        case 2 :
            ...
            break;
        default :
            __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("E574: Unknown register type %d")), y_regs [
              i].y_type);
            emsg (IObuff);
            type = (char_u *) "LINE";
            break;
        }
        if (y_previous == &y_regs[i]) fprintf (fp, "\"");
        c = get_register_name (i);
        fprintf (fp, "\"%c", c);
        if (c == execreg_lastc) fprintf (fp, "@");
        fprintf (fp, "\t%s\t%d\n", type, (int) y_regs [i].y_width);
        if (max_num_lines > 0 && num_lines > max_num_lines) num_lines = max_num_lines;
...
void clip_free_selection (cbd)
    VimClipboard * cbd;
{
    struct yankreg * y_ptr = y_current;
    if (cbd == &clip_star) y_current = &y_regs[37];
    else y_current = &y_regs[37];
    free_yank_all ();
    y_current -> y_size = 0;
    y_current = y_ptr;
}

void clip_get_selection (cbd)
    VimClipboard * cbd;
{
    struct yankreg * old_y_previous, * old_y_current;
    pos_T old_cursor;
    ...
    cmdarg_T ca;
    if (cbd -> owned) {
        if ((cbd == &clip_star && y_regs [37].y_array != ((void *) 0)) || (cbd == &clip_star && y_regs [37].y_array != ((void *) 0))) return;
        old_y_previous = y_previous;
        old_y_current = y_current;
...
void clip_yank_selection (type, str, len, cbd)
    int type;
    char_u * str;
    long len;
    VimClipboard * cbd;
{
    ...
    if (cbd == &clip_star) y_ptr = &y_regs[37];
    else y_ptr = &y_regs[37];
    clip_free_selection (cbd);
    str_to_reg (y_ptr, type, str, len, 0L);
}

int clip_convert_selection (str, len, cbd)
    char_u * * str;
    long_u * len;
    VimClipboard * cbd;
{
    ...
    * str = ((void *) 0);
    * len = 0;
    if (y_ptr -> y_array == ((void *) 0)) return -1;
    for (i = 0; i < y_ptr -> y_size; i ++) *len += (long_u) strlen ((char *) (y_ptr -> y_array [i])) + eolsize;
    if (y_ptr -> y_type == 0 && *len >= eolsize) *len -= eolsize;
    p = *str = lalloc (*len + 1, 1);
    if (p == ((void *) 0)) return -1;
    lnum = 0;
    for (i = 0, j = 0; i < (int) *len; i ++, j ++) {
        if (y_ptr -> y_array [lnum] [j] == '\n') p [i] = '\000';
        else if (y_ptr -> y_array [lnum] [j] == '\000') {
            p [i] = '\n';
            lnum ++;
            j = -1;
        }
        else p [i] = y_ptr -> y_array [lnum] [j];
    }
    return y_ptr -> y_type;
}

static void may_set_selection () {
    if (y_current == &(y_regs[37]) && clip_star.available) {
        clip_own_selection (&clip_star);
        clip_gen_set_selection (&clip_star);
    }
    else if (y_current == &(y_regs[37]) && clip_star.available) {
        clip_own_selection (&clip_star);
        clip_gen_set_selection (&clip_star);
    }
}
    ...
    long * reglen;
{
    ...
    get_yank_register (regname, 0);
    if (y_current -> y_array != ((void *) 0)) {
        if (reglen != ((void *) 0) && y_current -> y_type == 2) *reglen = y_current -> y_width;
    ...
    int expr_src;
{
    ...
    if (regname == '=') {
        if (allowexpr) {
            if (expr_src) return get_expr_line_src ();
            return get_expr_line ();
        }
        return ((void *) 0);
    }
    if (regname == '@') regname = '"';
    if (regname != '\000' && !valid_yank_reg(regname,0)) return ((void *) 0);
    regname = may_get_selection (regname);
    if (get_spec_reg (regname, &retval, &allocated, 0)) {
        if (retval == ((void *) 0)) return ((void *) 0);
        if (!allocated) retval = vim_strsave (retval);
        return retval;
    }
    get_yank_register (regname, 0);
    if (y_current -> y_array == ((void *) 0)) return ((void *) 0);
    len = 0;
    for (i = 0; i < y_current -> y_size; ++i) {
        len += (long) strlen ((char *) (y_current -> y_array [i]));
        if (y_current -> y_type == 1 || i < y_current -> y_size - 1) ++len;
    }
    retval = lalloc (len + 1, 1);
    if (retval != ((void *) 0)) {
        len = 0;
        for (i = 0; i < y_current -> y_size; ++i) {
            ((__builtin_object_size ((char *) (retval + len), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (retval + len), (char *) (y_current ->
              y_array [i]), __builtin_object_size ((char *) (retval + len), 1 > 1)) : __inline_strcpy_chk ((char *) (retval + len), (char *) (y_current ->
              y_array [i])));
            len += (long) strlen ((char *) (retval + len));
            if (y_current -> y_type == 1 || i < y_current -> y_size - 1) retval [len ++] = '\n';
        }
        retval [len] = '\000';
    }
    return retval;
...
void write_reg_contents (name, str, maxlen, must_append)
    ...
    int must_append;
{
    write_reg_contents_ex (name, str, maxlen, must_append, 0xff, 0L);
}
    ...
    long block_len;
{
    ...
    if (!y_append && !must_append) free_yank_all ();
    if (yank_type == 0xff) yank_type = ((len > 0 && (str [len - 1] == '\n' || str [len - 1] == '\r')) ? 1 : 0);
    str_to_reg (y_current, yank_type, str, len, block_len);
    may_set_selection ();
    if (name != '"') y_previous = old_y_previous;
    y_current = old_y_current;
}

static void str_to_reg (y_ptr, type, str, len, blocklen)
    struct yankreg * y_ptr;
    int type;
    char_u * str;
    long len;
    long blocklen;
{
    ...
    char_u * * pp;
    long maxlen;
    if (y_ptr -> y_array == ((void *) 0)) y_ptr -> y_size = 0;
    newlines = 0;
    ...
    pp = (char_u * *) lalloc_clear ((y_ptr -> y_size + newlines) * sizeof (char_u *), 1);
    if (pp == ((void *) 0)) return;
    for (lnum = 0; lnum < y_ptr -> y_size; ++lnum) pp [lnum] = y_ptr -> y_array [lnum];
    vim_free (y_ptr -> y_array);
    y_ptr -> y_array = pp;
    maxlen = 0;
    for (start = 0; start < len + extraline; start += i + 1) {
        for (i = start; i < len; ++i) if (str [i] == '\n') break;
        i -= start;
        if (i > maxlen) maxlen = i;
        if (append) {
            --lnum;
            extra = (int) strlen ((char *) (y_ptr -> y_array [lnum]));
        }
        else extra = 0;
        s = alloc ((unsigned) (i + extra + 1));
        if (s == ((void *) 0)) break;
        if (extra) ((__builtin_object_size ((char *) (s), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (s), (char *) (y_ptr -> y_array [lnum]), (
          size_t) extra, __builtin_object_size ((char *) (s), 0)) : __inline_memmove_chk ((char *) (s), (char *) (y_ptr -> y_array [lnum]), (size_t) extra));
        if (append) vim_free (y_ptr -> y_array [lnum]);
        if (i) ((__builtin_object_size ((char *) (s + extra), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (s + extra), (char *) (str + start), (
          size_t) i, __builtin_object_size ((char *) (s + extra), 0)) : __inline_memmove_chk ((char *) (s + extra), (char *) (str + start), (size_t) i));
        extra += i;
        s [extra] = '\000';
    ...
    y_ptr -> y_type = type;
    y_ptr -> y_size = lnum;
    if (type == 2) y_ptr -> y_width = (blocklen < 0 ? maxlen - 1 : blocklen);
    else y_ptr -> y_width = 0;
}

void clear_oparg (oap)
    oparg_T * oap;
{
    ((__builtin_object_size ((oap), 0) != (size_t) - 1) ? __builtin___memset_chk ((oap), (0), (sizeof (oparg_T)), __builtin_object_size ((oap), 0)) :
      __inline_memset_chk ((oap), (0), (sizeof (oparg_T))));
}
    ...
    int eol_size;
{
    ...
    for (i = 0; line [i] && i < limit;) {
        ...
        else if (!vim_isspace(line[i])) is_word = 1;
        ++chars;
        ++i;
    }
    if (is_word) words ++;
    *wc += words;
    if (line [i] == '\000' && i < limit) {
        i += eol_size;
        chars += eol_size;
    }
    *cc += chars;
...
void cursor_pos_info () {
    ...
    struct block_def bd;
    if (curbuf -> b_ml.ml_flags & 1) {
        msg ((char_u *) (((char *) (no_lines_msg))));
    }
    else {
        if (get_fileformat (curbuf) == 1) eol_size = 2;
        else eol_size = 1;
        if (VIsual_active) {
            if ((((VIsual).lnum != (curwin -> w_cursor).lnum) ? (VIsual).lnum < (curwin -> w_cursor).lnum : (VIsual).col != (curwin -> w_cursor).col ? (VIsual)
              .col < (curwin -> w_cursor).col : (VIsual).coladd < (curwin -> w_cursor).coladd)) {
                min_pos = VIsual;
            ...
            if (*p_sel == 'e' && max_pos.col > 0) --max_pos.col;
            if (VIsual_mode == 22) {
                ...
                p_sbr = saved_sbr;
                if (curwin -> w_curswant == (0x7fffffffL)) oparg.end_vcol = (0x7fffffffL);
        ...
        for (lnum = 1; lnum <= curbuf -> b_ml.ml_line_count; ++lnum) {
            ...
            if (VIsual_active && lnum >= min_pos.lnum && lnum <= max_pos.lnum) {
                ...
                case 'v' :
                    {
                        ...
                        colnr_T end_col = (lnum == max_pos.lnum) ? max_pos.col - start_col + 1 : (0x7fffffffL);
                ...
                if (s != ((void *) 0)) {
                    ...
                    if (lnum == curbuf -> b_ml.ml_line_count && !curbuf->b_p_eol && curbuf -> b_p_bin && (long) strlen ((char *) (s)) < len) byte_count_cursor
                      -= eol_size;
                }
            }
            else {
                if (lnum == curwin -> w_cursor.lnum) {
                    ...
                    byte_count_cursor = byte_count + line_count_info (ml_get (lnum), &word_count_cursor, &char_count_cursor, (long) (curwin -> w_cursor.col + 1
                      ), eol_size);
                }
            }
            byte_count += line_count_info (ml_get (lnum), &word_count, &char_count, (long) (0x7fffffffL), eol_size);
        }
        if (!curbuf->b_p_eol && curbuf -> b_p_bin) byte_count -= eol_size;
        if (VIsual_active) {
            if (VIsual_mode == 22 && curwin -> w_curswant < (0x7fffffffL)) {
                getvcols (curwin, &min_pos, &max_pos, &min_pos.col, &max_pos.col);
                vim_snprintf ((char *) buf1, sizeof (buf1), ((char *) ("%ld Cols; ")), (long) (oparg.end_vcol - oparg.start_vcol + 1));
            }
            else buf1 [0] = '\000';
            if (char_count_cursor == byte_count_cursor && char_count == byte_count) vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) (
              "Selected %s%ld of %ld Lines; %ld of %ld Words; %ld of %ld Bytes")), buf1, line_count_selected, (long) curbuf -> b_ml.ml_line_count,
              word_count_cursor, word_count, byte_count_cursor, byte_count);
            else vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) ("Selected %s%ld of %ld Lines; %ld of %ld Words; %ld of %ld Chars; %ld of %ld Bytes")),
              buf1, line_count_selected, (long) curbuf -> b_ml.ml_line_count, word_count_cursor, word_count, char_count_cursor, char_count, byte_count_cursor,
              byte_count);
        }
        else {
            p = ml_get_curline ();
            ...
            if (char_count_cursor == byte_count_cursor && char_count == byte_count) vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) (
              "Col %s of %s; Line %ld of %ld; Word %ld of %ld; Byte %ld of %ld")), (char *) buf1, (char *) buf2, (long) curwin -> w_cursor.lnum, (long) curbuf
              -> b_ml.ml_line_count, word_count_cursor, word_count, byte_count_cursor, byte_count);
            else vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) ("Col %s of %s; Line %ld of %ld; Word %ld of %ld; Char %ld of %ld; Byte %ld of %ld")), (

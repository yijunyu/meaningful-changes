...
# 20 "getchar.c" 2
# 43 "getchar.c"
static struct buffheader redobuff = {{((void *)0), {'\000'}}, ((void *)0), 0, 0};
static struct buffheader old_redobuff = {{((void *)0), {'\000'}}, ((void *)0), 0, 0};

static struct buffheader save_redobuff = {{((void *)0), {'\000'}}, ((void *)0), 0, 0};
static struct buffheader save_old_redobuff = {{((void *)0), {'\000'}}, ((void *)0), 0, 0};

static struct buffheader recordbuff = {{((void *)0), {'\000'}}, ((void *)0), 0, 0};
    ...
    int dozero;
{
    ...
    for (bp = buffer->bh_first.b_next; bp != ((void *)0); bp = bp->b_next)
 count += (long_u)strlen((char *)(bp->b_str));
    ...
    long slen;
{
 ...
 ((__builtin_object_size ((char *)(buf->bh_first.b_next->b_str), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(buf->bh_first.b_next->b_str), (char *)(buf->bh_first.b_next->b_str + buf->bh_index), strlen((char *)(buf->bh_first.b_next->b_str + buf->bh_index)) + 1, __builtin_object_size ((char *)(buf->bh_first.b_next->b_str), 0)) : __inline_memmove_chk ((char *)(buf->bh_first.b_next->b_str), (char *)(buf->bh_first.b_next->b_str + buf->bh_index), strlen((char *)(buf->bh_first.b_next->b_str + buf->bh_index)) + 1));
    ...
    int silent;
{
 ...
 ((__builtin_object_size ((char *)(typebuf.tb_buf + typebuf.tb_off), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(typebuf.tb_buf + typebuf.tb_off), (char *)(str), (size_t)addlen, __builtin_object_size ((char *)(typebuf.tb_buf + typebuf.tb_off), 0)) : __inline_memmove_chk ((char *)(typebuf.tb_buf + typebuf.tb_off), (char *)(str), (size_t)addlen));
    }
 ...
 ((__builtin_object_size ((char *)(s1 + newoff), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s1 + newoff), (char *)(typebuf.tb_buf + typebuf.tb_off), (size_t)offset, __builtin_object_size ((char *)(s1 + newoff), 0)) : __inline_memmove_chk ((char *)(s1 + newoff), (char *)(typebuf.tb_buf + typebuf.tb_off), (size_t)offset));


 ((__builtin_object_size ((char *)(s1 + newoff + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s1 + newoff + offset), (char *)(str), (size_t)addlen, __builtin_object_size ((char *)(s1 + newoff + offset), 0)) : __inline_memmove_chk ((char *)(s1 + newoff + offset), (char *)(str), (size_t)addlen));


 ((__builtin_object_size ((char *)(s1 + newoff + offset + addlen), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s1 + newoff + offset + addlen), (char *)(typebuf.tb_buf + typebuf.tb_off + offset), (size_t)(typebuf.tb_len - offset + 1), __builtin_object_size ((char *)(s1 + newoff + offset + addlen), 0)) : __inline_memmove_chk ((char *)(s1 + newoff + offset + addlen), (char *)(typebuf.tb_buf + typebuf.tb_off + offset), (size_t)(typebuf.tb_len - offset + 1)));
 ...
 ((__builtin_object_size ((char *)(s2 + newoff), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s2 + newoff), (char *)(typebuf.tb_noremap + typebuf.tb_off), (size_t)offset, __builtin_object_size ((char *)(s2 + newoff), 0)) : __inline_memmove_chk ((char *)(s2 + newoff), (char *)(typebuf.tb_noremap + typebuf.tb_off), (size_t)offset));

 ((__builtin_object_size ((char *)(s2 + newoff + offset + addlen), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s2 + newoff + offset + addlen), (char *)(typebuf.tb_noremap + typebuf.tb_off + offset), (size_t)(typebuf.tb_len - offset), __builtin_object_size ((char *)(s2 + newoff + offset + addlen), 0)) : __inline_memmove_chk ((char *)(s2 + newoff + offset + addlen), (char *)(typebuf.tb_noremap + typebuf.tb_off + offset), (size_t)(typebuf.tb_len - offset)));
    ...
    int offset;
{
 ...
 {
     ((__builtin_object_size ((char *)(typebuf.tb_buf + 50), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(typebuf.tb_buf + 50), (char *)(typebuf.tb_buf + typebuf.tb_off), (size_t)offset, __builtin_object_size ((char *)(typebuf.tb_buf + 50), 0)) : __inline_memmove_chk ((char *)(typebuf.tb_buf + 50), (char *)(typebuf.tb_buf + typebuf.tb_off), (size_t)offset));

     ((__builtin_object_size ((char *)(typebuf.tb_noremap + 50), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(typebuf.tb_noremap + 50), (char *)(typebuf.tb_noremap + typebuf.tb_off), (size_t)offset, __builtin_object_size ((char *)(typebuf.tb_noremap + 50), 0)) : __inline_memmove_chk ((char *)(typebuf.tb_noremap + 50), (char *)(typebuf.tb_noremap + typebuf.tb_off), (size_t)offset));

     typebuf.tb_off = 50;
 }

 ((__builtin_object_size ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), (char *)(typebuf.tb_buf + i + len), (size_t)(typebuf.tb_len - offset + 1), __builtin_object_size ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), 0)) : __inline_memmove_chk ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), (char *)(typebuf.tb_buf + i + len), (size_t)(typebuf.tb_len - offset + 1)));



 ((__builtin_object_size ((char *)(typebuf.tb_noremap + typebuf.tb_off + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(typebuf.tb_noremap + typebuf.tb_off + offset), (char *)(typebuf.tb_noremap + i + len), (size_t)(typebuf.tb_len - offset), __builtin_object_size ((char *)(typebuf.tb_noremap + typebuf.tb_off + offset), 0)) : __inline_memmove_chk ((char *)(typebuf.tb_noremap + typebuf.tb_off + offset), (char *)(typebuf.tb_noremap + i + len), (size_t)(typebuf.tb_len - offset)));
...
{
    if (typebuf.tb_buf == typebuf_init)
 emsg2((char_u *)(((char *)(e_intern2))), (char_u *)("Free typebuf 1"));
    else
 vim_free(typebuf.tb_buf);
    if (typebuf.tb_noremap == noremapbuf_init)
 emsg2((char_u *)(((char *)(e_intern2))), (char_u *)("Free typebuf 2"));
    else
 vim_free(typebuf.tb_noremap);
}
...
# 3035 "getchar.c"
    ...
    {
# 3056 "getchar.c"
 if (p[0] == '\000' || (p[0] == (0x80) && !script


      && (i < 2 || p[1] != 253 || p[2] != (int)KE_CURSORHOLD)
 ...
 {
     ((__builtin_object_size ((char *)(p + 3), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p + 3), (char *)(p + 1), (size_t)i, __builtin_object_size ((char *)(p + 3), 0)) : __inline_memmove_chk ((char *)(p + 3), (char *)(p + 1), (size_t)i));
...
# 3354 "getchar.c"
 ...
 for (hash = 0; hash < 256 && !got_int; ++hash)
 {
  ...
  {
      if (abbrev)
   emsg2((char_u *)(((char *)("E224: global abbreviation already exists for %s"))), (char_u *)(mp->m_keys));

      else
   emsg2((char_u *)(((char *)("E225: global mapping already exists for %s"))), (char_u *)(mp->m_keys));
...
# 3466 "getchar.c"
 ...
 for (hash = 0; hash < 256 && !got_int; ++hash)
 {
  ...
  else
  {
   ...
   {
       if (abbrev)
    emsg2((char_u *)(((char *)("E226: abbreviation already exists for %s"))), (char_u *)(p));

       else
    emsg2((char_u *)(((char *)("E227: mapping already exists for %s"))), (char_u *)(p));
       retval = 5;
       goto theend;
   }
   else
 ...
 {
     if (abbrev)
  msg((char_u *)(((char *)("No abbreviation found"))));
     else
  msg((char_u *)(((char *)("No mapping found"))));
 }
 goto theend;
    }
...
validate_maphash()
{
    if (!maphash_valid)
    {
 ((__builtin_object_size ((maphash), 0) != (size_t) -1) ? __builtin___memset_chk ((maphash), (0), (sizeof(maphash)), __builtin_object_size ((maphash), 0)) : __inline_memset_chk ((maphash), (0), (sizeof(maphash))));
 maphash_valid = 1;
    }
}
    ...
    int local;
{
 ...
 if (got_int)
    ...
    if ((mp->m_mode & (0x10 + 0x08)) == 0x10 + 0x08)
 msg_putchar('!');
    else if (mp->m_mode & 0x10)
 msg_putchar('i');
    else if (mp->m_mode & 0x20)
 msg_putchar('l');
    else if (mp->m_mode & 0x08)
 msg_putchar('c');
    else if ((mp->m_mode & (0x01 + 0x02 + 0x1000 + 0x04))
...
# 4349 "getchar.c"
  ...
  (mp = mp->m_next))
 {
     ...
     if ( (mp->m_mode & State)
      && mp->m_keylen == len
      && !strncmp((char *)(mp->m_keys), (char *)(ptr), (size_t)((size_t)len)))
  break;
 }
 if (mp != ((void *)0))
 {

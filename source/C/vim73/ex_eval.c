    ...
    char_u *cmdname;
{
 ...
 if (cmdname != ((void *)0) && *cmdname != '\000')
 {
     ...
     excp->value = vim_strnsave((char_u *)"Vim(",
        4 + cmdlen + 2 + (int)strlen((char *)(mesg)));
     if (excp->value == ((void *)0))
  goto nomem;
     ((__builtin_object_size ((char *)(&excp->value[4]), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(&excp->value[4]), (char *)(cmdname), __builtin_object_size ((char *)(&excp->value[4]), 1 > 1)) : __inline_strcpy_chk ((char *)(&excp->value[4]), (char *)(cmdname)));
     ((__builtin_object_size ((char *)(&excp->value[4 + cmdlen]), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(&excp->value[4 + cmdlen]), (char *)("):"), __builtin_object_size ((char *)(&excp->value[4 + cmdlen]), 1 > 1)) : __inline_strcpy_chk ((char *)(&excp->value[4 + cmdlen]), (char *)("):")));
 ...
 for (p = mesg; ; p++)
 {
   ...
   && (p[2] == ':'
    ...
    && (p[3] == ':'
     ...
     {
  if (*p == '\000' || p == mesg)
      ((__builtin_object_size ((char *)(val), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(val), (char *)(mesg), __builtin_object_size ((char *)(val), 1 > 1)) : __inline_strcat_chk ((char *)(val), (char *)(mesg)));
  else
  {
   ...
   continue;
      ...
      ((__builtin_object_size ((char *)(val), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(val), (char *)(p), __builtin_object_size ((char *)(val), 1 > 1)) : __inline_strcat_chk ((char *)(val), (char *)(p)));
      p[-2] = '\000';
      __builtin___sprintf_chk ((char *)(val + strlen((char *)(p))), 0, __builtin_object_size ((char *)(val + strlen((char *)(p))), 1 > 1), " (%s)", &mesg[1]);
      p[-2] = '"';
  }
  break;
     }
    ...
    int was_finished;
{
 ...
 if (debug_break_level > 0 || *p_vfile == '\000')
     msg_scroll = 1;
 smsg(was_finished
      ? (char_u *)((char *)("Exception finished: %s"))
      : (char_u *)((char *)("Exception discarded: %s")),
  excp->value);
 msg_puts((char_u *)"\n");
 if (debug_break_level > 0 || *p_vfile == '\000')
     cmdline_row = msg_row;
 ...
 if (debug_break_level > 0)
     ...
     verbose_leave();
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff), (char *)(saved_IObuff), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff), (char *)(saved_IObuff)));
    ...
    except_T *excp;
{
 ...
 if (excp->throw_lnum != 0)
     vim_snprintf((char *)IObuff, (1024+1), ((char *)("%s, line %ld")),
    ...
    void *value;
{
 ...
 default:
     ...
     {
  vim_snprintf((char *)IObuff, (1024+1),
      (char *)mesg, ((char *)("Exception")));
  mesg = vim_strnsave(IObuff, (int)strlen((char *)(IObuff)) + 4);
  ((__builtin_object_size ((char *)(mesg), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(mesg), (char *)(": %s"), __builtin_object_size ((char *)(mesg), 1 > 1)) : __inline_strcat_chk ((char *)(mesg), (char *)(": %s")));
    ...
    exarg_T *eap;
{
 ...
 if (!(fl & csf))
 {
     ...
     if (fl & 0x0008)
  eap->errmsg = (char_u *)((char *)("E732: Using :endfor with :while"));
     else if (fl & 0x0010)
  eap->errmsg = (char_u *)((char *)("E733: Using :endwhile with :for"));
 }
 if (!(fl & (0x0008 | 0x0010)))
 {
     if (!(fl & 0x0100))
    ...
    cleanup_T *csp;
{
 ...
 if (pending & 4)
     ...
     discard_exception((except_T *)csp->exception, 0);
 else

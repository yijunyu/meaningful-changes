...
# 321 "fileio.c"
      ...
      )
 {
  ...
  filemess(curbuf, fname, (char_u *)((char *)("is a directory")), 0);
     else
  filemess(curbuf, fname, (char_u *)((char *)("is not a file")), 0);
     msg_end();
     msg_scroll = msg_save;
     return 0;
 }
...
# 619 "fileio.c"
     ...
     )
  {
   ...
   filemess(curbuf, sfname, (char_u *)((char *)("[New File]")), 0);
      else
   filemess(curbuf, sfname,
        (char_u *)((char *)("[New DIRECTORY]")), 0);
...
# 676 "fileio.c"
  ...
  else
  {
      filemess(curbuf, sfname, (char_u *)(
       ...
       ((*__error()) == 27) ? ((char *)("[File too big]")) :


       ((*__error()) == 84) ? ((char *)("[File too big]")) :
...
# 822 "fileio.c"
 if (!read_stdin && (curbuf != old_curbuf
  || (using_b_ffname && (old_b_ffname != curbuf->b_ffname))
  || (using_b_fname && (old_b_fname != curbuf->b_fname))
  || (fd = open(((char *)fname), (0x0000 | 0), (0))) < 0))
 {
     --no_wait_return;
     msg_scroll = msg_save;
     if (fd < 0)
  emsg((char_u *)(((char *)("E200: *ReadPre autocommands made the file unreadable"))));
     else
  emsg((char_u *)(((char *)("E201: *ReadPre autocommands must not change current buffer"))));
     curbuf->b_p_ro = 1;
     return 0;
 }
    }
...
# 1234 "fileio.c"
 {
  ...
  if (linerest)
      ((__builtin_object_size ((char *)(new_buffer), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(new_buffer), (char *)(ptr - linerest), (size_t)linerest, __builtin_object_size ((char *)(new_buffer), 0)) : __inline_memmove_chk ((char *)(new_buffer), (char *)(ptr - linerest), (size_t)linerest));
  vim_free(buffer);
  buffer = new_buffer;
  ptr = buffer + linerest;
  line_start = buffer;
...
# 2355 "fileio.c"
 ...
 if (!filtering && !(flags & 0x10))
 {
     ...
     {
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("[fifo/socket]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("[fifo/socket]")))));
  c = 1;
     }
# 2459 "fileio.c"
     if (curbuf->b_p_ro)
  ...
  c = 1;
     ...
     if (ff_error == 1)
     {
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("[CR missing]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("[CR missing]")))));
  c = 1;
     }
     if (split)
     {
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("[long lines split]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("[long lines split]")))));
  c = 1;
     }
# 2492 "fileio.c"
     if (cryptkey != ((void *)0))
     {
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("[crypted]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("[crypted]")))));
  c = 1;
     }
# 2513 "fileio.c"
  if (error)
     {
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("[READ ERRORS]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("[READ ERRORS]")))));
  c = 1;
     }
...
prep_exarg(eap, buf)
    ...
    buf_T *buf;
{
    eap->cmd = alloc((unsigned)(strlen((char *)(buf->b_p_ff))
    ...
    int len;
{
    ...
    {
 if (len < (12 + crypt_salt_len[i] + crypt_seed_len[i]))
     continue;
 if (memcmp(ptr, crypt_magic[i], 12) == 0)
     return i;
    }

    i = (int)strlen((char *)(crypt_magic_head));
    if (len >= i && memcmp(ptr, crypt_magic_head, i) == 0)
 emsg((char_u *)(((char *)("E821: File is encrypted with unknown method"))));
 ...
 if (cryptkey != ((void *)0))
 {
  ...
  bf_ofb_init(ptr + 12 + salt_len, seed_len);
     ...
     *sizep -= 12 + salt_len + seed_len;
     ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ptr), (char *)(ptr + 12 + salt_len + seed_len), (size_t)*sizep, __builtin_object_size ((char *)(ptr), 0)) : __inline_memmove_chk ((char *)(ptr), (char *)(ptr + 12 + salt_len + seed_len), (size_t)*sizep));

 }
    }


    else if (newfile && *curbuf->b_p_key != '\000' && !starting)
 set_option_value((char_u *)"key", 0L, (char_u *)"", 4);
...
# 3252 "fileio.c"
 ...
 sfname = fname;
    ...
    if (buf->b_ffname != ((void *)0) && strcasecmp((char *)(((ffname))), (char *)(((buf->b_ffname)))) == 0)
 overwriting = 1;
    else
 overwriting = 0;
           ...
           )
 {
     ...
     msg_scroll = msg_save;
     if (nofile_err)
  emsg((char_u *)(((char *)("E676: No matching autocommands for acwrite buffer"))));
  ...
  emsg((char_u *)(((char *)("E203: Autocommands deleted or unloaded buffer to be written"))));
     return 0;
 }
...
# 3720 "fileio.c"
  ...
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff), (char *)(fname), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff), (char *)(fname)));
  for (i = 4913; ; i += 123)
  {
...
# 3998 "fileio.c"
   ...
   if (close(bfd) < 0 && errmsg == ((void *)0))
       errmsg = (char_u *)((char *)("E507: Close error for backup file (add ! to override)"));
   if (write_info.bw_len < 0)
       errmsg = (char_u *)((char *)("E508: Can't read file for backup (add ! to override)"));
  ...
  errmsg = (char_u *)((char *)("E509: Cannot create backup file (add ! to override)"));
...
# 4215 "fileio.c"
    wfname = fname;
# 4347 "fileio.c"
    while ((fd = open(((char *)wfname), (0x0001 | 0 | (append ? (forceit ? (0x0008 | 0x0200) : 0x0008) : (0x0200 | 0x0400))), (perm < 0 ? 0666 : (perm & 0777)))) < 0)
...
# 4779 "fileio.c"
  if (got_int)
      ...
      errmsg = (char_u *)((char *)("E514: write error (file system full?)"));
 }
# 4794 "fileio.c"
 if (backup != ((void *)0))
 {
  ...
  if ((fd = open(((char *)backup), (0x0000 | 0), (0))) >= 0)
  {
   ...
   while ((write_info.bw_len = read((fd), (char *)(smallbuf), (size_t) (256))) > 0)
...
# 4867 "fileio.c"
 if (device)
 {
     ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("[Device]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("[Device]")))));
     c = 1;
 }
 else if (newfile)
 {
     ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('n') ? ((char *)("[New]")) : ((char *)("[New File]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('n') ? ((char *)("[New]")) : ((char *)("[New File]")))));
     c = 1;
 }
 if (no_eol)
 {
 ...
 {
     if (append)
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('w') ? ((char *)(" [a]")) : ((char *)(" appended"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('w') ? ((char *)(" [a]")) : ((char *)(" appended")))));
     else
  ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('w') ? ((char *)(" [w]")) : ((char *)(" written"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('w') ? ((char *)(" [w]")) : ((char *)(" written")))));
 }
 ...
 if (backup != ((void *)0))
 {
     ...
     if (org == ((void *)0))
  emsg((char_u *)(((char *)("E205: Patchmode: can't save original file"))));
 ...
 else
 {
     ...
     if (org == ((void *)0)
      || (empty_fd = open((org), (0x0200 | 0 | 0x0800 | 0x0100), (perm < 0 ? 0666 : (perm & 0777)))) < 0)


       emsg((char_u *)(((char *)("E206: patchmode: can't touch empty original file"))));
     else
       close(empty_fd);
 }
 if (org != ((void *)0))
 {
    ...
    if (!p_bk && backup != ((void *)0) && unlink((char *)(backup)) != 0)
 emsg((char_u *)(((char *)("E207: Can't delete backup file"))));
...
# 5026 "fileio.c"
 ...
 if (errnum != ((void *)0))
 {
     ((__builtin_object_size ((char *)((IObuff + numlen)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((IObuff + numlen)), (char *)((IObuff)), strlen((char *)(IObuff)) + 1, __builtin_object_size ((char *)((IObuff + numlen)), 0)) : __inline_memmove_chk ((char *)((IObuff + numlen)), (char *)((IObuff)), strlen((char *)(IObuff)) + 1));
     ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(IObuff), (char *)(errnum), (size_t)numlen, __builtin_object_size ((char *)(IObuff), 0)) : __inline_memmove_chk ((char *)(IObuff), (char *)(errnum), (size_t)numlen));
 }
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(errmsg), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(errmsg)));
 emsg(IObuff);
 if (errmsg_allocated)
     vim_free(errmsg);
    ...
    int eol_type;
{
    ...
    if (eol_type == 1)
    {
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('x') ? ((char *)("[dos]")) : ((char *)("[dos format]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('x') ? ((char *)("[dos]")) : ((char *)("[dos format]")))));
 return 1;
    }
    ...
    if (eol_type == 2)
    {
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('x') ? ((char *)("[mac]")) : ((char *)("[mac format]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('x') ? ((char *)("[mac]")) : ((char *)("[mac format]")))));
 return 1;
    }
# 5234 "fileio.c"
    return 0;
 ...
 *p++ = ' ';
    if (shortmess('l'))
 __builtin___sprintf_chk ((char *)p, 0, __builtin_object_size ((char *)p, 1 > 1), "%ldL, %ldC", lnum, (long)nchars);
    ...
    {
 if (lnum == 1)
     ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p), (char *)(((char *)("1 line, "))), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcpy_chk ((char *)(p), (char *)(((char *)("1 line, ")))));
 else
     __builtin___sprintf_chk ((char *)p, 0, __builtin_object_size ((char *)p, 1 > 1), ((char *)("%ld lines, ")), lnum);
 p += strlen((char *)(p));
 if (nchars == 1)
     ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p), (char *)(((char *)("1 character"))), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcpy_chk ((char *)(p), (char *)(((char *)("1 character")))));
 else
     __builtin___sprintf_chk ((char *)p, 0, __builtin_object_size ((char *)p, 1 > 1), ((char *)("%ld characters")), (long)nchars);
    ...
    struct stat *st;
{
    if (buf->b_mtime_read != 0
     && time_differs((long)st->st_mtimespec.tv_sec, buf->b_mtime_read))
    {
 msg_scroll = 1;
 msg_silent = 0;
 ...
 if (ask_yesno((char_u *)((char *)("Do you really want to write to it")),
         1) == 'n')
     return 0;
 msg_scroll = 0;
    }
    ...
    int prepend_dot;
{
 ...
 if (retval == ((void *)0))
     return ((void *)0);
 if (mch_dirname(retval, 1024) == 0 ||
         (fnamelen = (int)strlen((char *)(retval))) == 0)
 {
     vim_free(retval);
     return ((void *)0);
 }
 ...
 if (retval == ((void *)0))
     return ((void *)0);
 ((__builtin_object_size ((char *)(retval), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(retval), (char *)(fname), __builtin_object_size ((char *)(retval), 1 > 1)) : __inline_strcpy_chk ((char *)(retval), (char *)(fname)));
 ...
 if (vim_ispathsep(*ptr))
 {
    ...
    if (strlen((char *)(ptr)) > (unsigned)(255 - 5))
 ptr[(255 - 5)] = '\0';
...
# 6297 "fileio.c"
 ...
 if (fname == ((void *)0) || *fname == '\000'
       || vim_ispathsep(fname[strlen((char *)(fname)) - 1]))
 {
...
# 6341 "fileio.c"
 else if ((e = vim_strchr(ptr, '.')) == ((void *)0))
     *s++ = '.';
 ...
 else if ((int)strlen((char *)(e)) + extlen > 4)
     s = e + 4 - extlen;
    }
# 6365 "fileio.c"
    ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(s), (char *)(ext), __builtin_object_size ((char *)(s), 1 > 1)) : __inline_strcpy_chk ((char *)(s), (char *)(ext)));
    ...
    {
 ((__builtin_object_size ((char *)((e + 1)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((e + 1)), (char *)((e)), strlen((char *)(e)) + 1, __builtin_object_size ((char *)((e + 1)), 0)) : __inline_memmove_chk ((char *)((e + 1)), (char *)((e)), strlen((char *)(e)) + 1));
    ...
    char_u *to;
{
 ...
 if (strcmp((char *)(gettail(from)), (char *)(gettail(to))) != 0)
     use_tmp_file = 1;
 else
 ...
 if (strlen((char *)(from)) >= 1024 - 5)
     return -1;
 ((__builtin_object_size ((char *)(tempname), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(tempname), (char *)(from), __builtin_object_size ((char *)(tempname), 1 > 1)) : __inline_strcpy_chk ((char *)(tempname), (char *)(from)));
 for (n = 123; n < 99999; ++n)
 {
...
# 6622 "fileio.c"
 ...
 return -1;
    ...
    while ((n = read((fd_in), (char *)(buffer), (size_t) (8192))) > 0)
 if (write((fd_out), (char *)(buffer), (size_t) (n)) != n)
 {
    ...
    int focus __attribute__((unused));
{
 ...
 return 0;
    ...
    if ( !(buf->b_flags & 0x08)
     && buf->b_mtime != 0
     && ((stat_res = stat(((char *)buf->b_ffname), (&st))) < 0
  || time_differs((long)st.st_mtimespec.tv_sec, buf->b_mtime)
 ...
 else
 {
  ...
  reason = "time";
     ...
     {
  if (!buf_valid(buf))
      emsg((char_u *)(((char *)("E246: FileChangedShell autocommand deleted buffer"))));
 ...
 if (path != ((void *)0))
 {
     if (!helpmesg)
  mesg2 = "";
     tbuf = alloc((unsigned)(strlen((char *)(path)) + strlen((char *)(mesg))
       + strlen((char *)(mesg2)) + 2));
  ...
  if (*mesg2 != '\000')
  {
      ...
      ((__builtin_object_size ((char *)(tbuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(tbuf), (char *)(mesg2), __builtin_object_size ((char *)(tbuf), 1 > 1)) : __inline_strcat_chk ((char *)(tbuf), (char *)(mesg2)));
  }
  if (do_dialog(2, (char_u *)((char *)("Warning")), tbuf,
    (char_u *)((char *)("&OK\n&Load File")), 1, ((void *)0)) == 2)
      reload = 1;
     }
     else

     if (State > (0x100 + 0x01) || (State & 0x08) || already_warned)
     {
  if (*mesg2 != '\000')
  {
      ((__builtin_object_size ((char *)(tbuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(tbuf), (char *)("; "), __builtin_object_size ((char *)(tbuf), 1 > 1)) : __inline_strcat_chk ((char *)(tbuf), (char *)("; ")));
      ((__builtin_object_size ((char *)(tbuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(tbuf), (char *)(mesg2), __builtin_object_size ((char *)(tbuf), 1 > 1)) : __inline_strcat_chk ((char *)(tbuf), (char *)(mesg2)));
  }
  emsg((char_u *)(tbuf));
  retval = 2;
...
# 7142 "fileio.c"
 ...
 if (saved == 1)
 {
   ...
   (linenr_T)0,
   (linenr_T)(0x7fffffffL), &ea, flags) == 0)
     {

  if (!aborting())

      emsg2((char_u *)(((char *)("E321: Could not reload \"%s\""))), (char_u *)(buf->b_fname));
    ...
    char_u *tempdir;
{
    ...
    if (buf != ((void *)0))
    {
 if (vim_FullName(tempdir, buf, 1024, 0) == 0)
     ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)(tempdir), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)(tempdir)));
...
# 7397 "fileio.c"
  ...
  ((__builtin_object_size ((char *)(itmp), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(itmp), (char *)("vXXXXXX"), __builtin_object_size ((char *)(itmp), 1 > 1)) : __inline_strcat_chk ((char *)(itmp), (char *)("vXXXXXX")));
  if (mkdtemp((char *)itmp) != ((void *)0))
      vim_settempdir(itmp);
# 7452 "fileio.c"
  if (vim_tempdir != ((void *)0))
      break;
    ...
    event_T event;
{
 ...
 if (ap->group != -1)
 {
  ...
  msg_puts_attr((char_u *)((char *)("--Deleted--")), highlight_attr[(int)(HLF_E)]);
     else
    ...
    char_u *name;
{
    ...
    i = au_find_group(name);
    if (i == -2)
 emsg2((char_u *)(((char *)("E367: No such group: \"%s\""))), (char_u *)(name));
    else
    {
    ...
    int have_group;
{
 ...
 for (pat = arg; *pat && !((*pat) == ' ' || (*pat) == '\t'); pat = p)
 {
     ...
     {
  if (have_group)
      emsg2((char_u *)(((char *)("E216: No such event: %s"))), (char_u *)(pat));
  else
      emsg2((char_u *)(((char *)("E216: No such group or event: %s"))), (char_u *)(pat));
  return ((void *)0);
     }
 }
    }
    ...
    char *what;
{
 ...
 {
     if (*what == ',' && *p_ei == '\000')
  ((__builtin_object_size ((char *)(new_ei), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(new_ei), (char *)(what + 1), __builtin_object_size ((char *)(new_ei), 1 > 1)) : __inline_strcpy_chk ((char *)(new_ei), (char *)(what + 1)));
     else
  ((__builtin_object_size ((char *)(new_ei), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(new_ei), (char *)(what), __builtin_object_size ((char *)(new_ei), 1 > 1)) : __inline_strcat_chk ((char *)(new_ei), (char *)(what)));
    ...
    int group;
{
 ...
 if (patlen >= 7 && strncmp((char *)(pat), (char *)("<buffer"), (size_t)(7)) == 0
          && pat[patlen - 1] == '>')
 {
  ...
  if (patlen == 13 && strncasecmp((char *)(pat), (char *)("<buffer=abuf>"), (size_t)(13)))
    ...
    int do_msg;
{
 ...
 msg((char_u *)(((char *)("No matching autocommands"))));
    ...
    int stop_at_last;
{
  ...
  && (apc->group == -3 || apc->group == ap->group))
 {
  ...
  sourcing_name = alloc((unsigned)(strlen((char *)(s))
         + strlen((char *)(name)) + ap->patlen + 1));
  if (sourcing_name != ((void *)0))
  {
      __builtin___sprintf_chk ((char *)sourcing_name, 0, __builtin_object_size ((char *)sourcing_name, 1 > 1), s, (char *)name, (char *)ap->pat);
 ...
 *p++ = '\000';
 ...
 if (ap->pat != ((void *)0) && ap->cmds != ((void *)0)
     ...
     && (pattern == ((void *)0)
  || (buflocal_buf == ((void *)0)
      ? strcasecmp((char *)(((ap->pat))), (char *)(((pattern)))) == 0
...
# 10262 "fileio.c"
 ...
 reg_pat[i++] = '$';
    ...
    {
 if (nested < 0)
     emsg((char_u *)(((char *)("E219: Missing {."))));
 else
     emsg((char_u *)(((char *)("E220: Missing }."))));
 vim_free(reg_pat);
 reg_pat = ((void *)0);
    }
    return reg_pat;

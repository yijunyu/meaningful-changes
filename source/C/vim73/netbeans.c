...
netbeans_connect(char *params, int doabort)
{
 ...
 if (arg == ((void *)0) && (fname = getenv("__NETBEANS_CONINFO")) != ((void *)0))
 {
     ...
     if (getConnInfo(fname, &hostname, &address, &password) == 0)
  return 0;
 }
 else
 {
 ...
 password = (char *)vim_strsave((char_u *)"changeme");
    ...
    if (hostname == ((void *)0) || address == ((void *)0) || password == ((void *)0))
 goto theend;
 ...
 goto theend;
    ...
    ((__builtin_object_size (((char *)&server), 0) != (size_t) -1) ? __builtin___memset_chk (((char *)&server), ('\0'), (sizeof(server)), __builtin_object_size (((char *)&server), 0)) : __inline_memset_chk (((char *)&server), ('\0'), (sizeof(server))));
    server.sin_family = 2;
    server.sin_port = (__builtin_constant_p(port) ? ((__uint16_t)((((__uint16_t)(port) & 0xff00) >> 8) | (((__uint16_t)(port) & 0x00ff) << 8))) : _OSSwapInt16(port));
 ...
 goto theend;
    ...
    ((__builtin_object_size ((char *)&server.sin_addr, 0) != (size_t) -1) ? __builtin___memcpy_chk ((char *)&server.sin_addr, host->h_addr_list[0], host->h_length, __builtin_object_size ((char *)&server.sin_addr, 0)) : __inline_memcpy_chk ((char *)&server.sin_addr, host->h_addr_list[0], host->h_length));
# 337 "netbeans.c"
...
save(char_u *buf, int len)
{
 ...
 return;
    ...
    ((__builtin_object_size ((char *)(node->buffer), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(node->buffer), (char *)(buf), (size_t)len, __builtin_object_size ((char *)(node->buffer), 0)) : __inline_memmove_chk ((char *)(node->buffer), (char *)(buf), (size_t)len));
    node->buffer[len] = '\000';
...
netbeans_parse_messages(void)
{
 ...
 if (p == ((void *)0))
 {
     ...
     if (node->next == &head)
  return;
     p = alloc((unsigned)(strlen((char *)(node->buffer))
        + strlen((char *)(node->next->buffer)) + 1));
     if (p == ((void *)0))
  return;
     ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p), (char *)(node->buffer), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcpy_chk ((char *)(p), (char *)(node->buffer)));
     ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(p), (char *)(node->next->buffer), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcat_chk ((char *)(p), (char *)(node->next->buffer)));
 ...
 else
 {
  ...
  ((__builtin_object_size ((char *)((node->buffer)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((node->buffer)), (char *)((p)), strlen((char *)(p)) + 1, __builtin_object_size ((char *)((node->buffer)), 0)) : __inline_memmove_chk ((char *)((node->buffer)), (char *)((p)), strlen((char *)(p)) + 1));
     }
 }
    }
}
...
# 755 "netbeans.c"
 ...
 do { int __fd = (nbsock); ((&rfds)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);
 tval.tv_sec = 0;
 tval.tv_usec = 0;
 if (select(nbsock + 1, &rfds, ((void *)0), ((void *)0), &tval) <= 0)
     break;
# 782 "netbeans.c"
...
nb_get_buf(int bufno)
{
 ...
 if (bufno >= buf_list_size)
 {
     ...
     ((__builtin_object_size ((buf_list + buf_list_size - incr), 0) != (size_t) -1) ? __builtin___memset_chk ((buf_list + buf_list_size - incr), (0), (incr * sizeof(nbbuf_T)), __builtin_object_size ((buf_list + buf_list_size - incr), 0)) : __inline_memset_chk ((buf_list + buf_list_size - incr), (0), (incr * sizeof(nbbuf_T))));
...
count_changed_buffers(void)
{
    ...
    n = 0;
    for (bufp = firstbuf; bufp != ((void *)0); bufp = bufp->b_next)
 if (bufp->b_changed)
     ++n;
    return n;
}
...
nb_partialremove(linenr_T lnum, colnr_T first, colnr_T last)
{
 ...
 lastbyte = oldlen - 1;
    ...
    if (newtext != ((void *)0))
    {
 ((__builtin_object_size ((char *)(newtext), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newtext), (char *)(oldtext), first, __builtin_object_size ((char *)(newtext), 0)) : __inline_memmove_chk ((char *)(newtext), (char *)(oldtext), first));
 ((__builtin_object_size ((char *)((newtext + first)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((newtext + first)), (char *)((oldtext + lastbyte + 1)), strlen((char *)(oldtext + lastbyte + 1)) + 1, __builtin_object_size ((char *)((newtext + first)), 0)) : __inline_memmove_chk ((char *)((newtext + first)), (char *)((oldtext + lastbyte + 1)), strlen((char *)(oldtext + lastbyte + 1)) + 1));
 ;
...
nb_joinlines(linenr_T first, linenr_T other)
{
    ...
    if (p != ((void *)0))
    {
      ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p), (char *)(ml_get(first)), len_first, __builtin_object_size ((char *)(p), 0)) : __inline_memmove_chk ((char *)(p), (char *)(ml_get(first)), len_first));
      ((__builtin_object_size ((char *)(p + len_first), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p + len_first), (char *)(ml_get(other)), len_other + 1, __builtin_object_size ((char *)(p + len_first), 0)) : __inline_memmove_chk ((char *)(p + len_first), (char *)(ml_get(other)), len_other + 1));
    ...
    char_u *args)
{
 ...
 else if ((strcmp((char *)cmd,"getCursor") == 0))
 {
     ...
     __builtin___sprintf_chk ((char *)text, 0, __builtin_object_size ((char *)text, 1 > 1), "%d %ld %d %ld", nb_getbufno(curbuf), (long)curwin->w_cursor.lnum, (int)curwin->w_cursor.col, pos2off(curbuf, &curwin->w_cursor));
 ...
 else if ((strcmp((char *)cmd,"getText") == 0))
 {
  ...
  else
  {
   ...
   if (line != ((void *)0))
   {
       ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p), (char *)(line), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcpy_chk ((char *)(p), (char *)(line)));
       p += strlen((char *)(line));
       *p++ = '\\';
       *p++ = 'n';
       vim_free(line);
 ...
 else if ((strcmp((char *)cmd,"remove") == 0))
 {
  ...
  if (first.col != 0
    || (next != ((void *)0) && first.lnum == next->lnum))
  {
  ...
  if (first.lnum != last.lnum && next != ((void *)0)
  ...
  if (first.lnum != last.lnum && del_from_lnum > first.lnum
   && next != ((void *)0) && last.lnum != next->lnum)
  {
      nb_joinlines(first.lnum, next->lnum);
      del_to_lnum = next->lnum;
  }
 ...
 else if ((strcmp((char *)cmd,"insert") == 0))
 {
  ...
  while (*args != '\000')
  {
   ...
   if (newline != ((void *)0))
   {
       ((__builtin_object_size ((char *)(newline), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(newline), (char *)(oldline), __builtin_object_size ((char *)(newline), 1 > 1)) : __inline_strcpy_chk ((char *)(newline), (char *)(oldline)));
       ((__builtin_object_size ((char *)(newline), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(newline), (char *)(args), __builtin_object_size ((char *)(newline), 1 > 1)) : __inline_strcat_chk ((char *)(newline), (char *)(args)));
 ...
 else if ((strcmp((char *)cmd,"stopDocumentListen") == 0))
 {
  ...
  else
  {
      ...
      do_bufdel(3, (char_u *)"", 1,
      buf->bufp->b_fnum, buf->bufp->b_fnum, 1);
      ((__builtin_object_size ((buf), 0) != (size_t) -1) ? __builtin___memset_chk ((buf), (0), (sizeof(nbbuf_T)), __builtin_object_size ((buf), 0)) : __inline_memset_chk ((buf), (0), (sizeof(nbbuf_T))));
  }
     }
 ...
 else if ((strcmp((char *)cmd,"setBufferNumber") == 0)
  || (strcmp((char *)cmd,"putBufferNumber") == 0))
 {
     char_u *path;
     buf_T *bufp;
 ...
 else if ((strcmp((char *)cmd,"setFullName") == 0))
 {
  ...
  return 0;
     ...
     netbeansReadFile = 0;
     do_ecmd(0, (char_u *)buf->displayname, 0, 0, (linenr_T)1,
          0x01 + 0x04, curwin);
     netbeansReadFile = 1;
     buf->bufp = curbuf;
     maketitle();
 ...
 else if ((strcmp((char *)cmd,"editFile") == 0))
 {
  ...
  return 0;
     ...
     vim_free(buf->displayname);
     buf->displayname = nb_unquote(args, ((void *)0));
     do_ecmd(0, (char_u *)buf->displayname, ((void *)0), ((void *)0), (linenr_T)1,
          0x01 + 0x04, curwin);
     buf->bufp = curbuf;
     buf->initDone = 1;
     doupdate = 1;
 ...
 else if ((strcmp((char *)cmd,"setModified") == 0))
 {
  ...
  if (buf->bufp->b_ffname != ((void *)0)
   && stat(((char *)buf->bufp->b_ffname), (&st)) >= 0)
...
# 2262 "netbeans.c"
  ...
  *p = '\000';
  ...
  parse_error = 1;
     ...
     else if (typeName != ((void *)0) && tooltip != ((void *)0) && glyphFile != ((void *)0))
...
{
    if (curbuf != buf && buf_jump_open_win(buf) == ((void *)0))
 set_curbuf(buf, 0);
}
...
special_keys(char_u *args)
{
 ...
 ((__builtin_object_size (&keybuf[i], 0) != (size_t) -1) ? __builtin___strcpy_chk (&keybuf[i], tok, __builtin_object_size (&keybuf[i], 1 > 1)) : __inline_strcpy_chk (&keybuf[i], tok));
...
netbeans_keyname(int key, char *buf)
{
 ...
 alt = 1;
    ...
    switch (key)
    {
 case (-(('k') + ((int)('1') << 8))): name = "F1"; break;
 case (-((253) + ((int)(KE_S_F1) << 8))): name = "F1"; shift = 1; break;
 case (-(('k') + ((int)('2') << 8))): name = "F2"; break;
 case (-((253) + ((int)(KE_S_F2) << 8))): name = "F2"; shift = 1; break;
 case (-(('k') + ((int)('3') << 8))): name = "F3"; break;
 case (-((253) + ((int)(KE_S_F3) << 8))): name = "F3"; shift = 1; break;
 case (-(('k') + ((int)('4') << 8))): name = "F4"; break;
 case (-((253) + ((int)(KE_S_F4) << 8))): name = "F4"; shift = 1; break;
 case (-(('k') + ((int)('5') << 8))): name = "F5"; break;
 case (-((253) + ((int)(KE_S_F5) << 8))): name = "F5"; shift = 1; break;
 case (-(('k') + ((int)('6') << 8))): name = "F6"; break;
 case (-((253) + ((int)(KE_S_F6) << 8))): name = "F6"; shift = 1; break;
 case (-(('k') + ((int)('7') << 8))): name = "F7"; break;
 case (-((253) + ((int)(KE_S_F7) << 8))): name = "F7"; shift = 1; break;
 case (-(('k') + ((int)('8') << 8))): name = "F8"; break;
 case (-((253) + ((int)(KE_S_F8) << 8))): name = "F8"; shift = 1; break;
 case (-(('k') + ((int)('9') << 8))): name = "F9"; break;
 case (-((253) + ((int)(KE_S_F9) << 8))): name = "F9"; shift = 1; break;
 case (-(('k') + ((int)(';') << 8))): name = "F10"; break;
 case (-((253) + ((int)(KE_S_F10) << 8))): name = "F10"; shift = 1; break;
 case (-(('F') + ((int)('1') << 8))): name = "F11"; break;
 case (-((253) + ((int)(KE_S_F11) << 8))): name = "F11"; shift = 1; break;
 case (-(('F') + ((int)('2') << 8))): name = "F12"; break;
 case (-((253) + ((int)(KE_S_F12) << 8))): name = "F12"; shift = 1; break;
 default:
   if (key >= ' ' && key <= '~')
   {
   ...
   break;
    ...
    buf[0] = '\0';
    if (ctrl)
 ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___strcat_chk (buf, "C", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (buf, "C"));
    if (shift)
 ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___strcat_chk (buf, "S", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (buf, "S"));
    if (alt)
 ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___strcat_chk (buf, "M", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (buf, "M"));
    if (ctrl || shift || alt)
 ((__builtin_object_size (buf, 0) != (size_t) -1) ? __builtin___strcat_chk (buf, "-", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (buf, "-"));
...
netbeans_open(char *params, int doabort)
{
 ...
 return;
    ...
    if (netbeans_connect(params, doabort) != 1)
 return;
...
netbeans_file_activated(buf_T *bufp)
{
    ...
    if (!(nbsock != -1) || !bufp->b_netbeans_file || dosetvisible)
 return;

    q = nb_quote(bufp->b_ffname);
    if (q == ((void *)0) || bp == ((void *)0))
 return;
...
netbeans_file_opened(buf_T *bufp)
{
 ...
 bnum = 0;
    ...
    nb_send(buffer, "netbeans_file_opened");
    if (p_acd && vim_chdirfile(bufp->b_ffname) == 1)
 shorten_fnames(1);
}
...
nb_bufp2nbbuf_fire(buf_T *bufp, int *bufnop)
{
    ...
    if (!(nbsock != -1) || !netbeansFireChanges)
 return ((void *)0);
 ...
 return ((void *)0);
    ...
    if (nbbuf != ((void *)0) && !nbbuf->fireChanges)
 return ((void *)0);
    ...
    long len)
{
 ...
 return;
    ...
    void
netbeans_unmodified(buf_T *bufp __attribute__((unused)))
{
...
netbeans_button_release(int button)
{
 ...
 int col = mouse_col - (curwin->w_wincol)
         - ((curwin->w_onebuf_opt.wo_nu || curwin->w_onebuf_opt.wo_rnu) ? 9 : 1);
...
netbeans_keystring(char_u *keyName)
{
 ...
 return 1;
    ...
    {
 ;
 q = curbuf->b_ffname == ((void *)0) ? (char_u *)""
...
addsigntype(
    ...
    int typeNum,
    char_u *typeName,
    char_u *tooltip __attribute__((unused)),
    char_u *glyphFile,
    char_u *fg,
    char_u *bg)
{
 ...
 if (strcmp((char *)(typeName), (char *)(globalsignmap[i])) == 0)
     break;
 ...
 if (use_fg || use_bg)
 {
     ...
     if (ptr != (char *)fg)
  __builtin___sprintf_chk (fgbuf, 0, __builtin_object_size (fgbuf, 1 > 1), "guifg=#%06x", value & 0xFFFFFF);
     else
  __builtin___sprintf_chk (fgbuf, 0, __builtin_object_size (fgbuf, 1 > 1), "guifg=%s ctermfg=%s", fg, fg);

     value = strtol((char *)bg, &ptr, 10);
     if (ptr != (char *)bg)
  __builtin___sprintf_chk (bgbuf, 0, __builtin_object_size (bgbuf, 1 > 1), "guibg=#%06x", value & 0xFFFFFF);
     else
  __builtin___sprintf_chk (bgbuf, 0, __builtin_object_size (bgbuf, 1 > 1), "guibg=%s ctermbg=%s", bg, bg);
 ...
 if (strcmp((char *)(typeName), (char *)("CurrentPC")) == 0)
     curPCtype = typeNum;
 ...
 if (globalsignmapused == globalsignmaplen)
 {
  ...
  ((__builtin_object_size ((globalsignmap + oldlen), 0) != (size_t) -1) ? __builtin___memset_chk ((globalsignmap + oldlen), (0), (incr * sizeof(char *)), __builtin_object_size ((globalsignmap + oldlen), 0)) : __inline_memset_chk ((globalsignmap + oldlen), (0), (incr * sizeof(char *))));
     }
 }
 ...
 else
 {
     ...
     ((__builtin_object_size ((buf->signmap + oldlen), 0) != (size_t) -1) ? __builtin___memset_chk ((buf->signmap + oldlen), (0), (incr * sizeof(int)), __builtin_object_size ((buf->signmap + oldlen), 0)) : __inline_memset_chk ((buf->signmap + oldlen), (0), (incr * sizeof(int))));
 }
    }
...
get_buf_size(buf_T *bufp)
{
    ...
    if (bufp->b_ml.ml_flags & 1)
 return 0;
    else
    {
 if (get_fileformat(bufp) == 1)
     eol_size = 2;
 else
     eol_size = 1;
 for (lnum = 1; lnum <= bufp->b_ml.ml_line_count; ++lnum)
 {
     char_count += (long)strlen((char *)(ml_get_buf(bufp, lnum, 0)))
           + eol_size;
    ...
    nbbuf_T *buf;
{
    ...
    if (buf->bufp->b_p_ro)
    {
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('r') ? ((char *)("[RO]")) : ((char *)("[readonly]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('r') ? ((char *)("[RO]")) : ((char *)("[readonly]")))));
 c = 1;
    }
    if (!buf->bufp->b_start_eol)
    {
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(shortmess('i') ? ((char *)("[noeol]")) : ((char *)("[Incomplete last line]"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(shortmess('i') ? ((char *)("[noeol]")) : ((char *)("[Incomplete last line]")))));
    ...
    off_t nchars;
{
 ...
 ((__builtin_object_size ((char *)(ebuf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ebuf), (char *)((char_u *)((char *)("E505: "))), __builtin_object_size ((char *)(ebuf), 1 > 1)) : __inline_strcpy_chk ((char *)(ebuf), (char *)((char_u *)((char *)("E505: ")))));
 ((__builtin_object_size ((char *)(ebuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ebuf), (char *)(IObuff), __builtin_object_size ((char *)(ebuf), 1 > 1)) : __inline_strcat_chk ((char *)(ebuf), (char *)(IObuff)));
 ((__builtin_object_size ((char *)(ebuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ebuf), (char *)((char_u *)((char *)("is read-only (add ! to override)"))), __builtin_object_size ((char *)(ebuf), 1 > 1)) : __inline_strcat_chk ((char *)(ebuf), (char *)((char_u *)((char *)("is read-only (add ! to override)")))));
 ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff), (char *)(ebuf), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff), (char *)(ebuf)));
 ;
 emsg(IObuff);
    }
}

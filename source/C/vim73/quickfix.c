    ...
    char_u *qf_title;
{
 ...
 char *pattern;
   ...
   {'s', ".\\+"}
    ...
    if (namebuf == ((void *)0) || errmsg == ((void *)0) || pattern == ((void *)0))
 goto qf_init_end;
 ...
 *ptr++ = '^';
 ...
 for (efmp = efm; efmp < efm + len; ++efmp)
 {
  ...
  if (idx < 10)
  {
      if (fmt_ptr->addr[idx])
      {
   __builtin___sprintf_chk ((char *)errmsg, 0, __builtin_object_size ((char *)errmsg, 1 > 1), ((char *)("E372: Too many %%%c in format string")), *efmp);
   ...
   goto error2;
    ...
    && vim_strchr((char_u *)"OPQ",
          fmt_ptr->prefix) == ((void *)0)))
      {
   __builtin___sprintf_chk ((char *)errmsg, 0, __builtin_object_size ((char *)errmsg, 1 > 1), ((char *)("E373: Unexpected %%%c in format string")), *efmp);
...
# 367 "quickfix.c"
   ...
   if (efmp[1] != '\\' && efmp[1] != '%')
   {
       ...
       ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ptr), (char *)(".\\{-1,}"), __builtin_object_size ((char *)(ptr), 1 > 1)) : __inline_strcpy_chk ((char *)(ptr), (char *)(".\\{-1,}")));
       ptr += 7;
   }
   else
   {
       ...
       ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ptr), (char *)("\\f\\+"), __builtin_object_size ((char *)(ptr), 1 > 1)) : __inline_strcpy_chk ((char *)(ptr), (char *)("\\f\\+")));
       ptr += 4;
   }
      }
      else
   ...
   *ptr++ = '+';
   ...
   __builtin___sprintf_chk ((char *)errmsg, 0, __builtin_object_size ((char *)errmsg, 1 > 1), ((char *)("E375: Unsupported %%%c in format string")), *efmp);
  ...
  else if (efmp == efm + 1)
  {
   ...
   fmt_ptr->prefix = *efmp;
      ...
      {
   __builtin___sprintf_chk ((char *)errmsg, 0, __builtin_object_size ((char *)errmsg, 1 > 1), ((char *)("E376: Invalid %%%c in format string prefix")), *efmp);
  ...
  {
      __builtin___sprintf_chk ((char *)errmsg, 0, __builtin_object_size ((char *)errmsg, 1 > 1), ((char *)("E377: Invalid %%%c in format string")), *efmp);
 ...
 if (fd == ((void *)0))
 {
  ...
  if (tv->v_type == 2)
  {
   ...
   len = (int)strlen((char *)(p_str));
      ...
      if (len > 1024 - 2)
   vim_strncpy(IObuff, p_str, 1024 - 2);
      else
  ...
  if (buflnum > lnumlast)
      break;
  vim_strncpy(IObuff, ml_get_buf(buf, buflnum++, 0),
       1024 - 2);
     }
 }
...
restofline:
 for ( ; fmt_ptr != ((void *)0); fmt_ptr = fmt_ptr->next)
 {
  ...
  if (fmt_ptr->flags == '+' && !multiscan)
      ((__builtin_object_size ((char *)(errmsg), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(errmsg), (char *)(IObuff), __builtin_object_size ((char *)(errmsg), 1 > 1)) : __inline_strcpy_chk ((char *)(errmsg), (char *)(IObuff)));
  ...
  if ((i = (int)fmt_ptr->addr[7]) > 0)
  {
   ...
   continue;
      ...
      if (*((char_u *)regmatch.startp[i]) != '\011')
   use_viscol = 1;
  }
  ...
  if ((i = (int)fmt_ptr->addr[9]) > 0)
  {
   ...
   continue;
      ...
      if (len > 1024 - 5)
   len = 1024 - 5;
      ((__builtin_object_size ((char *)(pattern), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(pattern), (char *)("^\\V"), __builtin_object_size ((char *)(pattern), 1 > 1)) : __inline_strcpy_chk ((char *)(pattern), (char *)("^\\V")));
      ((__builtin_object_size ((char *)(pattern), 0) != (size_t) -1) ? __builtin___strncat_chk ((char *)(pattern), (char *)(regmatch.startp[i]), (size_t)(len), __builtin_object_size ((char *)(pattern), 1 > 1)) : __inline_strncat_chk ((char *)(pattern), (char *)(regmatch.startp[i]), (size_t)(len)));
      pattern[len + 3] = '\\';
      pattern[len + 4] = '$';
      pattern[len + 5] = '\000';
  }
 ...
 else if (fmt_ptr != ((void *)0))
 {
  ...
  if (*errmsg && !multiignore)
  {
      ...
      if ((ptr = alloc((unsigned)(len + strlen((char *)(errmsg)) + 2)))
            == ((void *)0))
   goto error2;
      ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ptr), (char *)(qfprev->qf_text), __builtin_object_size ((char *)(ptr), 1 > 1)) : __inline_strcpy_chk ((char *)(ptr), (char *)(qfprev->qf_text)));
      vim_free(qfprev->qf_text);
      qfprev->qf_text = ptr;
      *(ptr += len) = '\n';
      ((__builtin_object_size ((char *)(++ptr), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(++ptr), (char *)(errmsg), __builtin_object_size ((char *)(++ptr), 1 > 1)) : __inline_strcpy_chk ((char *)(++ptr), (char *)(errmsg)));
  }
  if (qfprev->qf_nr == -1)
      qfprev->qf_nr = enr;
  ...
  if (*namebuf == '\000' || mch_getperm(namebuf) >= 0)
  {
   ...
   currfile = qf_pop_dir(&file_stack);
      *namebuf = '\000';
      if (tail && *tail)
      {
   ((__builtin_object_size ((char *)((IObuff)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((IObuff)), (char *)((skipwhite(tail))), strlen((char *)(skipwhite(tail))) + 1, __builtin_object_size ((char *)((IObuff)), 0)) : __inline_memmove_chk ((char *)((IObuff)), (char *)((skipwhite(tail))), strlen((char *)(skipwhite(tail))) + 1));
   multiscan = 1;
   goto restofline;
      }
  }
    ...
    char_u *qf_title;
{
 ...
 if (p != ((void *)0))
     __builtin___sprintf_chk ((char *)p, 0, __builtin_object_size ((char *)p, 1 > 1), ":%s", (char *)qf_title);
    }
    else
 qi->qf_lists[qi->qf_curlist].qf_title = ((void *)0);
}
    ...
    int valid;
{
    ...
    if ((qfp = (qfline_T *)alloc((unsigned)sizeof(qfline_T))) == ((void *)0))
 return 0;
    if (bufnum != 0)
 qfp->qf_fnum = bufnum;
    else
...
ll_new_list()
{
    ...
    if (qi != ((void *)0))
    {
 ((__builtin_object_size ((qi), 0) != (size_t) -1) ? __builtin___memset_chk ((qi), (0), ((size_t)(sizeof(qf_info_T))), __builtin_object_size ((qi), 0)) : __inline_memset_chk ((qi), (0), ((size_t)(sizeof(qf_info_T)))));
 qi->qf_refcount++;
    }
    ...
    win_T *to;
{
 ...
 return;
    ...
    if ((to->w_llist = ll_new_list()) == ((void *)0))
 return;
...
# 1200 "quickfix.c"
 if (directory != ((void *)0) && !vim_isAbsName(fname)
  && (ptr = concat_fnames(directory, fname, 1)) != ((void *)0))
 {
    ...
    struct dir_stack_T **stackptr;
{
 ...
 while (ds_new)
 {
     ...
     (*stackptr)->dirname = concat_fnames(ds_new->dirname, dirbuf,
      1);
     if (mch_isdir((*stackptr)->dirname) == 1)
  break;
    ...
    char_u *filename;
{
 ...
 if ((fullname != ((void *)0)) && (mch_getperm(fullname) >= 0))
     break;
...
win_found:
 ...
 if (print_message)
 {
     ...
     __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("(%d of %d)%s%s: ")), qf_index, qi->qf_lists[qi->qf_curlist].qf_count, qf_ptr->qf_cleared ? ((char *)(" (line deleted)")) : "", (char *)qf_types(qf_ptr->qf_type, qf_ptr->qf_nr));
    ...
    exarg_T *eap;
{
 ...
 if ((qfp->qf_valid || all) && idx1 <= i && i <= idx2)
 {
  ...
  if (qfp->qf_type == 1)
     ...
     if (fname == ((void *)0))
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), "%2d", i);
     else
  ...
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ":%ld", qfp->qf_lnum);
     else
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ":%ld col %d", qfp->qf_lnum, qfp->qf_col);

     __builtin___sprintf_chk ((char *)IObuff + strlen((char *)(IObuff)), 0, __builtin_object_size ((char *)IObuff + strlen((char *)(IObuff)), 1 > 1), "%s:", (char *)qf_types(qfp->qf_type, qfp->qf_nr));
...
qf_msg(qi)
    qf_info_T *qi;
{
    smsg((char_u *)((char *)("error list %d of %d; %d errors")),
    ...
    qf_info_T *qi;
{
 ...
 for (lnum = 0; lnum < qi->qf_lists[qi->qf_curlist].qf_count; ++lnum)
 {
     ...
     {
  if (qfp->qf_type == 1)
      ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff), (char *)(gettail(errbuf->b_fname)), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff), (char *)(gettail(errbuf->b_fname))));
  else
      ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff), (char *)(errbuf->b_fname), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff), (char *)(errbuf->b_fname)));
  len = (int)strlen((char *)(IObuff));
     }
     else
  len = 0;
  ...
  __builtin___sprintf_chk ((char *)IObuff + len, 0, __builtin_object_size ((char *)IObuff + len, 1 > 1), "%s", (char *)qf_types(qfp->qf_type, qfp->qf_nr));
...
get_mef_name()
{
 ...
 if (name == ((void *)0))
     break;
 ((__builtin_object_size ((char *)(name), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(name), (char *)(p_mef), __builtin_object_size ((char *)(name), 1 > 1)) : __inline_strcpy_chk ((char *)(name), (char *)(p_mef)));
 __builtin___sprintf_chk ((char *)name + (p - p_mef), 0, __builtin_object_size ((char *)name + (p - p_mef), 1 > 1), "%d%d", start, off);
 ((__builtin_object_size ((char *)(name), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(name), (char *)(p + 2), __builtin_object_size ((char *)(name), 1 > 1)) : __inline_strcat_chk ((char *)(name), (char *)(p + 2)));
    ...
    exarg_T *eap;
{
 ...
 for (prevp = qi->qf_lists[qi->qf_curlist].qf_start;
    ...
    if (get_arglist_exp(p, &fcount, &fnames) == 0)
 goto theend;
    if (fcount == 0)
    {
 ...
 {
     if (!got_int)
  smsg((char_u *)((char *)("Cannot open file \"%s\"")), fname);
 }
 else
 {
 ...
 emsg2((char_u *)(((char *)(e_nomatch2))), (char_u *)(s));
    ...
    char_u *fname;
{
 ...
 if (readfile(fname, ((void *)0),
      (linenr_T)0, (linenr_T)0, (linenr_T)(0x7fffffffL),
      ((void *)0), 0x01 | 0x10) == 1
  && !got_int
  && !(curbuf->b_flags & 0x10))
 {
    ...
    exarg_T *eap;
{
 ...
 emsg((char_u *)(((char *)("E681: Buffer is not loaded"))));
    else
    {
 if (eap->addr_count == 0)
 {
    ...
    exarg_T *eap;
{
  ...
  || (tv->v_type == 4 && tv->vval.v_list != ((void *)0)))
 {
  ...
  qf_jump(qi, 0, 0, eap->forceit);
     ...
     emsg((char_u *)(((char *)("E777: String or List expected"))));
 free_tv(tv);
    }
}
    ...
    exarg_T *eap;
{
 ...
 while (*p != '\000' && !got_int)
 {
     ...
     ((__builtin_object_size ((char *)(NameBuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(NameBuff), (char *)("doc/*.\\(txt\\|??x\\)"), __builtin_object_size ((char *)(NameBuff), 1 > 1)) : __inline_strcat_chk ((char *)(NameBuff), (char *)("doc/*.\\(txt\\|??x\\)")));
 ...
 emsg2((char_u *)(((char *)(e_nomatch2))), (char_u *)(eap->arg));

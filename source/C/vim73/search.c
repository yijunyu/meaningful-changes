    ...
    proftime_T *tm __attribute__((unused));
{
 ...
 if ((options & 0x0c) && !rc_did_emsg)
     emsg2((char_u *)(((char *)("E383: Invalid search string: %s"))), (char_u *)(mr_pattern));
 return 0;
    }
    ...
    if ((options & 0x100) || pos->col == (0x7fffffffL))
 extra_col = 0;
# 585 "search.c"
    else
 extra_col = 1;
...
# 955 "search.c"
  ...
  give_warning((char_u *)((char *)(dir == (-1) ? top_bot_msg : bot_top_msg)), 1);
 ...
 {
     if (p_ws)
  emsg2((char_u *)(((char *)(e_patnotf2))), (char_u *)(mr_pattern));
     else if (lnum == 0)
  emsg2((char_u *)(((char *)("E384: search hit TOP without match for: %s"))), (char_u *)(mr_pattern));

     else
  emsg2((char_u *)(((char *)("E385: search hit BOTTOM without match for: %s"))), (char_u *)(mr_pattern));
    ...
    proftime_T *tm;
{
         ...
         && !cmd_silent && msg_silent == 0)
 {
  ...
  msgbuf[0] = dirc;
# 1253 "search.c"
      ((__builtin_object_size ((char *)(msgbuf + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(msgbuf + 1), (char *)(p), __builtin_object_size ((char *)(msgbuf + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(msgbuf + 1), (char *)(p)));
   ...
   *p++ = '+';
      if (spats[0].off.off != 0 || spats[0].off.line)
   __builtin___sprintf_chk ((char *)p, 0, __builtin_object_size ((char *)p, 1 > 1), "%ld", spats[0].off.off);
      else
   *p = '\000';
  }
    ...
    char_u *pat;
{
 ...
 {
     if ((p_ic ? strcasecmp((char *)((p)), (char *)((pat))) : strcmp((char *)(p), (char *)(pat))) == 0)
  return 1;
 }
 else if (*p != '\000')
 {
     if ((p_ic ? strncasecmp((char *)((p)), (char *)((pat)), (size_t)((compl_length)))
...
# 2002 "search.c"
 ...
 comment_col = check_linecomment(linep);
    ...
    if (lisp && comment_col != (0x7fffffffL) && pos.col > (colnr_T)comment_col)
 lispcomm = 1;
 ...
 if (backwards)
 {
  ...
  if (lisp && comment_col != (0x7fffffffL))
      pos.col = comment_col;
    ...
    int eol;
{
 ...
 while (cls() == 0)
 {
     ...
     if (curwin->w_cursor.col == 0 && *ml_get_curline() == '\000')
  break;
    ...
    int quotechar;
{
 ...
 if (col_end < 0)
    ...
    if (include)
    {
 if (((line[col_end + 1]) == ' ' || (line[col_end + 1]) == '\t'))
     while (((line[col_end + 1]) == ' ' || (line[col_end + 1]) == '\t'))
  ++col_end;
 else
     while (col_start > 0 && ((line[col_start - 1]) == ' ' || (line[col_start - 1]) == '\t'))
  --col_start;
    }
    ...
    linenr_T end_lnum;
{
 ...
 def_regmatch.rm_ic = 0;
    ...
    files = (SearchedFile *)lalloc_clear((long_u)
          (max_path_depth * sizeof(SearchedFile)), 1);
    if (files == ((void *)0))
 goto fpip_end;
  ...
  && vim_regexec(&incl_regmatch, line, (colnr_T)0))
 {
  ...
  else
  {
      ...
      if (action != 4)
   msg_puts_title((char_u *)(((char *)("not found "))));
...

  {
   ...
   p[i] = save_char;
      ...
      {
   if (already_searched)
       msg_puts((char_u *)(((char *)("  (Already listed)"))));
   else
       msg_puts((char_u *)(((char *)("  NOT FOUND"))));
      }
  }
  out_flush();
     }
  ...
  if (depth + 1 == old_files)
  {
      bigger = (SearchedFile *)lalloc((long_u)(
       max_path_depth * 2 * sizeof(SearchedFile)), 1);
      if (bigger != ((void *)0))
      {
   for (i = 0; i <= depth; i++)
       bigger[i] = files[i];
  ...
  else
  {
   ...
   msg_trunc_attr(IObuff, 1, highlight_attr[(int)(HLF_R)]);
    ...
    if (p_verbose >= 5)
      {
   verbose_enter();
   smsg((char_u *)((char *)("Searching included file %s")),
          (char *)new_fname);
   verbose_leave();
      }
...
search_line:
      ...
      )
  {
      ...
      startp = skipwhite(p);
      if (p_ic)
   matched = !strncasecmp((char *)((startp)), (char *)((ptr)), (size_t)((len)));
      else
 ...
 if (matched)
 {
  ...
  if ((compl_cont_status & 1) && i == compl_length)
  {
      ...
      ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(IObuff), (char *)(aux), (size_t)(i), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strncpy_chk ((char *)(IObuff), (char *)(aux), (size_t)(i)));
   ...
   if (p - aux >= (1024+1) - i)
       p = aux + (1024+1) - i - 1;
   ((__builtin_object_size ((char *)(IObuff + i), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(IObuff + i), (char *)(aux), (size_t)(p - aux), __builtin_object_size ((char *)(IObuff + i), 1 > 1)) : __inline_strncpy_chk ((char *)(IObuff + i), (char *)(aux), (size_t)(p - aux)));
   i += (int)(p - aux);
   reuse |= 8;
      }
      IObuff[i] = '\000';
  ...
  if (depth == -1 && lnum == curwin->w_cursor.lnum
      ...
      emsg((char_u *)(((char *)("E387: Match is on current line"))));
  else if (action == 1)
  {
...
exit_matched:
 ...
 {
     if (action != 4)
  msg((char_u *)(((char *)("All included files were found"))));
     else
  msg((char_u *)(((char *)("No included files"))));
 }
    }
    else if (!found
 ...
 if (got_int || compl_interrupted)
     ...
     emsg((char_u *)(((char *)("E388: Couldn't find definition"))));
 else
     emsg((char_u *)(((char *)("E389: Couldn't find pattern"))));
    }

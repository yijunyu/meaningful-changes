    ...
    int len;
{
 ...
 if (ta_str != ((void *)0))
 {
     ((__builtin_object_size ((char *)(new), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(new), (char *)(ta_str + ta_off), (size_t)(ta_len - ta_off), __builtin_object_size ((char *)(new), 0)) : __inline_memmove_chk ((char *)(new), (char *)(ta_str + ta_off), (size_t)(ta_len - ta_off)));
     ((__builtin_object_size ((char *)(new + ta_len - ta_off), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(new + ta_len - ta_off), (char *)(s), (size_t)len, __builtin_object_size ((char *)(new + ta_len - ta_off), 0)) : __inline_memmove_chk ((char *)(new + ta_len - ta_off), (char *)(s), (size_t)len));
     vim_free(ta_str);
 }
 else
     ((__builtin_object_size ((char *)(new), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(new), (char *)(s), (size_t)len, __builtin_object_size ((char *)(new), 0)) : __inline_memmove_chk ((char *)(new), (char *)(s), (size_t)len));
 ta_str = new;
 ta_len = newlen;
 ta_off = 0;
    }
...
clip_update_selection()
{
 ...
 if (!(((clip_star.start).lnum == (start).lnum) && ((clip_star.start).col == (start).col) && ((clip_star.start).coladd == (start).coladd))
  || !(((clip_star.end).lnum == (end).lnum) && ((clip_star.end).col == (end).col) && ((clip_star.end).coladd == (end).coladd))
...
# 493 "ui.c"
 ...
 cbd->owned = (clip_gen_own_selection(cbd) == 1);
    ...
    int is_drag;
{
 ...
 if (clip_star.state == 0)
     clip_start_selection(mouse_col, mouse_row, 0);
 ...
 clip_process_selection(0x03, mouse_col, mouse_row, 0);
}
    ...
    int repeated_click;
{
 ...
 case 1:
     ...
     clip_invert_area((int)cb->start.lnum, cb->word_start_col,
       (int)cb->end.lnum, cb->word_end_col, 2);
    ...
    int_u repeated_click;
{
 ...
 if (clip_isautosel()
  || (
      ...
      clip_autoselectml))
     clip_copy_modeless_selection(0);
...
# 1222 "ui.c"
     {
  ((__builtin_object_size ((char *)(bufp), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(bufp), (char *)(ScreenLines + LineOffset[row] + start_col), (size_t)(end_col - start_col), __builtin_object_size ((char *)(bufp), 1 > 1)) : __inline_strncpy_chk ((char *)(bufp), (char *)(ScreenLines + LineOffset[row] + start_col), (size_t)(end_col - start_col)));
    ...
    int col;
{
    ...
    if (row >= screen_Rows || col >= screen_Columns || ScreenLines == ((void *)0))
 return;
 ...
 if ((p[temp_col - 1] <= ' ' ? ' ' : vim_iswordc(p[temp_col - 1])) != start_class
 ...
 if ((p[temp_col] <= ' ' ? ' ' : vim_iswordc(p[temp_col])) != start_class
    ...
    int row;
{
    ...
    if (row >= screen_Rows || ScreenLines == ((void *)0))
 return 0;
...
get_input_buf()
{
 ...
 if (gap->ga_data != ((void *)0))
     ((__builtin_object_size ((char *)(gap->ga_data), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(gap->ga_data), (char *)(inbuf), (size_t)inbufcount, __builtin_object_size ((char *)(gap->ga_data), 0)) : __inline_memmove_chk ((char *)(gap->ga_data), (char *)(inbuf), (size_t)inbufcount));
    ...
    char_u *p;
{
 ...
 if (gap->ga_data != ((void *)0))
 {
     ((__builtin_object_size ((char *)(inbuf), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(inbuf), (char *)(gap->ga_data), gap->ga_len, __builtin_object_size ((char *)(inbuf), 0)) : __inline_memmove_chk ((char *)(inbuf), (char *)(gap->ga_data), gap->ga_len));
    ...
    long maxlen;
{
 ...
 maxlen = inbufcount;
    ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(buf), (char *)(inbuf), (size_t)maxlen, __builtin_object_size ((char *)(buf), 0)) : __inline_memmove_chk ((char *)(buf), (char *)(inbuf), (size_t)maxlen));
    inbufcount -= maxlen;
    if (inbufcount)
 ((__builtin_object_size ((char *)(inbuf), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(inbuf), (char *)(inbuf + maxlen), (size_t)inbufcount, __builtin_object_size ((char *)(inbuf), 0)) : __inline_memmove_chk ((char *)(inbuf), (char *)(inbuf + maxlen), (size_t)inbufcount));
    return (int)maxlen;
}
...
# 1736 "ui.c"
 ...
 len = read(read_cmd_fd,
     ...
     (char *)inbuf + inbufcount, (size_t)((4096 - inbufcount)
...
# 1809 "ui.c"
 while (len-- > 0)
 {
  ...
  ((__builtin_object_size ((char *)(inbuf), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(inbuf), (char *)(inbuf + inbufcount), (size_t)(len + 1), __builtin_object_size ((char *)(inbuf), 0)) : __inline_memmove_chk ((char *)(inbuf), (char *)(inbuf + inbufcount), (size_t)(len + 1)));
  inbufcount = 0;
  got_int = 1;
     }
     ++inbufcount;
...
read_error_exit()
{
    if (silent_mode)
 getout(0);
    ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff), (char *)(((char *)("Vim: Error reading input, exiting...\n"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff), (char *)(((char *)("Vim: Error reading input, exiting...\n")))));
    preserve_exit();
}
 ...
 else if (row == 0)
 {
  ...
  curwin->w_valid &= ~(0x80);
    ...
    if (
     ...
     col >= curwin->w_onebuf_opt.wo_fdc

    ...
    colnr_T wcol;
{
 ...
 else
 {
     ...
     if (b > 0 && b < ((0x7fffffffL) - 2 * (curwin->w_width)))
  pos->coladd = b;
    ...
    unsigned size;
{
    ...
    if (p != ((void *)0))
 (void)((__builtin_object_size ((p), 0) != (size_t) -1) ? __builtin___memset_chk ((p), (0), ((size_t)size), __builtin_object_size ((p), 0)) : __inline_memset_chk ((p), (0), ((size_t)size)));
    return p;
}
    ...
    char_u *string;
{
    ...
    p = alloc(len);
    if (p != ((void *)0))
 ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p), (char *)(string), (size_t)len, __builtin_object_size ((char *)(p), 0)) : __inline_memmove_chk ((char *)(p), (char *)(string), (size_t)len));
    return p;
}
    ...
    int len;
{
    ...
    if (p != ((void *)0))
    {
 ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(p), (char *)(string), (size_t)(len), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strncpy_chk ((char *)(p), (char *)(string), (size_t)(len)));
 p[len] = '\000';
    }
    return p;
}
    ...
    char_u *ptr;
{
    ...
    while (--q > ptr && ((q[0]) == ' ' || (q[0]) == '\t') && q[-1] != '\\' && q[-1] != 22)
 *q = '\000';
}
...
vim_strncpy(to, from, len)
    ...
    size_t len;
{
    ((__builtin_object_size ((char *)(to), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(to), (char *)(from), (size_t)(len), __builtin_object_size ((char *)(to), 1 > 1)) : __inline_strncpy_chk ((char *)(to), (char *)(from), (size_t)(len)));
    to[len] = '\000';
}
# 1651 "misc2.c"
    int
    ...
    int n;
{
 ...
 {
     ((__builtin_object_size ((char *)(pp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(pp), (char *)(gap->ga_data), (size_t)(gap->ga_itemsize * gap->ga_len), __builtin_object_size ((char *)(pp), 0)) : __inline_memmove_chk ((char *)(pp), (char *)(gap->ga_data), (size_t)(gap->ga_itemsize * gap->ga_len)));
    ...
    garray_T *gap;
{
    ...
    for (i = 0; i < gap->ga_len; ++i)
 len += (int)strlen((char *)(((char_u **)(gap->ga_data))[i])) + 1;
 ...
 *s = '\000';
 ...
 {
     if (*s != '\000')
  ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(s), (char *)(","), __builtin_object_size ((char *)(s), 1 > 1)) : __inline_strcat_chk ((char *)(s), (char *)(",")));
     ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(s), (char *)(((char_u **)(gap->ga_data))[i]), __builtin_object_size ((char *)(s), 1 > 1)) : __inline_strcat_chk ((char *)(s), (char *)(((char_u **)(gap->ga_data))[i])));
 }
    }
    return s;
}
    ...
    char_u *s;
{
    ...
    {
 ((__builtin_object_size ((char *)((char *)gap->ga_data + gap->ga_len), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((char *)gap->ga_data + gap->ga_len), (char *)(s), (size_t)len, __builtin_object_size ((char *)((char *)gap->ga_data + gap->ga_len), 0)) : __inline_memmove_chk ((char *)((char *)gap->ga_data + gap->ga_len), (char *)(s), (size_t)len));
 gap->ga_len += len;
    }
}
    ...
    int modifiers;
{
 ...
 else
 {
  ...
  while (*s)
    ...
    {
 ((__builtin_object_size ((char *)(string + idx), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(string + idx), (char *)(key_names_table[table_idx].name), __builtin_object_size ((char *)(string + idx), 1 > 1)) : __inline_strcpy_chk ((char *)(string + idx), (char *)(key_names_table[table_idx].name)));
    ...
    int *modp;
{
    ...
    if ((modifiers & 0x02) && ((key) < 0x7f && isalpha(key)))
    {
 ...
 modifiers &= ~0x02;
    ...
    if ((modifiers & 0x04)
     ...
     && ((key >= '?' && key <= '_') || ((key) < 0x7f && isalpha(key)))
    ...
    char_u *name;
{
 ...
 string[1] = name[3];
 string[2] = '\000';
 if (add_termcap_entry(string, 0) == 1)
     return (-((name[2]) + ((int)(name[3]) << 8)));
    }
    else
 for (i = 0; key_names_table[i].name != ((void *)0); i++)
 {
...
get_key_name(i)
    int i;
{
    if (i >= (int)(sizeof(key_names_table) / sizeof(struct key_name_entry)))
 return ((void *)0);
    ...
    int opt;
{
    ...
    {
 verbose_enter();
 smsg((char_u *)((char *)("Calling shell to execute: \"%s\"")),
          cmd == ((void *)0) ? p_sh : cmd);
 out_char('\n');
 cursor_on();
 verbose_leave();
...
# 3128 "misc2.c"
 ...
 else
 {
     ...
     if (ncmd != ((void *)0))
     {
  ((__builtin_object_size ((char *)(ncmd), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ncmd), (char *)(p_sxq), __builtin_object_size ((char *)(ncmd), 1 > 1)) : __inline_strcpy_chk ((char *)(ncmd), (char *)(p_sxq)));
  ((__builtin_object_size ((char *)(ncmd), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ncmd), (char *)(cmd), __builtin_object_size ((char *)(ncmd), 1 > 1)) : __inline_strcat_chk ((char *)(ncmd), (char *)(cmd)));
  ((__builtin_object_size ((char *)(ncmd), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ncmd), (char *)(p_sxq), __builtin_object_size ((char *)(ncmd), 1 > 1)) : __inline_strcat_chk ((char *)(ncmd), (char *)(p_sxq)));
...
crypt_push_state()
{
 ...
 emsg2((char_u *)(((char *)(e_intern2))), (char_u *)("crypt_push_state()"));
    ++crypt_busy;
}
    ...
    char_u *to;
{
 ...
 {
     ztemp = from[i];
     { ush temp; temp = (ush)keys[2] | 2; t = (int)(((unsigned)(temp * (temp ^ 1)) >> 8) & 0xff); };
     { keys[0] = (crc_32_tab[((int)(keys[0]) ^ ((ztemp))) & 0xff] ^ ((keys[0]) >> 8)); keys[1] += keys[0] & 0xff; keys[1] = keys[1] * 134775813L + 1; keys[2] = (crc_32_tab[((int)(keys[2]) ^ ((int)(keys[1] >> 24))) & 0xff] ^ ((keys[2]) >> 8)); };
     to[i] = t ^ ztemp;
 }
    else
    ...
    long len;
{
 ...
 for (p = ptr; p < ptr + len; ++p)
 {
     ...
     { keys[0] = (crc_32_tab[((int)(keys[0]) ^ ((*p ^= temp))) & 0xff] ^ ((keys[0]) >> 8)); keys[1] += keys[0] & 0xff; keys[1] = keys[1] * 134775813L + 1; keys[2] = (crc_32_tab[((int)(keys[2]) ^ ((int)(keys[1] >> 24))) & 0xff] ^ ((keys[2]) >> 8)); };
 }
    else
    ...
    char_u *passwd;
{
 ...
 if (use_crypt_method == 0)
 {
     ...
     {
  { keys[0] = (crc_32_tab[((int)(keys[0]) ^ (((int)*p))) & 0xff] ^ ((keys[0]) >> 8)); keys[1] += keys[0] & 0xff; keys[1] = keys[1] * 134775813L + 1; keys[2] = (crc_32_tab[((int)(keys[2]) ^ ((int)(keys[1] >> 24))) & 0xff] ^ ((keys[2]) >> 8)); };
     }
 }
 else
    ...
    int twice;
{
 ...
 cmdline_star = 1;
 cmdline_row = msg_row;
 p1 = getcmdline_prompt('\000', round == 0
  ? (char_u *)((char *)("Enter encryption key: "))
  : (char_u *)((char *)("Enter same key again: ")), 0, 0,
  ((void *)0));
 cmdline_star = 0;
    ...
    char_u *rel_fname;
{
 ...
 if (search_ctx == ((void *)0))
     goto error_return;
 ((__builtin_object_size ((search_ctx), 0) != (size_t) -1) ? __builtin___memset_chk ((search_ctx), (0), (sizeof(ff_search_ctx_T)), __builtin_object_size ((search_ctx), 0)) : __inline_memset_chk ((search_ctx), (0), (sizeof(ff_search_ctx_T))));
    }
 ...
 if (*++path != '\000')
    ...
    {
# 4403 "misc2.c"
 if (mch_dirname(ff_expand_buffer, 1024) == 0)
     goto error_return;
...
# 4506 "misc2.c"
 ...
 search_ctx->ffsc_fix_path[0] = '\000';
    ...
    ((__builtin_object_size ((char *)(ff_expand_buffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ff_expand_buffer), (char *)(search_ctx->ffsc_start_dir), __builtin_object_size ((char *)(ff_expand_buffer), 1 > 1)) : __inline_strcpy_chk ((char *)(ff_expand_buffer), (char *)(search_ctx->ffsc_start_dir)));
    add_pathsep(ff_expand_buffer);
    ((__builtin_object_size ((char *)(ff_expand_buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ff_expand_buffer), (char *)(search_ctx->ffsc_fix_path), __builtin_object_size ((char *)(ff_expand_buffer), 1 > 1)) : __inline_strcat_chk ((char *)(ff_expand_buffer), (char *)(search_ctx->ffsc_fix_path)));
    add_pathsep(ff_expand_buffer);
 ...
 goto error_return;
    ...
    if (search_ctx->ffsc_file_to_search == ((void *)0))
 goto error_return;
    ...
    char_u *buf;
{
 ...
 if (r_ptr[0] == '\\' && r_ptr[1] == ';')
 {
     ...
     ((__builtin_object_size ((char *)((r_ptr)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((r_ptr)), (char *)((r_ptr + 1)), strlen((char *)(r_ptr + 1)) + 1, __builtin_object_size ((char *)((r_ptr)), 0)) : __inline_memmove_chk ((char *)((r_ptr)), (char *)((r_ptr + 1)), strlen((char *)(r_ptr + 1)) + 1));
     r_ptr++;
 }
 r_ptr++;
    }
    ...
    void *search_ctx_arg;
{
 ...
 return ((void *)0);
    ...
    if ((file_path = alloc((int)1024)) == ((void *)0))
 return ((void *)0);
...
# 4758 "misc2.c"
  ...
  {
      ((__builtin_object_size ((char *)(file_path), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(file_path), (char *)(search_ctx->ffsc_start_dir), __builtin_object_size ((char *)(file_path), 1 > 1)) : __inline_strcpy_chk ((char *)(file_path), (char *)(search_ctx->ffsc_start_dir)));
      add_pathsep(file_path);
  }


  ((__builtin_object_size ((char *)(file_path), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(file_path), (char *)(stackp->ffs_fix_path), __builtin_object_size ((char *)(file_path), 1 > 1)) : __inline_strcat_chk ((char *)(file_path), (char *)(stackp->ffs_fix_path)));
  add_pathsep(file_path);
  ...
  if (*rest_of_wildcards != '\000')
  {
   ...
   if (*p == 0)
   {
       ...
       ((__builtin_object_size ((char *)((rest_of_wildcards)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((rest_of_wildcards)), (char *)((rest_of_wildcards + 3)), strlen((char *)(rest_of_wildcards + 3)) + 1, __builtin_object_size ((char *)((rest_of_wildcards)), 0)) : __inline_memmove_chk ((char *)((rest_of_wildcards)), (char *)((rest_of_wildcards + 3)), strlen((char *)(rest_of_wildcards + 3)) + 1));
   }
   else
       rest_of_wildcards += 3;
...
# 4835 "misc2.c"
...

  {
   ...
   ((__builtin_object_size ((char *)(file_path), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(file_path), (char *)(stackp->ffs_filearray[i]), __builtin_object_size ((char *)(file_path), 1 > 1)) : __inline_strcpy_chk ((char *)(file_path), (char *)(stackp->ffs_filearray[i])));
   add_pathsep(file_path);
   ((__builtin_object_size ((char *)(file_path), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(file_path), (char *)(search_ctx->ffsc_file_to_search), __builtin_object_size ((char *)(file_path), 1 > 1)) : __inline_strcat_chk ((char *)(file_path), (char *)(search_ctx->ffsc_file_to_search)));
...
# 4954 "misc2.c"
    ...
    if (mch_dirname(ff_expand_buffer, 1024)
         == 1)
    {
        p = shorten_fname(file_path,
           ff_expand_buffer);
        if (p != ((void *)0))
     ((__builtin_object_size ((char *)((file_path)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((file_path)), (char *)((p)), strlen((char *)(p)) + 1, __builtin_object_size ((char *)((file_path)), 0)) : __inline_memmove_chk ((char *)((file_path)), (char *)((p)), strlen((char *)(p)) + 1));
    }
# 4977 "misc2.c"
    return file_path;
       }
  ...
  for (i = stackp->ffs_filearray_cur;
       i < stackp->ffs_filearray_size; ++i)
  {
      if (strcasecmp((char *)(((stackp->ffs_filearray[i]))), (char *)(((stackp->ffs_fix_path)))) == 0)
  ...
  && search_ctx->ffsc_stopdirs_v != ((void *)0) && !got_int)
 {
  ...
  break;
     ...
     ((__builtin_object_size ((char *)(file_path), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(file_path), (char *)(search_ctx->ffsc_start_dir), __builtin_object_size ((char *)(file_path), 1 > 1)) : __inline_strcpy_chk ((char *)(file_path), (char *)(search_ctx->ffsc_start_dir)));
     add_pathsep(file_path);
     ((__builtin_object_size ((char *)(file_path), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(file_path), (char *)(search_ctx->ffsc_fix_path), __builtin_object_size ((char *)(file_path), 1 > 1)) : __inline_strcat_chk ((char *)(file_path), (char *)(search_ctx->ffsc_fix_path)));
...

{
 ...
 if (
  ...
  strcasecmp((char *)(((vp->ffv_fname))), (char *)(((ff_expand_buffer)))) == 0
    )
 {
 ...
 else
 {
     ...
     ((__builtin_object_size ((char *)(vp->ffv_fname), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(vp->ffv_fname), (char *)(ff_expand_buffer), __builtin_object_size ((char *)(vp->ffv_fname), 1 > 1)) : __inline_strcpy_chk ((char *)(vp->ffv_fname), (char *)(ff_expand_buffer)));
    ...
    int star_star_empty;
{
 ...
 wc_part = (char_u *)"";
    ...
    if (new->ffs_fix_path == ((void *)0)

     || new->ffs_wc_path == ((void *)0)
    ...
    char_u **stopdirs_v;
{
 ...
 if ((int)strlen((char *)(stopdirs_v[i])) > path_len)
 {
     ...
     if (strncasecmp((char *)(((stopdirs_v[i]))), (char *)(((path))), (size_t)(((path_len)))) == 0
      && vim_ispathsep(stopdirs_v[i][path_len]))
  return 1;
 }
 else
 {
     if (strcasecmp((char *)(((stopdirs_v[i]))), (char *)(((path)))) == 0)
  return 1;
 }
    }
    return 0;
    ...
    char_u *rel_fname;
{
     ...
     *curbuf->b_p_path == '\000' ? p_path : curbuf->b_p_path,
...
# 5692 "misc2.c"
 ...
 if (first == 1)
 {
  ...
  {
      ((__builtin_object_size ((char *)(NameBuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(NameBuff), (char *)(rel_fname), __builtin_object_size ((char *)(NameBuff), 1 > 1)) : __inline_strcpy_chk ((char *)(NameBuff), (char *)(rel_fname)));
      ((__builtin_object_size ((char *)(gettail(NameBuff)), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(gettail(NameBuff)), (char *)(ff_file_to_find), __builtin_object_size ((char *)(gettail(NameBuff)), 1 > 1)) : __inline_strcpy_chk ((char *)(gettail(NameBuff)), (char *)(ff_file_to_find)));
      l = (int)strlen((char *)(NameBuff));
  }
  else
  {
      ((__builtin_object_size ((char *)(NameBuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(NameBuff), (char *)(ff_file_to_find), __builtin_object_size ((char *)(NameBuff), 1 > 1)) : __inline_strcpy_chk ((char *)(NameBuff), (char *)(ff_file_to_find)));
      run = 2;
  }
 ...
 {
     if (find_what == 1)
  emsg2((char_u *)(((char *)("E344: Can't find directory \"%s\" in cdpath"))), (char_u *)(ff_file_to_find));

     else
  emsg2((char_u *)(((char *)("E345: Can't find file \"%s\" in path"))), (char_u *)(ff_file_to_find));

 }
 else
 {
     if (find_what == 1)
  emsg2((char_u *)(((char *)("E346: No more directory \"%s\" found in cdpath"))), (char_u *)(ff_file_to_find));

     else
  emsg2((char_u *)(((char *)("E347: No more file \"%s\" found in path"))), (char_u *)(ff_file_to_find));
    ...
    char_u *new_dir;
{
    ...
    dir_name = find_directory_in_path(new_dir, (int)strlen((char *)(new_dir)),
      1, curbuf->b_ffname);
    if (dir_name == ((void *)0))
 return -1;
    ...
    int len;
{
    if (username == ((void *)0))
    {
 if (mch_get_user_name(buf, len) == 0)
     return 0;

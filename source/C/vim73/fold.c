    ...
    int create;
{
 ...
 return 1;
    if (create)
 emsg((char_u *)(((char *)("E350: Cannot create fold with current 'foldmethod'"))));
    else
 emsg((char_u *)(((char *)("E351: Cannot delete fold with current 'foldmethod'"))));
    return 0;
}
    ...
    linenr_T end;
{
 ...
 if (cont > 0 && ga_grow(&fold_ga, cont) == 1)
 {
  ...
  end_rel = fp[cont - 1].fd_top + fp[cont - 1].fd_len - 1;
     ...
     ((__builtin_object_size ((char *)(fold_ga.ga_data), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(fold_ga.ga_data), (char *)(fp), sizeof(fold_T) * cont, __builtin_object_size ((char *)(fold_ga.ga_data), 0)) : __inline_memmove_chk ((char *)(fold_ga.ga_data), (char *)(fp), sizeof(fold_T) * cont));
     fold_ga.ga_len += cont;
     i += cont;
 ...
 if (i < gap->ga_len)
     ((__builtin_object_size ((char *)(fp + 1), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(fp + 1), (char *)((fold_T *)gap->ga_data + i), sizeof(fold_T) * (gap->ga_len - i), __builtin_object_size ((char *)(fp + 1), 0)) : __inline_memmove_chk ((char *)(fp + 1), (char *)((fold_T *)gap->ga_data + i), sizeof(fold_T) * (gap->ga_len - i)));
    ...
    garray_T *to;
{
    ...
    if (from->ga_len == 0 || ga_grow(to, from->ga_len) == 0)
 return;
    ...
    int recursive;
{
 ...
 --gap->ga_len;
 if (idx < gap->ga_len)
     ((__builtin_object_size ((char *)(fp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(fp), (char *)(fp + 1), sizeof(fold_T) * (gap->ga_len - idx), __builtin_object_size ((char *)(fp), 0)) : __inline_memmove_chk ((char *)(fp), (char *)(fp + 1), sizeof(fold_T) * (gap->ga_len - idx)));
    }
    else
    {
 ...
 if (ga_grow(gap, (int)(moved - 1)) == 1)
 {
  ...
  if (fp->fd_small == 2)
     ...
     if (idx < gap->ga_len)
  ((__builtin_object_size ((char *)(fp + moved), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(fp + moved), (char *)(fp + 1), sizeof(fold_T) * (gap->ga_len - idx), __builtin_object_size ((char *)(fp + moved), 0)) : __inline_memmove_chk ((char *)(fp + moved), (char *)(fp + 1), sizeof(fold_T) * (gap->ga_len - idx)));


     ((__builtin_object_size ((char *)(fp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(fp), (char *)(nfp), (size_t)(sizeof(fold_T) * moved), __builtin_object_size ((char *)(fp), 0)) : __inline_memmove_chk ((char *)(fp), (char *)(nfp), (size_t)(sizeof(fold_T) * moved)));
     vim_free(nfp);
     gap->ga_len += moved - 1;
 }
    }
    ...
    long amount_after;
{
    ...
    if (amount == (0x7fffffffL) && line2 >= line1 && line2 - line1 >= -amount_after)
 line2 = line1 - amount_after - 1;


    if ((State & 0x10) && amount == (linenr_T)1 && line2 == (0x7fffffffL))
 --line1;
    ...
    int markerlen;
{
 ...
 if (newline == ((void *)0))
     return;
 ((__builtin_object_size ((char *)(newline), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(newline), (char *)(line), __builtin_object_size ((char *)(newline), 1 > 1)) : __inline_strcpy_chk ((char *)(newline), (char *)(line)));
 if (p == ((void *)0))
     vim_strncpy(newline + line_len, marker, markerlen);
 else
 {
     ((__builtin_object_size ((char *)(newline + line_len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(newline + line_len), (char *)(cms), __builtin_object_size ((char *)(newline + line_len), 1 > 1)) : __inline_strcpy_chk ((char *)(newline + line_len), (char *)(cms)));
     ((__builtin_object_size ((char *)(newline + line_len + (p - cms)), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(newline + line_len + (p - cms)), (char *)(marker), (size_t)(markerlen), __builtin_object_size ((char *)(newline + line_len + (p - cms)), 1 > 1)) : __inline_strncpy_chk ((char *)(newline + line_len + (p - cms)), (char *)(marker), (size_t)(markerlen)));
     ((__builtin_object_size ((char *)(newline + line_len + (p - cms) + markerlen), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(newline + line_len + (p - cms) + markerlen), (char *)(p + 2), __builtin_object_size ((char *)(newline + line_len + (p - cms) + markerlen), 1 > 1)) : __inline_strcpy_chk ((char *)(newline + line_len + (p - cms) + markerlen), (char *)(p + 2)));
 }
    ...
    int markerlen;
{
 ...
 if (strncmp((char *)(p), (char *)(marker), (size_t)(markerlen)) == 0)
 {
  ...
  if (newline != ((void *)0))
  {
      ((__builtin_object_size ((char *)(newline), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(newline), (char *)(line), (size_t)(p - line), __builtin_object_size ((char *)(newline), 1 > 1)) : __inline_strncpy_chk ((char *)(newline), (char *)(line), (size_t)(p - line)));
      ((__builtin_object_size ((char *)(newline + (p - line)), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(newline + (p - line)), (char *)(p + len), __builtin_object_size ((char *)(newline + (p - line)), 1 > 1)) : __inline_strcpy_chk ((char *)(newline + (p - line)), (char *)(p + len)));
      ml_replace(lnum, newline, 0);
  }
     }
     break;
    ...
    char_u *buf;
{
 ...
 ((__builtin_object_size ((dashes), 0) != (size_t) -1) ? __builtin___memset_chk ((dashes), ('-'), ((size_t)level), __builtin_object_size ((dashes), 0)) : __inline_memset_chk ((dashes), ('-'), ((size_t)level)));
 dashes[level] = '\000';
    ...
    char_u *str;
{
    ...
    while (cms_slen > 0 && ((cms_start[cms_slen - 1]) == ' ' || (cms_start[cms_slen - 1]) == '\t'))
 --cms_slen;
 ...
 if (len != 0)
 {
     while (((s[len]) == ' ' || (s[len]) == '\t'))
  ++len;
     ((__builtin_object_size ((char *)((s)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((s)), (char *)((s + len)), strlen((char *)(s + len)) + 1, __builtin_object_size ((char *)((s)), 0)) : __inline_memmove_chk ((char *)((s)), (char *)((s + len)), strlen((char *)(s + len)) + 1));
 }
 else
 {
     ++s;
        ...
        && fp->fd_top <= flp->lnum_save))))
  {
   ...
   if (fp->fd_top >= startlnum && fp->fd_top != firstlnum)
   {
    ...
    foldMarkAdjustRecurse(&fp->fd_nested,
     (linenr_T)0, (linenr_T)(0x7fffffffL),
   ...
   foldMarkAdjustRecurse(&fp->fd_nested,
    (linenr_T)fp->fd_len, (linenr_T)(0x7fffffffL),
             (linenr_T)(0x7fffffffL), 0L);
   fold_changed = 1;
      }
  }
  else
...
# 2719 "fold.c"
 ...
 if (fp2->fd_top + fp2->fd_len > flp->lnum)
 {
  ...
  foldMarkAdjustRecurse(&fp2->fd_nested,
   ...
   (linenr_T)(0x7fffffffL), (long)(fp2->fd_top - flp->lnum));
    ...
    int i;
{
 ...
 return 0;
    fp = (fold_T *)gap->ga_data + i;
    if (i < gap->ga_len)
 ((__builtin_object_size ((char *)(fp + 1), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(fp + 1), (char *)(fp), sizeof(fold_T) * (gap->ga_len - i), __builtin_object_size ((char *)(fp + 1), 0)) : __inline_memmove_chk ((char *)(fp + 1), (char *)(fp), sizeof(fold_T) * (gap->ga_len - i)));
    ++gap->ga_len;
    ...
    linenr_T bot;
{
 ...
 if (fp->fd_top >= top)
 {
  ...
  foldMarkAdjustRecurse(&fp->fd_nested,
   ...
   (linenr_T)(0x7fffffffL), (long)(fp->fd_top - bot - 1));

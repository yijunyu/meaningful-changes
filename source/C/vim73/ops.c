    ...
    int amount;
{
 ...
 {
     if (amount == 1)
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("1 line %sed 1 time")), s);
     else
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("1 line %sed %d times")), s, amount);
 }
 else
 {
     if (amount == 1)
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("%ld lines %sed 1 time")), oap->line_count, s);

     else
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("%ld lines %sed %d times")), oap->line_count, s, amount);
    ...
    int amount;
{
 ...
 if (newp == ((void *)0))
     return;
 ((__builtin_object_size ((newp), 0) != (size_t) -1) ? __builtin___memset_chk ((newp), ('\000'), ((size_t)(bd.textcol + i + j + len)), __builtin_object_size ((newp), 0)) : __inline_memset_chk ((newp), ('\000'), ((size_t)(bd.textcol + i + j + len))));
 ((__builtin_object_size ((char *)(newp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp), (char *)(oldp), (size_t)bd.textcol, __builtin_object_size ((char *)(newp), 0)) : __inline_memmove_chk ((char *)(newp), (char *)(oldp), (size_t)bd.textcol));
 copy_chars(newp + bd.textcol, (size_t)i, '\011');
 copy_spaces(newp + bd.textcol + i, (size_t)j);

 ((__builtin_object_size ((char *)(newp + bd.textcol + i + j), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp + bd.textcol + i + j), (char *)(bd.textstart), (size_t)len, __builtin_object_size ((char *)(newp + bd.textcol + i + j), 0)) : __inline_memmove_chk ((char *)(newp + bd.textcol + i + j), (char *)(bd.textstart), (size_t)len));
    }
    else
    {
...
# 483 "ops.c"
 ...
 if (newp == ((void *)0))
     return;
 ((__builtin_object_size ((char *)(newp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp), (char *)(oldp), (size_t)(verbatim_copy_end - oldp), __builtin_object_size ((char *)(newp), 0)) : __inline_memmove_chk ((char *)(newp), (char *)(oldp), (size_t)(verbatim_copy_end - oldp)));
 copy_spaces(newp + (verbatim_copy_end - oldp), (size_t)fill);
 ((__builtin_object_size ((char *)((newp + (verbatim_copy_end - oldp) + fill)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((newp + (verbatim_copy_end - oldp) + fill)), (char *)((non_white)), strlen((char *)(non_white)) + 1, __builtin_object_size ((char *)((newp + (verbatim_copy_end - oldp) + fill)), 0)) : __inline_memmove_chk ((char *)((newp + (verbatim_copy_end - oldp) + fill)), (char *)((non_white)), strlen((char *)(non_white)) + 1));
    }
    ...
    struct block_def *bdp;
{
 ...
 ((__builtin_object_size ((char *)(newp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp), (char *)(oldp), (size_t)(offset), __builtin_object_size ((char *)(newp), 0)) : __inline_memmove_chk ((char *)(newp), (char *)(oldp), (size_t)(offset)));
 oldp += offset;
 ...
 ((__builtin_object_size ((char *)(newp + offset + spaces), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp + offset + spaces), (char *)(s), (size_t)s_len, __builtin_object_size ((char *)(newp + offset + spaces), 0)) : __inline_memmove_chk ((char *)(newp + offset + spaces), (char *)(s), (size_t)s_len));
 offset += s_len;
 ...
 if (spaces > 0)
     offset += count;
 ((__builtin_object_size ((char *)((newp + offset)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((newp + offset)), (char *)((oldp)), strlen((char *)(oldp)) + 1, __builtin_object_size ((char *)((newp + offset)), 0)) : __inline_memmove_chk ((char *)((newp + offset)), (char *)((oldp)), strlen((char *)(oldp)) + 1));
    ...
    int (*how) (void);
{
 ...
 if (i > 1
  ...
  && oap->line_count > p_report)
     smsg((char_u *)((char *)("%ld lines to indent... ")), i);
 ...
 if (i == 1)
     msg((char_u *)(((char *)("1 line indented "))));
 else
     smsg((char_u *)((char *)("%ld lines indented ")), i);
    }
...
valid_yank_reg(regname, writing)
    ...
    int writing;
{
    if ( (regname > 0 && ((regname) < 0x7f && isalnum(regname)))
    ...
    char_u *p;
{
 ...
 ((__builtin_object_size ((char *)(lp), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(lp), (char *)(*pp), __builtin_object_size ((char *)(lp), 1 > 1)) : __inline_strcpy_chk ((char *)(lp), (char *)(*pp)));
 ((__builtin_object_size ((char *)(lp), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(lp), (char *)(p), __builtin_object_size ((char *)(lp), 1 > 1)) : __inline_strcat_chk ((char *)(lp), (char *)(p)));
 vim_free(p);
 vim_free(*pp);
 *pp = lp;
    }
 ...
 if ((y_current->y_array =
   (char_u **)alloc((unsigned)sizeof(char_u *))) == ((void *)0))
 {
     vim_free(p);
     return 0;
 }
    ...
    int silent;
{
 ...
 p = vim_strsave_escaped_ext(last_cmdline,
  (char_u *)"\001\002\003\004\005\006\007\010\011\012\013\014\015\016\017\020\021\022\023\024\025\026\027\030\031\032\033\034\035\036\037", 22, 0);
 if (p != ((void *)0))
 {
    ...
    int remcr;
{
 ...
 if (y_current->y_type == 1
  || (i < y_current->y_size - 1
      && !(remcr
   && i == y_current->y_size - 2
   && *y_current->y_array[i + 1] == '\000')))
...
# 1643 "ops.c"
 ...
 for (lnum = curwin->w_cursor.lnum; lnum <= oap->end.lnum; ++lnum)
 {
  ...
  continue;
     ...
     ((__builtin_object_size ((char *)((newp + bd.textcol + bd.startspaces + bd.endspaces)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((newp + bd.textcol + bd.startspaces + bd.endspaces)), (char *)((oldp)), strlen((char *)(oldp)) + 1, __builtin_object_size ((char *)((newp + bd.textcol + bd.startspaces + bd.endspaces)), 0)) : __inline_memmove_chk ((char *)((newp + bd.textcol + bd.startspaces + bd.endspaces)), (char *)((oldp)), strlen((char *)(oldp)) + 1));
...
# 2086 "ops.c"
     ...
     if (newp == ((void *)0))
  continue;
     ((__builtin_object_size ((newp), 0) != (size_t) -1) ? __builtin___memset_chk ((newp), ('\000'), ((size_t)(oldlen + 1 + n)), __builtin_object_size ((newp), 0)) : __inline_memset_chk ((newp), ('\000'), ((size_t)(oldlen + 1 + n))));
...
# 2109 "ops.c"
  ...
  ((__builtin_object_size ((char *)((newp + strlen((char *)(newp)))), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((newp + strlen((char *)(newp)))), (char *)((oldp)), strlen((char *)(oldp)) + 1, __builtin_object_size ((char *)((newp + strlen((char *)(newp)))), 0)) : __inline_memmove_chk ((char *)((newp + strlen((char *)(newp)))), (char *)((oldp)), strlen((char *)(oldp)) + 1));
     }
    ...
    oparg_T *oap;
{
 ...
 redraw_curbuf_later(20);
    ...
    {
 if (oap->line_count == 1)
     msg((char_u *)(((char *)("1 line changed"))));
 else
     smsg((char_u *)((char *)("%ld lines changed")), oap->line_count);
    }
}
# 2351 "ops.c"
    static int
    ...
    oparg_T *oap;
{
 ...
 if (ins_len > 0)
 {
             ...
             linenr++)
  {
   ...
   ((__builtin_object_size ((char *)(newp + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp + offset), (char *)(ins_text), (size_t)ins_len, __builtin_object_size ((char *)(newp + offset), 0)) : __inline_memmove_chk ((char *)(newp + offset), (char *)(ins_text), (size_t)ins_len));
   offset += ins_len;
   oldp += bd.textcol;
   ((__builtin_object_size ((char *)((newp + offset)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((newp + offset)), (char *)((oldp)), strlen((char *)(oldp)) + 1, __builtin_object_size ((char *)((newp + offset)), 0)) : __inline_memmove_chk ((char *)((newp + offset)), (char *)((oldp)), strlen((char *)(oldp)) + 1));
    ...
    int mess;
{
 ...
 oap->regname = 0;
    else if (!clip_star.available && oap->regname == '+')
 oap->regname = 0;
 ...
 if (curwin->w_curswant == (0x7fffffffL) && y_current->y_width > 0)
     y_current->y_width--;
    }
 ...
 switch (y_current->y_type)
 {
  ...
  if ((y_current->y_array[y_idx] =
       vim_strsave(ml_get(lnum))) == ((void *)0))
      goto fail;
  break;
 ...
 if (curr->y_type == 0 && vim_strchr(p_cpo, '>') == ((void *)0))
 {
  ...
  goto fail;
     ...
     ((__builtin_object_size ((char *)(pnew), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(pnew), (char *)(curr->y_array[--j]), __builtin_object_size ((char *)(pnew), 1 > 1)) : __inline_strcpy_chk ((char *)(pnew), (char *)(curr->y_array[--j])));
     ((__builtin_object_size ((char *)(pnew), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(pnew), (char *)(y_current->y_array[0]), __builtin_object_size ((char *)(pnew), 1 > 1)) : __inline_strcat_chk ((char *)(pnew), (char *)(y_current->y_array[0])));
 ...
 if (yanklines > p_report)
 {
  ...
  if (oap->block_mode)
      msg((char_u *)(((char *)("block of 1 line yanked"))));
  else

      msg((char_u *)(((char *)("1 line yanked"))));
     }

     else if (oap->block_mode)
  smsg((char_u *)((char *)("block of %ld lines yanked")), yanklines);

     else
  smsg((char_u *)((char *)("%ld lines yanked")), yanklines);
 }
    }
    ...
    long y_idx;
{
 ...
 return 0;
    ...
    pnew += bd->startspaces;
    ((__builtin_object_size ((char *)(pnew), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(pnew), (char *)(bd->textstart), (size_t)bd->textlen, __builtin_object_size ((char *)(pnew), 0)) : __inline_memmove_chk ((char *)(pnew), (char *)(bd->textstart), (size_t)bd->textlen));
    pnew += bd->textlen;
    ...
    struct yankreg *reg;
{
   ...
   (long_u)(sizeof(char_u *) * y_current->y_size), 1);
    if (y_current->y_array == ((void *)0))
 y_current->y_size = 0;
    else
 for (j = 0; j < y_current->y_size; ++j)
     if ((y_current->y_array[j] = vim_strsave(curr->y_array[j])) == ((void *)0))
     {
  free_yank(j);
  y_current->y_size = 0;
  break;
...
# 3477 "ops.c"
 ...
 for (i = 0; i < y_size; ++i)
 {
  ...
  break;
     ...
     ptr = newp;
     ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ptr), (char *)(oldp), (size_t)bd.textcol, __builtin_object_size ((char *)(ptr), 0)) : __inline_memmove_chk ((char *)(ptr), (char *)(oldp), (size_t)bd.textcol));
     ptr += bd.textcol;
     ...
     for (j = 0; j < count; ++j)
     {
  ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ptr), (char *)(y_array[i]), (size_t)yanklen, __builtin_object_size ((char *)(ptr), 0)) : __inline_memmove_chk ((char *)(ptr), (char *)(y_array[i]), (size_t)yanklen));
  ptr += yanklen;
  ...
  if ((j < count - 1 || !shortline) && spaces)
  {
     ...
     ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ptr), (char *)(oldp + bd.textcol + delcount), (size_t)(oldlen - bd.textcol - delcount + 1), __builtin_object_size ((char *)(ptr), 0)) : __inline_memmove_chk ((char *)(ptr), (char *)(oldp + bd.textcol + delcount), (size_t)(oldlen - bd.textcol - delcount + 1)));
...
# 3660 "ops.c"
 ...
 if (y_type == 0 && y_size == 1)
 {
  ...
  for (i = 0; i < count; ++i)
  {
      ((__builtin_object_size ((char *)(ptr), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ptr), (char *)(y_array[0]), (size_t)yanklen, __builtin_object_size ((char *)(ptr), 0)) : __inline_memmove_chk ((char *)(ptr), (char *)(y_array[0]), (size_t)yanklen));
      ptr += yanklen;
  }
  ((__builtin_object_size ((char *)((ptr)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((ptr)), (char *)((oldp + col)), strlen((char *)(oldp + col)) + 1, __builtin_object_size ((char *)((ptr)), 0)) : __inline_memmove_chk ((char *)((ptr)), (char *)((oldp + col)), strlen((char *)(oldp + col)) + 1));
  ml_replace(lnum, newp, 0);
 ...
 else
 {
  ...
  if (y_type == 0)
  {
      ...
      if (newp == ((void *)0))
   goto error;
      ((__builtin_object_size ((char *)(newp), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(newp), (char *)(y_array[y_size - 1]), __builtin_object_size ((char *)(newp), 1 > 1)) : __inline_strcpy_chk ((char *)(newp), (char *)(y_array[y_size - 1])));
      ((__builtin_object_size ((char *)(newp), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(newp), (char *)(ptr), __builtin_object_size ((char *)(newp), 1 > 1)) : __inline_strcat_chk ((char *)(newp), (char *)(ptr)));
   ...
   goto error;
      ...
      ((__builtin_object_size ((char *)(newp + col), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(newp + col), (char *)(y_array[0]), (size_t)(yanklen + 1), __builtin_object_size ((char *)(newp + col), 0)) : __inline_memmove_chk ((char *)(newp + col), (char *)(y_array[0]), (size_t)(yanklen + 1)));
      ml_replace(lnum, newp, 0);
...
error:
  ...
  if (dir == 1)
     ...
     mark_adjust(curbuf->b_op_start.lnum + (y_type == 0),
          (linenr_T)(0x7fffffffL), nr_lines, 0L);
...
# 4258 "ops.c"
    ...
    {
 cend -= currsize;
 ((__builtin_object_size ((char *)(cend), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(cend), (char *)(curr), (size_t)currsize, __builtin_object_size ((char *)(cend), 0)) : __inline_memmove_chk ((char *)(cend), (char *)(curr), (size_t)currsize));
 if (spaces[t] > 0)
 {
     cend -= spaces[t];
    ...
    linenr_T Prenum1;
{
 ...
 while (ptr[col] != '\000'
  && !vim_isdigit(ptr[col])
  && !(doalp && ((ptr[col]) < 0x7f && isalpha(ptr[col]))))
     ++col;
 ...
 while (col > 0
  ...
  && !(doalp && ((ptr[col]) < 0x7f && isalpha(ptr[col]))))
    ...
    firstdigit = ptr[col];
    ;
    if ((!((firstdigit) >= '0' && (firstdigit) <= '9') && !(doalp && ((firstdigit) < 0x7f && isalpha(firstdigit))))
     || u_save_cursor() != 1)
    {
 beep_flush();
 return 0;
 ...
 if (hex == 0)
     __builtin___sprintf_chk ((char *)buf2, 0, __builtin_object_size ((char *)buf2, 1 > 1), "%lu", n);
 else if (hex == '0')
     __builtin___sprintf_chk ((char *)buf2, 0, __builtin_object_size ((char *)buf2, 1 > 1), "%lo", n);
 else if (hex && hexupper)
     __builtin___sprintf_chk ((char *)buf2, 0, __builtin_object_size ((char *)buf2, 1 > 1), "%lX", n);
 else
     __builtin___sprintf_chk ((char *)buf2, 0, __builtin_object_size ((char *)buf2, 1 > 1), "%lx", n);
  ...
  *ptr++ = '0';
 *ptr = '\000';
 ((__builtin_object_size ((char *)(buf1), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf1), (char *)(buf2), __builtin_object_size ((char *)(buf1), 1 > 1)) : __inline_strcat_chk ((char *)(buf1), (char *)(buf2)));
 ins_str(buf1);
 vim_free(buf1);
    }
    --curwin->w_cursor.col;
    ...
    int force;
{
 ...
 str++;
    ...
    {
 if (viminfo_error("E577: ", ((char *)("Illegal register name")), virp->vir_line))
     return 1;
 do_it = 0;
    }
    get_yank_register(*str++, 0);
    if (!force && y_current->y_array != ((void *)0))
 do_it = 0;
    ...
    FILE *fp;
{
 ...
 switch (y_regs[i].y_type)
 {
  ...
  break;
     ...
     default:
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("E574: Unknown register type %d")), y_regs[i].y_type);
    ...
    VimClipboard *cbd;
{
    ...
    if (cbd->owned)
    {
 if ((cbd == &clip_star && y_regs[37].y_array != ((void *)0))
  || (cbd == &clip_star && y_regs[37].y_array != ((void *)0)))
     return;
 ...
 oa.op_type = 2;
 ((__builtin_object_size ((&ca), 0) != (size_t) -1) ? __builtin___memset_chk ((&ca), (0), (sizeof(ca)), __builtin_object_size ((&ca), 0)) : __inline_memset_chk ((&ca), (0), (sizeof(ca))));
 ca.oap = &oa;
 ca.cmdchar = 'y';
 ca.count1 = 1;
 ca.retval = 2;
 ...
 *len += (long_u)strlen((char *)(y_ptr->y_array[i])) + eolsize;




    if (y_ptr->y_type == 0 && *len >= eolsize)
 *len -= eolsize;
    ...
    long *reglen;
{
 ...
 if (reglen != ((void *)0) && y_current->y_type == 2)
    ...
    int expr_src;
{
 ...
 for (i = 0; i < y_current->y_size; ++i)
 {
     ((__builtin_object_size ((char *)(retval + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(retval + len), (char *)(y_current->y_array[i]), __builtin_object_size ((char *)(retval + len), 1 > 1)) : __inline_strcpy_chk ((char *)(retval + len), (char *)(y_current->y_array[i])));
    ...
    long blocklen;
{
 ...
 if (s == ((void *)0))
     break;
 if (extra)
     ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s), (char *)(y_ptr->y_array[lnum]), (size_t)extra, __builtin_object_size ((char *)(s), 0)) : __inline_memmove_chk ((char *)(s), (char *)(y_ptr->y_array[lnum]), (size_t)extra));
 if (append)
     vim_free(y_ptr->y_array[lnum]);
 if (i)
     ((__builtin_object_size ((char *)(s + extra), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s + extra), (char *)(str + start), (size_t)i, __builtin_object_size ((char *)(s + extra), 0)) : __inline_memmove_chk ((char *)(s + extra), (char *)(str + start), (size_t)i));
 extra += i;
 s[extra] = '\000';
...
clear_oparg(oap)
    oparg_T *oap;
{
    ((__builtin_object_size ((oap), 0) != (size_t) -1) ? __builtin___memset_chk ((oap), (0), (sizeof(oparg_T)), __builtin_object_size ((oap), 0)) : __inline_memset_chk ((oap), (0), (sizeof(oparg_T))));
}
  ...
  switch (VIsual_mode)
  {
      ...
      case 'v':
   {
       ...
       colnr_T end_col = (lnum == max_pos.lnum)
          ? max_pos.col - start_col + 1 : (0x7fffffffL);
   ...
   line_count_info(ml_get(lnum),
    &word_count_cursor, &char_count_cursor,
     ...
     byte_count += line_count_info(ml_get(lnum), &word_count,
      &char_count, (long)(0x7fffffffL), eol_size);
 }

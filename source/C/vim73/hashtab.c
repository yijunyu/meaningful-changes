    ...
    hashtab_T *ht;
{
    ...
    ((__builtin_object_size ((ht), 0) != (size_t) -1) ? __builtin___memset_chk ((ht), (0), (sizeof(hashtab_T)), __builtin_object_size ((ht), 0)) : __inline_memset_chk ((ht), (0), (sizeof(hashtab_T))));
    ...
    char_u *key;
{
    ...
    if (!((hi)->hi_key == ((void *)0) || (hi)->hi_key == &hash_removed))
    {
 emsg2((char_u *)(((char *)(e_intern2))), (char_u *)("hash_add()"));
 return 0;
    }
    ...
    hash_T hash;
{
    ...
    if (ht->ht_error && hash_may_resize(ht, 0) == 0)
 return 0;
...
# 363 "hashtab.c"
 ...
 if (ht->ht_array == newarray)
 {
     ...
     ((__builtin_object_size ((char *)(temparray), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(temparray), (char *)(newarray), sizeof(temparray), __builtin_object_size ((char *)(temparray), 0)) : __inline_memmove_chk ((char *)(temparray), (char *)(newarray), sizeof(temparray)));
     oldarray = temparray;
 }
 else
 ...
 oldarray = ht->ht_array;
    ...
    ((__builtin_object_size ((newarray), 0) != (size_t) -1) ? __builtin___memset_chk ((newarray), (0), ((size_t)(sizeof(hashitem_T) * newsize)), __builtin_object_size ((newarray), 0)) : __inline_memset_chk ((newarray), (0), ((size_t)(sizeof(hashitem_T) * newsize))));
 ...
 if (!((olditem)->hi_key == ((void *)0) || (olditem)->hi_key == &hash_removed))
 {
  ...
  for (perturb = olditem->hi_hash; ; perturb >>= 5)
  {

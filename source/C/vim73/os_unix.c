    ...
    int len;
{
    ...
    if (p_wd)
 RealWaitForChar(read_cmd_fd, p_wd, ((void *)0));
}
# 360 "os_unix.c"
    int
...
# 84 "/usr/include/sys/sysctl.h" 3 4
...
# 78 "/usr/include/sys/event.h" 3 4
#pragma pack(4)
...
# 277 "/usr/include/sys/event.h" 3 4
struct au_sentry;
# 293 "/usr/include/sys/event.h" 3 4
struct knote;
...
# 113 "/usr/include/sys/sysctl.h" 3 4
struct ctlname {
 char *ctl_name;
 int ctl_type;
};
# 424 "/usr/include/sys/sysctl.h" 3 4
struct _pcred {
 char pc_lock[72];
...
# 518 "/usr/include/sys/sysctl.h" 3 4
struct xsw_usage {
 u_int64_t xsu_total;
 u_int64_t xsu_avail;
 u_int64_t xsu_used;
...
# 750 "/usr/include/sys/sysctl.h" 3 4
    ...
    int special __attribute__((unused));
{
    ...
    mib[1] = 6;
    len = sizeof(physmem);
    if (sysctl(mib, 2, &physmem, &len, ((void *)0), 0) == 0)
 mem = (long_u)physmem;
# 563 "os_unix.c"
    {
 struct rlimit rlp;
 ...
 if (getrlimit(2, &rlp) == 0
  ...
  && rlp.rlim_cur != (((__uint64_t)1 << 63) - 1)
...
# 844 "os_unix.c"
    static void
sig_winch (sigarg) int sigarg __attribute__((unused));
{
    ...
    static void
catch_sigint (sigarg) int sigarg __attribute__((unused));
{
...
mch_didjmp()
{
    ...
    static void
deathtrap (sigarg) int sigarg __attribute__((unused));
{
...
# 1330 "os_unix.c"
 ...
 else if (func_other != ((void (*)(int))-1))
     sigset(signal_info[i].sig, func_other);
}
# 1344 "os_unix.c"
    int
    ...
    int test_only;
{
    if (!test_only)
    {
 if (strncmp((char *)((term_strings[(int)(KS_NAME)])), (char *)("builtin_"), (size_t)(8)) == 0)
    ...
    char_u *icon;
{
    ...
    if ((term_strings[(int)(KS_NAME)]) == ((void *)0))
 return;
    if (title == ((void *)0) && icon == ((void *)0))
 return;
...
# 2026 "os_unix.c"
 ...
 if (oldtitle == ((void *)0)
     ...
     (void)get_x11_title(0);

 if (*(term_strings[(int)(KS_TS)]) != '\000')
     term_settitle(title);
# 2049 "os_unix.c"
 did_set_title = 1;
    }
    ...
    int which;
{
   ...
   (oldtitle ? oldtitle : p_titleold) : ((void *)0),
         ((which & 2) && did_set_icon) ? oldicon : ((void *)0));
}
    ...
    char_u *name;
{
    if (name == ((void *)0))
 return 0;
    return (strncasecmp((char *)(name), (char *)("xterm"), (size_t)(5)) == 0
  || strncasecmp((char *)(name), (char *)("nxterm"), (size_t)(6)) == 0
  || strncasecmp((char *)(name), (char *)("kterm"), (size_t)(5)) == 0
  || strncasecmp((char *)(name), (char *)("mlterm"), (size_t)(6)) == 0
  || strncasecmp((char *)(name), (char *)("rxvt"), (size_t)(4)) == 0
  || strcmp((char *)(name), (char *)("builtin_xterm")) == 0);
}
...
{
    return (name != ((void *)0)
     && (term_is_xterm || strncasecmp((char *)(name), (char *)("screen"), (size_t)(6)) == 0));
}
# 2138 "os_unix.c"
    int
use_xterm_mouse()
    ...
    char_u *name;
{
    if (name == ((void *)0))
 return 0;
    return (strncasecmp((char *)(name), (char *)("iris-ansi"), (size_t)(9)) == 0
     || strcmp((char *)(name), (char *)("builtin_iris-ansi")) == 0);
}
    ...
    char_u *name;
{
 ...
 return 0;
    ...
    return ((strncasecmp((char *)(name), (char *)("vt"), (size_t)(2)) == 0
  && vim_strchr((char_u *)"12345", name[2]) != ((void *)0))
     || strcmp((char *)(name), (char *)("builtin_vt320")) == 0);
}
    ...
    char_u *name;
{
 ...
 return 1;
    return ( strncasecmp((char *)(name), (char *)("hpterm"), (size_t)(6)) == 0
     || strncasecmp((char *)(name), (char *)("sun-cmd"), (size_t)(7)) == 0
     || strncasecmp((char *)(name), (char *)("screen"), (size_t)(6)) == 0
     || strncasecmp((char *)(name), (char *)("dtterm"), (size_t)(6)) == 0);
}
    ...
    int len;
{
    ...
    {
 ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)(strerror((*__error()))), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)(strerror((*__error())))));
 return 0;
    }
    return 1;
...
# 2456 "os_unix.c"
 ...
 {
     if (l > 0 && buf[l - 1] != '/' && *fname != '\000'
         && strcmp((char *)(fname), (char *)(".")) != 0)
  ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)("/"), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)("/")));
    ...
    if (retval == 0 || (int)(strlen((char *)(buf)) + strlen((char *)(fname))) >= len)
 return 0;


    if (strcmp((char *)(fname), (char *)(".")) != 0)
 ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(fname), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(fname)));
    ...
    int len __attribute__((unused));
{
 ...
 if (dirp != ((void *)0))
 {
  ...
  if (strcasecmp((char *)(tail), (char *)(dp->d_name)) == 0
   && strlen((char *)(tail)) == strlen((char *)(dp->d_name)))
  {
      ...
      {
   ((__builtin_object_size ((char *)(tail), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(tail), (char *)(dp->d_name), __builtin_object_size ((char *)(tail), 1 > 1)) : __inline_strcpy_chk ((char *)(tail), (char *)(dp->d_name)));
   break;
      }
  }
     }
    ...
    char_u *name;
{
 ...
 ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(name), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(name)));
    ...
    int tmode;
{
 ...
 tnew.c_lflag &= ~(0x00000100 | 0x00000008 | 0x00000080 | 0x00000002
 ...
 while (tcsetattr(read_cmd_fd, 0, &tnew) == -1
         && (*__error()) == 4 && n > 0)
     --n;
    }
# 3221 "os_unix.c"
...
check_mouse_termcode()
{
    ...
    {
 set_mouse_termcode(251, (char_u *)(term_is_8bit((term_strings[(int)(KS_NAME)]))
      ? "\233M"
      : "\033[M"));
 if (*p_mouse != '\000')
 {
    ...
    garray_T *gap;
{
    ...
    if (gap->ga_len > 0
     && !curbuf->b_p_bin
     && ((char_u *)gap->ga_data)[gap->ga_len - 1] == '\015')
 --gap->ga_len;
    ga_append(gap, '\000');
...
# 4276 "os_unix.c"
   ...
   for (i = ta_len; i < ta_len + len; ++i)
   {
    ...
    {
        ((__builtin_object_size ((char *)(ta_buf + i + 1), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ta_buf + i + 1), (char *)(ta_buf + i + 3), (size_t)(len - i - 2), __builtin_object_size ((char *)(ta_buf + i + 1), 0)) : __inline_memmove_chk ((char *)(ta_buf + i + 1), (char *)(ta_buf + i + 3), (size_t)(len - i - 2)));
...
# 4393 "os_unix.c"
   ...
   else if (toshell_fd >= 0)
   {
       ...
       {
    ta_len -= len;
    ((__builtin_object_size ((char *)(ta_buf), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ta_buf), (char *)(ta_buf + len), ta_len, __builtin_object_size ((char *)(ta_buf), 0)) : __inline_memmove_chk ((char *)(ta_buf), (char *)(ta_buf + len), ta_len));
       }
   }
        }
      }
...
# 4545 "os_unix.c"
      ...
      if ((wait_pid == (pid_t)-1 && (*__error()) == 10)
       || (wait_pid == pid && (((*(int *)&(status)) & 0177) == 0)))
      {
...
mch_breakcheck()
{
    if (curr_tmode == 2 && RealWaitForChar(read_cmd_fd, 0L, ((void *)0)))
 fill_input_buf(0);
}
...
# 4995 "os_unix.c"
 ...
 do { int __fd = (fd); ((&rfds)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);


 do { int __fd = (fd); ((&efds)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);

 maxfd = fd;
# 5052 "os_unix.c"
 if (nb_fd != -1)
 {
     do { int __fd = (nb_fd); ((&rfds)->fds_bits[__fd/(sizeof(__int32_t) * 8)] |= (1<<(__fd % (sizeof(__int32_t) * 8)))); } while(0);
     if (maxfd < nb_fd)
  maxfd = nb_fd;
 }
...
# 5409 "os_unix.c"
 ...
 if (strcmp((char *)(p_sh + len - 3), (char *)("csh")) == 0)
    ...
    if (shell_style == 0 && strstr((char *)gettail(p_sh),
        "sh") != ((void *)0))
 shell_style = 2;
...
# 5463 "os_unix.c"
 ...
 ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(command), (char *)("("), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcpy_chk ((char *)(command), (char *)("(")));
 ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)(pat[0] + 1), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)(pat[0] + 1)));
 ...
 *p-- = ')';
 ...
 ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)(">"), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)(">")));
    }
    else
    {
 if (flags & 0x04)
     ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(command), (char *)("set nonomatch; "), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcpy_chk ((char *)(command), (char *)("set nonomatch; ")));
 else
     ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(command), (char *)("unset nonomatch; "), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcpy_chk ((char *)(command), (char *)("unset nonomatch; ")));
 if (shell_style == 1)
     ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)("glob >"), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)("glob >")));
 else if (shell_style == 3)
     ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)("print -N >"), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)("print -N >")));
 else if (shell_style == 2)
     ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)(sh_vimglob_func), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)(sh_vimglob_func)));
 else
     ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)("echo >"), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)("echo >")));
    }

    ((__builtin_object_size ((char *)(command), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(command), (char *)(tempname), __builtin_object_size ((char *)(command), 1 > 1)) : __inline_strcat_chk ((char *)(command), (char *)(tempname)));
...
# 5692 "os_unix.c"
 ...
 if (shell_style == 3 && !did_find_nul)
 {
     ...
     if (len && (int)strlen((char *)(buffer)) < (int)len - 1)
  did_find_nul = 1;
     else
  check_spaces = 1;
 }
 ...
 if (!(flags & 0x04) && mch_getperm((*file)[i]) < 0)
     continue;
 ...
 if (!dir && (flags & 0x40) && !mch_can_exe((*file)[i]))
     continue;

 p = alloc((unsigned)(strlen((char *)((*file)[i])) + 1 + dir));
 if (p)
 {
     ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p), (char *)((*file)[i]), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcpy_chk ((char *)(p), (char *)((*file)[i])));
     if (dir)
  add_pathsep(p);
     (*file)[j++] = p;
 }
    ...
    int *number_result;
{
    ...
    hinstLib = dlopen((char *)libname, 0x1
 ...
 dlerr = (char *)dlerror();
 if (dlerr != ((void *)0))
     emsg2((char_u *)(((char *)("dlerror = \"%s\""))), (char_u *)(dlerr));
    }
...

 {
  ...
  if ((success = (ProcAdd != ((void *)0)

       && dlerr == ((void *)0)

       )))
  {
      if (string_result == ((void *)0))

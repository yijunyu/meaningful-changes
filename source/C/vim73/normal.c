...
init_normal_cmds()
{
    ...
    for (i = 0; i < (int)(sizeof(nv_cmds) / sizeof(struct nv_cmd)); ++i)
 nv_cmd_idx[i] = i;
...
getcount:
 ...
 while ( (c >= '1' && c <= '9')
  || (ca.count0 != 0 && (c == (-(('k') + ((int)('D') << 8))) || c == (-((253) + ((int)(KE_KDEL) << 8))) || c == '0')))
 {
...
# 1422 "normal.c"
 ...
 if ((((oap->start).lnum != (curwin->w_cursor).lnum) ? (oap->start).lnum < (curwin->w_cursor).lnum : (oap->start).col != (curwin->w_cursor).col ? (oap->start).col < (curwin->w_cursor).col : (oap->start).coladd < (curwin->w_cursor).coladd))
 {
  ...
  if (hasFolding(curwin->w_cursor.lnum, ((void *)0),
      ...
      curwin->w_cursor.col = (colnr_T)strlen((char *)(ml_get_curline()));
     }
    ...
    oparg_T *oap __attribute__((unused));
{
    ...
    if (*p_opfunc == '\000')
 emsg((char_u *)(((char *)("E774: 'operatorfunc' is empty"))));
    else
    {
...
check_visual_highlight()
{
 ...
 if (!did_check && highlight_attr[(int)(HLF_V)] == 0)
     msg((char_u *)(((char *)("Warning: terminal cannot highlight"))));
 did_check = 1;
    }
}
...
# 3465 "normal.c"
     while (ptr[col] != '\000'
      && (i == 0 ? !vim_iswordc(ptr[col]) : ((ptr[col]) == ' ' || (ptr[col]) == '\t'))
...
# 3519 "normal.c"
 ...
 if (find_type & 2)
     emsg((char_u *)(((char *)("E348: No string under cursor"))));
 else
...
clear_showcmd()
{
 ...
 if (VIsual_mode == 22)
 {
     ...
     __builtin___sprintf_chk ((char *)showcmd_buf, 0, __builtin_object_size ((char *)showcmd_buf, 1 > 1), "%ldx%ld", lines, (long)(rightcol - leftcol + 1));

 }
 else if (VIsual_mode == 'V' || VIsual.lnum != curwin->w_cursor.lnum)
     __builtin___sprintf_chk ((char *)showcmd_buf, 0, __builtin_object_size ((char *)showcmd_buf, 1 > 1), "%ld", lines);
 else
 {
     char_u *s, *e;
     int l;
  ...
  s += l;
     ...
     if (bytes == chars)
  __builtin___sprintf_chk ((char *)showcmd_buf, 0, __builtin_object_size ((char *)showcmd_buf, 1 > 1), "%d", chars);
     else
  __builtin___sprintf_chk ((char *)showcmd_buf, 0, __builtin_object_size ((char *)showcmd_buf, 1 > 1), "%d-%d", chars, bytes);
 }
 showcmd_buf[10] = '\000';
 showcmd_visual = 1;
    }
    ...
    int c;
{
 ...
 for (i = 0; ignore[i] != 0; ++i)
  ...
  return 0;
    ...
    if (overflow > 0)
 ((__builtin_object_size ((char *)(showcmd_buf), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(showcmd_buf), (char *)(showcmd_buf + overflow), old_len - overflow + 1, __builtin_object_size ((char *)(showcmd_buf), 0)) : __inline_memmove_chk ((char *)(showcmd_buf), (char *)(showcmd_buf + overflow), old_len - overflow + 1));

    ((__builtin_object_size ((char *)(showcmd_buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(showcmd_buf), (char *)(p), __builtin_object_size ((char *)(showcmd_buf), 1 > 1)) : __inline_strcat_chk ((char *)(showcmd_buf), (char *)(p)));
...
{
    if (p_sc)
 ((__builtin_object_size ((char *)(old_showcmd_buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(old_showcmd_buf), (char *)(showcmd_buf), __builtin_object_size ((char *)(old_showcmd_buf), 1 > 1)) : __inline_strcpy_chk ((char *)(old_showcmd_buf), (char *)(showcmd_buf)));
}
...
pop_showcmd()
{
 ...
 return;
    ...
    ((__builtin_object_size ((char *)(showcmd_buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(showcmd_buf), (char *)(old_showcmd_buf), __builtin_object_size ((char *)(showcmd_buf), 1 > 1)) : __inline_strcpy_chk ((char *)(showcmd_buf), (char *)(old_showcmd_buf)));
...
{
    if (!checkclearopq(cap->oap)
     && do_addsub((int)cap->cmdchar, cap->count1) == 1)
 prep_redo_cmd(cap);
}
    ...
    int thisblock;
{
    ...
    if ((len = find_ident_under_cursor(&ptr, 1)) == 0
     || find_decl(ptr, len, nchar == 'd', thisblock, 0) == 0)
 clearopbeep(oap);
    ...
    int searchflags;
{
 ...
 par_pos = curwin->w_cursor;
    ...
    {
 par_pos = curwin->w_cursor;
 while (curwin->w_cursor.lnum > 1 && *skipwhite(ml_get_curline()) != '\000')
     --curwin->w_cursor.lnum;
    }
    curwin->w_cursor.col = 0;
...
dozet:
 ...
 check_cursor_col();
    ...
    case 'E': if (foldmethodIsManual(curwin))
  {
      ...
      emsg((char_u *)(((char *)("E352: Cannot erase folds with current 'foldmethod'"))));
  break;
    ...
    case 'W':
  {
   ...
   curwin->w_cursor = pos;
      ...
      if (ptr == ((void *)0) && (len = find_ident_under_cursor(&ptr,
           1)) == 0)
   return;
    ...
    cmdarg_T *cap;
{
 ...
 do_cmdline(((void *)0), getexline, ((void *)0),
    ...
    cmdarg_T *cap;
{
 ...
 case 'K':
     if (kp_help)
  ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)("he! "), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)("he! ")));
     else
     {
  ...
  if (cap->count0 != 0 && !(isman || isman_s))
      __builtin___sprintf_chk ((char *)buf, 0, __builtin_object_size ((char *)buf, 1 > 1), ".,.+%ld", cap->count0 - 1);
  ...
  if (cap->count0 == 0 && isman_s)
      ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)("man"), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)("man")));
  else
      ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(kp), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(kp)));
  ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(" "), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(" ")));
  if (cap->count0 != 0 && (isman || isman_s))
  {
      __builtin___sprintf_chk ((char *)buf + strlen((char *)(buf)), 0, __builtin_object_size ((char *)buf + strlen((char *)(buf)), 1 > 1), "%ld", cap->count0);
      ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(" "), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(" ")));
  }
     }
     break;
 ...
 case ']':
  ...
  ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)("ts "), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)("ts ")));
     break;
 ...
 default:
  ...
  ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)("he! "), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)("he! ")));
     ...
     {
  if (g_cmd)
      ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)("tj "), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)("tj ")));
  else
      __builtin___sprintf_chk ((char *)buf, 0, __builtin_object_size ((char *)buf, 1 > 1), "%ldta ", cap->count0);
     }
    }
...
# 6396 "normal.c"
 ...
 else
 {
  ...
  ((cap->nchar & 0xf) == ('d' & 0xf)) ? 2 : 1,
  cap->count1,
  isupper(cap->nchar) ? 4 :
       islower(cap->nchar) ? 1 : 2,
  cap->cmdchar == ']' ? curwin->w_cursor.lnum + 1 : (linenr_T)1,
  (linenr_T)(0x7fffffffL));
     curwin->w_set_curswant = 1;
 }
    }
    else
    ...
    cmdarg_T *cap;
{
 ...
 else if (cap->cmdchar == 'g')
 {
  ...
  emsg((char_u *)(((char *)("E664: changelist is empty"))));
     else if (cap->count1 < 0)
  emsg((char_u *)(((char *)("E662: At start of changelist"))));
     else
  emsg((char_u *)(((char *)("E663: At end of changelist"))));
 }
 else
     clearopbeep(cap->oap);
 ...
 else
 {
  ...
  --curwin->w_cursor.col;
     ...
     while (curwin->w_cursor.col > 0
        && ((ptr[curwin->w_cursor.col]) == ' ' || (ptr[curwin->w_cursor.col]) == '\t'))
  --curwin->w_cursor.col;
     curwin->w_set_curswant = 1;
    ...
    int optype;
{
    ...
    if (optype == 0)
 set_vim_var_string(52, ((void *)0), 0);
    else
    {
    ...
    cmdarg_T *cap;
{
 ...
 if (restart_edit == 0
  ...
  && no_reason)
     msg((char_u *)(((char *)("Type  :quit<Enter>  to exit Vim"))));
    ...
    cmdarg_T *cap;
{
 ...
 if (VIsual_active)
 {
     ...
     if (regname == 0 || ((regname) >= '0' && (regname) <= '9')

    ...
    char_u *term;
{
 ...
 if (p->bt_entry == (int)KS_NAME)
 {
     ...
     if (strcmp((char *)(p->bt_string), (char *)("iris-ansi")) == 0 && vim_is_iris(term))
  return p;
     else if (strcmp((char *)(p->bt_string), (char *)("xterm")) == 0 && vim_is_xterm(term))
  return p;
     else
    ...
    if (strcmp((char *)(term), (char *)(p->bt_string)) == 0)
      return p;
 }
 ++p;
    }
    ...
    char_u *term;
{
 ...
 if ((int)p->bt_entry >= 0)
 {
     ...
     if (term_strings[p->bt_entry] == ((void *)0)
  ...
  if (term_8bit && term_7to8bit((char_u *)p->bt_string) != 0)
  {
   ...
   for (t = s; *t; ++t)
       ...
       {
    *t = term_7to8bit(t);
    ((__builtin_object_size ((char *)(t + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(t + 1), (char *)(t + 2), __builtin_object_size ((char *)(t + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(t + 1), (char *)(t + 2)));
       }
    ...
    int nr;
{
    ...
    t_colors = nr;
    if (t_colors > 1)
 __builtin___sprintf_chk ((char *)nr_colors, 0, __builtin_object_size ((char *)nr_colors, 1 > 1), "%d", t_colors);
    else
 *nr_colors = '\000';
...
# 1634 "term.c"
 ...
 if (try == 1)
 {
  ...
  {
      if (term_strings[(int)(string_names[i].dest)] == ((void *)0)
       || term_strings[(int)(string_names[i].dest)] == empty_option)
   term_strings[(int)(string_names[i].dest)] =
        vim_tgetstr((string_names[i].name), (&tp));
  }



  if (((term_strings[(int)(KS_MS)]) == ((void *)0) || (term_strings[(int)(KS_MS)]) == empty_option)
       && tgetflag("ms") > 0)
      (term_strings[(int)(KS_MS)]) = (char_u *)"y";
  if (((term_strings[(int)(KS_XS)]) == ((void *)0) || (term_strings[(int)(KS_XS)]) == empty_option)
       && tgetflag("xs") > 0)
      (term_strings[(int)(KS_XS)]) = (char_u *)"y";
  if (((term_strings[(int)(KS_DB)]) == ((void *)0) || (term_strings[(int)(KS_DB)]) == empty_option)
       && tgetflag("db") > 0)
      (term_strings[(int)(KS_DB)]) = (char_u *)"y";
  if (((term_strings[(int)(KS_DA)]) == ((void *)0) || (term_strings[(int)(KS_DA)]) == empty_option)
       && tgetflag("da") > 0)
      (term_strings[(int)(KS_DA)]) = (char_u *)"y";
  if (((term_strings[(int)(KS_UT)]) == ((void *)0) || (term_strings[(int)(KS_UT)]) == empty_option)
       && tgetflag("ut") > 0)
      (term_strings[(int)(KS_UT)]) = (char_u *)"y";
  ...
  for (i = 0; key_names[i] != ((void *)0); ++i)
  {
   ...
   if (p != ((void *)0)
    && (*p != 8
        || key_names[i][0] != 'k'
        || key_names[i][1] != 'l'))
       add_termcode((char_u *)key_names[i], p, 0);
      }
  }
  ...
  if (term_strings[(int)(KS_CCO)] == ((void *)0)
...
# 1779 "term.c"
  ...
  fprintf(__stderrp, "%s", ("\r\n"));
  for (termp = &(builtin_termcaps[0]); termp->bt_string != ((void *)0);
              ++termp)
  {
...
# 1895 "term.c"
 ...
 if (bs_p == ((void *)0) || *bs_p == '\000')
     add_termcode((char_u *)"kb", (bs_p = (char_u *)"\010"), 0);
 if ((del_p == ((void *)0) || *del_p == '\000') &&
         (bs_p == ((void *)0) || *bs_p != 0x7f))
     add_termcode((char_u *)"kD", (char_u *)(char_u *)"\177", 0);
    }
...
# 2002 "term.c"
...

 {
  ...
  if (curbuf->b_ml.ml_mfp != ((void *)0))
      apply_autocmds(EVENT_TERMCHANGED, ((void *)0), ((void *)0), 0,
              curbuf);
     }
    ...
    char_u *term;
{
 ...
 if (i < 0)
     ...
     return (char_u *)((char *)("E558: Terminal entry not found in terminfo"));
    ...
    long *rp;
{
    ...
    if ((term_strings[(int)(KS_NAME)]) != ((void *)0) && *(term_strings[(int)(KS_NAME)]) != '\000' && tgetent_error(tbuf, (term_strings[(int)(KS_NAME)])) == ((void *)0))
    {
 if (*cp == 0)
     *cp = tgetnum("co");
 if (*rp == 0)
    ...
    int force;
{
    ...
    char_u *error_msg = ((void *)0);
# 2260 "term.c"
    if (!force && find_termcode(name) != ((void *)0))
 return 1;

    term = (term_strings[(int)(KS_NAME)]);
    if (term == ((void *)0) || *term == '\000')
 return 0;
...
# 2286 "term.c"
 ...
 if (error_msg != ((void *)0))
     emsg((char_u *)(error_msg));
 else

     emsg2((char_u *)(((char *)("E436: No \"%s\" entry in termcap"))), (char_u *)(name));
    }
    return 0;
}
    ...
    int n;
{
    ...
    if (*(term_strings[(int)(KS_CAF)]))
 term_color((term_strings[(int)(KS_CAF)]), n);
    else if (*(term_strings[(int)(KS_CSF)]))
 term_color((term_strings[(int)(KS_CSF)]), n);
}
    ...
    int n;
{
    ...
    if (*(term_strings[(int)(KS_CAB)]))
 term_color((term_strings[(int)(KS_CAB)]), n);
    else if (*(term_strings[(int)(KS_CSB)]))
 term_color((term_strings[(int)(KS_CSB)]), n);
}
    ...
    int n;
{
    ...
    if (n >= 8 && t_colors >= 16
       && ((s[0] == '\033' && s[1] == '[') || (s[0] == 0x9b && (i = 1) == 1))
       && s[i] != '\000'
       && (strcmp((char *)(s + i + 1), (char *)("%p1%dm")) == 0
    || strcmp((char *)(s + i + 1), (char *)("%dm")) == 0)
       && (s[i] == '3' || s[i] == '4'))
    {
 __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%s%s%%p1%%dm", i == 2 ? "\033[" : "\233", s[i] == '3' ? (n >= 16 ? "38;5;" : "9") : (n >= 16 ? "48;5;" : "10"));
# 2778 "term.c"
 out_str((char_u *)(tgoto(buf, 0, n >= 16 ? n : n - 8)));
    }
    else
 out_str((char_u *)(tgoto((char *)s, 0, n)));
}
    ...
    int pairs;
{
    ...
    if (*(term_strings[(int)(KS_CM)]) == '\000')
 emsg((char_u *)(((char *)("E437: terminal capability \"cm\" required"))));




    if (*(term_strings[(int)(KS_CS)]) != '\000')
 scroll_region = 1;
    else
 scroll_region = 0;
 ...
 if (*(term_strings[(int)(KS_ME)]) == '\000')
     (term_strings[(int)(KS_ME)]) = (term_strings[(int)(KS_MR)]) = (term_strings[(int)(KS_MD)]) = (term_strings[(int)(KS_MB)]) = empty_option;
 if (*(term_strings[(int)(KS_SO)]) == '\000' || *(term_strings[(int)(KS_SE)]) == '\000')
     (term_strings[(int)(KS_SO)]) = (term_strings[(int)(KS_SE)]) = empty_option;
 if (*(term_strings[(int)(KS_US)]) == '\000' || *(term_strings[(int)(KS_UE)]) == '\000')
     (term_strings[(int)(KS_US)]) = (term_strings[(int)(KS_UE)]) = empty_option;
 if (*(term_strings[(int)(KS_CZH)]) == '\000' || *(term_strings[(int)(KS_CZR)]) == '\000')
     (term_strings[(int)(KS_CZH)]) = (term_strings[(int)(KS_CZR)]) = empty_option;


 if (*(term_strings[(int)(KS_VE)]) == '\000')
     (term_strings[(int)(KS_VI)]) = empty_option;
 ...
 if (*(term_strings[(int)(KS_SO)]) == '\000')
 {
     ...
     if (*(term_strings[(int)(KS_MR)]) == '\000')
  (term_strings[(int)(KS_SO)]) = (term_strings[(int)(KS_MD)]);
     else
  (term_strings[(int)(KS_SO)]) = (term_strings[(int)(KS_MR)]);
 }
 ...
 if (*(term_strings[(int)(KS_CZH)]) == '\000')
 {
     ...
     if (*(term_strings[(int)(KS_MR)]) == '\000')
  (term_strings[(int)(KS_CZH)]) = (term_strings[(int)(KS_MD)]);
     else
  (term_strings[(int)(KS_CZH)]) = (term_strings[(int)(KS_MR)]);
 }
 ...
 if (*(term_strings[(int)(KS_CSB)]) == '\000' && *(term_strings[(int)(KS_CAB)]) == '\000')
...
setmouse()
{
    ...
    int checkfor;
# 3358 "term.c"
    if (*p_mouse == '\000' || has_mouse_termcode == 0)
 return;
...
cursor_off()
{
    ...
    {
 if (!cursor_is_off)
     out_str((term_strings[(int)(KS_VI)]));
 cursor_is_off = 1;
    }
}
...
term_cursor_shape()
{
    ...
    if (!full_screen || *(term_strings[(int)(KS_CSI)]) == '\000' || *(term_strings[(int)(KS_CEI)]) == '\000')
 return;

    if (State & 0x10)
    {
 if (showing_insert_mode != 1)
     out_str((term_strings[(int)(KS_CSI)]));
 showing_insert_mode = 1;
    }
    else
    {
 if (showing_insert_mode != 0)
     out_str((term_strings[(int)(KS_CEI)]));
    ...
    int off;
{
    ...
    if (*(term_strings[(int)(KS_CSV)]) != '\000' && wp->w_width != Columns)
 out_str((char_u *)(tgoto((char *)(term_strings[(int)(KS_CSV)]), (wp->w_wincol) + wp->w_width - 1, (wp->w_wincol))));
...
scroll_region_reset()
{
    ...
    if (*(term_strings[(int)(KS_CSV)]) != '\000')
 out_str((char_u *)(tgoto((char *)(term_strings[(int)(KS_CSV)]), (int)Columns - 1, 0)));
    ...
    int flags;
{
 ...
 if (termcodes[i].name[0] == name[0])
 {
  ...
  continue;
     ...
     if (termcodes[i].name[1] == name[1])
     {
  if (flags == 55 && (j = termcode_star(
        termcodes[i].code, termcodes[i].len)) > 0)
  {


      if (len == termcodes[i].len - j
       && strncmp((char *)(s), (char *)(termcodes[i].code), (size_t)(len - 1)) == 0
       && s[len - 1]
...
switch_to_8bit()
{
 ...
 for (i = 0; i < tc_len; ++i)
 {
     ...
     if (c != 0)
     {
  ((__builtin_object_size ((char *)((termcodes[i].code + 1)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((termcodes[i].code + 1)), (char *)((termcodes[i].code + 2)), strlen((char *)(termcodes[i].code + 2)) + 1, __builtin_object_size ((char *)((termcodes[i].code + 1)), 0)) : __inline_memmove_chk ((char *)((termcodes[i].code + 1)), (char *)((termcodes[i].code + 2)), strlen((char *)(termcodes[i].code + 2)) + 1));
...

  {
   ...
   return -1;
      ...
      if (termcodes[idx].name[0] == 'K'
           && ((termcodes[idx].name[1]) >= '0' && (termcodes[idx].name[1]) <= '9'))
      {
   for (j = idx + 1; j < tc_len; ++j)
       if (termcodes[j].len == slen &&
        strncmp((char *)(termcodes[idx].code), (char *)(termcodes[j].code), (size_t)(slen)) == 0)
...
# 4016 "term.c"
 ...
 if (key_name[0] == '\000')
 {
     ...
     if (*(term_strings[(int)(KS_CRV)]) != '\000' && ((tp[0] == '\033' && tp[1] == '[' && len >= 3)
            || (tp[0] == 0x9b && len >= 2)))
     {
  j = 0;
  extra = 0;
  for (i = 2 + (tp[0] != 0x9b); i < len
    && !(tp[i] >= '{' && tp[i] <= '~')
    && !((tp[i]) < 0x7f && isalpha(tp[i])); ++i)
      if (tp[i] == ';' && ++j == 1)
  ...
  if (i > 2 + (tp[0] != 0x9b) && tp[i] == 'c')
  {
   ...
   if (extra >= 141)
   {
      ...
      && ((tp[0] == '\033' && tp[1] == 'P' && len >= 2)
   || tp[0] == 0x90))
     {
  j = 1 + (tp[0] != 0x90);
  for (i = j; i < len; ++i)
      if ((tp[i] == '\033' && tp[i + 1] == '\\' && i + 1 < len)
       || tp[i] == 0x9c)
      {
...
# 4263 "term.c"
   j = termcodes[idx].len;
      if (strncmp((char *)(tp), (char *)(tp + slen), (size_t)((size_t)j)) == 0
...
# 4286 "term.c"
  ...
  {
      if (mouse_code & 0x40)
   mouse_code |= (0x40 | 0x03);
  }
# 4328 "term.c"
     }
# 4671 "term.c"
     current_button = (mouse_code & 0x03);
     if (current_button == 0x03
     ...
     {
# 4686 "term.c"
  if ((mouse_code & (0x40 | 0x03)) == (0x40 | 0x03))
      is_drag = 1;
...
# 4708 "term.c"
  ...
  orig_mouse_code = mouse_code;
     ...
     if (!is_drag)
  held_button = mouse_code & 0x03;





     if (orig_mouse_code & 0x04)
  modifiers |= 0x02;
     if (orig_mouse_code & 0x10)
  modifiers |= 0x04;
     if (orig_mouse_code & 0x08)
  modifiers |= 0x08;
...
# 4911 "term.c"
 ...
 if (buf == ((void *)0))
 {
  ...
  ins_typebuf(string + slen, 0, offset, 0, 0);





     ((__builtin_object_size ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), (char *)(string), (size_t)new_slen, __builtin_object_size ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), 0)) : __inline_memmove_chk ((char *)(typebuf.tb_buf + typebuf.tb_off + offset), (char *)(string), (size_t)new_slen));
 ...
 else
 {
  ...
  ((__builtin_object_size ((char *)(buf + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(buf + offset), (char *)(buf + offset - extra), (size_t)(buflen + offset + extra), __builtin_object_size ((char *)(buf + offset), 0)) : __inline_memmove_chk ((char *)(buf + offset), (char *)(buf + offset - extra), (size_t)(buflen + offset + extra)));

     else if (extra > 0)

  ((__builtin_object_size ((char *)(buf + offset + extra), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(buf + offset + extra), (char *)(buf + offset), (size_t)(buflen - offset), __builtin_object_size ((char *)(buf + offset + extra), 0)) : __inline_memmove_chk ((char *)(buf + offset + extra), (char *)(buf + offset), (size_t)(buflen - offset)));

     ((__builtin_object_size ((char *)(buf + offset), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(buf + offset), (char *)(string), (size_t)new_slen, __builtin_object_size ((char *)(buf + offset), 0)) : __inline_memmove_chk ((char *)(buf + offset), (char *)(string), (size_t)new_slen));
 }
...
# 5196 "term.c"
  ...
  result[dlen++] = *src;
    ...
    if ((*bufp = vim_strsave(result)) != ((void *)0))
 from = *bufp;
    vim_free(result);
    return from;
}
    ...
    char_u *src;
{
 ...
 if (slen > 1 && strncmp((char *)(termcodes[i].code), (char *)(src), (size_t)((size_t)slen)) == 0)
     return i;
    }
    return -1;
}
    ...
    int printit;
{
 ...
 IObuff[3] = name[1];
    ...
    if (p[1] != 't')
 ((__builtin_object_size ((char *)(IObuff + 5), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(IObuff + 5), (char *)(p), __builtin_object_size ((char *)(IObuff + 5), 1 > 1)) : __inline_strcpy_chk ((char *)(IObuff + 5), (char *)(p)));
    else
 IObuff[5] = '\000';
...
check_for_codes_from_term()
{
 ...
 if (c != (0x80) && c != (-((253) + ((int)(KE_IGNORE) << 8))))
     break;
 c = vgetc();

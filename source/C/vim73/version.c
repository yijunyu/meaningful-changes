...
char *Version = "7.3";
static char *mediumVersion = "7.3";
# 51 "version.c"
char *longVersion = "VIM - Vi IMproved 7.3 (2010 Aug 15, compiled " "Jun 24 2011" " " "15:56:51" ")";
...
# 853 "version.c"
 ...
 msg_puts((char_u *)(((char *)("\nExtra patches: "))));
 s = "";
 for (i = 0; extra_patches[i] != ((void *)0); ++i)
 {
     msg_puts((char_u *)(s));
     s = ", ";
...
# 922 "version.c"
    msg_puts((char_u *)(((char *)("\nNormal version "))));
# 933 "version.c"
    msg_puts((char_u *)(((char *)("without GUI."))));
# 975 "version.c"
 ...
 if (msg_col > 0)
    ...
    version_msg("$VIM/vimrc");
    version_msg("\"\n");


    version_msg(((char *)("     user vimrc file: \"")));
    version_msg("$HOME/.vimrc");
    version_msg("\"\n");
# 1007 "version.c"
    version_msg(((char *)("      user exrc file: \"")));
    version_msg("$HOME/.exrc");
    version_msg("\"\n");
# 1044 "version.c"
 ...
 for (i = 0; i < (int)(sizeof(lines) / sizeof(char *)); ++i)
 {
  ...
  if (strstr(p, "children") != ((void *)0))
   ...
   : "type  :help register<Enter>   for information ";
     ...
     if (*p != '\000')
  do_intro_line(row, (char_u *)((char *)(p)), i == 2, 0);
     ++row;
 }
# 1225 "version.c"
    }
...
# 1258 "version.c"
    ...
    if (add_version)
    {
 ((__builtin_object_size ((char *)(vers), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(vers), (char *)(mediumVersion), __builtin_object_size ((char *)(vers), 1 > 1)) : __inline_strcpy_chk ((char *)(vers), (char *)(mediumVersion)));
 if (highest_patch())
 {
  ...
  if (isalpha((int)mediumVersion[4]))
      __builtin___sprintf_chk ((char *)vers + 5, 0, __builtin_object_size ((char *)vers + 5, 1 > 1), ".%d%s", highest_patch(), mediumVersion + 5);

  else
      __builtin___sprintf_chk ((char *)vers + 4, 0, __builtin_object_size ((char *)vers + 4, 1 > 1), ".%d%s", highest_patch(), mediumVersion + 4);

     }
     else
  __builtin___sprintf_chk ((char *)vers + 3, 0, __builtin_object_size ((char *)vers + 3, 1 > 1), ".%d", highest_patch());
 }
 col += (int)strlen((char *)(vers));
    }
    col = (Columns - col) / 2;
    if (col < 0)
 col = 0;
...
# 1298 "version.c"
 ...
 screen_puts_len(p, l, row, col, *p == '<' ? highlight_attr[(int)(HLF_8)] : attr);
 col += clen;
    }

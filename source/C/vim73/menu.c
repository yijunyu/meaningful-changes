    ...
    exarg_T *eap;
{
 ...
 {
     if (*arg == '\\')
  ((__builtin_object_size ((char *)((arg)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((arg)), (char *)((arg + 1)), strlen((char *)(arg + 1)) + 1, __builtin_object_size ((char *)((arg)), 0)) : __inline_memmove_chk ((char *)((arg)), (char *)((arg + 1)), strlen((char *)(arg + 1)) + 1));
     ++arg;
 }
 if (*arg != '\000')
 {
...
# 253 "menu.c"
 ...
 if (menu_is_popup(menu_path))
 {
  ...
  if (modes & (1 << i))
  {
      ...
      if (p != ((void *)0))
      {
   menu_nable_recurse(root_menu, p, ((1 << 6) - 1),
              enable);
   vim_free(p);
      }
  }
...

{
 ...
 while (menu != ((void *)0))
 {
  ...
  {
      if (!sys_menu)
   emsg((char_u *)(((char *)("E330: Menu path must not lead to a sub-menu"))));
      goto erret;
  }
  if (*next_name != '\000' && menu->children == ((void *)0)
...
# 684 "menu.c"
 ...
 for (i = 0; i < 7; ++i)
 {
  ...
  if (c != 0)
  {
   ...
   menu->strings[i][0] = c;
   if (d == 0)
       ((__builtin_object_size ((char *)(menu->strings[i] + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(menu->strings[i] + 1), (char *)(call_data), __builtin_object_size ((char *)(menu->strings[i] + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(menu->strings[i] + 1), (char *)(call_data)));
   else
   {
       menu->strings[i][1] = d;
       ((__builtin_object_size ((char *)(menu->strings[i] + 2), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(menu->strings[i] + 2), (char *)(call_data), __builtin_object_size ((char *)(menu->strings[i] + 2), 1 > 1)) : __inline_strcpy_chk ((char *)(menu->strings[i] + 2), (char *)(call_data)));
   }
   if (c == 3)
   {
    ...
    int idx;
{
 ...
 if (menu->children != ((void *)0))
 {
     ...
     if (should_advance)
  ((__builtin_object_size ((char *)(tbuffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(tbuffer), (char *)(menu->en_dname), __builtin_object_size ((char *)(tbuffer), 1 > 1)) : __inline_strcpy_chk ((char *)(tbuffer), (char *)(menu->en_dname)));
     else
     {

  ((__builtin_object_size ((char *)(tbuffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(tbuffer), (char *)(menu->dname), __builtin_object_size ((char *)(tbuffer), 1 > 1)) : __inline_strcpy_chk ((char *)(tbuffer), (char *)(menu->dname)));
  ...
  if (menu->en_dname == ((void *)0))
     ...
     ((__builtin_object_size ((char *)(tbuffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(tbuffer), (char *)("\001"), __builtin_object_size ((char *)(tbuffer), 1 > 1)) : __inline_strcat_chk ((char *)(tbuffer), (char *)("\001")));
     str = tbuffer;
 }
 else
    ...
    int idx;
{
    ...
    if (p != ((void *)0))
    {
 ((__builtin_object_size ((char *)(p + 6), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p + 6), (char *)(p + 5), (size_t)(len - 4), __builtin_object_size ((char *)(p + 6), 0)) : __inline_memmove_chk ((char *)(p + 6), (char *)(p + 5), (size_t)(len - 4)));
    ...
    exarg_T *eap;
{
 ...
 emsg2((char_u *)(((char *)("E335: Menu not defined for %s mode"))), (char_u *)(mode));
}
# 2384 "menu.c"
typedef struct
{
...
static garray_T menutrans_ga = {0, 0, 0, 0, ((void *)0)};
    ...
    char_u *arg_start;
{
 ...
 {
     *arg = '\011';
     ((__builtin_object_size ((char *)((arg + 1)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((arg + 1)), (char *)((arg + 5)), strlen((char *)(arg + 5)) + 1, __builtin_object_size ((char *)((arg + 1)), 0)) : __inline_memmove_chk ((char *)((arg + 1)), (char *)((arg + 5)), strlen((char *)(arg + 5)) + 1));
 }
 arg++;
    }
    if (*arg != '\000')

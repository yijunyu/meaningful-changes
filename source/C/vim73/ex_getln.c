...
# 378 "ex_getln.c"
 ...
 if (c == 28)
 {
  ...
  if (c == '=')
  {
      ...
      {
   ccline.cmdlen = len;
   ((__builtin_object_size ((char *)(ccline.cmdbuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(ccline.cmdbuff), (char *)(p), __builtin_object_size ((char *)(ccline.cmdbuff), 1 > 1)) : __inline_strcpy_chk ((char *)(ccline.cmdbuff), (char *)(p)));
   vim_free(p);
...
# 1265 "ex_getln.c"
 ...
 case (-((253) + ((int)(KE_RIGHTMOUSE) << 8))):
  ...
  if (mouse_row < cmdline_row && clip_star.available)
  {
      ...
      button = get_mouse_button((((unsigned)(-(c)) >> 8) & 0xff),
        &is_click, &is_drag);
      if (mouse_model_popup() && button == 0x00
            && (mod_mask & 0x02))
      {
...
# 1376 "ex_getln.c"
 ...
 case (-(('K') + ((int)('5') << 8))):
  ...
  if (lookfor == ((void *)0))
  {
      if ((lookfor = vim_strsave(ccline.cmdbuff)) == ((void *)0))
   goto cmdline_not_changed;
    ...
    int indent;
{
 ...
 if (!escaped)
 {
  ...
  c1 = '\n';
     ...
     if (c1 == '\010' || c1 == (-(('k') + ((int)('b') << 8)))
     || c1 == 0x7f || c1 == (-(('k') + ((int)('D') << 8))) || c1 == (-((253) + ((int)(KE_KDEL) << 8))))
     {
  if (line_ga.ga_len > 0)
  {
      --line_ga.ga_len;
...
add_indent:
  while (get_indent_str(p, 8) < indent)
  {
      ...
      ga_grow(&line_ga, 1);
      ((__builtin_object_size ((char *)(s + 1), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(s + 1), (char *)(s), line_ga.ga_len - (s - p) + 1, __builtin_object_size ((char *)(s + 1), 0)) : __inline_memmove_chk ((char *)(s + 1), (char *)(s), line_ga.ga_len - (s - p) + 1));
      *s = ' ';
      ++line_ga.ga_len;
  }
redraw:
    ...
    int len;
{
 ...
 return 0;
    ...
    ((__builtin_object_size ((char *)(ccline.cmdbuff), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ccline.cmdbuff), (char *)(p), (size_t)ccline.cmdlen, __builtin_object_size ((char *)(ccline.cmdbuff), 0)) : __inline_memmove_chk ((char *)(ccline.cmdbuff), (char *)(p), (size_t)ccline.cmdlen));
    ccline.cmdbuff[ccline.cmdlen] = '\000';
    vim_free(p);

    if (ccline.xpc != ((void *)0)
     && ccline.xpc->xp_pattern != ((void *)0)
     && ccline.xpc->xp_context != 0
    ...
    int redraw;
{
 ...
 {
     ((__builtin_object_size ((char *)(ccline.cmdbuff + ccline.cmdpos + len), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ccline.cmdbuff + ccline.cmdpos + len), (char *)(ccline.cmdbuff + ccline.cmdpos), (size_t)(ccline.cmdlen - ccline.cmdpos), __builtin_object_size ((char *)(ccline.cmdbuff + ccline.cmdpos + len), 0)) : __inline_memmove_chk ((char *)(ccline.cmdbuff + ccline.cmdpos + len), (char *)(ccline.cmdbuff + ccline.cmdpos), (size_t)(ccline.cmdlen - ccline.cmdpos)));
...
# 2789 "ex_getln.c"
 ...
 ((__builtin_object_size ((char *)(ccline.cmdbuff + ccline.cmdpos), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ccline.cmdbuff + ccline.cmdpos), (char *)(str), (size_t)len, __builtin_object_size ((char *)(ccline.cmdbuff + ccline.cmdpos), 0)) : __inline_memmove_chk ((char *)(ccline.cmdbuff + ccline.cmdpos), (char *)(str), (size_t)len));
 ccline.cmdbuff[ccline.cmdlen] = '\000';
# 2842 "ex_getln.c"
    ...
    struct cmdline_info *ccp;
{
    if (!prev_ccline_used)
    {
 ((__builtin_object_size ((&prev_ccline), 0) != (size_t) -1) ? __builtin___memset_chk ((&prev_ccline), (0), (sizeof(struct cmdline_info)), __builtin_object_size ((&prev_ccline), 0)) : __inline_memset_chk ((&prev_ccline), (0), (sizeof(struct cmdline_info))));
 prev_ccline_used = 1;
    }
    *ccp = prev_ccline;
    prev_ccline = ccline;
    ...
    int literally;
{
 ...
 while (*s != '\000')
 {
  ...
  c = *s++;
     if (cv == 22 || c == '\033' || c == 3 || c == '\015' || c == '\012'
...
cmdline_del(from)
    int from;
{
    ((__builtin_object_size ((char *)(ccline.cmdbuff + from), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ccline.cmdbuff + from), (char *)(ccline.cmdbuff + ccline.cmdpos), (size_t)(ccline.cmdlen - ccline.cmdpos + 1), __builtin_object_size ((char *)(ccline.cmdbuff + from), 0)) : __inline_memmove_chk ((char *)(ccline.cmdbuff + from), (char *)(ccline.cmdbuff + ccline.cmdpos), (size_t)(ccline.cmdlen - ccline.cmdpos + 1)));
    ...
    int options;
{
 ...
 if (v == 1)
 {
     ((__builtin_object_size ((char *)(&ccline.cmdbuff[ccline.cmdpos + difflen]), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(&ccline.cmdbuff[ccline.cmdpos + difflen]), (char *)(&ccline.cmdbuff[ccline.cmdpos]), (size_t)(ccline.cmdlen - ccline.cmdpos + 1), __builtin_object_size ((char *)(&ccline.cmdbuff[ccline.cmdpos + difflen]), 0)) : __inline_memmove_chk ((char *)(&ccline.cmdbuff[ccline.cmdpos + difflen]), (char *)(&ccline.cmdbuff[ccline.cmdpos]), (size_t)(ccline.cmdlen - ccline.cmdpos + 1)));


     ((__builtin_object_size ((char *)(&ccline.cmdbuff[i]), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(&ccline.cmdbuff[i]), (char *)(p2), strlen((char *)(p2)), __builtin_object_size ((char *)(&ccline.cmdbuff[i]), 0)) : __inline_memmove_chk ((char *)(&ccline.cmdbuff[i]), (char *)(p2), strlen((char *)(p2))));
...
# 3507 "ex_getln.c"
 ...
 {
     if (!(options & 64))
  emsg2((char_u *)(((char *)(e_nomatch2))), (char_u *)(str));
 }
 else
 {
 ...
 len = 0;
 for (i = 0; i < xp->xp_numfiles; ++i)
     len += (long_u)strlen((char *)(xp->xp_files[i])) + 1;
 ss = lalloc(len, 1);
 if (ss != ((void *)0))
 {
     *ss = '\000';
     for (i = 0; i < xp->xp_numfiles; ++i)
     {
  ((__builtin_object_size ((char *)(ss), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ss), (char *)(xp->xp_files[i]), __builtin_object_size ((char *)(ss), 1 > 1)) : __inline_strcat_chk ((char *)(ss), (char *)(xp->xp_files[i])));
  if (i != xp->xp_numfiles - 1)
      ((__builtin_object_size ((char *)(ss), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(ss), (char *)((options & 4) ? "\n" : " "), __builtin_object_size ((char *)(ss), 1 > 1)) : __inline_strcat_chk ((char *)(ss), (char *)((options & 4) ? "\n" : " ")));
     }
 }
    }
    ...
    char_u **pp;
{
    ...
    {
 p[0] = '\\';
 ((__builtin_object_size ((char *)(p + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + 1), (char *)(*pp), __builtin_object_size ((char *)(p + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(p + 1), (char *)(*pp)));
 vim_free(*pp);
 *pp = p;
    }
}
    ...
    int wildmenu __attribute__((unused));
{
 ...
 for (i = 0; i < lines; ++i)
 {
       ...
       || xp->xp_context == 9)
  {
   ...
   j = mch_isdir(halved_slash != ((void *)0) ? halved_slash
           : files_found[k]);
   vim_free(exp_path);
    ...
    int options;
{
 ...
 if (xp->xp_backslash != 0)
 {
  ...
  if (pat[i] == '\\')
  {
      if (xp->xp_backslash == 2
       ...
       && pat[i + 2] == '\\'
       && pat[i + 3] == ' ')
   ((__builtin_object_size ((char *)((pat + i)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((pat + i)), (char *)((pat + i + 3)), strlen((char *)(pat + i + 3)) + 1, __builtin_object_size ((char *)((pat + i)), 0)) : __inline_memmove_chk ((char *)((pat + i)), (char *)((pat + i + 3)), strlen((char *)(pat + i + 3)) + 1));
      if (xp->xp_backslash == 1
       && pat[i + 1] == ' ')
   ((__builtin_object_size ((char *)((pat + i)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((pat + i)), (char *)((pat + i + 1)), strlen((char *)(pat + i + 1)) + 1, __builtin_object_size ((char *)((pat + i)), 0)) : __inline_memmove_chk ((char *)((pat + i)), (char *)((pat + i + 1)), strlen((char *)(pat + i + 1)) + 1));
  }
 }

 if (xp->xp_context == 2)
     flags |= 0x02;
 else if (xp->xp_context == 38)
     flags |= (0x02 | 0x80);
 else
 ...
 return ExpandBufnames(pat, num_file, file, options);
    if (xp->xp_context == 6
     || xp->xp_context == 17)
 return expand_tags(xp->xp_context == 6, pat, num_file, file);
    if (xp->xp_context == 28)
 ...
 ret = ExpandSettings(xp, &regmatch, num_file, file);
    else if (xp->xp_context == 16)
 ret = ExpandMappings(&regmatch, num_file, file);

    else if (xp->xp_context == 30)
...

{
  ...
  *file = (char_u **)"";
  return 0;
    ...
    if (xp->xp_context != 21 && xp->xp_context != 11)
    ...
    int flagsarg;
{
 ...
 if (ret == 1)
 {
  ...
  for (i = 0; i < *num_file; ++i)
  {
   ...
   ((__builtin_object_size ((char *)((s)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((s)), (char *)((s + l)), strlen((char *)(s + l)) + 1, __builtin_object_size ((char *)((s)), 0)) : __inline_memmove_chk ((char *)((s)), (char *)((s + l)), strlen((char *)(s + l)) + 1));
    ...
    char_u ***file;
{
    ...
    if (xp->xp_arg == ((void *)0) || xp->xp_arg[0] == '\0')
 return ((void *)0);
    *num_file = 0;
    *file = ((void *)0);
    ...
    int expand_options;
{
 ...
 if (strlen((char *)(buf)) + strlen((char *)(file)) + 2 < 1024)
 {
     ...
     ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(file), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(file)));
     if (ExpandFromContext(&xpc, buf, &num_p, &p,
        64|expand_options) != 0 && num_p > 0)
     {
  ExpandEscape(&xpc, buf, num_p, p, 64|expand_options);
  for (len = 0, i = 0; i < num_p; ++i)
      len += (int)strlen((char *)(p[i])) + 1;
  ...
  if (ga_grow(&ga, len) == 1)
  {
      ...
      for (i = 0; i < num_p; ++i)
      {
   ((__builtin_object_size ((char *)(cur), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(cur), (char *)(p[i]), __builtin_object_size ((char *)(cur), 1 > 1)) : __inline_strcpy_chk ((char *)(cur), (char *)(p[i])));
   cur += strlen((char *)(p[i]));
   *cur++ = '\n';
      }
      ga.ga_len += len;
...
init_history()
{
 ...
 for (type = 0; type < 5; ++type)
 {
  ...
  temp = (histentry_T *)lalloc(
    (long_u)(newlen * sizeof(histentry_T)), 1);
  if (temp == ((void *)0))
  {
      if (type == 0)
      {
...
remove_key_from_history()
{
 ...
 return;
    ...
    if (p != ((void *)0))
 for ( ; *p; ++p)
     if (strncmp((char *)(p), (char *)("key"), (size_t)(3)) == 0 && !isalpha(p[3]))
     {
  p = vim_strchr(p + 3, '=');
  if (p == ((void *)0))
      break;
  ...
  for (i = 0; p[i] && !((p[i]) == ' ' || (p[i]) == '\t'); ++i)
      if (p[i] == '\\' && p[i + 1])
   ++i;
  ((__builtin_object_size ((char *)((p)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((p)), (char *)((p + i)), strlen((char *)(p + i)) + 1, __builtin_object_size ((char *)((p)), 0)) : __inline_memmove_chk ((char *)((p)), (char *)((p + i)), strlen((char *)(p + i)) + 1));
  --p;
     }
}
# 5684 "ex_getln.c"
 ...
 *end = i;
 ...
 ((__builtin_object_size ((char *)(((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(history_names[histype1]), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(history_names[histype1])))), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(history_names[histype1]), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(history_names[histype1])))), (char *)(" history"), __builtin_object_size ((char *)(((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(history_names[histype1]), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(history_names[histype1])))), 1 > 1)) : __inline_strcat_chk ((char *)(((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(history_names[histype1]), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(history_names[histype1])))), (char *)(" history")));
 ...
 if (idx >= 0 && j <= k)
   ...
   && hist[i].hisnum >= j && hist[i].hisnum <= k)
  {
   ...
   ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(hist[i].hisstr), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(hist[i].hisstr)));
      msg_outtrans(IObuff);
      out_flush();
  }
  if (i == idx)
    ...
    int asklen;
{
 ...
 if (len <= 0)
     ...
     (char_u **)lalloc((long_u)(len * sizeof(char_u *)), 0);
    ...
    vir_T *virp;
{
 ...
 if (val != ((void *)0) && *val != '\000')
 {
  ...
  if (p != ((void *)0))
  {
   ...
   ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p), (char *)(val + 1), (size_t)len, __builtin_object_size ((char *)(p), 0)) : __inline_memmove_chk ((char *)(p), (char *)(val + 1), (size_t)len));
   p[len] = (*val == ' ' ? '\000' : *val);
      }
      else
      {
   ...
   ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(p), (char *)(val), (size_t)len + 1, __builtin_object_size ((char *)(p), 0)) : __inline_memmove_chk ((char *)(p), (char *)(val), (size_t)len + 1));
   p[len + 1] = '\000';
      }
    ...
    FILE *fp;
{
 ...
 fprintf(fp, ((char *)("\n# %s History (newest to oldest):\n")),
       type == 0 ? ((char *)("Command Line")) :
       type == 1 ? ((char *)("Search String")) :
       type == 2 ? ((char *)("Expression")) :
     ((char *)("Input Line")));
 if (num_saved > hislen)
     num_saved = hislen;
 i = hisidx[type];

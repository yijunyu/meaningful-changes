...
# 121 "ex_cmds2.c"
    ...
    if (!debug_did_msg)
 msg((char_u *)(((char *)("Entering Debug mode.  Type \"cont\" to continue."))));
    if (sourcing_name != ((void *)0))
 msg(sourcing_name);
    if (sourcing_lnum != 0)
 smsg((char_u *)((char *)("line %ld: %s")), (long)sourcing_lnum, cmd);
    else
 smsg((char_u *)((char *)("cmd: %s")), cmd);
    ...
    exarg_T *eap;
{
 ...
 if (!eap->skip)
 {
  ...
  p = (char_u *)"";
     smsg((char_u *)((char *)("Breakpoint in \"%s%s\" line %ld")),
      p,
    ...
    exarg_T *eap;
{
 ...
 vim_free(bp->dbg_name);
    ...
    if (todel < 0)
 emsg2((char_u *)(((char *)("E161: Breakpoint not found: %s"))), (char_u *)(eap->arg));
    else
    {
 while (gap->ga_len > 0)
 {
     ...
     --gap->ga_len;
     if (todel < gap->ga_len)
  ((__builtin_object_size ((char *)(&(((struct debuggy *)gap->ga_data)[todel])), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(&(((struct debuggy *)gap->ga_data)[todel])), (char *)(&(((struct debuggy *)gap->ga_data)[todel + 1])), (gap->ga_len - todel) * sizeof(struct debuggy), __builtin_object_size ((char *)(&(((struct debuggy *)gap->ga_data)[todel])), 0)) : __inline_memmove_chk ((char *)(&(((struct debuggy *)gap->ga_data)[todel])), (char *)(&(((struct debuggy *)gap->ga_data)[todel + 1])), (gap->ga_len - todel) * sizeof(struct debuggy)));
    ...
    exarg_T *eap __attribute__((unused));
{
 ...
 msg((char_u *)(((char *)("No breakpoints defined"))));
    else
 for (i = 0; i < dbg_breakp.ga_len; ++i)
 {
     bp = &(((struct debuggy *)dbg_breakp.ga_data)[i]);
     smsg((char_u *)((char *)("%3d  %s %s  line %ld")),
      bp->dbg_nr,
    ...
    int *fp;
{
 ...
 {
     ((__builtin_object_size ((char *)(name), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(name), (char *)("<SNR>"), __builtin_object_size ((char *)(name), 1 > 1)) : __inline_strcpy_chk ((char *)(name), (char *)("<SNR>")));
     ((__builtin_object_size ((char *)(name + 5), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(name + 5), (char *)(fname + 3), __builtin_object_size ((char *)(name + 5), 1 > 1)) : __inline_strcpy_chk ((char *)(name + 5), (char *)(fname + 3)));
 }
    }
    ...
    int allbuf __attribute__((unused));
{
    if ( !forceit
     ...
     && (!checkaw || autowrite(buf, forceit) == 0))
    {
    ...
    int checkall;
{
   ...
   (buf->b_fname != ((void *)0)) ?
   buf->b_fname : (char_u *)((char *)("Untitled")));
    if (checkall)
    ...
    int hidden;
{
 ...
 if (check_changed(buf, p_awa, 1, 0, 1) && buf_valid(buf))
     break;
    }
 ...
 if (emsg2((char_u *)(((char *)("E162: No write since last change for buffer \"%s\""))), (char_u *)(buf_spname(buf) != ((void *)0) ? (char_u *)buf_spname(buf) : buf->b_fname)))
    ...
    int after __attribute__((unused));
{
 ...
 for (i = 0; i < new_ga.ga_len && !got_int; ++i)
 {
          ...
          (colnr_T)0))
  {
      ...
      ((__builtin_object_size ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + match), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + match), (char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + match + 1), (((curwin)->w_alist->al_ga.ga_len) - match - 1) * sizeof(aentry_T), __builtin_object_size ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + match), 0)) : __inline_memmove_chk ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + match), (char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + match + 1), (((curwin)->w_alist->al_ga.ga_len) - match - 1) * sizeof(aentry_T)));
   ...
   --curwin->w_arg_idx;
     ...
     vim_free(p);
     if (!didone)
  emsg2((char_u *)(((char *)(e_nomatch2))), (char_u *)(((char_u **)new_ga.ga_data)[i]));
 }
 ga_clear(&new_ga);
    }
    else
    ...
    win_T *win;
{
 ...
 if (win->w_arg_idx != ((win)->w_alist->al_ga.ga_len) - 1
  ...
  && (win->w_buffer->b_fnum == ((aentry_T *)global_alist.al_ga.ga_data)[(global_alist.al_ga.ga_len) - 1].ae_fnum
      || (win->w_buffer->b_ffname != ((void *)0)
   && (fullpathcmp(alist_name(&((aentry_T *)global_alist.al_ga.ga_data)[(global_alist.al_ga.ga_len) - 1]),
    win->w_buffer->b_ffname, 1) & 1))))
     arg_had_last = 1;
    }
    else
    ...
    exarg_T *eap;
{
 ...
 if (ga_grow(gap, (global_alist.al_ga.ga_len)) == 1)
    ...
    int argn;
{
 ...
 if (((curwin)->w_alist->al_ga.ga_len) <= 1)
     emsg((char_u *)(((char *)("E163: There is only one file to edit"))));
 else if (argn < 0)
     emsg((char_u *)(((char *)("E164: Cannot go before first file"))));
 else
     emsg((char_u *)(((char *)("E165: Cannot go beyond last file"))));
    }
    else
    {
 setpcmark();
...

 {
  ...
  vim_free(p);
    ...
    && check_changed(curbuf, 1, !other, eap->forceit, 0))
  return;
 }
    ...
    exarg_T *eap;
{
    ...
    if ( (buf_hide(curbuf))
     ...
     || !check_changed(curbuf, 1, 0, eap->forceit, 0))
    {
 if (*eap->arg != '\000')
 {
    ...
    exarg_T *eap;
{
 ...
 else
 {
  ...
  vim_free(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[i - 1].ae_fname);
     ((__builtin_object_size ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + eap->line1 - 1), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + eap->line1 - 1), (char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + eap->line2), (size_t)((((curwin)->w_alist->al_ga.ga_len) - eap->line2) * sizeof(aentry_T)), __builtin_object_size ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + eap->line1 - 1), 0)) : __inline_memmove_chk ((char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + eap->line1 - 1), (char *)(((aentry_T *)(curwin)->w_alist->al_ga.ga_data) + eap->line2), (size_t)((((curwin)->w_alist->al_ga.ga_len) - eap->line2) * sizeof(aentry_T))));
...
# 2362 "ex_cmds2.c"
 ...
 while (!got_int)
 {
  ...
  next_fnum = -1;
  for (buf = curbuf->b_next; buf != ((void *)0); buf = buf->b_next)
      if (buf->b_p_bl)
      {
    ...
    int after;
{
 ...
 if (after < ((curwin)->w_alist->al_ga.ga_len))
     ((__builtin_object_size ((char *)(&(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[after + count])), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(&(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[after + count])), (char *)(&(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[after])), (((curwin)->w_alist->al_ga.ga_len) - after) * sizeof(aentry_T), __builtin_object_size ((char *)(&(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[after + count])), 0)) : __inline_memmove_chk ((char *)(&(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[after + count])), (char *)(&(((aentry_T *)(curwin)->w_alist->al_ga.ga_data)[after])), (((curwin)->w_alist->al_ga.ga_len) - after) * sizeof(aentry_T)));
    ...
    exarg_T *eap;
{
 ...
 if (buf != ((void *)0))
 {
  ...
  emsg2((char_u *)(((char *)("E666: compiler not supported: %s"))), (char_u *)(eap->arg));
     vim_free(buf);
...
# 2677 "ex_cmds2.c"
 ...
 {
     verbose_enter();
     smsg((char_u *)((char *)("Searching for \"%s\" in \"%s\"")),
...
# 2952 "ex_cmds2.c"
 ...
 p = gettail(fname_exp);
 if ((*p == '.' || *p == '_')
  && (strcasecmp((char *)(p + 1), (char *)("vimrc")) == 0
      || strcasecmp((char *)(p + 1), (char *)("gvimrc")) == 0
 ...
 if (p_verbose > 0)
 {
     verbose_enter();
     if (sourcing_name == ((void *)0))
  smsg((char_u *)((char *)("could not source \"%s\"")), fname);
     else
  smsg((char_u *)((char *)("line %ld: could not source \"%s\"")),
       sourcing_lnum, fname);
     verbose_leave();
 }
 goto theend;
 ...
 verbose_enter();
 if (sourcing_name == ((void *)0))
     smsg((char_u *)((char *)("sourcing \"%s\"")), fname);
 else
     smsg((char_u *)((char *)("line %ld: sourcing \"%s\"")),
       sourcing_lnum, fname);
 verbose_leave();
    }
    if (is_vimrc == 1)
...
# 3122 "ex_cmds2.c"
 ...
 if (si->sn_name != ((void *)0)
  ...
  strcasecmp((char *)(((si->sn_name))), (char *)(((fname_exp)))) == 0))
     break;
    }
    if (current_SID == 0)
    {
    ...
    exarg_T *eap __attribute__((unused));
{
 ...
 if ((((scriptitem_T *)script_items.ga_data)[(i) - 1]).sn_name != ((void *)0))
     smsg((char_u *)"%3d: %s", i, (((scriptitem_T *)script_items.ga_data)[(i) - 1]).sn_name);
}
# 3310 "ex_cmds2.c"
    char_u *
get_scriptname(id)
...
{
    if (id == -1)
 return (char_u *)((char *)("modeline"));
    if (id == -2)
 return (char_u *)((char *)("--cmd argument"));
    if (id == -3)
 return (char_u *)((char *)("-c argument"));
    if (id == -4)
 return (char_u *)((char *)("environment variable"));
    if (id == -5)
 return (char_u *)((char *)("error handler"));
...
# 3433 "ex_cmds2.c"
 ...
 for (;;)
 {
  ...
  break;
     ...
     if (s == ((void *)0))
  break;
     ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(s), (char *)(line), __builtin_object_size ((char *)(s), 1 > 1)) : __inline_strcpy_chk ((char *)(s), (char *)(line)));
     ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(s), (char *)(p + 1), __builtin_object_size ((char *)(s), 1 > 1)) : __inline_strcat_chk ((char *)(s), (char *)(p + 1)));
     vim_free(line);
     line = s;
    ...
    exarg_T *eap;
{
 ...
 emsg((char_u *)(((char *)("E168: :finish used outside of a sourced file"))));
}

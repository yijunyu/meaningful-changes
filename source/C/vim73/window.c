    ...
    int xchar;
{
 ...
 Prenum1 = Prenum;
    ...
    case 19:
    case 's':
  if (cmdwin_type != 0) { emsg((char_u *)(((char *)(e_cmdwin)))); break; }
  ...
  ((__builtin_object_size ((char *)(cbuf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(cbuf), (char *)("split #"), __builtin_object_size ((char *)(cbuf), 1 > 1)) : __inline_strcpy_chk ((char *)(cbuf), (char *)("split #")));
  if (Prenum)
...
newwindow:
  ...
  if (nchar == 'v' || nchar == 22)
      ((__builtin_object_size ((char *)(cbuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(cbuf), (char *)("v"), __builtin_object_size ((char *)(cbuf), 1 > 1)) : __inline_strcat_chk ((char *)(cbuf), (char *)("v")));

  ((__builtin_object_size ((char *)(cbuf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(cbuf), (char *)("new"), __builtin_object_size ((char *)(cbuf), 1 > 1)) : __inline_strcat_chk ((char *)(cbuf), (char *)("new")));
  do_cmdline_cmd(cbuf);
  break;
  ...
  for (wp = firstwin; wp != ((void *)0); wp = wp->w_next)
   ...
   break;
  if (wp == ((void *)0))
      emsg((char_u *)(((char *)("E441: There is no preview window"))));
  else
      win_goto(wp);
  break;
...
wingotofile:
  ...
  find_pattern_in_path(ptr, 0, len, 1,
   Prenum == 0 ? 1 : 0, type,
   Prenum1, 3, (linenr_T)1, (linenr_T)(0x7fffffffL));
  ...
  if (bt_quickfix(curbuf))
  {
      __builtin___sprintf_chk ((char *)cbuf, 0, __builtin_object_size ((char *)cbuf, 1 > 1), "split +%ld%s", (long)curwin->w_cursor.lnum, (curwin->w_llist_ref == ((void *)0)) ? "cc" : "ll");
...
# 737 "window.c"
 ...
 if (new_size > oldwin_height - p_wmh - 1)
     new_size = oldwin_height - p_wmh - 1;
 if (new_size < p_wmh)
     new_size = p_wmh;
    ...
    int keep_curwin;
{
 ...
 nexttp = tp->tp_next;
 if (tp != curtab)
     for (wp = tp->tp_firstwin; wp != ((void *)0); wp = wp->w_next)
  if (wp->w_buffer == buf)
  {
    ...
    int forceit;
{
 ...
 emsg((char_u *)(((char *)("E445: Other window contains changes"))));
}
    ...
    win_T *oldwin;
{
 ...
 if (curwin == ((void *)0) || curbuf == ((void *)0))
     return 0;
    ...
    int height;
{
 ...
 wp->w_fraction = ((long)wp->w_wrow * 16384L
        + 16384L / 2) / (long)wp->w_height;
    ...
    linenr_T *file_lnum;
{
 ...
 ++ptr;
    ...
    {
 if (options & 1)
     emsg((char_u *)(((char *)("E446: No file name under cursor"))));
 return ((void *)0);
    }
    ...
    int len;
{
    ...
    res = eval_to_string_safe(curbuf->b_p_inex, ((void *)0),
        was_set_insecurely((char_u *)"includeexpr", 4));
...
path_is_url(p)
    char_u *p;
{
    if (strncmp((char *)(p), (char *)("://"), (size_t)((size_t)3)) == 0)
 return 1;
    else if (strncmp((char *)(p), (char *)(":\\\\"), (size_t)((size_t)3)) == 0)
 return 2;
    return 0;
}
    ...
    int perr;
{
    ...
    {
 if (perr == 1)
     emsgn((char_u *)("E802: Invalid ID: %ld (must be greater than or equal to 1)"), (long)(id));
 ...
 cur = cur->next;
    ...
    {
 if (perr == 1)
     emsgn((char_u *)("E803: ID not found: %ld"), (long)(id));
 return -1;
    }
    if (cur == prev)

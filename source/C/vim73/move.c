    ...
    int scroll;
{
 ...
 redraw_later(40);
    ...
    if (((curwin->w_valid & 0x01) == 0 && (curwin->w_onebuf_opt.wo_rnu
 ...
 || (curwin->w_onebuf_opt.wo_cuc && (curwin->w_valid & 0x04) == 0)
    ...
    lineoff_T *lp;
{
 ...
 if (lp->lnum < 1)
     lp->height = (0x7fffffffL);
 else

     if (hasFolding(lp->lnum, &lp->lnum, ((void *)0)))
    ...
    lineoff_T *lp;
{
 ...
 if (lp->lnum > curbuf->b_ml.ml_line_count)
     ...
     if (hasFolding(lp->lnum, ((void *)0), &lp->lnum))
    ...
    int set_topbot;
{
  ...
  curwin->w_topline = loff.lnum)
 {
     ...
     topline_back(&loff);
     if (loff.height == (0x7fffffffL) || used + loff.height > curwin->w_height)
  break;
     used += loff.height;
    ...
    linenr_T Prenum;
{
 ...
 curwin->w_onebuf_opt.wo_scr = (Prenum > curwin->w_height) ?
    ...
    n = (curwin->w_onebuf_opt.wo_scr <= curwin->w_height) ?

...
# 187 "tag.c"
      ...
      ))
 {
  ...
  else
  {
      ...
      if ((ptag_entry.tagname = vim_strsave(tag)) == ((void *)0))
   goto end_do_tag;
  }
     }
     else
 ...
 else
 {
     if (
      ...
      g_do_tagpreview ? ptag_entry.tagname == ((void *)0) :
  ...
  switch (type)
  {
      ...
      case 6: cur_match = (0x7fffffffL) - 1; break;
      case 3: cur_match += count; break;
      case 4: cur_match -= count; break;
  }
  if (cur_match >= (0x7fffffffL))
 ...
 if (new_tag
  || (cur_match >= num_matches && max_num_matches != (0x7fffffffL))
  || other_name)
 {
     if (other_name)
     {
 ...
 {
     if (verbose)
  emsg2((char_u *)(((char *)("E426: tag not found: %s"))), (char_u *)(name));
...
# 601 "tag.c"
  ...
  for (i = 0; i < num_matches; ++i)
  {
   ...
   len = 128;
      ...
      if (p == ((void *)0))
   continue;
      ((__builtin_object_size ((char *)(fname), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(fname), (char *)(p), __builtin_object_size ((char *)(fname), 1 > 1)) : __inline_strcpy_chk ((char *)(fname), (char *)(p)));
      vim_free(p);
   ...
   if (*cmd_start == '^')
   {
       ((__builtin_object_size ((char *)(cmd), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(cmd), (char *)("^"), __builtin_object_size ((char *)(cmd), 1 > 1)) : __inline_strcpy_chk ((char *)(cmd), (char *)("^")));
       cmd_start++;
       len++;
   }
   ...
   ((__builtin_object_size ((char *)(cmd), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(cmd), (char *)("\\V"), __builtin_object_size ((char *)(cmd), 1 > 1)) : __inline_strcat_chk ((char *)(cmd), (char *)("\\V")));
   len += 2;

   cmd_len = (int)(cmd_end - cmd_start + 1);
   if (cmd_len > (1024 - 5))
       cmd_len = 1024 - 5;
   ((__builtin_object_size ((char *)(cmd), 0) != (size_t) -1) ? __builtin___strncat_chk ((char *)(cmd), (char *)(cmd_start), (size_t)(cmd_len), __builtin_object_size ((char *)(cmd), 1 > 1)) : __inline_strncat_chk ((char *)(cmd), (char *)(cmd_start), (size_t)(cmd_len)));
   len += cmd_len;
  ...
  {
      if (num_matches == 1)
   emsg((char_u *)(((char *)("E427: There is only one matching tag"))));
      else
   emsg((char_u *)(((char *)("E428: Cannot go beyond last matching tag"))));
      skip_msg = 1;
  }
  ...
  smsg((char_u *)((char *)("File \"%s\" does not exist")), nofile_fname);
  ...
  __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("tag %d of %d%s")), cur_match + 1, num_matches, max_num_matches != (0x7fffffffL) ? ((char *)(" or more")) : "");



  if (ic)
      ((__builtin_object_size ((char *)(IObuff), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(IObuff), (char *)(((char *)("  Using tag with different case!"))), __builtin_object_size ((char *)(IObuff), 1 > 1)) : __inline_strcat_chk ((char *)(IObuff), (char *)(((char *)("  Using tag with different case!")))));
    ...
    exarg_T *eap __attribute__((unused));
{
 ...
 if (tagstack[i].tagname != ((void *)0))
 {
  ...
  continue;
     ...
     msg_putchar('\n');
     __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), "%c%2d %2d %-15s %5ld  ", i == tagstackidx ? '>' : ' ', i + 1, tagstack[i].cur_match + 1, tagstack[i].tagname, tagstack[i].fmark.mark.lnum);
...
# 1339 "tag.c"
 ...
 ga_init2(&ga_match[mtt], (int)sizeof(struct match_found *), 100);
    ...
    if (lbuf == ((void *)0) || tag_fname == ((void *)0)
...
# 1418 "tag.c"
 ...
 if (pats->len > 3 && pat[pats->len - 3] == '@'
       && ((pat[pats->len - 2]) < 0x7f && isalpha(pat[pats->len - 2]))
      && ((pat[pats->len - 1]) < 0x7f && isalpha(pat[pats->len - 1])))
 {
 ...
 pats->len = p_tl;
    ...
    ((__builtin_object_size ((&search_info), 0) != (size_t) -1) ? __builtin___memset_chk ((&search_info), (0), ((size_t)1), __builtin_object_size ((&search_info), 0)) : __inline_memset_chk ((&search_info), (0), ((size_t)1)));
# 1463 "tag.c"
...
# 1491 "tag.c"
 {
  ...
  if (i > 3 && tag_fname[i - 3] == '-')
      ((__builtin_object_size ((char *)(help_lang), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(help_lang), (char *)(tag_fname + i - 2), __builtin_object_size ((char *)(help_lang), 1 > 1)) : __inline_strcpy_chk ((char *)(help_lang), (char *)(tag_fname + i - 2)));
  else
      ((__builtin_object_size ((char *)(help_lang), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(help_lang), (char *)("en"), __builtin_object_size ((char *)(help_lang), 1 > 1)) : __inline_strcpy_chk ((char *)(help_lang), (char *)("en")));
...
# 1780 "tag.c"
  if (linear)
      ...
      state = TS_LINEAR;
  else if (strncmp((char *)(lbuf), (char *)("!_TAG_"), (size_t)(6)) > 0)
      state = TS_BINARY;
...
# 1873 "tag.c"
  ...
  for (p = lbuf; p < tagp.tagname_end; ++p)
  {
   ...
   if ( strncasecmp((char *)(((lbuf))), (char *)(((tagp.fname))), (size_t)(((p - lbuf)))) == 0
  ...
  if (state == TS_BINARY)
  {
      ...
      if (sortic)
   i = (int)(((tagp.tagname[0]) < 'a' || (tagp.tagname[0]) > 'z') ? (tagp.tagname[0]) : (tagp.tagname[0]) - ('a' - 'A'));
   ...
   tagcmp = strncmp((char *)(tagp.tagname), (char *)(pats->head), (size_t)(cmplen));
...
# 2076 "tag.c"
  ...
  if (pats->regmatch.rm_ic)
  {
      ...
      if (match)
   match_no_ic = (strncmp((char *)(tagp.tagname), (char *)(pats->pat), (size_t)(cmplen)) == 0);

  }
  else
      match = (strncmp((char *)(tagp.tagname), (char *)(pats->pat), (size_t)(cmplen)) == 0);
     }
...
# 2224 "tag.c"
   *tagp.tagname_end = '\000';
   ...
   if (mfp != ((void *)0))
   {
       ...
       p = mfp->match;
       ((__builtin_object_size ((char *)(p), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p), (char *)(tagp.tagname), __builtin_object_size ((char *)(p), 1 > 1)) : __inline_strcpy_chk ((char *)(p), (char *)(tagp.tagname)));

       p[len] = '@';
       ((__builtin_object_size ((char *)(p + len + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + len + 1), (char *)(help_lang), __builtin_object_size ((char *)(p + len + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(p + len + 1), (char *)(help_lang)));

       __builtin___sprintf_chk ((char *)p + len + 1 + 3, 0, __builtin_object_size ((char *)p + len + 1 + 3, 1 > 1), "%06d", help_heuristic(tagp.tagname, match_re ? matchoff : 0, !match_no_ic) + help_pri);
   ...
   *tagp.tagname_end = '\011';
   ...
   if (mfp != ((void *)0))
   {
       ...
       p = mfp->match;
       p[0] = mtt;
       ((__builtin_object_size ((char *)(p + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + 1), (char *)(tag_fname), __builtin_object_size ((char *)(p + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(p + 1), (char *)(tag_fname)));
...
# 2334 "tag.c"
       ((__builtin_object_size ((char *)(s), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(s), (char *)(lbuf), __builtin_object_size ((char *)(s), 1 > 1)) : __inline_strcpy_chk ((char *)(s), (char *)(lbuf)));
   }
      }
...
# 2351 "tag.c"
     for (i = ga_match[mtt].ga_len; --i >= 0 && !got_int; )
     {
        ...
        (ga_match[mtt].ga_data))[i];
         if (mfp2->len == mfp->len
          && memcmp((mfp2->match), (mfp->match), ((size_t)mfp->len)) == 0)
...
# 2425 "tag.c"
 ...
 if (stop_searching)
   ...
   break;
    ...
    {
 if (!did_open && verbose)
     emsg((char_u *)(((char *)("E433: No tags file"))));
 retval = 1;
    }
...
# 2487 "tag.c"
 ...
 for (i = 0; i < ga_match[mtt].ga_len; ++i)
 {
  ...
  ((__builtin_object_size ((char *)(mfp), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(mfp), (char *)(mfp->match), (size_t)(mfp->len + (help_only ? 6 : 0)), __builtin_object_size ((char *)(mfp), 0)) : __inline_memmove_chk ((char *)(mfp), (char *)(mfp->match), (size_t)(mfp->len + (help_only ? 6 : 0))));
...
static garray_T tag_fnames = {0, 0, 0, 0, ((void *)0)};
    ...
    char_u *buf;
{
    ...
    if (first)
 ((__builtin_object_size ((tnp), 0) != (size_t) -1) ? __builtin___memset_chk ((tnp), (0), (sizeof(tagname_T)), __builtin_object_size ((tnp), 0)) : __inline_memset_chk ((tnp), (0), (sizeof(tagname_T))));
...
# 2600 "tag.c"
 ...
 if (tnp->tn_hf_idx >= tag_fnames.ga_len)
 {
  ...
  return 0;
     ++tnp->tn_hf_idx;
     ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)(p_hf), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)(p_hf)));
     ((__builtin_object_size ((char *)(gettail(buf)), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(gettail(buf)), (char *)("tags"), __builtin_object_size ((char *)(gettail(buf)), 1 > 1)) : __inline_strcpy_chk ((char *)(gettail(buf)), (char *)("tags")));
 }
 else
     vim_strncpy(buf, ((char_u **)(tag_fnames.ga_data))[
          tnp->tn_hf_idx++], 1024 - 1);
 return 1;
    }
 ...
 else
 {
  ...
  return 0;
     ...
     ((__builtin_object_size ((char *)((filename + 1)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((filename + 1)), (char *)((filename)), strlen((char *)(filename)) + 1, __builtin_object_size ((char *)((filename + 1)), 0)) : __inline_memmove_chk ((char *)((filename + 1)), (char *)((filename)), strlen((char *)(filename)) + 1));
     *filename++ = '\000';
  ...
  tnp->tn_did_filefind_init = 1;
    ...
    ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)(fname), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)(fname)));
    vim_free(fname);
    return 1;
}
    ...
    tagptrs_T *tagp;
{
    ...
    if ( p < tagp->tagname_end
     && *p == ':'
     && strncasecmp((char *)(((tagp->tagname))), (char *)(((tagp->fname))), (size_t)(((len)))) == 0)
    {
 tagp->tagname = p + 1;
 return 1;
    }
...
# 3203 "tag.c"
 ...
 if (str > pbuf_end - 1)
 {
       ...
       search_options, ((void *)0)))
  {
   ...
   __builtin___sprintf_chk ((char *)pbuf, 0, __builtin_object_size ((char *)pbuf, 1 > 1), "^\\[#a-zA-Z_]\\.\\*\\<%s\\s\\*(", tagp.tagname);
    ...
    int expand;
{
 ...
 ExpandInit(&xpc);
 xpc.xp_context = 2;
 expanded_fname = ExpandOne(&xpc, (char_u *)fname, ((void *)0),
       1|64, 2);
 ...
 if (retval != ((void *)0))
 {
     ((__builtin_object_size ((char *)(retval), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(retval), (char *)(tag_fname), __builtin_object_size ((char *)(retval), 1 > 1)) : __inline_strcpy_chk ((char *)(retval), (char *)(tag_fname)));
 ...
 else if (p[0] == '.' && (vim_ispathsep(p[1]) || p[1] == '\000'))
 {
  ...
  if (p[1] != '\000')
   ...
   ++tail;
      ...
      --p;
  ((__builtin_object_size ((char *)((p)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((p)), (char *)((tail)), strlen((char *)(tail)) + 1, __builtin_object_size ((char *)((p)), 0)) : __inline_memmove_chk ((char *)((p)), (char *)((tail)), strlen((char *)(tail)) + 1));
     }
 }
 else if (p[0] == '.' && p[1] == '.' &&
...
# 3560 "tag.c"
  ...
  if (p == start + 2 && p[-2] == '.')
  {
      ((__builtin_object_size ((char *)((p - 2)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((p - 2)), (char *)((p)), strlen((char *)(p)) + 1, __builtin_object_size ((char *)((p - 2)), 0)) : __inline_memmove_chk ((char *)((p - 2)), (char *)((p)), strlen((char *)(p)) + 1));
      tail -= 2;
  }
  p = tail;
     }
    ...
    char_u ***file;
{
 ...
 ret = find_tags(pat, num_file, file,
  ...
  for (i = 0; i < *num_file; i++)
  {
      ...
      ((__builtin_object_size ((char *)(tagnm), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(tagnm), (char *)(t_p.tagname), (size_t)c, __builtin_object_size ((char *)(tagnm), 0)) : __inline_memmove_chk ((char *)(tagnm), (char *)(t_p.tagname), (size_t)c));
      tagnm[c++] = 0;
      tagnm[c++] = (t_p.tagkind != ((void *)0) && *t_p.tagkind)
        ? *t_p.tagkind : 'f';
      tagnm[c++] = 0;
      ((__builtin_object_size ((char *)((*file)[i] + c), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((*file)[i] + c), (char *)(t_p.fname), t_p.fname_end - t_p.fname, __builtin_object_size ((char *)((*file)[i] + c), 0)) : __inline_memmove_chk ((char *)((*file)[i] + c), (char *)(t_p.fname), t_p.fname_end - t_p.fname));
      (*file)[i][c + (t_p.fname_end - t_p.fname)] = 0;
      ((__builtin_object_size ((char *)((*file)[i]), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((*file)[i]), (char *)(tagnm), (size_t)c, __builtin_object_size ((char *)((*file)[i]), 0)) : __inline_memmove_chk ((char *)((*file)[i]), (char *)(tagnm), (size_t)c));
 }
    }
    return ret;
}

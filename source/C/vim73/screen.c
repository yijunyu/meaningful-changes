...
# 529 "screen.c"
 ...
 showmode();
    ...
    if (!did_intro && (curbuf->b_ml.ml_line_count == 1 && *ml_get((linenr_T)1) == '\000')
...
# 2122 "screen.c"
 ...
 screen_fill((wp->w_winrow) + row, (wp->w_winrow) + endrow,
  (wp->w_wincol) + n, (int)(wp->w_wincol + wp->w_width),
...
# 2454 "screen.c"
 ...
 if (len > 0)
 {
  ...
  ((__builtin_object_size ((char *)(current_ScreenLine + col), 0) != (size_t) -1) ? __builtin___strncpy_chk ((char *)(current_ScreenLine + col), (char *)(text), (size_t)(len), __builtin_object_size ((char *)(current_ScreenLine + col), 1 > 1)) : __inline_strncpy_chk ((char *)(current_ScreenLine + col), (char *)(text), (size_t)(len)));
     col += len;
 }
    }
...
# 2493 "screen.c"
  ...
  >= (colnr_T)strlen((char *)(ml_get_buf(wp->w_buffer, lnume, 0))))))))
 {
  ...
  {
      if (wp->w_old_cursor_lcol + txtcol < (colnr_T)(wp->w_width))
   len = wp->w_old_cursor_lcol;
      else
   len = (wp->w_width) - txtcol;
      for (ri = 0; ri < len - (int)wp->w_old_cursor_fcol; ++ri) ScreenAttrs[off + (wp->w_old_cursor_fcol + txtcol) + ri] = highlight_attr[(int)(HLF_V)];
    ...
    int attr;
{
    ...
    ((__builtin_object_size ((char *)(ScreenLines + off), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ScreenLines + off), (char *)(buf), (size_t)len, __builtin_object_size ((char *)(ScreenLines + off), 0)) : __inline_memmove_chk ((char *)(ScreenLines + off), (char *)(buf), (size_t)len));
...
# 2832 "screen.c"
 ...
 else
 {
  ...
  nextlinecol = 0;
  ((__builtin_object_size ((char *)(nextline), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(nextline), (char *)(line), (size_t)v, __builtin_object_size ((char *)(nextline), 0)) : __inline_memmove_chk ((char *)(nextline), (char *)(line), (size_t)v));
  ((__builtin_object_size ((char *)((nextline + v)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((nextline + v)), (char *)((nextline + 150)), strlen((char *)(nextline + 150)) + 1, __builtin_object_size ((char *)((nextline + v)), 0)) : __inline_memmove_chk ((char *)((nextline + v)), (char *)((nextline + 150)), strlen((char *)(nextline + 150)) + 1));
  nextline_idx = v + 1;
     }
     else
     {
  ...
  nextlinecol = v - 150;
  ((__builtin_object_size ((char *)(nextline), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(nextline), (char *)(line + nextlinecol), 150, __builtin_object_size ((char *)(nextline), 0)) : __inline_memmove_chk ((char *)(nextline), (char *)(line + nextlinecol), 150));
  nextline_idx = 150 + 1;
     }
 }
    }
 ...
 while (trailcol > (colnr_T)0 && ((ptr[trailcol - 1]) == ' ' || (ptr[trailcol - 1]) == '\t'))
     --trailcol;
...
# 3437 "screen.c"
       ...
       || vim_strchr(p_cpo, 'n') == ((void *)0)))
  {
   ...
   char_attr = hl_combine_attr(highlight_attr[(int)(HLF_CUL)], char_attr);
...
# 3662 "screen.c"
  ...
  char_attr = search_attr;
     ...
     else if (line_attr != 0 && ((fromcol == -10 && tocol == (0x7fffffffL))
...
# 4028 "screen.c"
     ...
     if (wp->w_onebuf_opt.wo_list && (c == 160
...
# 4714 "screen.c"
 ...
 if (c == '\000')
 {
  ...
  while (col < (wp->w_width))
  {
      ...
      ++col;
      if (draw_color_col)
   draw_color_col = advance_color_col((vcol),
         &color_cols);

      if (wp->w_onebuf_opt.wo_cuc && (vcol) == (long)wp->w_virtcol)
...
# 5065 "screen.c"
 ...
 if (n_attr > 0 && draw_state == 0 + 1 + 1 + 1 + 1 + 1 + 1 && --n_attr == 0)
...
# 5407 "screen.c"
 ...
 redraw_next = force || char_needs_redraw(off_from + 1,
         off_to + 1, endcol - col - 1);
# 5437 "screen.c"
 if (redraw_this)
 {
# 5451 "screen.c"
...
skip_status_match_char(xp, s)
    ...
    char_u *s;
{
    if ((rem_backslash(s) && xp->xp_context != 8)
 ...
 *buf = '\000';
 ...
 emenu = (xp->xp_context == 11
  || xp->xp_context == 21);
 if (emenu && menu_is_separator(s))
 {
     ((__builtin_object_size ((char *)(buf + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf + len), (char *)(transchar('|')), __builtin_object_size ((char *)(buf + len), 1 > 1)) : __inline_strcpy_chk ((char *)(buf + len), (char *)(transchar('|'))));
...
# 6052 "screen.c"
     {
  ((__builtin_object_size ((char *)(buf + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf + len), (char *)(transchar(*s)), __builtin_object_size ((char *)(buf + len), 1 > 1)) : __inline_strcpy_chk ((char *)(buf + len), (char *)(transchar(*s))));
    ...
    win_T *wp;
{
 ...
 if (wp->w_buffer->b_help)
 {
     ((__builtin_object_size ((char *)(p + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + len), (char *)(((char *)("[Help]"))), __builtin_object_size ((char *)(p + len), 1 > 1)) : __inline_strcpy_chk ((char *)(p + len), (char *)(((char *)("[Help]")))));
     len += (int)strlen((char *)(p + len));
 }

 if (wp->w_onebuf_opt.wo_pvw)
 {
     ((__builtin_object_size ((char *)(p + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + len), (char *)(((char *)("[Preview]"))), __builtin_object_size ((char *)(p + len), 1 > 1)) : __inline_strcpy_chk ((char *)(p + len), (char *)(((char *)("[Preview]")))));
     len += (int)strlen((char *)(p + len));
 }

 if (bufIsChanged(wp->w_buffer))
 {
     ((__builtin_object_size ((char *)(p + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + len), (char *)("[+]"), __builtin_object_size ((char *)(p + len), 1 > 1)) : __inline_strcpy_chk ((char *)(p + len), (char *)("[+]")));
     len += 3;
 }
 if (wp->w_buffer->b_p_ro)
 {
     ((__builtin_object_size ((char *)(p + len), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(p + len), (char *)("[RO]"), __builtin_object_size ((char *)(p + len), 1 > 1)) : __inline_strcpy_chk ((char *)(p + len), (char *)("[RO]")));
     len += 4;
 }
...
# 6257 "screen.c"
 ...
 if (get_keymap_str(wp, NameBuff, 1024)
  && (int)(this_ru_col - len) > (int)(strlen((char *)(NameBuff)) + 1))
    ...
    int len;
{
 ...
 curbuf = wp->w_buffer;
 curwin = wp;
 ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buf), (char *)("b:keymap_name"), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcpy_chk ((char *)(buf), (char *)("b:keymap_name")));
 ++emsg_skip;
 ...
 if ((int)(strlen((char *)(p)) + 3) < len)
     __builtin___sprintf_chk ((char *)buf, 0, __builtin_object_size ((char *)buf, 1 > 1), "<%s>", p);
 else
     buf[0] = '\000';
    ...
    int draw_ruler;
{
 ...
 return;
    ...
    stl = vim_strsave(stl);
    width = build_stl_str_hl(wp == ((void *)0) ? curwin : wp,
    buf, sizeof(buf),
    stl, use_sandbox,
...
# 7248 "screen.c"
 {
  ...
  if (aep == ((void *)0))
     ...
     if ((attr & 0x02) && (term_strings[(int)(KS_MD)]) != ((void *)0))
  out_str((term_strings[(int)(KS_MD)]));
     else if (aep != ((void *)0) && t_colors > 1 && aep->ae_u.cterm.fg_color
            && cterm_normal_fg_bold)


  out_str((term_strings[(int)(KS_ME)]));
     if ((attr & 0x20) && (term_strings[(int)(KS_SO)]) != ((void *)0))
  out_str((term_strings[(int)(KS_SO)]));
     if ((attr & (0x08 | 0x10)) && (term_strings[(int)(KS_US)]) != ((void *)0))

  out_str((term_strings[(int)(KS_US)]));
     if ((attr & 0x04) && (term_strings[(int)(KS_CZH)]) != ((void *)0))
  out_str((term_strings[(int)(KS_CZH)]));
     if ((attr & 0x01) && (term_strings[(int)(KS_MR)]) != ((void *)0))
  out_str((term_strings[(int)(KS_MR)]));
...
# 7322 "screen.c"
 {
  ...
  if (t_colors > 1)
  {
      ...
      if (aep != ((void *)0) && (aep->ae_u.cterm.fg_color
  ...
  if (strcmp((char *)((term_strings[(int)(KS_SE)])), (char *)((term_strings[(int)(KS_ME)]))) == 0)
      ...
      out_str((term_strings[(int)(KS_SE)]));
     }
  ...
  if (strcmp((char *)((term_strings[(int)(KS_UE)])), (char *)((term_strings[(int)(KS_ME)]))) == 0)
      ...
      out_str((term_strings[(int)(KS_UE)]));
     }
     if (screen_attr & 0x04)
     {
  if (strcmp((char *)((term_strings[(int)(KS_CZR)])), (char *)((term_strings[(int)(KS_ME)]))) == 0)
      ...
      out_str((term_strings[(int)(KS_CZR)]));
     }
     if (do_ME || (screen_attr & (0x02 | 0x01)))
  out_str((term_strings[(int)(KS_ME)]));
...
# 7678 "screen.c"
 ...
 if (c2 == ' '
  && end_col == Columns
  && can_clear((term_strings[(int)(KS_CE)]))
  && (attr == 0
      || (norm_term
   && attr <= 0x3f
   && ((attr & ~(0x02 | 0x04)) == 0))))
...
# 7705 "screen.c"
 ...
 for (col = start_col; col < end_col; ++col)
 {
  ...
  {
      if (ScreenLines[off] != ' '
       && (ScreenAttrs[off] > 0x3f
    || ScreenAttrs[off] & 0x02))
   force_next = 1;
      else
   force_next = 0;
  }
...
# 7933 "screen.c"
 ...
 win_free_lsize(aucmd_win);
    ...
    new_ScreenLines = (schar_T *)lalloc((long_u)(
         (Rows + 1) * Columns * sizeof(schar_T)), 0);
# 7956 "screen.c"
    new_ScreenAttrs = (sattr_T *)lalloc((long_u)(
         (Rows + 1) * Columns * sizeof(sattr_T)), 0);
    new_LineOffset = (unsigned *)lalloc((long_u)(
      Rows * sizeof(unsigned)), 0);
...
# 8024 "screen.c"
 ...
 for (new_row = 0; new_row < Rows; ++new_row)
 {
     ...
     if (!clear)
     {
  (void)((__builtin_object_size ((new_ScreenLines + new_row * Columns), 0) != (size_t) -1) ? __builtin___memset_chk ((new_ScreenLines + new_row * Columns), (' '), ((size_t)Columns * sizeof(schar_T)), __builtin_object_size ((new_ScreenLines + new_row * Columns), 0)) : __inline_memset_chk ((new_ScreenLines + new_row * Columns), (' '), ((size_t)Columns * sizeof(schar_T))));
# 8068 "screen.c"
  (void)((__builtin_object_size ((new_ScreenAttrs + new_row * Columns), 0) != (size_t) -1) ? __builtin___memset_chk ((new_ScreenAttrs + new_row * Columns), (0), ((size_t)Columns * sizeof(sattr_T)), __builtin_object_size ((new_ScreenAttrs + new_row * Columns), 0)) : __inline_memset_chk ((new_ScreenAttrs + new_row * Columns), (0), ((size_t)Columns * sizeof(sattr_T))));
  ...
  if (old_row >= 0 && ScreenLines != ((void *)0))
  {
   ...
   ((__builtin_object_size ((char *)(new_ScreenLines + new_LineOffset[new_row]), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(new_ScreenLines + new_LineOffset[new_row]), (char *)(ScreenLines + LineOffset[old_row]), (size_t)len * sizeof(schar_T), __builtin_object_size ((char *)(new_ScreenLines + new_LineOffset[new_row]), 0)) : __inline_memmove_chk ((char *)(new_ScreenLines + new_LineOffset[new_row]), (char *)(ScreenLines + LineOffset[old_row]), (size_t)len * sizeof(schar_T)));
# 8104 "screen.c"
      ((__builtin_object_size ((char *)(new_ScreenAttrs + new_LineOffset[new_row]), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(new_ScreenAttrs + new_LineOffset[new_row]), (char *)(ScreenAttrs + LineOffset[old_row]), (size_t)len * sizeof(sattr_T), __builtin_object_size ((char *)(new_ScreenAttrs + new_LineOffset[new_row]), 0)) : __inline_memmove_chk ((char *)(new_ScreenAttrs + new_LineOffset[new_row]), (char *)(ScreenAttrs + LineOffset[old_row]), (size_t)len * sizeof(sattr_T)));
...
lineclear(off, width)
    ...
    int width;
{
    (void)((__builtin_object_size ((ScreenLines + off), 0) != (size_t) -1) ? __builtin___memset_chk ((ScreenLines + off), (' '), ((size_t)width * sizeof(schar_T)), __builtin_object_size ((ScreenLines + off), 0)) : __inline_memset_chk ((ScreenLines + off), (' '), ((size_t)width * sizeof(schar_T))));





    (void)((__builtin_object_size ((ScreenAttrs + off), 0) != (size_t) -1) ? __builtin___memset_chk ((ScreenAttrs + off), (0), ((size_t)width * sizeof(sattr_T)), __builtin_object_size ((ScreenAttrs + off), 0)) : __inline_memset_chk ((ScreenAttrs + off), (0), ((size_t)width * sizeof(sattr_T))));
}
...
lineinvalid(off, width)
    ...
    int width;
{
    (void)((__builtin_object_size ((ScreenAttrs + off), 0) != (size_t) -1) ? __builtin___memset_chk ((ScreenAttrs + off), (-1), ((size_t)width * sizeof(sattr_T)), __builtin_object_size ((ScreenAttrs + off), 0)) : __inline_memset_chk ((ScreenAttrs + off), (-1), ((size_t)width * sizeof(sattr_T))));
}
    ...
    win_T *wp;
{
    ...
    ((__builtin_object_size ((char *)(ScreenLines + off_to), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ScreenLines + off_to), (char *)(ScreenLines + off_from), wp->w_width * sizeof(schar_T), __builtin_object_size ((char *)(ScreenLines + off_to), 0)) : __inline_memmove_chk ((char *)(ScreenLines + off_to), (char *)(ScreenLines + off_from), wp->w_width * sizeof(schar_T)));
# 8330 "screen.c"
    ((__builtin_object_size ((char *)(ScreenAttrs + off_to), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(ScreenAttrs + off_to), (char *)(ScreenAttrs + off_from), wp->w_width * sizeof(sattr_T), __builtin_object_size ((char *)(ScreenAttrs + off_to), 0)) : __inline_memmove_chk ((char *)(ScreenAttrs + off_to), (char *)(ScreenAttrs + off_from), wp->w_width * sizeof(sattr_T)));
...
can_clear(p)
    char_u *p;
{
    return (*p != '\000' && (t_colors <= 1



  || cterm_normal_bg_color == 0 || *(term_strings[(int)(KS_UT)]) != '\000'));
}
...
# 8389 "screen.c"
 ...
 if (screen_attr && *(term_strings[(int)(KS_MS)]) == '\000')
     noinvcurs = 5;
 else
     noinvcurs = 0;
...
# 8422 "screen.c"
 if (row >= screen_cur_row && screen_cur_col < Columns)
 {
  ...
  if (*(term_strings[(int)(KS_LE)]))
      bs = (term_strings[(int)(KS_LE)]);
  else
      bs = (term_strings[(int)(KS_BC)]);
  if (*bs)
...
# 8526 "screen.c"
  ...
  if (i > 0)
  {
      ...
      {
   while (i-- > 0)
       out_char(*(term_strings[(int)(KS_ND)]));
      }
      else
      {
   int off;
    ...
    int mayclear;
{
 ...
 if (screen_del_lines(0, (wp->w_winrow) + wp->w_height - line_count,
        line_count, (int)Rows, 0, ((void *)0)) == 1)
     did_delete = 1;
 else if (wp->w_next)
     return 0;
    }
...
# 8839 "screen.c"
 ...
 if (scroll_region && (wp->w_width == Columns || *(term_strings[(int)(KS_CSV)]) != '\000'))

     scroll_region_set(wp, row);
 if (del)
     retval = screen_del_lines((wp->w_winrow) + row, 0, line_count,
            wp->w_height - row, 0, wp);
 else
...
# 8946 "screen.c"
    if (!screen_valid(1) || line_count <= 0 || line_count > p_ttyscroll)
 return 0;
# 8974 "screen.c"
    result_empty = (row + line_count >= end);

    if (wp != ((void *)0) && wp->w_width != Columns && *(term_strings[(int)(KS_CSV)]) == '\000')
 type = 9;
    else

    if (can_clear((term_strings[(int)(KS_CD)])) && result_empty)
 type = 8;
    else if (*(term_strings[(int)(KS_CAL)]) != '\000' && (line_count > 1 || *(term_strings[(int)(KS_AL)]) == '\000'))
 type = 1;
    else if (*(term_strings[(int)(KS_CDL)]) != '\000' && result_empty && (line_count > 1 || !can_ce))
 type = 2;
    else if (*(term_strings[(int)(KS_AL)]) != '\000')
 type = 3;
    else if (can_ce && result_empty)
 type = 4;
    else if (*(term_strings[(int)(KS_DL)]) != '\000' && result_empty)
 type = 5;
    else if (*(term_strings[(int)(KS_SR)]) != '\000' && row == 0 && (*(term_strings[(int)(KS_DA)]) == '\000' || can_ce))
 type = 6;
    else
 return 0;
    ...
    if (type == 8 || type == 2 ||
      type == 4 || type == 5)
 return screen_del_lines(off, row, line_count, end, 0, wp);
    ...
    if (*(term_strings[(int)(KS_DB)]))
 screen_del_lines(off, end - line_count, line_count, end, 0, wp);
...
# 9032 "screen.c"
 ...
 for (i = 0; i < line_count; i++)
 {
  ...
  out_str((term_strings[(int)(KS_SR)]));
     screen_start();
 }
    }
...
# 9210 "screen.c"
      ...
      *(term_strings[(int)(KS_CDL)]) == '\000'))

 type = 7;
    else if (*(term_strings[(int)(KS_CDL)]) != '\000' && line_count > 1 && can_delete)
 type = 2;
    else if (can_clear((term_strings[(int)(KS_CE)])) && result_empty

     && (wp == ((void *)0) || wp->w_width == Columns)

     )
 type = 4;
    else if (*(term_strings[(int)(KS_DL)]) != '\000' && can_delete)
 type = 5;
    else if (*(term_strings[(int)(KS_CDL)]) != '\000' && can_delete)
 type = 2;
    else
 return 0;
...
# 9457 "screen.c"
  ...
  if (State & 0x80)
      msg_puts_attr((char_u *)(((char *)(" VREPLACE"))), (attr));
  else

      if (State & 0x40)
      msg_puts_attr((char_u *)(((char *)(" REPLACE"))), (attr));
  else if (State & 0x10)
  {
...
# 9529 "screen.c"
  if ((State & 0x10) && p_paste)
      msg_puts_attr((char_u *)(((char *)(" (paste)"))), (attr));
    ...
    int force;
{
 ...
 msg_pos_mode();
 if (Recording)
     msg_puts_attr((char_u *)(((char *)("recording"))), (highlight_attr[(int)(HLF_CM)]));
 msg_clr_eos();
    }
}
...
# 9676 "screen.c"
 ...
 tabcount = 0;
 scol = 0;
 for (tp = first_tabpage; tp != ((void *)0) && col < Columns - 4;
            tp = tp->tp_next)
 {
     scol = col;
    ...
    buf_T *buf;
{
 ...
 ((__builtin_object_size ((char *)(NameBuff), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(NameBuff), (char *)(buf_spname(buf)), __builtin_object_size ((char *)(NameBuff), 1 > 1)) : __inline_strcpy_chk ((char *)(NameBuff), (char *)(buf_spname(buf))));
    else
...
# 9981 "screen.c"
 ...
 vim_snprintf((char *)buffer, 70, "%ld,",
  (wp->w_buffer->b_ml.ml_flags & 1)
      ? 0L
...
# 10142 "screen.c"
 if (this_ru_col + (int)strlen((char *)(buffer)) > width)

    ...
    linenr_T lnum __attribute__((unused));
{
 ...
 __builtin___sprintf_chk ((char *)tbuf, 0, __builtin_object_size ((char *)tbuf, 1 > 1), ((char *)("Page %d")), pagenum);
    ...
    exarg_T *eap;
{
    ...
    ((__builtin_object_size ((&settings), 0) != (size_t) -1) ? __builtin___memset_chk ((&settings), (0), (sizeof(prt_settings_T)), __builtin_object_size ((&settings), 0)) : __inline_memset_chk ((&settings), (0), (sizeof(prt_settings_T))));
...
# 599 "hardcopy.c"
 ...
 bytes_to_print += (long_u)strlen((char *)(skipwhite(ml_get(lnum))));
    if (bytes_to_print == 0)
    {
 ...
 ((__builtin_object_size ((&page_prtpos), 0) != (size_t) -1) ? __builtin___memset_chk ((&page_prtpos), (0), (sizeof(prt_pos_T)), __builtin_object_size ((&page_prtpos), 0)) : __inline_memset_chk ((&page_prtpos), (0), (sizeof(prt_pos_T))));
 ...
 for (page_count = 0; prtpos.file_line <= eap->line2; ++page_count)
 {
  ...
  for (side = 0; side <= settings.duplex; ++side)
  {
   ...
   goto print_fail;
      ...
      __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 1 > 1), ((char *)("Printing page %d (%d%%)")), page_count + 1 + side, prtpos.bytes_printed > 1000000 ? (int)(prtpos.bytes_printed / (bytes_to_print / 100)) : (int)((prtpos.bytes_printed * 100) / bytes_to_print));
   ...
   __builtin___sprintf_chk ((char *)IObuff + strlen((char *)(IObuff)), 0, __builtin_object_size ((char *)IObuff + strlen((char *)(IObuff)), 1 > 1), ((char *)(" Copy %d of %d")), collated_copies + 1, settings.n_collated_copies);
 ...
 vim_snprintf((char *)IObuff, (1024+1), ((char *)("Printed: %s")),
           settings.jobname);
 prt_message(IObuff);
    }
 ...
 *resource_filename = '\000';
 ...
 ((__builtin_object_size ((char *)(resource_filename), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(resource_filename), (char *)(filename), __builtin_object_size ((char *)(resource_filename), 1 > 1)) : __inline_strcpy_chk ((char *)(resource_filename), (char *)(filename)));
}
    ...
    struct prt_ps_resource_S *resource;
{
    ...
    ((__builtin_object_size ((char *)(resource->name), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(resource->name), (char *)(name), __builtin_object_size ((char *)(resource->name), 1 > 1)) : __inline_strcpy_chk ((char *)(resource->name), (char *)(name)));

    ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buffer), (char *)("print"), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcpy_chk ((char *)(buffer), (char *)("print")));
    add_pathsep(buffer);
    ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buffer), (char *)(name), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcat_chk ((char *)(buffer), (char *)(name)));
    ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buffer), (char *)(".ps"), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcat_chk ((char *)(buffer), (char *)(".ps")));
    resource->filename[0] = '\000';
    return (do_in_runtimepath(buffer, 0, prt_resource_name,
          resource->filename)
     && resource->filename[0] != '\000');
}
# 1783 "hardcopy.c"
    ...
    struct prt_dsc_line_S *p_dsc_line;
{
 ...
 return 0;
    ...
    for (comment = 0; comment < (int)(sizeof(prt_dsc_table)/sizeof((prt_dsc_table)[0])); comment++)
    ...
    struct prt_ps_resource_S *resource;
{
 ...
 return 0;
    ...
    ((__builtin_object_size ((prt_resfile.buffer), 0) != (size_t) -1) ? __builtin___memset_chk ((prt_resfile.buffer), ('\000'), ((2048)), __builtin_object_size ((prt_resfile.buffer), 0)) : __inline_memset_chk ((prt_resfile.buffer), ('\000'), ((2048))));
...
# 2616 "hardcopy.c"
 ...
 prt_ps_font = &prt_ps_courier_font;
    ...
    || (((printer_opts[9].string[0]) < 'A' || (printer_opts[9].string[0]) > 'Z') ? (printer_opts[9].string[0]) : (printer_opts[9].string[0]) + ('a' - 'A')) == 'y');
...
# 2654 "hardcopy.c"
 ...
 return 0;
    ...
    prt_collate = (!printer_opts[11].present
     || (((printer_opts[11].string[0]) < 'A' || (printer_opts[11].string[0]) > 'Z') ? (printer_opts[11].string[0]) : (printer_opts[11].string[0]) + ('a' - 'A')) == 'y');
    if (prt_collate)
    {
...
# 2864 "hardcopy.c"
 ...
 ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buffer), (char *)("Unknown"), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcpy_chk ((char *)(buffer), (char *)("Unknown")));
...
# 2983 "hardcopy.c"
 ...
 if (!prt_open_resource(&res_encoding))
     return 0;
# 3049 "hardcopy.c"
    ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buffer), (char *)(res_prolog.title), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcpy_chk ((char *)(buffer), (char *)(res_prolog.title)));
    ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buffer), (char *)(" "), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcat_chk ((char *)(buffer), (char *)(" ")));
    ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buffer), (char *)(res_prolog.version), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcat_chk ((char *)(buffer), (char *)(res_prolog.version)));
    prt_dsc_resources("DocumentSuppliedResources", "procset", buffer);
# 3071 "hardcopy.c"
    {
 ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(buffer), (char *)(res_encoding.title), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcpy_chk ((char *)(buffer), (char *)(res_encoding.title)));
 ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buffer), (char *)(" "), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcat_chk ((char *)(buffer), (char *)(" ")));
 ((__builtin_object_size ((char *)(buffer), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buffer), (char *)(res_encoding.version), __builtin_object_size ((char *)(buffer), 1 > 1)) : __inline_strcat_chk ((char *)(buffer), (char *)(res_encoding.version)));
    ...
    prt_settings_T *psettings;
{
 ...
 if (eval_printexpr(prt_ps_file_name, psettings->arguments) == 0)
     emsg((char_u *)(((char *)("E365: Failed to print PostScript file"))));
 else
     prt_message((char_u *)((char *)("Print job sent.")));
    }

...
# 314 "message.c"
 ...
 for (i = (int)strlen((char *)(s)); len + (n = ptr2cells(s + i - 1)) <= room; --i)
    ...
    ((__builtin_object_size ((char *)(buf + e), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(buf + e), (char *)("..."), (size_t)3, __builtin_object_size ((char *)(buf + e), 0)) : __inline_memmove_chk ((char *)(buf + e), (char *)("..."), (size_t)3));
    ((__builtin_object_size ((char *)((buf + e + 3)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((buf + e + 3)), (char *)((s + i)), strlen((char *)(s + i)) + 1, __builtin_object_size ((char *)((buf + e + 3)), 0)) : __inline_memmove_chk ((char *)((buf + e + 3)), (char *)((s + i)), strlen((char *)(s + i)) + 1));
}
# 383 "message.c"
...
get_emsg_source()
{
 ...
 if (Buf != ((void *)0))
     __builtin___sprintf_chk ((char *)Buf, 0, __builtin_object_size ((char *)Buf, 1 > 1), (char *)p, sourcing_name);
 return Buf;
    }
    return ((void *)0);
}
...
get_emsg_lnum()
{
 ...
 if (Buf != ((void *)0))
     __builtin___sprintf_chk ((char *)Buf, 0, __builtin_object_size ((char *)Buf, 1 > 1), (char *)p, (long)sourcing_lnum);
 return Buf;
    }
    return ((void *)0);
}
    ...
    exarg_T *eap __attribute__((unused));
{
    ...
    if (s != ((void *)0) && *s != '\000')
 msg_attr((char_u *)
  ((char *)("Messages maintainer: Bram Moolenaar <Bram@vim.org>")),
...
hit_return_msg()
{
 ...
 msg_putchar('\n');
    if (got_int)
 msg_puts((char_u *)(((char *)("Interrupt: "))));
...
{
    if (keep_msg == ((void *)0) && last_msg_hist != ((void *)0) && msg_scrolled == 0
         && (State & 0x01))
    ...
    int len;
{
 ...
 if ((int)(strlen((char *)(s)) + strlen((char *)(buf))) < len)
     ((__builtin_object_size ((char *)(buf), 0) != (size_t) -1) ? __builtin___strcat_chk ((char *)(buf), (char *)(s), __builtin_object_size ((char *)(buf), 1 > 1)) : __inline_strcat_chk ((char *)(buf), (char *)(s)));
    }
}
...
# 1888 "message.c"
        (msg_col + t_col >= Columns - 1
         || (*s == '\011' && msg_col + t_col >= ((Columns - 1) & ~7))
...
inc_msg_scrolled()
{
 ...
 else
 {
     ...
     if (tofree != ((void *)0))
     {
  vim_snprintf((char *)tofree, len, ((char *)("%s line %ld")),
...
msg_clr_eos_force()
{
 ...
 if (full_screen)
 {
     if (*(term_strings[(int)(KS_CD)]))
  out_str((term_strings[(int)(KS_CD)]));
     else if (*(term_strings[(int)(KS_CE)]))
    ...
    int maxlen;
{
 ...
 while (*s != '\000' && (maxlen < 0 || (int)(s - str) < maxlen))
 {
     ...
     if (!redir_reg && !redir_vname && redir_fd != ((void *)0))
    ...
    int dfltbutton;
{
 ...
 else
 {
  ...
  return ((void *)0);
     ...
     *confirm_msg = '\n';
     ((__builtin_object_size ((char *)(confirm_msg + 1), 0) != (size_t) -1) ? __builtin___strcpy_chk ((char *)(confirm_msg + 1), (char *)(message), __builtin_object_size ((char *)(confirm_msg + 1), 1 > 1)) : __inline_strcpy_chk ((char *)(confirm_msg + 1), (char *)(message)));
...
{
    if (do_dialog(type,
  title == ((void *)0) ? (char_u *)((char *)("Question")) : title,
  message,
  (char_u *)((char *)("&Yes\n&No")), dflt, ((void *)0)) == 1)
 return 2;
    return 3;
    ...
    int *idxp;
{
 ...
 if (tvs[idx].v_type == 6)
     ...
     emsg((char_u *)(((char *)("E807: Expected Float argument for printf()"))));
    }
    return f;
}
# 3983 "message.c"
...

{
 ...
 if (*p != '%')
 {
  ...
  ((__builtin_object_size ((char *)(str + str_l), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(str + str_l), (char *)(p), n > avail ? avail : n, __builtin_object_size ((char *)(str + str_l), 0)) : __inline_memmove_chk ((char *)(str + str_l), (char *)(p), n > avail ? avail : n));
     }
     p += n;
     str_l += n;
 }
...
# 4335 "message.c"
   ...
   ptr_arg =
     ...
     tvs != ((void *)0) ? (void *)tv_str(tvs, &arg_idx) :
   ...
   if (fmt_spec == 'p')
       str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, ptr_arg);
   else if (fmt_spec == 'd')
   {
       ...
       {
       case '\0':
       case 'h': str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, int_arg);

          break;
       case 'l': str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, long_arg);
   ...
   else
   {
       ...
       {
       case '\0':
       case 'h': str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, uint_arg);

          break;
       case 'l': str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, ulong_arg);
     ...
     case 'G':
  {
   ...
   tvs != ((void *)0) ? tv_float(tvs, &arg_idx) :
   ...
   ((__builtin_object_size (tmp, 0) != (size_t) -1) ? __builtin___strcpy_chk (tmp, "inf", __builtin_object_size (tmp, 1 > 1)) : __inline_strcpy_chk (tmp, "inf"));
   str_arg_l = 3;
      }
      else
      {
   ...
   if (remove_trailing_zeroes)
   {
    ...
    if (tp != ((void *)0))
    {
     ...
     ((__builtin_object_size ((char *)((tp + 1)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((tp + 1)), (char *)((tp + 2)), strlen((char *)(tp + 2)) + 1, __builtin_object_size ((char *)((tp + 1)), 0)) : __inline_memmove_chk ((char *)((tp + 1)), (char *)((tp + 2)), strlen((char *)(tp + 2)) + 1));
     --str_arg_l;
        }
        i = (tp[1] == '-') ? 2 : 1;
        while (tp[i] == '0')
     ...
     ((__builtin_object_size ((char *)((tp + i)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((tp + i)), (char *)((tp + i + 1)), strlen((char *)(tp + i + 1)) + 1, __builtin_object_size ((char *)((tp + i)), 0)) : __inline_memmove_chk ((char *)((tp + i)), (char *)((tp + i + 1)), strlen((char *)(tp + i + 1)) + 1));
     --str_arg_l;
        }
        --tp;
    }
    ...
    while (tp > tmp + 2 && *tp == '0'
            && tp[-1] != '.')
    {
        ((__builtin_object_size ((char *)((tp)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((tp)), (char *)((tp + 1)), strlen((char *)(tp + 1)) + 1, __builtin_object_size ((char *)((tp)), 0)) : __inline_memmove_chk ((char *)((tp)), (char *)((tp + 1)), strlen((char *)(tp + 1)) + 1));
        --tp;
        --str_arg_l;
    }
   }
   else
   {
       ...
       tp = (char *)vim_strchr((char_u *)tmp,
       fmt_spec == 'e' ? 'e' : 'E');
       if (tp != ((void *)0) && (tp[1] == '+' || tp[1] == '-')
       && tp[2] == '0'
       && vim_isdigit(tp[3])
       && vim_isdigit(tp[4]))
       {
    ((__builtin_object_size ((char *)((tp + 2)), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)((tp + 2)), (char *)((tp + 3)), strlen((char *)(tp + 3)) + 1, __builtin_object_size ((char *)((tp + 2)), 0)) : __inline_memmove_chk ((char *)((tp + 2)), (char *)((tp + 3)), strlen((char *)(tp + 3)) + 1));
    --str_arg_l;
       }
   }
      }
  ...
  if (pn > 0)
  {
   ...
   ((__builtin_object_size ((str + str_l), 0) != (size_t) -1) ? __builtin___memset_chk ((str + str_l), (zero_padding ? '0' : ' '), ((size_t)pn > avail ? avail : (size_t)pn), __builtin_object_size ((str + str_l), 0)) : __inline_memset_chk ((str + str_l), (zero_padding ? '0' : ' '), ((size_t)pn > avail ? avail : (size_t)pn)));
  ...
  if (zn > 0)
  {
   ...
   ((__builtin_object_size ((char *)(str + str_l), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(str + str_l), (char *)(str_arg), (size_t)zn > avail ? avail : (size_t)zn, __builtin_object_size ((char *)(str + str_l), 0)) : __inline_memmove_chk ((char *)(str + str_l), (char *)(str_arg), (size_t)zn > avail ? avail : (size_t)zn));
  ...
  if (zn > 0)
  {
   ...
   ((__builtin_object_size ((str + str_l), 0) != (size_t) -1) ? __builtin___memset_chk ((str + str_l), ('0'), ((size_t)zn > avail ? avail : (size_t)zn), __builtin_object_size ((str + str_l), 0)) : __inline_memset_chk ((str + str_l), ('0'), ((size_t)zn > avail ? avail : (size_t)zn)));
  ...
  if (sn > 0)
  {
   ...
   ((__builtin_object_size ((char *)(str + str_l), 0) != (size_t) -1) ? __builtin___memmove_chk ((char *)(str + str_l), (char *)(str_arg + zero_padding_insertion_ind), (size_t)sn > avail ? avail : (size_t)sn, __builtin_object_size ((char *)(str + str_l), 0)) : __inline_memmove_chk ((char *)(str + str_l), (char *)(str_arg + zero_padding_insertion_ind), (size_t)sn > avail ? avail : (size_t)sn));
  ...
  if (pn > 0)
  {
   ...
   ((__builtin_object_size ((str + str_l), 0) != (size_t) -1) ? __builtin___memset_chk ((str + str_l), (' '), ((size_t)pn > avail ? avail : (size_t)pn), __builtin_object_size ((str + str_l), 0)) : __inline_memset_chk ((str + str_l), (' '), ((size_t)pn > avail ? avail : (size_t)pn)));
 ...
 str[str_l <= str_m - 1 ? str_l : str_m - 1] = '\0';
    ...
    if (tvs != ((void *)0) && tvs[arg_idx - 1].v_type != 0)
 emsg((char_u *)(((char *)("E767: Too many arguments to printf()"))));

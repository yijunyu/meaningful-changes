    ...
    buf_T * buf;
{
    ...
    if (p_uc && buf -> b_p_swf) buf -> b_may_swap = 1;
    else buf -> b_may_swap = 0;
    mfp = mf_open (((void *) 0), 0);
    if (mfp == ((void *) 0)) goto error;
    buf -> b_ml.ml_mfp = mfp;
    mfp -> mf_buffer = buf;
    buf -> b_ml.ml_flags = 1;
    buf -> b_ml.ml_line_count = 1;
    curwin -> w_nrwidth_line_count = 0;
    if ((hp = mf_new (mfp, 0, 1)) == ((void *) 0)) goto error;
    if (hp -> bh_bnum != 0) {
        emsg ((char_u *) (((char *) ("E298: Didn't get block nr 0?"))));
        goto error;
    }
    ...
    ((__builtin_object_size ((char *) (b0p -> b0_version), 0) != (size_t) - 1) ? __builtin___strncpy_chk ((char *) (b0p -> b0_version), (char *) ("VIM "), (
      size_t) (4), __builtin_object_size ((char *) (b0p -> b0_version), 1 > 1)) : __inline_strncpy_chk ((char *) (b0p -> b0_version), (char *) ("VIM "), (
      size_t) (4)));
    ((__builtin_object_size ((char *) (b0p -> b0_version + 4), 0) != (size_t) - 1) ? __builtin___strncpy_chk ((char *) (b0p -> b0_version + 4), (char *) (
      Version), (size_t) (6), __builtin_object_size ((char *) (b0p -> b0_version + 4), 1 > 1)) : __inline_strncpy_chk ((char *) (b0p -> b0_version + 4), (char *
      ) (Version), (size_t) (6)));
    ...
    if (!buf->b_spell) {
        ...
        (void) get_user_name (b0p -> b0_uname, 40);
        b0p -> b0_uname [40 - 1] = '\000';
        mch_get_host_name (b0p -> b0_hname, 40);
        b0p -> b0_hname [40 - 1] = '\000';
        long_to_char (mch_get_pid (), b0p -> b0_pid);
        if (*buf->b_p_key != '\000') ml_set_b0_crypt (buf, b0p);
    }
    mf_put (mfp, hp, 1, 0);
    if (!buf->b_help && !((buf)->b_spell)) (void) mf_sync (mfp, 0);
    if ((hp = ml_new_ptr (mfp)) == ((void *) 0)) goto error;
    if (hp -> bh_bnum != 1) {
        emsg ((char_u *) (((char *) ("E298: Didn't get block nr 1?"))));
        goto error;
    }
    ...
    mf_put (mfp, hp, 1, 0);
    if ((hp = ml_new_data (mfp, 0, 1)) == ((void *) 0)) goto error;
    if (hp -> bh_bnum != 2) {
        emsg ((char_u *) (((char *) ("E298: Didn't get block nr 2?"))));
        goto error;
    }
...
static void ml_set_b0_crypt (buf, b0p)
    ...
    ZERO_BL * b0p;
{
    if (*buf->b_p_key == '\000') b0p -> b0_id [1] = '0';
    else {
        if (get_crypt_method (buf) == 0) b0p -> b0_id [1] = 'c';
        else {
            b0p -> b0_id [1] = 'C';
            sha2_seed (&b0p->b0_fname[900-2-8], 8, ((void *) 0), 0);
            ((__builtin_object_size ((char *) (buf -> b_ml.ml_mfp -> mf_seed), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf -> b_ml.ml_mfp ->
              mf_seed), (char *) (&b0p->b0_fname[900-2-8]), 8, __builtin_object_size ((char *) (buf -> b_ml.ml_mfp -> mf_seed), 0)) : __inline_memmove_chk ((
              char *) (buf -> b_ml.ml_mfp -> mf_seed), (char *) (&b0p->b0_fname[900-2-8]), 8));
        }
    }
}
    ...
    int old_cm;
{
    ...
    blocknr_T bnum;
    int top;
    if (mfp == ((void *) 0)) return;
    mfp -> mf_old_key = old_key;
    mfp -> mf_old_cm = old_cm;
    if (old_cm > 0) ((__builtin_object_size ((char *) (mfp -> mf_old_seed), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (mfp -> mf_old_seed), (char
      *) (mfp -> mf_seed), 8, __builtin_object_size ((char *) (mfp -> mf_old_seed), 0)) : __inline_memmove_chk ((char *) (mfp -> mf_old_seed), (char *) (mfp ->
      mf_seed), 8));
    ...
    if (mfp -> mf_infile_count > 2) {
        ...
        for (; !got_int; line_breakcheck ()) {
            if (hp != ((void *) 0)) mf_put (mfp, hp, 0, 0);
            if ((hp = mf_get (mfp, (blocknr_T) bnum, page_count)) == ((void *) 0)) {
                if (bnum == 1) break;
                ++error;
            }
            else {
    ...
    buf_T * buf;
{
    ...
    for (;;) {
        ...
        if (strcasecmp ((char *) (((fname))), (char *) (((mfp -> mf_fname)))) == 0) {
            vim_free (fname);
            success = 1;
            break;
        }
    ...
    if (mfp -> mf_fd == -1) {
        mfp -> mf_fd = open (((char *) mfp -> mf_fname), (0x0002 | 0), (0));
        if (mfp -> mf_fd < 0) {
            emsg ((char_u *) (((char *) ("E301: Oops, lost the swap file!!!"))));
            return;
        }
        {
            int fdflags = fcntl (mfp -> mf_fd, 1);
            if (fdflags >= 0 && (fdflags & 1) == 0) fcntl (mfp -> mf_fd, 2, fdflags | 1);
        }
    }
    if (!success) emsg ((char_u *) (((char *) ("E302: Could not rename swap file"))));
}

void ml_open_files () {
    buf_T * buf;
    for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) if (!buf->b_p_ro || buf -> b_changed) ml_open_file (buf);
}
    ...
    buf_T * buf;
{
    ...
    char_u * dirp;
    mfp = buf -> b_ml.ml_mfp;
    if (mfp == ((void *) 0) || mfp -> mf_fd >= 0 || !buf->b_p_swf) return;
    if (buf -> b_spell) {
        fname = vim_tempname ('s');
        if (fname != ((void *) 0)) (void) mf_open_file (mfp, fname);
        buf -> b_may_swap = 0;
        return;
    }
    dirp = p_dir;
    ...
    if (mfp -> mf_fname == ((void *) 0)) {
        need_wait_return = 1;
        ++no_wait_return;
        (void) emsg2 ((char_u *) (((char *) ("E303: Unable to open swap file for \"%s\", recovery impossible"))), (char_u *) (buf_spname (buf) != ((void *) 0) ?
          (char_u *) buf_spname (buf) : buf -> b_fname));
        --no_wait_return;
    }
    buf -> b_may_swap = 0;
}
...
void check_need_swap (newfile)
    int newfile;
{
    if (curbuf -> b_may_swap && (!curbuf->b_p_ro || !newfile)) ml_open_file (curbuf);
}
...
void ml_close (buf, del_file)
    ...
    int del_file;
{
    if (buf -> b_ml.ml_mfp == ((void *) 0)) return;
    mf_close (buf -> b_ml.ml_mfp, del_file);
    if (buf -> b_ml.ml_line_lnum != 0 && (buf -> b_ml.ml_flags & 2)) vim_free (buf -> b_ml.ml_line_ptr);
    vim_free (buf -> b_ml.ml_stack);
...
{
    buf_T * buf;
    for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) ml_close (buf, del_file && ((buf -> b_flags & 0x100) == 0 || vim_strchr (p_cpo, '&') == ((
      void *) 0)));
    vim_deltempdir ();
}
...
void ml_close_notmod () {
    buf_T * buf;
    for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) if (!bufIsChanged(buf)) ml_close (buf, 1);
}
...
static int ml_check_b0_id (b0p)
    ZERO_BL * b0p;
{
    if (b0p -> b0_id [0] != 'b' || (b0p -> b0_id [1] != '0' && b0p -> b0_id [1] != 'c' && b0p -> b0_id [1] != 'C')) return 0;
    return 1;
}
    ...
    upd_block0_T what;
{
    ...
    ZERO_BL * b0p;
    mfp = buf -> b_ml.ml_mfp;
    if (mfp == ((void *) 0) || (hp = mf_get (mfp, (blocknr_T) 0, 1)) == ((void *) 0)) return;
    b0p = (ZERO_BL *) (hp -> bh_data);
    if (ml_check_b0_id (b0p) == 0) emsg ((char_u *) (((char *) ("E304: ml_upd_block0(): Didn't get block 0??"))));
    else {
        if (what == UB_FNAME) set_b0_fname (b0p, buf);
        else if (what == UB_CRYPT) ml_set_b0_crypt (buf, b0p);
...
{
    struct stat st;
    if (buf -> b_ffname == ((void *) 0)) b0p -> b0_fname [0] = '\000';
    else {
        size_t flen, ulen;
        char_u uname [40];
        home_replace (((void *) 0), buf -> b_ffname, b0p -> b0_fname, 890, 1);
        if (b0p -> b0_fname [0] == '~') {
            flen = strlen ((char *) (b0p -> b0_fname));
            if (get_user_name (uname, 40) == 0 || (ulen = strlen ((char *) (uname))) + flen > 890 - 1) vim_strncpy (b0p -> b0_fname, buf -> b_ffname, 890 - 1);
            else {
                ((__builtin_object_size ((char *) (b0p -> b0_fname + ulen + 1), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (b0p -> b0_fname + ulen
                  + 1), (char *) (b0p -> b0_fname + 1), flen, __builtin_object_size ((char *) (b0p -> b0_fname + ulen + 1), 0)) : __inline_memmove_chk ((char *
                  ) (b0p -> b0_fname + ulen + 1), (char *) (b0p -> b0_fname + 1), flen));
                ((__builtin_object_size ((char *) (b0p -> b0_fname + 1), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (b0p -> b0_fname + 1), (char *
                  ) (uname), ulen, __builtin_object_size ((char *) (b0p -> b0_fname + 1), 0)) : __inline_memmove_chk ((char *) (b0p -> b0_fname + 1), (char *) (
                  uname), ulen));
            }
        }
        if (stat (((char *) buf -> b_ffname), (&st)) >= 0) {
            long_to_char ((long) st.st_mtimespec.tv_sec, b0p -> b0_mtime);
...
static void set_b0_dir_flag (b0p, buf)
    ...
    buf_T * buf;
{
    if (same_directory (buf -> b_ml.ml_mfp -> mf_fname, buf -> b_ffname)) b0p -> b0_fname [900 - 2] |= 4;
    else b0p -> b0_fname [900 - 2] &= ~4;
}
...
void ml_recover () {
    ...
    if (len >= 4 && strncasecmp ((char *) (fname + len - 4), (char *) (".s"), (size_t) (2)) == 0 && vim_strchr ((char_u *) "UVWuvw", fname [len - 2]) != ((void
      *) 0) && ((fname [len - 1]) < 0x7f && isalpha (fname [len - 1]))) {
        directly = 1;
        ...
        if (len == 0) {
            emsg2 ((char_u *) (((char *) ("E305: No swap file found for %s"))), (char_u *) (fname));
            goto theend;
        }
        if (len == 1) i = 1;
        else {
            ...
            msg_putchar ('\n');
            msg_puts ((char_u *) (((char *) ("Enter number of swap file to use (0 to quit): "))));
            i = get_number (0, ((void *) 0));
            if (i < 1 || i > len) goto theend;
        }
        (void) recover_names (fname, 0, i, &fname_used);
    }
    if (fname_used == ((void *) 0)) goto theend;
    if (called_from_main && ml_open (curbuf) == 0) getout (1);
    ...
    if (mfp == ((void *) 0) || mfp -> mf_fd < 0) {
        if (fname_used != ((void *) 0)) emsg2 ((char_u *) (((char *) ("E306: Cannot open %s"))), (char_u *) (fname_used));
        goto theend;
    }
    buf -> b_ml.ml_mfp = mfp;
    mfp -> mf_buffer = buf;
    mfp -> mf_page_size = 1048;
    if ((hp = mf_get (mfp, (blocknr_T) 0, 1)) == ((void *) 0)) {
        msg_start ();
        msg_puts_attr ((char_u *) (((char *) ("Unable to read block 0 from "))), (attr | 0x1000));
    ...
    if (strncmp ((char *) (b0p -> b0_version), (char *) ("VIM 3.0"), (size_t) (7)) == 0) {
        ...
        msg_puts_attr ((char_u *) (((char *) (" cannot be used with this version of Vim.\n"))), (0x1000));
        msg_puts_attr ((char_u *) (((char *) ("Use Vim version 3.0.\n"))), (0x1000));
        msg_end ();
        goto theend;
    }
    if (ml_check_b0_id (b0p) == 0) {
        emsg2 ((char_u *) (((char *) ("E307: %s does not look like a Vim swap file"))), (char_u *) (mfp -> mf_fname));
        goto theend;
    }
    if (b0_magic_wrong (b0p)) {
        msg_start ();
        msg_outtrans_attr (mfp -> mf_fname, attr | 0x1000);
        msg_puts_attr ((char_u *) (((char *) (" cannot be used on this computer.\n"))), (attr | 0x1000));
        msg_puts_attr ((char_u *) (((char *) ("The file was created on "))), (attr | 0x1000));
        b0p -> b0_fname [0] = '\000';
    ...
    if (b0p -> b0_id [1] == 'c') b0_cm = 0;
    else if (b0p -> b0_id [1] == 'C') {
        b0_cm = 1;
        ((__builtin_object_size ((char *) (mfp -> mf_seed), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (mfp -> mf_seed), (char *) 
          (&b0p->b0_fname[900-2-8]), 8, __builtin_object_size ((char *) (mfp -> mf_seed), 0)) : __inline_memmove_chk ((char *) (mfp -> mf_seed), (char *) 
          (&b0p->b0_fname[900-2-8]), 8));
    }
    ...
    if (mfp -> mf_page_size != (unsigned) char_to_long (b0p -> b0_page_size)) {
        ...
        if (mfp -> mf_page_size < previous_page_size) {
            msg_start ();
            msg_outtrans_attr (mfp -> mf_fname, attr | 0x1000);
            msg_puts_attr ((char_u *) (((char *) (" has been damaged (page size is smaller than minimum value).\n"))), (attr | 0x1000));
            msg_end ();
            goto theend;
        }
        if ((size = lseek (mfp -> mf_fd, (off_t) 0L, 2)) <= 0) mfp -> mf_blocknr_max = 0;
        else mfp -> mf_blocknr_max = (blocknr_T) (size / mfp -> mf_page_size);
        mfp -> mf_infile_count = mfp -> mf_blocknr_max;
        p = alloc (mfp -> mf_page_size);
        if (p == ((void *) 0)) goto theend;
        ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (p), (char *) (hp -> bh_data), previous_page_size,
          __builtin_object_size ((char *) (p), 0)) : __inline_memmove_chk ((char *) (p), (char *) (hp -> bh_data), previous_page_size));
        vim_free (hp -> bh_data);
        hp -> bh_data = p;
        b0p = (ZERO_BL *) (hp -> bh_data);
    }
    if (directly) {
        ...
        if (setfname (curbuf, NameBuff, ((void *) 0), 1) == 0) goto theend;
    }
    home_replace (((void *) 0), mfp -> mf_fname, NameBuff, 1024, 1);
    smsg ((char_u *) ((char *) ("Using swap file \"%s\"")), NameBuff);
    if (buf_spname (curbuf) != ((void *) 0)) ((__builtin_object_size ((char *) (NameBuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (NameBuff), (
      char *) (buf_spname (curbuf)), __builtin_object_size ((char *) (NameBuff), 1 > 1)) : __inline_strcpy_chk ((char *) (NameBuff), (char *) (buf_spname (
      curbuf))));
    else home_replace (((void *) 0), curbuf -> b_ffname, NameBuff, 1024, 1);
    smsg ((char_u *) ((char *) ("Original file \"%s\"")), NameBuff);
    msg_putchar ('\n');
    mtime = char_to_long (b0p -> b0_mtime);
    if (curbuf -> b_ffname != ((void *) 0) && stat (((char *) curbuf -> b_ffname), (&org_stat)) != -1 && ((stat (((char *) mfp -> mf_fname), (&swp_stat)) != -1
      && org_stat.st_mtimespec.tv_sec > swp_stat.st_mtimespec.tv_sec) || org_stat.st_mtimespec.tv_sec != mtime)) {
        emsg ((char_u *) (((char *) ("E308: Warning: Original file may have been changed"))));
    }
    out_flush ();
    b0_ff = (b0p -> b0_fname [900 - 2] & 3);
    if (b0p -> b0_fname [900 - 2] & 8) {
        int fnsize = 898;
        if (b0p -> b0_id [1] != '0') fnsize = 890;
        for (p = b0p -> b0_fname + fnsize; p > b0p -> b0_fname && p [-1] != '\000'; --p);
        b0_fenc = vim_strnsave (p, (int) (b0p -> b0_fname + fnsize - p));
    }
    mf_put (mfp, hp, 0, 0);
    hp = ((void *) 0);
    while (!(curbuf->b_ml.ml_flags&1)) ml_delete ((linenr_T) 1, 0);
    if (curbuf -> b_ffname != ((void *) 0)) orig_file_status = readfile (curbuf -> b_ffname, ((void *) 0), (linenr_T) 0, (linenr_T) 0, (linenr_T) (0x7fffffffL)
      , ((void *) 0), 0x01);
    if (b0_cm >= 0) {
        if (*curbuf->b_p_key != '\000') {
            smsg ((char_u *) ((char *) ("Swap file is encrypted: \"%s\"")), fname_used);
            msg_puts ((char_u *) (((char *) ("\nIf you entered a new crypt key but did not write the text file,"))));
            msg_puts ((char_u *) (((char *) ("\nenter the new crypt key."))));
            msg_puts ((char_u *) (((char *) ("\nIf you wrote the text file after changing the crypt key press enter"))));
            msg_puts ((char_u *) (((char *) ("\nto use the same key for text file and swap file"))));
        }
        else smsg ((char_u *) ((char *) (need_key_msg)), fname_used);
        buf -> b_p_key = get_crypt_key (0, 0);
        if (buf -> b_p_key == ((void *) 0)) buf -> b_p_key = curbuf -> b_p_key;
        else if (*buf->b_p_key == '\000') {
            vim_free (buf -> b_p_key);
            buf -> b_p_key = curbuf -> b_p_key;
        }
        if (buf -> b_p_key == ((void *) 0)) buf -> b_p_key = empty_option;
    }
    if (b0_ff != 0) set_fileformat (b0_ff - 1, 4);
    if (b0_fenc != ((void *) 0)) {
    ...
    buf -> b_ml.ml_stack = ((void *) 0);
    buf -> b_ml.ml_stack_size = 0;
    if (curbuf -> b_ffname == ((void *) 0)) cannot_open = 1;
    else cannot_open = 0;
    serious_error = 0;
    for (; !got_int; line_breakcheck ()) {
        if (hp != ((void *) 0)) mf_put (mfp, hp, 0, 0);
        if ((hp = mf_get (mfp, (blocknr_T) bnum, page_count)) == ((void *) 0)) {
            if (bnum == 1) {
                emsg2 ((char_u *) (((char *) ("E309: Unable to read block 1 from %s"))), (char_u *) (mfp -> mf_fname));
                goto theend;
            }
            ++error;
            ml_append (lnum ++, (char_u *) ((char *) ("???MANY LINES MISSING")), (colnr_T) 0, 1);
        }
        else {
            pp = (PTR_BL *) (hp -> bh_data);
            if (pp -> pb_id == (('p' << 8) + 't')) {
                if (idx == 0 && line_count != 0) {
                    for (i = 0; i < (int) pp -> pb_count; ++i) line_count -= pp -> pb_pointer [i].pe_line_count;
                    if (line_count != 0) {
                        ++error;
                        ml_append (lnum ++, (char_u *) ((char *) ("???LINE COUNT WRONG")), (colnr_T) 0, 1);
                    }
                }
                if (pp -> pb_count == 0) {
                    ml_append (lnum ++, (char_u *) ((char *) ("???EMPTY BLOCK")), (colnr_T) 0, 1);
                    ++error;
                }
                else if (idx < (int) pp -> pb_count) {
                    if (pp -> pb_pointer [idx].pe_bnum < 0) {
                        if (!cannot_open) {
                            ...
                            if (readfile (curbuf -> b_ffname, ((void *) 0), lnum, pp -> pb_pointer [idx].pe_old_lnum - 1, line_count, ((void *) 0), 0) == 0)
                              cannot_open = 1;
                            else lnum += line_count;
                        }
                        if (cannot_open) {
                            ++error;
                            ml_append (lnum ++, (char_u *) ((char *) ("???LINES MISSING")), (colnr_T) 0, 1);
                        }
                        ++idx;
                        continue;
                    }
                ...
                if (dp -> db_id != (('d' << 8) + 'a')) {
                    if (bnum == 1) {
                        emsg2 ((char_u *) (((char *) ("E310: Block 1 ID wrong (%s not a .swp file?)"))), (char_u *) (mfp -> mf_fname));
                        goto theend;
                    }
                    ++error;
                    ml_append (lnum ++, (char_u *) ((char *) ("???BLOCK MISSING")), (colnr_T) 0, 1);
                }
                else {
                    has_error = 0;
                    if (page_count * mfp -> mf_page_size != dp -> db_txt_end) {
                        ml_append (lnum ++, (char_u *) ((char *) ("??? from here until ???END lines may be messed up")), (colnr_T) 0, 1);
                        ++error;
                        has_error = 1;
                    ...
                    *((char_u*)dp+dp->db_txt_end-1) = '\000';
                    if (line_count != dp -> db_line_count) {
                        ml_append (lnum ++, (char_u *) ((char *) ("??? from here until ???END lines may have been inserted/deleted")), (colnr_T) 0, 1);
                        ++error;
                        has_error = 1;
                    }
                    for (i = 0; i < dp -> db_line_count; ++i) {
                        txt_start = (dp -> db_index [i] & (~((unsigned)1<<((sizeof(unsigned)*8) - 1))));
                        if (txt_start <= (int) (sizeof (DATA_BL) - (sizeof (unsigned))) || txt_start >= (int) dp -> db_txt_end) {
                            p = (char_u *) "???";
                            ++error;
                        }
                        else p = (char_u *) dp + txt_start;
                        ml_append (lnum ++, p, (colnr_T) 0, 1);
                    }
                    if (has_error) ml_append (lnum ++, (char_u *) ((char *) ("???END")), (colnr_T) 0, 1);
                }
            }
        }
        if (buf -> b_ml.ml_stack_top == 0) break;
    ...
    while (curbuf -> b_ml.ml_line_count > lnum && !(curbuf->b_ml.ml_flags&1)) ml_delete (curbuf -> b_ml.ml_line_count, 0);
    curbuf -> b_flags |= 0x01;
    recoverymode = 0;
    if (got_int) emsg ((char_u *) (((char *) ("E311: Recovery Interrupted"))));
    else if (error) {
        ++no_wait_return;
        msg ((char_u *) (">>>>>>>>>>>>>"));
        emsg ((char_u *) (((char *) ("E312: Errors detected while recovering; look for lines starting with ???"))));
        --no_wait_return;
        msg ((char_u *) (((char *) ("See \":help E312\" for more information."))));
        msg ((char_u *) (">>>>>>>>>>>>>"));
    }
    else {
        if (curbuf -> b_changed) {
            msg ((char_u *) (((char *) ("Recovery completed. You should check if everything is OK."))));
            msg_puts ((char_u *) (((char *) ("\n(You might want to write out this file under another name\n"))));
            msg_puts ((char_u *) (((char *) ("and run diff with the original file to check for changes)"))));
        }
        else msg ((char_u *) (((char *) ("Recovery completed. Buffer contents equals file contents."))));
        msg_puts ((char_u *) (((char *) ("\nYou may want to delete the .swp file now.\n\n"))));
        cmdline_row = msg_row;
    }
    if (*buf->b_p_key != '\000' && strcmp ((char *) (curbuf -> b_p_key), (char *) (buf -> b_p_key)) != 0) {
        msg_puts ((char_u *) (((char *) ("Using crypt key from swap file for the text file.\n"))));
        set_option_value ((char_u *) "key", 0L, buf -> b_p_key, 4);
    }
    redraw_curbuf_later (40);
    theend : vim_free (fname_used);
    recoverymode = 0;
    if (mfp != ((void *) 0)) {
        if (hp != ((void *) 0)) mf_put (mfp, hp, 0, 0);
        mf_close (mfp, 0);
    ...
    if (buf != ((void *) 0)) {
        if (buf -> b_p_key != curbuf -> b_p_key) free_string_option (buf -> b_p_key);
        free_string_option (buf -> b_p_cm);
        vim_free (buf -> b_ml.ml_stack);
        vim_free (buf);
    }
    if (serious_error && called_from_main) ml_close (curbuf, 1);
    else {
    ...
    char_u * * fname_out;
{
    ...
    if (fname != ((void *) 0)) {
        if (resolve_symlink (fname, fname_buf) == 1) fname_res = fname_buf;
        else fname_res = fname;
    }
    if (list) {
        msg ((char_u *) ((char *) ("Swap files found:")));
        msg_putchar ('\n');
    }
    dir_name = alloc ((unsigned) strlen ((char *) (p_dir)) + 1);
    dirp = p_dir;
    while (dir_name != ((void *) 0) && *dirp) {
        ...
        if (dir_name [0] == '.' && dir_name [1] == '\000') {
            ...
            else num_names = recov_file_names (names, fname_res, 1);
        }
        else {
            if (fname == ((void *) 0)) {
        ...
        for (i = 0; i < num_names; ++i) {
            if (names [i] == ((void *) 0)) {
                for (i = 0; i < num_names; ++i) vim_free (names [i]);
                num_names = 0;
            }
        }
        if (num_names == 0) num_files = 0;
        else if (expand_wildcards (num_names, names, &num_files, &files, 0x10 | 0x02 | 0x20) == 0) num_files = 0;
        if (*dirp == '\000' && file_count + num_files == 0 && fname != ((void *) 0)) {
            struct stat st;
            char_u * swapname;
            swapname = modname (fname_res, (char_u *) ".swp", 1);
            if (swapname != ((void *) 0)) {
        ...
        if (curbuf -> b_ml.ml_mfp != ((void *) 0) && (p = curbuf -> b_ml.ml_mfp -> mf_fname) != ((void *) 0)) {
            for (i = 0; i < num_files; ++i) if (fullpathcmp (p, files [i], 1) & 1) {
                vim_free (files [i]);
                if (--num_files == 0) vim_free (files);
                else for (; i < num_files; ++i) files [i] = files [i + 1];
            }
        }
        if (nr > 0) {
            ...
            if (dir_name [0] == '.' && dir_name [1] == '\000') {
                if (fname == ((void *) 0)) msg_puts ((char_u *) (((char *) ("   In current directory:\n"))));
                else msg_puts ((char_u *) (((char *) ("   Using specified name:\n"))));
            }
            else {
                msg_puts ((char_u *) (((char *) ("   In directory "))));
            ...
            else msg_puts ((char_u *) (((char *) ("      -- none --\n"))));
            out_flush ();
        }
        else file_count += num_files;
        for (i = 0; i < num_names; ++i) vim_free (names [i]);
        if (num_files > 0) FreeWild (num_files, files);
    }
    vim_free (dir_name);
    return file_count;
}
...
{
    char_u * d, * s, * f;
    f = fix_fname (name != ((void *) 0) ? name : (char_u *) "");
    d = ((void *) 0);
    if (f != ((void *) 0)) {
        s = alloc ((unsigned) (strlen ((char *) (f)) + 1));
        if (s != ((void *) 0)) {
            ((__builtin_object_size ((char *) (s), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (s), (char *) (f), __builtin_object_size ((char *) (s
              ), 1 > 1)) : __inline_strcpy_chk ((char *) (s), (char *) (f)));
            for (d = s; *d != '\000'; ++d) if (vim_ispathsep (*d)) *d = '%';
    ...
    char_u * fname;
{
    ...
    if (stat (((char *) fname), (&st)) != -1) {
        if (mch_get_uname (st.st_uid, uname, 40) == 1) {
            msg_puts ((char_u *) (((char *) ("          owned by: "))));
            msg_outtrans (uname);
            msg_puts ((char_u *) (((char *) ("   dated: "))));
        }
        else msg_puts ((char_u *) (((char *) ("             dated: "))));
        x = st.st_mtimespec.tv_sec;
        p = ctime (&x);
        if (p == ((void *) 0)) msg_puts ((char_u *) ("(invalid)\n"));
        else msg_puts ((char_u *) (p));
    }
    fd = open (((char *) fname), (0x0000 | 0), (0));
    if (fd >= 0) {
        if (read (fd, (char *) &b0, sizeof (b0)) == sizeof (b0)) {
            if (strncmp ((char *) (b0.b0_version), (char *) ("VIM 3.0"), (size_t) (7)) == 0) {
                msg_puts ((char_u *) (((char *) ("         [from Vim version 3.0]"))));
            }
            else if (ml_check_b0_id (&b0) == 0) {
                msg_puts ((char_u *) (((char *) ("         [does not look like a Vim swap file]"))));
            }
            else {
                msg_puts ((char_u *) (((char *) ("         file name: "))));
                if (b0.b0_fname [0] == '\000') msg_puts ((char_u *) (((char *) ("[No Name]"))));
                else msg_outtrans (b0.b0_fname);
                msg_puts ((char_u *) (((char *) ("\n          modified: "))));
                msg_puts ((char_u *) (b0.b0_fname [900 - 1] ? ((char *) ("YES")) : ((char *) ("no"))));
                if (*(b0.b0_uname) != '\000') {
                    msg_puts ((char_u *) (((char *) ("\n         user name: "))));
                    msg_outtrans (b0.b0_uname);
                }
                if (*(b0.b0_hname) != '\000') {
                    if (*(b0.b0_uname) != '\000') msg_puts ((char_u *) (((char *) ("   host name: "))));
                    else msg_puts ((char_u *) (((char *) ("\n         host name: "))));
                ...
                if (char_to_long (b0.b0_pid) != 0L) {
                    ...
                    if (kill ((pid_t) char_to_long (b0.b0_pid), 0) == 0) {
                        msg_puts ((char_u *) (((char *) (" (still running)"))));
        ...
        else msg_puts ((char_u *) (((char *) ("         [cannot be read]"))));
        close (fd);
    }
    else msg_puts ((char_u *) (((char *) ("         [cannot be opened]"))));
    msg_putchar ('\n');
    return x;
}
    ...
    int prepend_dot;
{
    ...
    if (prepend_dot) {
        ...
        if (names [num_names] == ((void *) 0)) goto end;
        ++num_names;
    }
    ...
    if (num_names >= 1) {
        ...
        if (i > 0) p += i;
        if (strcmp ((char *) (p), (char *) (names [num_names])) != 0) ++num_names;
        else vim_free (names [num_names]);
    }
    else ++num_names;
    ...
    if (i > 0) p += i;
    if (strcmp ((char *) (names [num_names - 1]), (char *) (p)) == 0) vim_free (names [num_names]);
    else ++num_names;
    end : curbuf -> b_shortname = shortname;
    return num_names;
}
    ...
    int check_char;
{
    ...
    for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) {
        if (buf -> b_ml.ml_mfp == ((void *) 0) || buf -> b_ml.ml_mfp -> mf_fname == ((void *) 0)) continue;
        ml_flush_line (buf);
        (void) ml_find_line (buf, (linenr_T) 0, 0x02);
        if (bufIsChanged (buf) && check_file && mf_need_trans (buf -> b_ml.ml_mfp) && buf -> b_ffname != ((void *) 0)) {
            if (stat (((char *) buf -> b_ffname), (&st)) == -1 || st.st_mtimespec.tv_sec != buf -> b_mtime_read || st.st_size != buf -> b_orig_size) {
                ml_preserve (buf, 0);
        ...
        if (buf -> b_ml.ml_mfp -> mf_dirty) {
            (void) mf_sync (buf -> b_ml.ml_mfp, (check_char ? 2 : 0) | (bufIsChanged (buf) ? 4 : 0));
    ...
    int message;
{
    ...
    if (mfp == ((void *) 0) || mfp -> mf_fname == ((void *) 0)) {
        if (message) emsg ((char_u *) (((char *) ("E313: Cannot preserve, there is no swap file"))));
        return;
    }
    got_int = 0;
    ml_flush_line (buf);
    ...
    if (mf_need_trans (mfp) && !got_int) {
        ...
        (void) ml_find_line (buf, (linenr_T) 0, 0x02);
        if (mf_sync (mfp, 1 | 4) == 0) status = 0;
        buf -> b_ml.ml_stack_top = 0;
    }
    theend : got_int |= got_int_save;
    if (message) {
        if (status == 1) msg ((char_u *) (((char *) ("File preserved"))));
        else emsg ((char_u *) (((char *) ("E314: Preserve failed"))));
    }
}
    ...
    int will_change;
{
    ...
    if (lnum > buf -> b_ml.ml_line_count) {
        if (recursive == 0) {
            ++recursive;
            emsgn ((char_u *) (((char *) ("E315: ml_get: invalid lnum: %ld"))), (long) (lnum));
            --recursive;
        }
        errorret : ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) ("???"),
          __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) ("???")));
        return IObuff;
    }
    if (lnum <= 0) lnum = 1;
    if (buf -> b_ml.ml_mfp == ((void *) 0)) return (char_u *) "";
    if (buf -> b_ml.ml_line_lnum != lnum || mf_dont_release) {
        ml_flush_line (buf);
        if ((hp = ml_find_line (buf, lnum, 0x13)) == ((void *) 0)) {
            if (recursive == 0) {
                ++recursive;
                emsgn ((char_u *) (((char *) ("E316: ml_get: cannot find line %ld"))), (long) (lnum));
                --recursive;
            }
            goto errorret;
        }
        dp = (DATA_BL *) (hp -> bh_data);
        ptr = (char_u *) dp + ((dp -> db_index [lnum - buf -> b_ml.ml_locked_low]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1))));
        buf -> b_ml.ml_line_ptr = ptr;
        buf -> b_ml.ml_line_lnum = lnum;
        buf -> b_ml.ml_flags &= ~2;
    }
    if (will_change) buf -> b_ml.ml_flags |= (4 | 8);
...
int ml_append (lnum, line, len, newfile)
    ...
    int newfile;
{
    if (curbuf -> b_ml.ml_mfp == ((void *) 0) && open_buffer (0, ((void *) 0), 0) == 0) return 0;
    if (curbuf -> b_ml.ml_line_lnum != 0) ml_flush_line (curbuf);
...
int ml_append_buf (buf, lnum, line, len, newfile)
    ...
    int newfile;
{
    if (buf -> b_ml.ml_mfp == ((void *) 0)) return 0;
    if (buf -> b_ml.ml_line_lnum != 0) ml_flush_line (buf);
    ...
    int mark;
{
    ...
    PTR_BL * pp;
    infoptr_T * ip;
    if (lnum > buf -> b_ml.ml_line_count || buf -> b_ml.ml_mfp == ((void *) 0)) return 0;
    if (lowest_marked && lowest_marked > lnum) lowest_marked = lnum + 1;
    if (len == 0) len = (colnr_T) strlen ((char *) (line)) + 1;
    space_needed = len + (sizeof (unsigned));
    mfp = buf -> b_ml.ml_mfp;
    page_size = mfp -> mf_page_size;
    if ((hp = ml_find_line (buf, lnum == 0 ? (linenr_T) 1 : lnum, 0x12)) == ((void *) 0)) return 0;
    buf -> b_ml.ml_flags &= ~1;
    if (lnum == 0) db_idx = -1;
    else db_idx = lnum - buf -> b_ml.ml_locked_low;
    line_count = buf -> b_ml.ml_locked_high - buf -> b_ml.ml_locked_low;
    dp = (DATA_BL *) (hp -> bh_data);
    if ((int) dp -> db_free < space_needed && db_idx == line_count - 1 && lnum < buf -> b_ml.ml_line_count) {
        --(buf->b_ml.ml_locked_lineadd);
        --(buf->b_ml.ml_locked_high);
        if ((hp = ml_find_line (buf, lnum + 1, 0x12)) == ((void *) 0)) return 0;
        db_idx = -1;
        line_count = buf -> b_ml.ml_locked_high - buf -> b_ml.ml_locked_low;
        ;
        dp = (DATA_BL *) (hp -> bh_data);
    ...
    if ((int) dp -> db_free >= space_needed) {
        ...
        if (line_count > db_idx + 1) {
            if (db_idx < 0) offset = dp -> db_txt_end;
            else offset = ((dp -> db_index [db_idx]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1))));
            ((__builtin_object_size ((char *) ((char *) dp + dp -> db_txt_start), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((char *) dp + dp ->
              db_txt_start), (char *) ((char *) dp + dp -> db_txt_start + len), (size_t) (offset - (dp -> db_txt_start + len)), __builtin_object_size ((char *)
              ((char *) dp + dp -> db_txt_start), 0)) : __inline_memmove_chk ((char *) ((char *) dp + dp -> db_txt_start), (char *) ((char *) dp + dp ->
              db_txt_start + len), (size_t) (offset - (dp -> db_txt_start + len))));
            for (i = line_count - 1; i > db_idx; --i) dp -> db_index [i + 1] = dp -> db_index [i] - len;
            dp -> db_index [db_idx + 1] = offset - len;
        }
        else dp -> db_index [db_idx + 1] = dp -> db_txt_start;
        ((__builtin_object_size ((char *) ((char *) dp + dp -> db_index [db_idx + 1]), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((char *) dp + dp
          -> db_index [db_idx + 1]), (char *) (line), (size_t) len, __builtin_object_size ((char *) ((char *) dp + dp -> db_index [db_idx + 1]), 0)) :
          __inline_memmove_chk ((char *) ((char *) dp + dp -> db_index [db_idx + 1]), (char *) (line), (size_t) len));
        if (mark) dp -> db_index [db_idx + 1] |= ((unsigned) 1 << ((sizeof (unsigned) *8) - 1));
        buf -> b_ml.ml_flags |= 4;
        if (!newfile) buf -> b_ml.ml_flags |= 8;
    }
    else {
        ...
        if (db_idx < 0) {
            ...
            if (lines_moved == 0) in_left = 0;
                ...
                data_moved = ((dp -> db_index [db_idx]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1)))) - dp -> db_txt_start;
        ...
        if ((hp_new = ml_new_data (mfp, newfile, page_count)) == ((void *) 0)) {
            --(buf->b_ml.ml_locked_lineadd);
            --(buf->b_ml.ml_locked_high);
            return 0;
        }
        ...
        if (!in_left) {
            ...
            if (mark) dp_right -> db_index [0] |= ((unsigned) 1 << ((sizeof (unsigned) *8) - 1));
            ((__builtin_object_size ((char *) ((char *) dp_right + dp_right -> db_txt_start), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((char *)
              dp_right + dp_right -> db_txt_start), (char *) (line), (size_t) len, __builtin_object_size ((char *) ((char *) dp_right + dp_right -> db_txt_start
              ), 0)) : __inline_memmove_chk ((char *) ((char *) dp_right + dp_right -> db_txt_start), (char *) (line), (size_t) len));
            ++line_count_right;
        }
        if (lines_moved) {
            ...
            ((__builtin_object_size ((char *) ((char *) dp_right + dp_right -> db_txt_start), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((char *)
              dp_right + dp_right -> db_txt_start), (char *) ((char *) dp_left + dp_left -> db_txt_start), (size_t) data_moved, __builtin_object_size ((char *)
              ((char *) dp_right + dp_right -> db_txt_start), 0)) : __inline_memmove_chk ((char *) ((char *) dp_right + dp_right -> db_txt_start), (char *) ((
            ...
            for (to = line_count_right, from = db_idx + 1; from < line_count_left; ++from, ++to) dp_right -> db_index [to] = dp -> db_index [from] + offset;
        ...
        if (in_left) {
            ...
            if (mark) dp_left -> db_index [line_count_left] |= ((unsigned) 1 << ((sizeof (unsigned) *8) - 1));
            ((__builtin_object_size ((char *) ((char *) dp_left + dp_left -> db_txt_start), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((char *)
              dp_left + dp_left -> db_txt_start), (char *) (line), (size_t) len, __builtin_object_size ((char *) ((char *) dp_left + dp_left -> db_txt_start), 0
              )) : __inline_memmove_chk ((char *) ((char *) dp_left + dp_left -> db_txt_start), (char *) (line), (size_t) len));
            ++line_count_left;
        }
        if (db_idx < 0) {
            lnum_left = lnum + 1;
            ...
            lnum_left = 0;
            if (in_left) lnum_right = lnum + 2;
            else lnum_right = lnum + 1;
        }
        dp_left -> db_line_count = line_count_left;
        dp_right -> db_line_count = line_count_right;
        if (lines_moved || in_left) buf -> b_ml.ml_flags |= 4;
        if (!newfile && db_idx >= 0 && in_left) buf -> b_ml.ml_flags |= 8;
        ...
        for (stack_idx = buf -> b_ml.ml_stack_top - 1; stack_idx >= 0; --stack_idx) {
            ...
            pb_idx = ip -> ip_index;
            if ((hp = mf_get (mfp, ip -> ip_bnum, 1)) == ((void *) 0)) return 0;
            pp = (PTR_BL *) (hp -> bh_data);
            if (pp -> pb_id != (('p' << 8) + 't')) {
                emsg ((char_u *) (((char *) ("E317: pointer block id wrong 3"))));
                mf_put (mfp, hp, 0, 0);
                return 0;
            }
            if (pp -> pb_count < pp -> pb_count_max) {
                if (pb_idx + 1 < (int) pp -> pb_count) ((__builtin_object_size ((char *) (&pp->pb_pointer[pb_idx+2]), 0) != (size_t) - 1) ?
                  __builtin___memmove_chk ((char *) (&pp->pb_pointer[pb_idx+2]), (char *) (&pp->pb_pointer[pb_idx+1]), (size_t) (pp -> pb_count - pb_idx - 1) *
                  sizeof (PTR_EN), __builtin_object_size ((char *) (&pp->pb_pointer[pb_idx+2]), 0)) : __inline_memmove_chk ((char *) (&pp->pb_pointer[pb_idx+2]
                  ), (char *) (&pp->pb_pointer[pb_idx+1]), (size_t) (pp -> pb_count - pb_idx - 1) * sizeof (PTR_EN)));
                ++pp->pb_count;
                ...
                if (lnum_left != 0) pp -> pb_pointer [pb_idx].pe_old_lnum = lnum_left;
                if (lnum_right != 0) pp -> pb_pointer [pb_idx + 1].pe_old_lnum = lnum_right;
                mf_put (mfp, hp, 1, 0);
                ...
                for (;;) {
                    ...
                    if (hp_new == ((void *) 0)) return 0;
                    pp_new = (PTR_BL *) (hp_new -> bh_data);
                    if (hp -> bh_bnum != 1) break;
                    ((__builtin_object_size ((char *) (pp_new), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (pp_new), (char *) (pp), (size_t)
                      page_size, __builtin_object_size ((char *) (pp_new), 0)) : __inline_memmove_chk ((char *) (pp_new), (char *) (pp), (size_t) page_size));
                    pp -> pb_count = 1;
                ...
                if (total_moved) {
                    ((__builtin_object_size ((char *) (&pp_new->pb_pointer[0]), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (&pp_new->pb_pointer[0]
                      ), (char *) (&pp->pb_pointer[pb_idx+1]), (size_t) (total_moved) * sizeof (PTR_EN), __builtin_object_size ((char *) 
                      (&pp_new->pb_pointer[0]), 0)) : __inline_memmove_chk ((char *) (&pp_new->pb_pointer[0]), (char *) (&pp->pb_pointer[pb_idx+1]), (size_t) (
                      total_moved) * sizeof (PTR_EN)));
                    pp_new -> pb_count = total_moved;
                    pp -> pb_count -= total_moved - 1;
                    pp -> pb_pointer [pb_idx + 1].pe_bnum = bnum_right;
                    pp -> pb_pointer [pb_idx + 1].pe_line_count = line_count_right;
                    pp -> pb_pointer [pb_idx + 1].pe_page_count = page_count_right;
                    if (lnum_right) pp -> pb_pointer [pb_idx + 1].pe_old_lnum = lnum_right;
                }
                else {
                    pp_new -> pb_count = 1;
                ...
                pp -> pb_pointer [pb_idx].pe_line_count = line_count_left;
                pp -> pb_pointer [pb_idx].pe_page_count = page_count_left;
                if (lnum_left) pp -> pb_pointer [pb_idx].pe_old_lnum = lnum_left;
                lnum_left = 0;
                lnum_right = 0;
                line_count_right = 0;
                for (i = 0; i < (int) pp_new -> pb_count; ++i) line_count_right += pp_new -> pb_pointer [i].pe_line_count;
                line_count_left = 0;
                for (i = 0; i < (int) pp -> pb_count; ++i) line_count_left += pp -> pb_pointer [i].pe_line_count;
        ...
        if (stack_idx < 0) {
            emsg ((char_u *) (((char *) ("E318: Updated too many blocks?"))));
            buf -> b_ml.ml_stack_top = 0;
        }
    }
    ml_updatechunk (buf, lnum + 1, (long) len, 1);
    if (netbeans_active ()) {
        if (strlen ((char *) (line)) > 0) netbeans_inserted (buf, lnum + 1, (colnr_T) 0, line, (int) strlen ((char *) (line)));
        netbeans_inserted (buf, lnum + 1, (colnr_T) strlen ((char *) (line)), (char_u *) "\n", 1);
    }
    return 1;
}
    ...
    int copy;
{
    ...
    if (curbuf -> b_ml.ml_mfp == ((void *) 0) && open_buffer (0, ((void *) 0), 0) == 0) return 0;
    if (copy && (line = vim_strsave (line)) == ((void *) 0)) return 0;
    if (netbeans_active ()) {
        netbeans_removed (curbuf, lnum, 0, (long) strlen ((char *) (ml_get (lnum))));
        netbeans_inserted (curbuf, lnum, 0, line, (int) strlen ((char *) (line)));
    }
    if (curbuf -> b_ml.ml_line_lnum != lnum) ml_flush_line (curbuf);
    else if (curbuf -> b_ml.ml_flags & 2) vim_free (curbuf -> b_ml.ml_line_ptr);
    ...
    int message;
{
    ...
    long line_size;
    int i;
    if (lnum < 1 || lnum > buf -> b_ml.ml_line_count) return 0;
    if (lowest_marked && lowest_marked > lnum) lowest_marked --;
    if (buf -> b_ml.ml_line_count == 1) {
        if (message && !netbeansSuppressNoLines) set_keep_msg ((char_u *) ((char *) (no_lines_msg)), 0);
        i = ml_replace ((linenr_T) 1, (char_u *) "", 1);
        buf -> b_ml.ml_flags |= 1;
        return i;
    }
    mfp = buf -> b_ml.ml_mfp;
    if (mfp == ((void *) 0)) return 0;
    if ((hp = ml_find_line (buf, lnum, 0x11)) == ((void *) 0)) return 0;
    dp = (DATA_BL *) (hp -> bh_data);
    ...
    else line_size = ((dp -> db_index [idx - 1]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1)))) - line_start;
    if (netbeans_active ()) netbeans_removed (buf, lnum, 0, (long) line_size);
    if (count == 1) {
        mf_free (mfp, hp);
        buf -> b_ml.ml_locked = ((void *) 0);
        for (stack_idx = buf -> b_ml.ml_stack_top - 1; stack_idx >= 0; --stack_idx) {
            ...
            pp = (PTR_BL *) (hp -> bh_data);
            if (pp -> pb_id != (('p' << 8) + 't')) {
                emsg ((char_u *) (((char *) ("E317: pointer block id wrong 4"))));
                mf_put (mfp, hp, 0, 0);
                return 0;
            }
            count = --(pp->pb_count);
            if (count == 0) mf_free (mfp, hp);
                ...
                if (count != idx) ((__builtin_object_size ((char *) (&pp->pb_pointer[idx]), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) 
                  (&pp->pb_pointer[idx]), (char *) (&pp->pb_pointer[idx+1]), (size_t) (count - idx) * sizeof (PTR_EN), __builtin_object_size ((char *) 
                  (&pp->pb_pointer[idx]), 0)) : __inline_memmove_chk ((char *) (&pp->pb_pointer[idx]), (char *) (&pp->pb_pointer[idx+1]), (size_t) (count - idx
                  ) * sizeof (PTR_EN)));
                mf_put (mfp, hp, 1, 0);
        ...
        ((__builtin_object_size ((char *) ((char *) dp + text_start + line_size), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((char *) dp +
          text_start + line_size), (char *) ((char *) dp + text_start), (size_t) (line_start - text_start), __builtin_object_size ((char *) ((char *) dp +
          text_start + line_size), 0)) : __inline_memmove_chk ((char *) ((char *) dp + text_start + line_size), (char *) ((char *) dp + text_start), (size_t) (
          line_start - text_start)));
        for (i = idx; i < count - 1; ++i) dp -> db_index [i] = dp -> db_index [i + 1] + line_size;
    ...
    linenr_T lnum;
{
    bhdr_T * hp;
    DATA_BL * dp;
    if (lnum < 1 || lnum > curbuf -> b_ml.ml_line_count || curbuf -> b_ml.ml_mfp == ((void *) 0)) return;
    if (lowest_marked == 0 || lowest_marked > lnum) lowest_marked = lnum;
    if ((hp = ml_find_line (curbuf, lnum, 0x13)) == ((void *) 0)) return;
    dp = (DATA_BL *) (hp -> bh_data);
...
linenr_T ml_firstmarked () {
    ...
    linenr_T lnum;
    int i;
    if (curbuf -> b_ml.ml_mfp == ((void *) 0)) return (linenr_T) 0;
    for (lnum = lowest_marked; lnum <= curbuf -> b_ml.ml_line_count;) {
        if ((hp = ml_find_line (curbuf, lnum, 0x13)) == ((void *) 0)) return (linenr_T) 0;
        dp = (DATA_BL *) (hp -> bh_data);
        for (i = lnum - curbuf -> b_ml.ml_locked_low; lnum <= curbuf -> b_ml.ml_locked_high; ++i, ++lnum) if ((dp -> db_index [i]) & ((unsigned) 1 << ((sizeof (
          unsigned) *8) - 1))) {
...
void ml_clearmarked () {
    ...
    linenr_T lnum;
    int i;
    if (curbuf -> b_ml.ml_mfp == ((void *) 0)) return;
    for (lnum = lowest_marked; lnum <= curbuf -> b_ml.ml_line_count;) {
        if ((hp = ml_find_line (curbuf, lnum, 0x13)) == ((void *) 0)) return;
        dp = (DATA_BL *) (hp -> bh_data);
        for (i = lnum - curbuf -> b_ml.ml_locked_low; lnum <= curbuf -> b_ml.ml_locked_high; ++i, ++lnum) if ((dp -> db_index [i]) & ((unsigned) 1 << ((sizeof (
    ...
    buf_T * buf;
{
    ...
    if (buf -> b_ml.ml_line_lnum == 0 || buf -> b_ml.ml_mfp == ((void *) 0)) return;
    if (buf -> b_ml.ml_flags & 2) {
        ...
        hp = ml_find_line (buf, lnum, 0x13);
        if (hp == ((void *) 0)) emsgn ((char_u *) (((char *) ("E320: Cannot find line %ld"))), (long) (lnum));
        else {
            dp = (DATA_BL *) (hp -> bh_data);
            idx = lnum - buf -> b_ml.ml_locked_low;
            ...
            else old_len = (dp -> db_index [idx - 1] & (~((unsigned)1<<((sizeof(unsigned)*8) - 1)))) - start;
            new_len = (colnr_T) strlen ((char *) (new_line)) + 1;
            extra = new_len - old_len;
            if ((int) dp -> db_free >= extra) {
                count = buf -> b_ml.ml_locked_high - buf -> b_ml.ml_locked_low + 1;
                if (extra != 0 && idx < count - 1) {
                    ((__builtin_object_size ((char *) ((char *) dp + dp -> db_txt_start - extra), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((
                      char *) dp + dp -> db_txt_start - extra), (char *) ((char *) dp + dp -> db_txt_start), (size_t) (start - dp -> db_txt_start),
                      __builtin_object_size ((char *) ((char *) dp + dp -> db_txt_start - extra), 0)) : __inline_memmove_chk ((char *) ((char *) dp + dp ->
                      db_txt_start - extra), (char *) ((char *) dp + dp -> db_txt_start), (size_t) (start - dp -> db_txt_start)));
                    for (i = idx + 1; i < count; ++i) dp -> db_index [i] -= extra;
                }
                dp -> db_index [idx] -= extra;
                dp -> db_free -= extra;
                dp -> db_txt_start -= extra;
                ((__builtin_object_size ((char *) (old_line - extra), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (old_line - extra), (char *) (
                  new_line), (size_t) new_len, __builtin_object_size ((char *) (old_line - extra), 0)) : __inline_memmove_chk ((char *) (old_line - extra), (
                  char *) (new_line), (size_t) new_len));
                buf -> b_ml.ml_flags |= (4 | 8);
                ml_updatechunk (buf, lnum, (long) extra, 3);
            }
            else {
                (void) ml_append_int (buf, lnum, new_line, new_len, 0, (dp -> db_index [idx] & ((unsigned) 1 << ((sizeof (unsigned) *8) - 1))));
    ...
    int page_count;
{
    bhdr_T * hp;
    DATA_BL * dp;
    if ((hp = mf_new (mfp, negative, page_count)) == ((void *) 0)) return ((void *) 0);
    dp = (DATA_BL *) (hp -> bh_data);
    dp -> db_id = (('d' << 8) + 'a');
    ...
    memfile_T * mfp;
{
    bhdr_T * hp;
    PTR_BL * pp;
    if ((hp = mf_new (mfp, 0, 1)) == ((void *) 0)) return ((void *) 0);
    pp = (PTR_BL *) (hp -> bh_data);
    pp -> pb_id = (('p' << 8) + 't');
    pp -> pb_count = 0;
    ...
    int action;
{
    ...
    if (buf -> b_ml.ml_locked) {
        ...
        mf_put (mfp, buf -> b_ml.ml_locked, buf -> b_ml.ml_flags & 4, buf -> b_ml.ml_flags & 8);
        buf -> b_ml.ml_locked = ((void *) 0);
        if (buf -> b_ml.ml_locked_lineadd != 0) ml_lineadd (buf, buf -> b_ml.ml_locked_lineadd);
    }
    if (action == 0x02) return ((void *) 0);
    bnum = 1;
    page_count = 1;
    low = 1;
    ...
    if (action == 0x13) {
        ...
        if (top < 0) buf -> b_ml.ml_stack_top = 0;
    }
    else buf -> b_ml.ml_stack_top = 0;
    for (;;) {
        if ((hp = mf_get (mfp, bnum, page_count)) == ((void *) 0)) goto error_noblock;
        if (action == 0x12) ++high;
        else if (action == 0x11) --high;
        dp = (DATA_BL *) (hp -> bh_data);
        if (dp -> db_id == (('d' << 8) + 'a')) {
        ...
        pp = (PTR_BL *) (dp);
        if (pp -> pb_id != (('p' << 8) + 't')) {
            emsg ((char_u *) (((char *) ("E317: pointer block id wrong"))));
            goto error_block;
        }
        ...
        if (idx >= (int) pp -> pb_count) {
            if (lnum > buf -> b_ml.ml_line_count) emsgn ((char_u *) (((char *) ("E322: line number out of range: %ld past the end"))), (long) (lnum - buf ->
              b_ml.ml_line_count));
            else emsgn ((char_u *) (((char *) ("E323: line count wrong in block %ld"))), (long) (bnum));
            goto error_block;
        }
        if (action == 0x11) {
    ...
    error_block : mf_put (mfp, hp, 0, 0);
    error_noblock : if (action == 0x11) ml_lineadd (buf, 1);
    else if (action == 0x12) ml_lineadd (buf, -1);
    buf -> b_ml.ml_stack_top = 0;
    return ((void *) 0);
}
    ...
    buf_T * buf;
{
    ...
    if (top == buf -> b_ml.ml_stack_size) {
        ;
        newstack = (infoptr_T *) alloc ((unsigned) sizeof (infoptr_T) * (buf -> b_ml.ml_stack_size + 5));
        if (newstack == ((void *) 0)) return -1;
        ((__builtin_object_size ((char *) (newstack), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newstack), (char *) (buf -> b_ml.ml_stack), (
          size_t) top * sizeof (infoptr_T), __builtin_object_size ((char *) (newstack), 0)) : __inline_memmove_chk ((char *) (newstack), (char *) (buf -> b_ml.
          ml_stack), (size_t) top * sizeof (infoptr_T)));
        vim_free (buf -> b_ml.ml_stack);
    ...
    int count;
{
    ...
    for (idx = buf -> b_ml.ml_stack_top - 1; idx >= 0; --idx) {
        ...
        if ((hp = mf_get (mfp, ip -> ip_bnum, 1)) == ((void *) 0)) break;
        pp = (PTR_BL *) (hp -> bh_data);
        if (pp -> pb_id != (('p' << 8) + 't')) {
            mf_put (mfp, hp, 0, 0);
            emsg ((char_u *) (((char *) ("E317: pointer block id wrong 2"))));
            break;
        }
    ...
    char_u * buf;
{
    ...
    vim_strncpy (tmp, fname, 1024 - 1);
    for (;;) {
        if (++depth == 100) {
            emsg2 ((char_u *) (((char *) ("E773: Symlink loop for \"%s\""))), (char_u *) (fname));
            return 0;
        }
        ...
        buf [ret] = '\000';
        if (mch_isFullName (buf)) ((__builtin_object_size ((char *) (tmp), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (tmp), (char *) (buf),
          __builtin_object_size ((char *) (tmp), 1 > 1)) : __inline_strcpy_chk ((char *) (tmp), (char *) (buf)));
        else {
            char_u * tail;
            tail = gettail (tmp);
            if (strlen ((char *) (tail)) + strlen ((char *) (buf)) >= 1024) return 0;
            ((__builtin_object_size ((char *) (tail), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (tail), (char *) (buf), __builtin_object_size ((
              char *) (tail), 1 > 1)) : __inline_strcpy_chk ((char *) (tail), (char *) (buf)));
        }
    }
    return vim_FullName (tmp, buf, 1024, 1);
}

char_u * makeswapname (fname, ffname, buf, dir_name)
    char_u * fname;
    char_u * ffname __attribute__ ((unused));
    buf_T * buf;
    char_u * dir_name;
{
    char_u * r, * s;
    ...
    if (vim_ispathsep (*((s)-1)) && s [-1] == s [-2]) {
        r = ((void *) 0);
        if ((s = make_percent_swname (dir_name, fname)) != ((void *) 0)) {
    ...
    if (resolve_symlink (fname, fname_buf) == 1) fname_res = fname_buf;
    r = buf_modname ((buf -> b_p_sn || buf -> b_shortname), fname_res, (char_u *) ".swp", dir_name [0] == '.' && dir_name [1] == '\000');
    ...
    char_u * dname;
{
    ...
    int save_char;
    tail = gettail (fname);
    if (dname [0] == '.' && dname [1] == '\000') retval = vim_strsave (fname);
    else if (dname [0] == '.' && vim_ispathsep (dname [1])) {
        if (tail == fname) retval = concat_fnames (dname + 2, tail, 1);
        else {
            save_char = *tail;
            * tail = '\000';
            t = concat_fnames (fname, dname + 2, 1);
            * tail = save_char;
            if (t == ((void *) 0)) retval = ((void *) 0);
            else {
    ...
    else retval = concat_fnames (dname, tail, 1);
    return retval;
}
    ...
    char_u * fname;
{
    ...
    char * p;
    ++no_wait_return;
    (void) emsg ((char_u *) (((char *) ("E325: ATTENTION"))));
    msg_puts ((char_u *) (((char *) ("\nFound a swap file by the name \""))));
    msg_home_replace (fname);
    msg_puts ((char_u *) ("\"\n"));
    sx = swapfile_info (fname);
    msg_puts ((char_u *) (((char *) ("While opening file \""))));
    ...
    if (stat (((char *) buf -> b_fname), (&st)) != -1) {
        ...
        if (sx != 0 && x > sx) msg_puts ((char_u *) (((char *) ("      NEWER than swap file!\n"))));
    }
    msg_puts ((char_u *) (((char *) (
"\n(1) Another program may be editing the same file.\n    If this is the case, be careful not to end up with two\n    different instances of the same file when making changes.\n"
    ))));
    msg_puts ((char_u *) (((char *) ("    Quit, or continue with caution.\n"))));
    msg_puts ((char_u *) (((char *) ("\n(2) An edit session for this file crashed.\n"))));
    msg_puts ((char_u *) (((char *) ("    If this is the case, use \":recover\" or \"vim -r "))));
    msg_outtrans (buf -> b_fname);
    msg_puts ((char_u *) (((char *) ("\"\n    to recover the changes (see \":help recovery\").\n"))));
    msg_puts ((char_u *) (((char *) ("    If you did this already, delete the swap file \""))));
    msg_outtrans (fname);
...
static int do_swapexists (buf, fname)
    ...
    char_u * fname;
{
    set_vim_var_string (45, fname, -1);
    set_vim_var_string (46, ((void *) 0), -1);
    ++allbuf_lock;
    apply_autocmds (EVENT_SWAPEXISTS, buf -> b_fname, ((void *) 0), 0, ((void *) 0));
    --allbuf_lock;
    set_vim_var_string (45, ((void *) 0), -1);
    switch (*get_vim_var_str(46)) {
    case 'o' :
        return 1;
    case 'e' :
        return 2;
    ...
    char_u * old_fname;
{
    ...
    char_u * dir_name;
    int r;
    dir_name = alloc ((unsigned) strlen ((char *) (*dirp)) + 1);
    if (dir_name != ((void *) 0)) (void) copy_option_part (dirp, dir_name, 31000, ",");
    if (dir_name == ((void *) 0)) fname = ((void *) 0);
    else fname = makeswapname (buf -> b_fname, buf -> b_ffname, buf, dir_name);
    for (;;) {
        if (fname == ((void *) 0)) break;
        ...
        if (fname [n - 2] == 'w' && fname [n - 1] == 'p' && !(buf->b_p_sn||buf->b_shortname)) {
            ...
            if (vim_strchr (tail, '.') != ((void *) 0) || strlen ((char *) (tail)) > (size_t) 8 || *gettail(fname) == '.') {
                fname2 = alloc (n + 2);
                if (fname2 != ((void *) 0)) {
                    ((__builtin_object_size ((char *) (fname2), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (fname2), (char *) (fname),
                      __builtin_object_size ((char *) (fname2), 1 > 1)) : __inline_strcpy_chk ((char *) (fname2), (char *) (fname)));
                    if (vim_strchr (tail, '.') != ((void *) 0)) fname2 [n - 1] = 'x';
                    else if (*gettail(fname) == '.') {
                        fname2 [n] = 'x';
                        fname2 [n + 1] = '\000';
                    }
                    else fname2 [n - 5] += 1;
                    f1 = open (((char *) fname), (0x0000 | 0), (0));
                    if (f1 < 0) {
                        f1 = open ((((char *) fname)), ((0x0002 | 0x0200 | 0x0800 | 0)), ((mode_t) 0600));
                        created1 = 1;
                    }
                    if (f1 >= 0) {
                        f2 = open (((char *) fname2), (0x0000 | 0), (0));
                        if (f2 < 0) {
                            f2 = open ((((char *) fname2)), ((0x0002 | 0x0200 | 0x0800 | 0)), ((mode_t) 0600));
                            created2 = 1;
                        }
                        if (f2 >= 0) {
                            if (fstat ((f1), (&s1)) != -1 && fstat ((f2), (&s2)) != -1 && s1.st_dev == s2.st_dev && s1.st_ino == s2.st_ino) same = 1;
                            close (f2);
                            if (created2) unlink ((char *) (fname2));
                        }
                        close (f1);
                        if (created1) unlink ((char *) (fname));
                    }
                    vim_free (fname2);
                    if (same) {
                        buf -> b_shortname = 1;
        ...
        if (mch_getperm (fname) < 0) {
            struct stat sb;
            if (lstat (((char *) fname), (&sb)) < 0) break;
        }
        if (old_fname != ((void *) 0) && strcasecmp ((char *) (((fname))), (char *) (((old_fname)))) == 0) break;
        if (fname [n - 2] == 'w' && fname [n - 1] == 'p') {
            ...
            if (!recoverymode && buf -> b_fname != ((void *) 0) && !buf->b_help && !(buf->b_flags&0x80)) {
                int fd;
                struct block0 b0;
                int differ = 0;
                fd = open (((char *) fname), (0x0000 | 0), (0));
                if (fd >= 0) {
                    if (read (fd, (char *) &b0, sizeof (b0)) == sizeof (b0)) {
                        if (b0.b0_fname [900 - 2] & 4) {
                            if (strcasecmp ((char *) (((gettail (buf -> b_ffname)))), (char *) (((gettail (b0.b0_fname))))) != 0 || 
                              !same_directory(fname,buf->b_ffname)) {
                                expand_env (b0.b0_fname, NameBuff, 1024);
                                if (fnamecmp_ino (buf -> b_ffname, NameBuff, char_to_long (b0.b0_ino))) differ = 1;
                            }
                        }
                        else {
                            expand_env (b0.b0_fname, NameBuff, 1024);
                ...
                if (differ == 0 && !(curbuf->b_flags&0x01) && vim_strchr (p_shm, 'A') == ((void *) 0)) {
                    int choice = 0;
                    process_still_running = 0;
                    if (swap_exists_action != 0 && has_autocmd (EVENT_SWAPEXISTS, buf -> b_fname, buf)) choice = do_swapexists (buf, fname);
                    if (choice == 0) {
                    ...
                    if (swap_exists_action != 0 && choice == 0) {
                        char_u * name;
                        name = alloc ((unsigned) (strlen ((char *) (fname)) + strlen ((char *) (((char *) ("Swap file \"")))) + strlen ((char *) (((char *) (
                          "\" already exists!")))) + 5));
                        if (name != ((void *) 0)) {
                            ((__builtin_object_size ((char *) (name), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (name), (char *) (((char *) (
                              "Swap file \""))), __builtin_object_size ((char *) (name), 1 > 1)) : __inline_strcpy_chk ((char *) (name), (char *) (((char *) (
                              "Swap file \"")))));
                            home_replace (((void *) 0), fname, name + strlen ((char *) (name)), 1000, 1);
                            ((__builtin_object_size ((char *) (name), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (name), (char *) (((char *) (
                              "\" already exists!"))), __builtin_object_size ((char *) (name), 1 > 1)) : __inline_strcat_chk ((char *) (name), (char *) (((char
                              *) ("\" already exists!")))));
                        }
                        choice = do_dialog (2, (char_u *) ((char *) ("VIM - ATTENTION")), name == ((void *) 0) ? (char_u *) ((char *) (
                          "Swap file already exists!")) : name, process_still_running ? (char_u *) ((char *) (
                          "&Open Read-Only\n&Edit anyway\n&Recover\n&Quit\n&Abort")) : (char_u *) ((char *) (
                          "&Open Read-Only\n&Edit anyway\n&Recover\n&Delete it\n&Quit\n&Abort")), 1, ((void *) 0));
                        if (process_still_running && choice >= 4) choice ++;
                        vim_free (name);
                        msg_scrolled = 0;
                        redraw_all_later (40);
                    }
                    if (choice > 0) {
                        ...
                        if (mch_getperm (fname) < 0) break;
                    }
                    else {
                        msg_puts ((char_u *) ("\n"));
                        if (msg_silent == 0) need_wait_return = 1;
                    }
                }
            }
        }
        if (fname [n - 1] == 'a') {
            if (fname [n - 2] == 'a') {
                emsg ((char_u *) (((char *) ("E326: Too many swap files found"))));
                vim_free (fname);
                fname = ((void *) 0);
                break;
            }
...
static int b0_magic_wrong (b0p)
    ZERO_BL * b0p;
{
    return (b0p -> b0_magic_long != (long) 0x30313233L || b0p -> b0_magic_int != (int) 0x20212223L || b0p -> b0_magic_short != (short) 0x10111213L || b0p ->
      b0_magic_char != 0x55);
}
    ...
    long ino_block0;
{
    ...
    int retval_c;
    int retval_s;
    if (stat (((char *) fname_c), (&st)) == 0) ino_c = (ino_t) st.st_ino;
    if (stat (((char *) fname_s), (&st)) == 0) ino_s = (ino_t) st.st_ino;
    else ino_s = (ino_t) ino_block0;
    if (ino_c && ino_s) return (ino_c != ino_s);
    retval_c = vim_FullName (fname_c, buf_c, 1024, 1);
    retval_s = vim_FullName (fname_s, buf_s, 1024, 1);
    if (retval_c == 1 && retval_s == 1) return (strcmp ((char *) (buf_c), (char *) (buf_s)) != 0);
    if (ino_s == 0 && ino_c == 0 && retval_c == 0 && retval_s == 0) return 0;
    return 1;
}
    ...
    buf_T * buf;
{
    bhdr_T * hp;
    ZERO_BL * b0p;
    if (!buf->b_ml.ml_mfp) return;
    for (hp = buf -> b_ml.ml_mfp -> mf_used_last; hp != ((void *) 0); hp = hp -> bh_prev) {
        if (hp -> bh_bnum == 0) {
            b0p = (ZERO_BL *) (hp -> bh_data);
            b0p -> b0_fname [900 - 1] = buf -> b_changed ? 0x55 : 0;
            b0p -> b0_fname [900 - 2] = (b0p -> b0_fname [900 - 2] & ~3) | (get_fileformat (buf) + 1);
            hp -> bh_flags |= 1;
    ...
    unsigned size;
{
    ...
    char_u * new_data;
    int text_len;
    if (dp -> db_id != (('d' << 8) + 'a')) return data;
    new_data = (char_u *) alloc (size);
    if (new_data == ((void *) 0)) return ((void *) 0);
    head_end = (char_u *) (&dp->db_index[dp->db_line_count]);
    text_start = (char_u *) dp + dp -> db_txt_start;
    text_len = size - dp -> db_txt_start;
    ((__builtin_object_size ((char *) (new_data), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (new_data), (char *) (dp), head_end - (char_u *) dp,
      __builtin_object_size ((char *) (new_data), 0)) : __inline_memmove_chk ((char *) (new_data), (char *) (dp), head_end - (char_u *) dp));
    crypt_push_state ();
    ml_crypt_prepare (mfp, offset, 0);
    crypt_encode (text_start, text_len, new_data + dp -> db_txt_start);
    crypt_pop_state ();
    if (head_end < text_start) ((__builtin_object_size ((new_data + (head_end - data)), 0) != (size_t) - 1) ? __builtin___memset_chk ((new_data + (head_end -
      data)), (0), (text_start - head_end), __builtin_object_size ((new_data + (head_end - data)), 0)) : __inline_memset_chk ((new_data + (head_end - data)), (
      0), (text_start - head_end)));
    return new_data;
}
    ...
    unsigned size;
{
    ...
    if (dp -> db_id == (('d' << 8) + 'a')) {
        ...
        if (head_end > text_start || dp -> db_txt_start > size || dp -> db_txt_end > size) return;
        crypt_push_state ();
        ml_crypt_prepare (mfp, offset, 1);
    ...
    int reading;
{
    ...
    char_u * key;
    char_u * seed;
    if (reading && mfp -> mf_old_key != ((void *) 0)) {
    ...
    if (method == 0) {
        ...
        bf_key_init (key, salt, (int) strlen ((char *) (salt)));
        bf_ofb_init (seed, 8);
    }
}
    ...
    int updtype;
{
    ...
    bhdr_T * hp;
    DATA_BL * dp;
    if (buf -> b_ml.ml_usedchunks == -1 || len == 0) return;
    ...
    if (updtype == 3 && buf -> b_ml.ml_line_count == 1) {
        buf -> b_ml.ml_usedchunks = 1;
        buf -> b_ml.ml_chunksize [0].mlcs_numlines = 1;
        buf -> b_ml.ml_chunksize [0].mlcs_totalsize = (long) strlen ((char *) (buf -> b_ml.ml_line_ptr)) + 1;
        return;
    }
    ...
    if (updtype == 1) {
        ...
        if (buf -> b_ml.ml_chunksize [curix].mlcs_numlines >= 800) {
            ...
            int text_end;
            int linecnt;
            ((__builtin_object_size ((char *) (buf -> b_ml.ml_chunksize + curix + 1), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf -> b_ml.
              ml_chunksize + curix + 1), (char *) (buf -> b_ml.ml_chunksize + curix), (buf -> b_ml.ml_usedchunks - curix) * sizeof (chunksize_T),
              __builtin_object_size ((char *) (buf -> b_ml.ml_chunksize + curix + 1), 0)) : __inline_memmove_chk ((char *) (buf -> b_ml.ml_chunksize + curix + 1
              ), (char *) (buf -> b_ml.ml_chunksize + curix), (buf -> b_ml.ml_usedchunks - curix) * sizeof (chunksize_T)));
            size = 0;
            linecnt = 0;
            while (curline < buf -> b_ml.ml_line_count && linecnt < 400) {
                ...
                else text_end = ((dp -> db_index [idx - 1]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1))));
                rest = count - idx;
                if (linecnt + rest > 400) {
                    idx += 400 - linecnt - 1;
                    linecnt = 400;
        ...
        else if (buf -> b_ml.ml_chunksize [curix].mlcs_numlines >= 400 && curix == buf -> b_ml.ml_usedchunks - 1 && buf -> b_ml.ml_line_count - line <= 1) {
            ...
            if (line == buf -> b_ml.ml_line_count) {
                ...
                dp = (DATA_BL *) (hp -> bh_data);
                if (dp -> db_line_count == 1) rest = dp -> db_txt_end - dp -> db_txt_start;
                else rest = ((dp -> db_index [dp -> db_line_count - 2]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1)))) - dp -> db_txt_start;
        ...
        curchnk -> mlcs_numlines --;
        ml_upd_lastbuf = ((void *) 0);
        if (curix < (buf -> b_ml.ml_usedchunks - 1) && (curchnk -> mlcs_numlines + curchnk [1].mlcs_numlines) <= 400) {
            curix ++;
            curchnk = buf -> b_ml.ml_chunksize + curix;
        }
        else if (curix == 0 && curchnk -> mlcs_numlines <= 0) {
            buf -> b_ml.ml_usedchunks --;
            ((__builtin_object_size ((char *) (buf -> b_ml.ml_chunksize), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf -> b_ml.ml_chunksize), (
              char *) (buf -> b_ml.ml_chunksize + 1), buf -> b_ml.ml_usedchunks * sizeof (chunksize_T), __builtin_object_size ((char *) (buf -> b_ml.
              ml_chunksize), 0)) : __inline_memmove_chk ((char *) (buf -> b_ml.ml_chunksize), (char *) (buf -> b_ml.ml_chunksize + 1), buf -> b_ml.
              ml_usedchunks * sizeof (chunksize_T)));
            return;
        }
        else if (curix == 0 || (curchnk -> mlcs_numlines > 10 && (curchnk -> mlcs_numlines + curchnk [-1].mlcs_numlines) > 400)) {
            return;
        }
        ...
        if (curix < buf -> b_ml.ml_usedchunks) {
            ((__builtin_object_size ((char *) (buf -> b_ml.ml_chunksize + curix), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf -> b_ml.
              ml_chunksize + curix), (char *) (buf -> b_ml.ml_chunksize + curix + 1), (buf -> b_ml.ml_usedchunks - curix) * sizeof (chunksize_T),
              __builtin_object_size ((char *) (buf -> b_ml.ml_chunksize + curix), 0)) : __inline_memmove_chk ((char *) (buf -> b_ml.ml_chunksize + curix), (
              char *) (buf -> b_ml.ml_chunksize + curix + 1), (buf -> b_ml.ml_usedchunks - curix) * sizeof (chunksize_T)));
        }
        return;
    }
    ml_upd_lastbuf = buf;
    ...
    long * offp;
{
    ...
    int extra = 0;
    ml_flush_line (curbuf);
    if (buf -> b_ml.ml_usedchunks == -1 || buf -> b_ml.ml_chunksize == ((void *) 0) || lnum < 0) return -1;
    if (offp == ((void *) 0)) offset = 0;
    else offset = *offp;
    if (lnum == 0 && offset <= 0) return 1;
    curline = 1;
    curix = size = 0;
    while (curix < buf -> b_ml.ml_usedchunks - 1 && ((lnum != 0 && lnum >= curline + buf -> b_ml.ml_chunksize [curix].mlcs_numlines) || (offset != 0 && offset >
      size + buf -> b_ml.ml_chunksize [curix].mlcs_totalsize + ffdos * buf -> b_ml.ml_chunksize [curix].mlcs_numlines))) {
        curline += buf -> b_ml.ml_chunksize [curix].mlcs_numlines;
        size += buf -> b_ml.ml_chunksize [curix].mlcs_totalsize;
        if (offset && ffdos) size += buf -> b_ml.ml_chunksize [curix].mlcs_numlines;
        curix ++;
    }
    while ((lnum != 0 && curline < lnum) || (offset != 0 && size < offset)) {
        if (curline > buf -> b_ml.ml_line_count || (hp = ml_find_line (buf, curline, 0x13)) == ((void *) 0)) return -1;
        dp = (DATA_BL *) (hp -> bh_data);
        count = (long) (buf -> b_ml.ml_locked_high) - (long) (buf -> b_ml.ml_locked_low) + 1;
        ...
        if (lnum != 0) {
            if (curline + (count - idx) >= lnum) idx += lnum - curline - 1;
            else idx = count - 1;
        }
        else {
            extra = 0;
            while (offset >= size + text_end - (int) ((dp -> db_index [idx]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1)))) + ffdos) {
                if (ffdos) size ++;
                if (idx == count - 1) {
                    extra = 1;
                    break;
        ...
        if (offset != 0 && size >= offset) {
            if (size + ffdos == offset) *offp = 0;
            else if (idx == start_idx) *offp = offset - size + len;
            else *offp = offset - size + len - (text_end - ((dp -> db_index [idx - 1]) & (~((unsigned)1<<((sizeof(unsigned)*8) - 1)))));
            curline += idx - start_idx + extra;
            if (curline > buf -> b_ml.ml_line_count) return -1;
            return curline;
        }
        curline = buf -> b_ml.ml_locked_high + 1;
    }
    if (lnum != 0) {
        if (ffdos) size += lnum - 1;
        if (buf -> b_p_bin && !buf->b_p_eol) size -= ffdos + 1;
    }
    return size;
}

...
static void win_new_width (win_T * wp, int width);
...
static void win_new_height (win_T *, int);
    ...
    int xchar;
{
    ...
    case 's' :
        if (cmdwin_type != 0) {
            emsg ((char_u *) (((char *) (e_cmdwin))));
            break;
        }
        reset_VIsual_and_resel ();
        if (bt_quickfix (curbuf)) goto newwindow;
    ...
    case '^' :
        ...
        reset_VIsual_and_resel ();
        ((__builtin_object_size ((char *) (cbuf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (cbuf), (char *) ("split #"), __builtin_object_size ((
          char *) (cbuf), 1 > 1)) : __inline_strcpy_chk ((char *) (cbuf), (char *) ("split #")));
        if (Prenum) vim_snprintf ((char *) cbuf + 7, sizeof (cbuf) - 7, "%ld", Prenum);
        do_cmdline_cmd (cbuf);
        break;
    case 14 :
    case 'n' :
        ...
        reset_VIsual_and_resel ();
        newwindow : if (Prenum) vim_snprintf ((char *) cbuf, sizeof (cbuf) - 5, "%ld", Prenum);
        else cbuf [0] = '\000';
        if (nchar == 'v' || nchar == 22) ((__builtin_object_size ((char *) (cbuf), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (cbuf), (char *) ("v"
          ), __builtin_object_size ((char *) (cbuf), 1 > 1)) : __inline_strcat_chk ((char *) (cbuf), (char *) ("v")));
        ((__builtin_object_size ((char *) (cbuf), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (cbuf), (char *) ("new"), __builtin_object_size ((char
          *) (cbuf), 1 > 1)) : __inline_strcat_chk ((char *) (cbuf), (char *) ("new")));
        do_cmdline_cmd (cbuf);
        break;
    case 17 :
    case 'q' :
    ...
    case 'P' :
        ...
        if (wp == ((void *) 0)) emsg ((char_u *) (((char *) ("E441: There is no preview window"))));
        else win_goto (wp);
        break;
    case 15 :
    case 'o' :
    ...
    case 'W' :
        ...
        if (firstwin == lastwin && Prenum != 1) beep_flush ();
        else {
            if (Prenum) {
                for (wp = firstwin; --Prenum > 0;) {
                    if (wp -> w_next == ((void *) 0)) break;
                    else wp = wp -> w_next;
                }
            }
            else {
                if (nchar == 'W') {
                    wp = curwin -> w_prev;
                    if (wp == ((void *) 0)) wp = lastwin;
                }
                else {
                    wp = curwin -> w_next;
                    if (wp == ((void *) 0)) wp = firstwin;
                }
            }
            win_goto (wp);
        }
    ...
    case 12 :
        ...
        break;
    case 'T' :
        if (one_window ()) msg ((char_u *) (((char *) (m_onlyone))));
        else {
            tabpage_T * oldtab = curtab;
            tabpage_T * newtab;
            wp = curwin;
            if (win_new_tabpage ((int) Prenum) == 1 && valid_tabpage (oldtab)) {
                newtab = curtab;
                goto_tabpage_tp (oldtab);
                if (curwin == wp) win_close (curwin, 0);
                if (valid_tabpage (newtab)) goto_tabpage_tp (newtab);
            }
        }
        break;
    case 't' :
    ...
    case 'L' :
        ...
        win_totop ((int) Prenum, ((nchar == 'H' || nchar == 'L') ? 2 : 0) | ((nchar == 'H' || nchar == 'K') ? 4 : 8));
        break;
    case '=' :
    ...
    case '}' :
        ...
        if (Prenum) g_do_tagpreview = Prenum;
    ...
    case 29 :
        ...
        reset_VIsual_and_resel ();
        if (Prenum) postponed_split = Prenum;
    ...
    case 6 :
        ...
        if (ptr != ((void *) 0)) {
            ...
            if (win_split (0, 0) == 1) {
                ...
                (void) do_ecmd (0, ptr, ((void *) 0), ((void *) 0), (linenr_T) 0, 0x01, ((void *) 0));
                if (nchar == 'F' && lnum >= 0) {
    ...
    case 4 :
        ...
        if ((len = find_ident_under_cursor (&ptr, 1)) == 0) break;
        find_pattern_in_path (ptr, 0, len, 1, Prenum == 0 ? 1 : 0, type, Prenum1, 3, (linenr_T) 1, (linenr_T) (0x7fffffffL));
        curwin -> w_set_curswant = 1;
        break;
    case (-(('K')+((int)('A')<<8))) :
    case '\015' :
        if (bt_quickfix (curbuf)) {
            __builtin___sprintf_chk ((char *) cbuf, 0, __builtin_object_size ((char *) cbuf, 1 > 1), "split +%ld%s", (long) curwin -> w_cursor.lnum, (curwin ->
              w_llist_ref == ((void *) 0)) ? "cc" : "ll");
            do_cmdline_cmd (cbuf);
        }
        break;
    case 'g' :
    case 7 :
        ...
        ++no_mapping;
        ++allow_keys;
        if (xchar == '\000') xchar = plain_vgetc ();
        ;
        --no_mapping;
        --allow_keys;
...
int win_split (size, flags)
    ...
    int flags;
{
    if (may_open_tabpage () == 1) return 1;
    flags |= cmdmod.split;
    if ((flags & 4) && (flags & 8)) {
        emsg ((char_u *) (((char *) ("E442: Can't split topleft and botright at the same time"))));
        return 0;
    }
    if (flags & 16) make_snapshot (0);
    else clear_snapshot (curtab, 0);
    return win_split_ins (size, flags, ((void *) 0), 0);
}

int win_split_ins (size, flags, newwin, dir)
    int size;
    int flags;
    win_T * newwin;
    int dir;
{
    ...
    frame_T * frp, * curfrp;
    int before;
    if (flags & 4) oldwin = firstwin;
    else if (flags & 8) oldwin = lastwin;
    else oldwin = curwin;
    if (lastwin == firstwin && p_ls == 1 && oldwin -> w_status_height == 0) {
        if (oldwin -> w_height <= p_wmh && newwin == ((void *) 0)) {
            emsg ((char_u *) (((char *) (e_noroom))));
            return 0;
        }
        need_status = 1;
    }
    if (flags & 2) {
        layout = 1;
        needed = p_wmw + 1;
        if (flags & 1) needed += p_wiw - p_wmw;
        if (p_ea || (flags & (8 | 4))) {
            available = topframe -> fr_width;
            needed += frame_minwidth (topframe, ((void *) 0));
        }
        else available = oldwin -> w_width;
        if (available < needed && newwin == ((void *) 0)) {
            emsg ((char_u *) (((char *) (e_noroom))));
            return 0;
        }
        if (new_size == 0) new_size = oldwin -> w_width / 2;
        if (new_size > oldwin -> w_width - p_wmw - 1) new_size = oldwin -> w_width - p_wmw - 1;
        if (new_size < p_wmw) new_size = p_wmw;
        if (oldwin -> w_width - new_size - 1 < p_wmw) do_equal = 1;
        if (oldwin -> w_onebuf_opt.wo_wfw) win_setwidth_win (oldwin -> w_width + new_size, oldwin);
        if (!do_equal && p_ea && size == 0 && *p_ead != 'v' && oldwin -> w_frame -> fr_parent != ((void *) 0)) {
            frp = oldwin -> w_frame -> fr_parent -> fr_child;
            while (frp != ((void *) 0)) {
                if (frp -> fr_win != oldwin && frp -> fr_win != ((void *) 0) && (frp -> fr_win -> w_width > new_size || frp -> fr_win -> w_width > oldwin ->
                  w_width - new_size - 1)) {
                    do_equal = 1;
                    break;
                }
        ...
        layout = 2;
        needed = p_wmh + 1 + need_status;
        if (flags & 1) needed += p_wh - p_wmh;
        if (p_ea || (flags & (8 | 4))) {
            available = topframe -> fr_height;
            needed += frame_minheight (topframe, ((void *) 0));
        }
        else {
        ...
        if (new_size == 0) new_size = oldwin_height / 2;
        if (new_size > oldwin_height - p_wmh - 1) new_size = oldwin_height - p_wmh - 1;
        if (new_size < p_wmh) new_size = p_wmh;
        if (oldwin_height - new_size - 1 < p_wmh) do_equal = 1;
        if (oldwin -> w_onebuf_opt.wo_wfh) {
            win_setheight_win (oldwin -> w_height + new_size + 1, oldwin);
            oldwin_height = oldwin -> w_height;
            if (need_status) oldwin_height -= 1;
        }
        if (!do_equal && p_ea && size == 0 && *p_ead != 'h' && oldwin -> w_frame -> fr_parent != ((void *) 0)) {
            frp = oldwin -> w_frame -> fr_parent -> fr_child;
            while (frp != ((void *) 0)) {
                if (frp -> fr_win != oldwin && frp -> fr_win != ((void *) 0) && (frp -> fr_win -> w_height > new_size || frp -> fr_win -> w_height >
                  oldwin_height - new_size - 1)) {
                    do_equal = 1;
                    break;
                }
                frp = frp -> fr_next;
    ...
    if ((flags & 4) == 0 && ((flags & 8) || (flags & 32) || (!(flags&64) && ((flags & 2) ? p_spr : p_sb)))) {
        if (newwin == ((void *) 0)) wp = win_alloc (oldwin, 0);
        else win_append (oldwin, wp);
    }
    else {
        if (newwin == ((void *) 0)) wp = win_alloc (oldwin -> w_prev, 0);
        else win_append (oldwin -> w_prev, wp);
    }
    if (newwin == ((void *) 0)) {
        if (wp == ((void *) 0)) return 0;
        new_frame (wp);
        if (wp -> w_frame == ((void *) 0)) {
            win_free (wp, ((void *) 0));
            return 0;
        }
    ...
    if (flags & (4 | 8)) {
        if ((topframe -> fr_layout == 2 && (flags & 2) == 0) || (topframe -> fr_layout == 1 && (flags & 2) != 0)) {
            curfrp = topframe -> fr_child;
            if (flags & 8) while (curfrp -> fr_next != ((void *) 0)) curfrp = curfrp -> fr_next;
        }
        ...
        if (flags & 32) before = 0;
        else if (flags & 64) before = 1;
        else if (flags & 2) before = !p_spr;
        else before = !p_sb;
    }
    if (curfrp -> fr_parent == ((void *) 0) || curfrp -> fr_parent -> fr_layout != layout) {
        ...
        * frp = *curfrp;
        ...
        curfrp = frp;
        if (frp -> fr_win != ((void *) 0)) oldwin -> w_frame = frp;
        else for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) frp -> fr_parent = curfrp;
    }
    if (newwin == ((void *) 0)) frp = wp -> w_frame;
    else frp = newwin -> w_frame;
    frp -> fr_parent = curfrp -> fr_parent;
    if (before) frame_insert (curfrp, frp);
    ...
    if (flags & 2) {
        ...
        if (before) wp -> w_vsep_width = 1;
        else {
            wp -> w_vsep_width = oldwin -> w_vsep_width;
            oldwin -> w_vsep_width = 1;
        }
        if (flags & (4 | 8)) {
            if (flags & 8) frame_add_vsep (curfrp);
            frame_new_width (curfrp, curfrp -> fr_width - (new_size + ((flags & 4) != 0)), flags & 4, 0);
        }
        ...
        if (flags & (4 | 8)) frame_new_height (curfrp, curfrp -> fr_height - (new_size + 1), flags & 4, 0);
        else win_new_height (oldwin, oldwin_height - (new_size + 1));
        if (before) {
            wp -> w_winrow = oldwin -> w_winrow;
        ...
        if (flags & 8) frame_add_statusline (curfrp);
        frame_fix_height (wp);
        frame_fix_height (oldwin);
    }
    if (flags & (4 | 8)) (void) win_comp_pos ();
    ...
    if (do_equal || dir != 0) win_equal (wp, 1, (flags & 2) ? (dir == 'v' ? 'b' : 'h') : dir == 'h' ? 'b' : 'v');
    if (flags & 2) {
        i = p_wiw;
        if (size != 0) p_wiw = size;
    }
    else {
        i = p_wh;
        if (size != 0) p_wh = size;
    ...
    int flags __attribute__ ((unused));
{
    ...
    else copy_loclist (oldp, newp);
    if (oldp -> w_localdir != ((void *) 0)) newp -> w_localdir = vim_strsave (oldp -> w_localdir);
    for (i = 0; i < oldp -> w_tagstacklen; i ++) {
        newp -> w_tagstack [i] = oldp -> w_tagstack [i];
        if (newp -> w_tagstack [i].tagname != ((void *) 0)) newp -> w_tagstack [i].tagname = vim_strsave (newp -> w_tagstack [i].tagname);
    }
...
{
    win_T * wp;
    if (win == ((void *) 0)) return 0;
    for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) if (wp == win) return 1;
    return 0;
}
...
int win_count () {
    win_T * wp;
    int count = 0;
    for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) ++count;
    return count;
}

int make_windows (count, vertical)
    int count;
    int vertical __attribute__ ((unused));
{
    int maxcount;
    int todo;
    if (vertical) {
        ...
        maxcount = (curwin -> w_height + curwin -> w_status_height - (p_wh - p_wmh)) / (p_wmh + 1);
    }
    if (maxcount < 2) maxcount = 2;
    if (count > maxcount) count = maxcount;
    if (count > 1) last_status (1);
    block_autocmds ();
    for (todo = count - 1; todo > 0; --todo) if (vertical) {
        if (win_split (curwin -> w_width - (curwin -> w_width - todo) / (todo + 1) - 1, 2 | 64) == 0) break;
    }
    else {
        if (win_split (curwin -> w_height - (curwin -> w_height - todo * 1) / (todo + 1) - 1, 64) == 0) break;
    }
    unblock_autocmds ();
    return (count - todo);
}
    ...
    long Prenum;
{
    ...
    if (Prenum) {
        ...
        while (frp != ((void *) 0) && --Prenum > 0) frp = frp -> fr_next;
    }
    else if (curwin -> w_frame -> fr_next != ((void *) 0)) frp = curwin -> w_frame -> fr_next;
    else frp = curwin -> w_frame -> fr_prev;
    if (frp == ((void *) 0) || frp -> fr_win == ((void *) 0) || frp -> fr_win == curwin) return;
    wp = frp -> fr_win;
    wp2 = curwin -> w_prev;
    ...
    if (wp != wp2) {
        ...
        win_append (wp2, wp);
        if (frp2 == ((void *) 0)) frame_insert (wp -> w_frame -> fr_parent -> fr_child, wp -> w_frame);
    ...
    int count;
{
    ...
    for (frp = curwin -> w_frame -> fr_parent -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) if (frp -> fr_win == ((void *) 0)) {
        emsg ((char_u *) (((char *) ("E443: Cannot rotate when another window is split"))));
        return;
    }
    while (count --) {
        if (upwards) {
            ...
            for (frp = curwin -> w_frame; frp -> fr_next != ((void *) 0); frp = frp -> fr_next);
            wp1 = frp -> fr_win;
            wp2 = wp1 -> w_prev;
            win_remove (wp1, ((void *) 0));
            frame_remove (frp);
...
{
    if (dir == 0) dir = *p_ead;
    win_equal_rec (next_curwin == ((void *) 0) ? curwin : next_curwin, current, topframe, dir, 0, tabline_height (), (int) Columns, topframe -> fr_height);
}

static void win_equal_rec (next_curwin, current, topfr, dir, col, row, width, height)
    win_T * next_curwin;
    int current;
    frame_T * topfr;
    int dir;
    ...
    int height;
{
    ...
    if (topfr -> fr_layout == 0) {
        ...
        if (dir != 'v') {
            ...
            if (col + width == Columns) extra_sep = 1;
            else extra_sep = 0;
            ...
            if (room < 0) {
                ...
                for (fr = topfr -> fr_child; fr != ((void *) 0); fr = fr -> fr_next) {
                    if (frame_fixed_width (fr)) {
                        ...
                        if (frame_has_win (fr, next_curwin)) {
                            room += p_wiw - p_wmw;
                            next_curwin_size = 0;
                            if (new_size < p_wiw) new_size = p_wiw;
                        }
                        else totwincount -= (n + (fr -> fr_next == ((void *) 0) ? extra_sep : 0)) / (p_wmw + 1);
                        room -= new_size - n;
                        if (room < 0) {
                            new_size += room;
                            room = 0;
                ...
                if (next_curwin_size == -1) {
                    if (!has_next_curwin) next_curwin_size = 0;
            ...
            if (has_next_curwin) --totwincount;
        }
        for (fr = topfr -> fr_child; fr != ((void *) 0); fr = fr -> fr_next) {
            n = m = 0;
            wincount = 1;
            if (fr -> fr_next == ((void *) 0)) new_size = width;
            else if (dir == 'v') new_size = fr -> fr_width;
                ...
                n = frame_minwidth (fr, (win_T *) -1);
                wincount = (n + (fr -> fr_next == ((void *) 0) ? extra_sep : 0)) / (p_wmw + 1);
                m = frame_minwidth (fr, next_curwin);
                if (has_next_curwin) hnc = frame_has_win (fr, next_curwin);
                else hnc = 0;
                if (hnc) --wincount;
                if (totwincount == 0) new_size = room;
                else new_size = (wincount * room + ((unsigned) totwincount >> 1)) / totwincount;
                if (hnc) {
            ...
            if (!current || dir != 'v' || topfr -> fr_parent != ((void *) 0) || (new_size != fr -> fr_width) || frame_has_win (fr, next_curwin)) win_equal_rec (
              next_curwin, current, fr, dir, col, row, new_size, height);
            col += new_size;
            width -= new_size;
        ...
        if (dir != 'h') {
            ...
            if (row + height == cmdline_row && p_ls == 0) extra_sep = 1;
            else extra_sep = 0;
                ...
                for (fr = topfr -> fr_child; fr != ((void *) 0); fr = fr -> fr_next) {
                    if (frame_fixed_height (fr)) {
                        ...
                        if (frame_has_win (fr, next_curwin)) {
                            room += p_wh - p_wmh;
                            next_curwin_size = 0;
                            if (new_size < p_wh) new_size = p_wh;
                        }
                        else totwincount -= (n + (fr -> fr_next == ((void *) 0) ? extra_sep : 0)) / (p_wmh + 1);
                        room -= new_size - n;
                        if (room < 0) {
                            new_size += room;
                            room = 0;
        ...
        for (fr = topfr -> fr_child; fr != ((void *) 0); fr = fr -> fr_next) {
            n = m = 0;
            wincount = 1;
            if (fr -> fr_next == ((void *) 0)) new_size = height;
            else if (dir == 'h') new_size = fr -> fr_height;
                ...
                n = frame_minheight (fr, (win_T *) -1);
                wincount = (n + (fr -> fr_next == ((void *) 0) ? extra_sep : 0)) / (p_wmh + 1);
            ...
            if (!current || dir != 'h' || topfr -> fr_parent != ((void *) 0) || (new_size != fr -> fr_height) || frame_has_win (fr, next_curwin)) win_equal_rec
              (next_curwin, current, fr, dir, col, row, width, new_size);
            row += new_size;
            height -= new_size;
            totwincount -= wincount;
        }
    ...
    int keep_curwin;
{
    ...
    ++RedrawingDisabled;
    for (wp = firstwin; wp != ((void *) 0) && lastwin != firstwin;) {
    ...
    for (tp = first_tabpage; tp != ((void *) 0); tp = nexttp) {
        nexttp = tp -> tp_next;
        if (tp != curtab) for (wp = tp -> tp_firstwin; wp != ((void *) 0); wp = wp -> w_next) if (wp -> w_buffer == buf) {
...
static int one_window () {
    win_T * wp;
    int seen_one = 0;
    for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) {
        if (wp != aucmd_win) {
            if (seen_one) return 0;
            seen_one = 1;
        }
    }
    return 1;
    ...
    int free_buf;
{
    ...
    if (last_window ()) {
        emsg ((char_u *) (((char *) ("E444: Cannot close last window"))));
        return;
    }
    if (win == aucmd_win) {
        emsg ((char_u *) (((char *) ("E813: Cannot close autocmd window"))));
        return;
    }
    if ((firstwin == aucmd_win || lastwin == aucmd_win) && one_window ()) {
        emsg ((char_u *) (((char *) ("E814: Cannot close window, only autocmd window would remain"))));
        return;
    }
    if (firstwin == lastwin) {
    ...
    if (win -> w_buffer -> b_help) help_window = 1;
    else clear_snapshot (curtab, 0);
    if (win == curwin) {
        ...
        if (wp -> w_buffer != curbuf) {
            ...
            if (!win_valid(win) || last_window ()) return;
        }
        apply_autocmds (EVENT_WINLEAVE, ((void *) 0), ((void *) 0), 0, curbuf);
        if (!win_valid(win) || last_window ()) return;
        if (aborting ()) return;
    }
    close_buffer (win, win -> w_buffer, free_buf ? 2 : 0);
    if (!win_valid(win) || last_window () || curtab != prev_curtab) return;
    wp = win_free_mem (win, &dir, ((void *) 0));
    if (win == curwin) {
        curwin = wp;
        if (wp -> w_onebuf_opt.wo_pvw || bt_quickfix (wp -> w_buffer)) {
            for (;;) {
                if (wp -> w_next == ((void *) 0)) wp = firstwin;
                else wp = wp -> w_next;
                if (wp == curwin) break;
                if (!wp->w_onebuf_opt.wo_pvw && !bt_quickfix(wp->w_buffer)) {
                    curwin = wp;
    ...
    if (p_ea && (*p_ead == 'b' || *p_ead == dir)) win_equal (curwin, 1, dir);
    else win_comp_pos ();
    if (close_curwin) {
        win_enter_ext (wp, 0, 1);
        if (other_buffer) apply_autocmds (EVENT_BUFENTER, ((void *) 0), ((void *) 0), 0, curbuf);
    }
    last_status (0);
    if (help_window) restore_snapshot (0, close_curwin);
    redraw_all_later (40);
}
    ...
    tabpage_T * tp;
{
    ...
    if (ptp == ((void *) 0) || tp == curtab) return;
    for (wp = tp -> tp_firstwin; wp != ((void *) 0) && wp != win; wp = wp -> w_next);
    if (wp == ((void *) 0)) return;
    if (tp == ((void *) 0) ? firstwin == lastwin : tp -> tp_firstwin == tp -> tp_lastwin) {
        if (tp == first_tabpage) first_tabpage = tp -> tp_next;
        else {
            for (ptp = first_tabpage; ptp != ((void *) 0) && ptp -> tp_next != tp; ptp = ptp -> tp_next);
            if (ptp == ((void *) 0)) {
                emsg2 ((char_u *) (((char *) (e_intern2))), (char_u *) ("win_close_othertab()"));
                return;
            }
    ...
    tabpage_T * tp;
{
    ...
    vim_free (frp);
    win_free (win, tp);
    if (tp != ((void *) 0) && win == tp -> tp_curwin) tp -> tp_curwin = wp;
    return wp;
}

win_T * winframe_remove (win, dirp, tp)
    win_T * win;
    int * dirp __attribute__ ((unused));
    tabpage_T * tp;
{
    frame_T * frp, * frp2, * frp3;
    frame_T * frp_close = win -> w_frame;
    win_T * wp;
    if (tp == ((void *) 0) ? firstwin == lastwin : tp -> tp_firstwin == tp -> tp_lastwin) return ((void *) 0);
    ...
    if (frp_close -> fr_parent -> fr_layout == 2) {
        ...
        frame_new_height (frp2, frp2 -> fr_height + frp_close -> fr_height, frp2 == frp_close -> fr_next ? 1 : 0, 0);
        * dirp = 'v';
    }
    else {
        ...
        frame_new_width (frp2, frp2 -> fr_width + frp_close -> fr_width, frp2 == frp_close -> fr_next ? 1 : 0, 0);
        * dirp = 'h';
    }
    ...
    if (frp2 -> fr_next == ((void *) 0) && frp2 -> fr_prev == ((void *) 0)) {
        ...
        for (frp = frp2 -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) frp -> fr_parent = frp2 -> fr_parent;
        frp2 -> fr_parent -> fr_win = frp2 -> fr_win;
        if (frp2 -> fr_win != ((void *) 0)) frp2 -> fr_win -> w_frame = frp2 -> fr_parent;
        frp = frp2 -> fr_parent;
        vim_free (frp2);
        frp2 = frp -> fr_parent;
        if (frp2 != ((void *) 0) && frp2 -> fr_layout == frp -> fr_layout) {
            if (frp2 -> fr_child == frp) frp2 -> fr_child = frp -> fr_child;
            frp -> fr_child -> fr_prev = frp -> fr_prev;
            if (frp -> fr_prev != ((void *) 0)) frp -> fr_prev -> fr_next = frp -> fr_child;
            for (frp3 = frp -> fr_child;; frp3 = frp3 -> fr_next) {
                frp3 -> fr_parent = frp2;
                if (frp3 -> fr_next == ((void *) 0)) {
                    frp3 -> fr_next = frp -> fr_next;
                    if (frp -> fr_next != ((void *) 0)) frp -> fr_next -> fr_prev = frp3;
                    break;
                }
            }
            vim_free (frp);
    ...
    tabpage_T * tp;
{
    frame_T * frp;
    int b;
    if (tp == ((void *) 0) ? firstwin == lastwin : tp -> tp_firstwin == tp -> tp_lastwin) return alt_tabpage () -> tp_curwin -> w_frame;
    frp = win -> w_frame;
    if (frp -> fr_parent != ((void *) 0) && frp -> fr_parent -> fr_layout == 1) b = p_spr;
    else b = p_sb;
    if ((!b && frp -> fr_next != ((void *) 0)) || frp -> fr_prev == ((void *) 0)) return frp -> fr_next;
    return frp -> fr_prev;
}

static tabpage_T * alt_tabpage () {
    tabpage_T * tp;
    if (curtab -> tp_next != ((void *) 0)) return curtab -> tp_next;
...
static win_T * frame2win (frp)
    frame_T * frp;
{
    while (frp -> fr_win == ((void *) 0)) frp = frp -> fr_child;
    return frp -> fr_win;
}
...
{
    frame_T * p;
    if (frp -> fr_layout == 0) return frp -> fr_win == wp;
    for (p = frp -> fr_child; p != ((void *) 0); p = p -> fr_next) if (frame_has_win (p, wp)) return 1;
    return 0;
}
    ...
    int wfh;
{
    ...
    if (topfrp -> fr_win != ((void *) 0)) {
        ...
        frp = topfrp -> fr_child;
        if (wfh) while (frame_fixed_height (frp)) {
            frp = frp -> fr_next;
            if (frp == ((void *) 0)) return;
        }
        if (!topfirst) {
            while (frp -> fr_next != ((void *) 0)) frp = frp -> fr_next;
            if (wfh) while (frame_fixed_height (frp)) frp = frp -> fr_prev;
        }
        ...
        if (extra_lines < 0) {
            while (frp != ((void *) 0)) {
                ...
                if (frp == ((void *) 0)) height -= extra_lines;
            }
        }
...
static int frame_fixed_height (frp)
    frame_T * frp;
{
    if (frp -> fr_win != ((void *) 0)) return frp -> fr_win -> w_onebuf_opt.wo_wfh;
    if (frp -> fr_layout == 1) {
        for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) if (frame_fixed_height (frp)) return 1;
        return 0;
    }
    for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) if (!frame_fixed_height(frp)) return 0;
    return 1;
}
...
static int frame_fixed_width (frp)
    frame_T * frp;
{
    if (frp -> fr_win != ((void *) 0)) return frp -> fr_win -> w_onebuf_opt.wo_wfw;
    if (frp -> fr_layout == 2) {
        for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) if (frame_fixed_width (frp)) return 1;
        return 0;
    }
    for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) if (!frame_fixed_width(frp)) return 0;
    return 1;
}
    ...
    frame_T * frp;
{
    ...
    if (frp -> fr_layout == 0) {
        ...
        if (wp -> w_status_height == 0) {
            if (wp -> w_height > 0) --wp->w_height;
            wp -> w_status_height = 1;
        }
    }
    else if (frp -> fr_layout == 1) {
        for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) frame_add_statusline (frp);
    }
    else {
    ...
    int wfw;
{
    ...
    if (topfrp -> fr_layout == 0) {
        wp = topfrp -> fr_win;
        for (frp = topfrp; frp -> fr_parent != ((void *) 0); frp = frp -> fr_parent) if (frp -> fr_parent -> fr_layout == 1 && frp -> fr_next != ((void *) 0))
          break;
        if (frp -> fr_parent == ((void *) 0)) wp -> w_vsep_width = 0;
        ...
        frp = topfrp -> fr_child;
        if (wfw) while (frame_fixed_width (frp)) {
            frp = frp -> fr_next;
            if (frp == ((void *) 0)) return;
        }
        if (!leftfirst) {
            while (frp -> fr_next != ((void *) 0)) frp = frp -> fr_next;
            if (wfw) while (frame_fixed_width (frp)) frp = frp -> fr_prev;
        }
        ...
        if (extra_cols < 0) {
            while (frp != ((void *) 0)) {
                ...
                if (frp == ((void *) 0)) width -= extra_cols;
            }
        }
    ...
    frame_T * frp;
{
    ...
    if (frp -> fr_layout == 0) {
        ...
        if (wp -> w_vsep_width == 0) {
            if (wp -> w_width > 0) --wp->w_width;
            wp -> w_vsep_width = 1;
        }
    }
    else if (frp -> fr_layout == 2) {
        for (frp = frp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) frame_add_vsep (frp);
    }
    else {
        frp = frp -> fr_child;
        while (frp -> fr_next != ((void *) 0)) frp = frp -> fr_next;
    ...
    win_T * next_curwin;
{
    ...
    int n;
    if (topfrp -> fr_win != ((void *) 0)) {
        if (topfrp -> fr_win == next_curwin) m = p_wh + topfrp -> fr_win -> w_status_height;
        else {
            m = p_wmh + topfrp -> fr_win -> w_status_height;
            if (p_wmh == 0 && topfrp -> fr_win == curwin && next_curwin == ((void *) 0)) ++m;
        }
    }
    else if (topfrp -> fr_layout == 1) {
        m = 0;
        ...
        m = 0;
        for (frp = topfrp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) m += frame_minheight (frp, next_curwin);
    }
    return m;
}
    ...
    win_T * next_curwin;
{
    ...
    int m, n;
    if (topfrp -> fr_win != ((void *) 0)) {
        if (topfrp -> fr_win == next_curwin) m = p_wiw + topfrp -> fr_win -> w_vsep_width;
        else {
            m = p_wmw + topfrp -> fr_win -> w_vsep_width;
            if (p_wmw == 0 && topfrp -> fr_win == curwin && next_curwin == ((void *) 0)) ++m;
        }
    }
    else if (topfrp -> fr_layout == 2) {
        m = 0;
        ...
        m = 0;
        for (frp = topfrp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) m += frame_minwidth (frp, next_curwin);
    }
    return m;
}
    ...
    int forceit;
{
    ...
    int r;
    if (one_window ()) {
        if (message && !autocmd_busy) msg ((char_u *) (((char *) (m_onlyone))));
        return;
    }
    for (wp = firstwin; win_valid (wp); wp = nextwp) {
        ...
        if (wp != curwin) {
            ...
            if (!r) {
                ...
                if (bufIsChanged (wp -> w_buffer)) continue;
            }
            win_close (wp, !(buf_hide(wp->w_buffer)) && !bufIsChanged(wp->w_buffer));
        }
    }
    if (message && lastwin != firstwin) emsg ((char_u *) (((char *) ("E445: Other window contains changes"))));
}
...
int win_alloc_first () {
    if (win_alloc_firstwin (((void *) 0)) == 0) return 0;
    first_tabpage = alloc_tabpage ();
    if (first_tabpage == ((void *) 0)) return 0;
...
void win_alloc_aucmd_win () {
    ...
    if (aucmd_win != ((void *) 0)) {
        ...
        aucmd_win -> w_onebuf_opt.wo_scb = 0;
        new_frame (aucmd_win);
    }
}
    ...
    win_T * oldwin;
{
    ...
    if (oldwin == ((void *) 0)) {
        curbuf = buflist_new (((void *) 0), ((void *) 0), 1L, 2);
        if (curwin == ((void *) 0) || curbuf == ((void *) 0)) return 0;
    ...
    new_frame (curwin);
    if (curwin -> w_frame == ((void *) 0)) return 0;
    ...
    tabpage_T * tp;
{
    int idx;
    diff_clear (tp);
    for (idx = 0; idx < 2; ++idx) clear_snapshot (tp, idx);
    ...
    int after;
{
    ...
    int n;
    newtp = alloc_tabpage ();
    if (newtp == ((void *) 0)) return 0;
    if (leave_tabpage (curbuf) == 0) {
        vim_free (newtp);
        return 0;
    }
    curtab = newtp;
    if (win_alloc_firstwin (tp -> tp_curwin) == 1) {
        if (after == 1) {
            ...
            if (after > 0) {
                n = 2;
                for (tp = first_tabpage; tp -> tp_next != ((void *) 0) && n < after; tp = tp -> tp_next) ++n;
            }
    ...
    int maxcount;
{
    int count = maxcount;
    int todo;
    if (count > p_tpm) count = p_tpm;
    block_autocmds ();
    for (todo = count - 1; todo > 0; --todo) if (win_new_tabpage (0) == 0) break;
    unblock_autocmds ();
    return (count - todo);
}
...
{
    tabpage_T * tp;
    for (tp = first_tabpage; tp != ((void *) 0); tp = tp -> tp_next) if (tp == tpc) return 1;
    return 0;
}
    ...
    int n;
{
    tabpage_T * tp;
    int i = 1;
    for (tp = first_tabpage; tp != ((void *) 0) && i != n; tp = tp -> tp_next) ++i;
    return tp;
}
    ...
    tabpage_T * ftp;
{
    int i = 1;
    tabpage_T * tp;
    for (tp = first_tabpage; tp != ((void *) 0) && tp != ftp; tp = tp -> tp_next) ++i;
    return i;
}

static int leave_tabpage (new_curbuf)
    buf_T * new_curbuf __attribute__ ((unused));
{
    tabpage_T * tp = curtab;
    reset_VIsual_and_resel ();
    if (new_curbuf != curbuf) {
        apply_autocmds (EVENT_BUFLEAVE, ((void *) 0), ((void *) 0), 0, curbuf);
        if (curtab != tp) return 0;
    }
    apply_autocmds (EVENT_WINLEAVE, ((void *) 0), ((void *) 0), 0, curbuf);
    if (curtab != tp) return 0;
...
static void enter_tabpage (tp, old_curbuf)
    tabpage_T * tp;
    buf_T * old_curbuf __attribute__ ((unused));
{
    ...
    apply_autocmds (EVENT_TABENTER, ((void *) 0), ((void *) 0), 0, curbuf);
    if (old_curbuf != curbuf) apply_autocmds (EVENT_BUFENTER, ((void *) 0), ((void *) 0), 0, curbuf);
    last_status (0);
    (void) win_comp_pos ();
    must_redraw = 50;
    diff_need_scrollbind = 1;
    p_ch = curtab -> tp_ch_used;
    if (curtab -> tp_old_Rows != Rows || (old_off != firstwin -> w_winrow)) shell_new_rows ();
    if (curtab -> tp_old_Columns != Columns && starting == 0) shell_new_columns ();
    redraw_all_later (50);
}
    ...
    int n;
{
    ...
    if (n == 0) {
        if (curtab -> tp_next == ((void *) 0)) tp = first_tabpage;
        else tp = curtab -> tp_next;
    }
    else if (n < 0) {
        ttp = curtab;
        for (i = n; i < 0; ++i) {
            for (tp = first_tabpage; tp -> tp_next != ttp && tp -> tp_next != ((void *) 0); tp = tp -> tp_next);
            ttp = tp;
        }
    }
    else if (n == 9999) {
...
void goto_tabpage_tp (tp)
    tabpage_T * tp;
{
    set_keep_msg (((void *) 0), 0);
    if (tp != curtab && leave_tabpage (tp -> tp_curwin -> w_buffer) == 1) {
        if (valid_tabpage (tp)) enter_tabpage (tp, curbuf);
        else enter_tabpage (curtab, curbuf);
    }
}
    ...
    int nr;
{
    int n = nr;
    tabpage_T * tp;
    if (first_tabpage -> tp_next == ((void *) 0)) return;
    if (curtab == first_tabpage) first_tabpage = curtab -> tp_next;
    else {
        for (tp = first_tabpage; tp != ((void *) 0); tp = tp -> tp_next) if (tp -> tp_next == curtab) break;
        if (tp == ((void *) 0)) return;
    ...
    if (n == 0) {
        ...
        for (tp = first_tabpage; tp -> tp_next != ((void *) 0) && n > 1; tp = tp -> tp_next) --n;
    ...
    win_T * wp;
{
    ...
    if (wp -> w_buffer != curbuf) reset_VIsual_and_resel ();
    else if (VIsual_active) wp -> w_cursor = curwin -> w_cursor;
    win_enter (wp, 1);
}
    ...
    long count;
{
    ...
    while (count --) {
        fr = foundfr;
        for (;;) {
            if (fr == topframe) goto end;
            if (up) nfr = fr -> fr_prev;
            else nfr = fr -> fr_next;
            if (fr -> fr_parent -> fr_layout == 2 && nfr != ((void *) 0)) break;
            fr = fr -> fr_parent;
        }
        for (;;) {
            if (nfr -> fr_layout == 0) {
            ...
            fr = nfr -> fr_child;
            if (nfr -> fr_layout == 1) {
                while (fr -> fr_next != ((void *) 0) && frame2win (fr) -> w_wincol + fr -> fr_width <= curwin -> w_wincol + curwin -> w_wcol) fr = fr -> fr_next
                  ;
            }
            if (nfr -> fr_layout == 2 && up) while (fr -> fr_next != ((void *) 0)) fr = fr -> fr_next;
            nfr = fr;
        }
    }
    end : if (foundfr != ((void *) 0)) win_goto (foundfr -> fr_win);
}
    ...
    long count;
{
    ...
    while (count --) {
        ...
        for (;;) {
            if (fr == topframe) goto end;
            if (left) nfr = fr -> fr_prev;
            else nfr = fr -> fr_next;
            if (fr -> fr_parent -> fr_layout == 1 && nfr != ((void *) 0)) break;
            fr = fr -> fr_parent;
        }
        for (;;) {
            if (nfr -> fr_layout == 0) {
            ...
            fr = nfr -> fr_child;
            if (nfr -> fr_layout == 2) {
                while (fr -> fr_next != ((void *) 0) && frame2win (fr) -> w_winrow + fr -> fr_height <= curwin -> w_winrow + curwin -> w_wrow) fr = fr ->
                  fr_next;
            }
            if (nfr -> fr_layout == 1 && left) while (fr -> fr_next != ((void *) 0)) fr = fr -> fr_next;
            nfr = fr;
        }
    }
    end : if (foundfr != ((void *) 0)) win_goto (foundfr -> fr_win);
...
static void win_enter_ext (wp, undo_sync, curwin_invalid)
    win_T * wp;
    int undo_sync;
    int curwin_invalid;
{
    int other_buffer = 0;
    if (wp == curwin && !curwin_invalid) return;
    if (!curwin_invalid) {
        if (wp -> w_buffer != curbuf) {
            apply_autocmds (EVENT_BUFLEAVE, ((void *) 0), ((void *) 0), 0, curbuf);
            other_buffer = 1;
            if (!win_valid(wp)) return;
        }
        apply_autocmds (EVENT_WINLEAVE, ((void *) 0), ((void *) 0), 0, curbuf);
        if (!win_valid(wp)) return;
        if (aborting ()) return;
    }
    if (undo_sync && curbuf != wp -> w_buffer) u_sync (0);
    if (wp -> w_buffer != curbuf) buf_copy_options (wp -> w_buffer, 1 | 4);
    if (!curwin_invalid) {
        prevwin = curwin;
    ...
    if (curwin -> w_localdir != ((void *) 0)) {
        if (globaldir == ((void *) 0)) {
            char_u cwd [1024];
            if (mch_dirname (cwd, 1024) == 1) globaldir = vim_strsave (cwd);
        }
        if (mch_chdir ((char *) curwin -> w_localdir) == 0) shorten_fnames (1);
    }
    ...
    curwin -> w_redr_status = 1;
    redraw_tabline = 1;
    if (restart_edit) redraw_later (10);
    if (curwin -> w_height < p_wh && !curwin->w_onebuf_opt.wo_wfh) win_setheight ((int) p_wh);
    else if (curwin -> w_height == 0) win_setheight (1);
    if (curwin -> w_width < p_wiw && !curwin->w_onebuf_opt.wo_wfw) win_setwidth ((int) p_wiw);
    setmouse ();
...
{
    win_T * wp;
    for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) if (wp -> w_buffer == buf) break;
    if (wp != ((void *) 0)) win_enter (wp, 0);
    return wp;
}
    ...
    buf_T * buf;
{
    ...
    for (tp = first_tabpage; tp != ((void *) 0); tp = tp -> tp_next) if (tp != curtab) {
        for (wp = tp -> tp_firstwin; wp != ((void *) 0); wp = wp -> w_next) if (wp -> w_buffer == buf) break;
        if (wp != ((void *) 0)) {
            goto_tabpage_win (tp, wp);
            if (curwin != wp) wp = ((void *) 0);
            break;
        }
    }
    return wp;
...
static win_T * win_alloc (after, hidden)
    win_T * after __attribute__ ((unused));
    int hidden __attribute__ ((unused));
{
    win_T * newwin;
    newwin = (win_T *) alloc_clear ((unsigned) sizeof (win_T));
    if (newwin != ((void *) 0) && win_alloc_lines (newwin) == 0) {
        vim_free (newwin);
        newwin = ((void *) 0);
    }
    if (newwin != ((void *) 0)) {
        block_autocmds ();
        if (!hidden) win_append (after, newwin);
        newwin -> w_wincol = 0;
    ...
    tabpage_T * tp;
{
    ...
    if (prevwin == wp) prevwin = ((void *) 0);
    win_free_lsize (wp);
    for (i = 0; i < wp -> w_tagstacklen; ++i) vim_free (wp -> w_tagstack [i].tagname);
    ...
    if (wp != aucmd_win) win_remove (wp, tp);
    vim_free (wp);
    unblock_autocmds ();
}
...
{
    win_T * before;
    if (after == ((void *) 0)) before = firstwin;
    else before = after -> w_next;
    wp -> w_next = before;
    wp -> w_prev = after;
    if (after == ((void *) 0)) firstwin = wp;
    else after -> w_next = wp;
    if (before == ((void *) 0)) lastwin = wp;
...
void win_remove (wp, tp)
    ...
    tabpage_T * tp;
{
    if (wp -> w_prev != ((void *) 0)) wp -> w_prev -> w_next = wp -> w_next;
    else if (tp == ((void *) 0)) firstwin = wp -> w_next;
    else tp -> tp_firstwin = wp -> w_next;
    if (wp -> w_next != ((void *) 0)) wp -> w_next -> w_prev = wp -> w_prev;
    else if (tp == ((void *) 0)) lastwin = wp -> w_prev;
    ...
    frame_T * after, * frp;
{
    ...
    after -> fr_next = frp;
    if (frp -> fr_next != ((void *) 0)) frp -> fr_next -> fr_prev = frp;
    frp -> fr_prev = after;
}
    ...
    frame_T * before, * frp;
{
    ...
    before -> fr_prev = frp;
    if (frp -> fr_prev != ((void *) 0)) frp -> fr_prev -> fr_next = frp;
...
static void frame_remove (frp)
    frame_T * frp;
{
    if (frp -> fr_prev != ((void *) 0)) frp -> fr_prev -> fr_next = frp -> fr_next;
    else frp -> fr_parent -> fr_child = frp -> fr_next;
    if (frp -> fr_next != ((void *) 0)) frp -> fr_next -> fr_prev = frp -> fr_prev;
}
...
void shell_new_rows () {
    ...
    if (firstwin == ((void *) 0)) return;
    if (h < frame_minheight (topframe, ((void *) 0))) h = frame_minheight (topframe, ((void *) 0));
    frame_new_height (topframe, h, 0, 1);
    if (topframe -> fr_height != h) frame_new_height (topframe, h, 0, 0);
    (void) win_comp_pos ();
    compute_cmdrow ();
...
void shell_new_columns () {
    ...
    if (topframe -> fr_width != Columns) frame_new_width (topframe, (int) Columns, 0, 0);
    (void) win_comp_pos ();
}
    ...
    garray_T * gap;
{
    ...
    if (ga_grow (gap, win_count () * 2) == 1) for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) {
    ...
    int * col;
{
    ...
    if (wp != ((void *) 0)) {
        ...
        *col += wp -> w_width + wp -> w_vsep_width;
        ...
        startcol = *col;
        for (frp = topfrp -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) {
            if (topfrp -> fr_layout == 1) *row = startrow;
            else *col = startcol;
    ...
    win_T * win;
{
    int row;
    if (win == curwin) {
        if (height < p_wmh) height = p_wmh;
        if (height == 0) height = 1;
    }
    frame_setheight (win -> w_frame, height + win -> w_status_height);
    row = win_comp_pos ();
    if (full_screen && msg_scrolled == 0 && row < cmdline_row) screen_fill (row, cmdline_row, 0, (int) Columns, ' ', ' ', 0);
    cmdline_row = row;
    msg_row = row;
    msg_col = 0;
    redraw_all_later (40);
    ...
    int height;
{
    ...
    int h;
    int room_reserved;
    if (curfrp -> fr_height == height) return;
    if (curfrp -> fr_parent == ((void *) 0)) {
        if (height > (Rows - p_ch - tabline_height ())) height = (Rows - p_ch - tabline_height ());
        if (height > 0) frame_new_height (curfrp, height, 0, 0);
    }
        ...
        for (run = 1; run <= 2; ++run) {
            ...
            for (frp = curfrp -> fr_parent -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) {
                if (frp != curfrp && frp -> fr_win != ((void *) 0) && frp -> fr_win -> w_onebuf_opt.wo_wfh) room_reserved += frp -> fr_height;
                room += frp -> fr_height;
                if (frp != curfrp) room -= frame_minheight (frp, ((void *) 0));
            }
            if (curfrp -> fr_width != Columns) room_cmdline = 0;
            else {
                room_cmdline = Rows - p_ch - (lastwin -> w_winrow + lastwin -> w_height + lastwin -> w_status_height);
                if (room_cmdline < 0) room_cmdline = 0;
            }
            if (height <= room + room_cmdline) break;
        ...
        if (height > room + room_cmdline - room_reserved) room_reserved = room + room_cmdline - height;
        if (take < 0 && room - curfrp -> fr_height < room_reserved) room_reserved = 0;
        if (take > 0 && room_cmdline > 0) {
            if (take < room_cmdline) room_cmdline = take;
            take -= room_cmdline;
            topframe -> fr_height += room_cmdline;
        }
        frame_new_height (curfrp, height, 0, 0);
        for (run = 0; run < 2; ++run) {
            if (run == 0) frp = curfrp -> fr_next;
            else frp = curfrp -> fr_prev;
            while (frp != ((void *) 0) && take != 0) {
                h = frame_minheight (frp, ((void *) 0));
                if (room_reserved > 0 && frp -> fr_win != ((void *) 0) && frp -> fr_win -> w_onebuf_opt.wo_wfh) {
                    if (room_reserved >= frp -> fr_height) room_reserved -= frp -> fr_height;
                    else {
                        if (frp -> fr_height - room_reserved > take) room_reserved = frp -> fr_height - take;
                    ...
                    if (frp -> fr_height - take < h) {
                        ...
                        frame_new_height (frp, frp -> fr_height - take, 0, 0);
                        take = 0;
                    }
                }
                if (run == 0) frp = frp -> fr_next;
    ...
    int width;
{
    ...
    int w;
    int room_reserved;
    if (curfrp -> fr_width == width) return;
    if (curfrp -> fr_parent == ((void *) 0)) return;
    if (curfrp -> fr_parent -> fr_layout == 2) {
        ...
        for (run = 1; run <= 2; ++run) {
            ...
            room_reserved = 0;
            for (frp = curfrp -> fr_parent -> fr_child; frp != ((void *) 0); frp = frp -> fr_next) {
                if (frp != curfrp && frp -> fr_win != ((void *) 0) && frp -> fr_win -> w_onebuf_opt.wo_wfw) room_reserved += frp -> fr_width;
                room += frp -> fr_width;
                if (frp != curfrp) room -= frame_minwidth (frp, ((void *) 0));
            }
            if (width <= room) break;
        ...
        if (width > room - room_reserved) room_reserved = room - width;
        if (take < 0 && room - curfrp -> fr_width < room_reserved) room_reserved = 0;
        ...
        for (run = 0; run < 2; ++run) {
            ...
            while (frp != ((void *) 0) && take != 0) {
                w = frame_minwidth (frp, ((void *) 0));
                if (room_reserved > 0 && frp -> fr_win != ((void *) 0) && frp -> fr_win -> w_onebuf_opt.wo_wfw) {
                    if (room_reserved >= frp -> fr_width) room_reserved -= frp -> fr_width;
                    else {
                        if (frp -> fr_width - room_reserved > take) room_reserved = frp -> fr_width - take;
                    ...
                    if (frp -> fr_width - take < w) {
                        ...
                        frame_new_width (frp, frp -> fr_width - take, 0, 0);
                        take = 0;
                    }
                }
                if (run == 0) frp = frp -> fr_next;
...
void win_setminheight () {
    ...
    while (p_wmh > 0) {
        room = -p_wh;
        for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) room += wp -> w_height - p_wmh;
        if (room >= 0) break;
        --p_wmh;
        if (first) {
            emsg ((char_u *) (((char *) (e_noroom))));
    ...
    int offset;
{
    ...
    if (fr != topframe) {
        ...
        if (fr -> fr_layout != 2) {
            curfr = fr;
            if (fr != topframe) fr = fr -> fr_parent;
        }
    }
    ...
    if (offset < 0) {
        ...
        if (curfr -> fr_next == ((void *) 0)) room -= 1;
        else room -= p_ch;
        if (room < 0) room = 0;
        for (fr = curfr -> fr_next; fr != ((void *) 0); fr = fr -> fr_next) room += fr -> fr_height - frame_minheight (fr, ((void *) 0));
        fr = curfr;
    }
    if (room < offset) offset = room;
    if (offset <= 0) return;
    if (fr != ((void *) 0)) frame_new_height (fr, fr -> fr_height + offset, up, 0);
    if (up) fr = curfr;
    ...
    int offset;
{
    ...
    if (offset < 0) {
        ...
        left = 0;
        room = 0;
        for (fr = curfr -> fr_next; fr != ((void *) 0); fr = fr -> fr_next) room += fr -> fr_width - frame_minwidth (fr, ((void *) 0));
        fr = curfr;
    }
    if (room < offset) offset = room;
    if (offset <= 0) return;
...
static void win_new_height (wp, height)
    win_T * wp;
    int height;
{
    linenr_T lnum;
    ...
    if (wp -> w_height == height) return;
    if (wp -> w_wrow != wp -> w_prev_fraction_row && wp -> w_height > 0) wp -> w_fraction = ((long) wp -> w_wrow * 16384L + 16384L / 2) / (long) wp -> w_height
      ;
    wp -> w_height = height;
    wp -> w_skipcol = 0;
    if (height > 0 && (!wp->w_onebuf_opt.wo_scb || wp == curwin)) {
        ...
        if (sline < 0) {
            ...
            while (sline > 0 && lnum > 1) {
                ...
                --lnum;
                if (lnum == wp -> w_topline) line_size = plines_win_nofill (wp, lnum, 1) + wp -> w_topfill;
                else line_size = plines_win (wp, lnum, 1);
                sline -= line_size;
            }
            if (sline < 0) {
...
static void win_new_width (wp, width)
    win_T * wp;
    int width;
{
    wp -> w_width = width;
...
void win_comp_scroll (wp)
    win_T * wp;
{
    wp -> w_onebuf_opt.wo_scr = ((unsigned) wp -> w_height >> 1);
    if (wp -> w_onebuf_opt.wo_scr == 0) wp -> w_onebuf_opt.wo_scr = 1;
}
...
void command_height () {
    ...
    curtab -> tp_ch_used = p_ch;
    frp = lastwin -> w_frame;
    while (frp -> fr_width != Columns && frp -> fr_parent != ((void *) 0)) frp = frp -> fr_parent;
    while (frp -> fr_prev != ((void *) 0) && frp -> fr_layout == 0 && frp -> fr_win -> w_onebuf_opt.wo_wfh) frp = frp -> fr_prev;
    if (starting != 2) {
        ...
        if (p_ch > old_p_ch) {
            while (p_ch > old_p_ch) {
                ...
                if (h > p_ch - old_p_ch) h = p_ch - old_p_ch;
                old_p_ch += h;
                frame_add_height (frp, -h);
                frp = frp -> fr_prev;
            }
            (void) win_comp_pos ();
            if (full_screen) screen_fill ((int) (cmdline_row), (int) Rows, 0, (int) Columns, ' ', ' ', 0);
            msg_row = cmdline_row;
            redraw_cmdline = 1;
            return;
        }
        if (msg_row < cmdline_row) msg_row = cmdline_row;
        redraw_cmdline = 1;
    }
    frame_add_height (frp, (int) (old_p_ch - p_ch));
    if (frp != lastwin -> w_frame) (void) win_comp_pos ();
}
    ...
    if (fr -> fr_layout == 0) {
        ...
        if (wp -> w_status_height != 0 && !statusline) {
            ...
            while (fp -> fr_height <= frame_minheight (fp, ((void *) 0))) {
                ...
                if (fp -> fr_parent -> fr_layout == 2 && fp -> fr_prev != ((void *) 0)) fp = fp -> fr_prev;
        ...
        for (fp = fr -> fr_child; fp != ((void *) 0); fp = fp -> fr_next) last_status_rec (fp, statusline);
    }
    else {
...
int tabline_height () {
    ...
    case 0 :
        return 0;
    case 1 :
        return (first_tabpage -> tp_next == ((void *) 0)) ? 0 : 1;
    }
    return 1;
}
    ...
    linenr_T * file_lnum;
{
    if (VIsual_active) {
        int len;
        char_u * ptr;
        if (get_visual_text (((void *) 0), &ptr, &len) == 0) return ((void *) 0);
        return find_file_name_in_path (ptr, len, 1 | 2 | 16, count, curbuf -> b_ffname);
    }
    return file_name_at_cursor (1 | 4 | 2 | 16, count, file_lnum);
}
    ...
    linenr_T * file_lnum;
{
    ...
    int len;
    ptr = line + col;
    while (*ptr != '\000' && !vim_isfilec(*ptr)) ++ptr;
    if (*ptr == '\000') {
        if (options & 1) emsg ((char_u *) (((char *) ("E446: No file name under cursor"))));
        return ((void *) 0);
    }
    while (ptr > line) {
        if (vim_isfilec (ptr [-1]) || ((options & 4) && path_is_url (ptr - 1))) --ptr;
        else break;
    }
    len = 0;
    while (vim_isfilec (ptr [len]) || ((options & 4) && path_is_url (ptr + len))) ++len;
    if (len > 2 && vim_strchr ((char_u *) ".,:;!", ptr [len - 1]) != ((void *) 0) && ptr [len - 2] != '.') --len;
    if (file_lnum != ((void *) 0)) {
        char_u * p;
        p = ptr + len;
        p = skipwhite (p);
        if (*p != '\000') {
            if (!isdigit(*p)) ++p;
            p = skipwhite (p);
            if (isdigit (*p)) *file_lnum = (int) getdigits (&p);
        }
    }
...
{
    char_u * res;
    set_vim_var_string (11, ptr, len);
    res = eval_to_string_safe (curbuf -> b_p_inex, ((void *) 0), was_set_insecurely ((char_u *) "includeexpr", 4));
    set_vim_var_string (11, ((void *) 0), 0);
    return res;
}
    ...
    char_u * rel_fname;
{
    ...
    if (options & 2) {
        file_name = find_file_in_path (ptr, len, options & ~1, 1, rel_fname);
        if (file_name == ((void *) 0) && !(options&8) && *curbuf->b_p_inex != '\000') {
            tofree = eval_includeexpr (ptr, len);
            if (tofree != ((void *) 0)) {
                ptr = tofree;
                len = (int) strlen ((char *) (ptr));
        ...
        if (file_name == ((void *) 0) && (options & 1)) {
            c = ptr [len];
            ptr [len] = '\000';
            emsg2 ((char_u *) (((char *) ("E447: Can't find file \"%s\" in path"))), (char_u *) (ptr));
            ptr [len] = c;
        }
...
static int path_is_url (p)
    char_u * p;
{
    if (strncmp ((char *) (p), (char *) ("://"), (size_t) ((size_t) 3)) == 0) return 1;
    else if (strncmp ((char *) (p), (char *) (":\\\\"), (size_t) ((size_t) 3)) == 0) return 2;
    return 0;
}
    ...
    int force;
{
    ...
    * buf = '\000';
    ...
    if (!url) retval = mch_FullName (fname, buf, len, force);
    if (url || retval == 0) {
...
int min_rows () {
    ...
    tabpage_T * tp;
    int n;
    if (firstwin == ((void *) 0)) return 2;
    total = 0;
    for (tp = first_tabpage; tp != ((void *) 0); tp = tp -> tp_next) {
        n = frame_minheight (tp -> tp_topframe, ((void *) 0));
        if (total < n) total = n;
    }
...
int only_one_window () {
    int count = 0;
    win_T * wp;
    if (first_tabpage -> tp_next != ((void *) 0)) return 0;
    for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) if ((!((wp->w_buffer->b_help&&!curbuf->b_help) || wp -> w_onebuf_opt.wo_pvw) || wp == curwin) &&
      wp != aucmd_win) ++count;
    return (count <= 1);
}
    ...
    int do_curwin;
{
    ...
    for ((tp) = first_tabpage; (tp) != ((void *) 0); (tp) = (tp) -> tp_next) for ((wp) = ((tp) == curtab) ? firstwin : (tp) -> tp_firstwin; (wp); (wp) = (wp) ->
      w_next) if ((do_curwin || wp != curwin) && wp -> w_buffer == curbuf) {
        if (wp -> w_cursor.lnum > curbuf -> b_ml.ml_line_count) wp -> w_cursor.lnum = curbuf -> b_ml.ml_line_count;
        if (wp -> w_topline > curbuf -> b_ml.ml_line_count) wp -> w_topline = curbuf -> b_ml.ml_line_count;
    }
}
    ...
    frame_T * * frp;
{
    * frp = (frame_T *) alloc_clear ((unsigned) sizeof (frame_T));
    ...
    if (fr -> fr_next != ((void *) 0)) make_snapshot_rec (fr -> fr_next, &((*frp) -> fr_next));
    if (fr -> fr_child != ((void *) 0)) make_snapshot_rec (fr -> fr_child, &((*frp) -> fr_child));
    if (fr -> fr_layout == 0 && fr -> fr_win == curwin) (*frp) -> fr_win = curwin;
}
...
{
    win_T * wp;
    if (curtab -> tp_snapshot [idx] != ((void *) 0) && curtab -> tp_snapshot [idx] -> fr_width == topframe -> fr_width && curtab -> tp_snapshot [idx] ->
      fr_height == topframe -> fr_height && check_snapshot_rec (curtab -> tp_snapshot [idx], topframe) == 1) {
        wp = restore_snapshot_rec (curtab -> tp_snapshot [idx], topframe);
        win_comp_pos ();
        if (wp != ((void *) 0) && close_curwin) win_goto (wp);
        redraw_all_later (50);
    }
    clear_snapshot (curtab, idx);
}
...
static int check_snapshot_rec (sn, fr)
    ...
    frame_T * fr;
{
    if (sn -> fr_layout != fr -> fr_layout || (sn -> fr_next == ((void *) 0)) != (fr -> fr_next == ((void *) 0)) || (sn -> fr_child == ((void *) 0)) != (fr ->
      fr_child == ((void *) 0)) || (sn -> fr_next != ((void *) 0) && check_snapshot_rec (sn -> fr_next, fr -> fr_next) == 0) || (sn -> fr_child != ((void *) 0)
      && check_snapshot_rec (sn -> fr_child, fr -> fr_child) == 0)) return 0;
    return 1;
}
    ...
    int id;
{
    ...
    int hlg_id;
    regprog_T * regprog;
    if (*grp == '\000' || *pat == '\000') return -1;
    if (id < -1 || id == 0) {
        emsgn ((char_u *) ("E799: Invalid ID: %ld (must be greater than or equal to 1)"), (long) (id));
        return -1;
    }
    if (id != -1) {
        cur = wp -> w_match_head;
        while (cur != ((void *) 0)) {
            if (cur -> id == id) {
                emsgn ((char_u *) ("E801: ID already taken: %ld"), (long) (id));
                return -1;
            }
            cur = cur -> next;
        }
    ...
    if ((hlg_id = syn_namen2id (grp, (int) strlen ((char *) (grp)))) == 0) {
        emsg2 ((char_u *) (((char *) (e_nogroup))), (char_u *) (grp));
        return -1;
    }
    if ((regprog = vim_regcomp (pat, 1)) == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (pat));
        return -1;
    }
    while (id == -1) {
        cur = wp -> w_match_head;
        while (cur != ((void *) 0) && cur -> id != wp -> w_next_match_id) cur = cur -> next;
        if (cur == ((void *) 0)) id = wp -> w_next_match_id;
        wp -> w_next_match_id ++;
    }
    ...
    int perr;
{
    ...
    if (id < 1) {
        if (perr == 1) emsgn ((char_u *) ("E802: Invalid ID: %ld (must be greater than or equal to 1)"), (long) (id));
        return -1;
    }
    ...
    if (cur == ((void *) 0)) {
        if (perr == 1) emsgn ((char_u *) ("E803: ID not found: %ld"), (long) (id));
        return -1;
    }
    if (cur == prev) wp -> w_match_head = cur -> next;
...
{
    matchitem_T * cur = wp -> w_match_head;
    while (cur != ((void *) 0) && cur -> id != id) cur = cur -> next;
    return cur;
}

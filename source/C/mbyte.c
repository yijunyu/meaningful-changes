...
size_t wcsftime (wchar_t *, size_t, const wchar_t *, const struct tm *) __asm ("_" "wcsftime");
...
{
    int i;
    for (i = 0; i < 60; ++i) if (strcmp ((char *) (name), (char *) (enc_canon_table [i].name)) == 0) return i;
    return -1;
}
...
char_u * enc_skip (p)
    char_u * p;
{
    if (strncmp ((char *) (p), (char *) ("2byte-"), (size_t) (6)) == 0) return p + 6;
    if (strncmp ((char *) (p), (char *) ("8bit-"), (size_t) (5)) == 0) return p + 5;
    return p;
}
    ...
    char_u * enc;
{
    ...
    char_u * p, * s;
    int i;
    r = alloc ((unsigned) (strlen ((char *) (enc)) + 3));
    if (r != ((void *) 0)) {
        p = r;
        for (s = enc; *s != '\000'; ++s) {
            if (*s == '_') *p++ = '-';
            else *p++ = (((*s) < 'A' || (*s) > 'Z') ? (*s) : (*s) + ('a' - 'A'));
        }
        * p = '\000';
        p = enc_skip (r);
        if (strncmp ((char *) (p), (char *) ("microsoft-cp"), (size_t) (12)) == 0) ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ?
          __builtin___memmove_chk ((char *) ((p)), (char *) ((p + 10)), strlen ((char *) (p + 10)) + 1, __builtin_object_size ((char *) ((p)), 0)) :
          __inline_memmove_chk ((char *) ((p)), (char *) ((p + 10)), strlen ((char *) (p + 10)) + 1));
        if (strncmp ((char *) (p), (char *) ("iso8859"), (size_t) (7)) == 0) {
            ((__builtin_object_size ((char *) ((p + 4)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p + 4)), (char *) ((p + 3)), strlen ((char *
              ) (p + 3)) + 1, __builtin_object_size ((char *) ((p + 4)), 0)) : __inline_memmove_chk ((char *) ((p + 4)), (char *) ((p + 3)), strlen ((char *) (
              p + 3)) + 1));
            p [3] = '-';
        }
        if (strncmp ((char *) (p), (char *) ("iso-8859"), (size_t) (8)) == 0 && p [8] != '-') {
            ((__builtin_object_size ((char *) ((p + 9)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p + 9)), (char *) ((p + 8)), strlen ((char *
              ) (p + 8)) + 1, __builtin_object_size ((char *) ((p + 9)), 0)) : __inline_memmove_chk ((char *) ((p + 9)), (char *) ((p + 8)), strlen ((char *) (
              p + 8)) + 1));
            p [8] = '-';
        }
        if (strncmp ((char *) (p), (char *) ("latin-"), (size_t) (6)) == 0) ((__builtin_object_size ((char *) ((p + 5)), 0) != (size_t) - 1) ?
          __builtin___memmove_chk ((char *) ((p + 5)), (char *) ((p + 6)), strlen ((char *) (p + 6)) + 1, __builtin_object_size ((char *) ((p + 5)), 0)) :
          __inline_memmove_chk ((char *) ((p + 5)), (char *) ((p + 6)), strlen ((char *) (p + 6)) + 1));
        if (enc_canon_search (p) >= 0) {
            if (p != r) ((__builtin_object_size ((char *) ((r)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((r)), (char *) ((p)), strlen ((char *
              ) (p)) + 1, __builtin_object_size ((char *) ((r)), 0)) : __inline_memmove_chk ((char *) ((r)), (char *) ((p)), strlen ((char *) (p)) + 1));
        }
...
{
    int i;
    for (i = 0; enc_alias_table [i].name != ((void *) 0); ++i) if (strcmp ((char *) (name), (char *) (enc_alias_table [i].name)) == 0) return enc_alias_table [
      i].canon;
    return -1;
}

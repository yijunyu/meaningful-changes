...
{(long_u) 0x000000L, (long_u) 0xff0000L, (long_u) 0x00ff00L, (long_u) 0xffff00L, (long_u) 0x0000ffL, (long_u) 0xff00ffL, (long_u) 0x00ffffL, (long_u) 0xffffffL
  };
static const long_u cterm_color_16 [16] =
{(long_u) 0x000000L, (long_u) 0x0000c0L, (long_u) 0x008000L, (long_u) 0x004080L, (long_u) 0xc00000L, (long_u) 0xc000c0L, (long_u) 0x808000L, (long_u) 0xc0c0c0L
      , (long_u) 0x808080L, (long_u) 0x6060ffL, (long_u) 0x00ff00L, (long_u) 0x00ffffL, (long_u) 0xff8080L, (long_u) 0xff40ffL, (long_u) 0xffff00L, (long_u)
      0xffffffL};
    ...
    int table_size;
{
    ...
    int idx = 0;
    int len;
    for (idx = 0; idx < table_size; ++idx) table [idx].present = 0;
    stringp = option_str;
    while (*stringp) {
        colonp = vim_strchr (stringp, ':');
        if (colonp == ((void *) 0)) return (char_u *) "E550: Missing colon";
        commap = vim_strchr (stringp, ',');
        if (commap == ((void *) 0)) commap = option_str + strlen ((char *) (option_str));
        len = (int) (colonp - stringp);
        for (idx = 0; idx < table_size; ++idx) if (strncasecmp ((char *) (stringp), (char *) (table [idx].name), (size_t) (len)) == 0) break;
        if (idx == table_size) return (char_u *) "E551: Illegal component";
        p = colonp + 1;
        table [idx].present = 1;
        if (table [idx].hasnum) {
            if (!((*p) >= '0' && (*p) <= '9')) return (char_u *) "E552: digit expected";
...
static long_u darken_rgb (rgb)
    long_u rgb;
{
    return ((rgb >> 17) << 16) + (((rgb & 0xff00) >> 9) << 8) + ((rgb & 0xff) >> 1);
}

static long_u prt_get_term_color (colorindex)
    int colorindex;
{
    if (t_colors > 8) return cterm_color_16 [colorindex % 16];
    ...
    int modec;
{
    ...
    {
        bg_color = (long_u) 0xFFFFFFL;
        color = (char *) highlight_color (hl_id, (char_u *) "fg", modec);
        if (color == ((void *) 0)) colorindex = 0;
        else colorindex = atoi (color);
        if (colorindex >= 0 && colorindex < t_colors) fg_color = prt_get_term_color (colorindex);
        else fg_color = (long_u) 0;
    }
    if (fg_color == (long_u) 0xFFFFFFL) fg_color = (long_u) 0;
    else if (*p_bg == 'd') fg_color = darken_rgb (fg_color);
...
static void prt_set_font (bold, italic, underline)
    ...
    int underline;
{
    if (curr_bold != bold || curr_italic != italic || curr_underline != underline) {
    ...
    linenr_T lnum;
{
    ...
    __builtin___sprintf_chk ((char *) tbuf, 0, __builtin_object_size ((char *) tbuf, 1 > 1), "%6ld", (long) lnum);
    for (i = 0; i < 6; i ++) (void) mch_print_text_out (&tbuf[i], 1);
    if (psettings -> do_syntax) current_syn_id = -1;
    else {
        prt_set_fg ((long_u) 0);
        prt_set_bg ((long_u) 0xFFFFFFL);
        prt_set_font (0, 0, 0);
    }
}

int prt_header_height () {
    if (printer_opts [4].present) return printer_opts [4].number;
    return 2;
}

int prt_use_number () {
    return (printer_opts [6].present && (((printer_opts [6].string [0]) < 'A' || (printer_opts [6].string [0]) > 'Z') ? (printer_opts [6].string [0]) : (
      printer_opts [6].string [0]) + ('a' - 'A')) == 'y');
}
    ...
    int idx;
{
    ...
    static char * (units [4]) =
    {"pc", "in", "mm", "pt"};
    if (printer_opts [idx].present) for (i = 0; i < 4; ++i) if (strncasecmp ((char *) (printer_opts [idx].string), (char *) (units [i]), (size_t) (2)) == 0) {
        u = i;
        break;
    }
    return u;
    ...
    linenr_T lnum __attribute__ ((unused));
{
    ...
    char_u * tbuf;
    char_u * p;
    if (prt_use_number ()) width += 8;
    tbuf = alloc (width + (1024 + 1));
    if (tbuf == ((void *) 0)) return;
    if (*p_header != '\000') {
        ...
        build_stl_str_hl (curwin, tbuf, (size_t) (width + (1024 + 1)), p_header, use_sandbox, ' ', width, ((void *) 0), ((void *) 0));
        curwin -> w_cursor.lnum = tmp_lnum;
        curwin -> w_topline = tmp_topline;
        curwin -> w_botline = tmp_botline;
    }
    else __builtin___sprintf_chk ((char *) tbuf, 0, __builtin_object_size ((char *) tbuf, 1 > 1), ((char *) ("Page %d")), pagenum);
    prt_set_fg ((long_u) 0);
    prt_set_bg ((long_u) 0xFFFFFFL);
    prt_set_font (1, 0, 0);
    ...
    mch_print_start_line (1, page_line);
    for (p = tbuf; *p != '\000';) {
        if (mch_print_text_out (p, 1)) {
            ++page_line;
            if (page_line >= 0) break;
            mch_print_start_line (1, page_line);
        }
        p ++;
    }
    ...
    exarg_T * eap;
{
    ...
    int page_line;
    int jobsplit;
    ((__builtin_object_size ((&settings), 0) != (size_t) - 1) ? __builtin___memset_chk ((&settings), (0), (sizeof (prt_settings_T)), __builtin_object_size 
      ((&settings), 0)) : __inline_memset_chk ((&settings), (0), (sizeof (prt_settings_T))));
    ...
    else if (*eap->arg != '\000') settings.arguments = eap -> arg;
    if (mch_print_init (&settings, curbuf -> b_fname == ((void *) 0) ? (char_u *) buf_spname (curbuf) : curbuf -> b_sfname == ((void *) 0) ? curbuf -> b_fname :
      curbuf -> b_sfname, eap -> forceit) == 0) return;
    if (t_colors > 1) settings.modec = 'c';
    else settings.modec = 't';
    if (!syntax_present(curwin)) settings.do_syntax = 0;
    else if (printer_opts [5].present && (((printer_opts [5].string [0]) < 'A' || (printer_opts [5].string [0]) > 'Z') ? (printer_opts [5].string [0]) : (
      printer_opts [5].string [0]) + ('a' - 'A')) != 'a') settings.do_syntax = ((((printer_opts [5].string [0]) < 'A' || (printer_opts [5].string [0]) > 'Z') ?
      (printer_opts [5].string [0]) : (printer_opts [5].string [0]) + ('a' - 'A')) == 'y');
    else settings.do_syntax = settings.has_color;
    settings.number.fg_color = (long_u) 0;
    settings.number.bg_color = (long_u) 0xFFFFFFL;
    ...
    for (lnum = eap -> line1; lnum <= eap -> line2; lnum ++) bytes_to_print += (long_u) strlen ((char *) (skipwhite (ml_get (lnum))));
    if (bytes_to_print == 0) {
        msg ((char_u *) (((char *) ("No text to be printed"))));
    ...
    prt_set_font (0, 0, 0);
    current_syn_id = -1;
    jobsplit = (printer_opts [12].present && (((printer_opts [12].string [0]) < 'A' || (printer_opts [12].string [0]) > 'Z') ? (printer_opts [12].string [0]) :
      (printer_opts [12].string [0]) + ('a' - 'A')) == 'y');
    if (!mch_print_begin(&settings)) goto print_fail_no_begin;
    page_count = 0;
    for (collated_copies = 0; collated_copies < settings.n_collated_copies; collated_copies ++) {
        prt_pos_T prtpos;
        prt_pos_T page_prtpos;
        int side;
        ((__builtin_object_size ((&page_prtpos), 0) != (size_t) - 1) ? __builtin___memset_chk ((&page_prtpos), (0), (sizeof (prt_pos_T)), __builtin_object_size
          ((&page_prtpos), 0)) : __inline_memset_chk ((&page_prtpos), (0), (sizeof (prt_pos_T))));
        ...
        for (page_count = 0; prtpos.file_line <= eap -> line2; ++page_count) {
            for (uncollated_copies = 0; uncollated_copies < settings.n_uncollated_copies; uncollated_copies ++) {
                prtpos = page_prtpos;
                for (side = 0; side <= settings.duplex; ++side) {
                    ui_breakcheck ();
                    if (got_int || settings.user_abort) goto print_fail;
                    __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("Printing page %d (%d%%)")),
                      page_count + 1 + side, prtpos.bytes_printed > 1000000 ? (int) (prtpos.bytes_printed / (bytes_to_print / 100)) : (int) ((prtpos.
                      bytes_printed * 100) / bytes_to_print));
                    if (!mch_print_begin_page(IObuff)) goto print_fail;
                    if (settings.n_collated_copies > 1) __builtin___sprintf_chk ((char *) IObuff + strlen ((char *) (IObuff)), 0, __builtin_object_size ((char *
                      ) IObuff + strlen ((char *) (IObuff)), 1 > 1), ((char *) (" Copy %d of %d")), collated_copies + 1, settings.n_collated_copies);
                    prt_message (IObuff);
                    if (prt_header_height () > 0) prt_header (&settings, page_count + 1 + side, prtpos.file_line);
                    for (page_line = 0; page_line < settings.lines_per_page; ++page_line) {
                        prtpos.column = hardcopy_line (&settings, page_line, &prtpos);
                        if (prtpos.column == 0) {
                            prtpos.bytes_printed += strlen ((char *) (skipwhite (ml_get (prtpos.file_line))));
                            if (++prtpos.file_line > eap -> line2) break;
                        }
                        else if (prtpos.ff) {
                            break;
                        }
                    }
                    if (!mch_print_end_page()) goto print_fail;
                    if (prtpos.file_line > eap -> line2) break;
                }
                if (prtpos.file_line > eap -> line2 && settings.duplex && side == 0 && uncollated_copies + 1 < settings.n_uncollated_copies) {
                    if (!mch_print_blank_page()) goto print_fail;
                }
            }
            if (settings.duplex && prtpos.file_line <= eap -> line2) ++page_count;
            page_prtpos = prtpos;
        }
        vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) ("Printed: %s")), settings.jobname);
        prt_message (IObuff);
    }
    print_fail : if (got_int || settings.user_abort) {
        __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), "%s", ((char *) ("Printing aborted")));
        prt_message (IObuff);
    }
    mch_print_end (&settings);
    print_fail_no_begin : mch_print_cleanup ();
}
    ...
    prt_pos_T * ppos;
{
    ...
    if (ppos -> column == 0 || ppos -> ff) {
        print_pos = 0;
        tab_spaces = 0;
        if (!ppos->ff && prt_use_number ()) prt_line_number (psettings, page_line, ppos -> file_line);
        ppos -> ff = 0;
    }
    else {
    ...
    for (col = ppos -> column; line [col] != '\000' && !need_break; col += outputlen) {
        ...
        if (line [col] == '\011' || tab_spaces != 0) {
            if (tab_spaces == 0) tab_spaces = (int) (curbuf -> b_p_ts - (print_pos % curbuf -> b_p_ts));
            while (tab_spaces > 0) {
            ...
            if (need_break && tab_spaces > 0) break;
        }
        else if (line [col] == '\014' && printer_opts [13].present && (((printer_opts [13].string [0]) < 'A' || (printer_opts [13].string [0]) > 'Z') ? (
          printer_opts [13].string [0]) : (printer_opts [13].string [0]) + ('a' - 'A')) == 'y') {
            ppos -> ff = 1;
            need_break = 1;
        }
        else {
    ...
    if (!ppos->ff && (line [col] == '\000' || (printer_opts [7].present && (((printer_opts [7].string [0]) < 'A' || (printer_opts [7].string [0]) > 'Z') ? (
      printer_opts [7].string [0]) : (printer_opts [7].string [0]) + ('a' - 'A')) == 'n'))) return 0;
    return col;
}
...
static struct prt_dsc_comment_S prt_dsc_table [] =
{
    ...
    {"%%Version:", (sizeof ("%%Version:") - 1), (2)},
    {"%%EndComments:", (sizeof ("%%EndComments:") - 1), (3)}};
...
static void prt_write_file_raw_len (buffer, bytes)
    ...
    int bytes;
{
    if (!prt_file_error && fwrite (buffer, sizeof (char_u), bytes, prt_ps_fd) != (size_t) bytes) {
        emsg ((char_u *) (((char *) ("E455: Error writing to PostScript output file"))));
        prt_file_error = 1;
    }
}
...
static void prt_write_file (buffer)
    char_u * buffer;
{
    prt_write_file_len (buffer, (int) strlen ((char *) (buffer)));
}
...
static void prt_write_int (i)
    int i;
{
    __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), "%d ", i);
    prt_write_file (prt_line_buffer);
}
...
static void prt_write_boolean (b)
    int b;
{
    __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), "%s ", (b ? "T" : "F"));
    prt_write_file (prt_line_buffer);
}
...
static void prt_def_font (new_name, encoding, height, font)
    ...
    char * font;
{
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "/_%s /VIM-%s /%s ref\n", new_name, encoding, font);
    prt_write_file (prt_line_buffer);
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "/%s %d /_%s ffs\n", new_name, height, new_name);
    prt_write_file (prt_line_buffer);
}
    ...
    int * pfraction;
{
    ...
    if (real < (double) integer) fraction = -fraction;
    for (i = 0; i < precision; i ++) fraction *= 10.0;
    * pinteger = integer;
    ...
    int prec;
{
    ...
    __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), "%d", integer);
    prt_write_file (prt_line_buffer);
    if (fraction != 0) {
        while ((fraction % 10) == 0) {
            prec --;
        ...
        __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), ".%0*d", prec, fraction);
        prt_write_file (prt_line_buffer);
    }
    __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), " ");
    prt_write_file (prt_line_buffer);
}
...
static void prt_def_var (name, value, prec)
    ...
    int prec;
{
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "/%s ", name);
    prt_write_file (prt_line_buffer);
    prt_write_real (value, prec);
    __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), "d\n");
    prt_write_file (prt_line_buffer);
}

static void prt_flush_buffer () {
    if (prt_ps_buffer.ga_len > 0) {
        if (prt_do_bgcol && (prt_new_bgcol != (long_u) 0xFFFFFFL)) {
            int r, g, b;
            if (prt_do_moveto) {
    ...
    void * cookie;
{
    ...
    if (strlen ((char *) (filename)) >= 1024) *resource_filename = '\000';
    else ((__builtin_object_size ((char *) (resource_filename), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (resource_filename), (char *) (filename)
      , __builtin_object_size ((char *) (resource_filename), 1 > 1)) : __inline_strcpy_chk ((char *) (resource_filename), (char *) (filename)));
}
...
{
    char_u buffer [1024 + 1];
    ((__builtin_object_size ((char *) (resource -> name), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (resource -> name), (char *) (name),
      __builtin_object_size ((char *) (resource -> name), 1 > 1)) : __inline_strcpy_chk ((char *) (resource -> name), (char *) (name)));
    ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buffer), (char *) ("print"), __builtin_object_size ((
      char *) (buffer), 1 > 1)) : __inline_strcpy_chk ((char *) (buffer), (char *) ("print")));
    add_pathsep (buffer);
    ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buffer), (char *) (name), __builtin_object_size ((char *
      ) (buffer), 1 > 1)) : __inline_strcat_chk ((char *) (buffer), (char *) (name)));
    ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buffer), (char *) (".ps"), __builtin_object_size ((char
      *) (buffer), 1 > 1)) : __inline_strcat_chk ((char *) (buffer), (char *) (".ps")));
    resource -> filename [0] = '\000';
    return (do_in_runtimepath (buffer, 0, prt_resource_name, resource -> filename) && resource -> filename [0] != '\000');
}
...
static int prt_resfile_next_line () {
    ...
    while (idx < prt_resfile.len) {
        if (prt_resfile.buffer [idx] != (0x0a) && prt_resfile.buffer [idx] != (0x0d)) break;
        idx ++;
    }
...
static int prt_resfile_strncmp (offset, string, len)
    ...
    int len;
{
    if (len > (prt_resfile.line_end - (prt_resfile.line_start + offset))) return 1;
    ...
    int offset;
{
    ...
    while (idx < prt_resfile.line_end) {
        if (isspace (prt_resfile.buffer [idx])) return idx - prt_resfile.line_start;
        idx ++;
    }
    return -1;
}
    ...
    struct prt_dsc_line_S * p_dsc_line;
{
    int comment;
    int offset;
    if (!prt_resfile_next_line()) return 0;
    if (prt_resfile_strncmp (0, "%%", 2) != 0) return 0;
    for (comment = 0; comment < (int) (sizeof (prt_dsc_table) / sizeof ((prt_dsc_table) [0])); comment ++) if (prt_resfile_strncmp (0, prt_dsc_table [comment].
      string, prt_dsc_table [comment].len) == 0) break;
    if (comment != (sizeof (prt_dsc_table) / sizeof ((prt_dsc_table) [0]))) {
    ...
    struct prt_ps_resource_S * resource;
{
    ...
    if (fd_resource == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) ("E624: Can't open file \"%s\""))), (char_u *) (resource -> filename));
        return 0;
    }
    ((__builtin_object_size ((prt_resfile.buffer), 0) != (size_t) - 1) ? __builtin___memset_chk ((prt_resfile.buffer), ('\000'), ((2048)), __builtin_object_size
      ((prt_resfile.buffer), 0)) : __inline_memset_chk ((prt_resfile.buffer), ('\000'), ((2048))));
    prt_resfile.len = (int) fread ((char *) prt_resfile.buffer, sizeof (char_u), (2048), fd_resource);
    if (ferror (fd_resource)) {
        emsg2 ((char_u *) (((char *) ("E457: Can't read PostScript resource file \"%s\""))), (char_u *) (resource -> filename));
        fclose (fd_resource);
        return 0;
    }
    fclose (fd_resource);
    ...
    if (!prt_resfile_next_line()) return 0;
    offset = 0;
    if (prt_resfile_strncmp (offset, "%!PS-Adobe-", (int) strlen ((char *) ("%!PS-Adobe-"))) != 0) {
        emsg2 ((char_u *) (((char *) ("E618: file \"%s\" is not a PostScript resource file"))), (char_u *) (resource -> filename));
        return 0;
    }
    ...
    offset = prt_resfile_skip_ws (offset);
    if (offset == -1) return 0;
    if (prt_resfile_strncmp (offset, "Resource-", (int) strlen ((char *) ("Resource-"))) != 0) {
        emsg2 ((char_u *) (((char *) ("E619: file \"%s\" is not a supported PostScript resource file"))), (char_u *) (resource -> filename));
        return 0;
    }
    offset += (int) strlen ((char *) ("Resource-"));
    if (prt_resfile_strncmp (offset, "ProcSet", (int) strlen ((char *) ("ProcSet"))) == 0) resource -> type = (0);
    else if (prt_resfile_strncmp (offset, "Encoding", (int) strlen ((char *) ("Encoding"))) == 0) resource -> type = (1);
    else if (prt_resfile_strncmp (offset, "CMap", (int) strlen ((char *) ("CMap"))) == 0) resource -> type = (2);
    else {
        emsg2 ((char_u *) (((char *) ("E619: file \"%s\" is not a supported PostScript resource file"))), (char_u *) (resource -> filename));
        return 0;
    }
    ...
    char_u * version;
{
    if (strncmp ((char *) (resource -> version), (char *) (version), (size_t) (strlen ((char *) (version))))) {
        emsg2 ((char_u *) (((char *) ("E621: \"%s\" resource file has wrong version"))), (char_u *) (resource -> name));
        return 0;
    }
    return 1;
}
...
static void prt_dsc_noarg (comment)
    char * comment;
{
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "%%%%%s\n", comment);
    prt_write_file (prt_line_buffer);
}
...
{
    int i;
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "%%%%%s:", comment);
    prt_write_file (prt_line_buffer);
    for (i = 0; i < count; i ++) {
        __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), " %d", ints [i]);
        prt_write_file (prt_line_buffer);
    }
    prt_write_string ("\n");
}
...
static void prt_dsc_resources (comment, type, string)
    ...
    char * string;
{
    if (comment != ((void *) 0)) vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "%%%%%s: %s", comment, type);
    else vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "%%%%+ %s", type);
    prt_write_file (prt_line_buffer);
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), " %s\n", string);
    prt_write_file (prt_line_buffer);
}
...
{
    int i;
    prt_dsc_resources (resource, "font", ps_font -> ps_fontname [(0)]);
    for (i = (1); i <= (3); i ++) if (ps_font -> ps_fontname [i] != ((void *) 0)) prt_dsc_resources (((void *) 0), "font", ps_font -> ps_fontname [i]);
}
...
static void prt_dsc_requirements (duplex, tumble, collate, color, num_copies)
    ...
    int num_copies;
{
    if (!(duplex||collate||color||(num_copies>1))) return;
    __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), "%%%%Requirements:");
    prt_write_file (prt_line_buffer);
    if (duplex) {
        prt_write_string (" duplex");
        if (tumble) prt_write_string ("(tumble)");
    }
    if (collate) prt_write_string (" collate");
    if (color) prt_write_string (" color");
    if (num_copies > 1) {
        prt_write_string (" numcopies(");
        __builtin___sprintf_chk ((char *) prt_line_buffer, 0, __builtin_object_size ((char *) prt_line_buffer, 1 > 1), "%d", num_copies);
        prt_write_file (prt_line_buffer);
        prt_write_string (")");
    }
    prt_write_string ("\n");
...
static void prt_dsc_docmedia (paper_name, width, height, weight, colour, type)
    ...
    char * type;
{
    vim_snprintf ((char *) prt_line_buffer, sizeof (prt_line_buffer), "%%%%DocumentMedia: %s ", paper_name);
    prt_write_file (prt_line_buffer);
    prt_write_real (width, 2);
    prt_write_real (height, 2);
    prt_write_real (weight, 2);
    if (colour == ((void *) 0)) prt_write_string ("()");
    else prt_write_string (colour);
    prt_write_string (" ");
    if (type == ((void *) 0)) prt_write_string ("()");
    else prt_write_string (type);
    prt_write_string ("\n");
}
    ...
    int def_number;
{
    ...
    else nr = printer_opts [idx].number;
    switch (u) {
    case 1 :
        ret = (float) (nr * (72));
        break;
    case 2 :
        ret = (float) (nr * (72)) / (float) 25.4;
        break;
    case 3 :
        ret = (float) nr;
        break;
...
static int prt_get_cpl () {
    ...
    else prt_number_width = 0.0;
    return (int) ((prt_right_margin - prt_left_margin) / prt_char_width);
}

static int prt_get_lpp () {
    int lpp;
    prt_bgcol_offset = (float) ((prt_ps_font -> bbox_min_y) * ((prt_line_height) / 1000.0));
    if ((prt_ps_font -> bbox_max_y - prt_ps_font -> bbox_min_y) < 1000.0) {
        prt_bgcol_offset -= (float) (((1000.0 - (prt_ps_font -> bbox_max_y - prt_ps_font -> bbox_min_y)) / 2) * ((prt_line_height) / 1000.0));
    }
...
int mch_print_init (psettings, jobname, forceit)
    prt_settings_T * psettings;
    char_u * jobname;
    int forceit __attribute__ ((unused));
{
    int i;
    char * paper_name;
    int paper_strlen;
    ...
    prt_portrait = (!printer_opts[9].present || (((printer_opts [9].string [0]) < 'A' || (printer_opts [9].string [0]) > 'Z') ? (printer_opts [9].string [0]) :
      (printer_opts [9].string [0]) + ('a' - 'A')) == 'y');
    ...
    for (i = 0; i < (int) (sizeof (prt_mediasize) / sizeof (struct prt_mediasize_S)); ++i) if (strlen ((char *) (prt_mediasize [i].name)) == (unsigned)
      paper_strlen && strncasecmp ((char *) (prt_mediasize [i].name), (char *) (paper_name), (size_t) (paper_strlen)) == 0) break;
    if (i == (sizeof (prt_mediasize) / sizeof (struct prt_mediasize_S))) i = 0;
    prt_media = i;
    if (prt_portrait) {
    ...
    fontsize = (10);
    for (p = p_pfn; (p = vim_strchr (p, ':')) != ((void *) 0); ++p) if (p [1] == 'h' && ((p [2]) >= '0' && (p [2]) <= '9')) fontsize = atoi ((char *) p + 2);
    prt_font_metrics (fontsize);
    psettings -> chars_per_line = prt_get_cpl ();
    psettings -> lines_per_page = prt_get_lpp ();
    if (psettings -> chars_per_line <= 0 || psettings -> lines_per_page <= 0) return 0;
    psettings -> n_collated_copies = 1;
    psettings -> n_uncollated_copies = 1;
    prt_num_copies = 1;
    prt_collate = (!printer_opts[11].present || (((printer_opts [11].string [0]) < 'A' || (printer_opts [11].string [0]) > 'Z') ? (printer_opts [11].string [0]
      ) : (printer_opts [11].string [0]) + ('a' - 'A')) == 'y');
    if (prt_collate) {
        psettings -> n_collated_copies = 1;
    }
    else {
    ...
    if (printer_opts [8].present) {
        ...
        else if (strncasecmp ((char *) (printer_opts [8].string), (char *) ("short"), (size_t) (5)) == 0) prt_tumble = 1;
    }
    ...
    if (prt_ps_fd == ((void *) 0)) {
        emsg ((char_u *) (((char *) ("E324: Can't open PostScript output file"))));
        mch_print_cleanup ();
        return 0;
    }
    ...
    struct prt_ps_resource_S * resource;
{
    ...
    fd_resource = fopen (((char *) resource -> filename), ("rb"));
    if (fd_resource == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) ("E456: Can't open file \"%s\""))), (char_u *) (resource -> filename));
        return 0;
    }
    prt_dsc_resources ("BeginResource", prt_resource_types [resource -> type], (char *) resource -> title);
    ...
    prt_settings_T * psettings;
{
    ...
    if (!get_user_name((char_u*)buffer,256)) ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buffer), (char
      *) ("Unknown"), __builtin_object_size ((char *) (buffer), 1 > 1)) : __inline_strcpy_chk ((char *) (buffer), (char *) ("Unknown")));
    prt_dsc_textline ("For", buffer);
    prt_dsc_textline ("Creator", "VIM - Vi IMproved 7.3 (2010 Aug 15)");
    now = time (((void *) 0));
    p_time = ctime (&now);
    ...
    prt_page_margins (prt_mediasize [prt_media].width, prt_mediasize [prt_media].height, &left, &right, &top, &bottom);
    bbox [0] = (int) left;
    if (prt_portrait) {
        ...
        bbox [1] = (int) bottom;
        bbox [2] = (int) (left + ((psettings -> lines_per_page + prt_header_height ()) * prt_line_height) + 0.5);
        bbox [3] = (int) (bottom + psettings -> chars_per_line * prt_char_width + 0.5);
    }
    prt_dsc_ints ("BoundingBox", 4, bbox);
    prt_dsc_docmedia (prt_mediasize [prt_media].name, prt_mediasize [prt_media].width, prt_mediasize [prt_media].height, (double) 0, ((void *) 0), ((void *) 0)
      );
    prt_dsc_font_resource ("DocumentNeededResources", &prt_ps_courier_font);
    if (!prt_find_resource("prolog",&res_prolog)) {
        emsg ((char_u *) (((char *) ("E456: Can't find PostScript resource file \"prolog.ps\""))));
        return 0;
    }
    if (!prt_open_resource(&res_prolog)) return 0;
    if (!prt_check_resource(&res_prolog, ((char_u *) "1.4"))) return 0;
    p_encoding = enc_skip (p_penc);
    if (*p_encoding == '\000' || !prt_find_resource((char*)p_encoding,&res_encoding)) {
        {
            p_encoding = (char_u *) "latin1";
            if (!prt_find_resource((char*)p_encoding,&res_encoding)) {
                emsg2 ((char_u *) (((char *) ("E456: Can't find PostScript resource file \"%s.ps\""))), (char_u *) (p_encoding));
                return 0;
            }
        }
    }
    if (!prt_open_resource(&res_encoding)) return 0;
    ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buffer), (char *) (res_prolog.title),
      __builtin_object_size ((char *) (buffer), 1 > 1)) : __inline_strcpy_chk ((char *) (buffer), (char *) (res_prolog.title)));
    ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buffer), (char *) (" "), __builtin_object_size ((char *
      ) (buffer), 1 > 1)) : __inline_strcat_chk ((char *) (buffer), (char *) (" ")));
    ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buffer), (char *) (res_prolog.version),
      __builtin_object_size ((char *) (buffer), 1 > 1)) : __inline_strcat_chk ((char *) (buffer), (char *) (res_prolog.version)));
    prt_dsc_resources ("DocumentSuppliedResources", "procset", buffer);
    {
        ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buffer), (char *) (res_encoding.title),
          __builtin_object_size ((char *) (buffer), 1 > 1)) : __inline_strcpy_chk ((char *) (buffer), (char *) (res_encoding.title)));
        ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buffer), (char *) (" "), __builtin_object_size ((
          char *) (buffer), 1 > 1)) : __inline_strcat_chk ((char *) (buffer), (char *) (" ")));
        ((__builtin_object_size ((char *) (buffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buffer), (char *) (res_encoding.version),
          __builtin_object_size ((char *) (buffer), 1 > 1)) : __inline_strcat_chk ((char *) (buffer), (char *) (res_encoding.version)));
        prt_dsc_resources (((void *) 0), "encoding", buffer);
    }
    prt_dsc_requirements (prt_duplex, prt_tumble, prt_collate, psettings -> do_syntax, prt_num_copies);
    ...
    if (!prt_add_resource(&res_prolog)) return 0;
    if (!prt_add_resource(&res_encoding)) return 0;
    ...
    prt_write_string ("c\n");
    prt_dsc_resources ("IncludeResource", "font", prt_ps_courier_font.ps_fontname [(0)]);
    prt_def_font ("F0", (char *) p_encoding, (int) prt_line_height, prt_ps_courier_font.ps_fontname [(0)]);
    prt_dsc_resources ("IncludeResource", "font", prt_ps_courier_font.ps_fontname [(1)]);
    prt_def_font ("F1", (char *) p_encoding, (int) prt_line_height, prt_ps_courier_font.ps_fontname [(1)]);
    prt_dsc_resources ("IncludeResource", "font", prt_ps_courier_font.ps_fontname [(2)]);
    prt_def_font ("F2", (char *) p_encoding, (int) prt_line_height, prt_ps_courier_font.ps_fontname [(2)]);
    prt_dsc_resources ("IncludeResource", "font", prt_ps_courier_font.ps_fontname [(3)]);
    prt_def_font ("F3", (char *) p_encoding, (int) prt_line_height, prt_ps_courier_font.ps_fontname [(3)]);
    ...
    prt_settings_T * psettings;
{
    ...
    if (!prt_file_error && psettings -> outfile == ((void *) 0) && !got_int && !psettings->user_abort) {
        if (prt_ps_fd != ((void *) 0)) {
            fclose (prt_ps_fd);
            prt_ps_fd = ((void *) 0);
        }
        prt_message ((char_u *) ((char *) ("Sending to printer...")));
        if (eval_printexpr (prt_ps_file_name, psettings -> arguments) == 0) emsg ((char_u *) (((char *) ("E365: Failed to print PostScript file"))));
        else prt_message ((char_u *) ((char *) ("Print job sent.")));
    }
    mch_print_cleanup ();
}
...
int mch_print_begin_page (str)
    char_u * str __attribute__ ((unused));
{
    int page_num [2];
    prt_page_num ++;
    ...
    int page_line;
{
    ...
    if (margin) prt_pos_x -= prt_number_width;
    prt_pos_y = prt_top_margin - prt_first_line_height - page_line * prt_line_height;
    ...
    int len __attribute__ ((unused));
{
    ...
    if (prt_attribute_change) {
        ...
        if (prt_bgcol != (long_u) 0xFFFFFFL) {
            prt_new_bgcol = prt_bgcol;
            if (prt_need_bgcol) prt_do_bgcol = 1;
        }
        else prt_do_bgcol = 0;
        prt_need_bgcol = 0;
        if (prt_need_underline) prt_do_underline = prt_underline;
        prt_need_underline = 0;
        prt_attribute_change = 0;
    }
    {
        ...
        if (ch < 32 || ch == '(' || ch == ')' || ch == '\\') {
            ...
            case '\\' :
                ...
                break;
            default :
                __builtin___sprintf_chk ((char *) ch_buff, 0, __builtin_object_size ((char *) ch_buff, 1 > 1), "%03o", (unsigned int) ch);
        ...
        else ga_append (&prt_ps_buffer, ch);
    }
    prt_text_run += char_width;
    prt_pos_x += char_width;
    next_pos = prt_pos_x + prt_char_width;
    need_break = (next_pos > prt_right_margin) && ((next_pos - prt_right_margin) > (prt_right_margin * 1e-5));
    if (need_break) prt_flush_buffer ();
    return need_break;
}

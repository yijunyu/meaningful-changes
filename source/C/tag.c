    ...
    int verbose;
{
    ...
    nofile_fname = ((void *) 0);
    {
        (&saved_fmark.mark) -> lnum = 0;
        (&saved_fmark.mark) -> col = 0;
        (&saved_fmark.mark) -> coladd = 0;
    };
    saved_fmark.fnum = 0;
    if ((!p_tgst && *tag != '\000')) {
        use_tagstack = 0;
        ...
        if (g_do_tagpreview) use_tagstack = 0;
        else use_tagstack = 1;
        if (*tag != '\000' && (type == 1 || type == 7 || type == 9 || type == 11)) {
            if (g_do_tagpreview) {
                if (ptag_entry.tagname != ((void *) 0) && strcmp ((char *) (ptag_entry.tagname), (char *) (tag)) == 0) {
                    cur_match = ptag_entry.cur_match;
                    cur_fnum = ptag_entry.cur_fnum;
                }
                else {
                    vim_free (ptag_entry.tagname);
                    if ((ptag_entry.tagname = vim_strsave (tag)) == ((void *) 0)) goto end_do_tag;
                }
            }
            else {
                while (tagstackidx < tagstacklen) vim_free (tagstack [--tagstacklen].tagname);
                if (++tagstacklen > 20) {
                    tagstacklen = 20;
                    vim_free (tagstack [0].tagname);
                    for (i = 1; i < tagstacklen; ++i) tagstack [i - 1] = tagstack [i];
                    --tagstackidx;
                }
                if ((tagstack [tagstackidx].tagname = vim_strsave (tag)) == ((void *) 0)) {
            ...
            if (g_do_tagpreview ? ptag_entry.tagname == ((void *) 0) : tagstacklen == 0) {
                emsg ((char_u *) (((char *) (e_tagstack))));
                goto end_do_tag;
            }
            if (type == 2) {
                int old_KeyTyped = KeyTyped;
                if ((tagstackidx -= count) < 0) {
                    emsg ((char_u *) (((char *) (bottommsg))));
                    if (tagstackidx + count == 0) {
                        tagstackidx = 0;
                        goto end_do_tag;
                    }
                    ...
                    emsg ((char_u *) (((char *) (topmsg))));
                    goto end_do_tag;
                }
                saved_fmark = tagstack [tagstackidx].fmark;
                if (saved_fmark.fnum != curbuf -> b_fnum) {
                    if (buflist_getfile (saved_fmark.fnum, saved_fmark.mark.lnum, 0x01, forceit) == 0) {
                ...
                check_cursor ();
                if ((fdo_flags & 0x080) && old_KeyTyped) foldOpenCursor ();
            ...
            if (type == 1 || type == 11) {
                ...
                if (g_do_tagpreview) {
                    ...
                    if (--tagstackidx < 0) tagstackidx = 0;
                    cur_match = tagstack [tagstackidx].cur_match;
                    cur_fnum = tagstack [tagstackidx].cur_fnum;
                }
                switch (type) {
                ...
                if (cur_match >= (0x7fffffffL)) cur_match = (0x7fffffffL) - 1;
                else if (cur_match < 0) {
                    emsg ((char_u *) (((char *) ("E425: Cannot go before first matching tag"))));
                    skip_msg = 1;
                    cur_match = 0;
    ...
    if (cur_fnum != curbuf -> b_fnum) {
        ...
        if (buf != ((void *) 0)) buf_ffname = buf -> b_ffname;
    }
    for (;;) {
        if (use_tagstack) name = tagstack [tagstackidx].tagname;
        else if (g_do_tagpreview) name = ptag_entry.tagname;
        else name = tag;
        other_name = (tagmatchname == ((void *) 0) || strcmp ((char *) (tagmatchname), (char *) (name)) != 0);
        if (new_tag || (cur_match >= num_matches && max_num_matches != (0x7fffffffL)) || other_name) {
            if (other_name) {
                vim_free (tagmatchname);
                tagmatchname = vim_strsave (name);
            }
            if (type == 1 && *tag != '\000' && count > 0) cur_match = count - 1;
            if (type == 7 || type == 9 || type == 11) cur_match = (0x7fffffffL) - 1;
            ...
            if (verbose) flags |= 32;
            if (find_tags (name, &new_num_matches, &new_matches, flags, max_num_matches, buf_ffname) == 1 && new_num_matches < max_num_matches) max_num_matches
              = (0x7fffffffL);
                ...
                for (j = 0; j < num_matches; ++j) {
                    ...
                    for (i = idx; i < new_num_matches; ++i) {
                        ...
                        if (strcmp ((char *) (tagp.tagname), (char *) (tagp2.tagname)) == 0) {
                            p = new_matches [i];
                            for (k = i; k > idx; --k) new_matches [k] = new_matches [k - 1];
                            new_matches [idx ++] = p;
                            break;
                        }
                    }
        ...
        if (num_matches <= 0) {
            if (verbose) emsg2 ((char_u *) (((char *) ("E426: tag not found: %s"))), (char_u *) (name));
            g_do_tagpreview = 0;
        }
        else {
            int ask_for_selection = 0;
            if (type == 7 || (type == 9 && num_matches > 1)) {
                parse_match (matches [0], &tagp);
                taglen = (int) (tagp.tagname_end - tagp.tagname + 2);
                if (taglen < 18) taglen = 18;
                if (taglen > Columns - 25) taglen = (0x7fffffffL);
                if (msg_col == 0) msg_didout = 0;
                msg_start ();
                msg_puts_attr ((char_u *) (((char *) ("  # pri kind tag"))), (highlight_attr [(int) (HLF_T)]));
                msg_clr_eos ();
                taglen_advance (taglen);
                msg_puts_attr ((char_u *) (((char *) ("file\n"))), (highlight_attr [(int) (HLF_T)]));
                for (i = 0; i < num_matches && !got_int; ++i) {
                    parse_match (matches [i], &tagp);
                    if (!new_tag && ((g_do_tagpreview && i == ptag_entry.cur_match) || (use_tagstack && i == tagstack [tagstackidx].cur_match))) *IObuff = '>';
                    else *IObuff = ' ';
                    vim_snprintf ((char *) IObuff + 1, (1024 + 1) - 1, "%2d %s ", i + 1, mt_names [matches [i] [0] & 7]);
                    msg_puts (IObuff);
                    if (tagp.tagkind != ((void *) 0)) msg_outtrans_len (tagp.tagkind, (int) (tagp.tagkind_end - tagp.tagkind));
                    msg_advance (13);
                    msg_outtrans_len_attr (tagp.tagname, (int) (tagp.tagname_end - tagp.tagname), highlight_attr [(int) (HLF_T)]);
                    msg_putchar (' ');
                    taglen_advance (taglen);
                    ...
                    if (command_end != ((void *) 0)) {
                        ...
                        while (*p && *p != '\r' && *p != '\n') {
                            while (*p == '\011') ++p;
                            if (strncmp ((char *) (p), (char *) ("file:"), (size_t) (5)) == 0 && vim_isspace (p [5])) {
                                p += 5;
                                continue;
                            }
                            if (p == tagp.tagkind || (p + 5 == tagp.tagkind && strncmp ((char *) (p), (char *) ("kind:"), (size_t) (5)) == 0)) {
                                p = tagp.tagkind_end;
                                continue;
                            }
                    ...
                    while (p != command_end && vim_isspace (*p)) ++p;
                    while (p != command_end) {
                        if (msg_col + (*p == '\011' ? 1 : ptr2cells (p)) > Columns) msg_putchar ('\n');
                        if (got_int) break;
                        msg_advance (15);
                        if (*p == '\\' && *(p+1) == *tagp.command) ++p;
                        if (*p == '\011') {
                            msg_putchar (' ');
                            ++p;
                        }
                        else p = msg_outtrans_one (p, 0);
                        if (p == command_end - 2 && *p == '$' && *(p+1) == *tagp.command) break;
                        if (p == command_end - 1 && *p == *tagp.command && (*p == '/' || *p == '?')) break;
                    }
                ...
                char_u cmd [1024 + 1];
                list = list_alloc ();
                if (list == ((void *) 0)) goto end_do_tag;
                for (i = 0; i < num_matches; ++i) {
                    ...
                    ((__builtin_object_size ((char *) (fname), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (fname), (char *) (p),
                      __builtin_object_size ((char *) (fname), 1 > 1)) : __inline_strcpy_chk ((char *) (fname), (char *) (p)));
                    vim_free (p);
                    lnum = 0;
                    if (isdigit (*tagp.command)) lnum = atol ((char *) tagp.command);
                    else {
                        ...
                        if (*cmd_end == '/' || *cmd_end == '?') cmd_end --;
                        len = 0;
                        cmd [0] = '\000';
                        if (*cmd_start == '^') {
                            ((__builtin_object_size ((char *) (cmd), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (cmd), (char *) ("^"),
                              __builtin_object_size ((char *) (cmd), 1 > 1)) : __inline_strcpy_chk ((char *) (cmd), (char *) ("^")));
                            cmd_start ++;
                            len ++;
                        }
                        ((__builtin_object_size ((char *) (cmd), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (cmd), (char *) ("\\V"),
                          __builtin_object_size ((char *) (cmd), 1 > 1)) : __inline_strcat_chk ((char *) (cmd), (char *) ("\\V")));
                        len += 2;
                        cmd_len = (int) (cmd_end - cmd_start + 1);
                        if (cmd_len > (1024 - 5)) cmd_len = 1024 - 5;
                        ((__builtin_object_size ((char *) (cmd), 0) != (size_t) - 1) ? __builtin___strncat_chk ((char *) (cmd), (char *) (cmd_start), (size_t) (
                          cmd_len), __builtin_object_size ((char *) (cmd), 1 > 1)) : __inline_strncat_chk ((char *) (cmd), (char *) (cmd_start), (size_t) (
                          cmd_len)));
                        len += cmd_len;
                        if (cmd [len - 1] == '$') {
                            cmd [len - 1] = '\\';
                    ...
                    if ((dict = dict_alloc ()) == ((void *) 0)) continue;
                    if (list_append_dict (list, dict) == 0) {
                        vim_free (dict);
                        continue;
                    }
                    ...
                    if (lnum == 0) dict_add_nr_str (dict, "pattern", 0L, cmd);
                }
            ...
            if (cur_match >= num_matches) {
                if ((type == 3 || type == 5) && nofile_fname == ((void *) 0)) {
                    if (num_matches == 1) emsg ((char_u *) (((char *) ("E427: There is only one matching tag"))));
                    else emsg ((char_u *) (((char *) ("E428: Cannot go beyond last matching tag"))));
                    skip_msg = 1;
                }
            ...
            if (nofile_fname != ((void *) 0) && error_cur_match != cur_match) smsg ((char_u *) ((char *) ("File \"%s\" does not exist")), nofile_fname);
            ic = (matches [cur_match] [0] & 4);
            if (type != 7 && type != 9 && (num_matches > 1 || ic) && !skip_msg) {
                __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("tag %d of %d%s")), cur_match + 1,
                  num_matches, max_num_matches != (0x7fffffffL) ? ((char *) (" or more")) : "");
                if (ic) ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (IObuff), (char *) (((char *) (
                  "  Using tag with different case!"))), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcat_chk ((char *) (IObuff), (char *) (
                  ((char *) ("  Using tag with different case!")))));
                if ((num_matches > prev_num_matches || new_tag) && num_matches > 1) {
                    if (ic) msg_attr (IObuff, highlight_attr [(int) (HLF_W)]);
                    else msg (IObuff);
                    msg_scroll = 1;
                }
                else give_warning (IObuff, ic);
            ...
            set_vim_var_string (47, IObuff, -1);
            i = jumpto_tag (matches [cur_match], forceit, type != 10);
            set_vim_var_string (47, ((void *) 0), -1);
            if (i == 99) {
                if ((type == 4 && cur_match > 0) || ((type == 1 || type == 3 || type == 5) && (max_num_matches != (0x7fffffffL) || cur_match < num_matches - 1)
                  )) {
                ...
                emsg2 ((char_u *) (((char *) ("E429: File \"%s\" does not exist"))), (char_u *) (nofile_fname));
            }
            else {
                if (use_tagstack && tagstackidx > curwin -> w_tagstacklen) tagstackidx = curwin -> w_tagstackidx;
            }
        }
        break;
    }
    end_do_tag : if (use_tagstack && tagstackidx <= curwin -> w_tagstacklen) curwin -> w_tagstackidx = tagstackidx;
    postponed_split = 0;
    return 0;
}
    ...
    exarg_T * eap __attribute__ ((unused));
{
    ...
    for (i = 0; i < tagstacklen; ++i) {
        if (tagstack [i].tagname != ((void *) 0)) {
            ...
            msg_putchar ('\n');
            __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), "%c%2d %2d %-15s %5ld  ", i == tagstackidx ? '>' : ' '
              , i + 1, tagstack [i].cur_match + 1, tagstack [i].tagname, tagstack [i].fmark.mark.lnum);
            msg_outtrans (IObuff);
            msg_outtrans_attr (name, tagstack [i].fmark.fnum == curbuf -> b_fnum ? highlight_attr [(int) (HLF_D)] : 0);
            vim_free (name);
        }
        out_flush ();
    }
    if (tagstackidx == tagstacklen) msg_puts ((char_u *) ("\n>"));
}
    ...
    size_t len;
{
    int i;
    while (len > 0) {
        i = (int) (((*s1) < 'a' || (*s1) > 'z') ? (*s1) : (*s1) - ('a' - 'A')) - (int) (((*s2) < 'a' || (*s2) > 'z') ? (*s2) : (*s2) - ('a' - 'A'));
        if (i != 0) return i;
        if (*s1 == '\000') break;
        ++s1;
        ++s2;
    ...
    int has_re;
{
    ...
    if (has_re) {
        if (pats -> pat [0] == '^') pats -> head = pats -> pat + 1;
        else if (pats -> pat [0] == '\\' && pats -> pat [1] == '<') pats -> head = pats -> pat + 2;
        if (pats -> head == pats -> pat) pats -> headlen = 0;
        else for (pats -> headlen = 0; pats -> head [pats -> headlen] != '\000'; ++pats->headlen) if (vim_strchr ((char_u *) (p_magic ? ".[~*\\$" : "\\$"), pats
          -> head [pats -> headlen]) != ((void *) 0)) break;
        if (p_tl != 0 && pats -> headlen > p_tl) pats -> headlen = p_tl;
    }
    if (has_re) pats -> regmatch.regprog = vim_regcomp (pats -> pat, p_magic ? 1 : 0);
    else pats -> regmatch.regprog = ((void *) 0);
}
    ...
    char_u * buf_ffname;
{
    ...
    pat_T * pats;
    pat_T orgpat;
    int findall = (mincount == (0x7fffffffL) || mincount == 300);
    int sort_error = 0;
    int linear;
    int sortic = 0;
    int line_error = 0;
    ...
    pats = &orgpat;
    lbuf = alloc (512);
    tag_fname = alloc (1024 + 1);
    for (mtt = 0; mtt < 16; ++mtt) ga_init2 (&ga_match[mtt], (int) sizeof (struct match_found *), 100);
    if (lbuf == ((void *) 0) || tag_fname == ((void *) 0)) goto findtag_end;
    if (help_only) curbuf -> b_help = 1;
    pats -> len = (int) strlen ((char *) (pat));
    if (curbuf -> b_help) {
        if (pats -> len > 3 && pat [pats -> len - 3] == '@' && ((pat [pats -> len - 2]) < 0x7f && isalpha (pat [pats -> len - 2])) && ((pat [pats -> len - 1]) <
          0x7f && isalpha (pat [pats -> len - 1]))) {
    ...
    if (p_tl != 0 && pats -> len > p_tl) pats -> len = p_tl;
    prepare_pats (pats, has_re);
    ((__builtin_object_size ((&search_info), 0) != (size_t) - 1) ? __builtin___memset_chk ((&search_info), (0), ((size_t) 1), __builtin_object_size 
      ((&search_info), 0)) : __inline_memset_chk ((&search_info), (0), ((size_t) 1)));
    pats -> regmatch.rm_ic = ((p_ic || !noic) && (findall || pats -> headlen == 0 || !p_tbs));
    for (round = 1; round <= 2; ++round) {
        linear = (pats -> headlen == 0 || !p_tbs || round == 2);
        for (first_file = 1; get_tagfname (&tn, first_file, tag_fname) == 1; first_file = 0) {
            {
                if (curbuf -> b_help) {
                    i = (int) strlen ((char *) (tag_fname));
                    if (i > 3 && tag_fname [i - 3] == '-') ((__builtin_object_size ((char *) (help_lang), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *
                      ) (help_lang), (char *) (tag_fname + i - 2), __builtin_object_size ((char *) (help_lang), 1 > 1)) : __inline_strcpy_chk ((char *) (
                      help_lang), (char *) (tag_fname + i - 2)));
                    else ((__builtin_object_size ((char *) (help_lang), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (help_lang), (char *) ("en"),
                      __builtin_object_size ((char *) (help_lang), 1 > 1)) : __inline_strcpy_chk ((char *) (help_lang), (char *) ("en")));
                    if (help_lang_find != ((void *) 0) && strcasecmp ((char *) (help_lang), (char *) (help_lang_find)) != 0) continue;
                    if ((flags & 128) && help_lang_find == ((void *) 0) && curbuf -> b_fname != ((void *) 0) && (i = (int) strlen ((char *) (curbuf -> b_fname)
                      )) > 4 && curbuf -> b_fname [i - 1] == 'x' && curbuf -> b_fname [i - 4] == '.' && strncasecmp ((char *) (curbuf -> b_fname + i - 3), (
                      char *) (help_lang), (size_t) (2)) == 0) help_pri = 0;
                    else {
                        help_pri = 1;
                        for (s = p_hlg; *s != '\000'; ++s) {
                            if (strncasecmp ((char *) (s), (char *) (help_lang), (size_t) (2)) == 0) break;
                            ++help_pri;
                            if ((s = vim_strchr (s, ',')) == ((void *) 0)) break;
                        }
                        if (s == ((void *) 0) || *s == '\000') {
                            ++help_pri;
                            if (strcasecmp ((char *) (help_lang), (char *) ("en")) != 0) ++help_pri;
                        }
                    }
                }
                if ((fp = fopen (((char *) tag_fname), ("r"))) == ((void *) 0)) continue;
                if (p_verbose >= 5) {
                    verbose_enter ();
                    smsg ((char_u *) ((char *) ("Searching tags file %s")), tag_fname);
                    verbose_leave ();
                }
            }
            did_open = 1;
            ...
            for (;;) {
                line_breakcheck ();
                if ((flags & 64)) ins_compl_check_keys (30);
                ...
                if (get_it_again) goto line_read_in;
                if (state == TS_BINARY) {
                    offset = search_info.low_offset + ((search_info.high_offset - search_info.low_offset) / 2);
                    if (offset == search_info.curr_offset) break;
                    else search_info.curr_offset = offset;
                }
                ...
                line_read_in : if (state == TS_START) {
                    if (linear) state = TS_LINEAR;
                    else if (strncmp ((char *) (lbuf), (char *) ("!_TAG_"), (size_t) (6)) > 0) state = TS_BINARY;
                    else if (strncmp ((char *) (lbuf), (char *) ("!_TAG_FILE_SORTED\t"), (size_t) (18)) == 0) {
                        if (lbuf [18] == '1') state = TS_BINARY;
                        else if (lbuf [18] == '2') {
                            state = TS_BINARY;
                            sortic = 1;
                            pats -> regmatch.rm_ic = (p_ic || !noic);
                        }
                        else state = TS_LINEAR;
                    }
                    ...
                    if (state == TS_BINARY) {
                        if ((filesize = lseek (fileno (fp), (off_t) 0L, 2)) <= 0) state = TS_LINEAR;
                        else {
                ...
                if (pats -> headlen) {
                    ...
                    for (p = lbuf; p < tagp.tagname_end; ++p) {
                        if (*p == ':') {
                            if (tagp.fname == ((void *) 0)) tagp.fname = tagp.tagname_end + 1;
                            if (strncasecmp ((char *) (((lbuf))), (char *) (((tagp.fname))), (size_t) (((p - lbuf)))) == 0 && tagp.fname [p - lbuf] == '\011') {
                                tagp.tagname = p + 1;
                                break;
                            }
                        }
                    ...
                    if (p_tl != 0 && cmplen > p_tl) cmplen = p_tl;
                    if (has_re && pats -> headlen < cmplen) cmplen = pats -> headlen;
                    else if (state == TS_LINEAR && pats -> headlen != cmplen) continue;
                    if (state == TS_BINARY) {
                        i = (int) tagp.tagname [0];
                        if (sortic) i = (int) (((tagp.tagname [0]) < 'a' || (tagp.tagname [0]) > 'z') ? (tagp.tagname [0]) : (tagp.tagname [0]) - ('a' - 'A'));
                        if (i < search_info.low_char || i > search_info.high_char) sort_error = 1;
                        if (sortic) tagcmp = tag_strnicmp (tagp.tagname, pats -> head, (size_t) cmplen);
                        else tagcmp = strncmp ((char *) (tagp.tagname), (char *) (pats -> head), (size_t) (cmplen));
                        if (tagcmp == 0) {
                            if (cmplen < pats -> headlen) tagcmp = -1;
                            else if (cmplen > pats -> headlen) tagcmp = 1;
                        }
                        if (tagcmp == 0) {
                            state = TS_SKIP_BACK;
                        ...
                        if (tagcmp < 0) {
                            ...
                            if (search_info.curr_offset < search_info.high_offset) {
                                ...
                                if (sortic) search_info.low_char = (((tagp.tagname [0]) < 'a' || (tagp.tagname [0]) > 'z') ? (tagp.tagname [0]) : (tagp.tagname
                                  [0]) - ('a' - 'A'));
                                else search_info.low_char = tagp.tagname [0];
                                continue;
                            }
                        }
                        if (tagcmp > 0 && search_info.curr_offset != search_info.high_offset) {
                            search_info.high_offset = search_info.curr_offset;
                            if (sortic) search_info.high_char = (((tagp.tagname [0]) < 'a' || (tagp.tagname [0]) > 'z') ? (tagp.tagname [0]) : (tagp.tagname [0
                              ]) - ('a' - 'A'));
                            else search_info.high_char = tagp.tagname [0];
                            continue;
                        }
                        break;
                    }
                    else if (state == TS_SKIP_BACK) {
                        if (strncasecmp ((char *) ((tagp.tagname)), (char *) ((pats -> head)), (size_t) ((cmplen))) != 0) state = TS_STEP_FORWARD;
                        else search_info.curr_offset = search_info.curr_offset_used;
                        continue;
                    }
                    else if (state == TS_STEP_FORWARD) {
                        if (strncasecmp ((char *) ((tagp.tagname)), (char *) ((pats -> head)), (size_t) ((cmplen))) != 0) {
                            if ((off_t) ftello (fp) > search_info.match_offset) break;
                            else continue;
                        }
                    }
                    else if (strncasecmp ((char *) ((tagp.tagname)), (char *) ((pats -> head)), (size_t) ((cmplen))) != 0) continue;
                    if (tagp.fname == ((void *) 0)) tagp.fname = tagp.tagname_end + 1;
                    tagp.fname_end = vim_strchr (tagp.fname, '\011');
                    tagp.command = tagp.fname_end + 1;
                    if (tagp.fname_end == ((void *) 0)) i = 0;
                    else i = 1;
                }
                else i = parse_tag_line (lbuf, &tagp);
                if (i == 0) {
                    line_error = 1;
                    break;
                }
                cmplen = (int) (tagp.tagname_end - tagp.tagname);
                if (p_tl != 0 && cmplen > p_tl) cmplen = p_tl;
                if (pats -> len != cmplen) match = 0;
                else {
                    if (pats -> regmatch.rm_ic) {
                        match = (strncasecmp ((char *) ((tagp.tagname)), (char *) ((pats -> pat)), (size_t) ((cmplen))) == 0);
                        if (match) match_no_ic = (strncmp ((char *) (tagp.tagname), (char *) (pats -> pat), (size_t) (cmplen)) == 0);
                    }
                    else match = (strncmp ((char *) (tagp.tagname), (char *) (pats -> pat), (size_t) (cmplen)) == 0);
                }
                match_re = 0;
                if (!match && pats -> regmatch.regprog != ((void *) 0)) {
                    int cc;
                    cc = *tagp.tagname_end;
                    *tagp.tagname_end = '\000';
                    ...
                    if (match) {
                        ...
                        if (pats -> regmatch.rm_ic) {
                            pats -> regmatch.rm_ic = 0;
                            match_no_ic = vim_regexec (&pats->regmatch, tagp.tagname, (colnr_T) 0);
                            pats -> regmatch.rm_ic = 1;
                        }
                    }
                    *tagp.tagname_end = cc;
                    match_re = 1;
                ...
                if (match) {
                    {
                        ...
                        {
                            if (tagp.tagname != lbuf) is_static = 1;
                            else is_static = test_for_static (&tagp);
                        }
                        if (is_static) {
                            if (is_current) mtt = 0;
                            else mtt = 3;
                        ...
                        if (pats -> regmatch.rm_ic && !match_no_ic) mtt += 4;
                        if (match_re) mtt += 8;
                    }
                    if (ga_grow (&ga_match[mtt], 1) == 1) {
                        if (help_only) {
                            *tagp.tagname_end = '\000';
                            len = (int) (tagp.tagname_end - tagp.tagname);
                            mfp = (struct match_found *) alloc ((int) sizeof (struct match_found) +len + 10 + 3);
                            if (mfp != ((void *) 0)) {
                                mfp -> len = len + 3 + 1;
                                p = mfp -> match;
                                ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (p), (char *) (tagp.tagname),
                                  __builtin_object_size ((char *) (p), 1 > 1)) : __inline_strcpy_chk ((char *) (p), (char *) (tagp.tagname)));
                                p [len] = '@';
                                ((__builtin_object_size ((char *) (p + len + 1), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (p + len + 1), (char *)
                                  (help_lang), __builtin_object_size ((char *) (p + len + 1), 1 > 1)) : __inline_strcpy_chk ((char *) (p + len + 1), (char *) (
                                  help_lang)));
                                __builtin___sprintf_chk ((char *) p + len + 1 + 3, 0, __builtin_object_size ((char *) p + len + 1 + 3, 1 > 1), "%06d",
                                  help_heuristic (tagp.tagname, match_re ? matchoff : 0, !match_no_ic) + help_pri);
                            }
                            *tagp.tagname_end = '\011';
                            ...
                            if (get_it_again) {
                                ...
                                if (*temp_end == '/') while (*temp_end && *temp_end != '\r' && *temp_end != '\n' && *temp_end != '$') temp_end ++;
                                if (tagp.command + 2 < temp_end) {
                                    len = (int) (temp_end - tagp.command - 2);
                                    mfp = (struct match_found *) alloc ((int) sizeof (struct match_found) +len);
                                    if (mfp != ((void *) 0)) {
                                        mfp -> len = len + 1;
                                        p = mfp -> match;
                                ...
                                if (State & 0x10) get_it_again = p_sft;
                            }
                        }
                        else {
                            len = (int) strlen ((char *) (tag_fname)) + (int) strlen ((char *) (lbuf)) + 3;
                            mfp = (struct match_found *) alloc ((int) sizeof (struct match_found) +len);
                            if (mfp != ((void *) 0)) {
                                mfp -> len = len;
                                p = mfp -> match;
                                p [0] = mtt;
                                ((__builtin_object_size ((char *) (p + 1), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (p + 1), (char *) (tag_fname)
                                  , __builtin_object_size ((char *) (p + 1), 1 > 1)) : __inline_strcpy_chk ((char *) (p + 1), (char *) (tag_fname)));
                                s = p + 1 + strlen ((char *) (tag_fname)) + 1;
                                ((__builtin_object_size ((char *) (s), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (s), (char *) (lbuf),
                                  __builtin_object_size ((char *) (s), 1 > 1)) : __inline_strcpy_chk ((char *) (s), (char *) (lbuf)));
                            }
                        }
                        if (mfp != ((void *) 0)) {
                            for (i = ga_match [mtt].ga_len; --i >= 0 && !got_int;) {
                                mfp2 = ((struct match_found * *) (ga_match [mtt].ga_data)) [i];
                                if (mfp2 -> len == mfp -> len && memcmp ((mfp2 -> match), (mfp -> match), ((size_t) mfp -> len)) == 0) break;
                                line_breakcheck ();
                            }
                            if (i < 0) {
                                ((struct match_found * *) (ga_match [mtt].ga_data)) [ga_match [mtt].ga_len ++] = mfp;
                                ++match_count;
                            }
                            else vim_free (mfp);
                        }
            ...
            if (line_error) {
                emsg2 ((char_u *) (((char *) ("E431: Format error in tags file \"%s\""))), (char_u *) (tag_fname));
                emsgn ((char_u *) (((char *) ("Before byte %ld"))), (long) ((long) ftello (fp)));
                stop_searching = 1;
                line_error = 0;
            }
            fclose (fp);
            if (sort_error) {
                emsg2 ((char_u *) (((char *) ("E432: Tags file not sorted: %s"))), (char_u *) (tag_fname));
                sort_error = 0;
            }
        ...
        tagname_free (&tn);
        if (stop_searching || linear || (!p_ic && noic) || pats -> regmatch.rm_ic) break;
        pats -> regmatch.rm_ic = 1;
    }
    if (!stop_searching) {
        if (!did_open && verbose) emsg ((char_u *) (((char *) ("E433: No tags file"))));
        retval = 1;
    }
    findtag_end : vim_free (lbuf);
    vim_free (pats -> regmatch.regprog);
    vim_free (tag_fname);
    if (retval == 0) match_count = 0;
    if (match_count > 0) matches = (char_u * *) lalloc ((long_u) (match_count * sizeof (char_u *)), 1);
    else matches = ((void *) 0);
    match_count = 0;
    for (mtt = 0; mtt < 16; ++mtt) {
        for (i = 0; i < ga_match [mtt].ga_len; ++i) {
            mfp = ((struct match_found * *) (ga_match [mtt].ga_data)) [i];
            if (matches == ((void *) 0)) vim_free (mfp);
            else {
                ((__builtin_object_size ((char *) (mfp), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (mfp), (char *) (mfp -> match), (size_t) (mfp
                  -> len + (help_only ? 6 : 0)), __builtin_object_size ((char *) (mfp), 0)) : __inline_memmove_chk ((char *) (mfp), (char *) (mfp -> match), (
                  size_t) (mfp -> len + (help_only ? 6 : 0))));
...
{
    if (ga_grow (&tag_fnames, 1) == 1) ((char_u * *) (tag_fnames.ga_data)) [tag_fnames.ga_len ++] = vim_strsave (fname);
}
    ...
    char_u * buf;
{
    char_u * fname = ((void *) 0);
    char_u * r_ptr;
    if (first) ((__builtin_object_size ((tnp), 0) != (size_t) - 1) ? __builtin___memset_chk ((tnp), (0), (sizeof (tagname_T)), __builtin_object_size ((tnp), 0)
      ) : __inline_memset_chk ((tnp), (0), (sizeof (tagname_T))));
    if (curbuf -> b_help) {
        if (first) {
            ga_clear_strings (&tag_fnames);
            ga_init2 (&tag_fnames, (int) sizeof (char_u *), 10);
            do_in_runtimepath ((char_u *) "doc/tags doc/tags-??", 1, found_tagfile_cb, ((void *) 0));
        }
        if (tnp -> tn_hf_idx >= tag_fnames.ga_len) {
            if (tnp -> tn_hf_idx > tag_fnames.ga_len || *p_hf == '\000') return 0;
            ++tnp->tn_hf_idx;
            ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buf), (char *) (p_hf), __builtin_object_size ((
              char *) (buf), 1 > 1)) : __inline_strcpy_chk ((char *) (buf), (char *) (p_hf)));
            ((__builtin_object_size ((char *) (gettail (buf)), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (gettail (buf)), (char *) ("tags"),
              __builtin_object_size ((char *) (gettail (buf)), 1 > 1)) : __inline_strcpy_chk ((char *) (gettail (buf)), (char *) ("tags")));
        }
        else vim_strncpy (buf, ((char_u * *) (tag_fnames.ga_data)) [tnp -> tn_hf_idx ++], 1024 - 1);
        return 1;
    }
    if (first) {
        tnp -> tn_tags = vim_strsave ((*curbuf->b_p_tags != '\000') ? curbuf -> b_p_tags : p_tags);
        if (tnp -> tn_tags == ((void *) 0)) return 0;
    ...
    for (;;) {
        if (tnp -> tn_did_filefind_init) {
            ...
            ((__builtin_object_size ((char *) ((filename + 1)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((filename + 1)), (char *) ((filename))
              , strlen ((char *) (filename)) + 1, __builtin_object_size ((char *) ((filename + 1)), 0)) : __inline_memmove_chk ((char *) ((filename + 1)), (
              char *) ((filename)), strlen ((char *) (filename)) + 1));
            *filename++ = '\000';
            tnp -> tn_search_ctx = vim_findfile_init (buf, filename, r_ptr, 100, 0, 0, tnp -> tn_search_ctx, 1, curbuf -> b_ffname);
            if (tnp -> tn_search_ctx != ((void *) 0)) tnp -> tn_did_filefind_init = 1;
        }
    }
    ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buf), (char *) (fname), __builtin_object_size ((char *) (
      buf), 1 > 1)) : __inline_strcpy_chk ((char *) (buf), (char *) (fname)));
    vim_free (fname);
    return 1;
}
...
static int parse_tag_line (lbuf, tagp)
    char_u * lbuf;
    tagptrs_T * tagp;
{
    char_u * p;
    ...
    tagptrs_T * tagp;
{
    ...
    p = tagp -> tagname + len;
    if (p < tagp -> tagname_end && *p == ':' && strncasecmp ((char *) (((tagp -> tagname))), (char *) (((tagp -> fname))), (size_t) (((len)))) == 0) {
        tagp -> tagname = p + 1;
        return 1;
    }
    p = tagp -> command;
    while ((p = vim_strchr (p, '\t')) != ((void *) 0)) {
        ++p;
        if (strncmp ((char *) (p), (char *) ("file:"), (size_t) (5)) == 0) return 1;
    }
    return 0;
}
    ...
    tagptrs_T * tagp;
{
    ...
    if (retval == 1) {
        ...
        if (find_extra (&p) == 1) {
            tagp -> command_end = p;
            p += 2;
            if (*p++ == '\011') while (((*p) < 0x7f && isalpha (*p))) {
    ...
    int keep_help;
{
    ...
    int old_KeyTyped = KeyTyped;
    pbuf = alloc (512);
    if (pbuf == ((void *) 0) || parse_match (lbuf, &tagp) == 0) {
    ...
    * pbuf_end = '\000';
    ...
    if (fname == ((void *) 0)) goto erret;
    tofree_fname = fname;
    if (mch_getperm (fname) < 0 && !has_autocmd(EVENT_BUFREADCMD,fname,((void*)0))) {
        retval = 99;
        vim_free (nofile_fname);
        nofile_fname = vim_strsave (fname);
        if (nofile_fname == ((void *) 0)) nofile_fname = empty_option;
        goto erret;
    }
    ++RedrawingDisabled;
    if (g_do_tagpreview) {
    ...
    if (keep_help) {
        if (g_do_tagpreview) keep_help_flag = curwin_save -> w_buffer -> b_help;
        else keep_help_flag = curbuf -> b_help;
    }
    ...
    if (getfile_result <= 0) {
        ...
        if (vim_strchr (p_cpo, 't') != ((void *) 0)) search_options = 0;
        else search_options = 0x400;
        str = pbuf;
        if (pbuf [0] == '/' || pbuf [0] == '?') str = skip_regexp (pbuf + 1, pbuf [0], 0, ((void *) 0)) + 1;
        if (str > pbuf_end - 1) {
            save_p_ws = p_ws;
            save_p_ic = p_ic;
            save_p_scs = p_scs;
            ...
            if (do_search (((void *) 0), pbuf [0], pbuf + 1, (long) 1, search_options, ((void *) 0))) retval = 1;
            else {
                int found = 1;
                int cc;
                p_ic = 1;
                if (!do_search(((void*)0),pbuf[0],pbuf+1,(long)1,search_options,((void*)0))) {
                    found = 2;
                    (void) test_for_static (&tagp);
                    cc = *tagp.tagname_end;
                    *tagp.tagname_end = '\000';
                    __builtin___sprintf_chk ((char *) pbuf, 0, __builtin_object_size ((char *) pbuf, 1 > 1), "^%s\\s\\*(", tagp.tagname);
                    if (!do_search(((void*)0),'/',pbuf,(long)1,search_options,((void*)0))) {
                        __builtin___sprintf_chk ((char *) pbuf, 0, __builtin_object_size ((char *) pbuf, 1 > 1), "^\\[#a-zA-Z_]\\.\\*\\<%s\\s\\*(", tagp.
                          tagname);
                        if (!do_search(((void*)0),'/',pbuf,(long)1,search_options,((void*)0))) found = 0;
                    }
                    *tagp.tagname_end = cc;
                }
                if (found == 0) {
                    emsg ((char_u *) (((char *) ("E434: Can't find tag pattern"))));
                    curwin -> w_cursor.lnum = save_lnum;
                }
                else {
                    if (found == 2 || !save_p_ic) {
                        msg ((char_u *) (((char *) ("E435: Couldn't find tag, just guessing!"))));
        ...
        if (secure == 2) wait_return (1);
        secure = save_secure;
        p_magic = save_magic;
        --sandbox;
        if (search_options) no_hlsearch = save_no_hlsearch;
        if (getfile_result == -1) retval = 1;
        if (retval == 1) {
            if (curbuf -> b_help) set_topline (curwin, curwin -> w_cursor.lnum);
            if ((fdo_flags & 0x080) && old_KeyTyped) foldOpenCursor ();
        }
    ...
    erret : g_do_tagpreview = 0;
    if (tagp.fname_end != ((void *) 0)) *tagp.fname_end = csave;
    vim_free (pbuf);
    ...
    int expand;
{
    ...
    if (expand && mch_has_wildcard (fname)) {
        ExpandInit (&xpc);
        xpc.xp_context = 2;
        expanded_fname = ExpandOne (&xpc, (char_u *) fname, ((void *) 0), 1 | 64, 2);
        if (expanded_fname != ((void *) 0)) fname = expanded_fname;
    }
    if ((p_tr || curbuf -> b_help) && !vim_isAbsName(fname) && (p = gettail (tag_fname)) != tag_fname) {
        retval = alloc (1024);
        if (retval != ((void *) 0)) {
            ((__builtin_object_size ((char *) (retval), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (retval), (char *) (tag_fname),
              __builtin_object_size ((char *) (retval), 1 > 1)) : __inline_strcpy_chk ((char *) (retval), (char *) (tag_fname)));
            vim_strncpy (retval + (p - tag_fname), fname, 1024 - (p - tag_fname) - 1);
            simplify_filename (retval);
        }
    }
    else retval = vim_strsave (fname);
    ...
    char_u * filename;
{
    ...
    start = p;
    do {
        if (vim_ispathsep (*p)) ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((p + 1)),
          strlen ((char *) (p + 1)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((char *
          ) (p + 1)) + 1));
        else if (p [0] == '.' && (vim_ispathsep (p [1]) || p [1] == '\000')) {
            if (p == start && relative) p += 1 + (p [1] != '\000');
            else {
                tail = p + 1;
                if (p [1] != '\000') while (vim_ispathsep (*tail)) ++tail;
                else if (p > start) --p;
                ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((tail)), strlen ((char *) (
                  tail)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((tail)), strlen ((char *) (tail)) + 1
                  ));
            }
        }
        else if (p [0] == '.' && p [1] == '.' && (vim_ispathsep (p [2]) || p [2] == '\000')) {
            tail = p + 2;
            while (vim_ispathsep (*tail)) ++tail;
            if (components > 0) {
                int do_strip = 0;
                char_u saved_char;
                struct stat st;
                if (!stripping_disabled) {
                    saved_char = p [-1];
                    p [-1] = '\000';
                    if (lstat (((char *) filename), (&st)) < 0) do_strip = 1;
                    p [-1] = saved_char;
                    --p;
                    while (p > start && !vim_ispathsep(*((p)-1))) --p;
                    if (!do_strip) {
                        saved_char = *tail;
                        * tail = '\000';
                        if (stat (((char *) filename), (&st)) >= 0) do_strip = 1;
                        else stripping_disabled = 1;
                        * tail = saved_char;
                        if (do_strip) {
                            struct stat new_st;
                            if (p == start && relative) (void) stat (("."), (&new_st));
                            else {
                                saved_char = *p;
                                * p = '\000';
                ...
                if (!do_strip) {
                    ...
                    if (p == start && relative && tail [-1] == '.') {
                        ...
                        * p = '\000';
                        ...
                        if (p > start && tail [-1] == '.') --p;
                        ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((tail)), strlen ((
                          char *) (tail)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((tail)), strlen ((
                          char *) (tail)) + 1));
                    }
                    --components;
                }
            }
            else if (p == start && !relative) ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) (
              (tail)), strlen ((char *) (tail)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((tail)),
              strlen ((char *) (tail)) + 1));
            else {
                if (p == start + 2 && p [-2] == '.') {
                    ((__builtin_object_size ((char *) ((p - 2)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p - 2)), (char *) ((p)), strlen ((
                      char *) (p)) + 1, __builtin_object_size ((char *) ((p - 2)), 0)) : __inline_memmove_chk ((char *) ((p - 2)), (char *) ((p)), strlen ((
                      char *) (p)) + 1));
                    tail -= 2;
                }
                p = tail;
    ...
    char_u * buf_ffname;
{
    ...
    if (buf_ffname != ((void *) 0)) {
        ...
        if (fullname != ((void *) 0)) {
            retval = (fullpathcmp (fullname, buf_ffname, 1) & 1);
            vim_free (fullname);
        }
        * fname_end = c;
    }
    ...
    char_u * * pp;
{
    char_u * str = *pp;
    for (;;) {
        if (((*str) >= '0' && (*str) <= '9')) str = skipdigits (str);
        else if (*str == '/' || *str == '?') {
            str = skip_regexp (str + 1, *str, 0, ((void *) 0));
            if (*str != **pp) str = ((void *) 0);
            else ++str;
        }
        else str = ((void *) 0);
        if (str == ((void *) 0) || *str != ';' || !(((str[1])>='0'&&(str[1])<='9')||str[1]=='/'||str[1]=='?')) break;
        ++str;
    }
    ...
    char_u * * * file;
{
    ...
    tagptrs_T t_p;
    int ret;
    if (tagnames) tagnmflag = 2;
    else tagnmflag = 0;
    if (pat [0] == '/') ret = find_tags (pat + 1, num_file, file, 4 | tagnmflag | 32, 300, curbuf -> b_ffname);
    else ret = find_tags (pat, num_file, file, 4 | tagnmflag | 32 | 8, 300, curbuf -> b_ffname);
    if (ret == 1 && !tagnames) {
        for (i = 0; i < *num_file; i ++) {
            parse_match ((*file) [i], &t_p);
            c = (int) (t_p.tagname_end - t_p.tagname);
            ((__builtin_object_size ((char *) (tagnm), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (tagnm), (char *) (t_p.tagname), (size_t) c,
              __builtin_object_size ((char *) (tagnm), 0)) : __inline_memmove_chk ((char *) (tagnm), (char *) (t_p.tagname), (size_t) c));
            tagnm [c ++] = 0;
            tagnm [c ++] = (t_p.tagkind != ((void *) 0) && *t_p.tagkind) ? *t_p.tagkind : 'f';
            tagnm [c ++] = 0;
            ((__builtin_object_size ((char *) ((*file) [i] + c), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((*file) [i] + c), (char *) (t_p.fname
              ), t_p.fname_end - t_p.fname, __builtin_object_size ((char *) ((*file) [i] + c), 0)) : __inline_memmove_chk ((char *) ((*file) [i] + c), (char *)
              (t_p.fname), t_p.fname_end - t_p.fname));
            (* file) [i] [c + (t_p.fname_end - t_p.fname)] = 0;
            ((__builtin_object_size ((char *) ((*file) [i]), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((*file) [i]), (char *) (tagnm), (size_t) c
              , __builtin_object_size ((char *) ((*file) [i]), 0)) : __inline_memmove_chk ((char *) ((*file) [i]), (char *) (tagnm), (size_t) c));
        }
    }
    return ret;
}
    ...
    char_u * end;
{
    ...
    if (dict_find (dict, (char_u *) field_name, -1) != ((void *) 0)) {
        if (p_verbose > 0) {
            verbose_enter ();
            smsg ((char_u *) ((char *) ("Duplicate field name: %s")), field_name);
            verbose_leave ();
        }
        return 0;
    }
    ...
    char_u * pat;
{
    ...
    tagptrs_T tp;
    long is_static;
    ret = find_tags (pat, &num_matches, &matches, 4 | 8, (int) (0x7fffffffL), ((void *) 0));
    if (ret == 1 && num_matches > 0) {
        for (i = 0; i < num_matches; ++i) {
            parse_match (matches [i], &tp);
            is_static = test_for_static (&tp);
            if (strncmp ((char *) (tp.tagname), (char *) ("!_TAG_"), (size_t) (6)) == 0) continue;
            if ((dict = dict_alloc ()) == ((void *) 0)) ret = 0;
            if (list_append_dict (list, dict) == 0) ret = 0;
            full_fname = tag_full_fname (&tp);
            if (add_tag_field (dict, "name", tp.tagname, tp.tagname_end) == 0 || add_tag_field (dict, "filename", full_fname, ((void *) 0)) == 0 ||
              add_tag_field (dict, "cmd", tp.command, tp.command_end) == 0 || add_tag_field (dict, "kind", tp.tagkind, tp.tagkind_end) == 0 || dict_add_nr_str (
              dict, "static", is_static, ((void *) 0)) == 0) ret = 0;
            vim_free (full_fname);
            if (tp.command_end != ((void *) 0)) {
                for (p = tp.command_end + 3; *p != '\000' && *p != '\n' && *p != '\r'; ++p) {
                    if (p == tp.tagkind || (p + 5 == tp.tagkind && strncmp ((char *) (p), (char *) ("kind:"), (size_t) (5)) == 0)) p = tp.tagkind_end - 1;
                    else if (strncmp ((char *) (p), (char *) ("file:"), (size_t) (5)) == 0) p += 4;
                    else if (!((*p) == ' ' || (*p) == '\t')) {
                        char_u * s, * n;
                        int len;
                        n = p;
                        while (*p != '\000' && *p >= ' ' && *p < 127 && *p != ':') ++p;
                        len = (int) (p - n);
                        if (*p == ':' && len > 0) {
                            s = ++p;
                            while (*p != '\000' && *p >= ' ') ++p;
                            n [len] = '\000';
                            if (add_tag_field (dict, (char *) n, s, p) == 0) ret = 0;
                            n [len] = ':';
                        }
                        else while (*p != '\000' && *p >= ' ') ++p;
                        if (*p == '\000') break;
                    }
                }
            }

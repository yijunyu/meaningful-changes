...
static garray_T ucmds =
{0, 0, sizeof (ucmd_T), 4, ((void *) 0)};
...
{CMD_append, CMD_buffer, CMD_change, CMD_delete, CMD_edit, CMD_file, CMD_global, CMD_help, CMD_insert, CMD_join, CMD_k, CMD_list, CMD_move, CMD_next, CMD_open,
      CMD_print, CMD_quit, CMD_read, CMD_substitute, CMD_t, CMD_undo, CMD_vglobal, CMD_write, CMD_xit, CMD_yank, CMD_z, CMD_bang};
static char_u dollar_command [2] =
{'$', 0};
typedef struct {
    char_u * line;
    linenr_T lnum;
    ...
    int improved;
{
    ...
    linenr_T prev_line;
    int changedtick;
    if (improved) exmode_active = 2;
    else exmode_active = 1;
    State = 0x01;
    if (global_busy) return;
    ...
    while (exmode_active) {
        ...
        else do_cmdline (((void *) 0), getexmodeline, ((void *) 0), 0x02);
        lines_left = Rows - 1;
        if ((prev_line != curwin -> w_cursor.lnum || changedtick != curbuf -> b_changedtick) && !ex_no_reprint) {
            if (curbuf -> b_ml.ml_flags & 1) emsg ((char_u *) (((char *) (e_emptybuf))));
            else {
                if (ex_pressedreturn) {
                    msg_row = prev_msg_row;
                    if (prev_msg_row == Rows - 1) msg_row --;
                }
                msg_col = 0;
            ...
            if (curbuf -> b_ml.ml_flags & 1) emsg ((char_u *) (((char *) (e_emptybuf))));
            else emsg ((char_u *) (((char *) ("E501: At end-of-file"))));
        }
    }
    --RedrawingDisabled;
    --no_wait_return;
...
int do_cmdline_cmd (cmd)
    char_u * cmd;
{
    return do_cmdline (cmd, ((void *) 0), ((void *) 0), 0x01 | 0x02 | 0x08);
}

int do_cmdline (cmdline, getline, cookie, flags)
    char_u * cmdline;
    char_u * (* getline) (int, void *, int);
    void * cookie;
    int flags;
{
    ...
    if (getline_is_func && ex_nesting_level == func_level (real_cookie)) ++ex_nesting_level;
    if (getline_is_func) {
    ...
    if (flags & 0x10) save_dbg_stuff (&debug_saved);
    else ((__builtin_object_size ((&debug_saved), 0) != (size_t) - 1) ? __builtin___memset_chk ((&debug_saved), (0), (1), __builtin_object_size ((&debug_saved)
      , 0)) : __inline_memset_chk ((&debug_saved), (0), (1)));
    initial_trylevel = trylevel;
    did_throw = 0;
    did_emsg = 0;
    if (!(flags&0x08) && !getline_equal(getline,cookie,getexline)) KeyTyped = 0;
    next_cmdline = cmdline;
    do {
        getline_is_func = getline_equal (getline, cookie, get_func_line);
        if (next_cmdline == ((void *) 0) && !force_abort && cstack.cs_idx < 0 && !(getline_is_func&&func_has_abort(real_cookie))) did_emsg = 0;
        if (cstack.cs_looplevel > 0 && current_line < lines_ga.ga_len) {
            ...
            if (breakpoint != ((void *) 0) && dbg_tick != ((void *) 0) && *dbg_tick != debug_tick) {
                * breakpoint = dbg_find_breakpoint (getline_equal (getline, cookie, getsourceline), fname, sourcing_lnum);
                * dbg_tick = debug_tick;
            }
            next_cmdline = ((wcmd_T *) (lines_ga.ga_data)) [current_line].line;
            sourcing_lnum = ((wcmd_T *) (lines_ga.ga_data)) [current_line].lnum;
            if (breakpoint != ((void *) 0) && *breakpoint != 0 && *breakpoint <= sourcing_lnum) {
        ...
        if (next_cmdline == ((void *) 0)) {
            if (count == 1 && getline_equal (getline, cookie, getexline)) msg_didout = 1;
            if (getline == ((void *) 0) || (next_cmdline = getline (':', cookie, cstack.cs_idx < 0 ? 0 : (cstack.cs_idx + 1) * 2)) == ((void *) 0)) {
                if (KeyTyped && !(flags&0x04)) need_wait_return = 0;
                retval = 0;
                break;
            }
            used_getline = 1;
            if (flags & 0x20) {
                ...
                if (count == 0) repeat_cmdline = vim_strsave (next_cmdline);
                else repeat_cmdline = ((void *) 0);
            }
        }
        ...
        if (p_verbose >= 15 && sourcing_name != ((void *) 0)) {
            ...
            smsg ((char_u *) ((char *) ("line %ld: %s")), (long) sourcing_lnum, cmdline_copy);
            if (msg_silent == 0) msg_puts ((char_u *) "\n");
            verbose_leave_scroll ();
            --no_wait_return;
        }
        ++recursive;
        next_cmdline = do_one_cmd (&cmdline_copy, flags & 0x01, &cstack, cmd_getline, cmd_cookie);
        --recursive;
        if (cmd_cookie == (void *) &cmd_loop_cookie) current_line = cmd_loop_cookie.current_line;
        if (next_cmdline == ((void *) 0)) {
            vim_free (cmdline_copy);
            cmdline_copy = ((void *) 0);
            if (getline_equal (getline, cookie, getexline) && new_last_cmdline != ((void *) 0)) {
            ...
            ((__builtin_object_size ((char *) ((cmdline_copy)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((cmdline_copy)), (char *) ((
              next_cmdline)), strlen ((char *) (next_cmdline)) + 1, __builtin_object_size ((char *) ((cmdline_copy)), 0)) : __inline_memmove_chk ((char *) ((
              cmdline_copy)), (char *) ((next_cmdline)), strlen ((char *) (next_cmdline)) + 1));
            next_cmdline = cmdline_copy;
        }
        if (did_emsg && !force_abort && getline_equal (getline, cookie, get_func_line) && !func_has_abort(real_cookie)) did_emsg = 0;
        if (cstack.cs_looplevel > 0) {
            ++current_line;
            if (cstack.cs_lflags & (4 | 2)) {
                cstack.cs_lflags &= ~(4|2);
                if (!did_emsg && !got_int && !did_throw && cstack.cs_idx >= 0 && (cstack.cs_flags [cstack.cs_idx] & (0x0008 | 0x0010)) && cstack.cs_line [
                  cstack.cs_idx] >= 0 && (cstack.cs_flags [cstack.cs_idx] & 0x0002)) {
                    current_line = cstack.cs_line [cstack.cs_idx];
                    cstack.cs_lflags |= 1;
                    line_breakcheck ();
                    if (breakpoint != ((void *) 0)) {
                        * breakpoint = dbg_find_breakpoint (getline_equal (getline, cookie, getsourceline), fname, ((wcmd_T *) lines_ga.ga_data) [current_line]
                          .lnum - 1);
                        * dbg_tick = debug_tick;
                    }
                }
                else {
                    if (cstack.cs_idx >= 0) rewind_conditionals (&cstack, cstack.cs_idx - 1, 0x0008 | 0x0010, &cstack.cs_looplevel);
                }
            }
        ...
        if (cstack.cs_lflags & 8) {
            cstack.cs_lflags &= ~8;
            report_make_pending (cstack.cs_pending [cstack.cs_idx] & (1 | 2 | 4), did_throw ? (void *) current_exception : ((void *) 0));
            did_emsg = got_int = did_throw = 0;
            cstack.cs_flags [cstack.cs_idx] |= 0x0002 | 0x0200;
        }
        trylevel = initial_trylevel + cstack.cs_trylevel;
        if (trylevel == 0 && !did_emsg && !got_int && !did_throw) force_abort = 0;
        (void) do_intthrow (&cstack);
    }
    while (!((got_int||(did_emsg&&force_abort)||did_throw)&&cstack.cs_trylevel==0) && 
      !(did_emsg&&used_getline&&(getline_equal(getline,cookie,getexmodeline)||getline_equal(getline,cookie,getexline))) && (next_cmdline != ((void *) 0) ||
      cstack.cs_idx >= 0 || (flags & 0x04)));
    vim_free (cmdline_copy);
    free_cmdlines (&lines_ga);
    ga_clear (&lines_ga);
    if (cstack.cs_idx >= 0) {
        if (!got_int && !did_throw && ((getline_equal (getline, cookie, getsourceline) && !source_finished(getline,cookie)) || (getline_equal (getline, cookie,
          get_func_line) && !func_has_ended(real_cookie)))) {
            if (cstack.cs_flags [cstack.cs_idx] & 0x0100) emsg ((char_u *) (((char *) (e_endtry))));
            else if (cstack.cs_flags [cstack.cs_idx] & 0x0008) emsg ((char_u *) (((char *) (e_endwhile))));
            else if (cstack.cs_flags [cstack.cs_idx] & 0x0010) emsg ((char_u *) (((char *) (e_endfor))));
            else emsg ((char_u *) (((char *) (e_endif))));
        }
        do {
            int idx = cleanup_conditionals (&cstack, 0, 1);
            if (idx >= 0) --idx;
            rewind_conditionals (&cstack, idx, 0x0008 | 0x0010, &cstack.cs_looplevel);
        }
        while (cstack.cs_idx >= 0);
        trylevel = initial_trylevel;
    }
    do_errthrow (&cstack, getline_equal (getline, cookie, get_func_line) ? (char_u *) "endfunction" : (char_u *) ((void *) 0));
    if (trylevel == 0) {
        if (did_throw) {
            void * p = ((void *) 0);
            ...
            case 0 :
                vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) ("E605: Exception not caught: %s")), current_exception -> value);
        ...
        else if (got_int || (did_emsg && force_abort)) suppress_errthrow = 1;
    }
    if (did_throw) need_rethrow = 1;
    if ((getline_equal (getline, cookie, getsourceline) && ex_nesting_level > source_level (real_cookie)) || (getline_equal (getline, cookie, get_func_line) &&
      ex_nesting_level > func_level (real_cookie) + 1)) {
        if (!did_throw) check_cstack = 1;
    }
    else {
        if (getline_equal (getline, cookie, get_func_line)) --ex_nesting_level;
        if ((getline_equal (getline, cookie, getsourceline) || getline_equal (getline, cookie, get_func_line)) && ex_nesting_level + 1 <= debug_break_level)
          do_debug (getline_equal (getline, cookie, getsourceline) ? (char_u *) ((char *) ("End of sourced file")) : (char_u *) ((char *) ("End of function")))
          ;
    }
    if (flags & 0x10) restore_dbg_stuff (&debug_saved);
    msg_list = saved_msg_list;
    if (did_inc) {
        --RedrawingDisabled;
        --no_wait_return;
        msg_scroll = 0;
        if (retval == 0 || (did_endif && KeyTyped && !did_emsg)) {
            need_wait_return = 0;
            msg_didany = 0;
        }
    ...
    int indent;
{
    ...
    if (cp -> current_line + 1 >= cp -> lines_gap -> ga_len) {
        if (cp -> repeating) return ((void *) 0);
        if (cp -> getline == ((void *) 0)) line = getcmdline (c, 0L, indent);
        else line = cp -> getline (c, cp -> cookie, indent);
        if (line != ((void *) 0) && store_loop_line (cp -> lines_gap, line) == 1) ++cp->current_line;
        return line;
    }
    KeyTyped = 0;
    ++cp->current_line;
...
static char_u * do_one_cmd (cmdlinep, sourcing, cstack, fgetline, cookie)
    char_u * * cmdlinep;
    int sourcing;
    struct condstack * cstack;
    char_u * (* fgetline) (int, void *, int);
    void * cookie;
{
    ...
    int ni;
    ((__builtin_object_size ((&ea), 0) != (size_t) - 1) ? __builtin___memset_chk ((&ea), (0), (sizeof (ea)), __builtin_object_size ((&ea), 0)) :
      __inline_memset_chk ((&ea), (0), (sizeof (ea))));
    ea.line1 = 1;
    ea.line2 = 1;
    ++ex_nesting_level;
    if (quitmore && !getline_equal(fgetline,cookie,get_func_line)) --quitmore;
    save_cmdmod = cmdmod;
    ((__builtin_object_size ((&cmdmod), 0) != (size_t) - 1) ? __builtin___memset_chk ((&cmdmod), (0), (sizeof (cmdmod)), __builtin_object_size ((&cmdmod), 0)) :
      __inline_memset_chk ((&cmdmod), (0), (sizeof (cmdmod))));
    if ((*cmdlinep) [0] == '#' && (*cmdlinep) [1] == '!') goto doend;
    ea.cmd = *cmdlinep;
    for (;;) {
        while (*ea.cmd == ' ' || *ea.cmd == '\t' || *ea.cmd == ':') ++ea.cmd;
        if (*ea.cmd == '\000' && exmode_active && (getline_equal (fgetline, cookie, getexmodeline) || getline_equal (fgetline, cookie, getexline)) && curwin ->
          w_cursor.lnum < curbuf -> b_ml.ml_line_count) {
            ea.cmd = (char_u *) "+";
            ex_pressedreturn = 1;
        }
        if (*ea.cmd == '"') goto doend;
        if (*ea.cmd == '\000') {
            ex_pressedreturn = 1;
            goto doend;
        }
        p = ea.cmd;
        if (((*ea.cmd) >= '0' && (*ea.cmd) <= '9')) p = skipwhite (skipdigits (ea.cmd));
        switch (*p) {
        case 'a' :
            if (!checkforcmd(&ea.cmd, "aboveleft", 3)) break;
            cmdmod.split |= 64;
            continue;
        case 'b' :
            ...
            if (!checkforcmd(&ea.cmd, "botright", 2)) break;
            cmdmod.split |= 8;
            continue;
        case 'c' :
            if (!checkforcmd(&ea.cmd, "confirm", 4)) break;
            cmdmod.confirm = 1;
            continue;
        case 'k' :
            ...
            if (!checkforcmd(&ea.cmd, "keepjumps", 5)) break;
            cmdmod.keepjumps = 1;
            continue;
        case 'h' :
            if (p != ea.cmd || !checkforcmd(&p, "hide", 3) || *p == '\000' || ends_excmd (*p)) break;
            ea.cmd = p;
            cmdmod.hide = 1;
            continue;
        case 'l' :
            ...
            if (!checkforcmd(&ea.cmd, "leftabove", 5)) break;
            cmdmod.split |= 64;
            continue;
        case 'n' :
            if (!checkforcmd(&ea.cmd, "noautocmd", 3)) break;
            if (cmdmod.save_ei == ((void *) 0)) {
                cmdmod.save_ei = vim_strsave (p_ei);
                set_string_option_direct ((char_u *) "ei", -1, (char_u *) "all", 1, -6);
            }
            continue;
        case 'r' :
            if (!checkforcmd(&ea.cmd, "rightbelow", 6)) break;
            cmdmod.split |= 32;
            continue;
        case 's' :
            if (checkforcmd (&ea.cmd, "sandbox", 3)) {
                if (!did_sandbox) ++sandbox;
                did_sandbox = 1;
                continue;
            }
            if (!checkforcmd(&ea.cmd, "silent", 3)) break;
            if (save_msg_silent == -1) save_msg_silent = msg_silent;
            ++msg_silent;
        ...
        case 't' :
            if (checkforcmd (&p, "tab", 3)) {
                if (vim_isdigit (*ea.cmd)) cmdmod.tab = atoi ((char *) ea.cmd) + 1;
                else cmdmod.tab = tabpage_index (curtab) + 1;
                ea.cmd = p;
                continue;
            }
            if (!checkforcmd(&ea.cmd, "topleft", 2)) break;
            cmdmod.split |= 4;
            continue;
        case 'u' :
            if (!checkforcmd(&ea.cmd, "unsilent", 3)) break;
            if (save_msg_silent == -1) save_msg_silent = msg_silent;
            msg_silent = 0;
            continue;
        case 'v' :
            ...
            if (!checkforcmd(&p, "verbose", 4)) break;
            if (verbose_save < 0) verbose_save = p_verbose;
            if (vim_isdigit (*ea.cmd)) p_verbose = atoi ((char *) ea.cmd);
            else p_verbose = 1;
            ea.cmd = p;
            continue;
        }
    ...
    ea.skip = did_emsg || got_int || did_throw || (cstack -> cs_idx >= 0 && !(cstack->cs_flags[cstack->cs_idx]&0x0002));
    ...
    for (;;) {
        ...
        ea.addr_count ++;
        if (*ea.cmd == ';') {
            if (!ea.skip) curwin -> w_cursor.lnum = ea.line2;
        }
        else if (*ea.cmd != ',') break;
        ++ea.cmd;
    }
    if (ea.addr_count == 1) {
        ea.line1 = ea.line2;
        if (lnum == (0x7fffffffL)) ea.addr_count = 0;
    }
    check_cursor_lnum ();
    ea.cmd = skipwhite (ea.cmd);
    while (*ea.cmd == ':') ea.cmd = skipwhite (ea.cmd + 1);
    if (*ea.cmd == '\000' || *ea.cmd == '"' || (ea.nextcmd = check_nextcmd (ea.cmd)) != ((void *) 0)) {
        if (ea.skip) goto doend;
        if (*ea.cmd == '|' || (exmode_active && ea.line1 != ea.line2)) {
            ...
            if (ea.line2 > curbuf -> b_ml.ml_line_count) {
                if (vim_strchr (p_cpo, '-') != ((void *) 0)) ea.line2 = -1;
                else ea.line2 = curbuf -> b_ml.ml_line_count;
            }
            if (ea.line2 < 0) errormsg = (char_u *) ((char *) (e_invrange));
            else {
                if (ea.line2 == 0) curwin -> w_cursor.lnum = 1;
                else curwin -> w_cursor.lnum = ea.line2;
                beginline (2 | 4);
            }
        }
        goto doend;
    ...
    if (p == ((void *) 0)) {
        if (!ea.skip) errormsg = (char_u *) ((char *) ("E464: Ambiguous use of user-defined command"));
        goto doend;
    }
    ...
    if (ea.cmdidx == CMD_SIZE) {
        if (!ea.skip) {
            ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) (((char *) (
              "E492: Not an editor command"))), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) (((char *)
            ...
            if (!sourcing) {
                ...
                ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strncat_chk ((char *) (IObuff), (char *) (*cmdlinep), (size_t) (
                  40), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strncat_chk ((char *) (IObuff), (char *) (*cmdlinep), (size_t) (40)));
            }
            errormsg = IObuff;
        }
        goto doend;
    ...
    if (!((int)(ea.cmdidx)<0)) ea.argt = (long) cmdnames [(int) ea.cmdidx].cmd_argt;
    if (!ea.skip) {
        ...
        if (text_locked () && !(ea.argt&0x100000L) && !((int)(ea.cmdidx)<0)) {
            if (cmdwin_type != 0) errormsg = (char_u *) ((char *) (e_cmdwin));
            else errormsg = (char_u *) ((char *) (e_secure));
            goto doend;
        }
        if (!(ea.argt&0x100000L) && ea.cmdidx != CMD_edit && ea.cmdidx != CMD_checktime && !((int)(ea.cmdidx)<0) && curbuf_locked ()) goto doend;
    ...
    if (!ea.skip && !ni) {
        if (!global_busy && ea.line1 > ea.line2) {
            if (msg_silent == 0) {
                ...
                if (ask_yesno ((char_u *) ((char *) ("Backwards range given, OK to swap")), 0) != 'y') goto doend;
            }
            lnum = ea.line1;
            ea.line1 = ea.line2;
            ea.line2 = lnum;
        }
        if ((errormsg = invalid_range (&ea)) != ((void *) 0)) goto doend;
    }
    if ((ea.argt & 0x4000) && ea.addr_count == 0) ea.line2 = 1;
    correct_range (&ea);
    ...
    if (p == ((void *) 0)) goto doend;
    if (ea.cmdidx == CMD_bang) ea.arg = p;
    else ea.arg = skipwhite (p);
    if (ea.argt & 0x40000L) while (ea.arg [0] == '+' && ea.arg [1] == '+') if (getargopt (&ea) == 0 && !ni) {
    ...
    if ((ea.argt & 0x8000) && !ea.usefilter) ea.do_ecmd_cmd = getargcmd (&ea.arg);
    if ((ea.argt & 0x100) && !ea.usefilter) separate_nextcmd (&ea);
    else if (ea.cmdidx == CMD_bang || ea.cmdidx == CMD_global || ea.cmdidx == CMD_vglobal || ea.usefilter) {
        for (p = ea.arg; *p; ++p) {
            if (*p == '\\' && p [1] == '\n') ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) (
    ...
    if ((ea.argt & 0x200) && *ea.arg != '\000' && valid_yank_reg (*ea.arg, (ea.cmdidx != CMD_put && ((int) (ea.cmdidx) < 0))) && (!((int)(ea.cmdidx)<0) || 
      *ea.arg != '=') && !((ea.argt&0x400)&&((*ea.arg) >= '0' && (*ea.arg) <= '9'))) {
        ea.regname = *ea.arg++;
    ...
    if ((ea.argt & 0x400) && ((*ea.arg) >= '0' && (*ea.arg) <= '9') && (!(ea.argt&0x10000L) || *(p=skipdigits(ea.arg)) == '\000' || ((*p) == ' ' || (*p) == '\t'
      ))) {
        n = getdigits (&ea.arg);
        ea.arg = skipwhite (ea.arg);
        ...
        if (ea.argt & 0x4000) {
            ea.line2 = n;
            if (ea.addr_count == 0) ea.addr_count = 1;
        }
        else {
            ea.line1 = ea.line2;
            ea.line2 += n - 1;
            ++ea.addr_count;
            if (ea.line2 > curbuf -> b_ml.ml_line_count) ea.line2 = curbuf -> b_ml.ml_line_count;
        }
    }
    if (ea.argt & 0x400000L) get_flags (&ea);
    if (!ni && !(ea.argt&0x004) && *ea.arg != '\000' && *ea.arg != '"' && (*ea.arg != '|' || (ea.argt & 0x100) == 0)) {
    ...
    if (ea.argt & 0x008) {
        if (expand_filename (&ea, cmdlinep, &errormsg) == 0) goto doend;
    }
    if ((ea.argt & 0x10000L) && *ea.arg != '\000' && ea.addr_count == 0 && !((int)(ea.cmdidx)<0)) {
        if (ea.cmdidx == CMD_bdelete || ea.cmdidx == CMD_bwipeout || ea.cmdidx == CMD_bunload) p = skiptowhite_esc (ea.arg);
        else {
            p = ea.arg + strlen ((char *) (ea.arg));
            while (p > ea.arg && ((p [-1]) == ' ' || (p [-1]) == '\t')) --p;
        }
        ea.line2 = buflist_findpat (ea.arg, p, (ea.argt & 0x20000L) != 0, 0);
        if (ea.line2 < 0) goto doend;
        ea.addr_count = 1;
        ea.arg = skipwhite (p);
    }
    ...
    if (((int) (ea.cmdidx) < 0)) {
        ...
        if (ea.errmsg != ((void *) 0)) errormsg = (char_u *) ((char *) (ea.errmsg));
    }
    if (need_rethrow) do_throw (cstack);
    else if (check_cstack) {
        if (source_finished (fgetline, cookie)) do_finish (&ea, 1);
        else if (getline_equal (fgetline, cookie, get_func_line) && current_func_returned ()) do_return (&ea, 1, 0, ((void *) 0));
    }
    need_rethrow = check_cstack = 0;
    doend : if (curwin -> w_cursor.lnum == 0) curwin -> w_cursor.lnum = 1;
    if (errormsg != ((void *) 0) && *errormsg != '\000' && !did_emsg) {
        if (sourcing) {
            if (errormsg != IObuff) {
                ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) (errormsg),
                  __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) (errormsg)));
                errormsg = IObuff;
            }
            ((__builtin_object_size ((char *) (errormsg), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (errormsg), (char *) (": "),
              __builtin_object_size ((char *) (errormsg), 1 > 1)) : __inline_strcat_chk ((char *) (errormsg), (char *) (": ")));
            ((__builtin_object_size ((char *) (errormsg), 0) != (size_t) - 1) ? __builtin___strncat_chk ((char *) (errormsg), (char *) (*cmdlinep), (size_t) ((
              1024 + 1) - strlen ((char *) (IObuff)) - 1), __builtin_object_size ((char *) (errormsg), 1 > 1)) : __inline_strncat_chk ((char *) (errormsg), (
              char *) (*cmdlinep), (size_t) ((1024 + 1) - strlen ((char *) (IObuff)) - 1)));
        }
        emsg (errormsg);
    }
    do_errthrow (cstack, (ea.cmdidx != CMD_SIZE && !((int)(ea.cmdidx)<0)) ? cmdnames [(int) ea.cmdidx].cmd_name : (char_u *) ((void *) 0));
    if (verbose_save >= 0) p_verbose = verbose_save;
    if (cmdmod.save_ei != ((void *) 0)) {
        set_string_option_direct ((char_u *) "ei", -1, cmdmod.save_ei, 1, -6);
        free_string_option (cmdmod.save_ei);
    }
    cmdmod = save_cmdmod;
    if (save_msg_silent != -1) {
        if (!did_emsg || msg_silent > save_msg_silent) msg_silent = save_msg_silent;
        emsg_silent -= did_esilent;
        if (emsg_silent < 0) emsg_silent = 0;
        msg_scroll = save_msg_scroll;
        if (redirecting ()) msg_col = 0;
    }
    if (did_sandbox) --sandbox;
    if (ea.nextcmd && *ea.nextcmd == '\000') ea.nextcmd = ((void *) 0);
    --ex_nesting_level;
    return ea.nextcmd;
}
...
{
    int i;
    for (i = 0; cmd [i] != '\000'; ++i) if (((char_u *) cmd) [i] != (*pp) [i]) break;
    ...
    int * full __attribute__ ((unused));
{
    ...
    else if (p [0] == 's' && ((p [1] == 'c' && p [2] != 's' && p [2] != 'r' && p [3] != 'i' && p [4] != 'p') || p [1] == 'g' || (p [1] == 'i' && p [2] != 'm' &&
      p [2] != 'l' && p [2] != 'g') || p [1] == 'I' || (p [1] == 'r' && p [2] != 'e'))) {
        eap -> cmdidx = CMD_substitute;
        ++p;
    }
    else {
        while (((*p) < 0x7f && isalpha (*p))) ++p;
        if (eap -> cmd [0] == 'p' && eap -> cmd [1] == 'y') while (((*p) < 0x7f && isalnum (*p))) ++p;
        if (p == eap -> cmd && vim_strchr ((char_u *) "@*!=><&~#", *p) != ((void *) 0)) ++p;
        len = (int) (p - eap -> cmd);
        if (*eap->cmd == 'd' && (p [-1] == 'l' || p [-1] == 'p')) {
            for (i = 0; i < len; ++i) if (eap -> cmd [i] != ((char_u *) "delete") [i]) break;
            if (i == len - 1) {
                --len;
                if (p [-1] == 'l') eap -> flags |= 0x01;
                else eap -> flags |= 0x04;
            }
        }
        if (((*eap->cmd) < 0x7f && islower (*eap->cmd))) eap -> cmdidx = cmdidxs [((*eap->cmd) - 'a')];
        else eap -> cmdidx = cmdidxs [26];
        for (; (int) eap -> cmdidx < (int) CMD_SIZE; eap -> cmdidx = (cmdidx_T) ((int) eap -> cmdidx + 1)) if (strncmp ((char *) (cmdnames [(int) eap -> cmdidx
          ].cmd_name), (char *) ((char *) eap -> cmd), (size_t) ((size_t) len)) == 0) {
            if (full != ((void *) 0) && cmdnames [(int) eap -> cmdidx].cmd_name [len] == '\000') *full = 1;
            break;
        }
        ...
        if (p == eap -> cmd) eap -> cmdidx = CMD_SIZE;
    }
    return p;
}
    ...
    int * compl;
{
    ...
    for (;;) {
        for (j = 0; j < gap -> ga_len; ++j) {
            ...
            np = uc -> uc_name;
            k = 0;
            while (k < len && *np != '\000' && *cp++ == *np++) k ++;
            if (k == len || (*np == '\000' && vim_isdigit (eap -> cmd [k]))) {
                if (k == len && found && *np != '\000') {
                    if (gap == &ucmds) return ((void *) 0);
                    amb_local = 1;
                }
                if (!found || (k == len && *np == '\000')) {
                    if (k == len) found = 1;
                    else possible = 1;
                    if (gap == &ucmds) eap -> cmdidx = CMD_USER;
                    else eap -> cmdidx = CMD_USER_BUF;
                    eap -> argt = (long) uc -> uc_argt;
                    eap -> useridx = j;
                    if (compl != ((void *) 0)) *compl = uc -> uc_compl;
                    if (xp != ((void *) 0)) {
        ...
        if (j < gap -> ga_len || gap == &ucmds) break;
        gap = &ucmds;
    }
    if (amb_local) {
        if (xp != ((void *) 0)) xp -> xp_context = (-2);
        return ((void *) 0);
    }
    if (found || possible) return p + (matchlen - len);
    return p;
}
    ...
    char_u * cmd;
{
    int i, j;
    char_u * p = cmd;
    if (((*cmd) >= '0' && (*cmd) <= '9')) p = skipwhite (skipdigits (cmd));
    for (i = 0; i < (int) (sizeof (cmdmods) / sizeof (struct cmdmod)); ++i) {
        for (j = 0; p [j] != '\000'; ++j) if (p [j] != cmdmods [i].name [j]) break;
        if (!isalpha(p[j]) && j >= cmdmods [i].minlen && (p == cmd || cmdmods [i].has_count)) return j + (int) (p - cmd);
    }
    return 0;
}
    ...
    char_u * name;
{
    ...
    char_u * p;
    for (i = 0; i < (int) (sizeof (cmdmods) / sizeof (struct cmdmod)); ++i) {
        for (j = 0; name [j] != '\000'; ++j) if (name [j] != cmdmods [i].name [j]) break;
        if (name [j] == '\000' && j >= cmdmods [i].minlen) return (cmdmods [i].name [j] == '\000' ? 2 : 1);
    }
    ea.cmd = (*name == '2' || *name == '3') ? name + 1 : name;
    ea.cmdidx = (cmdidx_T) 0;
    p = find_command (&ea, &full);
    if (p == ((void *) 0)) return 3;
    if (vim_isdigit (*name) && ea.cmdidx != CMD_match) return 0;
    if (*skipwhite(p) != '\000') return 0;
    ...
    char_u * buff;
{
    ...
    if (*cmd == 'k' && cmd [1] != 'e') {
        ...
        p = cmd;
        while (((*p) < 0x7f && isalpha (*p)) || *p == '*') ++p;
        if (p == cmd && vim_strchr ((char_u *) "@*!=><&~#", *p) != ((void *) 0)) ++p;
        len = (int) (p - cmd);
        if (len == 0) {
            xp -> xp_context = (-2);
            return ((void *) 0);
        }
        for (ea.cmdidx = (cmdidx_T) 0; (int) ea.cmdidx < (int) CMD_SIZE; ea.cmdidx = (cmdidx_T) ((int) ea.cmdidx + 1)) if (strncmp ((char *) (cmdnames [(int) ea
          .cmdidx].cmd_name), (char *) (cmd), (size_t) ((size_t) len)) == 0) break;
        if (cmd [0] >= 'A' && cmd [0] <= 'Z') while (((*p) < 0x7f && isalnum (*p)) || *p == '*') ++p;
    }
    if (*p == '\000' && ((p [-1]) < 0x7f && isalnum (p [-1]))) return ((void *) 0);
    if (ea.cmdidx == CMD_SIZE) {
        if (*cmd == 's' && vim_strchr ((char_u *) "cgriI", cmd [1]) != ((void *) 0)) {
            ...
            ea.cmd = cmd;
            p = find_ucmd (&ea, p, ((void *) 0), xp, &compl);
    ...
    if ((ea.argt & 0x100) && !usefilter) {
        p = arg;
        if (ea.cmdidx == CMD_redir && p [0] == '@' && p [1] == '"') p += 2;
        while (*p) {
            if (*p == 22) {
                if (p [1] != '\000') ++p;
            }
            else if ((*p == '"' && !(ea.argt&0x800)) || *p == '|' || *p == '\n') {
                if (*(p-1) != '\\') {
                    if (*p == '|' || *p == '\n') return p + 1;
                    return ((void *) 0);
                }
    ...
    if (!(ea.argt&0x004) && *arg != '\000' && vim_strchr ((char_u *) "|\"", *arg) == ((void *) 0)) return ((void *) 0);
    p = buff + strlen ((char *) (buff));
    while (p != arg && *p != ' ' && *p != '\011') p --;
    if (*p == ' ' || *p == '\011') p ++;
    xp -> xp_pattern = p;
    if (ea.argt & 0x008) {
        int c;
        ...
        while (*p != '\000') {
            ...
            else if (c == '|' || c == '\n' || c == '"' || (((c) == ' ' || (c) == '\t') && (!(ea.argt&0x010) || usefilter))) {
                len = 0;
                while (*p != '\000') {
                    c = *p;
                    if (c == '`' || vim_isfilec_or_wc (c)) break;
                    len = 1;
                    ++p;
                }
                if (in_quote) bow = p;
                else xp -> xp_pattern = p;
                p -= len;
            }
            ++p;
        }
        if (bow != ((void *) 0) && in_quote) xp -> xp_pattern = bow;
        xp -> xp_context = 2;
        if (usefilter || ea.cmdidx == CMD_bang) {
            xp -> xp_shell = 1;
            if (xp -> xp_pattern == skipwhite (arg)) xp -> xp_context = 32;
        }
        if (*xp->xp_pattern == '$') {
            for (p = xp -> xp_pattern + 1; *p != '\000'; ++p) if (!vim_isIDc(*p)) break;
            if (*p == '\000') {
                xp -> xp_context = 26;
                ++xp->xp_pattern;
                if (compl != 30 && compl != 31) compl = 26;
            }
        }
    }
    switch (ea.cmdidx) {
    ...
    case CMD_lcd :
    case CMD_lchdir :
        if (xp -> xp_context == 2) xp -> xp_context = 3;
        break;
    case CMD_help :
        xp -> xp_context = 8;
        xp -> xp_pattern = arg;
    ...
    case CMD_vglobal :
        ...
        while (arg [0] != '\000' && arg [0] != delim) {
            if (arg [0] == '\\' && arg [1] != '\000') ++arg;
            ++arg;
        }
        if (arg [0] != '\000') return arg + 1;
        break;
    case CMD_and :
    case CMD_substitute :
        delim = *arg;
        ...
        if (arg [0] != '\000') ++arg;
        while (arg [0] && vim_strchr ((char_u *) "|\"#", arg [0]) == ((void *) 0)) ++arg;
        if (arg [0] != '\000') return arg;
        break;
    case CMD_isearch :
    case CMD_dsearch :
    case CMD_ilist :
    ...
    case CMD_dsplit :
        ...
        if (*arg == '/') {
            for (++arg; *arg && *arg != '/'; arg ++) if (*arg == '\\' && arg [1] != '\000') arg ++;
            if (*arg) {
                arg = skipwhite (arg + 1);
                if (*arg && vim_strchr ((char_u *) "|\"\n", *arg) == ((void *) 0)) xp -> xp_context = 0;
                else return arg;
            }
        }
        break;
    ...
    case CMD_stjump :
    case CMD_ptjump :
        if (*p_wop != '\000') xp -> xp_context = 17;
        else xp -> xp_context = 6;
        xp -> xp_pattern = arg;
        break;
    case CMD_augroup :
        xp -> xp_context = 14;
    ...
    case CMD_return :
        ...
        break;
    case CMD_unlet :
        while ((xp -> xp_pattern = vim_strchr (arg, ' ')) != ((void *) 0)) arg = xp -> xp_pattern + 1;
        xp -> xp_context = 15;
        xp -> xp_pattern = arg;
        break;
    case CMD_function :
    ...
    case CMD_USER_BUF :
        if (compl != 0) {
            if (!(ea.argt&0x008)) {
                if (compl == 11) return set_context_in_menu_cmd (xp, cmd, arg, forceit);
                if (compl == 1) return arg;
                if (compl == 16) return set_context_in_map_cmd (xp, (char_u *) "map", arg, forceit, 0, 0, CMD_map);
                while ((xp -> xp_pattern = vim_strchr (arg, ' ')) != ((void *) 0)) arg = xp -> xp_pattern + 1;
                xp -> xp_pattern = arg;
            }
            xp -> xp_context = compl;
    ...
    case CMD_lmap :
    case CMD_lnoremap :
        return set_context_in_map_cmd (xp, cmd, arg, forceit, 0, 0, ea.cmdidx);
    case CMD_unmap :
    case CMD_nunmap :
    case CMD_vunmap :
    case CMD_ounmap :
    ...
    case CMD_cunmap :
    case CMD_lunmap :
        return set_context_in_map_cmd (xp, cmd, arg, forceit, 0, 1, ea.cmdidx);
    case CMD_abbreviate :
    case CMD_noreabbrev :
    case CMD_cabbrev :
    ...
    case CMD_inoreabbrev :
        return set_context_in_map_cmd (xp, cmd, arg, forceit, 1, 0, ea.cmdidx);
    case CMD_unabbreviate :
    case CMD_cunabbrev :
    case CMD_iunabbrev :
        return set_context_in_map_cmd (xp, cmd, arg, forceit, 1, 1, ea.cmdidx);
    case CMD_menu :
    case CMD_noremenu :
    case CMD_unmenu :
    case CMD_amenu :
    ...
    int * ctx;
{
    ...
    while (vim_strchr ((char_u *) " \t0123456789.$%'/?-+,;", *cmd) != ((void *) 0)) {
        if (*cmd == '\'') {
            if (*++cmd == '\000' && ctx != ((void *) 0)) *ctx = 0;
        }
        else if (*cmd == '/' || *cmd == '?') {
            delim = *cmd++;
            while (*cmd != '\000' && *cmd != delim) if (*cmd++ == '\\' && *cmd != '\000') ++cmd;
            if (*cmd == '\000' && ctx != ((void *) 0)) *ctx = 0;
        }
        if (*cmd != '\000') ++cmd;
    }
    while (*cmd == ':') cmd = skipwhite (cmd + 1);
    return cmd;
}
    ...
    do {
        ...
        case '\'' :
            ...
            if (skip) ++cmd;
                ...
                ++cmd;
                if (fp == (pos_T *) -1) lnum = curwin -> w_cursor.lnum;
                else {
                    if (check_mark (fp) == 0) {
                        cmd = ((void *) 0);
                        goto error;
        ...
        case '?' :
            ...
            if (skip) {
                ...
                pos = curwin -> w_cursor;
                if (lnum != (0x7fffffffL)) curwin -> w_cursor.lnum = lnum;
                if (c == '/') curwin -> w_cursor.col = (0x7fffffffL);
                else curwin -> w_cursor.col = 0;
                searchcmdlen = 0;
                if (!do_search(((void*)0),c,cmd,1L,0x20|0x0c,((void*)0))) {
                    curwin -> w_cursor = pos;
                    cmd = ((void *) 0);
                    goto error;
                }
        ...
        case '\\' :
            ...
            if (!skip) {
                if (lnum != (0x7fffffffL)) pos.lnum = lnum;
                else pos.lnum = curwin -> w_cursor.lnum;
                if (*cmd != '?') pos.col = (0x7fffffffL);
                else pos.col = 0;
                if (searchit (curwin, curbuf, &pos, *cmd == '?' ? (-1) : 1, (char_u *) "", 1L, 0x0c, i, (linenr_T) 0, ((void *) 0)) != 0) lnum = pos.lnum;
                else {
                    cmd = ((void *) 0);
                    goto error;
                }
            ...
            break;
        default :
            if (((*cmd) >= '0' && (*cmd) <= '9')) lnum = getdigits (&cmd);
        }
        for (;;) {
            cmd = skipwhite (cmd);
            if (*cmd != '-' && *cmd != '+' && !((*cmd) >= '0' && (*cmd) <= '9')) break;
            if (lnum == (0x7fffffffL)) lnum = curwin -> w_cursor.lnum;
            if (((*cmd) >= '0' && (*cmd) <= '9')) i = '+';
            else i = *cmd++;
            if (!((*cmd) >= '0' && (*cmd) <= '9')) n = 1;
            else n = getdigits (&cmd);
            if (i == '-') lnum -= n;
            else lnum += n;
        }
    }
    ...
    exarg_T * eap;
{
    while (vim_strchr ((char_u *) "lp#", *eap->arg) != ((void *) 0)) {
        if (*eap->arg == 'l') eap -> flags |= 0x01;
        else if (*eap->arg == 'p') eap -> flags |= 0x04;
        else eap -> flags |= 0x02;
...
void ex_ni (eap)
    exarg_T * eap;
{
    if (!eap->skip) eap -> errmsg = (char_u *) "E319: Sorry, the command is not available in this version";
}

static void ex_script_ni (eap)
    exarg_T * eap;
{
    if (!eap->skip) ex_ni (eap);
    else vim_free (script_get (eap, eap -> arg));
}

static char_u * invalid_range (eap)
    exarg_T * eap;
{
    if (eap -> line1 < 0 || eap -> line2 < 0 || eap -> line1 > eap -> line2 || ((eap -> argt & 0x001) && !(eap->argt&0x4000) && eap -> line2 > curbuf -> b_ml.
      ml_line_count + (eap -> cmdidx == CMD_diffget))) return (char_u *) ((char *) (e_invrange));
    return ((void *) 0);
}
...
{
    if (!(eap->argt&0x1000)) {
        if (eap -> line1 == 0) eap -> line1 = 1;
        if (eap -> line2 == 0) eap -> line2 = 1;
    }
}
...
{
    char_u * p = eap -> arg;
    if (*p != '\000' && (eap -> cmdidx == CMD_vimgrep || eap -> cmdidx == CMD_lvimgrep || eap -> cmdidx == CMD_vimgrepadd || eap -> cmdidx == CMD_lvimgrepadd ||
      grep_internal (eap -> cmdidx))) {
        p = skip_vimgrep_pat (p, ((void *) 0), ((void *) 0));
        if (p == ((void *) 0)) p = eap -> arg;
    }
    return p;
}
    ...
    char_u * * cmdlinep;
{
    ...
    int len;
    int i;
    if ((eap -> cmdidx == CMD_make || eap -> cmdidx == CMD_lmake || eap -> cmdidx == CMD_grep || eap -> cmdidx == CMD_lgrep || eap -> cmdidx == CMD_grepadd ||
      eap -> cmdidx == CMD_lgrepadd) && !grep_internal(eap->cmdidx)) {
        if (eap -> cmdidx == CMD_grep || eap -> cmdidx == CMD_lgrep || eap -> cmdidx == CMD_grepadd || eap -> cmdidx == CMD_lgrepadd) {
            if (*curbuf->b_p_gp == '\000') program = p_gp;
            else program = curbuf -> b_p_gp;
        }
        else {
            if (*curbuf->b_p_mp == '\000') program = p_mp;
            else program = curbuf -> b_p_mp;
        }
        p = skipwhite (p);
        if ((pos = (char_u *) strstr ((char *) program, "$*")) != ((void *) 0)) {
            i = 1;
            while ((pos = (char_u *) strstr ((char *) pos + 2, "$*")) != ((void *) 0)) ++i;
            len = (int) strlen ((char *) (p));
            new_cmdline = alloc ((int) (strlen ((char *) (program)) + i * (len - 2) + 1));
            if (new_cmdline == ((void *) 0)) return ((void *) 0);
            ptr = new_cmdline;
            while ((pos = (char_u *) strstr ((char *) program, "$*")) != ((void *) 0)) {
                i = (int) (pos - program);
                ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___strncpy_chk ((char *) (ptr), (char *) (program), (size_t) (i),
                  __builtin_object_size ((char *) (ptr), 1 > 1)) : __inline_strncpy_chk ((char *) (ptr), (char *) (program), (size_t) (i)));
                ((__builtin_object_size ((char *) (ptr += i), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ptr += i), (char *) (p),
                  __builtin_object_size ((char *) (ptr += i), 1 > 1)) : __inline_strcpy_chk ((char *) (ptr += i), (char *) (p)));
                ptr += len;
                program = pos + 2;
            }
            ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ptr), (char *) (program), __builtin_object_size ((
              char *) (ptr), 1 > 1)) : __inline_strcpy_chk ((char *) (ptr), (char *) (program)));
        }
        else {
            new_cmdline = alloc ((int) (strlen ((char *) (program)) + strlen ((char *) (p)) + 2));
            if (new_cmdline == ((void *) 0)) return ((void *) 0);
            ((__builtin_object_size ((char *) (new_cmdline), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (new_cmdline), (char *) (program),
              __builtin_object_size ((char *) (new_cmdline), 1 > 1)) : __inline_strcpy_chk ((char *) (new_cmdline), (char *) (program)));
            ((__builtin_object_size ((char *) (new_cmdline), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (new_cmdline), (char *) (" "),
              __builtin_object_size ((char *) (new_cmdline), 1 > 1)) : __inline_strcat_chk ((char *) (new_cmdline), (char *) (" ")));
            ((__builtin_object_size ((char *) (new_cmdline), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (new_cmdline), (char *) (p),
              __builtin_object_size ((char *) (new_cmdline), 1 > 1)) : __inline_strcat_chk ((char *) (new_cmdline), (char *) (p)));
        }
        msg_make (p);
        vim_free (* cmdlinep);
    ...
    char_u * * errormsgp;
{
    ...
    while (*p != '\000') {
        ...
        if (!eap->usefilter && !escaped && eap -> cmdidx != CMD_bang && eap -> cmdidx != CMD_make && eap -> cmdidx != CMD_lmake && eap -> cmdidx != CMD_grep &&
          eap -> cmdidx != CMD_lgrep && eap -> cmdidx != CMD_grepadd && eap -> cmdidx != CMD_lgrepadd) {
            char_u * l;
            for (l = repl; *l; ++l) if (vim_strchr (escape_chars, *l) != ((void *) 0)) {
        ...
        if ((eap -> usefilter || eap -> cmdidx == CMD_bang) && (char_u *) strpbrk ((char *) (repl), (char *) ((char_u *) "!&;()<>")) != ((void *) 0)) {
            char_u * l;
    ...
    if ((eap -> argt & 0x010) && !eap->usefilter) {
        for (n = 1; n <= 2; ++n) {
            if (n == 2) {
                if (!has_wildcards) for (p = eap -> arg; *p; ++p) {
                    if (p [1] && (*p == '\\' || *p == 22)) ++p;
                    else if (((*p) == ' ' || (*p) == '\t')) {
                ...
                if (!has_wildcards) backslash_halve (eap -> arg);
            }
            if (has_wildcards) {
                if (n == 1) {
                    if (vim_strchr (eap -> arg, '$') != ((void *) 0) || vim_strchr (eap -> arg, '~') != ((void *) 0)) {
                        expand_env_esc (eap -> arg, NameBuff, 1024, 1, 1, ((void *) 0));
                    ...
                    ExpandInit (&xpc);
                    xpc.xp_context = 2;
                    p = ExpandOne (&xpc, eap -> arg, ((void *) 0), 1 | 16, 2);
                    if (p == ((void *) 0)) return 0;
                }
                if (p != ((void *) 0)) {
                    (void) repl_cmdline (eap, eap -> arg, (int) strlen ((char *) (eap -> arg)), p, cmdlinep);
                    if (n == 2) vim_free (p);
                }
            }
        }
    ...
    char_u * * cmdlinep;
{
    ...
    if (eap -> nextcmd != ((void *) 0)) i += (int) strlen ((char *) (eap -> nextcmd));
    if ((new_cmdline = alloc ((unsigned) i)) == ((void *) 0)) return ((void *) 0);
    i = (int) (src - *cmdlinep);
    ((__builtin_object_size ((char *) (new_cmdline), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (new_cmdline), (char *) (*cmdlinep), (size_t) i,
      __builtin_object_size ((char *) (new_cmdline), 0)) : __inline_memmove_chk ((char *) (new_cmdline), (char *) (*cmdlinep), (size_t) i));
    ((__builtin_object_size ((char *) (new_cmdline + i), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (new_cmdline + i), (char *) (repl), (size_t)
      len, __builtin_object_size ((char *) (new_cmdline + i), 0)) : __inline_memmove_chk ((char *) (new_cmdline + i), (char *) (repl), (size_t) len));
    i += len;
    ((__builtin_object_size ((char *) (new_cmdline + i), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (new_cmdline + i), (char *) (src + srclen),
      __builtin_object_size ((char *) (new_cmdline + i), 1 > 1)) : __inline_strcpy_chk ((char *) (new_cmdline + i), (char *) (src + srclen)));
    src = new_cmdline + i;
    if (eap -> nextcmd != ((void *) 0)) {
        i = (int) strlen ((char *) (new_cmdline)) + 1;
        ((__builtin_object_size ((char *) (new_cmdline + i), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (new_cmdline + i), (char *) (eap -> nextcmd
          ), __builtin_object_size ((char *) (new_cmdline + i), 1 > 1)) : __inline_strcpy_chk ((char *) (new_cmdline + i), (char *) (eap -> nextcmd)));
        eap -> nextcmd = new_cmdline + i;
    }
    eap -> cmd = new_cmdline + (eap -> cmd - *cmdlinep);
    eap -> arg = new_cmdline + (eap -> arg - *cmdlinep);
    if (eap -> do_ecmd_cmd != ((void *) 0) && eap -> do_ecmd_cmd != dollar_command) eap -> do_ecmd_cmd = new_cmdline + (eap -> do_ecmd_cmd - *cmdlinep);
    vim_free (* cmdlinep);
    * cmdlinep = new_cmdline;
    return src;
}
    ...
    exarg_T * eap;
{
    ...
    for (; *p; ++p) {
        if (*p == 22) {
            if (eap -> argt & (0x2000 | 0x008)) ++p;
            else ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((char *) (
              p + 1)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((char *) (p + 1)) + 1
              ));
            if (*p == '\000') break;
        }
        ...
        else if ((*p == '"' && !(eap->argt&0x800) && ((eap -> cmdidx != CMD_at && eap -> cmdidx != CMD_star) || p != eap -> arg) && (eap -> cmdidx != CMD_redir
          || p != eap -> arg + 1 || p [-1] != '@')) || *p == '|' || *p == '\n') {
            if ((vim_strchr (p_cpo, 'b') == ((void *) 0) || !(eap->argt&0x2000)) && *(p-1) == '\\') {
                ((__builtin_object_size ((char *) ((p - 1)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p - 1)), (char *) ((p)), strlen ((char *
                  ) (p)) + 1, __builtin_object_size ((char *) ((p - 1)), 0)) : __inline_memmove_chk ((char *) ((p - 1)), (char *) ((p)), strlen ((char *) (p)) +
                  1));
                --p;
            }
            else {
    ...
    if (!(eap->argt&0x800)) del_trailing_spaces (eap -> arg);
}
    ...
    char_u * * argp;
{
    ...
    if (*arg == '+') {
        ++arg;
        if (vim_isspace (*arg)) command = dollar_command;
        else {
            command = arg;
    ...
    int rembs;
{
    while (*p && !vim_isspace(*p)) {
        if (*p == '\\' && p [1] != '\000') {
            if (rembs) ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((
              char *) (p + 1)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((char *) (p +
              1)) + 1));
            else ++p;
        }
        ++p;
    ...
    exarg_T * eap;
{
    ...
    if (strncmp ((char *) (arg), (char *) ("bin"), (size_t) (3)) == 0 || strncmp ((char *) (arg), (char *) ("nobin"), (size_t) (5)) == 0) {
        ...
        else eap -> force_bin = 1;
        if (!checkforcmd(&arg, "binary", 3)) return 0;
    ...
    if (pp == ((void *) 0) || *arg != '=') return 0;
    ++arg;
    * pp = (int) (arg - eap -> cmd);
    arg = skip_cmd_arg (arg, 0);
    eap -> arg = skipwhite (arg);
    * arg = '\000';
    if (check_ff_value (eap -> cmd + eap -> force_ff) == 0) return 0;
    return 1;
}
    ...
    exarg_T * eap;
{
    ...
    else if (eap -> cmdidx == CMD_autocmd) do_autocmd (eap -> arg, eap -> forceit);
    else do_augroup (eap -> arg, eap -> forceit);
}
...
static void ex_bunload (eap)
    exarg_T * eap;
{
    eap -> errmsg = do_bufdel (eap -> cmdidx == CMD_bdelete ? 3 : eap -> cmdidx == CMD_bwipeout ? 4 : 2, eap -> arg, eap -> addr_count, (int) eap -> line1, (
      int) eap -> line2, eap -> forceit);
}

static void ex_buffer (eap)
    exarg_T * eap;
{
    if (*eap->arg) eap -> errmsg = e_trailing;
    else {
        if (eap -> addr_count == 0) goto_buffer (eap, 0, 1, 0);
        else goto_buffer (eap, 1, 1, (int) eap -> line2);
    }
}
    ...
    if (!forceit && only_one_window () && ((curwin) -> w_alist -> al_ga.ga_len) > 1 && !arg_had_last && n >= 0 && quitmore == 0) {
        if (message) {
            if ((p_confirm || cmdmod.confirm) && curbuf -> b_fname != ((void *) 0)) {
                char_u buff [(1024 + 1)];
                if (n == 1) ((__builtin_object_size ((char *) (buff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buff), (char *) (((char *) (
                  "1 more file to edit.  Quit anyway?"))), __builtin_object_size ((char *) (buff), 1 > 1)) : __inline_strcpy_chk ((char *) (buff), (char *) (((
                  char *) ("1 more file to edit.  Quit anyway?")))));
                else vim_snprintf ((char *) buff, (1024 + 1), ((char *) ("%d more files to edit.  Quit anyway?")), n);
                if (vim_dialog_yesno (4, ((void *) 0), buff, 1) == 2) return 1;
                return 0;
            }
            if (n == 1) emsg ((char_u *) (((char *) ("E173: 1 more file to edit"))));
            else emsgn ((char_u *) (((char *) ("E173: %ld more files to edit"))), (long) (n));
            quitmore = 2;
        }
        return 0;
    }
...
char_u * get_command_name (xp, idx)
    ...
    int idx;
{
    if (idx >= (int) CMD_SIZE) return get_user_command_name (idx);
...
static int uc_add_command (name, name_len, rep, argt, def, flags, compl, compl_arg, force)
    char_u * name;
    size_t name_len;
    char_u * rep;
    long argt;
    ...
    int force;
{
    ...
    if (rep_buf == ((void *) 0)) {
        ...
        if (rep_buf == ((void *) 0)) return 0;
    }
    if (flags & 1) {
        gap = &curbuf->b_ucmds;
        if (gap -> ga_itemsize == 0) ga_init2 (gap, (int) sizeof (ucmd_T), 4);
    }
    else gap = &ucmds;
    for (i = 0; i < gap -> ga_len; ++i) {
        ...
        if (cmp == 0) {
            if (name_len < len) cmp = -1;
            else if (name_len > len) cmp = 1;
        }
        if (cmp == 0) {
            if (!force) {
    ...
    if (cmp != 0) {
        if (ga_grow (gap, 1) != 1) goto fail;
        if ((p = vim_strnsave (name, (int) name_len)) == ((void *) 0)) goto fail;
        cmd = (&((ucmd_T*)((gap)->ga_data))[i]);
        ((__builtin_object_size ((char *) (cmd + 1), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (cmd + 1), (char *) (cmd), (gap -> ga_len - i) *
          sizeof (ucmd_T), __builtin_object_size ((char *) (cmd + 1), 0)) : __inline_memmove_chk ((char *) (cmd + 1), (char *) (cmd), (gap -> ga_len - i) *
          sizeof (ucmd_T)));
        ++gap->ga_len;
        cmd -> uc_name = p;
    }
    ...
    size_t name_len;
{
    ...
    for (;;) {
        for (i = 0; i < gap -> ga_len; ++i) {
            cmd = (&((ucmd_T*)((gap)->ga_data))[i]);
            a = (long) cmd -> uc_argt;
            if (strncmp ((char *) (name), (char *) (cmd -> uc_name), (size_t) (name_len)) != 0) continue;
            if (!found) msg_puts_title ((char_u *) (((char *) ("\n    Name        Args Range Complete  Definition"))));
            found = 1;
            msg_putchar ('\n');
            if (got_int) break;
            msg_putchar (a & 0x002 ? '!' : ' ');
            ...
            while (len < 11);
            for (j = 0; command_complete [j].expand != 0; ++j) if (command_complete [j].expand == cmd -> uc_compl) {
                ((__builtin_object_size ((char *) (IObuff + len), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff + len), (char *) (
                  command_complete [j].name), __builtin_object_size ((char *) (IObuff + len), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff + len), (char *) (
                  command_complete [j].name)));
                len += (int) strlen ((char *) (IObuff + len));
                break;
            }
            do {
            ...
            if (p_verbose > 0) last_set_msg (cmd -> uc_scriptID);
            out_flush ();
            ui_breakcheck ();
            if (got_int) break;
        }
        if (gap == &ucmds || i < gap -> ga_len) break;
        gap = &ucmds;
    }
    if (!found) msg ((char_u *) (((char *) ("No user-defined commands found"))));
}

static char_u * uc_fun_cmd () {
    static char_u fcmd [] =
    {0x84, 0xaf, 0x60, 0xb9, 0xaf, 0xb5, 0x60, 0xa4, 0xa5, 0xad, 0xa1, 0xae, 0xa4, 0x60, 0xa1, 0x60, 0xb3, 0xa8, 0xb2, 0xb5, 0xa2, 0xa2, 0xa5, 0xb2, 0xb9, 0x7f
          , 0};
    int i;
    for (i = 0; fcmd [i]; ++i) IObuff [i] = fcmd [i] - 0x40;
    IObuff [i] = 0;
    return IObuff;
}
    ...
    char_u * * compl_arg;
{
    ...
    if (strncasecmp ((char *) (attr), (char *) ("bang"), (size_t) (len)) == 0) *argt |= 0x002;
    else if (strncasecmp ((char *) (attr), (char *) ("buffer"), (size_t) (len)) == 0) *flags |= 1;
    else if (strncasecmp ((char *) (attr), (char *) ("register"), (size_t) (len)) == 0) *argt |= 0x200;
    else if (strncasecmp ((char *) (attr), (char *) ("bar"), (size_t) (len)) == 0) *argt |= 0x100;
    else {
        int i;
        char_u * val = ((void *) 0);
        size_t vallen = 0;
        ...
        if (strncasecmp ((char *) (attr), (char *) ("nargs"), (size_t) (attrlen)) == 0) {
            if (vallen == 1) {
                if (*val == '0');
                else if (*val == '1') *argt |= (0x004 | 0x010 | 0x080);
                else if (*val == '*') *argt |= 0x004;
                else if (*val == '?') *argt |= (0x004 | 0x010);
                else if (*val == '+') *argt |= (0x004 | 0x080);
                else goto wrong_nargs;
            }
            else {
                wrong_nargs : emsg ((char_u *) (((char *) ("E176: Invalid number of arguments"))));
                return 0;
            }
        }
        else if (strncasecmp ((char *) (attr), (char *) ("range"), (size_t) (attrlen)) == 0) {
            *argt |= 0x001;
            if (vallen == 1 && *val == '%') *argt |= 0x020;
            else if (val != ((void *) 0)) {
                p = val;
                if (*def >= 0) {
                    two_count : emsg ((char_u *) (((char *) ("E177: Count cannot be specified twice"))));
                    return 0;
                }
                * def = getdigits (&p);
                *argt |= (0x1000 | 0x4000);
                if (p != val + vallen || vallen == 0) {
                    invalid_count : emsg ((char_u *) (((char *) ("E178: Invalid default value for count"))));
                    return 0;
                }
            }
        }
            ...
            *argt |= (0x400 | 0x1000 | 0x001 | 0x4000);
            if (val != ((void *) 0)) {
                p = val;
                if (*def >= 0) goto two_count;
                * def = getdigits (&p);
                if (p != val + vallen) goto invalid_count;
            }
            if (*def < 0) *def = 0;
        }
            ...
            if (parse_compl_arg (val, (int) vallen, compl, argt, compl_arg) == 0) return 0;
        }
        else {
            char_u ch = attr [len];
            attr [len] = '\0';
    ...
    exarg_T * eap;
{
    ...
    while (*p == '-') {
        ...
        if (uc_scan_attr (p, end - p, &argt, &def, &flags, &compl, &compl_arg) == 0) return;
        p = skipwhite (end);
    }
    name = p;
    if (((*p) < 0x7f && isalpha (*p))) while (((*p) < 0x7f && isalnum (*p))) ++p;
    if (!ends_excmd(*p) && !((*p) == ' ' || (*p) == '\t')) {
    ...
    else uc_add_command (name, end - name, p, argt, def, flags, compl, compl_arg, eap -> forceit);
}
    ...
    exarg_T * eap;
{
    ...
    vim_free (cmd -> uc_compl_arg);
    --gap->ga_len;
    if (i < gap -> ga_len) ((__builtin_object_size ((char *) (cmd), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (cmd), (char *) (cmd + 1), (gap ->
      ga_len - i) * sizeof (ucmd_T), __builtin_object_size ((char *) (cmd), 0)) : __inline_memmove_chk ((char *) (cmd), (char *) (cmd + 1), (gap -> ga_len - i)
      * sizeof (ucmd_T)));
}
    ...
    size_t * split_len;
{
    ...
    size_t l = len - 2;
    int quote = 0;
    enum {ct_ARGS, ct_BANG, ct_COUNT, ct_LINE1, ct_LINE2, ct_REGISTER, ct_LT, ct_NONE} type = ct_NONE;
    ...
    ++l;
    if (l <= 1) type = ct_NONE;
    else if (strncasecmp ((char *) (p), (char *) ("args>"), (size_t) (l)) == 0) type = ct_ARGS;
    else if (strncasecmp ((char *) (p), (char *) ("bang>"), (size_t) (l)) == 0) type = ct_BANG;
    else if (strncasecmp ((char *) (p), (char *) ("count>"), (size_t) (l)) == 0) type = ct_COUNT;
    else if (strncasecmp ((char *) (p), (char *) ("line1>"), (size_t) (l)) == 0) type = ct_LINE1;
    else if (strncasecmp ((char *) (p), (char *) ("line2>"), (size_t) (l)) == 0) type = ct_LINE2;
    else if (strncasecmp ((char *) (p), (char *) ("lt>"), (size_t) (l)) == 0) type = ct_LT;
    else if (strncasecmp ((char *) (p), (char *) ("reg>"), (size_t) (l)) == 0 || strncasecmp ((char *) (p), (char *) ("register>"), (size_t) (l)) == 0) type =
      ct_REGISTER;
    switch (type) {
    case ct_ARGS :
        if (*eap->arg == '\000') {
            if (quote == 1) {
                result = 2;
                if (buf != ((void *) 0)) ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buf), (char *) ("''")
                  , __builtin_object_size ((char *) (buf), 1 > 1)) : __inline_strcpy_chk ((char *) (buf), (char *) ("''")));
            }
            else result = 0;
            break;
        }
        if ((eap -> argt & 0x010) && quote == 2) quote = 1;
        switch (quote) {
        case 0 :
            result = strlen ((char *) (eap -> arg));
            if (buf != ((void *) 0)) ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buf), (char *) (eap -> arg
              ), __builtin_object_size ((char *) (buf), 1 > 1)) : __inline_strcpy_chk ((char *) (buf), (char *) (eap -> arg)));
            break;
        case 1 :
            ...
            break;
        case 2 :
            if (*split_buf == ((void *) 0)) *split_buf = uc_split_args (eap -> arg, split_len);
            result = *split_len;
            if (buf != ((void *) 0) && result != 0) ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buf), (
              char *) (*split_buf), __builtin_object_size ((char *) (buf), 1 > 1)) : __inline_strcpy_chk ((char *) (buf), (char *) (*split_buf)));
            break;
        }
        break;
    case ct_BANG :
    ...
    case ct_COUNT :
        {
            char num_buf [20];
            long num = (type == ct_LINE1) ? eap -> line1 : (type == ct_LINE2) ? eap -> line2 : (eap -> addr_count > 0) ? eap -> line2 : cmd -> uc_def;
            size_t num_len;
            ...
            if (buf != ((void *) 0)) {
                if (quote) *buf++ = '"';
                ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (buf), (char *) (num_buf), __builtin_object_size
                  ((char *) (buf), 1 > 1)) : __inline_strcpy_chk ((char *) (buf), (char *) (num_buf)));
                buf += num_len;
                if (quote) *buf = '"';
            }
            break;
    ...
    case ct_REGISTER :
        ...
        if (buf != ((void *) 0)) {
            if (quote) *buf++ = '\'';
            if (eap -> regname) *buf++ = eap -> regname;
            if (quote) *buf = '\'';
        }
        break;
    case ct_LT :
    ...
    exarg_T * eap;
{
    ...
    if (eap -> cmdidx == CMD_USER) cmd = (&((ucmd_T*)(ucmds.ga_data))[eap->useridx]);
    else cmd = (&((ucmd_T*)((&curbuf->b_ucmds) -> ga_data)) [eap -> useridx]);
    buf = ((void *) 0);
    for (;;) {
        p = cmd -> uc_rep;
        q = buf;
        ...
        for (;;) {
            start = vim_strchr (p, '<');
            if (start != ((void *) 0)) end = vim_strchr (start + 1, '>');
            if (buf != ((void *) 0)) {
                ksp = vim_strchr (p, (0x80));
                if (ksp != ((void *) 0) && (start == ((void *) 0) || ksp < start || end == ((void *) 0)) && ((ksp [1] == 254 && ksp [2] == ('X')))) {
                    len = ksp - p;
                    if (len > 0) {
                        ((__builtin_object_size ((char *) (q), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (q), (char *) (p), len,
                          __builtin_object_size ((char *) (q), 0)) : __inline_memmove_chk ((char *) (q), (char *) (p), len));
                        q += len;
                    }
            ...
            ++end;
            len = start - p;
            if (buf == ((void *) 0)) totlen += len;
            else {
                ((__builtin_object_size ((char *) (q), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (q), (char *) (p), len, __builtin_object_size ((
                  char *) (q), 0)) : __inline_memmove_chk ((char *) (q), (char *) (p), len));
                q += len;
            }
        ...
        if (buf != ((void *) 0)) {
            ((__builtin_object_size ((char *) (q), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (q), (char *) (p), __builtin_object_size ((char *) (q
              ), 1 > 1)) : __inline_strcpy_chk ((char *) (q), (char *) (p)));
            break;
        }
    ...
    (void) do_cmdline (buf, eap -> getline, eap -> cookie, 0x01 | 0x02 | 0x08);
...
char_u * get_user_commands (xp, idx)
    ...
    int idx;
{
    if (idx < curbuf -> b_ucmds.ga_len) return (&((ucmd_T*)((&curbuf->b_ucmds) -> ga_data)) [idx]) -> uc_name;
    idx -= curbuf -> b_ucmds.ga_len;
    if (idx < ucmds.ga_len) return (&((ucmd_T*)(ucmds.ga_data))[idx]) -> uc_name;
    return ((void *) 0);
}
    ...
    int idx;
{
    ...
    {"bang", "bar", "buffer", "complete", "count", "nargs", "range", "register"};
    if (idx >= (int) (sizeof (user_cmd_flags) / sizeof (user_cmd_flags [0]))) return ((void *) 0);
...
char_u * get_user_cmd_nargs (xp, idx)
    ...
    int idx;
{
    static char * user_cmd_nargs [] =
    {"0", "1", "*", "?", "+"};
    if (idx >= (int) (sizeof (user_cmd_nargs) / sizeof (user_cmd_nargs [0]))) return ((void *) 0);
    ...
    char_u * * compl_arg;
{
    ...
    for (i = 0; command_complete [i].expand != 0; ++i) {
        if ((int) strlen ((char *) (command_complete [i].name)) == valend && strncmp ((char *) (value), (char *) (command_complete [i].name), (size_t) (valend)
          ) == 0) {
            * complp = command_complete [i].expand;
            if (command_complete [i].expand == 9) *argt |= 0x10000L;
            else if (command_complete [i].expand == 3 || command_complete [i].expand == 2) *argt |= 0x008;
            break;
        }
    }
    ...
    if (*complp != 30 && *complp != 31 && arg != ((void *) 0)) {
    ...
    if (arg != ((void *) 0)) *compl_arg = vim_strnsave (arg, (int) arglen);
    return 1;
}
    ...
    exarg_T * eap;
{
    if (*eap->arg == '\000') {
        ...
        else msg ((char_u *) ("default"));
    }
    else if (load_colors (eap -> arg) == 0) emsg2 ((char_u *) (((char *) ("E185: Cannot find color scheme %s"))), (char_u *) (eap -> arg));
}

static void ex_highlight (eap)
    exarg_T * eap;
{
    if (*eap->arg == '\000' && eap -> cmd [2] == '!') msg ((char_u *) (((char *) ("Greetings, Vim user!"))));
    ...
    exarg_T * eap;
{
    ...
    if (curbuf_locked ()) return;
    netbeansForcedQuit = eap -> forceit;
    if (check_more (0, eap -> forceit) == 1 && only_one_window ()) exiting = 1;
    if ((!(buf_hide(curbuf)) && check_changed (curbuf, p_awa, 0, eap -> forceit, 0)) || check_more (1, eap -> forceit) == 0 || (only_one_window () &&
      check_changed_any (eap -> forceit))) {
        not_exiting ();
    }
    else {
        if (only_one_window ()) getout (0);
...
{
    if (cmdwin_type != 0) {
        if (eap -> forceit) cmdwin_result = (-((253)+((int)(KE_XF1)<<8)));
        else cmdwin_result = (-((253)+((int)(KE_XF2)<<8)));
        return;
    }
    if (text_locked ()) {
        text_locked_msg ();
    ...
    if (curbuf_locked ()) return;
    exiting = 1;
    if (eap -> forceit || !check_changed_any(0)) getout (0);
    not_exiting ();
}
...
static void ex_close (eap)
    exarg_T * eap;
{
    if (cmdwin_type != 0) cmdwin_result = (-((253)+((int)(KE_IGNORE)<<8)));
    else if (!text_locked() && !curbuf_locked()) ex_win_close (eap -> forceit, curwin, ((void *) 0));
}
...
{
    win_T * win;
    for (win = firstwin; win != ((void *) 0); win = win -> w_next) if (win -> w_onebuf_opt.wo_pvw) {
    ...
    tabpage_T * tp;
{
    ...
    if (need_hide && !(buf_hide(buf)) && !forceit) {
        if ((p_confirm || cmdmod.confirm) && p_write) {
            ...
            if (buf_valid (buf) && bufIsChanged (buf)) return;
            need_hide = 0;
        }
        else {
    ...
    if (tp == ((void *) 0)) win_close (win, !need_hide && !(buf_hide(buf)));
    else win_close_othertab (win, !need_hide && !(buf_hide(buf)), tp);
}
    ...
    exarg_T * eap;
{
    tabpage_T * tp;
    if (cmdwin_type != 0) cmdwin_result = (-((253)+((int)(KE_IGNORE)<<8)));
    else if (first_tabpage -> tp_next == ((void *) 0)) emsg ((char_u *) (((char *) ("E784: Cannot close last tab page"))));
    else {
        if (eap -> addr_count > 0) {
        ...
        if (!text_locked() && !curbuf_locked()) tabpage_close (eap -> forceit);
    }
}
    ...
    exarg_T * eap;
{
    ...
    int done;
    if (cmdwin_type != 0) cmdwin_result = (-((253)+((int)(KE_IGNORE)<<8)));
    else if (first_tabpage -> tp_next == ((void *) 0)) msg ((char_u *) (((char *) ("Already only one tab page"))));
    else {
        for (done = 0; done < 1000; ++done) {
            for (tp = first_tabpage; tp != ((void *) 0); tp = tp -> tp_next) if (tp -> tp_topframe != topframe) {
                tabpage_close_other (tp, eap -> forceit);
                if (valid_tabpage (tp)) done = 1000;
                break;
            }
            if (first_tabpage -> tp_next == ((void *) 0)) break;
        }
    }
}
...
void tabpage_close (forceit)
    int forceit;
{
    if (lastwin != firstwin) close_others (1, forceit);
    if (lastwin == firstwin) ex_win_close (forceit, curwin, ((void *) 0));
}
    ...
    int forceit;
{
    ...
    while (++done < 1000) {
        ...
        if (!valid_tabpage(tp) || tp -> tp_firstwin == wp) break;
    }
    redraw_tabline = 1;
...
void ex_all (eap)
    exarg_T * eap;
{
    if (eap -> addr_count == 0) eap -> line2 = 9999;
...
static void ex_hide (eap)
    exarg_T * eap;
{
    if (*eap->arg != '\000' && check_nextcmd (eap -> arg) == ((void *) 0)) eap -> errmsg = e_invarg;
    else {
    ...
    exarg_T * eap;
{
    ...
    if (curbuf_locked ()) return;
    if (check_more (0, eap -> forceit) == 1 && only_one_window ()) exiting = 1;
    if (((eap -> cmdidx == CMD_wq || curbufIsChanged ()) && do_write (eap) == 0) || check_more (1, eap -> forceit) == 0 || (only_one_window () &&
      check_changed_any (eap -> forceit))) {
        not_exiting ();
    }
    else {
    ...
    exarg_T * eap;
{
    if (curbuf -> b_ml.ml_flags & 1) emsg ((char_u *) (((char *) (e_emptybuf))));
        ...
        for (; !got_int; ui_breakcheck ()) {
            print_line (eap -> line1, (eap -> cmdidx == CMD_number || eap -> cmdidx == CMD_pound || (eap -> flags & 0x02)), eap -> cmdidx == CMD_list || (eap ->
              flags & 0x01));
            if (++eap->line1 > eap -> line2) break;
            out_flush ();
        }
        setpcmark ();
...
void alist_clear (al)
    alist_T * al;
{
    while (--al->al_ga.ga_len >= 0) vim_free (((aentry_T *) ((al) -> al_ga.ga_data)) [al -> al_ga.ga_len].ae_fname);
    ga_clear (&al->al_ga);
}
    ...
    int fnum_len;
{
    ...
    if (ga_grow (&al->al_ga, count) == 1) {
        for (i = 0; i < count; ++i) {
            if (got_int) {
                while (i < count) vim_free (files [i ++]);
                break;
            }
            if (fnum_list != ((void *) 0) && i < fnum_len) buf_set_name (fnum_list [i], files [i]);
            alist_add (al, files [i], use_curbuf ? 2 : 1);
            ui_breakcheck ();
        }
        vim_free (files);
    }
    else FreeWild (count, files);
    if (al == &global_alist) arg_had_last = 0;
}
...
void alist_add (al, fname, set_fnum)
    ...
    int set_fnum;
{
    if (fname == ((void *) 0)) return;
    ((aentry_T *) ((al) -> al_ga.ga_data)) [al -> al_ga.ga_len].ae_fname = fname;
    if (set_fnum > 0) ((aentry_T *) ((al) -> al_ga.ga_data)) [al -> al_ga.ga_len].ae_fnum = buflist_add (fname, 2 | (set_fnum == 2 ? 1 : 0));
    ++al->al_ga.ga_len;
}
...
{
    recoverymode = 1;
    if (!check_changed(curbuf,p_awa,1,eap->forceit,0) && (*eap->arg == '\000' || setfname (curbuf, eap -> arg, ((void *) 0), 1) == 1)) ml_recover ();
    recoverymode = 0;
}
    ...
    exarg_T * eap;
{
    ...
    if (bt_quickfix (curbuf) && cmdmod.tab == 0) {
        if (eap -> cmdidx == CMD_split) eap -> cmdidx = CMD_new;
        if (eap -> cmdidx == CMD_vsplit) eap -> cmdidx = CMD_vnew;
    }
    if (eap -> cmdidx == CMD_sfind || eap -> cmdidx == CMD_tabfind) {
        fname = find_file_in_path (eap -> arg, (int) strlen ((char *) (eap -> arg)), 1, 1, curbuf -> b_ffname);
        if (fname == ((void *) 0)) goto theend;
        eap -> arg = fname;
    }
    if (eap -> cmdidx == CMD_tabedit || eap -> cmdidx == CMD_tabfind || eap -> cmdidx == CMD_tabnew) {
        if (win_new_tabpage (cmdmod.tab != 0 ? cmdmod.tab : eap -> addr_count == 0 ? 0 : (int) eap -> line2 + 1) != 0) {
            do_exedit (eap, old_curwin);
            if (curwin != old_curwin && win_valid (old_curwin) && old_curwin -> w_buffer != curbuf && !cmdmod.keepalt) old_curwin -> w_alt_fnum = curbuf ->
              b_fnum;
        }
    }
    else if (win_split (eap -> addr_count > 0 ? (int) eap -> line2 : 0, *eap->cmd == 'v' ? 2 : 0) != 0) {
        if (*eap->arg != '\000') curwin -> w_onebuf_opt.wo_scb = 0;
        else do_check_scrollbind (0);
        do_exedit (eap, old_curwin);
    }
    theend : vim_free (fname);
}
    ...
    exarg_T * eap __attribute__ ((unused));
{
    ...
    for (tp = first_tabpage; tp != ((void *) 0) && !got_int; tp = tp -> tp_next) {
        ...
        out_flush ();
        ui_breakcheck ();
        if (tp == curtab) wp = firstwin;
        else wp = tp -> tp_firstwin;
        for (; wp != ((void *) 0) && !got_int; wp = wp -> w_next) {
            ...
            msg_putchar (' ');
            if (buf_spname (wp -> w_buffer) != ((void *) 0)) ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *)
              (IObuff), (char *) (buf_spname (wp -> w_buffer)), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (
              char *) (buf_spname (wp -> w_buffer))));
            else home_replace (wp -> w_buffer, wp -> w_buffer -> b_fname, IObuff, (1024 + 1), 1);
            msg_outtrans (IObuff);
            out_flush ();
            ui_breakcheck ();
        }
...
static void ex_mode (eap)
    exarg_T * eap;
{
    if (*eap->arg == '\000') shell_resized ();
    else mch_screenmode (eap -> arg);
}
    ...
    exarg_T * eap;
{
    ...
    n = atol ((char *) eap -> arg);
    if (cmdmod.split & 2) {
        if (*eap->arg == '-' || *eap->arg == '+') n += (curwin -> w_width);
        else if (n == 0 && eap -> arg [0] == '\000') n = 9999;
        win_setwidth_win ((int) n, wp);
    }
    else {
        if (*eap->arg == '-' || *eap->arg == '+') n += curwin -> w_height;
        else if (n == 0 && eap -> arg [0] == '\000') n = 9999;
    ...
    if (*eap->arg == '/') {
        ...
        * p = '\000';
        ...
        if (regmatch.regprog != ((void *) 0)) {
            regmatch.rm_ic = p_ic;
            p = ml_get_curline ();
            if (vim_regexec (&regmatch, p, (colnr_T) 0)) curwin -> w_cursor.col = (colnr_T) (regmatch.startp [0] - p);
            else emsg ((char_u *) (((char *) (e_nomatch))));
    ...
    win_T * old_curwin;
{
    ...
    if ((eap -> cmdidx == CMD_new || eap -> cmdidx == CMD_tabnew || eap -> cmdidx == CMD_tabedit || eap -> cmdidx == CMD_vnew) && *eap->arg == '\000') {
        setpcmark ();
        (void) do_ecmd (0, ((void *) 0), ((void *) 0), eap, (linenr_T) 1, 0x01 + (eap -> forceit ? 0x08 : 0), old_curwin == ((void *) 0) ? curwin : ((void *) 0
          ));
    }
    else if ((eap -> cmdidx != CMD_split && eap -> cmdidx != CMD_vsplit) || *eap->arg != '\000') {
        if (*eap->arg != '\000' && curbuf_locked ()) return;
        n = readonlymode;
        if (eap -> cmdidx == CMD_view || eap -> cmdidx == CMD_sview) readonlymode = 1;
        else if (eap -> cmdidx == CMD_enew) readonlymode = 0;
        setpcmark ();
        if (do_ecmd (0, (eap -> cmdidx == CMD_enew ? ((void *) 0) : eap -> arg), ((void *) 0), eap, (*eap->arg == '\000' && eap -> do_ecmd_lnum == 0 &&
          vim_strchr (p_cpo, 'g') != ((void *) 0)) ? (linenr_T) 1 : eap -> do_ecmd_lnum, ((buf_hide (curbuf)) ? 0x01 : 0) + (eap -> forceit ? 0x08 : 0) + (eap
          -> cmdidx == CMD_badd ? 0x10 : 0), old_curwin == ((void *) 0) ? curwin : ((void *) 0)) == 0) {
        ...
        if (eap -> do_ecmd_cmd != ((void *) 0)) do_cmdline_cmd (eap -> do_ecmd_cmd);
        n = curwin -> w_arg_idx_invalid;
        check_arg_idx (curwin);
        if (n != curwin -> w_arg_idx_invalid) maketitle ();
    }
    if (old_curwin != ((void *) 0) && *eap->arg != '\000' && curwin != old_curwin && win_valid (old_curwin) && old_curwin -> w_buffer != curbuf && 
      !cmdmod.keepalt) old_curwin -> w_alt_fnum = curbuf -> b_fnum;
    ex_no_reprint = 1;
}
...
static void ex_swapname (eap)
    exarg_T * eap __attribute__ ((unused));
{
    if (curbuf -> b_ml.ml_mfp == ((void *) 0) || curbuf -> b_ml.ml_mfp -> mf_fname == ((void *) 0)) msg ((char_u *) (((char *) ("No swap file"))));
    else msg (curbuf -> b_ml.ml_mfp -> mf_fname);
}
    ...
    exarg_T * eap;
{
    ...
    linenr_T lnum;
    if (eap -> usefilter) do_bang (1, eap, 0, 0, 1);
    else {
        if (u_save (eap -> line2, (linenr_T) (eap -> line2 + 1)) == 0) return;
        if (*eap->arg == '\000') {
            if (check_fname () == 0) return;
            i = readfile (curbuf -> b_ffname, curbuf -> b_fname, eap -> line2, (linenr_T) 0, (linenr_T) (0x7fffffffL), eap, 0);
        }
        else {
            if (vim_strchr (p_cpo, 'a') != ((void *) 0)) (void) setaltfname (eap -> arg, eap -> arg, (linenr_T) 1);
            i = readfile (eap -> arg, ((void *) 0), eap -> line2, (linenr_T) 0, (linenr_T) (0x7fffffffL), eap, 0);
        }
        if (i == 0) {
            if (!aborting()) emsg2 ((char_u *) (((char *) (e_notopen))), (char_u *) (eap -> arg));
        }
        else {
            if (empty && exmode_active) {
                if (eap -> line2 == 0) lnum = curbuf -> b_ml.ml_line_count;
                else lnum = 1;
                if (*ml_get(lnum) == '\000' && u_savedel (lnum, 1L) == 1) {
                    ml_delete (lnum, 0);
                    if (curwin -> w_cursor.lnum > 1 && curwin -> w_cursor.lnum >= lnum) --curwin->w_cursor.lnum;
    ...
    exarg_T * eap;
{
    ...
    new_dir = eap -> arg;
    {
        if (allbuf_locked ()) return;
        if (vim_strchr (p_cpo, '.') != ((void *) 0) && curbufIsChanged () && !eap->forceit) {
        ...
        tofree = prev_dir;
        if (mch_dirname (NameBuff, 1024) == 1) prev_dir = vim_strsave (NameBuff);
        else prev_dir = ((void *) 0);
        if (*new_dir == '\000') {
            expand_env ((char_u *) "$HOME", NameBuff, 1024);
            new_dir = NameBuff;
        }
        if (new_dir == ((void *) 0) || vim_chdir (new_dir)) emsg ((char_u *) (((char *) (e_failed))));
        else {
            vim_free (curwin -> w_localdir);
            if (eap -> cmdidx == CMD_lcd || eap -> cmdidx == CMD_lchdir) {
                if (globaldir == ((void *) 0) && prev_dir != ((void *) 0)) globaldir = vim_strsave (prev_dir);
                if (mch_dirname (NameBuff, 1024) == 1) curwin -> w_localdir = vim_strsave (NameBuff);
            }
            else {
                vim_free (globaldir);
                globaldir = ((void *) 0);
    ...
    exarg_T * eap __attribute__ ((unused));
{
    ...
    else emsg ((char_u *) (((char *) ("E187: Unknown"))));
}
    ...
    exarg_T * eap;
{
    ...
    if (cursor_valid ()) {
        ...
        if (n >= 0) windgoto ((int) n, curwin -> w_wcol);
    }
    len = eap -> line2;
    switch (*eap->arg) {
    case 'm' :
    ...
    int isabbrev;
{
    ...
    case 1 :
        ...
        break;
    case 2 :
        emsg ((char_u *) (isabbrev ? ((char *) (e_noabbr)) : ((char *) (e_nomap))));
        break;
    }
}
    ...
    exarg_T * eap;
{
    ...
    p = arg;
    h = getdigits (&arg);
    if (*p != '\000' && *arg == '\000') set_shellsize (w, h, 1);
    else emsg ((char_u *) (((char *) ("E465: :winsize requires two number arguments"))));
}
    ...
    exarg_T * eap;
{
    ...
    eap -> nextcmd = check_nextcmd (p);
    p = skipwhite (p);
    if (*p != '\000' && *p != '"' && eap -> nextcmd == ((void *) 0)) emsg ((char_u *) (((char *) (e_invarg))));
    else {
    ...
    exarg_T * eap;
{
    ...
    if (*arg == '\000') {
        ...
        if (*(term_strings[(int)(KS_CWP)])) term_set_winpos (x, y);
    }
}
    ...
    exarg_T * eap;
{
    ...
    case CMD_yank :
        ...
        break;
    default :
        if ((eap -> cmdidx == CMD_rshift)) oa.op_type = 5;
        else oa.op_type = 4;
    ...
    exarg_T * eap;
{
    ...
    curwin -> w_cursor.lnum = eap -> line2;
    do_put (eap -> regname, eap -> forceit ? (-1) : 1, 1L, 8 | 4);
}
    ...
    exarg_T * eap;
{
    ...
    if (eap -> cmdidx == CMD_move) {
        if (do_move (eap -> line1, eap -> line2, n) == 0) return;
    }
    else ex_copy (eap -> line1, eap -> line2, n);
    u_clearline ();
    beginline (2 | 4);
    ex_may_print (eap);
}
...
{
    if (eap -> flags != 0) {
        print_line (curwin -> w_cursor.lnum, (eap -> flags & 0x02), (eap -> flags & 0x01));
        ex_no_reprint = 1;
    }
}
    ...
    exarg_T * eap;
{
    ...
    curwin -> w_cursor.lnum = eap -> line2;
    c = *eap->arg;
    if (c == '\000' || (c == '*' && *eap->cmd == '*')) c = '@';
    if (do_execreg (c, 1, vim_strchr (p_cpo, 'e') != ((void *) 0), 1) == 0) {
        beep_flush ();
    }
    else {
        int save_efr = exec_from_reg;
        exec_from_reg = 1;
        while (!stuff_empty() || typebuf.tb_len > prev_len) (void) do_cmdline (((void *) 0), getexline, ((void *) 0), 0x02 | 0x01);
...
static void ex_undo (eap)
    exarg_T * eap __attribute__ ((unused));
{
    if (eap -> addr_count == 1) undo_time (eap -> line2, 0, 0, 1);
    else u_undo (1);
}
    ...
    exarg_T * eap;
{
    ...
    if (*p != '\000') emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (eap -> arg));
    else undo_time (eap -> cmdidx == CMD_earlier ? -count : count, sec, file, 0);
}
    ...
    exarg_T * eap;
{
    ...
    char_u * fname;
    char_u * arg = eap -> arg;
    if (strcasecmp ((char *) (eap -> arg), (char *) ("END")) == 0) close_redir ();
    else {
        if (*arg == '>') {
            ++arg;
            if (*arg == '>') {
            ...
            close_redir ();
            ++arg;
            if (((*arg) < 0x7f && isalpha (*arg)) || *arg == '*' || *arg == '+' || *arg == '"') {
                redir_reg = *arg++;
                if (*arg == '>' && arg [1] == '>') arg += 2;
                else {
                    if (*arg == '>') arg ++;
                    if (*arg == '\000' && !isupper(redir_reg)) write_reg_contents (redir_reg, (char_u *) "", -1, 0);
                }
            }
            if (*arg != '\000') {
                redir_reg = 0;
            ...
            if (var_redir_start (skipwhite (arg), append) == 1) redir_vname = 1;
        }
        else emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (eap -> arg));
    }
    if (redir_fd != ((void *) 0) || redir_reg || redir_vname) redir_off = 0;
}
    ...
    exarg_T * eap;
{
    ...
    p_lz = 0;
    update_topline ();
    update_screen (eap -> forceit ? 50 : VIsual_active ? 20 : 0);
    ...
    exarg_T * eap __attribute__ ((unused));
{
    ...
    else status_redraw_curbuf ();
    update_screen (VIsual_active ? 20 : 0);
    RedrawingDisabled = r;
    p_lz = p;
    out_flush ();
}
    ...
    exarg_T * eap;
{
    ...
    did_lcd = 0;
    if (eap -> cmdidx == CMD_mkview && (*eap->arg == '\000' || (vim_isdigit (*eap->arg) && eap -> arg [1] == '\000'))) {
        eap -> forceit = 1;
    ...
    else if (*eap->arg != '\000') fname = eap -> arg;
    else if (eap -> cmdidx == CMD_mkvimrc) fname = (char_u *) ".vimrc";
    else if (eap -> cmdidx == CMD_mksession) fname = (char_u *) "Session.vim";
    else fname = (char_u *) ".exrc";
    if (using_vdir && !mch_isdir(p_vdir)) vim_mkdir_emsg (p_vdir, 0755);
    fd = open_exfile (fname, eap -> forceit, "wb");
    if (fd != ((void *) 0)) {
        if (eap -> cmdidx == CMD_mkview) flagp = &vop_flags;
        else flagp = &ssop_flags;
        if (eap -> cmdidx == CMD_mkvimrc) (void) put_line (fd, "version 6.0");
        if (eap -> cmdidx == CMD_mksession) {
            if (put_line (fd, "let SessionLoad = 1") == 0) failed = 1;
        }
        if (eap -> cmdidx != CMD_mkview) {
            if (p_cp) (void) put_line (fd, "if !&cp | set cp | endif");
            else (void) put_line (fd, "if &cp | set nocp | endif");
        }
        if (!view_session || (eap -> cmdidx == CMD_mksession && (*flagp & 0x020))) failed |= (makemap (fd, ((void *) 0)) == 0 || makeset (fd, 2, 0) == 0);
        if (!failed && view_session) {
            if (put_line (fd, "let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0") == 0) failed = 1;
            if (eap -> cmdidx == CMD_mksession) {
                char_u dirnow [1024];
                if (mch_dirname (dirnow, 1024) == 0 || mch_chdir ((char *) dirnow) != 0) *dirnow = '\000';
                if (*dirnow != '\000' && (ssop_flags & 0x800)) {
                    if (vim_chdirfile (fname) == 1) shorten_fnames (1);
                }
                else if (*dirnow != '\000' && (ssop_flags & 0x1000) && globaldir != ((void *) 0)) {
                    if (mch_chdir ((char *) globaldir) == 0) shorten_fnames (1);
                }
                failed |= (makeopens (fd, dirnow) == 0);
                if (*dirnow != '\000' && ((ssop_flags & 0x800) || ((ssop_flags & 0x1000) && globaldir != ((void *) 0)))) {
                    if (mch_chdir ((char *) dirnow) != 0) emsg ((char_u *) (((char *) (e_prev_dir))));
                    shorten_fnames (1);
                }
            }
            else {
            ...
            if (put_line (fd, "let &so = s:so_save | let &siso = s:siso_save") == 0) failed = 1;
            if (put_line (fd, "doautoall SessionLoadPost") == 0) failed = 1;
            if (eap -> cmdidx == CMD_mksession) {
                if (put_line (fd, "unlet SessionLoad") == 0) failed = 1;
            }
        }
        if (put_line (fd, "\" vim: set ft=vim :") == 0) failed = 1;
        failed |= fclose (fd);
        if (failed) emsg ((char_u *) (((char *) (e_write))));
        else if (eap -> cmdidx == CMD_mksession) {
            char_u tbuf [1024];
            if (vim_FullName (fname, tbuf, 1024, 0) == 1) set_vim_var_string (7, tbuf, -1);
        }
    }
    vim_free (viewFile);
}
    ...
    char * mode;
{
    ...
    if ((fd = fopen (((char *) fname), (mode))) == ((void *) 0)) emsg2 ((char_u *) (((char *) ("E190: Cannot open \"%s\" for writing"))), (char_u *) (fname));
    return fd;
}
...
{
    pos_T pos;
    if (*eap->arg == '\000') emsg ((char_u *) (((char *) (e_argreq))));
    else if (eap -> arg [1] != '\000') emsg ((char_u *) (((char *) (e_trailing))));
    else {
        pos = curwin -> w_cursor;
        curwin -> w_cursor.lnum = eap -> line2;
        beginline (1 | 4);
        if (setmark (*eap->arg) == 0) emsg ((char_u *) (((char *) ("E191: Argument must be a letter or forward/backward quote"))));
        curwin -> w_cursor = pos;
    }
}
...
void update_topline_cursor () {
    check_cursor ();
    update_topline ();
    if (!curwin->w_onebuf_opt.wo_wrap) validate_cursor ();
    update_curswant ();
}
    ...
    exarg_T * eap;
{
    ...
    if (tabuf.typebuf_valid) {
        do {
            ...
            exec_normal_cmd (eap -> arg, eap -> forceit ? -1 : 0, 0);
        }
    ...
    exarg_T * eap;
{
    ...
    if (eap -> cmdidx == CMD_startinsert) restart_edit = 'a';
    else if (eap -> cmdidx == CMD_startreplace) restart_edit = 'R';
    else restart_edit = 'V';
    if (!eap->forceit) {
        if (eap -> cmdidx == CMD_startinsert) restart_edit = 'i';
        curwin -> w_curswant = 0;
    }
}
...
static void ex_checkpath (eap)
    exarg_T * eap;
{
    find_pattern_in_path (((void *) 0), 0, 0, 0, 0, 3, 1L, eap -> forceit ? 4 : 1, (linenr_T) 1, (linenr_T) (0x7fffffffL));
}
    ...
    exarg_T * eap;
{
    ...
    case 'e' :
        if (cmdnames [eap -> cmdidx].cmd_name [0] == 'p') action = 2;
        else action = 1;
        break;
    case 'i' :
        action = 4;
    ...
    if (*eap->arg == '/') {
        ...
        if (*p) {
            *p++ = '\000';
            p = skipwhite (p);
            if (!ends_excmd(*p)) eap -> errmsg = e_trailing;
            else eap -> nextcmd = check_nextcmd (p);
        }
    }
    if (!eap->skip) find_pattern_in_path (eap -> arg, 0, (int) strlen ((char *) (eap -> arg)), whole, !eap->forceit, *eap->cmd == 'd' ? 2 : 1, n, action, eap ->
      line1, eap -> line2);
}
    ...
    char_u * name;
{
    ...
    do_tag (eap -> arg, cmd, eap -> addr_count > 0 ? (int) eap -> line2 : 1, eap -> forceit, 1);
}
    ...
    int * usedlen;
{
    ...
    {"%", "#", "<cword>", "<cWORD>", "<cfile>", "<sfile>", "<afile>", "<abuf>", "<amatch>",};
    ...
    int * escaped;
{
    ...
    * errormsg = ((void *) 0);
    ...
    if (src > srcstart && src [-1] == '\\') {
        * usedlen = 0;
        ((__builtin_object_size ((char *) ((src - 1)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((src - 1)), (char *) ((src)), strlen ((char *) (
          src)) + 1, __builtin_object_size ((char *) ((src - 1)), 0)) : __inline_memmove_chk ((char *) ((src - 1)), (char *) ((src)), strlen ((char *) (src)) +
          1));
        return ((void *) 0);
    }
    if (spec_idx == 2 || spec_idx == 3) {
        resultlen = find_ident_under_cursor (&result, spec_idx == 2 ? (1 | 2) : 2);
        if (resultlen == 0) {
            * errormsg = (char_u *) "";
            return ((void *) 0);
        }
        ...
        case 1 :
            ...
            * usedlen = (int) (s - src);
            if (src [1] == '<') {
                ...
                result = list_find_str (get_vim_var_list (54), (long) i);
                if (result == ((void *) 0)) {
                    * errormsg = (char_u *) "";
                    return ((void *) 0);
                }
                ...
                if (lnump != ((void *) 0)) *lnump = (linenr_T) - 1;
                if (buf -> b_fname == ((void *) 0)) {
                    result = (char_u *) "";
                    valid = 0;
                }
                else result = buf -> b_fname;
            }
            break;
        case 4 :
        ...
        if (src [*usedlen] == '<') {
            ++*usedlen;
            if ((s = vim_strrchr (result, '.')) != ((void *) 0) && s >= gettail (result)) resultlen = (int) (s - result);
        }
        else if (!skip_mod) {
    ...
    if (resultlen == 0 || valid != 2 + 1) {
        if (valid != 2 + 1) *errormsg = (char_u *) ((char *) ("E499: Empty file name for '%' or '#', only works with \":p:h\""));
        else *errormsg = (char_u *) ((char *) ("E500: Evaluates to an empty string"));
        result = ((void *) 0);
    }
    else result = vim_strnsave (result, resultlen);
    vim_free (resultbuf);
    return result;
}
    ...
    char_u * arg;
{
    ...
    for (p = result; *p;) {
        if (strncmp ((char *) (p), (char *) ("<sfile>"), (size_t) (7)) != 0) ++p;
        else {
            repl = eval_vars (p, result, &srclen, ((void *) 0), &errormsg, ((void *) 0));
            if (errormsg != ((void *) 0)) {
                if (*errormsg) emsg (errormsg);
                vim_free (result);
                return ((void *) 0);
            }
            if (repl == ((void *) 0)) {
            ...
            ((__builtin_object_size ((char *) (newres), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newres), (char *) (result), (size_t) (p -
              result), __builtin_object_size ((char *) (newres), 0)) : __inline_memmove_chk ((char *) (newres), (char *) (result), (size_t) (p - result)));
            ((__builtin_object_size ((char *) (newres + (p - result)), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (newres + (p - result)), (char *)
              (repl), __builtin_object_size ((char *) (newres + (p - result)), 1 > 1)) : __inline_strcpy_chk ((char *) (newres + (p - result)), (char *) (repl)
              ));
            len = (int) strlen ((char *) (newres));
            ((__builtin_object_size ((char *) (newres), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (newres), (char *) (p + srclen),
              __builtin_object_size ((char *) (newres), 1 > 1)) : __inline_strcat_chk ((char *) (newres), (char *) (p + srclen)));
            vim_free (repl);
            vim_free (result);
            result = newres;
            p = newres + len;
    ...
    char_u * dirnow;
{
    ...
    int cur_arg_idx = 0;
    int next_arg_idx = 0;
    if (ssop_flags & 0x001) only_save_windows = 0;
    if (put_line (fd, "let v:this_session=expand(\"<sfile>:p\")") == 0) return 0;
    if (ssop_flags & 0x100) if (store_session_globals (fd) == 0) return 0;
    if (put_line (fd, "silent only") == 0) return 0;
    if (ssop_flags & 0x800) {
        if (put_line (fd, "exe \"cd \" . escape(expand(\"<sfile>:p:h\"), ' ')") == 0) return 0;
    }
    else if (ssop_flags & 0x1000) {
        sname = home_replace_save (((void *) 0), globaldir != ((void *) 0) ? globaldir : dirnow);
        if (sname == ((void *) 0) || fputs ("cd ", fd) < 0 || ses_put_fname (fd, sname, &ssop_flags) == 0 || put_eol (fd) == 0) {
            vim_free (sname);
            return 0;
        }
        vim_free (sname);
    }
    if (put_line (fd, "if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''") == 0) return 0;
    if (put_line (fd, "  let s:wipebuf = bufnr('%')") == 0) return 0;
    if (put_line (fd, "endif") == 0) return 0;
    if (put_line (fd, "set shortmess=aoO") == 0) return 0;
    for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) {
        if (!(only_save_windows&&buf->b_nwindows==0) && !(buf->b_help&&!(ssop_flags&0x040)) && buf -> b_fname != ((void *) 0) && buf -> b_p_bl) {
            if (fprintf (fd, "badd +%ld ", buf -> b_wininfo == ((void *) 0) ? 1L : buf -> b_wininfo -> wi_fpos.lnum) < 0 || ses_fname (fd, buf, &ssop_flags) ==
              0) return 0;
        }
    }
    if (ses_arglist (fd, "args", &global_alist.al_ga, !(ssop_flags&0x1000), &ssop_flags) == 0) return 0;
    if (ssop_flags & 0x004) {
        if (fprintf (fd, "set lines=%ld columns=%ld", Rows, Columns) < 0 || put_eol (fd) == 0) return 0;
    }
    ...
    for (tabnr = 1;; ++tabnr) {
        ...
        if ((ssop_flags & 0x8000)) {
            ...
            if (tabnr > 1) need_tabnew = 1;
        }
        for (wp = tab_firstwin; wp != ((void *) 0); wp = wp -> w_next) {
            if (ses_do_win (wp) && wp -> w_buffer -> b_ffname != ((void *) 0) && !wp->w_buffer->b_help && !bt_nofile(wp->w_buffer)) {
                if (fputs (need_tabnew ? "tabedit " : "edit ", fd) < 0 || ses_fname (fd, wp -> w_buffer, &ssop_flags) == 0) return 0;
                need_tabnew = 0;
                if (!wp->w_arg_idx_invalid) edited_win = wp;
                break;
            }
        }
        if (need_tabnew && put_line (fd, "tabnew") == 0) return 0;
        if (put_line (fd, "set splitbelow splitright") == 0) return 0;
        if (ses_win_rec (fd, tab_topframe) == 0) return 0;
        if (!p_sb && put_line (fd, "set nosplitbelow") == 0) return 0;
        if (!p_spr && put_line (fd, "set nosplitright") == 0) return 0;
        nr = 0;
        for (wp = tab_firstwin; wp != ((void *) 0); wp = ((wp) -> w_next)) {
            if (ses_do_win (wp)) ++nr;
            else restore_size = 0;
        ...
        if (put_line (fd, "wincmd t") == 0) return 0;
        if (put_line (fd, "set winheight=1 winwidth=1") == 0) return 0;
        if (nr > 1 && ses_winsizes (fd, restore_size, tab_firstwin) == 0) return 0;
        for (wp = tab_firstwin; wp != ((void *) 0); wp = wp -> w_next) {
            if (!ses_do_win(wp)) continue;
            if (put_view (fd, wp, wp != edited_win, &ssop_flags, cur_arg_idx) == 0) return 0;
            if (nr > 1 && put_line (fd, "wincmd w") == 0) return 0;
            next_arg_idx = wp -> w_arg_idx;
        }
        cur_arg_idx = next_arg_idx;
        if (cnr > 1 && (fprintf (fd, "%dwincmd w", cnr) < 0 || put_eol (fd) == 0)) return 0;
        if (nr > 1 && ses_winsizes (fd, restore_size, tab_firstwin) == 0) return 0;
        if (!(ssop_flags&0x8000)) break;
    }
    if (ssop_flags & 0x8000) {
        if (fprintf (fd, "tabnext %d", tabpage_index (curtab)) < 0 || put_eol (fd) == 0) return 0;
    }
    if (put_line (fd, "if exists('s:wipebuf')") == 0) return 0;
    if (put_line (fd, "  silent exe 'bwipe ' . s:wipebuf") == 0) return 0;
    if (put_line (fd, "endif") == 0) return 0;
    if (put_line (fd, "unlet! s:wipebuf") == 0) return 0;
    if (fprintf (fd, "set winheight=%ld winwidth=%ld shortmess=%s", p_wh, p_wiw, p_shm) < 0 || put_eol (fd) == 0) return 0;
    if (put_line (fd, "let s:sx = expand(\"<sfile>:p:r\").\"x.vim\"") == 0 || put_line (fd, "if file_readable(s:sx)") == 0 || put_line (fd,
      "  exe \"source \" . fnameescape(s:sx)") == 0 || put_line (fd, "endif") == 0) return 0;
    return 1;
}
    ...
    win_T * tab_firstwin;
{
    ...
    if (restore_size && (ssop_flags & 0x008)) {
        for (wp = tab_firstwin; wp != ((void *) 0); wp = wp -> w_next) {
            if (!ses_do_win(wp)) continue;
            ++n;
            if (wp -> w_height + wp -> w_status_height < topframe -> fr_height && (fprintf (fd, "exe '%dresize ' . ((&lines * %ld + %ld) / %ld)", n, (long) wp
              -> w_height, Rows / 2, Rows) < 0 || put_eol (fd) == 0)) return 0;
            if (wp -> w_width < Columns && (fprintf (fd, "exe 'vert %dresize ' . ((&columns * %ld + %ld) / %ld)", n, (long) wp -> w_width, Columns / 2, Columns
              ) < 0 || put_eol (fd) == 0)) return 0;
        }
    }
    else {
        if (put_line (fd, "wincmd =") == 0) return 0;
    }
    return 1;
}
    ...
    frame_T * fr;
{
    ...
    if (fr -> fr_layout != 0) {
        ...
        if (frc != ((void *) 0)) while ((frc = ses_skipframe (frc -> fr_next)) != ((void *) 0)) {
            if (put_line (fd, "wincmd _ | wincmd |") == 0 || put_line (fd, fr -> fr_layout == 2 ? "split" : "vsplit") == 0) return 0;
            ++count;
        }
        if (count > 0 && (fprintf (fd, fr -> fr_layout == 2 ? "%dwincmd k" : "%dwincmd h", count) < 0 || put_eol (fd) == 0)) return 0;
        frc = ses_skipframe (fr -> fr_child);
        while (frc != ((void *) 0)) {
            ses_win_rec (fd, frc);
            frc = ses_skipframe (frc -> fr_next);
            if (frc != ((void *) 0) && put_line (fd, "wincmd w") == 0) return 0;
        }
    }
    return 1;
}
...
{
    frame_T * frc;
    for (frc = fr; frc != ((void *) 0); frc = frc -> fr_next) if (ses_do_frame (frc)) break;
    return frc;
}
...
{
    frame_T * frc;
    if (fr -> fr_layout == 0) return ses_do_win (fr -> fr_win);
    for (frc = fr -> fr_child; frc != ((void *) 0); frc = frc -> fr_next) if (ses_do_frame (frc)) return 1;
    return 0;
}
...
static int ses_do_win (wp)
    win_T * wp;
{
    if (wp -> w_buffer -> b_fname == ((void *) 0) || bt_nofile (wp -> w_buffer)) return (ssop_flags & 0x080);
    if (wp -> w_buffer -> b_help) return (ssop_flags & 0x040);
    return 1;
}
    ...
    int current_arg_idx;
{
    ...
    if (wp -> w_alist == &global_alist) {
        if (put_line (fd, "argglobal") == 0) return 0;
    }
    else {
        if (ses_arglist (fd, "arglocal", &wp->w_alist->al_ga, flagp == &vop_flags || !(*flagp & 0x1000) || wp -> w_localdir != ((void *) 0), flagp) == 0) return
          0;
    }
    if (wp -> w_arg_idx != current_arg_idx && wp -> w_arg_idx < ((wp) -> w_alist -> al_ga.ga_len) && flagp == &ssop_flags) {
        if (fprintf (fd, "%ldargu", (long) wp -> w_arg_idx + 1) < 0 || put_eol (fd) == 0) return 0;
        did_next = 1;
    }
    if (add_edit && (!did_next || wp -> w_arg_idx_invalid)) {
        if (wp -> w_buffer -> b_ffname != ((void *) 0) && !bt_nofile(wp->w_buffer)) {
            if (fputs ("edit ", fd) < 0 || ses_fname (fd, wp -> w_buffer, flagp) == 0) return 0;
        }
        else {
            if (put_line (fd, "enew") == 0) return 0;
            if (wp -> w_buffer -> b_ffname != ((void *) 0)) {
                if (fputs ("file ", fd) < 0 || ses_fname (fd, wp -> w_buffer, flagp) == 0) return 0;
            }
            do_cursor = 0;
        }
    }
    if ((*flagp & (0x020 | 0x010)) && makemap (fd, wp -> w_buffer) == 0) return 0;
    save_curwin = curwin;
    curwin = wp;
    curbuf = curwin -> w_buffer;
    if (*flagp & (0x020 | 0x010)) f = makeset (fd, 4, flagp == &vop_flags || !(*flagp & 0x020));
    else if (*flagp & 0x2000) f = makefoldset (fd);
    else f = 1;
    curwin = save_curwin;
    curbuf = curwin -> w_buffer;
    if (f == 0) return 0;
    if ((*flagp & 0x2000) && wp -> w_buffer -> b_ffname != ((void *) 0) && (*wp->w_buffer->b_p_bt == '\000' || wp -> w_buffer -> b_help)) {
        if (put_folds (fd, wp) == 0) return 0;
    }
    if (do_cursor) {
        if (fprintf (fd, "let s:l = %ld - ((%ld * winheight(0) + %ld) / %ld)", (long) wp -> w_cursor.lnum, (long) (wp -> w_cursor.lnum - wp -> w_topline), (
          long) wp -> w_height / 2, (long) wp -> w_height) < 0 || put_eol (fd) == 0 || put_line (fd, "if s:l < 1 | let s:l = 1 | endif") == 0 || put_line (fd,
          "exe s:l") == 0 || put_line (fd, "normal! zt") == 0 || fprintf (fd, "%ld", (long) wp -> w_cursor.lnum) < 0 || put_eol (fd) == 0) return 0;
        if (wp -> w_cursor.col == 0) {
            if (put_line (fd, "normal! 0") == 0) return 0;
        }
        else {
            if (!wp->w_onebuf_opt.wo_wrap && wp -> w_leftcol > 0 && wp -> w_width > 0) {
                if (fprintf (fd, "let s:c = %ld - ((%ld * winwidth(0) + %ld) / %ld)", (long) wp -> w_cursor.col, (long) (wp -> w_cursor.col - wp -> w_leftcol),
                  (long) wp -> w_width / 2, (long) wp -> w_width) < 0 || put_eol (fd) == 0 || put_line (fd, "if s:c > 0") == 0 || fprintf (fd,
                  "  exe 'normal! 0' . s:c . 'lzs' . (%ld - s:c) . 'l'", (long) wp -> w_cursor.col) < 0 || put_eol (fd) == 0 || put_line (fd, "else") == 0 ||
                  fprintf (fd, "  normal! 0%dl", wp -> w_cursor.col) < 0 || put_eol (fd) == 0 || put_line (fd, "endif") == 0) return 0;
            }
            else {
                if (fprintf (fd, "normal! 0%dl", wp -> w_cursor.col) < 0 || put_eol (fd) == 0) return 0;
            }
        }
    }
    if (wp -> w_localdir != ((void *) 0)) {
        if (fputs ("lcd ", fd) < 0 || ses_put_fname (fd, wp -> w_localdir, flagp) == 0 || put_eol (fd) == 0) return 0;
        did_lcd = 1;
    }
    return 1;
}
    ...
    unsigned * flagp;
{
    ...
    char_u buf [1024];
    char_u * s;
    if (gap -> ga_len == 0) return put_line (fd, "silent! argdel *");
    if (fputs (cmd, fd) < 0) return 0;
    for (i = 0; i < gap -> ga_len; ++i) {
        ...
        if (s != ((void *) 0)) {
            ...
            if (fputs (" ", fd) < 0 || ses_put_fname (fd, s, flagp) == 0) return 0;
        }
    }
    return put_eol (fd);
}
...
{
    char_u * name;
    if (buf -> b_sfname != ((void *) 0) && flagp == &ssop_flags && (ssop_flags & (0x1000 | 0x800)) && !p_acd && !did_lcd) name = buf -> b_sfname;
    else name = buf -> b_ffname;
    if (ses_put_fname (fd, name, flagp) == 0 || put_eol (fd) == 0) return 0;
    return 1;
}
    ...
    unsigned * flagp;
{
    ...
    if (sname != ((void *) 0)) name = sname;
    while (*name != '\000') {
        c = *name++;
        if (c == '\\' && (*flagp & 0x200)) c = '/';
        else if ((vim_strchr (escape_chars, c) != ((void *) 0)) || c == '#' || c == '%') {
            if (putc ('\\', fd) != '\\') retval = 0;
        }
        if (putc (c, fd) != c) retval = 0;
    }
    vim_free (sname);
    return retval;
}
    ...
    int c;
{
    ...
    if (sname == ((void *) 0)) return ((void *) 0);
    for (p = sname; *p; ++p) if (*p == '=' || vim_ispathsep (*p)) ++len;
    retval = alloc ((unsigned) (strlen ((char *) (sname)) + len + strlen ((char *) (p_vdir)) + 9));
    if (retval != ((void *) 0)) {
        ((__builtin_object_size ((char *) (retval), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (retval), (char *) (p_vdir), __builtin_object_size (
          (char *) (retval), 1 > 1)) : __inline_strcpy_chk ((char *) (retval), (char *) (p_vdir)));
        add_pathsep (retval);
        ...
        *s++ = '=';
        *s++ = c;
        ((__builtin_object_size ((char *) (s), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (s), (char *) (".vim"), __builtin_object_size ((char *) (
          s), 1 > 1)) : __inline_strcpy_chk ((char *) (s), (char *) (".vim")));
    }
    vim_free (sname);
    return retval;
}
...
int put_line (fd, s)
    ...
    char * s;
{
    if (fputs (s, fd) < 0 || put_eol (fd) == 0) return 0;
    return 1;
}
    ...
    exarg_T * eap;
{
    ...
    if (*p_viminfo == '\000') p_viminfo = (char_u *) "'100";
    if (eap -> cmdidx == CMD_rviminfo) {
        if (read_viminfo (eap -> arg, 1 | 2 | (eap -> forceit ? 4 : 0)) == 0) emsg ((char_u *) (((char *) ("E195: Cannot open viminfo file for reading"))));
    }
...
void dialog_msg (buff, format, fname)
    ...
    char_u * fname;
{
    if (fname == ((void *) 0)) fname = (char_u *) ((char *) ("Untitled"));
...
char_u * get_behave_arg (xp, idx)
    ...
    int idx;
{
    if (idx == 0) return (char_u *) "mswin";
    if (idx == 1) return (char_u *) "xterm";
    return ((void *) 0);
}
    ...
    exarg_T * eap;
{
    ...
    int indent = 0;
    if (*eap->arg == '\000') {
        smsg ((char_u *) "filetype detection:%s  plugin:%s  indent:%s", filetype_detect ? "ON" : "OFF", filetype_plugin ? (filetype_detect ? "ON" : "(on)") :
          "OFF", filetype_indent ? (filetype_detect ? "ON" : "(on)") : "OFF");
        return;
    }
    for (;;) {
...
static void ex_setfiletype (eap)
    exarg_T * eap;
{
    if (!did_filetype) set_option_value ((char_u *) "filetype", 0L, eap -> arg, 4);
}

static void ex_digraphs (eap)
    exarg_T * eap __attribute__ ((unused));
{
    if (*eap->arg != '\000') putdigraph (eap -> arg);
    else listdigraphs ();
}
...
{
    int flags = 0;
    if (eap -> cmdidx == CMD_setlocal) flags = 4;
    else if (eap -> cmdidx == CMD_setglobal) flags = 2;
    ...
    exarg_T * eap;
{
    ...
    int c;
    int id;
    if (eap -> line2 <= 3) id = eap -> line2;
    else {
        emsg ((char_u *) (e_invcmd));
        return;
    }
    if (!eap->skip) match_delete (curwin, id, 0);
    if (ends_excmd (*eap->arg)) end = eap -> arg;
    else if ((strncasecmp ((char *) (eap -> arg), (char *) ("none"), (size_t) (4)) == 0 && (((eap -> arg [4]) == ' ' || (eap -> arg [4]) == '\t') || ends_excmd
      (eap -> arg [4])))) end = eap -> arg + 4;
    else {
        p = skiptowhite (eap -> arg);
        if (!eap->skip) g = vim_strnsave (eap -> arg, (int) (p - eap -> arg));
        p = skipwhite (p);
        if (*p == '\000') {
            emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (eap -> arg));
            return;
...
static void ex_X (eap)
    exarg_T * eap __attribute__ ((unused));
{
    if (get_crypt_method (curbuf) == 0 || blowfish_self_test () == 1) (void) get_crypt_key (1, 1);
}

static void ex_fold (eap)
    exarg_T * eap;
{
    if (foldManualAllowed (1)) foldCreate (eap -> line1, eap -> line2);
}

static void ex_foldopen (eap)
    exarg_T * eap;
{
    opFoldRange (eap -> line1, eap -> line2, eap -> cmdidx == CMD_foldopen, eap -> forceit, 0);
}
...
{
    linenr_T lnum;
    for (lnum = eap -> line1; lnum <= eap -> line2; ++lnum) if (hasFolding (lnum, ((void *) 0), ((void *) 0)) == (eap -> cmdidx == CMD_folddoclosed))
      ml_setmarked (lnum);
    global_exe (eap -> arg);
    ml_clearmarked ();
}

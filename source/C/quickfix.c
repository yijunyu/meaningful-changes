...
static int qf_init_ext (qf_info_T * qi, char_u * efile, buf_T * buf, typval_T * tv, char_u * errorformat, int newlist, linenr_T lnumfirst, linenr_T lnumlast,
  char_u * qf_title);
static void qf_new_list (qf_info_T * qi, char_u * qf_title);
static void ll_free_all (qf_info_T * * pqi);
static int qf_add_entry (qf_info_T * qi, qfline_T * * prevp, char_u * dir, char_u * fname, int bufnum, char_u * mesg, long lnum, int col, int vis_col, char_u *
...
static void unload_dummy_buffer (buf_T * buf);
    ...
    char_u * qf_title;
{
    ...
    if (efile == ((void *) 0)) return 0;
    if (wp != ((void *) 0)) {
        qi = ll_get_or_alloc_list (wp);
        if (qi == ((void *) 0)) return 0;
    }
    return qf_init_ext (qi, efile, curbuf, ((void *) 0), errorformat, newlist, (linenr_T) 0, (linenr_T) 0, qf_title);
}

static int qf_init_ext (qi, efile, buf, tv, errorformat, newlist, lnumfirst, lnumlast, qf_title)
    qf_info_T * qi;
    char_u * efile;
    buf_T * buf;
    typval_T * tv;
    ...
    char_u * qf_title;
{
    ...
    } fmt_pat [10] =
    {
        ...
        {'v', "\\d\\+"},
        {'s', ".\\+"}};
    namebuf = alloc (1024 + 1);
    errmsg = alloc (1024 + 1);
    pattern = alloc (1024 + 1);
    if (namebuf == ((void *) 0) || errmsg == ((void *) 0) || pattern == ((void *) 0)) goto qf_init_end;
    if (efile != ((void *) 0) && (fd = fopen (((char *) efile), ("r"))) == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) (e_openerrf))), (char_u *) (efile));
        goto qf_init_end;
    }
    if (newlist || qi -> qf_curlist == qi -> qf_listcount) qf_new_list (qi, qf_title);
    else if (qi -> qf_lists [qi -> qf_curlist].qf_count > 0) for (qfprev = qi -> qf_lists [qi -> qf_curlist].qf_start; qfprev -> qf_next != qfprev; qfprev =
      qfprev -> qf_next);
    if (errorformat == p_efm && tv == ((void *) 0) && *buf->b_p_efm != '\000') efm = buf -> b_p_efm;
    else efm = errorformat;
    i = (10 * 3) + ((int) strlen ((char *) (efm)) << 2);
    for (round = 10; round > 0;) i += (int) strlen ((char *) (fmt_pat [--round].pattern));
    i += 2;
    if ((fmtstr = alloc (i)) == ((void *) 0)) goto error2;
    while (efm [0] != '\000') {
        fmt_ptr = (efm_T *) alloc_clear ((unsigned) sizeof (efm_T));
        if (fmt_ptr == ((void *) 0)) goto error2;
        if (fmt_first == ((void *) 0)) fmt_first = fmt_ptr;
        else fmt_last -> next = fmt_ptr;
        fmt_last = fmt_ptr;
        for (len = 0; efm [len] != '\000' && efm [len] != ','; ++len) if (efm [len] == '\\' && efm [len + 1] != '\000') ++len;
        ptr = fmtstr;
        *ptr++ = '^';
        round = 0;
        for (efmp = efm; efmp < efm + len; ++efmp) {
            if (*efmp == '%') {
                ++efmp;
                for (idx = 0; idx < 10; ++idx) if (fmt_pat [idx].convchar == *efmp) break;
                if (idx < 10) {
                    if (fmt_ptr -> addr [idx]) {
                        __builtin___sprintf_chk ((char *) errmsg, 0, __builtin_object_size ((char *) errmsg, 1 > 1), ((char *) (
                          "E372: Too many %%%c in format string")), *efmp);
                        emsg ((char_u *) (errmsg));
                        goto error2;
                    }
                    if ((idx && idx < 6 && vim_strchr ((char_u *) "DXOPQ", fmt_ptr -> prefix) != ((void *) 0)) || (idx == 6 && vim_strchr ((char_u *) "OPQ",
                      fmt_ptr -> prefix) == ((void *) 0))) {
                        __builtin___sprintf_chk ((char *) errmsg, 0, __builtin_object_size ((char *) errmsg, 1 > 1), ((char *) (
                          "E373: Unexpected %%%c in format string")), *efmp);
                        emsg ((char_u *) (errmsg));
                        goto error2;
                    }
                    ...
                    *ptr++ = '(';
                    if (*efmp == 'f' && efmp [1] != '\000') {
                        if (efmp [1] != '\\' && efmp [1] != '%') {
                            ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ptr), (char *) (".\\{-1,}"),
                              __builtin_object_size ((char *) (ptr), 1 > 1)) : __inline_strcpy_chk ((char *) (ptr), (char *) (".\\{-1,}")));
                            ptr += 7;
                        }
                        else {
                            ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ptr), (char *) ("\\f\\+"),
                              __builtin_object_size ((char *) (ptr), 1 > 1)) : __inline_strcpy_chk ((char *) (ptr), (char *) ("\\f\\+")));
                            ptr += 4;
                        }
                    }
                    else {
                        srcptr = (char_u *) fmt_pat [idx].pattern;
                        while ((*ptr = *srcptr++) != '\000') ++ptr;
                    }
                    *ptr++ = '\\';
                    *ptr++ = ')';
                }
                        ...
                        if ((*ptr++ = *efmp) == '[') {
                            ...
                            if (efmp < efm + len) {
                                *ptr++ = *++efmp;
                                ...
                                if (efmp == efm + len) {
                                    emsg ((char_u *) (((char *) ("E374: Missing ] in format string"))));
                                    goto error2;
                                }
                            }
                        }
                        else if (efmp < efm + len) *ptr++ = *++efmp;
                        *ptr++ = '\\';
                        *ptr++ = '+';
                    }
                    else {
                        __builtin___sprintf_chk ((char *) errmsg, 0, __builtin_object_size ((char *) errmsg, 1 > 1), ((char *) (
                          "E375: Unsupported %%%c in format string")), *efmp);
                        emsg ((char_u *) (errmsg));
                        goto error2;
                    }
                }
                else if (vim_strchr ((char_u *) "%\\.^$~[", *efmp) != ((void *) 0)) *ptr++ = *efmp;
                else if (*efmp == '#') *ptr++ = '*';
                else if (*efmp == '>') fmt_ptr -> conthere = 1;
                else if (efmp == efm + 1) {
                    if (vim_strchr ((char_u *) "+-", *efmp) != ((void *) 0)) fmt_ptr -> flags = *efmp++;
                    if (vim_strchr ((char_u *) "DXAEWICZGOPQ", *efmp) != ((void *) 0)) fmt_ptr -> prefix = *efmp;
                    else {
                        __builtin___sprintf_chk ((char *) errmsg, 0, __builtin_object_size ((char *) errmsg, 1 > 1), ((char *) (
                          "E376: Invalid %%%c in format string prefix")), *efmp);
                        emsg ((char_u *) (errmsg));
                        goto error2;
                    }
                }
                    ...
                    __builtin___sprintf_chk ((char *) errmsg, 0, __builtin_object_size ((char *) errmsg, 1 > 1), ((char *) (
                      "E377: Invalid %%%c in format string")), *efmp);
                    emsg ((char_u *) (errmsg));
                    goto error2;
                }
            }
            else {
                if (*efmp == '\\' && efmp + 1 < efm + len) ++efmp;
                else if (vim_strchr ((char_u *) ".*^$~[", *efmp) != ((void *) 0)) *ptr++ = '\\';
                if (*efmp) *ptr++ = *efmp;
            }
        }
        *ptr++ = '$';
        * ptr = '\000';
        if ((fmt_ptr -> prog = vim_regcomp (fmtstr, 1 + 2)) == ((void *) 0)) goto error2;
        efm = skip_to_option_part (efm + len);
    }
    if (fmt_first == ((void *) 0)) {
        emsg ((char_u *) (((char *) ("E378: 'errorformat' contains no pattern"))));
        goto error2;
    }
    got_int = 0;
    regmatch.rm_ic = 1;
    if (tv != ((void *) 0)) {
        if (tv -> v_type == 2) p_str = tv -> vval.v_string;
        else if (tv -> v_type == 4) p_li = tv -> vval.v_list -> lv_first;
    }
    while (!got_int) {
        if (fd == ((void *) 0)) {
            if (tv != ((void *) 0)) {
                if (tv -> v_type == 2) {
                    ...
                    if (!*p_str) break;
                    p = vim_strchr (p_str, '\n');
                    if (p) len = (int) (p - p_str + 1);
                    else len = (int) strlen ((char *) (p_str));
                    if (len > 1024 - 2) vim_strncpy (IObuff, p_str, 1024 - 2);
                    else vim_strncpy (IObuff, p_str, len);
                    p_str += len;
                }
                else if (tv -> v_type == 4) {
                    while (p_li && p_li -> li_tv.v_type != 2) p_li = p_li -> li_next;
                    if (!p_li) break;
                ...
                if (buflnum > lnumlast) break;
                vim_strncpy (IObuff, ml_get_buf (buf, buflnum ++, 0), 1024 - 2);
            }
        }
        else if (fgets ((char *) IObuff, 1024 - 2, fd) == ((void *) 0)) break;
        IObuff [1024 - 2] = '\000';
        if ((efmp = vim_strrchr (IObuff, '\n')) != ((void *) 0)) *efmp = '\000';
        if (fmt_start == ((void *) 0)) fmt_ptr = fmt_first;
        else {
            fmt_ptr = fmt_start;
            fmt_start = ((void *) 0);
        }
        valid = 1;
        restofline : for (; fmt_ptr != ((void *) 0); fmt_ptr = fmt_ptr -> next) {
            idx = fmt_ptr -> prefix;
            if (multiscan && vim_strchr ((char_u *) "OPQ", idx) == ((void *) 0)) continue;
            namebuf [0] = '\000';
            pattern [0] = '\000';
            if (!multiscan) errmsg [0] = '\000';
            lnum = 0;
            col = 0;
            use_viscol = 0;
            enr = -1;
            ...
            if (vim_regexec (&regmatch, IObuff, (colnr_T) 0)) {
                if ((idx == 'C' || idx == 'Z') && !multiline) continue;
                if (vim_strchr ((char_u *) "EWI", idx) != ((void *) 0)) type = idx;
                else type = 0;
                if ((i = (int) fmt_ptr -> addr [0]) > 0) {
                    int c;
                    if (regmatch.startp [i] == ((void *) 0) || regmatch.endp [i] == ((void *) 0)) continue;
                    c = *regmatch.endp[i];
                    *regmatch.endp[i] = '\000';
                    expand_env (regmatch.startp [i], namebuf, 1024);
                    *regmatch.endp[i] = c;
                    if (vim_strchr ((char_u *) "OPQ", idx) != ((void *) 0) && mch_getperm (namebuf) == -1) continue;
                }
                if ((i = (int) fmt_ptr -> addr [1]) > 0) {
                    if (regmatch.startp [i] == ((void *) 0)) continue;
                ...
                if (fmt_ptr -> flags == '+' && !multiscan) ((__builtin_object_size ((char *) (errmsg), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (
                  errmsg), (char *) (IObuff), __builtin_object_size ((char *) (errmsg), 1 > 1)) : __inline_strcpy_chk ((char *) (errmsg), (char *) (IObuff)));
                ...
                if ((i = (int) fmt_ptr -> addr [7]) > 0) {
                    ...
                    if (*((char_u*)regmatch.startp[i]) != '\011') use_viscol = 1;
                }
                ...
                if ((i = (int) fmt_ptr -> addr [9]) > 0) {
                    if (regmatch.startp [i] == ((void *) 0) || regmatch.endp [i] == ((void *) 0)) continue;
                    len = (int) (regmatch.endp [i] - regmatch.startp [i]);
                    if (len > 1024 - 5) len = 1024 - 5;
                    ((__builtin_object_size ((char *) (pattern), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (pattern), (char *) ("^\\V"),
                      __builtin_object_size ((char *) (pattern), 1 > 1)) : __inline_strcpy_chk ((char *) (pattern), (char *) ("^\\V")));
                    ((__builtin_object_size ((char *) (pattern), 0) != (size_t) - 1) ? __builtin___strncat_chk ((char *) (pattern), (char *) (regmatch.startp [
                      i]), (size_t) (len), __builtin_object_size ((char *) (pattern), 1 > 1)) : __inline_strncat_chk ((char *) (pattern), (char *) (regmatch.
                      startp [i]), (size_t) (len)));
                    pattern [len + 3] = '\\';
                    pattern [len + 4] = '$';
                    pattern [len + 5] = '\000';
        ...
        if (fmt_ptr == ((void *) 0) || idx == 'D' || idx == 'X') {
            if (fmt_ptr != ((void *) 0)) {
                if (idx == 'D') {
                    if (*namebuf == '\000') {
                        emsg ((char_u *) (((char *) ("E379: Missing or empty directory name"))));
                        goto error2;
                    }
                    if ((directory = qf_push_dir (namebuf, &dir_stack)) == ((void *) 0)) goto error2;
                }
                else if (idx == 'X') directory = qf_pop_dir (&dir_stack);
            }
            namebuf [0] = '\000';
            lnum = 0;
            valid = 0;
            ((__builtin_object_size ((char *) (errmsg), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (errmsg), (char *) (IObuff),
              __builtin_object_size ((char *) (errmsg), 1 > 1)) : __inline_strcpy_chk ((char *) (errmsg), (char *) (IObuff)));
            if (fmt_ptr == ((void *) 0)) multiline = multiignore = 0;
        }
        else if (fmt_ptr != ((void *) 0)) {
            if (fmt_ptr -> conthere) fmt_start = fmt_ptr;
            if (vim_strchr ((char_u *) "AEWI", idx) != ((void *) 0)) multiline = 1;
            else if (vim_strchr ((char_u *) "CZ", idx) != ((void *) 0)) {
                if (qfprev == ((void *) 0)) goto error2;
                if (*errmsg && !multiignore) {
                    len = (int) strlen ((char *) (qfprev -> qf_text));
                    if ((ptr = alloc ((unsigned) (len + strlen ((char *) (errmsg)) + 2))) == ((void *) 0)) goto error2;
                    ((__builtin_object_size ((char *) (ptr), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ptr), (char *) (qfprev -> qf_text),
                      __builtin_object_size ((char *) (ptr), 1 > 1)) : __inline_strcpy_chk ((char *) (ptr), (char *) (qfprev -> qf_text)));
                    vim_free (qfprev -> qf_text);
                    qfprev -> qf_text = ptr;
                    *(ptr+=len) = '\n';
                    ((__builtin_object_size ((char *) (++ptr), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (++ptr), (char *) (errmsg),
                      __builtin_object_size ((char *) (++ptr), 1 > 1)) : __inline_strcpy_chk ((char *) (++ptr), (char *) (errmsg)));
                }
                if (qfprev -> qf_nr == -1) qfprev -> qf_nr = enr;
                if (vim_isprintc (type) && !qfprev->qf_type) qfprev -> qf_type = type;
                if (!qfprev->qf_lnum) qfprev -> qf_lnum = lnum;
                if (!qfprev->qf_col) qfprev -> qf_col = col;
                qfprev -> qf_viscol = use_viscol;
                if (!qfprev->qf_fnum) qfprev -> qf_fnum = qf_get_fnum (directory, *namebuf || directory ? namebuf : currfile && valid ? currfile : 0);
                if (idx == 'Z') multiline = multiignore = 0;
                line_breakcheck ();
                continue;
            }
            else if (vim_strchr ((char_u *) "OPQ", idx) != ((void *) 0)) {
                valid = 0;
                if (*namebuf == '\000' || mch_getperm (namebuf) >= 0) {
                    if (*namebuf && idx == 'P') currfile = qf_push_dir (namebuf, &file_stack);
                    else if (idx == 'Q') currfile = qf_pop_dir (&file_stack);
                    * namebuf = '\000';
                    if (tail && *tail) {
                        ((__builtin_object_size ((char *) ((IObuff)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((IObuff)), (char *) ((skipwhite (
                          tail))), strlen ((char *) (skipwhite (tail))) + 1, __builtin_object_size ((char *) ((IObuff)), 0)) : __inline_memmove_chk ((char *) (
                          (IObuff)), (char *) ((skipwhite (tail))), strlen ((char *) (skipwhite (tail))) + 1));
                        multiscan = 1;
                        goto restofline;
                    }
                }
            ...
            if (fmt_ptr -> flags == '-') {
                if (multiline) multiignore = 1;
                continue;
            }
        }
        if (qf_add_entry (qi, &qfprev, directory, (*namebuf || directory) ? namebuf : ((currfile && valid) ? currfile : (char_u *) ((void *) 0)), 0, errmsg,
          lnum, col, use_viscol, pattern, enr, type, valid) == 0) goto error2;
        line_breakcheck ();
    }
    if (fd == ((void *) 0) || !ferror(fd)) {
        if (qi -> qf_lists [qi -> qf_curlist].qf_index == 0) {
            ...
            if (qi -> qf_lists [qi -> qf_curlist].qf_ptr == ((void *) 0)) qi -> qf_lists [qi -> qf_curlist].qf_ptr = qi -> qf_lists [qi -> qf_curlist].qf_start
              ;
        }
        retval = qi -> qf_lists [qi -> qf_curlist].qf_count;
        goto qf_init_ok;
    }
    emsg ((char_u *) (((char *) (e_readerrf))));
    error2 : qf_free (qi, qi -> qf_curlist);
    qi -> qf_listcount --;
    if (qi -> qf_curlist > 0) --qi->qf_curlist;
    qf_init_ok : if (fd != ((void *) 0)) fclose (fd);
...
{
    int i;
    while (qi -> qf_listcount > qi -> qf_curlist + 1) qf_free (qi, --qi->qf_listcount);
    if (qi -> qf_listcount == 10) {
        qf_free (qi, 0);
        for (i = 1; i < 10; ++i) qi -> qf_lists [i - 1] = qi -> qf_lists [i];
        qi -> qf_curlist = 10 - 1;
    }
    ...
    if (qf_title != ((void *) 0)) {
        char_u * p = alloc ((int) strlen ((char *) (qf_title)) + 2);
        qi -> qf_lists [qi -> qf_curlist].qf_title = p;
        if (p != ((void *) 0)) __builtin___sprintf_chk ((char *) p, 0, __builtin_object_size ((char *) p, 1 > 1), ":%s", (char *) qf_title);
    }
    else qi -> qf_lists [qi -> qf_curlist].qf_title = ((void *) 0);
}
    ...
    qf_info_T * * pqi;
{
    ...
    * pqi = ((void *) 0);
    qi -> qf_refcount --;
    if (qi -> qf_refcount < 1) {
        for (i = 0; i < qi -> qf_listcount; ++i) qf_free (qi, i);
        vim_free (qi);
    }
}
    ...
    win_T * wp;
{
    ...
    else for (i = 0; i < qi -> qf_listcount; ++i) qf_free (qi, i);
}

static int qf_add_entry (qi, prevp, dir, fname, bufnum, mesg, lnum, col, vis_col, pattern, nr, type, valid)
    qf_info_T * qi;
    qfline_T * * prevp;
    char_u * dir;
    char_u * fname;
...
{
    qfline_T * qfp;
    if ((qfp = (qfline_T *) alloc ((unsigned) sizeof (qfline_T))) == ((void *) 0)) return 0;
    if (bufnum != 0) qfp -> qf_fnum = bufnum;
    else qfp -> qf_fnum = qf_get_fnum (dir, fname);
    if ((qfp -> qf_text = vim_strsave (mesg)) == ((void *) 0)) {
        vim_free (qfp);
        return 0;
    }
    qfp -> qf_lnum = lnum;
    ...
    if (pattern == ((void *) 0) || *pattern == '\000') qfp -> qf_pattern = ((void *) 0);
    else if ((qfp -> qf_pattern = vim_strsave (pattern)) == ((void *) 0)) {
        vim_free (qfp -> qf_text);
        vim_free (qfp);
        return 0;
    }
    qfp -> qf_nr = nr;
    if (type != 1 && !vim_isprintc(type)) type = 0;
    qfp -> qf_type = type;
    qfp -> qf_valid = valid;
    ...
    * prevp = qfp;
    ...
    if (qi -> qf_lists [qi -> qf_curlist].qf_index == 0 && qfp -> qf_valid) {
        qi -> qf_lists [qi -> qf_curlist].qf_index = qi -> qf_lists [qi -> qf_curlist].qf_count;
...
static qf_info_T * ll_new_list () {
    ...
    if (qi != ((void *) 0)) {
        ((__builtin_object_size ((qi), 0) != (size_t) - 1) ? __builtin___memset_chk ((qi), (0), ((size_t) (sizeof (qf_info_T))), __builtin_object_size ((qi), 0
          )) : __inline_memset_chk ((qi), (0), ((size_t) (sizeof (qf_info_T)))));
        qi -> qf_refcount ++;
    }
    return qi;
}
...
static qf_info_T * ll_get_or_alloc_list (wp)
    win_T * wp;
{
    if ((bt_quickfix (wp -> w_buffer) && wp -> w_llist_ref != ((void *) 0))) return wp -> w_llist_ref;
    ll_free_all (&wp->w_llist_ref);
    if (wp -> w_llist == ((void *) 0)) wp -> w_llist = ll_new_list ();
    return wp -> w_llist;
}
    ...
    win_T * to;
{
    ...
    int idx;
    int i;
    if ((bt_quickfix (from -> w_buffer) && from -> w_llist_ref != ((void *) 0))) qi = from -> w_llist_ref;
    else qi = from -> w_llist;
    if (qi == ((void *) 0)) return;
    if ((to -> w_llist = ll_new_list ()) == ((void *) 0)) return;
    ...
    for (idx = 0; idx < qi -> qf_listcount; idx ++) {
        ...
        if (from_qfl -> qf_title != ((void *) 0)) to_qfl -> qf_title = vim_strsave (from_qfl -> qf_title);
        else to_qfl -> qf_title = ((void *) 0);
        if (from_qfl -> qf_count) {
            qfline_T * from_qfp;
            qfline_T * prevp = ((void *) 0);
            for (i = 0, from_qfp = from_qfl -> qf_start; i < from_qfl -> qf_count; ++i, from_qfp = from_qfp -> qf_next) {
                if (qf_add_entry (to -> w_llist, &prevp, ((void *) 0), ((void *) 0), 0, from_qfp -> qf_text, from_qfp -> qf_lnum, from_qfp -> qf_col, from_qfp
                  -> qf_viscol, from_qfp -> qf_pattern, from_qfp -> qf_nr, 0, from_qfp -> qf_valid) == 0) {
                    qf_free_all (to);
                    return;
                }
                prevp -> qf_fnum = from_qfp -> qf_fnum;
                prevp -> qf_type = from_qfp -> qf_type;
                if (from_qfl -> qf_ptr == from_qfp) to_qfl -> qf_ptr = prevp;
            }
        }
        to_qfl -> qf_index = from_qfl -> qf_index;
        if (to_qfl -> qf_nonevalid == 1) to_qfl -> qf_ptr = to_qfl -> qf_start;
    }
    ...
    char_u * fname;
{
    if (fname == ((void *) 0) || *fname == '\000') return 0;
    {
        char_u * ptr;
        int fnum;
        if (directory != ((void *) 0) && !vim_isAbsName(fname) && (ptr = concat_fnames (directory, fname, 1)) != ((void *) 0)) {
            if (mch_getperm (ptr) < 0) {
                vim_free (ptr);
                directory = qf_guess_filepath (fname);
                if (directory) ptr = concat_fnames (directory, fname, 1);
    ...
    struct dir_stack_T * * stackptr;
{
    ...
    if (ds_new == ((void *) 0)) return ((void *) 0);
    ds_new -> next = *stackptr;
    * stackptr = ds_new;
    if (vim_isAbsName (dirbuf) || (*stackptr) -> next == ((void *) 0) || (*stackptr && dir_stack != *stackptr)) (*stackptr) -> dirname = vim_strsave (dirbuf);
    else {
        ...
        while (ds_new) {
            ...
            if (mch_isdir ((*stackptr) -> dirname) == 1) break;
            ds_new = ds_new -> next;
        }
    ...
    if ((*stackptr) -> dirname != ((void *) 0)) return (*stackptr) -> dirname;
    else {
        ds_ptr = *stackptr;
    ...
    char_u * filename;
{
    ...
    char_u * fullname;
    if (dir_stack == ((void *) 0)) return ((void *) 0);
    ds_ptr = dir_stack -> next;
    fullname = ((void *) 0);
    while (ds_ptr) {
        vim_free (fullname);
        fullname = concat_fnames (ds_ptr -> dirname, filename, 1);
        if ((fullname != ((void *) 0)) && (mch_getperm (fullname) >= 0)) break;
        ds_ptr = ds_ptr -> next;
    }
    vim_free (fullname);
    ...
    int forceit;
{
    ...
    int ok = 1;
    int usable_win;
    if (qi == ((void *) 0)) qi = &ql_info;
    if (qi -> qf_curlist >= qi -> qf_listcount || qi -> qf_lists [qi -> qf_curlist].qf_count == 0) {
        emsg ((char_u *) (((char *) (e_quickfix))));
        return;
    }
    ...
    if (dir == 1 || dir == 3) {
        while (errornr --) {
            ...
            do {
                if (qf_index == qi -> qf_lists [qi -> qf_curlist].qf_count || qf_ptr -> qf_next == ((void *) 0)) {
                    qf_ptr = old_qf_ptr;
                    qf_index = prev_index;
                    if (err != ((void *) 0)) {
                        emsg ((char_u *) (((char *) (err))));
                        goto theend;
                    }
                    errornr = 0;
                    break;
            ...
            while ((!qi->qf_lists[qi->qf_curlist].qf_nonevalid && !qf_ptr->qf_valid) || (dir == 3 && qf_ptr -> qf_fnum == old_qf_fnum));
            err = ((void *) 0);
        }
    }
    else if (dir == (-1) || dir == (-3)) {
        ...
        while (errornr > qf_index && qf_index < qi -> qf_lists [qi -> qf_curlist].qf_count && qf_ptr -> qf_next != ((void *) 0)) {
            ++qf_index;
            qf_ptr = qf_ptr -> qf_next;
        }
    }
    qi -> qf_lists [qi -> qf_curlist].qf_index = qf_index;
    if (qf_win_pos_update (qi, old_qf_index)) print_message = 0;
    if (qf_ptr -> qf_type == 1 && (!curwin->w_buffer->b_help || cmdmod.tab != 0)) {
        ...
        if (wp != ((void *) 0) && wp -> w_buffer -> b_nwindows > 0) win_enter (wp, 1);
            ...
            flags = 16;
            if (cmdmod.split == 0 && curwin -> w_width != Columns && curwin -> w_width < 80) flags |= 4;
            if (qi != &ql_info) flags |= 128;
            if (win_split (0, flags) == 0) goto theend;
            opened_window = 1;
    ...
    if (bt_quickfix (curbuf) && !opened_window) {
        if (qf_ptr -> qf_fnum == 0) goto theend;
        usable_win = 0;
        for (win = firstwin; win != ((void *) 0); win = win -> w_next) if (win -> w_buffer -> b_p_bt [0] == '\000') {
            usable_win = 1;
            break;
        }
        ...
        win_found : if (((firstwin == lastwin) && bt_quickfix (curbuf)) || !usable_win) {
            ll_ref = curwin -> w_llist_ref;
            flags = 64;
            if (ll_ref != ((void *) 0)) flags |= 128;
            if (win_split (0, flags) == 0) goto failed;
            opened_window = 1;
            p_swb = empty_option;
            swb_flags = 0;
            ...
            if (curwin -> w_llist_ref != ((void *) 0)) {
                ll_ref = curwin -> w_llist_ref;
                for (win = firstwin; win != ((void *) 0); win = win -> w_next) if (win -> w_llist == ll_ref) break;
                if (win == ((void *) 0)) {
                    for (win = firstwin; win != ((void *) 0); win = win -> w_next) if (win -> w_buffer -> b_fnum == qf_ptr -> qf_fnum) break;
                    if (win == ((void *) 0)) {
                        win = curwin;
                        do {
                            if (win -> w_buffer -> b_p_bt [0] == '\000') break;
                            if (win -> w_prev == ((void *) 0)) win = lastwin;
                            else win = win -> w_prev;
                        }
                        while (win != curwin);
                    }
                ...
                altwin = ((void *) 0);
                for (;;) {
                    if (win -> w_buffer -> b_fnum == qf_ptr -> qf_fnum) break;
                    if (win -> w_prev == ((void *) 0)) win = lastwin;
                    else win = win -> w_prev;
                    if ((bt_quickfix (win -> w_buffer) && win -> w_llist_ref == ((void *) 0))) {
                        if (altwin != ((void *) 0)) win = altwin;
                        else if (curwin -> w_prev != ((void *) 0)) win = curwin -> w_prev;
                        else win = curwin -> w_next;
                        break;
                    }
                    if (altwin == ((void *) 0) && !win->w_onebuf_opt.wo_pvw && win -> w_buffer -> b_p_bt [0] == '\000') altwin = win;
                }
                win_goto (win);
            }
        }
    ...
    if (qf_ptr -> qf_fnum != 0) {
        if (qf_ptr -> qf_type == 1) {
            ...
            else ok = do_ecmd (qf_ptr -> qf_fnum, ((void *) 0), ((void *) 0), ((void *) 0), (linenr_T) 1, 0x01 + 0x02, oldwin == curwin ? curwin : ((void *) 0)
              );
        }
        else ok = buflist_getfile (qf_ptr -> qf_fnum, (linenr_T) 1, 0x01 | 0x04, forceit);
    }
    if (ok == 1) {
        if (curbuf == old_curbuf) setpcmark ();
        if (qf_ptr -> qf_pattern == ((void *) 0)) {
            i = qf_ptr -> qf_lnum;
            if (i > 0) {
                if (i > curbuf -> b_ml.ml_line_count) i = curbuf -> b_ml.ml_line_count;
            ...
            if (!do_search(((void*)0),'/',qf_ptr->qf_pattern,(long)1,0x400,((void*)0))) curwin -> w_cursor = save_cursor;
        }
        if ((fdo_flags & 0x020) && old_KeyTyped) foldOpenCursor ();
        if (print_message) {
            update_topline_redraw ();
            __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ((char *) ("(%d of %d)%s%s: ")), qf_index, qi ->
              qf_lists [qi -> qf_curlist].qf_count, qf_ptr -> qf_cleared ? ((char *) (" (line deleted)")) : "", (char *) qf_types (qf_ptr -> qf_type, qf_ptr ->
              qf_nr));
            len = (int) strlen ((char *) (IObuff));
            qf_fmt_text (skipwhite (qf_ptr -> qf_text), IObuff + len, (1024 + 1) - len);
            i = msg_scroll;
            if (curbuf == old_curbuf && curwin -> w_cursor.lnum == old_lnum) msg_scroll = 1;
            else if (!msg_scrolled && shortmess ('O')) msg_scroll = 0;
            msg_attr_keep (IObuff, 0, 1);
            msg_scroll = i;
        }
    }
    else {
        if (opened_window) win_close (curwin, 1);
        if (qf_ptr -> qf_fnum != 0) {
            failed : qf_ptr = old_qf_ptr;
            qf_index = old_qf_index;
        }
    }
    theend : qi -> qf_lists [qi -> qf_curlist].qf_ptr = qf_ptr;
    qi -> qf_lists [qi -> qf_curlist].qf_index = qf_index;
    if (p_swb != old_swb && opened_window) {
        ...
        else free_string_option (old_swb);
    }
}
    ...
    exarg_T * eap;
{
    ...
    if (idx1 < 0) idx1 = (-idx1 > i) ? 0 : idx1 + i + 1;
    if (idx2 < 0) idx2 = (-idx2 > i) ? 0 : idx2 + i + 1;
    if (qi -> qf_lists [qi -> qf_curlist].qf_nonevalid) all = 1;
    ...
    for (i = 1; !got_int && i <= qi -> qf_lists [qi -> qf_curlist].qf_count;) {
        if ((qfp -> qf_valid || all) && idx1 <= i && i <= idx2) {
            ...
            if (got_int) break;
            fname = ((void *) 0);
            if (qfp -> qf_fnum != 0 && (buf = buflist_findnr (qfp -> qf_fnum)) != ((void *) 0)) {
                fname = buf -> b_fname;
                if (qfp -> qf_type == 1) fname = gettail (fname);
            }
            if (fname == ((void *) 0)) __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), "%2d", i);
            else vim_snprintf ((char *) IObuff, (1024 + 1), "%2d %s", i, (char *) fname);
            msg_outtrans_attr (IObuff, i == qi -> qf_lists [qi -> qf_curlist].qf_index ? highlight_attr [(int) (HLF_L)] : highlight_attr [(int) (HLF_D)]);
            if (qfp -> qf_lnum == 0) IObuff [0] = '\000';
            else if (qfp -> qf_col == 0) __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ":%ld", qfp -> qf_lnum);
            else __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), ":%ld col %d", qfp -> qf_lnum, qfp -> qf_col);
            __builtin___sprintf_chk ((char *) IObuff + strlen ((char *) (IObuff)), 0, __builtin_object_size ((char *) IObuff + strlen ((char *) (IObuff)), 1 > 1
              ), "%s:", (char *) qf_types (qfp -> qf_type, qfp -> qf_nr));
            ...
            msg_puts ((char_u *) " ");
            qf_fmt_text ((fname != ((void *) 0) || qfp -> qf_lnum != 0) ? skipwhite (qfp -> qf_text) : qfp -> qf_text, IObuff, (1024 + 1));
    ...
    exarg_T * eap;
{
    ...
    if (eap -> addr_count != 0) count = eap -> line2;
    else count = 1;
    while (count --) {
        if (eap -> cmdidx == CMD_colder || eap -> cmdidx == CMD_lolder) {
            if (qi -> qf_curlist == 0) {
                emsg ((char_u *) (((char *) ("E380: At bottom of quickfix stack"))));
                return;
            }
            --qi->qf_curlist;
        }
            ...
            if (qi -> qf_curlist >= qi -> qf_listcount - 1) {
                emsg ((char_u *) (((char *) ("E381: At top of quickfix stack"))));
                return;
            }
            ++qi->qf_curlist;
        }
...
static void qf_msg (qi)
    qf_info_T * qi;
{
    smsg ((char_u *) ((char *) ("error list %d of %d; %d errors")), qi -> qf_curlist + 1, qi -> qf_listcount, qi -> qf_lists [qi -> qf_curlist].qf_count);
    qf_update_buffer (qi);
}
    ...
    long amount_after;
{
    ...
    qf_info_T * qi = &ql_info;
    if (wp != ((void *) 0)) {
        if (wp -> w_llist == ((void *) 0)) return;
        qi = wp -> w_llist;
    }
    for (idx = 0; idx < qi -> qf_listcount; ++idx) if (qi -> qf_lists [idx].qf_count) for (i = 0, qfp = qi -> qf_lists [idx].qf_start; i < qi -> qf_lists [idx]
      .qf_count; ++i, qfp = qfp -> qf_next) if (qfp -> qf_fnum == curbuf -> b_fnum) {
        if (qfp -> qf_lnum >= line1 && qfp -> qf_lnum <= line2) {
            if (amount == (0x7fffffffL)) qfp -> qf_cleared = 1;
            else qfp -> qf_lnum += amount;
        }
        else if (amount_after && qfp -> qf_lnum > line2) qfp -> qf_lnum += amount_after;
    }
}
    ...
    int c, nr;
{
    ...
    static char_u cc [3];
    char_u * p;
    if (c == 'W' || c == 'w') p = (char_u *) " warning";
    else if (c == 'I' || c == 'i') p = (char_u *) " info";
    else if (c == 'E' || c == 'e' || (c == 0 && nr > 0)) p = (char_u *) " error";
    else if (c == 0 || c == 1) p = (char_u *) "";
    else {
        cc [0] = ' ';
        cc [1] = c;
        cc [2] = '\000';
    ...
    if (nr <= 0) return p;
    __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "%s %3d", (char *) p, nr);
    return buf;
}
    ...
    exarg_T * eap;
{
    ...
    win = qf_find_win (qi);
    if (qi -> qf_lists [qi -> qf_curlist].qf_nonevalid || qi -> qf_curlist >= qi -> qf_listcount) {
        if (win != ((void *) 0)) ex_cclose (eap);
    }
    else if (win == ((void *) 0)) ex_copen (eap);
}
    ...
    exarg_T * eap;
{
    ...
    if (eap -> addr_count != 0) height = eap -> line2;
    else height = 10;
    reset_VIsual_and_resel ();
    win = qf_find_win (qi);
    if (win != ((void *) 0) && cmdmod.tab == 0) win_goto (win);
    else {
        qf_buf = qf_find_buf (qi);
        win = curwin;
        if (eap -> cmdidx == CMD_copen || eap -> cmdidx == CMD_cwindow) win_goto (lastwin);
        if (win_split (height, 32 | 128) == 0) return;
        curwin -> w_onebuf_opt.wo_scb = 0;
        if (eap -> cmdidx == CMD_lopen || eap -> cmdidx == CMD_lwindow) {
            curwin -> w_llist_ref = win -> w_llist;
            win -> w_llist -> qf_refcount ++;
        }
        if (oldwin != curwin) oldwin = ((void *) 0);
        if (qf_buf != ((void *) 0)) (void) do_ecmd (qf_buf -> b_fnum, ((void *) 0), ((void *) 0), ((void *) 0), (linenr_T) 1, 0x01 + 0x04, oldwin);
        else {
            (void) do_ecmd (0, ((void *) 0), ((void *) 0), ((void *) 0), (linenr_T) 1, 0x01, oldwin);
            set_option_value ((char_u *) "swf", 0L, ((void *) 0), 4);
            set_option_value ((char_u *) "bt", 0L, (char_u *) "quickfix", 4);
            set_option_value ((char_u *) "bh", 0L, (char_u *) "wipe", 4);
            curwin -> w_onebuf_opt.wo_diff = 0;
            set_option_value ((char_u *) "fdm", 0L, (char_u *) "manual", 4);
        }
        if (curtab == prevtab && curwin -> w_width == Columns) win_setheight (height);
        curwin -> w_onebuf_opt.wo_wfh = 1;
        if (win_valid (win)) prevwin = win;
    }
    qf_fill_buffer (qi);
    if (qi -> qf_lists [qi -> qf_curlist].qf_title != ((void *) 0)) set_internal_string_var ((char_u *) "w:quickfix_title", qi -> qf_lists [qi -> qf_curlist].
      qf_title);
...
{
    qf_info_T * qi = &ql_info;
    if ((bt_quickfix (wp -> w_buffer) && wp -> w_llist_ref != ((void *) 0))) qi = wp -> w_llist_ref;
    ...
    int old_qf_index;
{
    ...
    win = qf_find_win (qi);
    if (win != ((void *) 0) && qf_index <= win -> w_buffer -> b_ml.ml_line_count && old_qf_index != qf_index) {
...
static int is_qf_win (win, qi)
    ...
    qf_info_T * qi;
{
    if (bt_quickfix (win -> w_buffer)) if ((qi == &ql_info && win -> w_llist_ref == ((void *) 0)) || (qi != &ql_info && win -> w_llist_ref == qi)) return 1;
    return 0;
}
...
{
    win_T * win;
    for (win = firstwin; win != ((void *) 0); win = win -> w_next) if (is_qf_win (win, qi)) break;
    return win;
}
    ...
    qf_info_T * qi;
{
    tabpage_T * tp;
    win_T * win;
    for ((tp) = first_tabpage; (tp) != ((void *) 0); (tp) = (tp) -> tp_next) for ((win) = ((tp) == curtab) ? firstwin : (tp) -> tp_firstwin; (win); (win) = (
      win) -> w_next) if (is_qf_win (win, qi)) return win -> w_buffer;
    return ((void *) 0);
}
    ...
    qf_info_T * qi;
{
    ...
    int len;
    int old_KeyTyped = KeyTyped;
    while ((curbuf -> b_ml.ml_flags & 1) == 0) (void) ml_delete ((linenr_T) 1, 0);
    if (qi -> qf_curlist < qi -> qf_listcount) {
        qfp = qi -> qf_lists [qi -> qf_curlist].qf_start;
        for (lnum = 0; lnum < qi -> qf_lists [qi -> qf_curlist].qf_count; ++lnum) {
            if (qfp -> qf_fnum != 0 && (errbuf = buflist_findnr (qfp -> qf_fnum)) != ((void *) 0) && errbuf -> b_fname != ((void *) 0)) {
                if (qfp -> qf_type == 1) ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) (
                  gettail (errbuf -> b_fname)), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) (gettail (
                  errbuf -> b_fname))));
                else ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) (errbuf -> b_fname),
                  __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) (errbuf -> b_fname)));
                len = (int) strlen ((char *) (IObuff));
            }
            else len = 0;
            IObuff [len ++] = '|';
            if (qfp -> qf_lnum > 0) {
                __builtin___sprintf_chk ((char *) IObuff + len, 0, __builtin_object_size ((char *) IObuff + len, 1 > 1), "%ld", qfp -> qf_lnum);
                len += (int) strlen ((char *) (IObuff + len));
                if (qfp -> qf_col > 0) {
                    __builtin___sprintf_chk ((char *) IObuff + len, 0, __builtin_object_size ((char *) IObuff + len, 1 > 1), " col %d", qfp -> qf_col);
                    len += (int) strlen ((char *) (IObuff + len));
                }
                __builtin___sprintf_chk ((char *) IObuff + len, 0, __builtin_object_size ((char *) IObuff + len, 1 > 1), "%s", (char *) qf_types (qfp -> qf_type
                  , qfp -> qf_nr));
                len += (int) strlen ((char *) (IObuff + len));
            }
            ...
            IObuff [len ++] = '|';
            IObuff [len ++] = ' ';
            qf_fmt_text (len > 3 ? skipwhite (qfp -> qf_text) : qfp -> qf_text, IObuff + len, (1024 + 1) - len);
            if (ml_append (lnum, IObuff, (colnr_T) strlen ((char *) (IObuff)) + 1, 0) == 0) break;
            qfp = qfp -> qf_next;
        }
    ...
    curbuf -> b_p_ma = 0;
    keep_filetype = 1;
    apply_autocmds (EVENT_BUFREADPOST, (char_u *) "quickfix", ((void *) 0), 0, curbuf);
    apply_autocmds (EVENT_BUFWINENTER, (char_u *) "quickfix", ((void *) 0), 0, curbuf);
    keep_filetype = 0;
...
int bt_nofile (buf)
    buf_T * buf;
{
    return (buf -> b_p_bt [0] == 'n' && buf -> b_p_bt [2] == 'f') || buf -> b_p_bt [0] == 'a';
}
...
{
    if (bt_dontwrite (buf)) {
        emsg ((char_u *) (((char *) ("E382: Cannot write, 'buftype' option is set"))));
        return 1;
    }
    return 0;
}
...
int grep_internal (cmdidx)
    cmdidx_T cmdidx;
{
    return ((cmdidx == CMD_grep || cmdidx == CMD_lgrep || cmdidx == CMD_grepadd || cmdidx == CMD_lgrepadd) && strcmp ((char *) ("internal"), (char *) 
      (*curbuf->b_p_gp == '\000' ? p_gp : curbuf -> b_p_gp)) == 0);
}
    ...
    exarg_T * eap;
{
    ...
    if (au_name != ((void *) 0)) {
        apply_autocmds (EVENT_QUICKFIXCMDPRE, au_name, curbuf -> b_fname, 1, curbuf);
        if (did_throw || force_abort) return;
    }
    if (grep_internal (eap -> cmdidx)) {
        ex_vimgrep (eap);
        return;
    }
    if (eap -> cmdidx == CMD_lmake || eap -> cmdidx == CMD_lgrep || eap -> cmdidx == CMD_lgrepadd) wp = curwin;
    autowrite_all ();
    fname = get_mef_name ();
    if (fname == ((void *) 0)) return;
    unlink ((char *) (fname));
    len = (unsigned) strlen ((char *) (p_shq)) * 2 + (unsigned) strlen ((char *) (eap -> arg)) + 1;
    if (*p_sp != '\000') len += (unsigned) strlen ((char *) (p_sp)) + (unsigned) strlen ((char *) (fname)) + 3;
    cmd = alloc (len);
    if (cmd == ((void *) 0)) return;
    __builtin___sprintf_chk ((char *) cmd, 0, __builtin_object_size ((char *) cmd, 1 > 1), "%s%s%s", (char *) p_shq, (char *) eap -> arg, (char *) p_shq);
    if (*p_sp != '\000') append_redir (cmd, len, p_sp, fname);
    if (msg_col == 0) msg_didout = 0;
    msg_start ();
    msg_puts ((char_u *) (":!"));
    msg_outtrans (cmd);
    do_shell (cmd, *p_sp != '\000' ? 8 : 0);
    res = qf_init (wp, fname, (eap -> cmdidx != CMD_make && eap -> cmdidx != CMD_lmake) ? p_gefm : p_efm, (eap -> cmdidx != CMD_grepadd && eap -> cmdidx !=
      CMD_lgrepadd), *eap->cmdlinep);
    if (au_name != ((void *) 0)) apply_autocmds (EVENT_QUICKFIXCMDPOST, au_name, curbuf -> b_fname, 1, curbuf);
    if (res > 0 && !eap->forceit) {
        if (wp != ((void *) 0)) qi = ((bt_quickfix (wp -> w_buffer) && wp -> w_llist_ref != ((void *) 0)) ? wp -> w_llist_ref : wp -> w_llist);
        qf_jump (qi, 0, 0, 0);
    }
    unlink ((char *) (fname));
    vim_free (fname);
...
static char_u * get_mef_name () {
    ...
    if (*p_mef == '\000') {
        name = vim_tempname ('e');
        if (name == ((void *) 0)) emsg ((char_u *) (((char *) (e_notmp))));
        return name;
    }
    for (p = p_mef; *p; ++p) if (p [0] == '#' && p [1] == '#') break;
    if (*p == '\000') return vim_strsave (p_mef);
    for (;;) {
        if (start == -1) start = mch_get_pid ();
        else off += 19;
        name = alloc ((unsigned) strlen ((char *) (p_mef)) + 30);
        if (name == ((void *) 0)) break;
        ((__builtin_object_size ((char *) (name), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (name), (char *) (p_mef), __builtin_object_size ((char
          *) (name), 1 > 1)) : __inline_strcpy_chk ((char *) (name), (char *) (p_mef)));
        __builtin___sprintf_chk ((char *) name + (p - p_mef), 0, __builtin_object_size ((char *) name + (p - p_mef), 1 > 1), "%d%d", start, off);
        ((__builtin_object_size ((char *) (name), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (name), (char *) (p + 2), __builtin_object_size ((char
          *) (name), 1 > 1)) : __inline_strcat_chk ((char *) (name), (char *) (p + 2)));
        if (mch_getperm (name) < 0 && lstat (((char *) name), (&sb)) < 0) break;
        vim_free (name);
    }
    return name;
}
...
{
    qf_info_T * qi = &ql_info;
    if (eap -> cmdidx == CMD_ll || eap -> cmdidx == CMD_lrewind || eap -> cmdidx == CMD_lfirst || eap -> cmdidx == CMD_llast) {
        qi = ((bt_quickfix (curwin -> w_buffer) && curwin -> w_llist_ref != ((void *) 0)) ? curwin -> w_llist_ref : curwin -> w_llist);
        if (qi == ((void *) 0)) {
            emsg ((char_u *) (((char *) (e_loclist))));
            return;
    ...
    qf_jump (qi, 0, eap -> addr_count > 0 ? (int) eap -> line2 : (eap -> cmdidx == CMD_cc || eap -> cmdidx == CMD_ll) ? 0 : (eap -> cmdidx == CMD_crewind || eap
      -> cmdidx == CMD_lrewind || eap -> cmdidx == CMD_cfirst || eap -> cmdidx == CMD_lfirst) ? 1 : 32767, eap -> forceit);
}
...
{
    qf_info_T * qi = &ql_info;
    if (eap -> cmdidx == CMD_lnext || eap -> cmdidx == CMD_lNext || eap -> cmdidx == CMD_lprevious || eap -> cmdidx == CMD_lnfile || eap -> cmdidx == CMD_lNfile
    ...
    qf_jump (qi, (eap -> cmdidx == CMD_cnext || eap -> cmdidx == CMD_lnext) ? 1 : (eap -> cmdidx == CMD_cnfile || eap -> cmdidx == CMD_lnfile) ? 3 : (eap ->
      cmdidx == CMD_cpfile || eap -> cmdidx == CMD_lpfile || eap -> cmdidx == CMD_cNfile || eap -> cmdidx == CMD_lNfile) ? (-3) : (-1), eap -> addr_count > 0 ?
      (int) eap -> line2 : 1, eap -> forceit);
}
    ...
    exarg_T * eap;
{
    win_T * wp = ((void *) 0);
    qf_info_T * qi = &ql_info;
    if (eap -> cmdidx == CMD_lfile || eap -> cmdidx == CMD_lgetfile || eap -> cmdidx == CMD_laddfile) wp = curwin;
    if (*eap->arg != '\000') set_string_option_direct ((char_u *) "ef", -1, eap -> arg, 1, 0);
    if (qf_init (wp, p_ef, p_efm, (eap -> cmdidx != CMD_caddfile && eap -> cmdidx != CMD_laddfile), *eap->cmdlinep) > 0 && (eap -> cmdidx == CMD_cfile || eap ->
      cmdidx == CMD_lfile)) {
        if (wp != ((void *) 0)) qi = ((bt_quickfix (wp -> w_buffer) && wp -> w_llist_ref != ((void *) 0)) ? wp -> w_llist_ref : wp -> w_llist);
    ...
    exarg_T * eap;
{
    ...
    colnr_T col;
    long tomatch;
    char_u dirname_start [1024];
    char_u dirname_now [1024];
    ...
    if (eap -> cmdidx == CMD_lgrep || eap -> cmdidx == CMD_lvimgrep || eap -> cmdidx == CMD_lgrepadd || eap -> cmdidx == CMD_lvimgrepadd) {
        qi = ll_get_or_alloc_list (curwin);
        if (qi == ((void *) 0)) return;
    }
    if (eap -> addr_count > 0) tomatch = eap -> line2;
    else tomatch = (0x7fffffffL);
    ...
    if (regmatch.regprog == ((void *) 0)) goto theend;
    regmatch.rmm_ic = p_ic;
    regmatch.rmm_maxcol = 0;
    p = skipwhite (p);
    if (*p == '\000') {
        emsg ((char_u *) (((char *) ("E683: File name missing or invalid pattern"))));
        goto theend;
    }
    if ((eap -> cmdidx != CMD_grepadd && eap -> cmdidx != CMD_lgrepadd && eap -> cmdidx != CMD_vimgrepadd && eap -> cmdidx != CMD_lvimgrepadd) || qi ->
      qf_curlist == qi -> qf_listcount) qf_new_list (qi, *eap->cmdlinep);
    else if (qi -> qf_lists [qi -> qf_curlist].qf_count > 0) for (prevp = qi -> qf_lists [qi -> qf_curlist].qf_start; prevp -> qf_next != prevp; prevp = prevp
      -> qf_next);
    if (get_arglist_exp (p, &fcount, &fnames) == 0) goto theend;
    if (fcount == 0) {
        emsg ((char_u *) (((char *) (e_nomatch))));
        goto theend;
    }
    mch_dirname (dirname_start, 1024);
    seconds = (time_t) 0;
    for (fi = 0; fi < fcount && !got_int && tomatch > 0; ++fi) {
        ...
        if (time (((void *) 0)) > seconds) {
            ...
            if (p == ((void *) 0)) msg_outtrans (fname);
            else {
                msg_outtrans (p);
                vim_free (p);
            }
        ...
        if (buf == ((void *) 0)) {
            if (!got_int) smsg ((char_u *) ((char *) ("Cannot open file \"%s\"")), fname);
        }
        else {
            found_match = 0;
            for (lnum = 1; lnum <= buf -> b_ml.ml_line_count && tomatch > 0; ++lnum) {
                col = 0;
                while (vim_regexec_multi (&regmatch, curwin, buf, lnum, col, ((void *) 0)) > 0) {
                    ;
                    if (qf_add_entry (qi, &prevp, ((void *) 0), fname, 0, ml_get_buf (buf, regmatch.startpos [0].lnum + lnum, 0), regmatch.startpos [0].lnum +
                      lnum, regmatch.startpos [0].col + 1, 0, ((void *) 0), 0, 0, 1) == 0) {
                        got_int = 1;
                        break;
                    }
                    found_match = 1;
                    if (--tomatch == 0) break;
                    if ((flags & 1) == 0 || regmatch.endpos [0].lnum > 0) break;
                    col = regmatch.endpos [0].col + (col == regmatch.endpos [0].col);
                    if (col > (colnr_T) strlen ((char *) (ml_get_buf (buf, lnum, 0)))) break;
                }
                line_breakcheck ();
                if (got_int) break;
            }
            if (using_dummy) {
                if (found_match && first_match_buf == ((void *) 0)) first_match_buf = buf;
                if (duplicate_name) {
                    wipe_dummy_buffer (buf);
                    buf = ((void *) 0);
                }
                else if (!cmdmod.hide || buf -> b_p_bh [0] == 'u' || buf -> b_p_bh [0] == 'w' || buf -> b_p_bh [0] == 'd') {
                    if (!found_match) {
                        wipe_dummy_buffer (buf);
                        buf = ((void *) 0);
                    }
                ...
                if (buf != ((void *) 0)) {
                    if (buf == first_match_buf && target_dir == ((void *) 0) && strcmp ((char *) (dirname_start), (char *) (dirname_now)) != 0) target_dir =
                      vim_strsave (dirname_now);
                    aucmd_prepbuf (&aco, buf);
                    apply_autocmds (EVENT_FILETYPE, buf -> b_p_ft, buf -> b_fname, 1, buf);
                    do_modelines (32);
                    aucmd_restbuf (&aco);
                }
            }
    ...
    if (qi -> qf_lists [qi -> qf_curlist].qf_count > 0) {
        if ((flags & 2) == 0) {
            buf = curbuf;
            qf_jump (qi, 0, 0, eap -> forceit);
            if (buf != curbuf) redraw_for_dummy = 0;
    ...
    else emsg2 ((char_u *) (((char *) (e_nomatch2))), (char_u *) (s));
    if (redraw_for_dummy) {
        foldUpdateAll (curwin);
    }
    theend : vim_free (target_dir);
    ...
    int * flags;
{
    ...
    if (vim_isIDc (*p)) {
        if (s != ((void *) 0)) *s = p;
        p = skiptowhite (p);
        if (s != ((void *) 0) && *p != '\000') *p++ = '\000';
    }
    else {
        if (s != ((void *) 0)) *s = p + 1;
        c = *p;
        p = skip_regexp (p + 1, c, 1, ((void *) 0));
        if (*p != c) return ((void *) 0);
        if (s != ((void *) 0)) *p = '\000';
        ++p;
        while (*p == 'g' || *p == 'j') {
            if (flags != ((void *) 0)) {
...
static buf_T * load_dummy_buffer (fname)
    char_u * fname;
{
    buf_T * newbuf;
    int failed = 1;
    ...
    if (ml_open (newbuf) == 1) {
        ...
        check_need_swap (1);
        curbuf -> b_flags &= ~0x80;
        if (readfile (fname, ((void *) 0), (linenr_T) 0, (linenr_T) 0, (linenr_T) (0x7fffffffL), ((void *) 0), 0x01 | 0x10) == 1 && !got_int && 
          !(curbuf->b_flags&0x10)) {
            failed = 0;
            if (curbuf != newbuf) {
                if (buf_valid (newbuf)) wipe_buffer (newbuf, 0);
                newbuf = curbuf;
            }
        }
        aucmd_restbuf (&aco);
    }
    if (!buf_valid(newbuf)) return ((void *) 0);
    if (failed) {
...
static void wipe_dummy_buffer (buf)
    buf_T * buf;
{
    if (curbuf != buf) {
        cleanup_T cs;
...
static void unload_dummy_buffer (buf)
    buf_T * buf;
{
    if (curbuf != buf) close_buffer (((void *) 0), buf, 2);
}
    ...
    list_T * list;
{
    ...
    if (qi -> qf_curlist >= qi -> qf_listcount || qi -> qf_lists [qi -> qf_curlist].qf_count == 0) return 0;
    qfp = qi -> qf_lists [qi -> qf_curlist].qf_start;
    for (i = 1; !got_int && i <= qi -> qf_lists [qi -> qf_curlist].qf_count; ++i) {
        bufnum = qfp -> qf_fnum;
        if (bufnum != 0 && (buflist_findnr (bufnum) == ((void *) 0))) bufnum = 0;
        if ((dict = dict_alloc ()) == ((void *) 0)) return 0;
        if (list_append_dict (list, dict) == 0) return 0;
        buf [0] = qfp -> qf_type;
        buf [1] = '\000';
        if (dict_add_nr_str (dict, "bufnr", (long) bufnum, ((void *) 0)) == 0 || dict_add_nr_str (dict, "lnum", (long) qfp -> qf_lnum, ((void *) 0)) == 0 ||
          dict_add_nr_str (dict, "col", (long) qfp -> qf_col, ((void *) 0)) == 0 || dict_add_nr_str (dict, "vcol", (long) qfp -> qf_viscol, ((void *) 0)) == 0
          || dict_add_nr_str (dict, "nr", (long) qfp -> qf_nr, ((void *) 0)) == 0 || dict_add_nr_str (dict, "pattern", 0L, qfp -> qf_pattern == ((void *) 0) ? (
          char_u *) "" : qfp -> qf_pattern) == 0 || dict_add_nr_str (dict, "text", 0L, qfp -> qf_text == ((void *) 0) ? (char_u *) "" : qfp -> qf_text) == 0 ||
          dict_add_nr_str (dict, "type", 0L, buf) == 0 || dict_add_nr_str (dict, "valid", (long) qfp -> qf_valid, ((void *) 0)) == 0) return 0;
        qfp = qfp -> qf_next;
    }
    return 1;
}
    ...
    char_u * title;
{
    ...
    if (action == ' ' || qi -> qf_curlist == qi -> qf_listcount) qf_new_list (qi, title);
    else if (action == 'a' && qi -> qf_lists [qi -> qf_curlist].qf_count > 0) for (prevp = qi -> qf_lists [qi -> qf_curlist].qf_start; prevp -> qf_next != prevp
      ; prevp = prevp -> qf_next);
    else if (action == 'r') qf_free (qi, qi -> qf_curlist);
    for (li = list -> lv_first; li != ((void *) 0); li = li -> li_next) {
        if (li -> li_tv.v_type != 5) continue;
        ...
        if (text == ((void *) 0)) text = vim_strsave ((char_u *) "");
        valid = 1;
        if ((filename == ((void *) 0) && bufnum == 0) || (lnum == 0 && pattern == ((void *) 0))) valid = 0;
        if (bufnum != 0 && (buflist_findnr (bufnum) == ((void *) 0))) {
            if (!did_bufnr_emsg) {
                did_bufnr_emsg = 1;
                emsgn ((char_u *) (((char *) ("E92: Buffer %ld not found"))), (long) (bufnum));
            }
            valid = 0;
            bufnum = 0;
        }
        status = qf_add_entry (qi, &prevp, ((void *) 0), filename, bufnum, text, lnum, col, vcol, pattern, nr, type == ((void *) 0) ? '\000' : *type, valid);
        vim_free (filename);
        vim_free (pattern);
        vim_free (text);
        vim_free (type);
    ...
    if (qi -> qf_lists [qi -> qf_curlist].qf_index == 0) qi -> qf_lists [qi -> qf_curlist].qf_nonevalid = 1;
    else qi -> qf_lists [qi -> qf_curlist].qf_nonevalid = 0;
    qi -> qf_lists [qi -> qf_curlist].qf_ptr = qi -> qf_lists [qi -> qf_curlist].qf_start;
    qi -> qf_lists [qi -> qf_curlist].qf_index = 1;
    qf_update_buffer (qi);
    return retval;
    ...
    exarg_T * eap;
{
    buf_T * buf = ((void *) 0);
    qf_info_T * qi = &ql_info;
    if (eap -> cmdidx == CMD_lbuffer || eap -> cmdidx == CMD_lgetbuffer || eap -> cmdidx == CMD_laddbuffer) {
        qi = ll_get_or_alloc_list (curwin);
        if (qi == ((void *) 0)) return;
    }
    if (*eap->arg == '\000') buf = curbuf;
    else if (*skipwhite(skipdigits(eap->arg)) == '\000') buf = buflist_findnr (atoi ((char *) eap -> arg));
    if (buf == ((void *) 0)) emsg ((char_u *) (((char *) (e_invarg))));
    else if (buf -> b_ml.ml_mfp == ((void *) 0)) emsg ((char_u *) (((char *) ("E681: Buffer is not loaded"))));
    else {
        if (eap -> addr_count == 0) {
            eap -> line1 = 1;
            eap -> line2 = buf -> b_ml.ml_line_count;
        }
        if (eap -> line1 < 1 || eap -> line1 > buf -> b_ml.ml_line_count || eap -> line2 < 1 || eap -> line2 > buf -> b_ml.ml_line_count) emsg ((char_u *) (((
          char *) (e_invrange))));
        else {
            char_u * qf_title = *eap->cmdlinep;
            if (buf -> b_sfname) {
                vim_snprintf ((char *) IObuff, (1024 + 1), "%s (%s)", (char *) qf_title, (char *) buf -> b_sfname);
                qf_title = IObuff;
            }
            if (qf_init_ext (qi, ((void *) 0), buf, ((void *) 0), p_efm, (eap -> cmdidx != CMD_caddbuffer && eap -> cmdidx != CMD_laddbuffer), eap -> line1, eap
              -> line2, qf_title) > 0 && (eap -> cmdidx == CMD_cbuffer || eap -> cmdidx == CMD_lbuffer)) qf_jump (qi, 0, 0, eap -> forceit);
        }
    }
}
    ...
    exarg_T * eap;
{
    typval_T * tv;
    qf_info_T * qi = &ql_info;
    if (eap -> cmdidx == CMD_lexpr || eap -> cmdidx == CMD_lgetexpr || eap -> cmdidx == CMD_laddexpr) {
        qi = ll_get_or_alloc_list (curwin);
        if (qi == ((void *) 0)) return;
    }
    tv = eval_expr (eap -> arg, ((void *) 0));
    if (tv != ((void *) 0)) {
        if ((tv -> v_type == 2 && tv -> vval.v_string != ((void *) 0)) || (tv -> v_type == 4 && tv -> vval.v_list != ((void *) 0))) {
            if (qf_init_ext (qi, ((void *) 0), ((void *) 0), tv, p_efm, (eap -> cmdidx != CMD_caddexpr && eap -> cmdidx != CMD_laddexpr), (linenr_T) 0, (
              linenr_T) 0, *eap->cmdlinep) > 0 && (eap -> cmdidx == CMD_cexpr || eap -> cmdidx == CMD_lexpr)) qf_jump (qi, 0, 0, eap -> forceit);
        }
        else emsg ((char_u *) (((char *) ("E777: String or List expected"))));
        free_tv (tv);
    }
}
    ...
    exarg_T * eap;
{
    ...
    if (eap -> cmdidx == CMD_lhelpgrep) {
        for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) if (wp -> w_buffer != ((void *) 0) && wp -> w_buffer -> b_help) break;
        if (wp == ((void *) 0)) qi = ((void *) 0);
        else qi = wp -> w_llist;
        if (qi == ((void *) 0)) {
            if ((qi = ll_new_list ()) == ((void *) 0)) return;
            new_qi = 1;
        }
    }
    ...
    if (regmatch.regprog != ((void *) 0)) {
        ...
        while (*p != '\000' && !got_int) {
            ...
            ((__builtin_object_size ((char *) (NameBuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (NameBuff), (char *) ("doc/*.\\(txt\\|??x\\)")
              , __builtin_object_size ((char *) (NameBuff), 1 > 1)) : __inline_strcat_chk ((char *) (NameBuff), (char *) ("doc/*.\\(txt\\|??x\\)")));
            if (gen_expand_wildcards (1, &NameBuff, &fcount, &fnames, 0x02 | 0x20) == 1 && fcount > 0) {
                for (fi = 0; fi < fcount && !got_int; ++fi) {
                    if (lang != ((void *) 0) && strncasecmp ((char *) (lang), (char *) (fnames [fi] + strlen ((char *) (fnames [fi])) - 3), (size_t) (2)) != 0
                      && !(strncasecmp((char*)(lang),(char*)("en"),(size_t)(2))==0&&strncasecmp((char*)("txt"),(char*)(fnames[fi]+strlen((char*)(fnames[fi]))-3
                      ),(size_t)(3))==0)) continue;
                    ...
                    if (fd != ((void *) 0)) {
                        ...
                        while (!vim_fgets(IObuff,(1024+1),fd) && !got_int) {
                            if (vim_regexec (&regmatch, IObuff, (colnr_T) 0)) {
                                int l = (int) strlen ((char *) (IObuff));
                                while (l > 0 && IObuff [l - 1] <= ' ') IObuff [--l] = '\000';
                                if (qf_add_entry (qi, &prevp, ((void *) 0), fnames [fi], 0, IObuff, lnum, (int) (regmatch.startp [0] - IObuff) + 1, 0, ((void *
                                  ) 0), 0, 1, 1) == 0) {
                                    got_int = 1;
                                    break;
                                }
    ...
    qf_update_buffer (qi);
    if (qi -> qf_lists [qi -> qf_curlist].qf_count > 0) qf_jump (qi, 0, 0, 0);
    else emsg2 ((char_u *) (((char *) (e_nomatch2))), (char_u *) (eap -> arg));
    if (eap -> cmdidx == CMD_lhelpgrep) {
        if (!curwin->w_buffer->b_help || curwin -> w_llist == qi) {
            if (new_qi) ll_free_all (&qi);
        }
        else if (curwin -> w_llist == ((void *) 0)) curwin -> w_llist = qi;
    }
}

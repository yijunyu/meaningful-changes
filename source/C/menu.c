    ...
    exarg_T * eap;
{
    ...
    if (strncmp ((char *) (arg), (char *) ("icon="), (size_t) (5)) == 0) {
        arg += 5;
        while (*arg != '\000' && *arg != ' ') {
            if (*arg == '\\') ((__builtin_object_size ((char *) ((arg)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((arg)), (char *) ((arg + 1)),
              strlen ((char *) (arg + 1)) + 1, __builtin_object_size ((char *) ((arg)), 0)) : __inline_memmove_chk ((char *) ((arg)), (char *) ((arg + 1)),
              strlen ((char *) (arg + 1)) + 1));
            ++arg;
        }
        if (*arg != '\000') {
    ...
    for (p = arg; *p; ++p) if (!((*p) >= '0' && (*p) <= '9') && *p != '.') break;
    if (((*p) == ' ' || (*p) == '\t')) {
        for (i = 0; i < 10 && !((*arg) == ' ' || (*arg) == '\t'); ++i) {
            pri_tab [i] = getdigits (&arg);
            if (pri_tab [i] == 0) pri_tab [i] = 500;
            if (*arg == '.') ++arg;
        }
        arg = skipwhite (arg);
    }
    ...
    while (i < 10) pri_tab [i ++] = 500;
    pri_tab [10] = -1;
    if (strncmp ((char *) (arg), (char *) ("enable"), (size_t) (6)) == 0 && ((arg [6]) == ' ' || (arg [6]) == '\t')) {
        enable = 1;
        arg = skipwhite (arg + 6);
    }
    else if (strncmp ((char *) (arg), (char *) ("disable"), (size_t) (7)) == 0 && ((arg [7]) == ' ' || (arg [7]) == '\t')) {
        enable = 0;
        arg = skipwhite (arg + 7);
    }
    if (*arg == '\000') {
    ...
    menu_path = arg;
    if (*menu_path == '.') {
        emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (menu_path));
        goto theend;
    }
    ...
    if (enable != 2) {
        if (strcmp ((char *) (menu_path), (char *) ("*")) == 0) menu_path = (char_u *) "";
        if (menu_is_popup (menu_path)) {
            for (i = 0; i < 6; ++i) if (modes & (1 << i)) {
        ...
        else if (modes & (1 << 6)) map_buf = ((void *) 0);
        else map_to = replace_termcodes (map_to, &map_buf, 0, 1, special);
        menuarg.modes = modes;
    ...
    char_u * call_data;
{
    ...
    while (*name) {
        ...
        if (dname == ((void *) 0)) goto erret;
        if (*dname == '\000') {
            emsg ((char_u *) (((char *) ("E792: Empty menu name"))));
            goto erret;
        }
        lower_pri = menup;
        menu = *menup;
        while (menu != ((void *) 0)) {
            if (menu_name_equal (name, menu) || menu_name_equal (dname, menu)) {
                if (*next_name == '\000' && menu -> children != ((void *) 0)) {
                    if (!sys_menu) emsg ((char_u *) (((char *) ("E330: Menu path must not lead to a sub-menu"))));
                    goto erret;
                }
                if (*next_name != '\000' && menu -> children == ((void *) 0)) {
                    if (!sys_menu) emsg ((char_u *) (((char *) (e_notsubmenu))));
                    goto erret;
                }
                break;
            }
        ...
        if (menu == ((void *) 0)) {
            if (*next_name == '\000' && parent == ((void *) 0)) {
                emsg ((char_u *) (((char *) ("E331: Must not add menu items directly to menu bar"))));
                goto erret;
            }
            if (menu_is_separator (dname) && *next_name != '\000') {
                emsg ((char_u *) (((char *) ("E332: Separator cannot be part of a menu path"))));
                goto erret;
            }
            menu = (vimmenu_T *) alloc_clear ((unsigned) sizeof (vimmenu_T));
            if (menu == ((void *) 0)) goto erret;
            menu -> modes = modes;
            menu -> enabled = ((1 << 6) - 1);
        ...
        vim_free (dname);
        dname = ((void *) 0);
        if (pri_tab [pri_idx + 1] != -1) ++pri_idx;
    }
    vim_free (path_name);
    amenu = ((modes & ((1 << 0) | (1 << 4))) == ((1 << 0) | (1 << 4)));
    if (sys_menu) modes &= ~old_modes;
    if (menu != ((void *) 0) && modes) {
        ...
        for (i = 0; i < 7; ++i) {
            if (modes & (1 << i)) {
                ...
                if (c != 0) {
                    menu -> strings [i] = alloc ((unsigned) (strlen ((char *) (call_data)) + 5));
                    if (menu -> strings [i] != ((void *) 0)) {
                        menu -> strings [i] [0] = c;
                        if (d == 0) ((__builtin_object_size ((char *) (menu -> strings [i] + 1), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (menu ->
                          strings [i] + 1), (char *) (call_data), __builtin_object_size ((char *) (menu -> strings [i] + 1), 1 > 1)) : __inline_strcpy_chk ((
                          char *) (menu -> strings [i] + 1), (char *) (call_data)));
                        else {
                            menu -> strings [i] [1] = d;
                            ((__builtin_object_size ((char *) (menu -> strings [i] + 2), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (menu -> strings
                              [i] + 2), (char *) (call_data), __builtin_object_size ((char *) (menu -> strings [i] + 2), 1 > 1)) : __inline_strcpy_chk ((char *
                              ) (menu -> strings [i] + 2), (char *) (call_data)));
                        }
                        if (c == 3) {
    ...
    return 1;
    erret : vim_free (path_name);
    vim_free (dname);
    while (parent != ((void *) 0) && parent -> children == ((void *) 0)) {
        if (parent -> parent == ((void *) 0)) menup = &root_menu;
        else menup = &parent->parent->children;
        for (; *menup != ((void *) 0) && *menup != parent; menup = &((*menup) -> next));
        if (*menup == ((void *) 0)) break;
...
{
    char_u * p;
    if (menu == ((void *) 0)) return 1;
    p = menu_name_skip (name);
    while (menu != ((void *) 0)) {
        if (*name == '\000' || *name == '*' || menu_name_equal (name, menu)) {
            if (*p != '\000') {
                if (menu -> children == ((void *) 0)) {
                    emsg ((char_u *) (((char *) (e_notsubmenu))));
                    return 0;
                }
                if (menu_nable_recurse (menu -> children, p, modes, enable) == 0) return 0;
            }
            else if (enable) menu -> enabled |= modes;
            else menu -> enabled &= ~modes;
            if (*name != '\000' && *name != '*') break;
        }
        menu = menu -> next;
    }
    if (*name != '\000' && *name != '*' && menu == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) (e_nomenu))), (char_u *) (name));
        return 0;
    }
    return 1;
}
    ...
    int silent;
{
    ...
    vimmenu_T * child;
    char_u * p;
    if (*menup == ((void *) 0)) return 1;
    p = menu_name_skip (name);
    while ((menu = *menup) != ((void *) 0)) {
        if (*name == '\000' || menu_name_equal (name, menu)) {
            if (*p != '\000' && menu -> children == ((void *) 0)) {
                if (!silent) emsg ((char_u *) (((char *) (e_notsubmenu))));
                return 0;
            }
            if ((menu -> modes & modes) != 0x0) {
                if (remove_menu (&menu->children, p, modes, silent) == 0) return 0;
            }
            else if (*name != '\000') {
                if (!silent) emsg ((char_u *) (((char *) (e_othermode))));
                return 0;
            }
            if (*name != '\000') break;
            menu -> modes &= ~modes;
            if (modes & (1 << 6)) free_menu_string (menu, 6);
            if ((menu -> modes & ((1 << 6) - 1)) == 0) free_menu (menup);
            else menup = &menu->next;
        }
        else menup = &menu->next;
    }
    if (*name != '\000') {
        if (menu == ((void *) 0)) {
            if (!silent) emsg2 ((char_u *) (((char *) (e_nomenu))), (char_u *) (name));
            return 0;
        }
        menu -> modes &= ~modes;
        child = menu -> children;
        for (; child != ((void *) 0); child = child -> next) menu -> modes |= child -> modes;
        if (modes & (1 << 6)) {
    ...
    vimmenu_T * * menup;
{
    ...
    * menup = menu -> next;
    ...
    for (i = 0; i < 7; i ++) free_menu_string (menu, i);
    vim_free (menu);
}
    ...
    int idx;
{
    int count = 0;
    int i;
    for (i = 0; i < 7; i ++) if (menu -> strings [i] == menu -> strings [idx]) count ++;
    if (count == 1) vim_free (menu -> strings [idx]);
    ...
    int depth;
{
    int i;
    int bit;
    if (menu != ((void *) 0) && (menu -> modes & modes) == 0x0) return;
    if (menu != ((void *) 0)) {
        msg_putchar ('\n');
        if (got_int) return;
        for (i = 0; i < depth; i ++) msg_puts ((char_u *) ("  "));
        if (menu -> priority) {
    ...
    if (menu != ((void *) 0) && menu -> children == ((void *) 0)) {
        for (bit = 0; bit < 7; bit ++) if ((menu -> modes & modes & (1 << bit)) != 0) {
            msg_putchar ('\n');
            if (got_int) return;
            for (i = 0; i < depth + 2; i ++) msg_puts ((char_u *) ("  "));
            msg_putchar (menu_mode_chars [bit]);
            if (menu -> noremap [bit] == -1) msg_putchar ('*');
            else if (menu -> noremap [bit] == -2) msg_putchar ('&');
            else msg_putchar (' ');
            if (menu -> silent [bit]) msg_putchar ('s');
            else msg_putchar (' ');
            if ((menu -> modes & menu -> enabled & (1 << bit)) == 0) msg_putchar ('-');
            else msg_putchar (' ');
            msg_puts ((char_u *) (" "));
            if (*menu->strings[bit] == '\000') msg_puts_attr ((char_u *) "<Nop>", highlight_attr [(int) (HLF_8)]);
            else msg_outtrans_special (menu -> strings [bit], 0);
        }
    }
    else {
        if (menu == ((void *) 0)) {
        ...
        else menu = menu -> children;
        for (; menu != ((void *) 0) && !got_int; menu = menu -> next) if (!menu_is_hidden(menu->dname)) show_menus_recursive (menu, modes, depth + 1);
    }
}
    ...
    int forceit;
{
    ...
    for (p = arg; *p; ++p) if (!((*p) >= '0' && (*p) <= '9') && *p != '.') break;
    if (!((*p) == ' ' || (*p) == '\t')) {
        if (strncmp ((char *) (arg), (char *) ("enable"), (size_t) (6)) == 0 && (arg [6] == '\000' || ((arg [6]) == ' ' || (arg [6]) == '\t'))) p = arg + 6;
        else if (strncmp ((char *) (arg), (char *) ("disable"), (size_t) (7)) == 0 && (arg [7] == '\000' || ((arg [7]) == ' ' || (arg [7]) == '\t'))) p = arg +
          7;
        else p = arg;
    }
    while (*p != '\000' && ((*p) == ' ' || (*p) == '\t')) ++p;
    ...
    for (; *p && !((*p) == ' ' || (*p) == '\t'); ++p) {
        if ((*p == '\\' || *p == 22) && p [1] != '\000') p ++;
        else if (*p == '.') after_dot = p + 1;
    }
    expand_menus = !((*cmd == 't' && cmd [1] == 'e') || *cmd == 'p');
    expand_emenu = (*cmd == 'e');
    if (expand_menus && ((*p) == ' ' || (*p) == '\t')) return ((void *) 0);
    if (*p == '\000') {
        expand_modes = get_menu_cmd_modes (cmd, forceit, ((void *) 0), &unmenu);
        if (!unmenu) expand_modes = ((1 << 6) - 1);
        menu = root_menu;
        if (after_dot != arg) {
            path_name = alloc ((unsigned) (after_dot - arg));
            if (path_name == ((void *) 0)) return ((void *) 0);
        ...
        while (name != ((void *) 0) && *name) {
            ...
            while (menu != ((void *) 0)) {
                if (menu_name_equal (name, menu)) {
                    if ((*p != '\000' && menu -> children == ((void *) 0)) || ((menu -> modes & expand_modes) == 0x0)) {
                        vim_free (path_name);
                        return ((void *) 0);
                    }
                    break;
        ...
        vim_free (path_name);
        xp -> xp_context = expand_menus ? 21 : 11;
    ...
    int idx;
{
    ...
    while (menu != ((void *) 0) && (menu_is_hidden (menu -> dname) || menu_is_separator (menu -> dname) || menu_is_tearoff (menu -> dname) || menu -> children
      == ((void *) 0))) menu = menu -> next;
    if (menu == ((void *) 0)) return ((void *) 0);
    if (menu -> modes & expand_modes) if (should_advance) str = menu -> en_dname;
    else {
        str = menu -> dname;
        if (menu -> en_dname == ((void *) 0)) should_advance = 1;
    }
    else str = (char_u *) "";
    if (should_advance) menu = menu -> next;
    ...
    int idx;
{
    ...
    while (menu != ((void *) 0) && (menu_is_hidden (menu -> dname) || (expand_emenu && menu_is_separator (menu -> dname)) || menu_is_tearoff (menu -> dname) ||
      menu -> dname [strlen ((char *) (menu -> dname)) - 1] == '.')) menu = menu -> next;
    if (menu == ((void *) 0)) return ((void *) 0);
    if (menu -> modes & expand_modes) {
        if (menu -> children != ((void *) 0)) {
            if (should_advance) ((__builtin_object_size ((char *) (tbuffer), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (tbuffer), (char *) (menu ->
              en_dname), __builtin_object_size ((char *) (tbuffer), 1 > 1)) : __inline_strcpy_chk ((char *) (tbuffer), (char *) (menu -> en_dname)));
            else {
                ((__builtin_object_size ((char *) (tbuffer), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (tbuffer), (char *) (menu -> dname),
                  __builtin_object_size ((char *) (tbuffer), 1 > 1)) : __inline_strcpy_chk ((char *) (tbuffer), (char *) (menu -> dname)));
                if (menu -> en_dname == ((void *) 0)) should_advance = 1;
            }
            ((__builtin_object_size ((char *) (tbuffer), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (tbuffer), (char *) ("\001"),
              __builtin_object_size ((char *) (tbuffer), 1 > 1)) : __inline_strcat_chk ((char *) (tbuffer), (char *) ("\001")));
            str = tbuffer;
        }
        else {
            if (should_advance) str = menu -> en_dname;
            else {
                str = menu -> dname;
                if (menu -> en_dname == ((void *) 0)) should_advance = 1;
            }
...
static int menu_name_equal (name, menu)
    ...
    vimmenu_T * menu;
{
    if (menu -> en_name != ((void *) 0) && (menu_namecmp (name, menu -> en_name) || menu_namecmp (name, menu -> en_dname))) return 1;
...
{
    int i;
    for (i = 0; name [i] != '\000' && name [i] != '\011'; ++i) if (name [i] != mname [i]) break;
    return ((name [i] == '\000' || name [i] == '\011') && (mname [i] == '\000' || mname [i] == '\011'));
}
    ...
    int * unmenu;
{
    ...
    default :
        --cmd;
        if (forceit) modes = (1 << 4) | (1 << 5);
        else modes = (1 << 0) | (1 << 1) | (1 << 2) | (1 << 3);
    }
    if (noremap != ((void *) 0)) *noremap = (*cmd == 'n' ? -1 : 0);
    if (unmenu != ((void *) 0)) *unmenu = (*cmd == 'u');
    return modes;
}
    ...
    int idx;
{
    ...
    if (p != ((void *) 0)) {
        ((__builtin_object_size ((char *) (p + 6), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (p + 6), (char *) (p + 5), (size_t) (len - 4),
          __builtin_object_size ((char *) (p + 6), 0)) : __inline_memmove_chk ((char *) (p + 6), (char *) (p + 5), (size_t) (len - 4)));
    ...
    char_u * * actext;
{
    ...
    if (p != ((void *) 0)) {
        if (actext != ((void *) 0)) *actext = vim_strsave (p + 1);
        text = vim_strnsave (str, (int) (p - str));
    }
    else text = vim_strsave (str);
    for (p = text; p != ((void *) 0);) {
        p = vim_strchr (p, '&');
        if (p != ((void *) 0)) {
            if (p [1] == '\000') break;
            if (mnemonic != ((void *) 0) && p [1] != '&') *mnemonic = p [1];
            ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((char *) (p + 1
              )) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((p + 1)), strlen ((char *) (p + 1)) + 1));
            p = p + 1;
        }
...
int menu_is_menubar (name)
    char_u * name;
{
    return (!menu_is_popup(name) && !menu_is_toolbar(name) && *name != ']');
}
    ...
    exarg_T * eap;
{
    ...
    while (*name) {
        ...
        while (menu != ((void *) 0)) {
            if (menu_name_equal (name, menu)) {
                if (*p == '\000' && menu -> children != ((void *) 0)) {
                    emsg ((char_u *) (((char *) ("E333: Menu path must lead to a menu item"))));
                    menu = ((void *) 0);
                }
        ...
        if (menu == ((void *) 0) || *p == '\000') break;
        menu = menu -> children;
        name = p;
    }
    vim_free (saved_name);
    if (menu == ((void *) 0)) {
        emsg2 ((char_u *) (((char *) ("E334: Menu not found: %s"))), (char_u *) (eap -> arg));
        return;
    }
    if (restart_edit && !current_SID) {
        ...
        check_cursor ();
        if (*p_sel == 'e' && gchar_cursor () != '\000') ++curwin->w_cursor.col;
    }
    else {
        mode = (char_u *) "Normal";
        idx = 0;
    ...
    if (idx != -1 && menu -> strings [idx] != ((void *) 0)) {
        if (current_SID != 0) exec_normal_cmd (menu -> strings [idx], menu -> noremap [idx], menu -> silent [idx]);
        else ins_typebuf (menu -> strings [idx], menu -> noremap [idx], 0, 1, menu -> silent [idx]);
    }
    else emsg2 ((char_u *) (((char *) ("E335: Menu not defined for %s mode"))), (char_u *) (mode));
}
    ...
    exarg_T * eap __attribute__ ((unused));
{
    ...
    if (menutrans_ga.ga_itemsize == 0) ga_init2 (&menutrans_ga, (int) sizeof (menutrans_T), 5);
    if (strncmp ((char *) (arg), (char *) ("clear"), (size_t) (5)) == 0 && ends_excmd (*skipwhite(arg+5))) {
        ...
        * arg = '\000';
        ...
        if (arg == to) emsg ((char_u *) (((char *) (e_invarg))));
        else {
            if (ga_grow (&menutrans_ga, 1) == 1) {
                tp = (menutrans_T *) menutrans_ga.ga_data;
                from = vim_strsave (from);
                if (from != ((void *) 0)) {
                    from_noamp = menu_text (from, ((void *) 0), ((void *) 0));
                    to = vim_strnsave (to, (int) (arg - to));
                    if (from_noamp != ((void *) 0) && to != ((void *) 0)) {
    ...
    int len;
{
    ...
    int i;
    char_u * dname;
    for (i = 0; i < menutrans_ga.ga_len; ++i) if (strncmp ((char *) (name), (char *) (tp [i].from), (size_t) (len)) == 0 && tp [i].from [len] == '\000') return
      tp [i].to;
    i = name [len];
    name [len] = '\000';
    dname = menu_text (name, ((void *) 0), ((void *) 0));
    name [len] = i;
    if (dname != ((void *) 0)) {
        for (i = 0; i < menutrans_ga.ga_len; ++i) if (strcmp ((char *) (dname), (char *) (tp [i].from_noamp)) == 0) {
            vim_free (dname);
            return tp [i].to;
        }
        vim_free (dname);
...
{
    char_u * p;
    for (p = name; *p && *p != '.'; ++p) if (*p == '\\') ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p))
      , (char *) ((p + 1)), strlen ((char *) (p + 1)) + 1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((p + 1)
      ), strlen ((char *) (p + 1)) + 1));
}
    ...
    char_u * arg_start;
{
    ...
    while (*arg && !((*arg) == ' ' || (*arg) == '\t')) {
        if ((*arg == '\\' || *arg == 22) && arg [1] != '\000') arg ++;
        else if (strncasecmp ((char *) (arg), (char *) ("<TAB>"), (size_t) (5)) == 0) {
            * arg = '\011';
            ((__builtin_object_size ((char *) ((arg + 1)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((arg + 1)), (char *) ((arg + 5)), strlen ((
              char *) (arg + 5)) + 1, __builtin_object_size ((char *) ((arg + 1)), 0)) : __inline_memmove_chk ((char *) ((arg + 1)), (char *) ((arg + 5)),
              strlen ((char *) (arg + 5)) + 1));
        }
        arg ++;
    }

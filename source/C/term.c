...
extern char * BC;
extern short ospeed;
extern char * tgetstr_defined_wrong (char *, char * *);
...
static int crv_status = 1;
static char_u * vim_tgetstr (char * s, char_u * * pp);
static int detected_8bit = 0;
static struct builtin_term builtin_termcaps [] =
{
    ...
    {(-(('k')+((int)('r')<<8))), "\033O*C"},
    {(-(('k')+((int)('l')<<8))), "\033O*D"},
    {(-((253)+((int)(KE_XUP)<<8))), "\033[1;*A"},
    {(-((253)+((int)(KE_XDOWN)<<8))), "\033[1;*B"},
    {(-((253)+((int)(KE_XRIGHT)<<8))), "\033[1;*C"},
    {(-((253)+((int)(KE_XLEFT)<<8))), "\033[1;*D"},
    {(-((253)+((int)(KE_XF1)<<8))), "\033O*P"},
    {(-((253)+((int)(KE_XF2)<<8))), "\033O*Q"},
    {(-((253)+((int)(KE_XF3)<<8))), "\033O*R"},
    {(-((253)+((int)(KE_XF4)<<8))), "\033O*S"},
    {(-(('k')+((int)('1')<<8))), "\033[11;*~"},
    {(-(('k')+((int)('2')<<8))), "\033[12;*~"},
    {(-(('k')+((int)('3')<<8))), "\033[13;*~"},
    {(-(('k')+((int)('4')<<8))), "\033[14;*~"},
    ...
    {(-(('k')+((int)('h')<<8))), "\033[1;*H"},
    {(-(('K')+((int)('1')<<8))), "\033[1;*~"},
    {(-((253)+((int)(KE_XHOME)<<8))), "\033O*H"},
    {(-((253)+((int)(KE_ZHOME)<<8))), "\033[7;*~"},
    {(-(('@')+((int)('7')<<8))), "\033[1;*F"},
    {(-(('K')+((int)('4')<<8))), "\033[4;*~"},
    {(-((253)+((int)(KE_XEND)<<8))), "\033O*F"},
    {(-((253)+((int)(KE_ZEND)<<8))), "\033[8;*~"},
    {(-(('k')+((int)('P')<<8))), "\033[5;*~"},
    {(-(('k')+((int)('N')<<8))), "\033[6;*~"},
    {(-(('K')+((int)('6')<<8))), "\033O*k"},
    {(-(('K')+((int)('7')<<8))), "\033O*m"},
    ...
    {(-(('k')+((int)('l')<<8))), "\033[D"},
    {(-(('k')+((int)('r')<<8))), "\033[C"},
    {(-((253)+((int)(KE_S_UP)<<8))), "\033[161q"},
    {(-((253)+((int)(KE_S_DOWN)<<8))), "\033[164q"},
    {(-(('#')+((int)('4')<<8))), "\033[158q"},
    {(-(('%')+((int)('i')<<8))), "\033[167q"},
    {(-(('k')+((int)('1')<<8))), "\033[001q"},
    {(-(('k')+((int)('2')<<8))), "\033[002q"},
    ...
    {(-(('F')+((int)('1')<<8))), "\033[011q"},
    {(-(('F')+((int)('2')<<8))), "\033[012q"},
    {(-((253)+((int)(KE_S_F1)<<8))), "\033[013q"},
    {(-((253)+((int)(KE_S_F2)<<8))), "\033[014q"},
    {(-((253)+((int)(KE_S_F3)<<8))), "\033[015q"},
    {(-((253)+((int)(KE_S_F4)<<8))), "\033[016q"},
    {(-((253)+((int)(KE_S_F5)<<8))), "\033[017q"},
    {(-((253)+((int)(KE_S_F6)<<8))), "\033[018q"},
    {(-((253)+((int)(KE_S_F7)<<8))), "\033[019q"},
    {(-((253)+((int)(KE_S_F8)<<8))), "\033[020q"},
    {(-((253)+((int)(KE_S_F9)<<8))), "\033[021q"},
    {(-((253)+((int)(KE_S_F10)<<8))), "\033[022q"},
    {(-((253)+((int)(KE_S_F11)<<8))), "\033[023q"},
    {(-((253)+((int)(KE_S_F12)<<8))), "\033[024q"},
    {(-(('k')+((int)('I')<<8))), "\033[139q"},
    {(-(('k')+((int)('h')<<8))), "\033[H"},
    {(-(('@')+((int)('7')<<8))), "\033[146q"},
    {(-(('k')+((int)('P')<<8))), "\033[150q"},
    ...
    {(int) KS_CM, "\033[%i%p1%d;%p2%dH"},
    {(int) KS_NAME, ((void *) 0)}};
char_u * (term_strings [(int) KS_OP + 1]);
static int need_gather = 0;
static char_u termleader [256 + 1];
static int check_for_codes = 0;
    ...
    char_u * term;
{
    ...
    p = builtin_termcaps;
    while (p -> bt_string != ((void *) 0)) {
        if (p -> bt_entry == (int) KS_NAME) {
            if (strcmp ((char *) (p -> bt_string), (char *) ("iris-ansi")) == 0 && vim_is_iris (term)) return p;
            else if (strcmp ((char *) (p -> bt_string), (char *) ("xterm")) == 0 && vim_is_xterm (term)) return p;
            else if (strcmp ((char *) (term), (char *) (p -> bt_string)) == 0) return p;
        }
        ++p;
    }
    return p;
    ...
    char_u * term;
{
    ...
    if (p -> bt_string == ((void *) 0)) return;
    for (++p; p -> bt_entry != (int) KS_NAME && p -> bt_entry != 0x101; ++p) {
        if ((int) p -> bt_entry >= 0) {
            if (term_strings [p -> bt_entry] == ((void *) 0) || term_strings [p -> bt_entry] == empty_option) {
                if (term_8bit && term_7to8bit ((char_u *) p -> bt_string) != 0) {
                    ...
                    if (s != ((void *) 0)) {
                        for (t = s; *t; ++t) if (term_7to8bit (t)) {
                            * t = term_7to8bit (t);
                            ((__builtin_object_size ((char *) (t + 1), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (t + 1), (char *) (t + 2),
                              __builtin_object_size ((char *) (t + 1), 1 > 1)) : __inline_strcpy_chk ((char *) (t + 1), (char *) (t + 2)));
                        }
                        term_strings [p -> bt_entry] = s;
                        set_term_option_alloced (&term_strings[p->bt_entry]);
                    }
                }
                else term_strings [p -> bt_entry] = (char_u *) p -> bt_string;
            }
        }
        else {
            name [0] = ((-((int)p->bt_entry)) & 0xff);
            name [1] = (((unsigned) (-((int)p->bt_entry)) >> 8) & 0xff);
            if (find_termcode (name) == ((void *) 0)) add_termcode (name, (char_u *) p -> bt_string, term_8bit);
        }
    }
}
    ...
    int nr;
{
    char_u nr_colors [20];
    t_colors = nr;
    if (t_colors > 1) __builtin___sprintf_chk ((char *) nr_colors, 0, __builtin_object_size ((char *) nr_colors, 1 > 1), "%d", t_colors);
    else *nr_colors = '\000';
    set_string_option_direct ((char_u *) "t_Co", -1, nr_colors, 1, 0);
}

static char * (key_names []) =
{"Co", "ku", "kd", "kr", "kl", "#2", "#4", "%i", "*7", "k1", "k2", "k3", "k4", "k5", "k6", "k7", "k8", "k9", "k;", "F1", "F2", "%1", "&8", "kb", "kI", "kD",
      "kh", "@7", "kP", "kN", "K1", "K3", "K4", "K5", "kB", ((void *) 0)};
    ...
    char_u * term;
{
    ...
    int try;
    int termcap_cleared = 0;
    int width = 0, height = 0;
    char_u * error_msg = ((void *) 0);
    char_u * bs_p, * del_p;
    if (silent_mode) return 1;
    detected_8bit = 0;
    ...
    for (try = builtin_first ? 0 : 1; try < 3; ++try) {
        if (try == 1) {
            ...
            } string_names [] =
            {
                ...
                {KS_CSI, "SI"},
                {KS_CEI, "EI"},
                {(enum SpecialKey) 0, ((void *) 0)}};
            if ((error_msg = tgetent_error (tbuf, term)) == ((void *) 0)) {
                tp = tstrbuf;
                if (!termcap_cleared) {
                    clear_termoptions ();
                    termcap_cleared = 1;
                }
                for (i = 0; string_names [i].name != ((void *) 0); ++i) {
                    if (term_strings [(int) (string_names [i].dest)] == ((void *) 0) || term_strings [(int) (string_names [i].dest)] == empty_option)
                      term_strings [(int) (string_names [i].dest)] = vim_tgetstr ((string_names [i].name), (&tp));
                }
                if (((term_strings [(int) (KS_MS)]) == ((void *) 0) || (term_strings [(int) (KS_MS)]) == empty_option) && tgetflag ("ms") > 0) (term_strings [(
                  int) (KS_MS)]) = (char_u *) "y";
                if (((term_strings [(int) (KS_XS)]) == ((void *) 0) || (term_strings [(int) (KS_XS)]) == empty_option) && tgetflag ("xs") > 0) (term_strings [(
                  int) (KS_XS)]) = (char_u *) "y";
                if (((term_strings [(int) (KS_DB)]) == ((void *) 0) || (term_strings [(int) (KS_DB)]) == empty_option) && tgetflag ("db") > 0) (term_strings [(
                  int) (KS_DB)]) = (char_u *) "y";
                if (((term_strings [(int) (KS_DA)]) == ((void *) 0) || (term_strings [(int) (KS_DA)]) == empty_option) && tgetflag ("da") > 0) (term_strings [(
                  int) (KS_DA)]) = (char_u *) "y";
                if (((term_strings [(int) (KS_UT)]) == ((void *) 0) || (term_strings [(int) (KS_UT)]) == empty_option) && tgetflag ("ut") > 0) (term_strings [(
                  int) (KS_UT)]) = (char_u *) "y";
                for (i = 0; key_names [i] != ((void *) 0); ++i) {
                    if (find_termcode ((char_u *) key_names [i]) == ((void *) 0)) {
                        p = vim_tgetstr ((key_names [i]), (&tp));
                        if (p != ((void *) 0) && (*p != 8 || key_names [i] [0] != 'k' || key_names [i] [1] != 'l')) add_termcode ((char_u *) key_names [i], p, 0
                          );
                    }
                }
                if (height == 0) height = tgetnum ("li");
                if (width == 0) width = tgetnum ("co");
                if (term_strings [(int) (KS_CCO)] == ((void *) 0) || term_strings [(int) (KS_CCO)] == empty_option) set_color_count (tgetnum ("Co"));
            ...
            if (try == 2 && builtin_first && termcap_cleared) break;
            termp = find_builtin_term (term);
            if (termp -> bt_string == ((void *) 0)) {
                if (try == 0) continue;
                if (termcap_cleared) break;
                fprintf (__stderrp, "%s", ("\r\n"));
                if (error_msg != ((void *) 0)) {
                    fprintf (__stderrp, "%s", ((char *) error_msg));
                    fprintf (__stderrp, "%s", ("\r\n"));
                }
                fprintf (__stderrp, "%s", ("'"));
                fprintf (__stderrp, "%s", ((char *) term));
                fprintf (__stderrp, "%s", (((char *) ("' not known. Available builtin terminals are:"))));
                fprintf (__stderrp, "%s", ("\r\n"));
                for (termp = &(builtin_termcaps[0]); termp -> bt_string != ((void *) 0); ++termp) {
                    if (termp -> bt_entry == (int) KS_NAME) {
                        fprintf (__stderrp, "%s", ("    builtin_"));
                        fprintf (__stderrp, "%s", (termp -> bt_string));
                        fprintf (__stderrp, "%s", ("\r\n"));
                    }
                }
                if (starting != 2) {
                ...
                term = (char_u *) "ansi";
                fprintf (__stderrp, "%s", (((char *) ("defaulting to '"))));
                fprintf (__stderrp, "%s", ((char *) term));
                fprintf (__stderrp, "%s", ("'\r\n"));
                if (emsg_silent == 0) {
                    screen_start ();
                ...
                set_string_option_direct ((char_u *) "term", -1, term, 1, 0);
                fflush (__stderrp);
            }
            out_flush ();
            if (!termcap_cleared) {
    ...
    if (strcmp ((char *) (term), (char *) ("pcterm")) == 0) (term_strings [(int) (KS_CCS)]) = (char_u *) "yes";
    else (term_strings [(int) (KS_CCS)]) = empty_option;
    get_stty ();
    {
        bs_p = find_termcode ((char_u *) "kb");
        del_p = find_termcode ((char_u *) "kD");
        if (bs_p == ((void *) 0) || *bs_p == '\000') add_termcode ((char_u *) "kb", (bs_p = (char_u *) "\010"), 0);
        if ((del_p == ((void *) 0) || *del_p == '\000') && (bs_p == ((void *) 0) || *bs_p != 0x7f)) add_termcode ((char_u *) "kD", (char_u *) (char_u *) "\177"
          , 0);
    }
    term_is_xterm = vim_is_xterm (term);
    {
        ...
        if (use_xterm_like_mouse (term)) {
            if (use_xterm_mouse ()) p = ((void *) 0);
            else p = (char_u *) "xterm";
        }
        if (p != ((void *) 0)) set_option_value ((char_u *) "ttym", 0L, p, 0);
        if (p == ((void *) 0)) check_mouse_termcode ();
    }
    if (vim_is_fastterm (term)) p_tf = 1;
    ttest (1);
    full_screen = 1;
    set_term_defaults ();
    crv_status = 1;
    ...
    set_shellsize (width, height, 0);
    if (starting != 2) {
        if (scroll_region) scroll_region_reset ();
        check_map_keycodes ();
        {
            buf_T * old_curbuf;
            old_curbuf = curbuf;
            for (curbuf = firstbuf; curbuf != ((void *) 0); curbuf = curbuf -> b_next) {
                if (curbuf -> b_ml.ml_mfp != ((void *) 0)) apply_autocmds (EVENT_TERMCHANGED, ((void *) 0), ((void *) 0), 0, curbuf);
            }
            if (buf_valid (old_curbuf)) curbuf = old_curbuf;
        }
    }
...
{
    int i;
    i = tgetent ((char *) (tbuf), (char *) (term));
    if (i < 0) {
        (void) tgetent ((char *) (tbuf), (char *) ("dumb"));
        if (i < 0) return (char_u *) ((char *) ("E558: Terminal entry not found in terminfo"));
    }
    return ((void *) 0);
}
...
{
    char_u tbuf [2048];
    if ((term_strings [(int) (KS_NAME)]) != ((void *) 0) && *(term_strings[(int)(KS_NAME)]) != '\000' && tgetent_error (tbuf, (term_strings [(int) (KS_NAME)]))
      == ((void *) 0)) {
        if (*cp == 0) *cp = tgetnum ("co");
        if (*rp == 0) *rp = tgetnum ("li");
    }
}
    ...
    int force;
{
    ...
    char_u * tp = tstrbuf;
    char_u * error_msg = ((void *) 0);
    if (!force && find_termcode (name) != ((void *) 0)) return 1;
    term = (term_strings [(int) (KS_NAME)]);
    if (term == ((void *) 0) || *term == '\000') return 0;
    if (term_is_builtin (term)) {
        term += 8;
        builtin_first = 1;
    }
    else builtin_first = p_tbi;
    for (i = 0; i < 2; ++i) {
        if (!builtin_first == i) {
            termp = find_builtin_term (term);
            if (termp -> bt_string != ((void *) 0)) {
    ...
    if (sourcing_name == ((void *) 0)) {
        if (error_msg != ((void *) 0)) emsg ((char_u *) (error_msg));
        else emsg2 ((char_u *) (((char *) ("E436: No \"%s\" entry in termcap"))), (char_u *) (name));
    }
    return 0;
}
...
static int term_is_builtin (name)
    char_u * name;
{
    return (strncmp ((char *) (name), (char *) ("builtin_"), (size_t) ((size_t) 8)) == 0);
}

int term_is_8bit (name)
    char_u * name;
{
    return (detected_8bit || strstr ((char *) name, "8bit") != ((void *) 0));
}
...
{
    char_u * term;
    if (name != ((void *) 0) && *name == '\000') name = ((void *) 0);
    term = name;
    if (term == ((void *) 0)) term = (char_u *) getenv ((char *) ((char_u *) "TERM"));
    if (term == ((void *) 0) || *term == '\000') term = (char_u *) "ansi";
    set_string_option_direct ((char_u *) "term", -1, term, 1, 0);
    set_string_default ("term", term);
    set_string_default ("ttytype", term);
    set_termname ((term_strings [(int) (KS_NAME)]) != ((void *) 0) ? (term_strings [(int) (KS_NAME)]) : term);
}

static char_u out_buf [2047 + 1];
    ...
    unsigned c;
{
    if (c == '\n') out_char ('\r');
    out_buf [out_pos ++] = c;
    if (out_pos >= 2047 || p_wd) out_flush ();
}
    ...
    unsigned c;
{
    if (c == '\n') out_char_nf ('\r');
    out_buf [out_pos ++] = c;
    if (out_pos >= 2047) out_flush ();
}

void out_str_nf (s)
    char_u * s;
{
    if (out_pos > 2047 - 20) out_flush ();
    while (*s) out_char_nf (*s++);
    if (p_wd) out_flush ();
}
...
void term_windgoto (row, col)
    ...
    int col;
{
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CM)]), col, row)));
}

void term_cursor_right (i)
    int i;
{
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CRI)]), 0, i)));
}

void term_append_lines (line_count)
    int line_count;
{
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CAL)]), 0, line_count)));
}

void term_delete_lines (line_count)
    int line_count;
{
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CDL)]), 0, line_count)));
}
    ...
    int y;
{
    if (x < 0) x = 0;
    if (y < 0) y = 0;
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CWP)]), y, x)));
}
...
void term_set_winsize (width, height)
    ...
    int height;
{
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CWS)]), height, width)));
}

void term_fg_color (n)
    int n;
{
    if (*(term_strings[(int)(KS_CAF)])) term_color ((term_strings [(int) (KS_CAF)]), n);
    else if (*(term_strings[(int)(KS_CSF)])) term_color ((term_strings [(int) (KS_CSF)]), n);
}

void term_bg_color (n)
    int n;
{
    if (*(term_strings[(int)(KS_CAB)])) term_color ((term_strings [(int) (KS_CAB)]), n);
    else if (*(term_strings[(int)(KS_CSB)])) term_color ((term_strings [(int) (KS_CSB)]), n);
}
    ...
    int n;
{
    char buf [20];
    int i = 2;
    if (n >= 8 && t_colors >= 16 && ((s [0] == '\033' && s [1] == '[') || (s [0] == 0x9b && (i = 1) == 1)) && s [i] != '\000' && (strcmp ((char *) (s + i + 1),
      (char *) ("%p1%dm")) == 0 || strcmp ((char *) (s + i + 1), (char *) ("%dm")) == 0) && (s [i] == '3' || s [i] == '4')) {
        __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%s%s%%p1%%dm", i == 2 ? "\033[" : "\233", s [i] == '3' ? (n >= 16 ? "38;5;" : "9"
          ) : (n >= 16 ? "48;5;" : "10"));
        out_str ((char_u *) (tgoto (buf, 0, n >= 16 ? n : n - 8)));
    }
    else out_str ((char_u *) (tgoto ((char *) s, 0, n)));
}
...
{
    check_options ();
    if (*(term_strings[(int)(KS_CM)]) == '\000') emsg ((char_u *) (((char *) ("E437: terminal capability \"cm\" required"))));
    if (*(term_strings[(int)(KS_CS)]) != '\000') scroll_region = 1;
    else scroll_region = 0;
    if (pairs) {
        if (*(term_strings[(int)(KS_ME)]) == '\000') (term_strings [(int) (KS_ME)]) = (term_strings [(int) (KS_MR)]) = (term_strings [(int) (KS_MD)]) = (
          term_strings [(int) (KS_MB)]) = empty_option;
        if (*(term_strings[(int)(KS_SO)]) == '\000' || *(term_strings[(int)(KS_SE)]) == '\000') (term_strings [(int) (KS_SO)]) = (term_strings [(int) (KS_SE)])
          = empty_option;
        if (*(term_strings[(int)(KS_US)]) == '\000' || *(term_strings[(int)(KS_UE)]) == '\000') (term_strings [(int) (KS_US)]) = (term_strings [(int) (KS_UE)])
          = empty_option;
        if (*(term_strings[(int)(KS_CZH)]) == '\000' || *(term_strings[(int)(KS_CZR)]) == '\000') (term_strings [(int) (KS_CZH)]) = (term_strings [(int) (
          KS_CZR)]) = empty_option;
        if (*(term_strings[(int)(KS_VE)]) == '\000') (term_strings [(int) (KS_VI)]) = empty_option;
        if (*(term_strings[(int)(KS_ME)]) == '\000') {
            (term_strings [(int) (KS_ME)]) = (term_strings [(int) (KS_SE)]);
            (term_strings [(int) (KS_MR)]) = (term_strings [(int) (KS_SO)]);
            (term_strings [(int) (KS_MD)]) = (term_strings [(int) (KS_SO)]);
        }
        if (*(term_strings[(int)(KS_SO)]) == '\000') {
            (term_strings [(int) (KS_SE)]) = (term_strings [(int) (KS_ME)]);
            if (*(term_strings[(int)(KS_MR)]) == '\000') (term_strings [(int) (KS_SO)]) = (term_strings [(int) (KS_MD)]);
            else (term_strings [(int) (KS_SO)]) = (term_strings [(int) (KS_MR)]);
        }
        if (*(term_strings[(int)(KS_CZH)]) == '\000') {
            (term_strings [(int) (KS_CZR)]) = (term_strings [(int) (KS_ME)]);
            if (*(term_strings[(int)(KS_MR)]) == '\000') (term_strings [(int) (KS_CZH)]) = (term_strings [(int) (KS_MD)]);
            else (term_strings [(int) (KS_CZH)]) = (term_strings [(int) (KS_MR)]);
        }
        if (*(term_strings[(int)(KS_CSB)]) == '\000' || *(term_strings[(int)(KS_CSF)]) == '\000') {
            (term_strings [(int) (KS_CSB)]) = empty_option;
            (term_strings [(int) (KS_CSF)]) = empty_option;
        }
        if (*(term_strings[(int)(KS_CAB)]) == '\000' || *(term_strings[(int)(KS_CAF)]) == '\000') {
            (term_strings [(int) (KS_CAB)]) = empty_option;
            (term_strings [(int) (KS_CAF)]) = empty_option;
        }
        if (*(term_strings[(int)(KS_CSB)]) == '\000' && *(term_strings[(int)(KS_CAB)]) == '\000') free_one_termoption ((term_strings [(int) (KS_CCO)]));
    ...
    int num_bytes;
{
    ...
    for (i = 0; i < num_bytes; i ++) {
        if ((c = buf [len ++]) == '\000') return -1;
        if (c == (0x80)) {
            if (buf [len] == '\000' || buf [len + 1] == '\000') return -1;
            if (buf [len ++] == (int) 255) c = '\000';
            ++len;
        }
        else if (c == 0x9b && buf [len] == 253 && buf [len + 1] == (int) KE_CSI) len += 2;
        bytes [i] = c;
    }
    return len;
}
...
void win_new_shellsize () {
    ...
    if (old_Rows != Rows || old_Columns != Columns) ui_new_shellsize ();
    if (old_Rows != Rows) {
        if (p_window == old_Rows - 1 || old_Rows == 0) p_window = Rows - 1;
        old_Rows = Rows;
        shell_new_rows ();
    }
...
void shell_resized_check () {
    ...
    check_shellsize ();
    if (old_Rows != Rows || old_Columns != Columns) shell_resized ();
}
    ...
    int mustset;
{
    ...
    ++busy;
    if (mustset || (ui_get_shellsize () == 0 && height != 0)) {
        Rows = height;
        Columns = width;
        check_shellsize ();
        ui_set_shellsize (mustset);
    }
    else check_shellsize ();
    if (State != 0x300 && State != 0x600 && State != 0x800) screenclear ();
    else screen_start ();
    if (starting != 2) {
        maketitle ();
        changed_line_abv_curs ();
        invalidate_botline ();
        if (State == 0x300 || State == 0x600 || State == 0x800 || exmode_active) {
            screenalloc (0);
            repeat_message ();
        }
        else {
            if (curwin -> w_onebuf_opt.wo_scb) do_check_scrollbind (1);
            if (State & 0x08) {
                update_screen (40);
                redrawcmdline ();
            }
                ...
                else update_screen (40);
                if (redrawing ()) setcursor ();
            }
        }
        cursor_on ();
    }
...
{
    if (full_screen) {
        if (tmode != 0 || cur_tmode != 0) {
            {
                if (tmode != 2 && crv_status == 2) (void) vpeekc_nomap ();
                check_for_codes_from_term ();
            }
            if (tmode != 2) mch_setmouse (0);
            out_flush ();
            mch_settmode (tmode);
            cur_tmode = tmode;
            if (tmode == 2) setmouse ();
...
void starttermcap () {
    if (full_screen && !termcap_active) {
        out_str ((term_strings [(int) (KS_TI)]));
        out_str ((term_strings [(int) (KS_KS)]));
        out_flush ();
        termcap_active = 1;
        screen_start ();
        {
            may_req_termresponse ();
            if (crv_status != 1) check_for_codes_from_term ();
        }
    }
}
...
void stoptermcap () {
    ...
    if (termcap_active) {
        {
            if (crv_status == 2) (void) vpeekc_nomap ();
            check_for_codes_from_term ();
        }
        out_str ((term_strings [(int) (KS_KE)]));
        out_flush ();
        termcap_active = 0;
        cursor_on ();
        out_str ((term_strings [(int) (KS_TE)]));
        screen_start ();
        out_flush ();
    }
}
...
void may_req_termresponse () {
    if (crv_status == 1 && cur_tmode == 2 && starting == 0 && termcap_active && p_ek && isatty (1) && isatty (read_cmd_fd) && *(term_strings[(int)(KS_CRV)]) !=
      '\000') {
        out_str ((term_strings [(int) (KS_CRV)]));
        crv_status = 2;
        out_flush ();
        (void) vpeekc_nomap ();
    }
...
int swapping_screen () {
    return (full_screen && *(term_strings[(int)(KS_TI)]) != '\000');
}

void setmouse () {
    int checkfor;
    if (*p_mouse == '\000' || has_mouse_termcode == 0) return;
    if (cur_tmode != 2) {
        mch_setmouse (0);
        return;
    }
    if (VIsual_active) checkfor = 'v';
    else if (State == (0x200 + 0x01) || State == 0x300 || State == 0x400) checkfor = 'r';
    else if (State & 0x10) checkfor = 'i';
    else if (State & 0x08) checkfor = 'c';
    else if (State == 0x800 || State == 0x600) checkfor = ' ';
    else checkfor = 'n';
    if (mouse_has (checkfor)) mch_setmouse (1);
    else mch_setmouse (0);
}
...
{
    char_u * p;
    for (p = p_mouse; *p; ++p) switch (*p) {
    case 'a' :
        if (vim_strchr ((char_u *) "nvich", c) != ((void *) 0)) return 1;
        break;
    case 'h' :
        if (c != 'r' && curbuf -> b_help) return 1;
        break;
    default :
        if (c == *p) return 1;
        break;
...
void scroll_start () {
    if (*(term_strings[(int)(KS_VS)]) != '\000') {
        out_str ((term_strings [(int) (KS_VS)]));
        out_str ((term_strings [(int) (KS_VE)]));
        screen_start ();
    }
}
...
void cursor_off () {
    if (full_screen) {
        if (!cursor_is_off) out_str ((term_strings [(int) (KS_VI)]));
        cursor_is_off = 1;
    }
}
...
void term_cursor_shape () {
    ...
    if (!full_screen || *(term_strings[(int)(KS_CSI)]) == '\000' || *(term_strings[(int)(KS_CEI)]) == '\000') return;
    if (State & 0x10) {
        if (showing_insert_mode != 1) out_str ((term_strings [(int) (KS_CSI)]));
        showing_insert_mode = 1;
    }
    else {
        if (showing_insert_mode != 0) out_str ((term_strings [(int) (KS_CEI)]));
...
void scroll_region_set (wp, off)
    ...
    int off;
{
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CS)]), (wp -> w_winrow) + wp -> w_height - 1, (wp -> w_winrow) + off)));
    if (*(term_strings[(int)(KS_CSV)]) != '\000' && wp -> w_width != Columns) out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CSV)]), (wp ->
      w_wincol) + wp -> w_width - 1, (wp -> w_wincol))));
    screen_start ();
}

void scroll_region_reset () {
    out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CS)]), (int) Rows - 1, 0)));
    if (*(term_strings[(int)(KS_CSV)]) != '\000') out_str ((char_u *) (tgoto ((char *) (term_strings [(int) (KS_CSV)]), (int) Columns - 1, 0)));
    screen_start ();
}
...
void clear_termcodes () {
    while (tc_len > 0) vim_free (termcodes [--tc_len].code);
    vim_free (termcodes);
    termcodes = ((void *) 0);
    tc_max_len = 0;
    ...
    int flags;
{
    ...
    if (s == ((void *) 0)) return;
    if (flags != 0 && flags != 55 && term_7to8bit (string) != 0) {
        ((__builtin_object_size ((char *) ((s)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((s)), (char *) ((s + 1)), strlen ((char *) (s + 1)) +
          1, __builtin_object_size ((char *) ((s)), 0)) : __inline_memmove_chk ((char *) ((s)), (char *) ((s + 1)), strlen ((char *) (s + 1)) + 1));
    ...
    if (tc_len == tc_max_len) {
        ...
        for (i = 0; i < tc_len; ++i) new_tc [i] = termcodes [i];
        vim_free (termcodes);
        termcodes = new_tc;
    }
    for (i = 0; i < tc_len; ++i) {
        if (termcodes [i].name [0] < name [0]) continue;
        if (termcodes [i].name [0] == name [0]) {
            if (termcodes [i].name [1] < name [1]) continue;
            if (termcodes [i].name [1] == name [1]) {
                if (flags == 55 && (j = termcode_star (termcodes [i].code, termcodes [i].len)) > 0) {
                    if (len == termcodes [i].len - j && strncmp ((char *) (s), (char *) (termcodes [i].code), (size_t) (len - 1)) == 0 && s [len - 1] ==
        ...
        for (j = tc_len; j > i; --j) termcodes [j] = termcodes [j - 1];
        break;
    }
    ...
    if (j > 0) termcodes [i].modlen = len - 1 - j;
    ++tc_len;
}
...
{
    if (len >= 3 && code [len - 2] == '*') {
        if (len >= 5 && code [len - 3] == ';') return 2;
        if ((len >= 4 && code [len - 3] == 'O') || code [len - 3] == 'O' + 128) return 1;
    }
    return 0;
}
...
{
    int i;
    for (i = 0; i < tc_len; ++i) if (termcodes [i].name [0] == name [0] && termcodes [i].name [1] == name [1]) return termcodes [i].code;
    return ((void *) 0);
}
...
{
    int i;
    if (termcodes == ((void *) 0)) return;
    need_gather = 1;
    for (i = 0; i < tc_len; ++i) if (termcodes [i].name [0] == name [0] && termcodes [i].name [1] == name [1]) {
        del_termcode_idx (i);
        return;
    }
}
    ...
    int idx;
{
    ...
    --tc_len;
    for (i = idx; i < tc_len; ++i) termcodes [i] = termcodes [i + 1];
}

static void switch_to_8bit () {
    int i;
    int c;
    if (!term_is_8bit((term_strings[(int)(KS_NAME)]))) {
        for (i = 0; i < tc_len; ++i) {
            c = term_7to8bit (termcodes [i].code);
            if (c != 0) {
                ((__builtin_object_size ((char *) ((termcodes [i].code + 1)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((termcodes [i].code + 1)
                  ), (char *) ((termcodes [i].code + 2)), strlen ((char *) (termcodes [i].code + 2)) + 1, __builtin_object_size ((char *) ((termcodes [i].code +
                  1)), 0)) : __inline_memmove_chk ((char *) ((termcodes [i].code + 1)), (char *) ((termcodes [i].code + 2)), strlen ((char *) (termcodes [i].
                  code + 2)) + 1));
...
int check_termcode (max_offset, buf, buflen)
    int max_offset;
    char_u * buf;
    int buflen;
{
    ...
    int wheel_code = 0;
    int current_button;
    static int held_button = 0x03;
    static int orig_num_clicks = 1;
    static int orig_mouse_code = 0x0;
    static int orig_mouse_col = 0;
    static int orig_mouse_row = 0;
    static struct timeval orig_mouse_time =
    {0, 0};
    struct timeval mouse_time;
    long timediff;
    int cpo_koffset;
    cpo_koffset = (vim_strchr (p_cpo, 'K') != ((void *) 0));
    if (need_gather) gather_termleader ();
    for (offset = 0; offset < max_offset; ++offset) {
        if (buf == ((void *) 0)) {
            if (offset >= typebuf.tb_len) break;
        ...
        if (*p == '\000') continue;
        if (*tp == '\033' && !p_ek && (State & 0x10)) continue;
        key_name [0] = '\000';
        key_name [1] = '\000';
        modifiers = 0;
        {
            for (idx = 0; idx < tc_len; ++idx) {
                ...
                if (cpo_koffset && offset && len < slen) continue;
                if (strncmp ((char *) (termcodes [idx].code), (char *) (tp), (size_t) ((size_t) (slen > len ? len : slen))) == 0) {
                    if (len < slen) return -1;
                    if (termcodes [idx].name [0] == 'K' && ((termcodes [idx].name [1]) >= '0' && (termcodes [idx].name [1]) <= '9')) {
                        for (j = idx + 1; j < tc_len; ++j) if (termcodes [j].len == slen && strncmp ((char *) (termcodes [idx].code), (char *) (termcodes [j].
                          code), (size_t) (slen)) == 0) {
                            idx = j;
                            break;
                        }
                ...
                if (termcodes [idx].modlen > 0) {
                    ...
                    if (cpo_koffset && offset && len < modslen) continue;
                    if (strncmp ((char *) (termcodes [idx].code), (char *) (tp), (size_t) ((size_t) (modslen > len ? len : modslen))) == 0) {
                        int n;
                        if (len <= modslen) return -1;
                        if (tp [modslen] == termcodes [idx].code [slen - 1]) slen = modslen + 1;
                        else if (tp [modslen] != ';' && modslen == slen - 3) continue;
                        else {
                            for (j = slen - 2; j < len && isdigit (tp [j]); ++j);
                            ++j;
                            if (len < j) return -1;
                            if (tp [j - 1] != termcodes [idx].code [slen - 1]) continue;
                            n = atoi ((char *) tp + slen - 2) - 1;
                            if (n & 1) modifiers |= 0x02;
                            if (n & 2) modifiers |= 0x08;
                            if (n & 4) modifiers |= 0x04;
                            if (n & 8) modifiers |= 0x10;
                            slen = j;
                        }
                        key_name [0] = termcodes [idx].name [0];
                        key_name [1] = termcodes [idx].name [1];
        ...
        if (key_name [0] == '\000') {
            if (*(term_strings[(int)(KS_CRV)]) != '\000' && ((tp [0] == '\033' && tp [1] == '[' && len >= 3) || (tp [0] == 0x9b && len >= 2))) {
                j = 0;
                extra = 0;
                for (i = 2 + (tp [0] != 0x9b); i < len && !(tp[i]>='{'&&tp[i]<='~') && !((tp[i])<0x7f&&isalpha(tp[i])); ++i) if (tp [i] == ';' && ++j == 1)
                  extra = atoi ((char *) tp + i + 1);
                if (i == len) return -1;
                if (i > 2 + (tp [0] != 0x9b) && tp [i] == 'c') {
                    crv_status = 3;
                    if (tp [0] == 0x9b) switch_to_8bit ();
                    if (extra > 20000) extra = 0;
                    if (tp [1 + (tp [0] != 0x9b)] == '>' && j == 2) {
                        if (extra >= 95) set_option_value ((char_u *) "ttym", 0L, (char_u *) "xterm2", 0);
                        if (extra >= 141) {
                            check_for_codes = 1;
                            need_gather = 1;
                            req_codes_from_term ();
            ...
            else if (check_for_codes && ((tp [0] == '\033' && tp [1] == 'P' && len >= 2) || tp [0] == 0x90)) {
                j = 1 + (tp [0] != 0x90);
                for (i = j; i < len; ++i) if ((tp [i] == '\033' && tp [i + 1] == '\\' && i + 1 < len) || tp [i] == 0x9c) {
                    if (i - j >= 3 && tp [j + 1] == '+' && tp [j + 2] == 'r') got_code_from_term (tp + j, i);
                    key_name [0] = (int) 253;
                    key_name [1] = (int) KE_IGNORE;
                    slen = i + 1 + (tp [i] == '\033');
                    break;
        ...
        if (key_name [0] == '\000') continue;
        if (key_name [0] == (int) 251) {
            is_click = is_drag = 0;
            if (key_name [0] == (int) 251) {
                for (;;) {
                    {
                    ...
                    slen += num_bytes;
                    j = termcodes [idx].len;
                    if (strncmp ((char *) (tp), (char *) (tp + slen), (size_t) ((size_t) j)) == 0 && tp [slen + j] == mouse_code && tp [slen + j + 1] != '\000'
                      && tp [slen + j + 2] != '\000') slen += j;
                    else break;
                }
                if (mouse_code >= 0x60) {
                    wheel_code = mouse_code;
                }
                else if (held_button == 0x03 && (mouse_code == 0x23 || mouse_code == 0x24)) {
                    wheel_code = mouse_code - 0x23 + 0x60;
                }
                else if (use_xterm_mouse () > 1) {
                    if (mouse_code & 0x40) mouse_code |= (0x40 | 0x03);
                }
            }
            current_button = (mouse_code & 0x03);
            if (current_button == 0x03 && wheel_code == 0) {
                if ((mouse_code & (0x40 | 0x03)) == (0x40 | 0x03)) is_drag = 1;
                current_button = held_button;
            }
            else if (wheel_code == 0) {
                {
                    gettimeofday (&mouse_time, ((void *) 0));
                    timediff = (mouse_time.tv_usec - orig_mouse_time.tv_usec) / 1000;
                    if (timediff < 0) --orig_mouse_time.tv_sec;
                    timediff += (mouse_time.tv_sec - orig_mouse_time.tv_sec) * 1000;
                    orig_mouse_time = mouse_time;
                    if (mouse_code == orig_mouse_code && timediff < p_mouset && orig_num_clicks != 4 && orig_mouse_col == mouse_col && orig_mouse_row ==
                      mouse_row && ((orig_topline == curwin -> w_topline && orig_topfill == curwin -> w_topfill) || (mouse_row == 0 && firstwin -> w_winrow > 0
                      ))) ++orig_num_clicks;
            ...
            if (!is_drag) held_button = mouse_code & 0x03;
            if (orig_mouse_code & 0x04) modifiers |= 0x02;
            if (orig_mouse_code & 0x10) modifiers |= 0x04;
            if (orig_mouse_code & 0x08) modifiers |= 0x08;
            if (orig_num_clicks == 2) modifiers |= 0x20;
            else if (orig_num_clicks == 3) modifiers |= 0x40;
            else if (orig_num_clicks == 4) modifiers |= 0x60;
            key_name [0] = (int) 253;
            if (wheel_code != 0) {
                if (wheel_code & 0x10) modifiers |= 0x04;
                if (wheel_code & 0x08) modifiers |= 0x08;
                key_name [1] = (wheel_code & 1) ? (int) KE_MOUSEUP : (int) KE_MOUSEDOWN;
            }
            else key_name [1] = get_pseudo_mouse_code (current_button, is_click, is_drag);
        }
        ...
        extra = new_slen - slen;
        if (buf == ((void *) 0)) {
            if (extra < 0) del_typebuf (-extra, offset);
            else if (extra > 0) ins_typebuf (string + slen, 0, offset, 0, 0);
            ((__builtin_object_size ((char *) (typebuf.tb_buf + typebuf.tb_off + offset), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (typebuf.
              tb_buf + typebuf.tb_off + offset), (char *) (string), (size_t) new_slen, __builtin_object_size ((char *) (typebuf.tb_buf + typebuf.tb_off + offset
              ), 0)) : __inline_memmove_chk ((char *) (typebuf.tb_buf + typebuf.tb_off + offset), (char *) (string), (size_t) new_slen));
        }
        else {
            if (extra < 0) ((__builtin_object_size ((char *) (buf + offset), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf + offset), (char *) (
              buf + offset - extra), (size_t) (buflen + offset + extra), __builtin_object_size ((char *) (buf + offset), 0)) : __inline_memmove_chk ((char *) (
              buf + offset), (char *) (buf + offset - extra), (size_t) (buflen + offset + extra)));
            else if (extra > 0) ((__builtin_object_size ((char *) (buf + offset + extra), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf + offset
              + extra), (char *) (buf + offset), (size_t) (buflen - offset), __builtin_object_size ((char *) (buf + offset + extra), 0)) : __inline_memmove_chk
              ((char *) (buf + offset + extra), (char *) (buf + offset), (size_t) (buflen - offset)));
            ((__builtin_object_size ((char *) (buf + offset), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf + offset), (char *) (string), (
              size_t) new_slen, __builtin_object_size ((char *) (buf + offset), 0)) : __inline_memmove_chk ((char *) (buf + offset), (char *) (string), (size_t
              ) new_slen));
        }
    ...
    int special;
{
    ...
    do_key_code = (vim_strchr (p_cpo, 'k') == ((void *) 0));
    result = alloc ((unsigned) strlen ((char *) (from)) * 6 + 1);
    if (result == ((void *) 0)) {
        * bufp = ((void *) 0);
        return from;
    }
    src = from;
    if (from_part && src [0] == '#' && ((src [1]) >= '0' && (src [1]) <= '9')) {
        result [dlen ++] = (0x80);
        result [dlen ++] = 'k';
        if (src [1] == '0') result [dlen ++] = ';';
        else result [dlen ++] = src [1];
        src += 2;
    }
    while (*src != '\000') {
        if (do_special && (do_lt || strncmp ((char *) (src), (char *) ("<lt>"), (size_t) (4)) != 0)) {
            if (strncasecmp ((char *) (src), (char *) ("<SID>"), (size_t) (5)) == 0) {
                if (current_SID <= 0) emsg ((char_u *) (((char *) (e_usingsid))));
                else {
                    src += 5;
                    result [dlen ++] = (0x80);
                    result [dlen ++] = (int) 253;
                    result [dlen ++] = (int) KE_SNR;
                    __builtin___sprintf_chk ((char *) result + dlen, 0, __builtin_object_size ((char *) result + dlen, 1 > 1), "%ld", (long) current_SID);
                    dlen += (int) strlen ((char *) (result + dlen));
                    result [dlen ++] = '_';
                    continue;
                }
            }
        ...
        if (do_special) {
            ...
            if (len != 0) {
                if (p == ((void *) 0) || *p == '\000' || strlen ((char *) (p)) > 8 * 6) s = (char_u *) "\\";
                else s = p;
                while (*s != '\000') result [dlen ++] = *s++;
                src += len;
                continue;
            }
        }
        ...
        }
        {
            ...
            else result [dlen ++] = *src;
            ++src;
        }
    }
    result [dlen] = '\000';
    if ((*bufp = vim_strsave (result)) != ((void *) 0)) from = *bufp;
    vim_free (result);
    return from;
}
    ...
    char_u * src;
{
    ...
    for (i = 0; i < tc_len; ++i) {
        ...
        if (slen > 1 && strncmp ((char *) (termcodes [i].code), (char *) (src), (size_t) ((size_t) slen)) == 0) return i;
    }
    return -1;
}
...
static void gather_termleader () {
    int i;
    int len = 0;
    if (check_for_codes) termleader [len ++] = 0x90;
    termleader [len] = '\000';
    for (i = 0; i < tc_len; ++i) if (vim_strchr (termleader, termcodes [i].code [0]) == ((void *) 0)) {
...
void show_termcodes () {
    ...
    for (run = 1; run <= 3 && !got_int; ++run) {
        item_count = 0;
        for (i = 0; i < tc_len; i ++) {
            len = show_one_termcode (termcodes [i].name, termcodes [i].code, 0);
            if (len <= 27 - 2 ? run == 1 : len <= 40 - 2 ? run == 2 : run == 3) items [item_count ++] = i;
        }
        if (run <= 2) {
        ...
        for (row = 0; row < rows && !got_int; ++row) {
            ...
            for (i = row; i < item_count; i += rows) {
                msg_col = col;
                show_one_termcode (termcodes [items [i]].name, termcodes [items [i]].code, 1);
                if (run == 2) col += 40;
                else col += 27;
            }
            out_flush ();
    ...
    int printit;
{
    ...
    if (p [1] != 't') ((__builtin_object_size ((char *) (IObuff + 5), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff + 5), (char *) (p),
      __builtin_object_size ((char *) (IObuff + 5), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff + 5), (char *) (p)));
    else IObuff [5] = '\000';
    len = (int) strlen ((char *) (IObuff));
    do IObuff [len ++] = ' ';
    while (len < 17);
    IObuff [len] = '\000';
    if (code == ((void *) 0)) len += 4;
    else len += vim_strsize (code);
    if (printit) {
        msg_puts (IObuff);
        if (code == ((void *) 0)) msg_puts ((char_u *) "NULL");
        else msg_outtrans (code);
    }
    return len;
}
...
static void req_more_codes_from_term () {
    ...
    if (exiting) return;
    while (xt_index_out < xt_index_in + 10 && key_names [xt_index_out] != ((void *) 0)) {
        __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "\033P+q%02x%02x\033\\", key_names [xt_index_out] [0], key_names [xt_index_out] [1
          ]);
        out_str_nf ((char_u *) buf);
        ++xt_index_out;
    }
    if (xt_index_out != old_idx) out_flush ();
}
    ...
    int len;
{
    ...
    int j = 0;
    int c;
    if (code [0] == '1' && code [7] == '=' && len / 2 < 100) {
        name [0] = hexhex2nr (code + 3);
        name [1] = hexhex2nr (code + 5);
        name [2] = '\000';
        for (i = 0; key_names [i] != ((void *) 0); ++i) {
            if (strcmp ((char *) (key_names [i]), (char *) (name)) == 0) {
                xt_index_in = i;
                break;
            }
        }
        if (key_names [i] != ((void *) 0)) {
            for (i = 8; (c = hexhex2nr (code + i)) >= 0; i += 2) str [j ++] = c;
            str [j] = '\000';
            if (name [0] == 'C' && name [1] == 'o') {
                ...
                if (i >= 0) del_termcode_idx (i);
                add_termcode (name, str, 55);
            }
        }
    }
    ++xt_index_in;
...
static void check_for_codes_from_term () {
    int c;
    if (xt_index_out == 0 || xt_index_out == xt_index_in) return;
    ++no_mapping;
    ++allow_keys;
    for (;;) {
        c = vpeekc ();
        if (c == '\000') break;
        if (c != (0x80) && c != (-((253)+((int)(KE_IGNORE)<<8)))) break;
        c = vgetc ();
    ...
    int expmap;
{
    ...
    ga.ga_itemsize = 1;
    ga.ga_growsize = 40;
    cpo_bslash = (vim_strchr (p_cpo, 'B') != ((void *) 0));
    cpo_special = (vim_strchr (p_cpo, '<') != ((void *) 0));
    cpo_keycode = (vim_strchr (p_cpo, 'k') == ((void *) 0));
    for (; *str; ++str) {
        c = *str;
        if (c == (0x80) && str [1] != '\000' && str [2] != '\000') {
            ...
            if (cpo_special && cpo_keycode && c == (0x80) && !modifiers) {
                int i;
                for (i = 0; i < tc_len; ++i) if (termcodes [i].name [0] == str [1] && termcodes [i].name [1] == str [2]) break;
                if (i < tc_len) {
        ...
        if (c == ' ' || c == '\t' || c == 10 || c == 22 || (c == '<' && !cpo_special) || (c == '\\' && !cpo_bslash)) ga_append (&ga, cpo_bslash ? 22 : '\\');
        if (c) ga_append (&ga, c);
    }
    ga_append (&ga, '\000');

...
typedef int NBSOCK;
static NBSOCK nbsock = -1;
static int r_cmdno;
static int dosetvisible = 0;
...
static int netbeans_connect (char * params, int doabort) {
    ...
    char * arg = ((void *) 0);
    if (*params == '=') {
        if (getConnInfo (params + 1, &hostname, &address, &password) == 0) return 0;
    }
    else {
        if (*params == ':') arg = params + 1;
        if (arg == ((void *) 0) && (fname = getenv ("__NETBEANS_CONINFO")) != ((void *) 0)) {
            if (getConnInfo (fname, &hostname, &address, &password) == 0) return 0;
        }
        else {
            if (arg != ((void *) 0)) {
                hostname = arg;
            ...
            if (hostname == ((void *) 0) || *hostname == '\0') hostname = getenv ("__NETBEANS_HOST");
            if (address == ((void *) 0)) address = getenv ("__NETBEANS_SOCKET");
            if (password == ((void *) 0)) password = getenv ("__NETBEANS_VIM_PASSWORD");
            if (hostname != ((void *) 0)) hostname = (char *) vim_strsave ((char_u *) hostname);
            if (address != ((void *) 0)) address = (char *) vim_strsave ((char_u *) address);
            if (password != ((void *) 0)) password = (char *) vim_strsave ((char_u *) password);
        }
    }
    if (hostname == ((void *) 0) || *hostname == '\0') {
        vim_free (hostname);
        hostname = (char *) vim_strsave ((char_u *) "localhost");
    }
    if (address == ((void *) 0) || *address == '\0') {
        vim_free (address);
        address = (char *) vim_strsave ((char_u *) "3219");
    }
    if (password == ((void *) 0) || *password == '\0') {
        vim_free (password);
        password = (char *) vim_strsave ((char_u *) "changeme");
    }
    if (hostname == ((void *) 0) || address == ((void *) 0) || password == ((void *) 0)) goto theend;
    port = atoi (address);
    if ((sd = (NBSOCK) socket (2, 1, 0)) == (NBSOCK) - 1) {
        ;
        (void) emsg3 ((char_u *) "%s: %s", (char_u *) "socket() in netbeans_connect()", (char_u *) strerror ((*__error())));
        goto theend;
    }
    ((__builtin_object_size (((char *) &server), 0) != (size_t) - 1) ? __builtin___memset_chk (((char *) &server), ('\0'), (sizeof (server)),
      __builtin_object_size (((char *) &server), 0)) : __inline_memset_chk (((char *) &server), ('\0'), (sizeof (server))));
    server.sin_family = 2;
    server.sin_port = (__builtin_constant_p (port) ? ((__uint16_t) ((((__uint16_t) (port) & 0xff00) >> 8) | (((__uint16_t) (port) & 0x00ff) << 8))) :
      _OSSwapInt16 (port));
    if ((host = gethostbyname (hostname)) == ((void *) 0)) {
        if (access ((hostname), ((1 << 2))) >= 0) {
            sd = open ((hostname), (0x0000), (0));
            goto theend;
        };
        (void) emsg3 ((char_u *) "%s: %s", (char_u *) "gethostbyname() in netbeans_connect()", (char_u *) strerror ((*__error())));
        goto theend;
    }
    ((__builtin_object_size ((char *) &server.sin_addr, 0) != (size_t) - 1) ? __builtin___memcpy_chk ((char *) &server.sin_addr, host -> h_addr_list [0], host
      -> h_length, __builtin_object_size ((char *) &server.sin_addr, 0)) : __inline_memcpy_chk ((char *) &server.sin_addr, host -> h_addr_list [0], host ->
      h_length));
    if (connect (sd, (struct sockaddr *) &server, sizeof (server))) {
        ...
        if ((*__error()) == 61) {
            ...
            if ((sd = (NBSOCK) socket (2, 1, 0)) == (NBSOCK) - 1) {
                ;
                ;
                (void) emsg3 ((char_u *) "%s: %s", (char_u *) "socket()#2 in netbeans_connect()", (char_u *) strerror ((*__error())));
                goto theend;
            }
            if (connect (sd, (struct sockaddr *) &server, sizeof (server))) {
                int retries = 36;
                int success = 0;
                ;
                while (retries -- && (((*__error()) == 61) || ((*__error()) == 4))) {
                    ;
                    sleep (5);
                    if (!doabort) {
                        ui_breakcheck ();
                ...
                if (!success) {
                    ;
                    (void) emsg3 ((char_u *) "%s: %s", (char_u *) ((char *) ("Cannot connect to Netbeans #2")), (char_u *) strerror ((*__error())));
                    if (doabort) getout (1);
                    goto theend;
                }
            }
            ...
            ;
            (void) emsg3 ((char_u *) "%s: %s", (char_u *) ((char *) ("Cannot connect to Netbeans")), (char_u *) strerror ((*__error())));
            if (doabort) getout (1);
            goto theend;
        }
    }
    ...
    __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "0:version=0 \"%s\"\n", ExtEdProtocolVersion);
    nb_send (buf, "externaleditor_version");
    theend : vim_free (hostname);
    vim_free (address);
    vim_free (password);
    return (nbsock != -1) ? 1 : 0;
}

static int getConnInfo (char * file, char * * host, char * * port, char * * auth) {
    FILE * fp;
    char_u buf [1024];
    char_u * lp;
    char_u * nl;
    struct stat st;
    if (stat ((file), (&st)) == 0 && (st.st_mode & 0077) != 0) {
        ;
        emsg2 ((char_u *) (((char *) ("E668: Wrong access mode for NetBeans connection info file: \"%s\""))), (char_u *) (file));
        return 0;
    }
    fp = fopen ((file), ("r"));
    if (fp == ((void *) 0)) {
        ;
        (void) emsg3 ((char_u *) "%s: %s", (char_u *) "E660: Cannot open NetBeans connection info file", (char_u *) strerror ((*__error())));
        return 0;
    }
    while ((lp = (char_u *) fgets ((char *) buf, 1024, fp)) != ((void *) 0)) {
        if ((nl = vim_strchr (lp, '\n')) != ((void *) 0)) *nl = 0;
        if (strncmp ((char *) (lp), (char *) ("host="), (size_t) (5)) == 0) {
            vim_free (* host);
            * host = (char *) vim_strsave (&buf[5]);
        }
        else if (strncmp ((char *) (lp), (char *) ("port="), (size_t) (5)) == 0) {
            vim_free (* port);
            * port = (char *) vim_strsave (&buf[5]);
        }
        else if (strncmp ((char *) (lp), (char *) ("auth="), (size_t) (5)) == 0) {
            vim_free (* auth);
...
static void handle_key_queue (void) {
    ...
    while (!postponed && keyHead.next && keyHead.next != &keyHead) {
        ...
        if (node -> keystr != ((void *) 0)) postponed = !netbeans_keystring(node->keystr);
...
static void save (char_u * buf, int len) {
    queue_T * node;
    node = (queue_T *) alloc (sizeof (queue_T));
    if (node == ((void *) 0)) return;
    node -> buffer = alloc (len + 1);
    if (node -> buffer == ((void *) 0)) {
        vim_free (node);
        return;
    }
    ((__builtin_object_size ((char *) (node -> buffer), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (node -> buffer), (char *) (buf), (size_t) len,
      __builtin_object_size ((char *) (node -> buffer), 0)) : __inline_memmove_chk ((char *) (node -> buffer), (char *) (buf), (size_t) len));
    node -> buffer [len] = '\000';
    if (head.next == ((void *) 0)) {
        head.next = &head;
        head.prev = &head;
...
void netbeans_parse_messages (void) {
    ...
    queue_T * node;
    if (!(nbsock!=-1)) return;
    while (head.next != ((void *) 0) && head.next != &head) {
        node = head.next;
        p = vim_strchr (node -> buffer, '\n');
        if (p == ((void *) 0)) {
            if (node -> next == &head) return;
            p = alloc ((unsigned) (strlen ((char *) (node -> buffer)) + strlen ((char *) (node -> next -> buffer)) + 1));
            if (p == ((void *) 0)) return;
            ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (p), (char *) (node -> buffer), __builtin_object_size
              ((char *) (p), 1 > 1)) : __inline_strcpy_chk ((char *) (p), (char *) (node -> buffer)));
            ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (p), (char *) (node -> next -> buffer),
              __builtin_object_size ((char *) (p), 1 > 1)) : __inline_strcat_chk ((char *) (p), (char *) (node -> next -> buffer)));
            ...
            *p++ = '\000';
            ...
            if (*p == '\000') {
                ...
                ((__builtin_object_size ((char *) ((node -> buffer)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((node -> buffer)), (char *) ((p)
                  ), strlen ((char *) (p)) + 1, __builtin_object_size ((char *) ((node -> buffer)), 0)) : __inline_memmove_chk ((char *) ((node -> buffer)), (
...
void netbeans_read () {
    ...
    for (;;) {
        ...
        do {
            int __fd = (nbsock);
            ((&rfds) -> fds_bits [__fd / (sizeof (__int32_t) * 8)] |= (1 << (__fd % (sizeof (__int32_t) * 8))));
        }
        while (0);
        tval.tv_sec = 0;
        tval.tv_usec = 0;
        if (select (nbsock + 1, &rfds, ((void *) 0), ((void *) 0), &tval) <= 0) break;
        len = read (nbsock, buf, 4096);
        if (len <= 0) break;
        save (buf, len);
        readlen += len;
        if (len < 4096) break;
    ...
    if (readlen <= 0) {
        ...
        if (len < 0) {
            ;
            (void) emsg3 ((char_u *) "%s: %s", (char_u *) ((char *) ("read from Netbeans socket")), (char_u *) strerror ((*__error())));
        }
        return;
    }
}
...
static void nb_parse_cmd (char_u * cmd) {
    ...
    int bufno;
    int isfunc = -1;
    if (strcmp ((char *) (cmd), (char *) ("DISCONNECT")) == 0) {
        netbeans_close ();
        getout (0);
    }
    if (strcmp ((char *) (cmd), (char *) ("DETACH")) == 0) {
        netbeans_close ();
        return;
    }
    ...
    if (*verb != ':') {
        ;
        emsg2 ((char_u *) ("E627: missing colon: %s"), (char_u *) (cmd));
        return;
    }
    ++verb;
    for (q = verb; *q; q ++) {
    ...
    if (isfunc < 0) {
        ;
        emsg2 ((char_u *) ("E628: missing ! or / in: %s"), (char_u *) (cmd));
        return;
    }
    r_cmdno = strtol (q, &q, 10);
    q = (char *) skipwhite ((char_u *) q);
    if (nb_do_cmd (bufno, (char_u *) verb, isfunc, r_cmdno, (char_u *) q) == 0) {
    }
}
...
static nbbuf_T * buf_list = ((void *) 0);
static int buf_list_size = 0;
static int buf_list_used = 0;
static char * * globalsignmap = ((void *) 0);
static int globalsignmaplen = 0;
static int globalsignmapused = 0;
static int mapsigntype (nbbuf_T *, int localsigntype);
static void addsigntype (nbbuf_T *, int localsigntype, char_u * typeName, char_u * tooltip, char_u * glyphfile, char_u * fg, char_u * bg);
...
static void nb_free () {
    ...
    for (i = 0; i < buf_list_used; i ++) {
        ...
        if ((bufp = buf.bufp) != ((void *) 0)) {
            buf.bufp -> b_netbeans_file = 0;
            buf.bufp -> b_was_netbeans_file = 0;
        }
    }
    vim_free (buf_list);
    buf_list = ((void *) 0);
    buf_list_size = 0;
    buf_list_used = 0;
    while (key_node != ((void *) 0) && key_node != &keyHead) {
    ...
    while (cmd_node != ((void *) 0) && cmd_node != &head) {
...
static int nb_getbufno (buf_T * bufp) {
    int i;
    for (i = 0; i < buf_list_used; i ++) if (buf_list [i].bufp == bufp) return i;
    return -1;
}

int isNetbeansBuffer (buf_T * bufp) {
    return (nbsock != -1) && bufp -> b_netbeans_file;
}

int isNetbeansModified (buf_T * bufp) {
    if (isNetbeansBuffer (bufp)) {
        int bufno = nb_getbufno (bufp);
        if (bufno > 0) return buf_list [bufno].modified;
        else return 0;
    }
    else return 0;
}
...
static nbbuf_T * nb_get_buf (int bufno) {
    ...
    if (bufno >= buf_list_used) {
        if (bufno >= buf_list_size) {
            ...
            buf_list_size += incr;
            buf_list = (nbbuf_T *) realloc ((buf_list), (buf_list_size * sizeof (nbbuf_T)));
            ((__builtin_object_size ((buf_list + buf_list_size - incr), 0) != (size_t) - 1) ? __builtin___memset_chk ((buf_list + buf_list_size - incr), (0), (
              incr * sizeof (nbbuf_T)), __builtin_object_size ((buf_list + buf_list_size - incr), 0)) : __inline_memset_chk ((buf_list + buf_list_size - incr),
              (0), (incr * sizeof (nbbuf_T))));
        }
...
static int count_changed_buffers (void) {
    ...
    int n;
    n = 0;
    for (bufp = firstbuf; bufp != ((void *) 0); bufp = bufp -> b_next) if (bufp -> b_changed) ++n;
    return n;
}
...
void netbeans_end (void) {
    ...
    if (!(nbsock!=-1)) return;
    for (i = 0; i < buf_list_used; i ++) {
        if (!buf_list[i].bufp) continue;
        if (netbeansForcedQuit) {
            __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%d:unmodified=%d\n", i, r_cmdno);
            ;
            nb_send (buf, "netbeans_end");
        }
        __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%d:killed=%d\n", i, r_cmdno);
        ;
        ignored = write (nbsock, buf, (int) strlen ((char *) (buf)));
    }
}
...
static void nb_send (char * buf, char * fun) {
    ...
    if (!(nbsock!=-1)) {
        if (!did_error) {
            ;
            emsg2 ((char_u *) ("E630: %s(): write while not connected"), (char_u *) (fun));
        }
        did_error = 1;
    }
    else if (write (nbsock, buf, (int) strlen ((char *) (buf))) != (int) strlen ((char *) (buf))) {
        if (!did_error) {
            ;
            emsg2 ((char_u *) ("E631: %s(): write failed"), (char_u *) (fun));
        }
        did_error = 1;
    }
    else did_error = 0;
...
static void nb_reply_nil (int cmdno) {
    char reply [32];
    ;
    __builtin___sprintf_chk (reply, 0, __builtin_object_size (reply, 1 > 1), "%d\n", cmdno);
...
static void nb_reply_text (int cmdno, char_u * result) {
    char_u * reply;
    ;
    reply = alloc ((unsigned) strlen ((char *) (result)) + 32);
    __builtin___sprintf_chk ((char *) reply, 0, __builtin_object_size ((char *) reply, 1 > 1), "%d %s\n", cmdno, (char *) result);
...
static void nb_reply_nr (int cmdno, long result) {
    char reply [32];
    ;
    __builtin___sprintf_chk (reply, 0, __builtin_object_size (reply, 1 > 1), "%d %ld\n", cmdno, result);
    nb_send (reply, "nb_reply_nr");
}

static char_u * nb_quote (char_u * txt) {
    char_u * buf = alloc ((unsigned) (2 * strlen ((char *) (txt)) + 1));
    char_u * p = txt;
    char_u * q = buf;
...
static char * nb_unquote (char_u * p, char_u * * endp) {
    ...
    char * q;
    int done = 0;
    result = (char *) alloc_clear ((unsigned) strlen ((char *) (p)) + 1);
...
static void nb_partialremove (linenr_T lnum, colnr_T first, colnr_T last) {
    ...
    int lastbyte = last;
    oldtext = ml_get (lnum);
    oldlen = (int) strlen ((char *) (oldtext));
    if (first >= (colnr_T) oldlen || oldlen == 0) return;
    if (lastbyte >= oldlen) lastbyte = oldlen - 1;
    newtext = alloc (oldlen - (int) (lastbyte - first));
    if (newtext != ((void *) 0)) {
        ((__builtin_object_size ((char *) (newtext), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (newtext), (char *) (oldtext), first,
          __builtin_object_size ((char *) (newtext), 0)) : __inline_memmove_chk ((char *) (newtext), (char *) (oldtext), first));
        ((__builtin_object_size ((char *) ((newtext + first)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((newtext + first)), (char *) ((oldtext +
          lastbyte + 1)), strlen ((char *) (oldtext + lastbyte + 1)) + 1, __builtin_object_size ((char *) ((newtext + first)), 0)) : __inline_memmove_chk ((
          char *) ((newtext + first)), (char *) ((oldtext + lastbyte + 1)), strlen ((char *) (oldtext + lastbyte + 1)) + 1));
        ;
        ml_replace (lnum, newtext, 0);
    }
}
...
static void nb_joinlines (linenr_T first, linenr_T other) {
    ...
    char_u * p;
    len_first = (int) strlen ((char *) (ml_get (first)));
    len_other = (int) strlen ((char *) (ml_get (other)));
    p = alloc ((unsigned) (len_first + len_other + 1));
    if (p != ((void *) 0)) {
        ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (p), (char *) (ml_get (first)), len_first,
          __builtin_object_size ((char *) (p), 0)) : __inline_memmove_chk ((char *) (p), (char *) (ml_get (first)), len_first));
        ((__builtin_object_size ((char *) (p + len_first), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (p + len_first), (char *) (ml_get (other)),
          len_other + 1, __builtin_object_size ((char *) (p + len_first), 0)) : __inline_memmove_chk ((char *) (p + len_first), (char *) (ml_get (other)),
          len_other + 1));
        ml_replace (first, p, 0);
    }
}
...
static int nb_do_cmd (int bufno, char_u * cmd, int func, int cmdno, char_u * args) {
    ...
    ;
    if (func) {
        if ((strcmp ((char *) cmd, "getModified") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) nb_reply_nr (cmdno, (long) count_changed_buffers ());
            else nb_reply_nr (cmdno, (long) (buf -> bufp -> b_changed || isNetbeansModified (buf -> bufp)));
        }
        else if ((strcmp ((char *) cmd, "saveAndExit") == 0)) {
            coloncmd (":confirm qall");
            nb_reply_nr (cmdno, (long) count_changed_buffers ());
        }
        else if ((strcmp ((char *) cmd, "getCursor") == 0)) {
            char_u text [200];
            __builtin___sprintf_chk ((char *) text, 0, __builtin_object_size ((char *) text, 1 > 1), "%d %ld %d %ld", nb_getbufno (curbuf), (long) curwin ->
              w_cursor.lnum, (int) curwin -> w_cursor.col, pos2off (curbuf, &curwin->w_cursor));
            nb_reply_text (cmdno, text);
        }
        else if ((strcmp ((char *) cmd, "getAnno") == 0)) {
            long linenum = 0;
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
        ...
        else if ((strcmp ((char *) cmd, "getLength") == 0)) {
            long len = 0;
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
        ...
        else if ((strcmp ((char *) cmd, "getText") == 0)) {
            long len;
            linenr_T nlines;
            char_u * text = ((void *) 0);
            linenr_T lno = 1;
            ...
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ...
                if (text == ((void *) 0)) {
                    ...
                    *p++ = '\"';
                    for (; lno <= nlines; lno ++) {
                        line = nb_quote (ml_get_buf (buf -> bufp, lno, 0));
                        if (line != ((void *) 0)) {
                            ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (p), (char *) (line),
                              __builtin_object_size ((char *) (p), 1 > 1)) : __inline_strcpy_chk ((char *) (p), (char *) (line)));
                            p += strlen ((char *) (line));
                            *p++ = '\\';
                            *p++ = 'n';
                            vim_free (line);
            ...
            if (text == ((void *) 0)) nb_reply_text (cmdno, (char_u *) "");
            else {
                nb_reply_text (cmdno, text);
                vim_free (text);
            }
        }
        else if ((strcmp ((char *) cmd, "remove") == 0)) {
            long count;
            pos_T first, last;
            pos_T * pos;
            pos_T * next;
            ...
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ...
                if (first.col != 0 || (next != ((void *) 0) && first.lnum == next -> lnum)) {
                    if (first.lnum != last.lnum || (next != ((void *) 0) && first.lnum != next -> lnum)) {
                        nb_partialremove (first.lnum, first.col, (colnr_T) (0x7fffffffL));
                ...
                if (first.lnum != last.lnum && next != ((void *) 0) && next -> col != 0 && last.lnum == next -> lnum) {
                ...
                if (first.lnum != last.lnum && del_from_lnum > first.lnum && next != ((void *) 0) && last.lnum != next -> lnum) {
                    nb_joinlines (first.lnum, next -> lnum);
                    del_to_lnum = next -> lnum;
                }
                if (del_to_lnum >= del_from_lnum) {
                    ...
                    del_lines (del_to_lnum - del_from_lnum + 1, 0);
                }
        ...
        else if ((strcmp ((char *) cmd, "insert") == 0)) {
            char_u * to_free;
            if (skip >= 2) {
                ;
                nb_reply_nil (cmdno);
            ...
            args = (char_u *) cp;
            args = skipwhite (args);
            args = to_free = (char_u *) nb_unquote (args, ((void *) 0));
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
                ...
                int ff_detected = -1;
                int buf_was_empty = (buf -> bufp -> b_ml.ml_flags & 1);
                size_t len = 0;
                int added = 0;
                int oldFire = netbeansFireChanges;
                int old_b_changed;
                ...
                if (pos != ((void *) 0)) {
                    if (pos -> lnum <= 0) lnum_start = 1;
                    else lnum_start = pos -> lnum;
                }
                else {
                    if (buf_was_empty) lnum_start = 1;
                    else lnum_start = curbuf -> b_ml.ml_line_count + 1;
                }
                lnum = lnum_start;
                doupdate = 1;
                while (*args != '\000') {
                    ...
                    args [len] = '\000';
                    if (lnum == lnum_start && ((pos != ((void *) 0) && pos -> col > 0) || (lnum == 1 && buf_was_empty))) {
                        char_u * oldline = ml_get (lnum);
                        char_u * newline;
                        newline = alloc_check ((unsigned) (strlen ((char *) (oldline)) + len + 1));
                        if (newline != ((void *) 0)) {
                            ((__builtin_object_size ((char *) (newline), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (newline), (char *) (oldline),
                              __builtin_object_size ((char *) (newline), 1 > 1)) : __inline_strcpy_chk ((char *) (newline), (char *) (oldline)));
                            ((__builtin_object_size ((char *) (newline), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (newline), (char *) (args),
                              __builtin_object_size ((char *) (newline), 1 > 1)) : __inline_strcat_chk ((char *) (newline), (char *) (args)));
                            ml_replace (lnum, newline, 0);
                        }
                    }
                    else {
                        ml_append ((linenr_T) (lnum - 1), args, (colnr_T) (len + 1), 0);
                        ++added;
                    }
                    if (nl == ((void *) 0)) break;
                    ++lnum;
                ...
                if (buf_was_empty) {
                    if (ff_detected == -1) ff_detected = 0;
                    set_fileformat (ff_detected, 4);
        ...
        if ((strcmp ((char *) cmd, "create") == 0)) {
            ...
            vim_free (buf -> displayname);
            buf -> displayname = ((void *) 0);
            netbeansReadFile = 0;
            do_ecmd (0, ((void *) 0), 0, 0, (linenr_T) 1, 0x01 + 0x04, curwin);
            netbeansReadFile = 1;
            buf -> bufp = curbuf;
            maketitle ();
            buf -> insertDone = 0;
        }
        else if ((strcmp ((char *) cmd, "insertDone") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
            }
            else {
        ...
        else if ((strcmp ((char *) cmd, "saveDone") == 0)) {
            long savedChars = atol ((char *) args);
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
            }
            else print_save_msg (buf, savedChars);
        }
        else if ((strcmp ((char *) cmd, "startDocumentListen") == 0)) {
            if (buf == ((void *) 0)) {
                ;
        ...
        else if ((strcmp ((char *) cmd, "stopDocumentListen") == 0)) {
            if (buf == ((void *) 0)) {
                ;
            ...
            buf -> fireChanges = 0;
            if (buf -> bufp != ((void *) 0) && buf -> bufp -> b_was_netbeans_file) {
                if (!buf->bufp->b_netbeans_file) {
                    ;
                    emsgn ((char_u *) (((char *) ("E658: NetBeans connection lost for buffer %ld"))), (long) (buf -> bufp -> b_fnum));
                }
                else {
                    do_bufdel (3, (char_u *) "", 1, buf -> bufp -> b_fnum, buf -> bufp -> b_fnum, 1);
                    ((__builtin_object_size ((buf), 0) != (size_t) - 1) ? __builtin___memset_chk ((buf), (0), (sizeof (nbbuf_T)), __builtin_object_size ((buf),
                      0)) : __inline_memset_chk ((buf), (0), (sizeof (nbbuf_T))));
                }
            }
        }
        else if ((strcmp ((char *) cmd, "setTitle") == 0)) {
            if (buf == ((void *) 0)) {
                ;
            ...
            vim_free (buf -> displayname);
            buf -> displayname = nb_unquote (args, ((void *) 0));
        }
        else if ((strcmp ((char *) cmd, "initDone") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
            ...
            buf -> initDone = 1;
            nb_set_curbuf (buf -> bufp);
            apply_autocmds (EVENT_BUFREADPOST, 0, 0, 0, buf -> bufp);
            handle_key_queue ();
        }
        else if ((strcmp ((char *) cmd, "setBufferNumber") == 0) || (strcmp ((char *) cmd, "putBufferNumber") == 0)) {
            char_u * path;
            buf_T * bufp;
            if (buf == ((void *) 0)) {
                ;
            ...
            path = (char_u *) nb_unquote (args, ((void *) 0));
            if (path == ((void *) 0)) return 0;
            bufp = buflist_findname (path);
            vim_free (path);
            if (bufp == ((void *) 0)) {
                ;
                emsg2 ((char_u *) ("E642: File %s not found in setBufferNumber"), (char_u *) (args));
                return 0;
            }
            buf -> bufp = bufp;
            buf -> nbbuf_number = bufp -> b_fnum;
            if (*cmd != 'p') coloncmd (":buffer %d", bufp -> b_fnum);
            else {
                buf -> initDone = 1;
                handle_key_queue ();
            }
        }
        else if ((strcmp ((char *) cmd, "setFullName") == 0)) {
            if (buf == ((void *) 0)) {
                ;
            ...
            buf -> displayname = nb_unquote (args, ((void *) 0));
            netbeansReadFile = 0;
            do_ecmd (0, (char_u *) buf -> displayname, 0, 0, (linenr_T) 1, 0x01 + 0x04, curwin);
            netbeansReadFile = 1;
            buf -> bufp = curbuf;
            maketitle ();
        }
        else if ((strcmp ((char *) cmd, "editFile") == 0)) {
            if (buf == ((void *) 0)) {
                ;
            ...
            vim_free (buf -> displayname);
            buf -> displayname = nb_unquote (args, ((void *) 0));
            do_ecmd (0, (char_u *) buf -> displayname, ((void *) 0), ((void *) 0), (linenr_T) 1, 0x01 + 0x04, curwin);
            buf -> bufp = curbuf;
            buf -> initDone = 1;
            doupdate = 1;
            maketitle ();
        }
        else if ((strcmp ((char *) cmd, "setVisible") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
                if (p_verbose > 0) emsg ((char_u *) ("E645: invalid buffer identifier in setVisible"));
                return 0;
            }
            if ((strcmp ((char *) args, "T") == 0) && buf -> bufp != curbuf) {
                exarg_T exarg;
                exarg.cmd = (char_u *) "goto";
                exarg.forceit = 0;
                dosetvisible = 1;
                goto_buffer (&exarg, 1, 1, buf -> bufp -> b_fnum);
                doupdate = 1;
                dosetvisible = 0;
            }
        }
        else if ((strcmp ((char *) cmd, "raise") == 0)) {
        }
        else if ((strcmp ((char *) cmd, "setModified") == 0)) {
            int prev_b_changed;
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
                if (p_verbose > 0) emsg ((char_u *) ("E646: invalid buffer identifier in setModified"));
                return 0;
            }
            prev_b_changed = buf -> bufp -> b_changed;
            if ((strcmp ((char *) args, "T") == 0)) buf -> bufp -> b_changed = 1;
            else {
                struct stat st;
                if (buf -> bufp -> b_ffname != ((void *) 0) && stat (((char *) buf -> bufp -> b_ffname), (&st)) >= 0) buf_store_time (buf -> bufp, &st, buf ->
                  bufp -> b_ffname);
        ...
        else if ((strcmp ((char *) cmd, "setModtime") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0));
            else buf -> bufp -> b_mtime = atoi ((char *) args);
        }
        else if ((strcmp ((char *) cmd, "setReadOnly") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0));
            else if ((strcmp ((char *) args, "T") == 0)) buf -> bufp -> b_p_ro = 1;
            else buf -> bufp -> b_p_ro = 0;
        }
        else if ((strcmp ((char *) cmd, "setMark") == 0)) {
        }
        else if ((strcmp ((char *) cmd, "showBalloon") == 0)) {
        }
        else if ((strcmp ((char *) cmd, "setDot") == 0)) {
            pos_T * pos;
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
            ...
            setcursor ();
            out_flush ();
            if (State == (0x200 + 0x01) || State == 0x300) {
            }
        }
        else if ((strcmp ((char *) cmd, "close") == 0)) {
            if (buf == ((void *) 0)) {
                ;
            ...
            if (buf -> bufp == ((void *) 0)) {
                ;
                if (p_verbose > 0) emsg ((char_u *) ("E649: invalid buffer identifier in close"));
            };
            if (buf -> bufp != ((void *) 0)) do_buffer (4, 1, 1, buf -> bufp -> b_fnum, 1);
            buf -> bufp = ((void *) 0);
            buf -> initDone = 0;
            doupdate = 1;
        }
        else if ((strcmp ((char *) cmd, "setStyle") == 0)) {
            ;
        }
        else if ((strcmp ((char *) cmd, "setExitDelay") == 0)) {
        }
        else if ((strcmp ((char *) cmd, "defineAnnoType") == 0)) {
            int typeNum;
            char_u * typeName;
            char_u * tooltip;
            char_u * p;
            ...
            fg = vim_strsave (args);
            bg = vim_strsave (p);
            if (strlen ((char *) (fg)) > 32 || strlen ((char *) (bg)) > 32) {
                emsg ((char_u *) ("E532: highlighting color name too long in defineAnnoType"));
                vim_free (typeName);
                parse_error = 1;
            }
            else if (typeName != ((void *) 0) && tooltip != ((void *) 0) && glyphFile != ((void *) 0)) addsigntype (buf, typeNum, typeName, tooltip, glyphFile,
              fg, bg);
            else vim_free (typeName);
            vim_free (fg);
            vim_free (bg);
            vim_free (tooltip);
            vim_free (glyphFile);
        ...
        else if ((strcmp ((char *) cmd, "addAnno") == 0)) {
            int serNum;
            int localTypeNum;
            int typeNum;
            pos_T * pos;
            ...
            if (pos) {
                ...
                if (typeNum == curPCtype) coloncmd (":sign jump %d buffer=%d", serNum, buf -> bufp -> b_fnum);
            }
        }
        else if ((strcmp ((char *) cmd, "removeAnno") == 0)) {
            int serNum;
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
                return 0;
            ...
            redraw_buf_later (buf -> bufp, 40);
        }
        else if ((strcmp ((char *) cmd, "moveAnnoToFront") == 0)) {
            ;
        }
        else if ((strcmp ((char *) cmd, "guard") == 0) || (strcmp ((char *) cmd, "unguard") == 0)) {
            int len;
            pos_T first;
            pos_T last;
            pos_T * pos;
            int un = (cmd [0] == 'u');
            static int guardId = 1000000;
            if (skip >= 2) {
                ;
                return 1;
            }
                ...
                if (!pos);
                    ...
                    for (lnum = first.lnum; lnum <= last.lnum; lnum ++) {
                        if (un) {
                            ...
                            if (buf_findsigntype_id (buf -> bufp, lnum, 10000) == 0) {
                                coloncmd (":sign place %d line=%ld name=%d buffer=%d", guardId ++, lnum, 10000, buf -> bufp -> b_fnum);
                            }
                        }
                    }
                    redraw_buf_later (buf -> bufp, 40);
        ...
        else if ((strcmp ((char *) cmd, "startAtomic") == 0)) {
            inAtomic = 1;
        }
        else if ((strcmp ((char *) cmd, "endAtomic") == 0)) {
            inAtomic = 0;
            if (needupdate) {
                doupdate = 1;
                needupdate = 0;
        ...
        else if ((strcmp ((char *) cmd, "save") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
                return 0;
            }
            if (bufIsChanged (buf -> bufp)) {
                if (p_write && !buf->bufp->b_p_ro && buf -> bufp -> b_ffname != ((void *) 0) && !bt_dontwrite(buf->bufp)) {
                    buf_write_all (buf -> bufp, 0);
                    if (!buf_valid(buf->bufp)) buf -> bufp = ((void *) 0);
                }
            }
            else {
                ;
        ...
        else if ((strcmp ((char *) cmd, "netbeansBuffer") == 0)) {
            if (buf == ((void *) 0) || buf -> bufp == ((void *) 0)) {
                ;
                return 0;
            }
            if (*args == 'T') {
                buf -> bufp -> b_netbeans_file = 1;
                buf -> bufp -> b_was_netbeans_file = 1;
            }
            else buf -> bufp -> b_netbeans_file = 0;
        }
        else if ((strcmp ((char *) cmd, "specialKeys") == 0)) {
            special_keys (args);
        }
        else if ((strcmp ((char *) cmd, "actionMenuItem") == 0)) {
        }
        else if ((strcmp ((char *) cmd, "version") == 0)) {
        }
        else {
            ;
        }
    ...
    if (buf != ((void *) 0) && buf -> initDone && doupdate) {
        update_screen (40);
        setcursor ();
        out_flush ();
        if (State == (0x200 + 0x01) || State == 0x300) {
...
static void nb_set_curbuf (buf_T * buf) {
    if (curbuf != buf && buf_jump_open_win (buf) == ((void *) 0)) set_curbuf (buf, 0);
}
...
static void coloncmd (char * cmd,...) {
    ...
    vim_vsnprintf (buf, sizeof (buf), cmd, ap, ((void *) 0));
    __builtin_va_end (ap);
    ;
    do_cmdline ((char_u *) buf, ((void *) 0), ((void *) 0), 0x02 | 0x08);
    setcursor ();
    out_flush ();
}

static void special_keys (char_u * args) {
    char * save_str = nb_unquote (args, ((void *) 0));
    ...
    while (tok != ((void *) 0)) {
        ...
        ((__builtin_object_size (&keybuf[i], 0) != (size_t) - 1) ? __builtin___strcpy_chk (&keybuf[i], tok, __builtin_object_size (&keybuf[i], 1 > 1)) :
          __inline_strcpy_chk (&keybuf[i], tok));
        vim_snprintf (cmdbuf, sizeof (cmdbuf), "<silent><%s> :nbkey %s<CR>", keybuf, keybuf);
        do_map (0, (char_u *) cmdbuf, 0x01, 0);
        tok = strtok (((void *) 0), " ");
    }
    vim_free (save_str);
}
...
static void nb_init_graphics (void) {
    ...
    if (!did_init) {
        ...
        coloncmd (":sign define %d linehl=NBGuarded", 10000);
        did_init = 1;
    }
}
...
static void netbeans_keyname (int key, char * buf) {
    ...
    int shift = 0;
    int alt = 0;
    if (mod_mask & 0x04) ctrl = 1;
    if (mod_mask & 0x02) shift = 1;
    if (mod_mask & 0x08) alt = 1;
    switch (key) {
    case (-(('k')+((int)('1')<<8))) :
        name = "F1";
        break;
    ...
    buf [0] = '\0';
    if (ctrl) ((__builtin_object_size (buf, 0) != (size_t) - 1) ? __builtin___strcat_chk (buf, "C", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (
      buf, "C"));
    if (shift) ((__builtin_object_size (buf, 0) != (size_t) - 1) ? __builtin___strcat_chk (buf, "S", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (
      buf, "S"));
    if (alt) ((__builtin_object_size (buf, 0) != (size_t) - 1) ? __builtin___strcat_chk (buf, "M", __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (
      buf, "M"));
    if (ctrl || shift || alt) ((__builtin_object_size (buf, 0) != (size_t) - 1) ? __builtin___strcat_chk (buf, "-", __builtin_object_size (buf, 1 > 1)) :
      __inline_strcat_chk (buf, "-"));
    ((__builtin_object_size (buf, 0) != (size_t) - 1) ? __builtin___strcat_chk (buf, name, __builtin_object_size (buf, 1 > 1)) : __inline_strcat_chk (buf, name
      ));
}
...
void netbeans_open (char * params, int doabort) {
    ...
    if ((nbsock != -1)) {
        emsg ((char_u *) (((char *) ("E511: netbeans already connected"))));
        return;
    }
    if (netbeans_connect (params, doabort) != 1) return;
    ;
...
void netbeans_send_disconnect () {
    char buf [128];
    if ((nbsock != -1)) {
        __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "0:disconnect=%d\n", r_cmdno);
        ;
...
void netbeans_file_activated (buf_T * bufp) {
    ...
    char buffer [2 * 1024];
    char_u * q;
    if (!(nbsock!=-1) || !bufp->b_netbeans_file || dosetvisible) return;
    q = nb_quote (bufp -> b_ffname);
    if (q == ((void *) 0) || bp == ((void *) 0)) return;
...
void netbeans_file_opened (buf_T * bufp) {
    ...
    q = nb_quote (bufp -> b_ffname);
    if (q == ((void *) 0)) return;
    if (bp != ((void *) 0)) bnum = bufno;
    else bnum = 0;
    vim_snprintf (buffer, sizeof (buffer), "%d:fileOpened=%d \"%s\" %s %s\n", bnum, 0, (char *) q, "T", "F");
    vim_free (q);
    ;
    nb_send (buffer, "netbeans_file_opened");
    if (p_acd && vim_chdirfile (bufp -> b_ffname) == 1) shorten_fnames (1);
}
...
void netbeans_file_killed (buf_T * bufp) {
    ...
    char buffer [2 * 1024];
    if (!(nbsock!=-1) || bufno == -1) return;
    ;
    ;
    __builtin___sprintf_chk (buffer, 0, __builtin_object_size (buffer, 1 > 1), "%d:killed=%d\n", bufno, r_cmdno);
    ;
    nb_send (buffer, "netbeans_file_killed");
    if (nbbuf != ((void *) 0)) nbbuf -> bufp = ((void *) 0);
}

static nbbuf_T * nb_bufp2nbbuf_fire (buf_T * bufp, int * bufnop) {
    int bufno;
    nbbuf_T * nbbuf;
    if (!(nbsock!=-1) || !netbeansFireChanges) return ((void *) 0);
    bufno = nb_getbufno (bufp);
    if (bufno <= 0) return ((void *) 0);
    nbbuf = nb_get_buf (bufno);
    if (nbbuf != ((void *) 0) && !nbbuf->fireChanges) return ((void *) 0);
    * bufnop = bufno;
    return nbbuf;
}
...
void netbeans_inserted (buf_T * bufp, linenr_T linenr, colnr_T col, char_u * txt, int newlen) {
    ...
    if (nbbuf == ((void *) 0)) return;
    if (nbbuf -> insertDone) nbbuf -> modified = 1;
    pos.lnum = linenr;
    pos.col = col;
    ...
    if (p != ((void *) 0)) {
        ...
        __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "%d:insert=%d %ld \"%s\"\n", bufno, r_cmdno, off, p);
        ;
...
void netbeans_removed (buf_T * bufp, linenr_T linenr, colnr_T col, long len) {
    ...
    pos.col = col;
    off = pos2off (bufp, &pos);
    __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "%d:remove=%d %ld %ld\n", bufno, r_cmdno, off, len);
    ;
    nb_send ((char *) buf, "netbeans_removed");
}

void netbeans_unmodified (buf_T * bufp __attribute__ ((unused))) {
}
...
void netbeans_button_release (int button) {
    ...
    if (bufno >= 0 && curwin != ((void *) 0) && curwin -> w_buffer == curbuf) {
        int col = mouse_col - (curwin -> w_wincol) - ((curwin -> w_onebuf_opt.wo_nu || curwin -> w_onebuf_opt.wo_rnu) ? 9 : 1);
        long off = pos2off (curbuf, &curwin->w_cursor);
        __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%d:newDotAndMark=%d %ld %ld\n", bufno, r_cmdno, off, off);
        ;
        nb_send (buf, "netbeans_button_release[newDotAndMark]");
        __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%d:buttonRelease=%d %d %ld %d\n", bufno, r_cmdno, button, (long) curwin ->
          w_cursor.lnum, col);
        ;
...
static int netbeans_keystring (char_u * keyName) {
    ...
    long off;
    char_u * q;
    if (!(nbsock!=-1)) return 1;
    if (bufno == -1) {
        ;
        q = curbuf -> b_ffname == ((void *) 0) ? (char_u *) "" : nb_quote (curbuf -> b_ffname);
        if (q == ((void *) 0)) return 1;
        vim_snprintf (buf, sizeof (buf), "0:fileOpened=%d \"%s\" %s %s\n", 0, q, "T", "F");
        if (curbuf -> b_ffname != ((void *) 0)) vim_free (q);
        ;
    ...
    ;
    nb_send (buf, "netbeans_keycommand");
    vim_snprintf (buf, sizeof (buf), "%d:keyAtPos=%d \"%s\" %ld %ld/%ld\n", bufno, r_cmdno, keyName, off, (long) curwin -> w_cursor.lnum, (long) curwin ->
      w_cursor.col);
    ;
    nb_send (buf, "netbeans_keycommand");
    return 1;
...
void netbeans_save_buffer (buf_T * bufp) {
    ...
    if (nbbuf == ((void *) 0)) return;
    nbbuf -> modified = 0;
    __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "%d:save=%d\n", bufno, r_cmdno);
    ;
...
void netbeans_deleted_all_lines (buf_T * bufp) {
    ...
    if (nbbuf == ((void *) 0)) return;
    if (nbbuf -> insertDone) nbbuf -> modified = 1;
    __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "%d:remove=%d 0 -1\n", bufno, r_cmdno);
    ;
}
...
int netbeans_is_guarded (linenr_T top, linenr_T bot) {
    signlist_T * p;
    int lnum;
    if (!(nbsock!=-1)) return 0;
    for (p = curbuf -> b_signlist; p != ((void *) 0); p = p -> next) if (p -> id >= 1000000) for (lnum = top + 1; lnum < bot; lnum ++) if (lnum == p -> lnum)
      return 1;
    return 0;
}
...
void netbeans_gutter_click (linenr_T lnum) {
    signlist_T * p;
    if (!(nbsock!=-1)) return;
    for (p = curbuf -> b_signlist; p != ((void *) 0); p = p -> next) {
        if (p -> lnum == lnum && p -> next && p -> next -> lnum == lnum) {
            signlist_T * tail;
            if (p -> prev) p -> prev -> next = p -> next;
            else curbuf -> b_signlist = p -> next;
            p -> next -> prev = p -> prev;
            for (tail = p -> next; tail -> next && tail -> next -> lnum == lnum && tail -> next -> id < 1000000; tail = tail -> next);
            p -> next = tail -> next;
            if (tail -> next) tail -> next -> prev = p;
            p -> prev = tail;
            tail -> next = p;
...
static void addsigntype (nbbuf_T * buf, int typeNum, char_u * typeName, char_u * tooltip __attribute__ ((unused)), char_u * glyphFile, char_u * fg, char_u * bg
  ) {
    int i, j;
    int use_fg = (*fg && strcmp ((char *) (fg), (char *) ("none")) != 0);
    int use_bg = (*bg && strcmp ((char *) (bg), (char *) ("none")) != 0);
    for (i = 0; i < globalsignmapused; i ++) if (strcmp ((char *) (typeName), (char *) (globalsignmap [i])) == 0) break;
    if (i == globalsignmapused) {
        ...
        if (use_fg || use_bg) {
            ...
            if (ptr != (char *) fg) __builtin___sprintf_chk (fgbuf, 0, __builtin_object_size (fgbuf, 1 > 1), "guifg=#%06x", value & 0xFFFFFF);
            else __builtin___sprintf_chk (fgbuf, 0, __builtin_object_size (fgbuf, 1 > 1), "guifg=%s ctermfg=%s", fg, fg);
            value = strtol ((char *) bg, &ptr, 10);
            if (ptr != (char *) bg) __builtin___sprintf_chk (bgbuf, 0, __builtin_object_size (bgbuf, 1 > 1), "guibg=#%06x", value & 0xFFFFFF);
            else __builtin___sprintf_chk (bgbuf, 0, __builtin_object_size (bgbuf, 1 > 1), "guibg=%s ctermbg=%s", bg, bg);
            coloncmd (":highlight NB_%s %s %s", typeName, (use_fg) ? fgbuf : "", (use_bg) ? bgbuf : "");
            if (*glyphFile == '\000') coloncmd (":sign define %d linehl=NB_%s", i + 1, typeName);
            else if (vim_strsize (glyphFile) <= 2) coloncmd (":sign define %d text=%s texthl=NB_%s", i + 1, glyphFile, typeName);
            else coloncmd (":sign define %d icon=%s linehl=NB_%s", i + 1, glyphFile, typeName);
        }
        else coloncmd (":sign define %d icon=%s", i + 1, glyphFile);
        if (strcmp ((char *) (typeName), (char *) ("CurrentPC")) == 0) curPCtype = typeNum;
        if (globalsignmapused == globalsignmaplen) {
            if (globalsignmaplen == 0) {
                ...
                globalsignmap = (char * *) realloc ((globalsignmap), (globalsignmaplen * sizeof (char *)));
                ((__builtin_object_size ((globalsignmap + oldlen), 0) != (size_t) - 1) ? __builtin___memset_chk ((globalsignmap + oldlen), (0), (incr * sizeof (
                  char *)), __builtin_object_size ((globalsignmap + oldlen), 0)) : __inline_memset_chk ((globalsignmap + oldlen), (0), (incr * sizeof (char *))
                  ));
            }
        }
    ...
    for (j = 0; j < buf -> signmapused; j ++) if (buf -> signmap [j] == i + 1) return;
    if (buf -> signmapused == buf -> signmaplen) {
        if (buf -> signmaplen == 0) {
            ...
            buf -> signmap = (int *) realloc ((buf -> signmap), (buf -> signmaplen * sizeof (int)));
            ((__builtin_object_size ((buf -> signmap + oldlen), 0) != (size_t) - 1) ? __builtin___memset_chk ((buf -> signmap + oldlen), (0), (incr * sizeof (
              int)), __builtin_object_size ((buf -> signmap + oldlen), 0)) : __inline_memset_chk ((buf -> signmap + oldlen), (0), (incr * sizeof (int))));
        }
    }
...
static int mapsigntype (nbbuf_T * buf, int localsigntype) {
    if (--localsigntype >= 0 && localsigntype < buf -> signmapused) return buf -> signmap [localsigntype];
    return 0;
}
...
static long get_buf_size (buf_T * bufp) {
    ...
    if (bufp -> b_ml.ml_flags & 1) return 0;
    else {
        if (get_fileformat (bufp) == 1) eol_size = 2;
        else eol_size = 1;
        for (lnum = 1; lnum <= bufp -> b_ml.ml_line_count; ++lnum) {
            char_count += (long) strlen ((char *) (ml_get_buf (bufp, lnum, 0))) + eol_size;
            if (char_count > last_check) {
                ui_breakcheck ();
                if (got_int) return char_count;
                last_check = char_count + 100000L;
            }
        }
        if (!bufp->b_p_eol && bufp -> b_p_bin) char_count -= eol_size;
    }
    return char_count;
}
...
static pos_T * off2pos (buf_T * buf, long offset) {
    ...
    if (!(buf->b_ml.ml_flags&1)) {
        if ((lnum = ml_find_line_or_offset (buf, (linenr_T) 0, &offset)) < 0) return ((void *) 0);
        pos.lnum = lnum;
        pos.col = offset;
    }
    return &pos;
...
static long pos2off (buf_T * buf, pos_T * pos) {
    long offset = 0;
    if (!(buf->b_ml.ml_flags&1)) {
        if ((offset = ml_find_line_or_offset (buf, pos -> lnum, 0)) < 0) return 0;
        offset += pos -> col;
    }
    return offset;
}

static void print_read_msg (buf)
    nbbuf_T * buf;
{
    ...
    if (!buf->bufp->b_start_eol) {
        ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (IObuff), (char *) (shortmess ('i') ? ((char *) (
          "[noeol]")) : ((char *) ("[Incomplete last line]"))), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcat_chk ((char *) (IObuff), (
          char *) (shortmess ('i') ? ((char *) ("[noeol]")) : ((char *) ("[Incomplete last line]")))));
        c = 1;
    }
    ...
    keep_msg = ((void *) 0);
    msg_scrolled_ign = 1;
    msg_trunc_attr (IObuff, 0, 0);
    msg_scrolled_ign = 0;
}

static void print_save_msg (buf, nchars)
    nbbuf_T * buf;
    off_t nchars;
{
    char_u c;
    ...
    if (nchars >= 0) {
        ...
        char_u ebuf [1024];
        ((__builtin_object_size ((char *) (ebuf), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ebuf), (char *) ((char_u *) ((char *) ("E505: "))),
          __builtin_object_size ((char *) (ebuf), 1 > 1)) : __inline_strcpy_chk ((char *) (ebuf), (char *) ((char_u *) ((char *) ("E505: ")))));
        ((__builtin_object_size ((char *) (ebuf), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (ebuf), (char *) (IObuff), __builtin_object_size ((
          char *) (ebuf), 1 > 1)) : __inline_strcat_chk ((char *) (ebuf), (char *) (IObuff)));
        ((__builtin_object_size ((char *) (ebuf), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (ebuf), (char *) ((char_u *) ((char *) (
          "is read-only (add ! to override)"))), __builtin_object_size ((char *) (ebuf), 1 > 1)) : __inline_strcat_chk ((char *) (ebuf), (char *) ((char_u *) (
          (char *) ("is read-only (add ! to override)")))));
        ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) (ebuf), __builtin_object_size ((
          char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) (ebuf)));
        ;
        emsg (IObuff);
    }
}

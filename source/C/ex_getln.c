...
static int in_history (int, char_u *, int);
...
static int nextwild (expand_T * xp, int type, int options);
    ...
    int indent;
{
    ...
    if (ccline.cmdbuff == ((void *) 0)) return ((void *) 0);
    ...
    if (firstc == '/' || firstc == '?' || firstc == '@') {
        if (curbuf -> b_p_imsearch == -1) b_im_ptr = &curbuf->b_p_iminsert;
        else b_im_ptr = &curbuf->b_p_imsearch;
        if (*b_im_ptr == 1) State |= 0x20;
    }
    setmouse ();
    ui_cursor_shape ();
    settmode (2);
    ...
    for (;;) {
        ...
        if ((c == 3 || c == intr_char) && firstc != '@' && !break_ctrl_c && !global_busy) got_int = 0;
        if (lookfor != ((void *) 0) && c != (-((253)+((int)(KE_S_DOWN)<<8))) && c != (-((253)+((int)(KE_S_UP)<<8))) && c != (-(('k')+((int)('d')<<8))) && c != (
          -(('k')+((int)('u')<<8))) && c != (-(('k')+((int)('N')<<8))) && c != (-(('k')+((int)('P')<<8))) && c != (-(('K')+((int)('5')<<8))) && c != 
          (-(('K')+((int)('3')<<8))) && c != (-(('k')+((int)('l')<<8))) && c != (-(('k')+((int)('r')<<8))) && (xpc.xp_numfiles > 0 || (c != 16 && c != 14))) {
            vim_free (lookfor);
            lookfor = ((void *) 0);
        }
        if (c != p_wc && c == (-(('k')+((int)('B')<<8))) && xpc.xp_numfiles > 0) c = 16;
        if (did_wild_list && p_wmnu) {
            if (c == (-(('k')+((int)('l')<<8)))) c = 16;
            else if (c == (-(('k')+((int)('r')<<8)))) c = 14;
        }
        if (xpc.xp_context == 21 && p_wmnu && ccline.cmdpos > 1 && ccline.cmdbuff [ccline.cmdpos - 1] == '.' && ccline.cmdbuff [ccline.cmdpos - 2] != '\\' && (
          c == '\n' || c == '\r' || c == (-(('K')+((int)('A')<<8))))) c = (-(('k')+((int)('d')<<8)));
        if (xpc.xp_numfiles != -1 && !(c==p_wc&&KeyTyped) && c != p_wcm && c != 14 && c != 16 && c != 1 && c != 12) {
            (void) ExpandOne (&xpc, ((void *) 0), ((void *) 0), 0, 1);
            did_wild_list = 0;
            if (!p_wmnu || (c != (-(('k')+((int)('u')<<8))) && c != (-(('k')+((int)('d')<<8))))) xpc.xp_context = 0;
            wim_index = 0;
            if (p_wmnu && wild_menu_showing != 0) {
                int skt = KeyTyped;
                int old_RedrawingDisabled = RedrawingDisabled;
                if (ccline.input_fn) RedrawingDisabled = 0;
        ...
        if (xpc.xp_context == 21 && p_wmnu) {
            if (c == (-(('k')+((int)('d')<<8))) && ccline.cmdpos > 0 && ccline.cmdbuff [ccline.cmdpos - 1] == '.') c = p_wc;
            else if (c == (-(('k')+((int)('u')<<8)))) {
                int found = 0;
                ...
                if (i > 0) cmdline_del (i);
                c = p_wc;
                xpc.xp_context = 0;
            }
        }
        if ((xpc.xp_context == 2 || xpc.xp_context == 3 || xpc.xp_context == 32) && p_wmnu) {
            char_u upseg [5];
            upseg [0] = '/';
            upseg [1] = '.';
            upseg [2] = '.';
            upseg [3] = '/';
            upseg [4] = '\000';
            if (c == (-(('k')+((int)('d')<<8))) && ccline.cmdpos > 0 && ccline.cmdbuff [ccline.cmdpos - 1] == '/' && (ccline.cmdpos < 3 || ccline.cmdbuff [
              ccline.cmdpos - 2] != '.' || ccline.cmdbuff [ccline.cmdpos - 3] != '.')) {
                c = p_wc;
            }
                ...
                if (!found) j = i;
                else if (strncmp ((char *) (ccline.cmdbuff + j), (char *) (upseg), (size_t) (4)) == 0) j += 4;
                else if (strncmp ((char *) (ccline.cmdbuff + j), (char *) (upseg + 1), (size_t) (3)) == 0 && j == i) j += 3;
                else j = 0;
                if (j > 0) {
                    cmdline_del (j);
                    put_on_cmdline (upseg + 1, 3, 0);
                }
                else if (ccline.cmdpos > i) cmdline_del (i);
                c = p_wc;
            }
        }
        if (c == 28) {
            ...
            --no_mapping;
            --allow_keys;
            if (c != 14 && c != 7 && (c != 'e' || ccline.cmdfirstc == '=')) {
                vungetc (c);
                c = 28;
            }
            else if (c == 'e') {
                char_u * p = ((void *) 0);
                int len;
                if (ccline.cmdpos == ccline.cmdlen) new_cmdpos = 99999;
                ...
                if (c == '=') {
                    ...
                    if (p != ((void *) 0) && realloc_cmdbuff (len + 1) == 1) {
                        ccline.cmdlen = len;
                        ((__builtin_object_size ((char *) (ccline.cmdbuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ccline.cmdbuff), (char *) (
                          p), __builtin_object_size ((char *) (ccline.cmdbuff), 1 > 1)) : __inline_strcpy_chk ((char *) (ccline.cmdbuff), (char *) (p)));
                        vim_free (p);
                        if (new_cmdpos > ccline.cmdlen) ccline.cmdpos = ccline.cmdlen;
                ...
                if (c == 7 && p_im && restart_edit == 0) restart_edit = 'a';
                gotesc = 1;
                goto returncmd;
            }
        }
        ...
        if (c == '\n' || c == '\r' || c == (-(('K')+((int)('A')<<8))) || (c == '\033' && (!KeyTyped || vim_strchr (p_cpo, 'x') != ((void *) 0)))) {
            if (exmode_active && c != '\033' && ccline.cmdpos == ccline.cmdlen && ccline.cmdpos > 0 && ccline.cmdbuff [ccline.cmdpos - 1] == '\\') {
                if (c == (-(('K')+((int)('A')<<8)))) c = '\n';
            }
            else {
                gotesc = 0;
                if (ccheck_abbr (c + 0x100)) goto cmdline_changed;
                if (!cmd_silent) {
                    windgoto (msg_row, 0);
                    out_flush ();
                }
        ...
        if ((c == p_wc && !gotesc && KeyTyped) || c == p_wcm) {
            if (xpc.xp_numfiles > 0) {
                if (xpc.xp_numfiles > 1 && !did_wild_list && (wim_flags [wim_index] & 4)) {
                    (void) showmatches (&xpc, 0);
                    redrawcmd ();
                    did_wild_list = 1;
                }
                if (wim_flags [wim_index] & 2) res = nextwild (&xpc, 7, 8);
                else if (wim_flags [wim_index] & 1) res = nextwild (&xpc, 4, 8);
                else res = 1;
            }
            else {
                wim_index = 0;
                j = ccline.cmdpos;
                if (wim_flags [0] & 2) res = nextwild (&xpc, 7, 8);
                else res = nextwild (&xpc, 3, 8);
                if (got_int) {
                    (void) vpeekc ();
                    got_int = 0;
                    (void) ExpandOne (&xpc, ((void *) 0), ((void *) 0), 0, 1);
                ...
                if (res == 1 && xpc.xp_numfiles > 1) {
                    if (wim_flags [0] == 2 && ccline.cmdpos == j) wim_index = 1;
                    if ((wim_flags [wim_index] & 4) || (p_wmnu && (wim_flags [wim_index] & 1) != 0)) {
                        if (!(wim_flags[0]&2)) {
                        ...
                        (void) showmatches (&xpc, p_wmnu && ((wim_flags [wim_index] & 4) == 0));
                        redrawcmd ();
                        did_wild_list = 1;
                        if (wim_flags [wim_index] & 2) nextwild (&xpc, 7, 8);
                        else if (wim_flags [wim_index] & 1) nextwild (&xpc, 4, 8);
                    }
                    else vim_beep ();
                }
                else if (xpc.xp_numfiles == -1) xpc.xp_context = 0;
            }
            if (wim_index < 3) ++wim_index;
            if (c == '\033') gotesc = 1;
            if (res == 1) goto cmdline_changed;
        }
        gotesc = 0;
        if (c == (-(('k')+((int)('B')<<8))) && KeyTyped) {
            if (nextwild (&xpc, 3, 0) == 1 && nextwild (&xpc, 5, 0) == 1 && nextwild (&xpc, 5, 0) == 1) goto cmdline_changed;
        }
        if (c == '\000' || c == (-((255)+((int)(('X'))<<8)))) c = '\012';
        do_abbr = 1;
        switch (c) {
        case (-(('k')+((int)('b')<<8))) :
        case 8 :
        ...
        case 23 :
            if (c == (-((253)+((int)(KE_KDEL)<<8)))) c = (-(('k')+((int)('D')<<8)));
            if (c == (-(('k')+((int)('D')<<8))) && ccline.cmdpos != ccline.cmdlen) ++ccline.cmdpos;
            if (ccline.cmdpos > 0) {
                char_u * p;
                j = ccline.cmdpos;
                p = ccline.cmdbuff + j;
                if (c == 23) {
                    while (p > ccline.cmdbuff && vim_isspace (p [-1])) --p;
                    i = vim_iswordc (p [-1]);
                    while (p > ccline.cmdbuff && !vim_isspace(p[-1]) && vim_iswordc (p [-1]) == i) --p;
                }
                else --p;
                ccline.cmdpos = (int) (p - ccline.cmdbuff);
                ccline.cmdlen -= j - ccline.cmdpos;
                i = ccline.cmdpos;
                while (i < ccline.cmdlen) ccline.cmdbuff [i ++] = ccline.cmdbuff [j ++];
                ccline.cmdbuff [ccline.cmdlen] = '\000';
                redrawcmd ();
            }
            else if (ccline.cmdlen == 0 && c != 23 && ccline.cmdprompt == ((void *) 0) && indent == 0) {
                if (exmode_active || ccline.cmdfirstc == '>') goto cmdline_not_changed;
        ...
        case 30 :
            if (map_to_exists_mode ((char_u *) "", 0x20, 0)) {
                State ^= 0x20;
                if (b_im_ptr != ((void *) 0)) {
                    if (State & 0x20) *b_im_ptr = 1;
                    else *b_im_ptr = 0;
                }
            }
            if (b_im_ptr != ((void *) 0)) {
                if (b_im_ptr == &curbuf->b_p_iminsert) set_iminsert_global ();
        ...
        case 21 :
            ...
            goto cmdline_changed;
        case 25 :
            if (clip_star.state != 0) {
                if (clip_star.state == 2) clip_copy_modeless_selection (1);
                goto cmdline_not_changed;
            }
            break;
        case '\033' :
        case 3 :
            if (exmode_active && (ex_normal_busy == 0 || typebuf.tb_len > 0)) goto cmdline_not_changed;
            gotesc = 1;
            goto returncmd;
        case 18 :
            putcmdline ('"', 1);
        ...
        case (-((253)+((int)(KE_C_RIGHT)<<8))) :
            do {
                if (ccline.cmdpos >= ccline.cmdlen) break;
                i = cmdline_charsize (ccline.cmdpos);
                if (KeyTyped && ccline.cmdspos + i >= Columns * Rows) break;
                ccline.cmdspos += i;
                ++ccline.cmdpos;
            }
            while ((c == (-(('%')+((int)('i')<<8))) || c == (-((253)+((int)(KE_C_RIGHT)<<8))) || (mod_mask & (0x02 | 0x04))) && ccline.cmdbuff [ccline.cmdpos]
              != ' ');
            goto cmdline_not_changed;
        case (-(('k')+((int)('l')<<8))) :
        case (-(('#')+((int)('4')<<8))) :
        case (-((253)+((int)(KE_C_LEFT)<<8))) :
            if (ccline.cmdpos == 0) goto cmdline_not_changed;
            do {
                --ccline.cmdpos;
                ccline.cmdspos -= cmdline_charsize (ccline.cmdpos);
            }
            while (ccline.cmdpos > 0 && (c == (-(('#')+((int)('4')<<8))) || c == (-((253)+((int)(KE_C_LEFT)<<8))) || (mod_mask & (0x02 | 0x04))) && ccline.
              cmdbuff [ccline.cmdpos - 1] != ' ');
            goto cmdline_not_changed;
        ...
        case (-((253)+((int)(KE_MIDDLEMOUSE)<<8))) :
            if (!mouse_has('c')) goto cmdline_not_changed;
            if (clip_star.available) cmdline_paste ('*', 1, 1);
            else cmdline_paste (0, 1, 1);
            redrawcmd ();
            goto cmdline_changed;
        ...
        case (-((253)+((int)(KE_RIGHTRELEASE)<<8))) :
            if (ignore_drag_release) goto cmdline_not_changed;
        case (-((253)+((int)(KE_LEFTMOUSE)<<8))) :
        case (-((253)+((int)(KE_RIGHTMOUSE)<<8))) :
            if (c == (-((253)+((int)(KE_LEFTRELEASE)<<8))) || c == (-((253)+((int)(KE_RIGHTRELEASE)<<8)))) ignore_drag_release = 1;
            else ignore_drag_release = 0;
            if (!mouse_has('c')) goto cmdline_not_changed;
            if (mouse_row < cmdline_row && clip_star.available) {
                int button, is_click, is_drag;
                button = get_mouse_button ((((unsigned) (-(c)) >> 8) & 0xff), &is_click, &is_drag);
                if (mouse_model_popup () && button == 0x00 && (mod_mask & 0x02)) {
                    button = 0x02;
                    mod_mask &= ~0x02;
                }
            ...
            for (ccline.cmdpos = 0; ccline.cmdpos < ccline.cmdlen; ++ccline.cmdpos) {
                i = cmdline_charsize (ccline.cmdpos);
                if (mouse_row <= cmdline_row + ccline.cmdspos / Columns && mouse_col < ccline.cmdspos % Columns + i) break;
                ccline.cmdspos += i;
            }
            goto cmdline_not_changed;
        ...
        case (-((253)+((int)(KE_C_END)<<8))) :
            ...
            goto cmdline_not_changed;
        case 1 :
            if (nextwild (&xpc, 6, 0) == 0) break;
            goto cmdline_changed;
        case 12 :
            if (p_is && !cmd_silent && (firstc == '/' || firstc == '?')) {
                if (did_incsearch && !(((curwin->w_cursor).lnum==(old_cursor).lnum)&&((curwin->w_cursor).col==(old_cursor).col)&&((curwin->w_cursor).coladd==(
                  old_cursor).coladd))) {
                    c = gchar_cursor ();
                    if (p_ic && p_scs && !pat_has_uppercase(ccline.cmdbuff)) c = tolower (c);
                    if (c != '\000') {
                        if (c == firstc || vim_strchr ((char_u *) (p_magic ? "\\^$.*[" : "\\^$"), c) != ((void *) 0)) {
                            stuffcharReadbuff (c);
                            c = '\\';
                        }
                        break;
            ...
            if (nextwild (&xpc, 7, 0) == 0) break;
            goto cmdline_changed;
        case 14 :
        case 16 :
            if (xpc.xp_numfiles > 0) {
                if (nextwild (&xpc, (c == 16) ? 5 : 4, 0) == 0) break;
                goto cmdline_changed;
            }
        case (-(('k')+((int)('u')<<8))) :
        case (-(('k')+((int)('d')<<8))) :
        ...
        case (-(('k')+((int)('N')<<8))) :
        case (-(('K')+((int)('5')<<8))) :
            if (hislen == 0 || firstc == '\000') goto cmdline_not_changed;
            i = hiscnt;
            if (lookfor == ((void *) 0)) {
                if ((lookfor = vim_strsave (ccline.cmdbuff)) == ((void *) 0)) goto cmdline_not_changed;
                lookfor [ccline.cmdpos] = '\000';
            }
            j = (int) strlen ((char *) (lookfor));
            for (;;) {
                if (c == (-(('k')+((int)('u')<<8))) || c == (-((253)+((int)(KE_S_UP)<<8))) || c == 16 || c == (-(('k')+((int)('P')<<8))) || c == 
                  (-(('K')+((int)('3')<<8)))) {
                    if (hiscnt == hislen) hiscnt = hisidx [histype];
                    else if (hiscnt == 0 && hisidx [histype] != hislen - 1) hiscnt = hislen - 1;
                    else if (hiscnt != hisidx [histype] + 1) --hiscnt;
                    else {
                        hiscnt = i;
                        break;
                    }
                    ...
                    if (hiscnt == hislen) break;
                    if (hiscnt == hislen - 1) hiscnt = 0;
                    else ++hiscnt;
                }
                ...
                if ((c != (-(('k')+((int)('u')<<8))) && c != (-(('k')+((int)('d')<<8)))) || hiscnt == i || strncmp ((char *) (history [histype] [hiscnt].hisstr
                  ), (char *) (lookfor), (size_t) ((size_t) j)) == 0) break;
            }
            if (hiscnt != i) {
                char_u * p;
                int len;
                ...
                vim_free (ccline.cmdbuff);
                xpc.xp_context = 0;
                if (hiscnt == hislen) p = lookfor;
                else p = history [histype] [hiscnt].hisstr;
                if (histype == 1 && p != lookfor && (old_firstc = p [strlen ((char *) (p)) + 1]) != firstc) {
                    for (i = 0; i <= 1; ++i) {
                        len = 0;
                        for (j = 0; p [j] != '\000'; ++j) {
                            if (p [j] == old_firstc && (j == 0 || p [j - 1] != '\\')) {
                                if (i > 0) ccline.cmdbuff [len] = firstc;
                            }
                            else {
                                if (p [j] == firstc && (j == 0 || p [j - 1] != '\\')) {
                                    if (i > 0) ccline.cmdbuff [len] = '\\';
                                    ++len;
                                }
                                if (i > 0) ccline.cmdbuff [len] = p [j];
                            }
                            ++len;
                        }
                        if (i == 0) {
                            alloc_cmdbuff (len);
                            if (ccline.cmdbuff == ((void *) 0)) goto returncmd;
                        }
                    }
                    ...
                    if (ccline.cmdbuff == ((void *) 0)) goto returncmd;
                    ((__builtin_object_size ((char *) (ccline.cmdbuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (ccline.cmdbuff), (char *) (p),
                      __builtin_object_size ((char *) (ccline.cmdbuff), 1 > 1)) : __inline_strcpy_chk ((char *) (ccline.cmdbuff), (char *) (p)));
                }
        ...
        if (do_abbr && (((c) < 0) || !vim_iswordc(c)) && ccheck_abbr (c)) goto cmdline_changed;
        if (((c) < 0) || mod_mask != 0) put_on_cmdline (get_special_key_name (c, mod_mask), -1, 1);
        else {
            {
                IObuff [0] = c;
        ...
        goto cmdline_changed;
        cmdline_not_changed : if (!incsearch_postponed) continue;
        cmdline_changed : if (p_is && !cmd_silent && (firstc == '/' || firstc == '?')) {
            pos_T end_pos;
            proftime_T tm;
            if (char_avail ()) {
            ...
            if (ccline.cmdlen == 0) i = 0;
            else {
                cursor_off ();
                out_flush ();
                ++emsg_off;
                profile_setlimit (500L, &tm);
                i = do_search (((void *) 0), firstc, ccline.cmdbuff, count, 0x400 + 0x10 + 0x80 + 0x800, &tm);
                --emsg_off;
                if (got_int) {
                    (void) vpeekc ();
                    got_int = 0;
                ...
                else if (char_avail ()) incsearch_postponed = 1;
            }
            if (i != 0) highlight_match = 1;
            else highlight_match = 0;
            ...
            validate_cursor ();
            if (p_ru && curwin -> w_status_height > 0) curwin -> w_redr_status = 1;
            save_cmdline (&save_ccline);
            update_screen (35);
            restore_cmdline (&save_ccline);
            if (i != 0) curwin -> w_cursor = end_pos;
            msg_starthere ();
            redrawcmdline ();
            did_incsearch = 1;
        }
    }
    returncmd : ExpandCleanup (&xpc);
    ccline.xpc = ((void *) 0);
    if (did_incsearch) {
        curwin -> w_cursor = old_cursor;
    ...
    if (ccline.cmdbuff != ((void *) 0)) {
        if (ccline.cmdlen && firstc != '\000' && (some_key_typed || histype == 1)) {
            add_to_history (histype, ccline.cmdbuff, 1, histype == 1 ? firstc : '\000');
            if (firstc == ':') {
        ...
        if (gotesc) {
            vim_free (ccline.cmdbuff);
            ccline.cmdbuff = ((void *) 0);
            if (msg_scrolled == 0) compute_cmdrow ();
            msg ((char_u *) (""));
            redraw_cmdline = 1;
        }
    }
    ...
    redir_off = 0;
    if (some_key_typed) need_wait_return = 0;
    State = save_State;
    setmouse ();
    ui_cursor_shape ();
    {
...
int text_locked () {
    if (cmdwin_type != 0) return 1;
    return textlock != 0;
}

void text_locked_msg () {
    if (cmdwin_type != 0) emsg ((char_u *) (((char *) (e_cmdwin))));
    else emsg ((char_u *) (((char *) (e_secure))));
}

int curbuf_locked () {
    if (curbuf_lock > 0) {
        emsg ((char_u *) (((char *) ("E788: Not allowed to edit another buffer now"))));
        return 1;
    }
...
int allbuf_locked () {
    if (allbuf_lock > 0) {
        emsg ((char_u *) (((char *) ("E811: Not allowed to change buffer information now"))));
        return 1;
    }
    return 0;
}
...
static int cmdline_charsize (idx)
    int idx;
{
    if (cmdline_star > 0) return 1;
    return ptr2cells (ccline.cmdbuff + idx);
}

static void set_cmdspos () {
    if (ccline.cmdfirstc != '\000') ccline.cmdspos = 1 + ccline.cmdindent;
...
char_u * getexline (c, cookie, indent)
    ...
    int indent;
{
    if (exec_from_reg && vpeekc () == ':') (void) vgetc ();
    ...
    int indent;
{
    ...
    cursor_on ();
    compute_cmdrow ();
    if ((msg_col || msg_didout) && promptc != '?') msg_putchar ('\n');
    if (promptc == ':') {
        if (p_prompt) msg_putchar (':');
        while (indent -- > 0) msg_putchar (' ');
        startcol = msg_col;
    }
    ...
    while (!got_int) {
        ...
        if (!escaped) {
            ...
            if (c1 == 20) {
                ...
                add_indent : while (get_indent_str (p, 8) < indent) {
                    char_u * s = skipwhite (p);
                    ga_grow (&line_ga, 1);
                    ((__builtin_object_size ((char *) (s + 1), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (s + 1), (char *) (s), line_ga.ga_len - (
                      s - p) + 1, __builtin_object_size ((char *) (s + 1), 0)) : __inline_memmove_chk ((char *) (s + 1), (char *) (s), line_ga.ga_len - (s - p)
                      + 1));
                    * s = ' ';
                    ++line_ga.ga_len;
                }
                redraw : msg_col = startcol;
                vcol = 0;
                for (p = (char_u *) line_ga.ga_data; p < (char_u *) line_ga.ga_data + line_ga.ga_len; ++p) {
                    if (*p == '\011') {
                        do {
                            msg_putchar (' ');
                        }
        ...
        if (c1 == '\n') msg_putchar ('\n');
            ...
            msg_outtrans_len (((char_u *) line_ga.ga_data) + line_ga.ga_len, 1);
            vcol += char2cells (c1);
        }
        ++line_ga.ga_len;
        escaped = 0;
    ...
    msg_didout = 0;
    msg_col = 0;
    if (msg_row < Rows - 1) ++msg_row;
    emsg_on_display = 0;
    if (got_int) ga_clear (&line_ga);
...
{
    char_u * p;
    if (len < ccline.cmdbufflen) return 1;
    p = ccline.cmdbuff;
    alloc_cmdbuff (len);
    if (ccline.cmdbuff == ((void *) 0)) {
        ccline.cmdbuff = p;
    ...
    ((__builtin_object_size ((char *) (ccline.cmdbuff), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ccline.cmdbuff), (char *) (p), (size_t) ccline
      .cmdlen, __builtin_object_size ((char *) (ccline.cmdbuff), 0)) : __inline_memmove_chk ((char *) (ccline.cmdbuff), (char *) (p), (size_t) ccline.cmdlen));
    ccline.cmdbuff [ccline.cmdlen] = '\000';
    vim_free (p);
    if (ccline.xpc != ((void *) 0) && ccline.xpc -> xp_pattern != ((void *) 0) && ccline.xpc -> xp_context != 0 && ccline.xpc -> xp_context != (-2)) {
        int i = (int) (ccline.xpc -> xp_pattern - p);
        if (i >= 0 && i <= ccline.cmdlen) ccline.xpc -> xp_pattern = ccline.cmdbuff + i;
    }
    return 1;
}
...
{
    int i;
    if (cmdline_star > 0) for (i = 0; i < len; ++i) {
        msg_putchar ('*');
    }
    ...
    int shift;
{
    ...
    msg_no_more = 1;
    msg_putchar (c);
    if (shift) draw_cmdline (ccline.cmdpos, ccline.cmdlen - ccline.cmdpos);
    msg_no_more = 0;
    cursorcmd ();
}
...
void unputcmdline () {
    if (cmd_silent) return;
    msg_no_more = 1;
    if (ccline.cmdlen == ccline.cmdpos) msg_putchar (' ');
    ...
    int redraw;
{
    ...
    if (ccline.cmdlen + len + 1 >= ccline.cmdbufflen) retval = realloc_cmdbuff (ccline.cmdlen + len + 1);
    else retval = 1;
    if (retval == 1) {
        if (!ccline.overstrike) {
            ((__builtin_object_size ((char *) (ccline.cmdbuff + ccline.cmdpos + len), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ccline.cmdbuff +
              ccline.cmdpos + len), (char *) (ccline.cmdbuff + ccline.cmdpos), (size_t) (ccline.cmdlen - ccline.cmdpos), __builtin_object_size ((char *) (
              ccline.cmdbuff + ccline.cmdpos + len), 0)) : __inline_memmove_chk ((char *) (ccline.cmdbuff + ccline.cmdpos + len), (char *) (ccline.cmdbuff +
              ccline.cmdpos), (size_t) (ccline.cmdlen - ccline.cmdpos)));
            ccline.cmdlen += len;
        }
        else {
            if (ccline.cmdpos + len > ccline.cmdlen) ccline.cmdlen = ccline.cmdpos + len;
        }
        ((__builtin_object_size ((char *) (ccline.cmdbuff + ccline.cmdpos), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ccline.cmdbuff + ccline.
          cmdpos), (char *) (str), (size_t) len, __builtin_object_size ((char *) (ccline.cmdbuff + ccline.cmdpos), 0)) : __inline_memmove_chk ((char *) (ccline
          .cmdbuff + ccline.cmdpos), (char *) (str), (size_t) len));
        ccline.cmdbuff [ccline.cmdlen] = '\000';
        if (redraw && !cmd_silent) {
            msg_no_more = 1;
            i = cmdline_row;
            draw_cmdline (ccline.cmdpos, ccline.cmdlen - ccline.cmdpos);
            if (cmdline_row != i || ccline.overstrike) msg_clr_eos ();
            msg_no_more = 0;
        }
        {
            if (KeyTyped) {
            ...
            for (i = 0; i < len; ++i) {
                ...
                if (ccline.cmdspos + c < m) ccline.cmdspos += c;
                ++ccline.cmdpos;
            }
        }
    }
...
{
    if (!prev_ccline_used) {
        ((__builtin_object_size ((&prev_ccline), 0) != (size_t) - 1) ? __builtin___memset_chk ((&prev_ccline), (0), (sizeof (struct cmdline_info)),
          __builtin_object_size ((&prev_ccline), 0)) : __inline_memset_chk ((&prev_ccline), (0), (sizeof (struct cmdline_info))));
        prev_ccline_used = 1;
    }
    * ccp = prev_ccline;
    prev_ccline = ccline;
    ...
    int remcr;
{
    ...
    int allocated;
    struct cmdline_info save_ccline;
    if (regname != 6 && regname != 16 && regname != 23 && regname != 1 && !valid_yank_reg(regname,0)) return 0;
    line_breakcheck ();
    if (got_int) return 0;
    ...
    if (i) {
        ...
        if (p_is && regname == 23) {
            ...
            for (w = ccline.cmdbuff + ccline.cmdlen; w > ccline.cmdbuff;) {
                {
                    if (!vim_iswordc(w[-1])) break;
                    --w;
                }
            }
            len = (int) ((ccline.cmdbuff + ccline.cmdlen) - w);
            if (p_ic ? strncasecmp ((char *) (w), (char *) (arg), (size_t) (len)) == 0 : strncmp ((char *) (w), (char *) (arg), (size_t) (len)) == 0) p += len;
        }
...
{
    int c, cv;
    if (literally) put_on_cmdline (s, -1, 1);
    else while (*s != '\000') {
        cv = *s;
        if (cv == 22 && s [1]) ++s;
        c = *s++;
        if (cv == 22 || c == '\033' || c == 3 || c == '\015' || c == '\012' || c == intr_char || (c == 28 && *s == 14)) stuffcharReadbuff (22);
        stuffcharReadbuff (c);
    }
}
...
static void cmdline_del (from)
    int from;
{
    ((__builtin_object_size ((char *) (ccline.cmdbuff + from), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (ccline.cmdbuff + from), (char *) (
      ccline.cmdbuff + ccline.cmdpos), (size_t) (ccline.cmdlen - ccline.cmdpos + 1), __builtin_object_size ((char *) (ccline.cmdbuff + from), 0)) :
      __inline_memmove_chk ((char *) (ccline.cmdbuff + from), (char *) (ccline.cmdbuff + ccline.cmdpos), (size_t) (ccline.cmdlen - ccline.cmdpos + 1)));
...
static void redrawcmdprompt () {
    int i;
    if (cmd_silent) return;
    if (ccline.cmdfirstc != '\000') msg_putchar (ccline.cmdfirstc);
    if (ccline.cmdprompt != ((void *) 0)) {
        msg_puts_attr (ccline.cmdprompt, ccline.cmdattr);
        ccline.cmdindent = msg_col + (msg_row - cmdline_row) * Columns;
        if (ccline.cmdfirstc != '\000') --ccline.cmdindent;
    }
    else for (i = ccline.cmdindent; i > 0; --i) msg_putchar (' ');
}
...
void compute_cmdrow () {
    if (exmode_active || msg_scrolled != 0) cmdline_row = Rows - 1;
    else cmdline_row = (lastwin -> w_winrow) + lastwin -> w_height + (lastwin -> w_status_height);
}
...
static void cursorcmd () {
    if (cmd_silent) return;
    {
        ...
        if (msg_row >= Rows) msg_row = Rows - 1;
    }
    windgoto (msg_row, msg_col);
}
...
static int ccheck_abbr (c)
    int c;
{
    if (p_paste || no_abbr) return 0;
    return check_abbr (c, ccline.cmdbuff, ccline.cmdpos, 0);
}

static int nextwild (xp, type, options)
    expand_T * xp;
    int type;
    int options;
{
    ...
    if (type == 4 || type == 5) {
        ...
        if ((p1 = addstar (xp -> xp_pattern, xp -> xp_pattern_len, xp -> xp_context)) == ((void *) 0)) p2 = ((void *) 0);
        else {
            p2 = ExpandOne (xp, p1, vim_strnsave (&ccline.cmdbuff[i], xp -> xp_pattern_len), 2 | 16 | 64 | 128 | options, type);
            vim_free (p1);
            if (p2 != ((void *) 0) && type == 7) {
                for (j = 0; j < xp -> xp_pattern_len; ++j) if (ccline.cmdbuff [i + j] == '*' || ccline.cmdbuff [i + j] == '?') break;
    ...
    if (p2 != ((void *) 0) && !got_int) {
        ...
        if (v == 1) {
            ((__builtin_object_size ((char *) (&ccline.cmdbuff[ccline.cmdpos+difflen]), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) 
              (&ccline.cmdbuff[ccline.cmdpos+difflen]), (char *) (&ccline.cmdbuff[ccline.cmdpos]), (size_t) (ccline.cmdlen - ccline.cmdpos + 1),
              __builtin_object_size ((char *) (&ccline.cmdbuff[ccline.cmdpos+difflen]), 0)) : __inline_memmove_chk ((char *) 
              (&ccline.cmdbuff[ccline.cmdpos+difflen]), (char *) (&ccline.cmdbuff[ccline.cmdpos]), (size_t) (ccline.cmdlen - ccline.cmdpos + 1)));
            ((__builtin_object_size ((char *) (&ccline.cmdbuff[i]), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (&ccline.cmdbuff[i]), (char *) (p2)
              , strlen ((char *) (p2)), __builtin_object_size ((char *) (&ccline.cmdbuff[i]), 0)) : __inline_memmove_chk ((char *) (&ccline.cmdbuff[i]), (char *
              ) (p2), strlen ((char *) (p2))));
    ...
    redrawcmd ();
    cursorcmd ();
    if (xp -> xp_context == 16 && p2 == ((void *) 0)) return 0;
    if (xp -> xp_numfiles <= 0 && p2 == ((void *) 0)) beep_flush ();
    else if (xp -> xp_numfiles == 1) (void) ExpandOne (xp, ((void *) 0), ((void *) 0), 0, 1);
    return 1;
}
    ...
    int mode;
{
    ...
    if (mode == 4 || mode == 5) {
        if (xp -> xp_numfiles > 0) {
            if (mode == 5) {
                if (findex == -1) findex = xp -> xp_numfiles;
                --findex;
            }
            else ++findex;
            if (findex < 0) {
                if (orig_save == ((void *) 0)) findex = xp -> xp_numfiles - 1;
                else findex = -1;
            }
            if (findex >= xp -> xp_numfiles) {
                if (orig_save == ((void *) 0)) findex = 0;
                else findex = -1;
            }
            if (p_wmnu) win_redr_status_matches (xp, xp -> xp_numfiles, xp -> xp_files, findex, cmd_showtail);
            if (findex == -1) return vim_strsave (orig_save);
    ...
    if (xp -> xp_numfiles == -1) {
        ...
        orig_save = orig;
        orig_saved = 1;
        if (ExpandFromContext (xp, str, &xp->xp_numfiles, &xp->xp_files, options) == 0) {
        }
        else if (xp -> xp_numfiles == 0) {
            if (!(options&64)) emsg2 ((char_u *) (((char *) (e_nomatch2))), (char_u *) (str));
        }
        else {
            ExpandEscape (xp, str, xp -> xp_numfiles, xp -> xp_files, options);
            if (mode != 6 && mode != 7) {
                if (xp -> xp_numfiles) non_suf_match = xp -> xp_numfiles;
                else non_suf_match = 1;
                if ((xp -> xp_context == 2 || xp -> xp_context == 3) && xp -> xp_numfiles > 1) {
                    non_suf_match = 0;
                    for (i = 0; i < 2; ++i) if (match_suffix (xp -> xp_files [i])) ++non_suf_match;
                }
                if (non_suf_match != 1) {
                    if (!(options&64)) emsg ((char_u *) (((char *) (e_toomany))));
                    else if (!(options&8)) beep_flush ();
                }
                if (!(non_suf_match!=1&&mode==2)) ss = vim_strsave (xp -> xp_files [0]);
            }
        }
    }
    if (mode == 7 && xp -> xp_numfiles > 0) {
        for (len = 0; xp -> xp_files [0] [len]; ++len) {
            for (i = 0; i < xp -> xp_numfiles; ++i) {
                if (xp -> xp_context == 3 || xp -> xp_context == 2 || xp -> xp_context == 32 || xp -> xp_context == 9) {
                    if (tolower (xp -> xp_files [i] [len]) != tolower (xp -> xp_files [0] [len])) break;
                }
                else if (xp -> xp_files [i] [len] != xp -> xp_files [0] [len]) break;
            }
            if (i < xp -> xp_numfiles) {
                if (!(options&8)) vim_beep ();
                break;
            }
        }
        ss = alloc ((unsigned) len + 1);
        if (ss) vim_strncpy (ss, xp -> xp_files [0], (size_t) len);
        findex = -1;
    }
    if (mode == 6 && xp -> xp_numfiles > 0) {
        len = 0;
        for (i = 0; i < xp -> xp_numfiles; ++i) len += (long_u) strlen ((char *) (xp -> xp_files [i])) + 1;
        ss = lalloc (len, 1);
        if (ss != ((void *) 0)) {
            * ss = '\000';
            for (i = 0; i < xp -> xp_numfiles; ++i) {
                ((__builtin_object_size ((char *) (ss), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (ss), (char *) (xp -> xp_files [i]),
                  __builtin_object_size ((char *) (ss), 1 > 1)) : __inline_strcat_chk ((char *) (ss), (char *) (xp -> xp_files [i])));
                if (i != xp -> xp_numfiles - 1) ((__builtin_object_size ((char *) (ss), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (ss), (char *) (
                  (options & 4) ? "\n" : " "), __builtin_object_size ((char *) (ss), 1 > 1)) : __inline_strcat_chk ((char *) (ss), (char *) ((options & 4) ?
                  "\n" : " ")));
            }
        }
    }
    if (mode == 2 || mode == 6) ExpandCleanup (xp);
    if (!orig_saved) vim_free (orig);
    return ss;
}
    ...
    int options;
{
    int i;
    char_u * p;
    if (options & 2) tilde_replace (str, numfiles, files);
    if (options & 128) {
        if (xp -> xp_context == 2 || xp -> xp_context == 32 || xp -> xp_context == 9 || xp -> xp_context == 3) {
            for (i = 0; i < numfiles; ++i) {
                ...
                if (str [0] == '\\' && str [1] == '~' && files [i] [0] == '~') escape_fname (&files[i]);
            }
            xp -> xp_backslash = 0;
            if (*files[0] == '+') escape_fname (&files[0]);
        }
        else if (xp -> xp_context == 6) {
            for (i = 0; i < numfiles; ++i) {
                p = vim_strsave_escaped (files [i], (char_u *) "\\|\"");
                if (p != ((void *) 0)) {
                    vim_free (files [i]);
    ...
    int shell;
{
    ...
    if (shell && csh_like_shell () && p != ((void *) 0)) {
        char_u * s;
        s = vim_strsave_escaped (p, (char_u *) "!");
        vim_free (p);
        p = s;
    }
    if (p != ((void *) 0) && (*p == '>' || *p == '+' || (*p == '-' && p [1] == '\000'))) escape_fname (&p);
    return p;
}
...
{
    char_u * p;
    p = alloc ((unsigned) (strlen ((char *) (*pp)) + 2));
    if (p != ((void *) 0)) {
        p [0] = '\\';
        ((__builtin_object_size ((char *) (p + 1), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (p + 1), (char *) (*pp), __builtin_object_size ((char
          *) (p + 1), 1 > 1)) : __inline_strcpy_chk ((char *) (p + 1), (char *) (*pp)));
        vim_free (* pp);
        * pp = p;
    }
}
...
static int showmatches (xp, wildmenu)
    expand_T * xp;
    int wildmenu __attribute__ ((unused));
{
    int num_files;
    char_u * * files_found;
    int i, j, k;
    ...
    if (got_int) got_int = 0;
    else if (wildmenu) win_redr_status_matches (xp, num_files, files_found, 0, showtail);
    else {
        maxlen = 0;
        for (i = 0; i < num_files; ++i) {
            if (!showtail && (xp -> xp_context == 2 || xp -> xp_context == 32 || xp -> xp_context == 9)) {
                home_replace (((void *) 0), files_found [i], NameBuff, 1024, 1);
                j = vim_strsize (NameBuff);
            }
            else j = vim_strsize ((showtail ? sm_gettail (files_found [i]) : files_found [i]));
            if (j > maxlen) maxlen = j;
        }
        if (xp -> xp_context == 17) lines = num_files;
        else {
            maxlen += 2;
        ...
        if (xp -> xp_context == 17) {
            msg_puts_attr ((char_u *) (((char *) ("tagname"))), (highlight_attr [(int) (HLF_T)]));
            msg_clr_eos ();
            msg_advance (maxlen - 3);
            msg_puts_attr ((char_u *) (((char *) (" kind file\n"))), (highlight_attr [(int) (HLF_T)]));
        }
        for (i = 0; i < lines; ++i) {
            lastlen = 999;
            for (k = i; k < num_files; k += lines) {
                ...
                for (j = maxlen - lastlen; --j >= 0;) msg_putchar (' ');
                if (xp -> xp_context == 2 || xp -> xp_context == 32 || xp -> xp_context == 9) {
                    if (xp -> xp_numfiles != -1) {
                        char_u * halved_slash;
                        char_u * exp_path;
                        exp_path = expand_env_save_opt (files_found [k], 1);
                        halved_slash = backslash_halve_save (exp_path != ((void *) 0) ? exp_path : files_found [k]);
                        j = mch_isdir (halved_slash != ((void *) 0) ? halved_slash : files_found [k]);
                        vim_free (exp_path);
                        vim_free (halved_slash);
                    }
                    else j = mch_isdir (files_found [k]);
                    if (showtail) p = (showtail ? sm_gettail (files_found [k]) : files_found [k]);
                    else {
                        home_replace (((void *) 0), files_found [k], NameBuff, 1024, 1);
                        p = NameBuff;
                    }
                }
                else {
    ...
    if (xp -> xp_numfiles == -1) FreeWild (num_files, files_found);
    return (-1);
}
    ...
    expand_T * xp;
{
    char_u * s;
    char_u * end;
    if (xp -> xp_context != 2 && xp -> xp_context != 32 && xp -> xp_context != 3) return 0;
    end = gettail (xp -> xp_pattern);
    if (end == xp -> xp_pattern) return 0;
    for (s = xp -> xp_pattern; s < end; s ++) {
        if (rem_backslash (s)) ++s;
        else if (vim_strchr ((char_u *) "*?[", *s) != ((void *) 0)) return 0;
    }
    return 1;
}
    ...
    int context;
{
    ...
    char_u * tail;
    int ends_in_star;
    if (context != 2 && context != 38 && context != 32 && context != 3) {
        if (context == 8 || context == 28 || context == 29 || context == 39 || context == 37 || (context == 6 && fname [0] == '/')) retval = vim_strnsave (
          fname, len);
        else {
            new_len = len + 2;
            for (i = 0; i < len; i ++) {
                if (fname [i] == '*' || fname [i] == '~') new_len ++;
                if (context == 9 && fname [i] == '.') new_len ++;
                if ((context == 30 || context == 31) && fname [i] == '\\') new_len ++;
            }
            ...
            if (retval != ((void *) 0)) {
                ...
                j = 1;
                for (i = 0; i < len; i ++, j ++) {
                    if (context != 30 && context != 31 && fname [i] == '\\' && ++i == len) break;
                    switch (fname [i]) {
                    case '*' :
                        retval [j ++] = '.';
                        break;
                    ...
                    case '?' :
                        ...
                        continue;
                    case '.' :
                        if (context == 9) retval [j ++] = '\\';
                        break;
                    case '\\' :
                        if (context == 30 || context == 31) retval [j ++] = '\\';
                        break;
                    }
                    retval [j] = fname [i];
                }
        ...
        if (retval != ((void *) 0)) {
            ...
            if ((*retval != '~' || tail != retval) && !ends_in_star && vim_strchr (tail, '$') == ((void *) 0) && vim_strchr (retval, '`') == ((void *) 0))
              retval [len ++] = '*';
            else if (len > 0 && retval [len - 1] == '$') --len;
            retval [len] = '\000';
        }
    }
    return retval;
    ...
    int col;
{
    ...
    else while (nextcomm != ((void *) 0)) nextcomm = set_one_cmd_context (xp, nextcomm);
    str [col] = old_char;
}
    ...
    char_u * * * matches;
{
    ...
    if (file_str == ((void *) 0)) return (-2);
    if (ExpandFromContext (xp, file_str, matchcount, matches, 16 | 64) == 0) {
        * matchcount = 0;
        * matches = ((void *) 0);
    }
    vim_free (file_str);
    ...
    char_u * * file;
{
    ...
    for (i = 0; i < num_file; ++i) {
        ...
        if (len > 0 && strcmp ((char *) (file [i] + len), (char *) ("@en")) == 0) {
            for (j = 0; j < num_file; ++j) if (j != i && (int) strlen ((char *) (file [j])) == len + 3 && strncmp ((char *) (file [i]), (char *) (file [j]), (
              size_t) (len + 1)) == 0) break;
            if (j == num_file) file [i] [len] = '\000';
        }
    }
}
    ...
    int options;
{
    ...
    int flags;
    flags = 0x01;
    if (options & 1) flags |= 0x04;
    if (options & 16) flags |= 0x08;
    if (options & 32) flags |= 0x10;
    if (options & 64) flags |= 0x20;
    if (xp -> xp_context == 2 || xp -> xp_context == 3 || xp -> xp_context == 38) {
        int free_pat = 0;
        int i;
        if (xp -> xp_backslash != 0) {
            free_pat = 1;
            pat = vim_strsave (pat);
            for (i = 0; pat [i]; ++i) if (pat [i] == '\\') {
                if (xp -> xp_backslash == 2 && pat [i + 1] == '\\' && pat [i + 2] == '\\' && pat [i + 3] == ' ') ((__builtin_object_size ((char *) ((pat + i)),
                  0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((pat + i)), (char *) ((pat + i + 3)), strlen ((char *) (pat + i + 3)) + 1,
                  __builtin_object_size ((char *) ((pat + i)), 0)) : __inline_memmove_chk ((char *) ((pat + i)), (char *) ((pat + i + 3)), strlen ((char *) (
                  pat + i + 3)) + 1));
                if (xp -> xp_backslash == 1 && pat [i + 1] == ' ') ((__builtin_object_size ((char *) ((pat + i)), 0) != (size_t) - 1) ? __builtin___memmove_chk
                  ((char *) ((pat + i)), (char *) ((pat + i + 1)), strlen ((char *) (pat + i + 1)) + 1, __builtin_object_size ((char *) ((pat + i)), 0)) :
                  __inline_memmove_chk ((char *) ((pat + i)), (char *) ((pat + i + 1)), strlen ((char *) (pat + i + 1)) + 1));
            }
        }
        if (xp -> xp_context == 2) flags |= 0x02;
        else if (xp -> xp_context == 38) flags |= (0x02 | 0x80);
        else flags = (flags | 0x01) & ~0x02;
        ret = expand_wildcards_eval (&pat, num_file, file, flags);
        if (free_pat) vim_free (pat);
        return ret;
    }
    * file = (char_u * *) "";
    * num_file = 0;
    if (xp -> xp_context == 8) {
        if (find_help_tags (*pat == '\000' ? (char_u *) "help" : pat, num_file, file, 0) == 1) {
            cleanup_help_tags (* num_file, * file);
            return 1;
        }
        return 0;
    }
    if (xp -> xp_context == 32) return expand_shellcmd (pat, num_file, file, flags);
    if (xp -> xp_context == 7) return ExpandOldSetting (num_file, file);
    if (xp -> xp_context == 9) return ExpandBufnames (pat, num_file, file, options);
    if (xp -> xp_context == 6 || xp -> xp_context == 17) return expand_tags (xp -> xp_context == 6, pat, num_file, file);
    if (xp -> xp_context == 28) return ExpandRTDir (pat, num_file, file, "colors");
    if (xp -> xp_context == 29) return ExpandRTDir (pat, num_file, file, "compiler");
    if (xp -> xp_context == 39) return ExpandRTDir (pat, num_file, file, "syntax");
    if (xp -> xp_context == 37) return ExpandRTDir (pat, num_file, file, "{syntax,indent,ftplugin}");
    if (xp -> xp_context == 31) return ExpandUserList (xp, num_file, file);
    regmatch.regprog = vim_regcomp (pat, p_magic ? 1 : 0);
    if (regmatch.regprog == ((void *) 0)) return 0;
    regmatch.rm_ic = ignorecase (pat);
    if (xp -> xp_context == 4 || xp -> xp_context == 5) ret = ExpandSettings (xp, &regmatch, num_file, file);
    else if (xp -> xp_context == 16) ret = ExpandMappings (&regmatch, num_file, file);
    else if (xp -> xp_context == 30) ret = ExpandUserDefined (xp, &regmatch, num_file, file);
    else {
        ...
        {
            {1, get_command_name, 0},
            {36, get_behave_arg, 1},
            {22, get_user_commands, 0},
            {23, get_user_cmd_flags, 0},
            {24, get_user_cmd_nargs, 0},
            {25, get_user_cmd_complete, 0},
            {15, get_user_var_name, 0},
            {18, get_function_name, 0},
            {19, get_user_func_name, 0},
            {20, get_expr_name, 0},
            {11, get_menu_name, 0},
            {21, get_menu_names, 0},
            {12, get_syntax_name, 1},
            {13, get_highlight_name, 1},
            {10, get_event_name, 1},
            {14, get_augroup_name, 1},
            {34, get_sign_name, 1},
            {26, get_env_name, 1},};
        int i;
        ret = 0;
        for (i = 0; i < (int) (sizeof (tab) / sizeof (struct expgen)); ++i) if (xp -> xp_context == tab [i].context) {
            if (tab [i].ic) regmatch.rm_ic = 1;
    ...
    char_u * ((* func) (expand_T *, int));
{
    ...
    if (xp -> xp_context != 21 && xp -> xp_context != 11) sort_strings (*file, *num_file);
    ...
    int flagsarg;
{
    ...
    for (i = 0; pat [i]; ++i) if (pat [i] == '\\' && pat [i + 1] == ' ') ((__builtin_object_size ((char *) ((pat + i)), 0) != (size_t) - 1) ?
      __builtin___memmove_chk ((char *) ((pat + i)), (char *) ((pat + i + 1)), strlen ((char *) (pat + i + 1)) + 1, __builtin_object_size ((char *) ((pat + i))
      , 0)) : __inline_memmove_chk ((char *) ((pat + i)), (char *) ((pat + i + 1)), strlen ((char *) (pat + i + 1)) + 1));
    flags |= 0x02 | 0x40;
    if (mch_isFullName (pat)) path = (char_u *) " ";
    else if ((pat [0] == '.' && (vim_ispathsep (pat [1]) || (pat [1] == '.' && vim_ispathsep (pat [2]))))) path = (char_u *) ".";
    else path = vim_getenv ((char_u *) "PATH", &mustfree);
    ga_init2 (&ga, (int) sizeof (char *), 10);
    for (s = path; *s != '\000'; s = e) {
        if (*s == ' ') ++s;
        e = vim_strchr (s, ':');
        if (e == ((void *) 0)) e = s + strlen ((char *) (s));
        l = e - s;
        if (l > 1024 - 5) break;
        vim_strncpy (buf, s, l);
        add_pathsep (buf);
        l = strlen ((char *) (buf));
        vim_strncpy (buf + l, pat, 1024 - 1 - l);
        ret = expand_wildcards (1, &buf, num_file, file, flags);
        if (ret == 1) {
            if (ga_grow (&ga, *num_file) == 0) FreeWild (*num_file, *file);
            else {
                for (i = 0; i < *num_file; ++i) {
                    s = (*file) [i];
                    if (strlen ((char *) (s)) > l) {
                        ((__builtin_object_size ((char *) ((s)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((s)), (char *) ((s + l)), strlen ((
                          char *) (s + l)) + 1, __builtin_object_size ((char *) ((s)), 0)) : __inline_memmove_chk ((char *) ((s)), (char *) ((s + l)), strlen (
                          (char *) (s + l)) + 1));
    ...
    char_u * * * file;
{
    ...
    void * ret;
    struct cmdline_info save_ccline;
    if (xp -> xp_arg == ((void *) 0) || xp -> xp_arg [0] == '\0') return ((void *) 0);
    * num_file = 0;
    * file = ((void *) 0);
    if (ccline.cmdbuff == ((void *) 0)) {
        keep = 0;
        __builtin___sprintf_chk ((char *) num, 0, __builtin_object_size ((char *) num, 1 > 1), "%d", (int) strlen ((char *) (xp -> xp_pattern)));
        args [1] = xp -> xp_pattern;
    }
    else {
        keep = ccline.cmdbuff [ccline.cmdlen];
        ccline.cmdbuff [ccline.cmdlen] = 0;
        __builtin___sprintf_chk ((char *) num, 0, __builtin_object_size ((char *) num, 1 > 1), "%d", ccline.cmdpos);
    ...
    if (ccline.cmdbuff != ((void *) 0)) ccline.cmdbuff [ccline.cmdlen] = keep;
    vim_free (args [0]);
    return ret;
}
    ...
    char_u * * * file;
{
    ...
    if (retlist == ((void *) 0)) return 0;
    ga_init2 (&ga, (int) sizeof (char *), 3);
    for (li = retlist -> lv_first; li != ((void *) 0); li = li -> li_next) {
        if (li -> li_tv.v_type != 2 || li -> li_tv.vval.v_string == ((void *) 0)) continue;
        if (ga_grow (&ga, 1) == 0) break;
    ...
    char * dirnames;
{
    ...
    * num_file = 0;
    * file = ((void *) 0);
    s = alloc ((unsigned) (strlen ((char *) (pat)) + strlen ((char *) (dirnames)) + 7));
    if (s == ((void *) 0)) return 0;
    __builtin___sprintf_chk ((char *) s, 0, __builtin_object_size ((char *) s, 1 > 1), "%s/%s*.vim", dirnames, pat);
    all = globpath (p_rtp, s, 0);
    vim_free (s);
    if (all == ((void *) 0)) return 0;
    ga_init2 (&ga, (int) sizeof (char *), 3);
    for (s = all; *s != '\000'; s = e) {
        e = vim_strchr (s, '\n');
        if (e == ((void *) 0)) e = s + strlen ((char *) (s));
        if (ga_grow (&ga, 1) == 0) break;
        if (e - 4 > s && strncasecmp ((char *) (e - 4), (char *) (".vim"), (size_t) (4)) == 0) {
            for (s = e - 4; s > all; --s) if (*s == '\n' || vim_ispathsep (*s)) break;
            ++s;
            ((char_u * *) ga.ga_data) [ga.ga_len] = vim_strnsave (s, (int) (e - s - 4));
            ++ga.ga_len;
        }
        if (*e != '\000') ++e;
    }
    ...
    int expand_options;
{
    ...
    while (*path != '\000') {
        ...
        if (strlen ((char *) (buf)) + strlen ((char *) (file)) + 2 < 1024) {
            add_pathsep (buf);
            ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (buf), (char *) (file), __builtin_object_size ((
              char *) (buf), 1 > 1)) : __inline_strcat_chk ((char *) (buf), (char *) (file)));
            if (ExpandFromContext (&xpc, buf, &num_p, &p, 64 | expand_options) != 0 && num_p > 0) {
                ExpandEscape (&xpc, buf, num_p, p, 64 | expand_options);
                for (len = 0, i = 0; i < num_p; ++i) len += (int) strlen ((char *) (p [i])) + 1;
                if (ga_grow (&ga, len) == 1) {
                    cur = (char_u *) ga.ga_data + ga.ga_len;
                    for (i = 0; i < num_p; ++i) {
                        ((__builtin_object_size ((char *) (cur), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (cur), (char *) (p [i]),
                          __builtin_object_size ((char *) (cur), 1 > 1)) : __inline_strcpy_chk ((char *) (cur), (char *) (p [i])));
                        cur += strlen ((char *) (p [i]));
                        *cur++ = '\n';
                    }
                    ga.ga_len += len;
...
{"cmd", "search", "expr", "input", "debug", ((void *) 0)};
...
void init_history () {
    ...
    if (newlen != hislen) {
        for (type = 0; type < 5; ++type) {
            if (newlen) {
                temp = (histentry_T *) lalloc ((long_u) (newlen * sizeof (histentry_T)), 1);
                if (temp == ((void *) 0)) {
                    if (type == 0) {
                        newlen = hislen;
                        break;
            ...
            if (newlen == 0 || temp != ((void *) 0)) {
                if (hisidx [type] < 0) {
                    for (i = 0; i < newlen; ++i) {
                        temp [i].hisnum = 0;
                        temp [i].hisstr = ((void *) 0);
                    }
                }
                else if (newlen > hislen) {
                    for (i = 0; i <= hisidx [type]; ++i) temp [i] = history [type] [i];
                    j = i;
                    for (; i <= newlen - (hislen - hisidx [type]); ++i) {
                        temp [i].hisnum = 0;
                        temp [i].hisstr = ((void *) 0);
                    }
                    for (; j < hislen; ++i, ++j) temp [i] = history [type] [j];
                }
                else {
                    j = hisidx [type];
                    for (i = newlen - 1;; --i) {
                        if (i >= 0) temp [i] = history [type] [j];
                        else vim_free (history [type] [j].hisstr);
                        if (--j < 0) j = hislen - 1;
                        if (j == hisidx [type]) break;
                    }
...
static int in_history (type, str, move_to_front)
    int type;
    char_u * str;
    int move_to_front;
{
    int i;
    int last_i = -1;
    if (hisidx [type] < 0) return 0;
    i = hisidx [type];
    do {
        if (history [type] [i].hisstr == ((void *) 0)) return 0;
        if (strcmp ((char *) (str), (char *) (history [type] [i].hisstr)) == 0) {
            if (!move_to_front) return 1;
            last_i = i;
            break;
        }
        if (--i < 0) i = hislen - 1;
    ...
    char_u * name;
{
    ...
    if (len == 0) return hist_char2type (ccline.cmdfirstc);
    for (i = 0; history_names [i] != ((void *) 0); ++i) if (strncasecmp ((char *) (name), (char *) (history_names [i]), (size_t) (len)) == 0) return i;
    if (vim_strchr ((char_u *) ":=@>?/", name [0]) != ((void *) 0) && name [1] == '\000') return hist_char2type (name [0]);
    return -1;
}
    ...
    int sep;
{
    ...
    if (histype == 1 && in_map) {
        if (maptick == last_maptick) {
            ...
            hisptr -> hisnum = 0;
            --hisnum[histype];
            if (--hisidx[1] < 0) hisidx [1] = hislen - 1;
        }
        last_maptick = -1;
    }
    if (!in_history(histype,new_entry,1)) {
        if (++hisidx[histype] == hislen) hisidx [histype] = 0;
        hisptr = &history[histype][hisidx[histype]];
        vim_free (hisptr -> hisstr);
        len = (int) strlen ((char *) (new_entry));
        hisptr -> hisstr = vim_strnsave (new_entry, len + 2);
        if (hisptr -> hisstr != ((void *) 0)) hisptr -> hisstr [len + 1] = sep;
        hisptr -> hisnum = ++hisnum[histype];
        if (histype == 1 && in_map) last_maptick = maptick;
    }
}
...
int get_history_idx (histype)
    int histype;
{
    if (hislen == 0 || histype < 0 || histype >= 5 || hisidx [histype] < 0) return -1;
...
static struct cmdline_info * get_ccline_ptr () {
    if ((State & 0x08) == 0) return ((void *) 0);
    if (ccline.cmdbuff != ((void *) 0)) return &ccline;
    if (prev_ccline_used && prev_ccline.cmdbuff != ((void *) 0)) return &prev_ccline;
    return ((void *) 0);
}
...
int get_cmdline_type () {
    struct cmdline_info * p = get_ccline_ptr ();
    if (p == ((void *) 0)) return '\000';
    if (p -> cmdfirstc == '\000') return (p -> input_fn) ? '@' : '-';
    return p -> cmdfirstc;
}
    ...
    int num;
{
    ...
    histentry_T * hist;
    int wrapped = 0;
    if (hislen == 0 || histype < 0 || histype >= 5 || (i = hisidx [histype]) < 0 || num == 0) return -1;
    hist = history [histype];
    if (num > 0) {
        while (hist [i].hisnum > num) if (--i < 0) {
            if (wrapped) break;
            i += hislen;
            wrapped = 1;
        }
        if (hist [i].hisnum == num && hist [i].hisstr != ((void *) 0)) return i;
    }
    else if (-num <= hislen) {
        i += num + 1;
        if (i < 0) i += hislen;
        if (hist [i].hisstr != ((void *) 0)) return i;
    }
    return -1;
}
    ...
    int idx;
{
    ...
    if (idx >= 0) return history [histype] [idx].hisstr;
    else return (char_u *) "";
}
    ...
    char_u * str;
{
    ...
    regmatch.rm_ic = 0;
    if (hislen != 0 && histype >= 0 && histype < 5 && *str != '\000' && (idx = hisidx [histype]) >= 0 && (regmatch.regprog = vim_regcomp (str, 1 + 2)) != ((
      void *) 0)) {
        i = last = idx;
        do {
            hisptr = &history[histype][i];
            if (hisptr -> hisstr == ((void *) 0)) break;
            if (vim_regexec (&regmatch, hisptr -> hisstr, (colnr_T) 0)) {
                ...
                if (--last < 0) last += hislen;
            }
            if (--i < 0) i += hislen;
        }
        while (i != idx);
        if (history [histype] [idx].hisstr == ((void *) 0)) hisidx [histype] = -1;
    }
    vim_free (regmatch.regprog);
    return found;
}
    ...
    int idx;
{
    ...
    if (histype == 1 && maptick == last_maptick && i == idx) last_maptick = -1;
    while (i != idx) {
        j = (i + 1) % hislen;
        history [histype] [i] = history [histype] [j];
        i = j;
    }
    history [histype] [i].hisstr = ((void *) 0);
...
void remove_key_from_history () {
    ...
    i = hisidx [0];
    if (i < 0) return;
    p = history [0] [i].hisstr;
    if (p != ((void *) 0)) for (; *p; ++p) if (strncmp ((char *) (p), (char *) ("key"), (size_t) (3)) == 0 && !isalpha(p[3])) {
        p = vim_strchr (p + 3, '=');
        if (p == ((void *) 0)) break;
        ++p;
        for (i = 0; p [i] && !((p[i])==' '||(p[i])=='\t'); ++i) if (p [i] == '\\' && p [i + 1]) ++i;
        ((__builtin_object_size ((char *) ((p)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((p)), (char *) ((p + i)), strlen ((char *) (p + i)) +
          1, __builtin_object_size ((char *) ((p)), 0)) : __inline_memmove_chk ((char *) ((p)), (char *) ((p + i)), strlen ((char *) (p + i)) + 1));
        --p;
    }
}
    ...
    exarg_T * eap;
{
    ...
    char_u * arg = eap -> arg;
    if (hislen == 0) {
        msg ((char_u *) (((char *) ("'history' option is zero"))));
        return;
    }
    if (!(((*arg) >= '0' && (*arg) <= '9') || *arg == '-' || *arg == ',')) {
        end = arg;
        while (((*end) < 0x7f && isalpha (*end)) || vim_strchr ((char_u *) ":=@>/?", *end) != ((void *) 0)) end ++;
        i = *end;
        * end = '\000';
    ...
    for (; !got_int && histype1 <= histype2; ++histype1) {
        ...
        ((__builtin_object_size ((char *) (((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (IObuff), (char *
          ) (history_names [histype1]), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcat_chk ((char *) (IObuff), (char *) (history_names [
          histype1])))), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ?
          __builtin___strcat_chk ((char *) (IObuff), (char *) (history_names [histype1]), __builtin_object_size ((char *) (IObuff), 1 > 1)) :
          __inline_strcat_chk ((char *) (IObuff), (char *) (history_names [histype1])))), (char *) (" history"), __builtin_object_size ((char *) (((
          __builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (IObuff), (char *) (history_names [histype1]),
          __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcat_chk ((char *) (IObuff), (char *) (history_names [histype1])))), 1 > 1)) :
          __inline_strcat_chk ((char *) (((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (IObuff), (char *) (
          history_names [histype1]), __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcat_chk ((char *) (IObuff), (char *) (history_names [
          histype1])))), (char *) (" history")));
        msg_puts_title ((char_u *) (IObuff));
        idx = hisidx [histype1];
        hist = history [histype1];
        j = hisidx1;
        k = hisidx2;
        if (j < 0) j = (-j > hislen) ? 0 : hist [(hislen + j + idx + 1) % hislen].hisnum;
        if (k < 0) k = (-k > hislen) ? 0 : hist [(hislen + k + idx + 1) % hislen].hisnum;
        if (idx >= 0 && j <= k) for (i = idx + 1; !got_int; ++i) {
            if (i == hislen) i = 0;
            if (hist [i].hisstr != ((void *) 0) && hist [i].hisnum >= j && hist [i].hisnum <= k) {
                msg_putchar ('\n');
                __builtin___sprintf_chk ((char *) IObuff, 0, __builtin_object_size ((char *) IObuff, 1 > 1), "%c%6d  ", i == idx ? '>' : ' ', hist [i].hisnum);
                if (vim_strsize (hist [i].hisstr) > (int) Columns - 10) trunc_string (hist [i].hisstr, IObuff + strlen ((char *) (IObuff)), (int) Columns - 10)
                  ;
                else ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (IObuff), (char *) (hist [i].hisstr),
                  __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcat_chk ((char *) (IObuff), (char *) (hist [i].hisstr)));
                msg_outtrans (IObuff);
                out_flush ();
            }
            if (i == idx) break;
...
static char_u * * viminfo_history [5] =
{((void *) 0), ((void *) 0), ((void *) 0), ((void *) 0)};
static int viminfo_hisidx [5] =
{0, 0, 0, 0};
static int viminfo_hislen [5] =
{0, 0, 0, 0};
...
void prepare_viminfo_history (asklen)
    int asklen;
{
    int i;
    int num;
    ...
    if (asklen > hislen) asklen = hislen;
    for (type = 0; type < 5; ++type) {
        for (i = 0, num = 0; i < hislen; i ++) if (history [type] [i].hisstr == ((void *) 0)) num ++;
        len = asklen;
        if (num > len) len = num;
        if (len <= 0) viminfo_history [type] = ((void *) 0);
        else viminfo_history [type] = (char_u * *) lalloc ((long_u) (len * sizeof (char_u *)), 0);
        if (viminfo_history [type] == ((void *) 0)) len = 0;
    ...
    vir_T * virp;
{
    ...
    if (viminfo_hisidx [type] < viminfo_hislen [type]) {
        ...
        if (val != ((void *) 0) && *val != '\000') {
            if (!in_history(type,val+(type==1),viminfo_add_at_front)) {
                len = strlen ((char *) (val));
                p = lalloc (len + 2, 1);
                if (p != ((void *) 0)) {
                    if (type == 1) {
                        ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (p), (char *) (val + 1), (size_t) len,
                          __builtin_object_size ((char *) (p), 0)) : __inline_memmove_chk ((char *) (p), (char *) (val + 1), (size_t) len));
                        p [len] = (*val == ' ' ? '\000' : *val);
                    }
                    else {
                        ((__builtin_object_size ((char *) (p), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (p), (char *) (val), (size_t) len + 1,
                          __builtin_object_size ((char *) (p), 0)) : __inline_memmove_chk ((char *) (p), (char *) (val), (size_t) len + 1));
                        p [len + 1] = '\000';
                    }
...
void finish_viminfo_history () {
    ...
    int type;
    for (type = 0; type < 5; ++type) {
        if (history [type] == ((void *) 0)) return;
        idx = hisidx [type] + viminfo_hisidx [type];
        if (idx >= hislen) idx -= hislen;
        else if (idx < 0) idx = hislen - 1;
        if (viminfo_add_at_front) hisidx [type] = idx;
        else {
            if (hisidx [type] == -1) hisidx [type] = hislen - 1;
            do {
                if (history [type] [idx].hisstr != ((void *) 0)) break;
                if (++idx == hislen) idx = 0;
            }
            while (idx != hisidx [type]);
            if (idx != hisidx [type] && --idx < 0) idx = hislen - 1;
        }
        for (i = 0; i < viminfo_hisidx [type]; i ++) {
            vim_free (history [type] [idx].hisstr);
            history [type] [idx].hisstr = viminfo_history [type] [i];
            if (--idx < 0) idx = hislen - 1;
        }
        idx += 1;
        idx %= hislen;
        for (i = 0; i < viminfo_hisidx [type]; i ++) {
    ...
    FILE * fp;
{
    ...
    for (type = 0; type < 5; ++type) {
        ...
        if (num_saved == 0) continue;
        if (num_saved < 0) num_saved = hislen;
        fprintf (fp, ((char *) ("\n# %s History (newest to oldest):\n")), type == 0 ? ((char *) ("Command Line")) : type == 1 ? ((char *) ("Search String")) :
          type == 2 ? ((char *) ("Expression")) : ((char *) ("Input Line")));
        if (num_saved > hislen) num_saved = hislen;
        i = hisidx [type];
        if (i >= 0) while (num_saved --) {
...
static int ex_window () {
    ...
    if (hislen > 0) {
        ...
        if (i >= 0) {
            ...
            do {
                if (++i == hislen) i = 0;
                if (history [histtype] [i].hisstr != ((void *) 0)) ml_append (lnum ++, history [histtype] [i].hisstr, (colnr_T) 0, 0);
            }
    ...
    if (restart_edit != 0) stuffcharReadbuff ((-((253)+((int)(KE_NOP)<<8))));
    i = RedrawingDisabled;
    RedrawingDisabled = 0;
    cmdwin_result = 0;
    main_loop (1, 0);
    ...
    if (!win_valid(old_curwin) || !buf_valid(old_curbuf)) {
        cmdwin_result = 3;
        emsg ((char_u *) (((char *) ("E199: Active window or buffer deleted"))));
    }
    else {
        if (aborting () && cmdwin_result != (-((253)+((int)(KE_IGNORE)<<8)))) cmdwin_result = 3;
        vim_free (ccline.cmdbuff);
        ...
        if (ccline.cmdbuff == ((void *) 0)) cmdwin_result = 3;
        else {
            ccline.cmdlen = (int) strlen ((char *) (ccline.cmdbuff));
            ccline.cmdbufflen = ccline.cmdlen + 1;
            ccline.cmdpos = curwin -> w_cursor.col;
            if (ccline.cmdpos > ccline.cmdlen) ccline.cmdpos = ccline.cmdlen;
        ...
        win_goto (old_curwin);
        win_close (wp, 1);
        if (buf_valid (bp)) close_buffer (((void *) 0), bp, 4);
    ...
    char_u * cmd;
{
    ...
    char dot [] = ".";
    garray_T ga;
    if (cmd [0] != '<' || cmd [1] != '<' || eap -> getline == ((void *) 0)) return ((void *) 0);
    ga_init2 (&ga, 1, 0x400);
    if (cmd [2] != '\000') end_pattern = (char *) skipwhite (cmd + 2);
    else end_pattern = dot;
    for (;;) {
        theline = eap -> getline (eap -> cstack -> cs_looplevel > 0 ? -1 : '\000', eap -> cookie, 0);

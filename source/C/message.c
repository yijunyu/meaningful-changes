...
static void verbose_write (char_u * s, int maxlen);
    ...
    int keep;
{
    ...
    int retval;
    char_u * buf = ((void *) 0);
    if (attr == 0) set_vim_var_string (5, s, -1);
    if (entered >= 3) return 1;
    ++entered;
    if (s != keep_msg || (*s != '<' && last_msg_hist != ((void *) 0) && last_msg_hist -> msg != ((void *) 0) && strcmp ((char *) (s), (char *) (last_msg_hist ->
      msg)))) add_msg_hist (s, -1, attr);
    if (s == keep_msg) keep_msg = ((void *) 0);
    msg_start ();
    ...
    msg_clr_eos ();
    retval = msg_end ();
    if (keep && retval && vim_strsize (s) < (int) (Rows - cmdline_row - 1) * Columns + sc_col) set_keep_msg (s, 0);
    vim_free (buf);
    --entered;
    return retval;
}
    ...
    int force;
{
    ...
    int len;
    int room;
    if ((!msg_scroll && !need_wait_return && shortmess ('T') && !exmode_active && msg_silent == 0) || force) {
        len = vim_strsize (s);
        if (msg_scrolled != 0) room = (int) (Rows - msg_row) * Columns - 1;
        else room = (int) (Rows - msg_row - 1) * Columns + sc_col - 1;
        if (len > room && room > 0) {
            buf = alloc (room + 2);
            if (buf != ((void *) 0)) trunc_string (s, buf, room);
        }
    }
    return buf;
}

void trunc_string (s, buf, room)
    char_u * s;
    char_u * buf;
    int room;
{
    ...
    i = e;
    {
        for (i = (int) strlen ((char *) (s)); len + (n = ptr2cells (s + i - 1)) <= room; --i) len += n;
    }
    ((__builtin_object_size ((char *) (buf + e), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (buf + e), (char *) ("..."), (size_t) 3,
      __builtin_object_size ((char *) (buf + e), 0)) : __inline_memmove_chk ((char *) (buf + e), (char *) ("..."), (size_t) 3));
    ((__builtin_object_size ((char *) ((buf + e + 3)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((buf + e + 3)), (char *) ((s + i)), strlen ((
      char *) (s + i)) + 1, __builtin_object_size ((char *) ((buf + e + 3)), 0)) : __inline_memmove_chk ((char *) ((buf + e + 3)), (char *) ((s + i)), strlen (
      (char *) (s + i)) + 1));
}
...
int smsg (char_u * s,...) {
    ...
    vim_vsnprintf ((char *) IObuff, (1024 + 1), (char *) s, arglist, ((void *) 0));
...
static int other_sourcing_name () {
    if (sourcing_name != ((void *) 0)) {
        if (last_sourcing_name != ((void *) 0)) return strcmp ((char *) (sourcing_name), (char *) (last_sourcing_name)) != 0;
        return 1;
    }
    return 0;
}
...
static char_u * get_emsg_source () {
    ...
    if (sourcing_name != ((void *) 0) && other_sourcing_name ()) {
        p = (char_u *) ((char *) ("Error detected while processing %s:"));
        Buf = alloc ((unsigned) (strlen ((char *) (sourcing_name)) + strlen ((char *) (p))));
        if (Buf != ((void *) 0)) __builtin___sprintf_chk ((char *) Buf, 0, __builtin_object_size ((char *) Buf, 1 > 1), (char *) p, sourcing_name);
        return Buf;
    }
    return ((void *) 0);
}
...
static char_u * get_emsg_lnum () {
    char_u * Buf, * p;
    if (sourcing_name != ((void *) 0) && (other_sourcing_name () || sourcing_lnum != last_sourcing_lnum) && sourcing_lnum != 0) {
        p = (char_u *) ((char *) ("line %4ld:"));
        Buf = alloc ((unsigned) (strlen ((char *) (p)) + 20));
        if (Buf != ((void *) 0)) __builtin___sprintf_chk ((char *) Buf, 0, __builtin_object_size ((char *) Buf, 1 > 1), (char *) p, (long) sourcing_lnum);
        return Buf;
    }
    return ((void *) 0);
}
    ...
    int attr;
{
    ...
    if (sourcing_name == ((void *) 0) || other_sourcing_name ()) {
        vim_free (last_sourcing_name);
        if (sourcing_name == ((void *) 0)) last_sourcing_name = ((void *) 0);
        else last_sourcing_name = vim_strsave (sourcing_name);
    }
    --no_wait_return;
}

int emsg_not_now () {
    if ((emsg_off > 0 && vim_strchr (p_debug, 'm') == ((void *) 0) && vim_strchr (p_debug, 't') == ((void *) 0)) || emsg_skip > 0) return 1;
    return 0;
}
    ...
    char_u * s;
{
    ...
    if (!emsg_off || vim_strchr (p_debug, 't') != ((void *) 0)) {
        if (cause_errthrow (s, severe, &ignore) == 1) {
            if (!ignore) did_emsg = 1;
            return 1;
        }
        set_vim_var_string (3, s, -1);
        if (emsg_silent != 0) {
            msg_start ();
            p = get_emsg_source ();
            if (p != ((void *) 0)) {
        ...
        msg_silent = 0;
        cmd_silent = 0;
        if (global_busy) ++global_busy;
        if (p_eb) beep_flush ();
        else flush_buffers (0);
        did_emsg = 1;
    }
    emsg_on_display = 1;
    ++msg_scroll;
    attr = highlight_attr [(int) (HLF_E)];
    if (msg_scrolled != 0) need_wait_return = 1;
    msg_source (attr);
    msg_nowait = 0;
...
void emsg_invreg (name)
    int name;
{
    emsg2 ((char_u *) (((char *) ("E354: Invalid register name: '%s'"))), (char_u *) (transchar (name)));
}
    ...
    char_u * s;
{
    ...
    if ((force || (shortmess ('t') && !exmode_active)) && (n = (int) strlen ((char *) (s)) - room) > 0) {
        s += n;
        * s = '<';
    }
    return s;
...
{
    struct msg_hist * p;
    if (msg_hist_off || msg_silent != 0) return;
    while (msg_hist_len > 200) (void) delete_first_msg ();
    ...
    if (p != ((void *) 0)) {
        ...
        p -> next = ((void *) 0);
        p -> attr = attr;
        if (last_msg_hist != ((void *) 0)) last_msg_hist -> next = p;
        last_msg_hist = p;
        if (first_msg_hist == ((void *) 0)) first_msg_hist = last_msg_hist;
        ++msg_hist_len;
    }
}
...
int delete_first_msg () {
    struct msg_hist * p;
    if (msg_hist_len <= 0) return 0;
    p = first_msg_hist;
    first_msg_hist = p -> next;
    if (first_msg_hist == ((void *) 0)) last_msg_hist = ((void *) 0);
    vim_free (p -> msg);
    vim_free (p);
    --msg_hist_len;
    return 1;
    ...
    exarg_T * eap __attribute__ ((unused));
{
    ...
    if (s != ((void *) 0) && *s != '\000') msg_attr ((char_u *) ((char *) ("Messages maintainer: Bram Moolenaar <Bram@vim.org>")), highlight_attr [(int) (HLF_T
      )]);
    for (p = first_msg_hist; p != ((void *) 0) && !got_int; p = p -> next) if (p -> msg != ((void *) 0)) msg_attr (p -> msg, p -> attr);
    msg_hist_off = 0;
}
    ...
    int redraw;
{
    ...
    int tmpState;
    int had_got_int;
    if (redraw == 1) must_redraw = 50;
    if (msg_silent != 0) return;
    if (vgetc_busy > 0) return;
    if (no_wait_return) {
        need_wait_return = 1;
    ...
    if (quit_more) {
        ...
        do {
            ...
            ++allow_keys;
            c = safe_vgetc ();
            if (had_got_int && !global_busy) got_int = 0;
            --no_mapping;
            --allow_keys;
            if (c == 25 && clip_star.state == 2) {
                clip_copy_modeless_selection (1);
                c = (-((253)+((int)(KE_IGNORE)<<8)));
            }
            if (p_more && !p_cp) {
                if (c == 'b' || c == 'k' || c == 'u' || c == 'g' || c == (-(('k')+((int)('u')<<8)))) {
                    do_more_prompt (c);
                    if (quit_more) {
                        c = '\015';
                        quit_more = 0;
                ...
                else if (msg_scrolled > Rows - 2 && (c == 'j' || c == (-(('k')+((int)('d')<<8))) || c == 'd' || c == 'f')) c = (-((253)+((int)(KE_IGNORE)<<8)))
                  ;
            }
        }
        while ((had_got_int && c == 3) || c == (-((253)+((int)(KE_IGNORE)<<8))) || c == (-((253)+((int)(KE_LEFTDRAG)<<8))) || c == 
          (-((253)+((int)(KE_LEFTRELEASE)<<8))) || c == (-((253)+((int)(KE_MIDDLEDRAG)<<8))) || c == (-((253)+((int)(KE_MIDDLERELEASE)<<8))) || c == 
          (-((253)+((int)(KE_RIGHTDRAG)<<8))) || c == (-((253)+((int)(KE_RIGHTRELEASE)<<8))) || c == (-((253)+((int)(KE_MOUSELEFT)<<8))) || c == 
          (-((253)+((int)(KE_MOUSERIGHT)<<8))) || c == (-((253)+((int)(KE_MOUSEDOWN)<<8))) || c == (-((253)+((int)(KE_MOUSEUP)<<8))) || (!mouse_has('r') &&
          mouse_row < msg_row && (c == (-((253)+((int)(KE_LEFTMOUSE)<<8))) || c == (-((253)+((int)(KE_MIDDLEMOUSE)<<8))) || c == 
          (-((253)+((int)(KE_RIGHTMOUSE)<<8))) || c == (-((253)+((int)(KE_X1MOUSE)<<8))) || c == (-((253)+((int)(KE_X2MOUSE)<<8))))));
        ui_breakcheck ();
        if (c == (-((253)+((int)(KE_LEFTMOUSE)<<8))) || c == (-((253)+((int)(KE_MIDDLEMOUSE)<<8))) || c == (-((253)+((int)(KE_RIGHTMOUSE)<<8))) || c == 
          (-((253)+((int)(KE_X1MOUSE)<<8))) || c == (-((253)+((int)(KE_X2MOUSE)<<8)))) (void) jump_to_mouse (0x08, ((void *) 0), 0);
    ...
    setmouse ();
    msg_check ();
    if (swapping_screen () && !termcap_active) newline_on_exit = 1;
    need_wait_return = 0;
    did_wait_return = 1;
    emsg_on_display = 0;
    lines_left = -1;
    reset_last_sourcing ();
    if (keep_msg != ((void *) 0) && vim_strsize (keep_msg) >= (Rows - cmdline_row - 1) * Columns + sc_col) {
        vim_free (keep_msg);
        keep_msg = ((void *) 0);
    }
    if (tmpState == 0x400) {
...
static void hit_return_msg () {
    ...
    if (got_int) msg_puts ((char_u *) (((char *) ("Interrupt: "))));
    msg_puts_attr ((char_u *) (((char *) ("Press ENTER or type command to continue"))), (highlight_attr [(int) (HLF_R)]));
    if (!msg_use_printf()) msg_clr_eos ();
    p_more = save_p_more;
}
...
{
    vim_free (keep_msg);
    if (s != ((void *) 0) && msg_silent == 0) keep_msg = vim_strsave (s);
    else keep_msg = ((void *) 0);
    keep_msg_more = 0;
    keep_msg_attr = attr;
}

void set_keep_msg_from_hist () {
    if (keep_msg == ((void *) 0) && last_msg_hist != ((void *) 0) && msg_scrolled == 0 && (State & 0x01)) set_keep_msg (last_msg_hist -> msg, last_msg_hist ->
      attr);
}
...
void msg_start () {
    ...
    if (!msg_scroll && full_screen) {
        ...
        msg_putchar ('\n');
        did_return = 1;
        if (exmode_active != 1) cmdline_row = msg_row;
    }
    if (!msg_didany || lines_left < 0) msg_starthere ();
    if (msg_silent == 0) {
        msg_didout = 0;
        cursor_off ();
    }
    if (!did_return) redir_write ((char_u *) "\n", -1);
}
...
{
    char_u buf [20];
    __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "%ld", n);
    msg_puts (buf);
}
    ...
    int attr;
{
    ...
    if (name != ((void *) 0)) msg_outtrans_attr (name, attr);
    vim_free (name);
}
    ...
    while (--len >= 0) {
        {
            s = transchar (*str);
            if (s [1] != '\000') {
                if (str > plain_start) msg_puts_attr_len (plain_start, (int) (str - plain_start), attr);
                plain_start = str + 1;
    ...
    char_u * arg;
{
    ...
    arg = skipwhite (arg);
    for (i = 5; *arg && i >= 0; --i) if (*arg++ != str [i]) break;
    if (i < 0) {
        msg_putchar ('\n');
        for (i = 0; rs [i]; ++i) msg_putchar (rs [i] - 3);
    }
}
    ...
    int from;
{
    ...
    while (*str != '\000') {
        ...
        else string = str2special (&str, from);
    ...
    int from;
{
    ...
    if (c == (0x80) && str [1] != '\000' && str [2] != '\000') {
        ...
        if (((c) < 0) || modifiers) special = 1;
    }
    * sp = str + 1;
    if (special || char2cells (c) > 1 || (from && c == ' ')) return get_special_key_name (c, modifiers);
    buf [0] = c;
    buf [1] = '\000';
    return buf;
}
    ...
    int len;
{
    ...
    * buf = '\000';
    while (*sp) {
        s = str2special (&sp, 0);
        if ((int) (strlen ((char *) (s)) + strlen ((char *) (buf))) < len) ((__builtin_object_size ((char *) (buf), 0) != (size_t) - 1) ? __builtin___strcat_chk
          ((char *) (buf), (char *) (s), __builtin_object_size ((char *) (buf), 1 > 1)) : __inline_strcat_chk ((char *) (buf), (char *) (s)));
    }
}
    ...
    int list;
{
    ...
    int attr = 0;
    char_u * trail = ((void *) 0);
    if (curwin -> w_onebuf_opt.wo_list) list = 1;
    if (list && lcs_trail) {
        trail = s + strlen ((char *) (s));
        while (trail > s && ((trail [-1]) == ' ' || (trail [-1]) == '\t')) --trail;
    }
    if (*s == '\000' && !(list&&lcs_eol!='\000')) msg_putchar (' ');
    while (!got_int) {
        if (n_extra > 0) {
            --n_extra;
            if (c_extra) c = c_extra;
            else c = *p_extra++;
        }
        else {
            attr = 0;
    ...
    int attr;
{
    ...
    if (msg_scrolled != 0 && !msg_scrolled_ign) need_wait_return = 1;
    msg_didany = 1;
    if (msg_use_printf ()) msg_puts_printf (str, maxlen);
    else msg_puts_display (str, maxlen, attr, 0);
}
    ...
    int recurse;
{
    ...
    while ((maxlen < 0 || (int) (s - str) < maxlen) && *s != '\000') {
        if (!recurse && msg_row >= Rows - 1 && (*s == '\n' || ((msg_col + t_col >= Columns - 1 || (*s == '\011' && msg_col + t_col >= ((Columns - 1) & ~7))))))
          {
            if (t_col > 0) t_puts (&t_col, t_s, s, attr);
            if (msg_no_more && lines_left == 0) break;
            msg_scroll_up ();
            msg_row = Rows - 2;
            if (msg_col >= Columns) msg_col = Columns - 1;
            if (*s >= ' ') {
                msg_screen_putchar (*s++, attr);
                did_last_char = 1;
            }
            else did_last_char = 0;
            if (p_more) store_sb_text (&sb_str, s, attr, &sb_col, 1);
            inc_msg_scrolled ();
            need_wait_return = 1;
            if (must_redraw < 10) must_redraw = 10;
            redraw_cmdline = 1;
            if (cmdline_row > 0 && !exmode_active) --cmdline_row;
            if (lines_left > 0) --lines_left;
            if (p_more && lines_left == 0 && State != (0x200 + 0x01) && !msg_no_more && !exmode_active) {
                if (do_more_prompt ('\000')) s = confirm_msg_tail;
                if (quit_more) return;
            }
            if (did_last_char) continue;
        }
        wrap = *s == '\n' || msg_col + t_col >= Columns;
        if (t_col > 0 && (wrap || *s == '\r' || *s == '\b' || *s == '\t' || *s == '\007')) t_puts (&t_col, t_s, s, attr);
        if (wrap && p_more && !recurse) store_sb_text (&sb_str, s, attr, &sb_col, 1);
        if (*s == '\n') {
            msg_didout = 0;
            msg_col = 0;
    ...
    if (t_col > 0) t_puts (&t_col, t_s, s, attr);
    if (p_more && !recurse) store_sb_text (&sb_str, s, attr, &sb_col, 0);
    msg_check ();
}
...
static void msg_scroll_up () {
    ...
    if (!can_clear((char_u*)" ")) {
        ...
        if (ScreenAttrs [LineOffset [Rows - 2] + Columns - 1] == (sattr_T) - 1) screen_fill ((int) Rows - 2, (int) Rows - 1, (int) Columns - 1, (int) Columns,
          ' ', ' ', 0);
    }
}

static void inc_msg_scrolled () {
    if (*get_vim_var_str(44) == '\000') {
        char_u * p = sourcing_name;
        char_u * tofree = ((void *) 0);
        int len;
        if (p == ((void *) 0)) p = (char_u *) ((char *) ("Unknown"));
        else {
    ...
    int finish;
{
    ...
    else if (finish && last_msgchunk != ((void *) 0)) last_msgchunk -> sb_eol = 1;
    * sb_str = s;
    * sb_col = 0;
}
...
void show_sb_text () {
    ...
    if (mp == ((void *) 0) || mp -> sb_prev == ((void *) 0)) vim_beep ();
    else {
        do_more_prompt ('G');
        wait_return (0);
    }
...
{
    msgchunk_T * mp = mps;
    while (mp != ((void *) 0) && mp -> sb_prev != ((void *) 0) && !mp->sb_prev->sb_eol) mp = mp -> sb_prev;
    return mp;
}
    ...
    msgchunk_T * smp;
{
    ...
    for (;;) {
        ...
        if (mp -> sb_eol || mp -> sb_next == ((void *) 0)) break;
        mp = mp -> sb_next;
    }
    return mp -> sb_next;
}
    ...
    int maxlen;
{
    ...
    while (*s != '\000' && (maxlen < 0 || (int) (s - str) < maxlen)) {
        if (!(silent_mode&&p_verbose==0)) {
            ...
            *p++ = *s;
            * p = '\0';
            if (info_message) printf ("%s", ((char *) buf));
            else fprintf (__stderrp, "%s", ((char *) buf));
        }
        {
            if (*s == '\r' || *s == '\n') msg_col = 0;
            else ++msg_col;
    ...
    int typed_char;
{
    ...
    if (typed_char == 'G') {
        ...
        for (i = 0; i < Rows - 2 && mp_last != ((void *) 0) && mp_last -> sb_prev != ((void *) 0); ++i) mp_last = msg_sb_start (mp_last -> sb_prev);
    }
    State = 0x300;
    setmouse ();
    if (typed_char == '\000') msg_moremsg (0);
    for (;;) {
        ...
        if (scroll != 0) {
            if (scroll < 0) {
                if (mp_last == ((void *) 0)) mp = msg_sb_start (last_msgchunk);
                else if (mp_last -> sb_prev != ((void *) 0)) mp = msg_sb_start (mp_last -> sb_prev);
                else mp = ((void *) 0);
                for (i = 0; i < Rows - 2 && mp != ((void *) 0) && mp -> sb_prev != ((void *) 0); ++i) mp = msg_sb_start (mp -> sb_prev);
                if (mp != ((void *) 0) && mp -> sb_prev != ((void *) 0)) {
                    for (i = 0; i > scroll; --i) {
                        if (mp == ((void *) 0) || mp -> sb_prev == ((void *) 0)) break;
                        mp = msg_sb_start (mp -> sb_prev);
                        if (mp_last == ((void *) 0)) mp_last = msg_sb_start (last_msgchunk);
                        else mp_last = msg_sb_start (mp_last -> sb_prev);
                    }
                    if (scroll == -1 && screen_ins_lines (0, 0, 1, (int) Rows, ((void *) 0)) == 1) {
...
{
    int attr;
    char_u * s = (char_u *) ((char *) ("-- More --"));
    attr = highlight_attr [(int) (HLF_M)];
    screen_puts (s, (int) Rows - 1, 0, attr);
    if (full) screen_puts ((char_u *) ((char *) (" SPACE/d/j: screen/page/line down, b/u/k: up, q: quit ")), (int) Rows - 1, vim_strsize (s), attr);
}
...
static int msg_check_screen () {
    if (!full_screen || !screen_valid(0)) return 0;
    if (msg_row >= Rows) msg_row = Rows - 1;
    if (msg_col >= Columns) msg_col = Columns - 1;
    return 1;
}
...
void msg_clr_eos () {
    if (msg_silent == 0) msg_clr_eos_force ();
}

void msg_clr_eos_force () {
    if (msg_use_printf ()) {
        if (full_screen) {
            if (*(term_strings[(int)(KS_CD)])) out_str ((term_strings [(int) (KS_CD)]));
            else if (*(term_strings[(int)(KS_CE)])) out_str ((term_strings [(int) (KS_CE)]));
        }
    }
    else {
        {
    ...
    int maxlen;
{
    ...
    if (redir_off) return;
    if (*p_vfile != '\000') verbose_write (s, maxlen);
    if (redirecting ()) {
        if (*s != '\n' && *s != '\r') {
            while (cur_col < msg_col) {
                if (redir_reg) write_reg_contents (redir_reg, (char_u *) " ", -1, 1);
                else if (redir_vname) var_redir_str ((char_u *) " ", -1);
                else if (redir_fd) fputs (" ", redir_fd);
                ++cur_col;
            }
        }
        if (redir_reg) write_reg_contents (redir_reg, s, maxlen, 1);
        if (redir_vname) var_redir_str (s, maxlen);
        while (*s != '\000' && (maxlen < 0 || (int) (s - str) < maxlen)) {
            if (!redir_reg && !redir_vname && redir_fd != ((void *) 0)) putc (*s, redir_fd);
            if (*s == '\r' || *s == '\n') cur_col = 0;
            else if (*s == '\t') cur_col += (8 - cur_col % 8);
            else ++cur_col;
            ++s;
        }
        if (msg_silent != 0) msg_col = cur_col;
    }
}

int redirecting () {
    return redir_fd != ((void *) 0) || redir_reg || redir_vname;
}

void verbose_enter () {
    if (*p_vfile != '\000') ++msg_silent;
}

void verbose_leave () {
    if (*p_vfile != '\000') if (--msg_silent < 0) msg_silent = 0;
}
...
int verbose_open () {
    if (verbose_fd == ((void *) 0) && !verbose_did_open) {
        ...
        if (verbose_fd == ((void *) 0)) {
            emsg2 ((char_u *) (((char *) (e_notopen))), (char_u *) (p_vfile));
            return 0;
        }
    }
    return 1;
...
static void verbose_write (str, maxlen)
    char_u * str;
    int maxlen;
{
    char_u * s = str;
    static int cur_col = 0;
    if (verbose_fd == ((void *) 0)) verbose_open ();
    if (verbose_fd != ((void *) 0)) {
        if (*s != '\n' && *s != '\r') {
            while (cur_col < msg_col) {
                fputs (" ", verbose_fd);
    ...
    int hl;
{
    if (msg_silent != 0) return;
    ++no_wait_return;
    set_vim_var_string (4, message, -1);
    vim_free (keep_msg);
    keep_msg = ((void *) 0);
    if (hl) keep_msg_attr = highlight_attr [(int) (HLF_W)];
    else keep_msg_attr = 0;
    if (msg_attr (message, keep_msg_attr) && msg_scrolled == 0) set_keep_msg (message, keep_msg_attr);
    msg_didout = 0;
    msg_nowait = 1;
    msg_col = 0;
    --no_wait_return;
    ...
    int col;
{
    ...
    while (msg_col < col) msg_putchar (' ');
}

int do_dialog (type, title, message, buttons, dfltbutton, textfield)
    int type __attribute__ ((unused));
    char_u * title __attribute__ ((unused));
    char_u * message;
    char_u * buttons;
    int dfltbutton;
    char_u * textfield __attribute__ ((unused));
{
    int oldState;
    int retval = 0;
    char_u * hotkeys;
    int c;
    int i;
    if (silent_mode) return dfltbutton;
    oldState = State;
    State = 0x800;
    setmouse ();
    ++no_wait_return;
...
{
    {
        if (lowercase) *to = (char_u) tolower (*from);
        else *to = *from;
        return 1;
    }
}
        ...
        while (*r) {
            if (*r == '\n') {
                if (copy) {
                    ...
                    *msgp++ = ' ';
                    ++hotkp;
                    hotkp [copy_char (r + 1, hotkp, 1)] = '\000';
                    if (dfltbutton) --dfltbutton;
                    if (idx < 30 - 1 && !has_hotkey[++idx]) first_hotkey = 1;
                }
                else {
                    len += 3;
                    lenhotkey += 1;
                    if (idx < 30 - 1) has_hotkey [++idx] = 0;
                }
            }
                ...
                if (copy) {
                    if (*r == '&') *msgp++ = *r;
                        ...
                        *msgp++ = (dfltbutton == 1) ? ']' : ')';
                        hotkp [copy_char (r, hotkp, 1)] = '\000';
                    }
                }
                else {
                    ++len;
                    if (idx < 30 - 1) has_hotkey [idx] = 1;
                }
            }
            else {
                if (copy) msgp += copy_char (r, msgp, 0);
            }
            ++r;
        }
        if (copy) {
            ...
            * msgp = '\000';
            ...
            len += (int) (strlen ((char *) (message)) + 2 + strlen ((char *) (buttons)) + 3);
            lenhotkey ++;
            if (!has_hotkey[0]) {
                first_hotkey = 1;
                len += 2;
            ...
            if (confirm_msg == ((void *) 0)) return ((void *) 0);
            * confirm_msg = '\000';
            hotk = alloc (lenhotkey);
            if (hotk == ((void *) 0)) return ((void *) 0);
            * confirm_msg = '\n';
            ((__builtin_object_size ((char *) (confirm_msg + 1), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (confirm_msg + 1), (char *) (message),
              __builtin_object_size ((char *) (confirm_msg + 1), 1 > 1)) : __inline_strcpy_chk ((char *) (confirm_msg + 1), (char *) (message)));
            msgp = confirm_msg + 1 + strlen ((char *) (message));
            hotkp = hotk;
            hotkp [copy_char (buttons, hotkp, 1)] = '\000';
...
void display_confirm_msg () {
    ++confirm_msg_used;
    if (confirm_msg != ((void *) 0)) msg_puts_attr (confirm_msg, highlight_attr [(int) (HLF_M)]);
    --confirm_msg_used;
}
...
int vim_dialog_yesno (type, title, message, dflt)
    ...
    int dflt;
{
    if (do_dialog (type, title == ((void *) 0) ? (char_u *) ((char *) ("Question")) : title, message, (char_u *) ((char *) ("&Yes\n&No")), dflt, ((void *) 0))
      == 1) return 2;
    return 3;
}
...
int vim_dialog_yesnocancel (type, title, message, dflt)
    ...
    int dflt;
{
    switch (do_dialog (type, title == ((void *) 0) ? (char_u *) ((char *) ("Question")) : title, message, (char_u *) ((char *) ("&Yes\n&No\n&Cancel")), dflt, (
      (void *) 0))) {
    case 1 :
        return 2;
    case 2 :
...
int vim_dialog_yesnoallcancel (type, title, message, dflt)
    ...
    int dflt;
{
    switch (do_dialog (type, title == ((void *) 0) ? (char_u *) "Question" : title, message, (char_u *) ((char *) (
      "&Yes\n&No\nSave &All\n&Discard All\n&Cancel")), dflt, ((void *) 0))) {
    case 1 :
        return 2;
    case 2 :
    ...
    int * idxp;
{
    ...
    long n = 0;
    int err = 0;
    if (tvs [idx].v_type == 0) emsg ((char_u *) (((char *) (e_printf))));
    else {
        ++*idxp;
    ...
    int * idxp;
{
    ...
    if (tvs [idx].v_type == 0) emsg ((char_u *) (((char *) (e_printf))));
        ...
        ++*idxp;
        if (tvs [idx].v_type == 6) f = tvs [idx].vval.v_float;
        else if (tvs [idx].v_type == 1) f = tvs [idx].vval.v_number;
        else emsg ((char_u *) (((char *) ("E807: Expected Float argument for printf()"))));
    }
    return f;
}
    ...
    typval_T * tvs;
{
    ...
    while (*p != '\000') {
        if (*p != '%') {
            char * q = strchr (p + 1, '%');
            size_t n = (q == ((void *) 0)) ? strlen ((char *) (p)) : (size_t) (q - p);
            if (str_l < str_m) {
                size_t avail = str_m - str_l;
                ((__builtin_object_size ((char *) (str + str_l), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (str + str_l), (char *) (p), n > avail
                  ? avail : n, __builtin_object_size ((char *) (str + str_l), 0)) : __inline_memmove_chk ((char *) (str + str_l), (char *) (p), n > avail ?
                  avail : n));
            }
            p += n;
            str_l += n;
            ...
            if (*p == '*') {
                int j;
                p ++;
                j = tvs != ((void *) 0) ? tv_nr (tvs, &arg_idx) : __builtin_va_arg (ap, int);
            ...
            else if ((((int) (*p)) >= '0' && ((int) (*p)) <= '9')) {
                unsigned int uj = *p++ - '0';
                while ((((int) (*p)) >= '0' && ((int) (*p)) <= '9')) uj = 10 * uj + (unsigned int) (*p++ - '0');
                min_field_width = uj;
            }
            if (*p == '.') {
                p ++;
            ...
            case 's' :
                ...
                case 's' :
                    str_arg = tvs != ((void *) 0) ? tv_str (tvs, &arg_idx) : __builtin_va_arg (ap, char *);
                    if (str_arg == ((void *) 0)) {
                        str_arg = "[NULL]";
                        str_arg_l = 6;
                    }
                        ...
                        str_arg_l = (q == ((void *) 0)) ? precision : (size_t) (q - str_arg);
                    }
                    break;
                default :
                    break;
            ...
            case 'p' :
                {
                    ...
                    if (fmt_spec == 'p') {
                        length_modifier = '\0';
                        ptr_arg = tvs != ((void *) 0) ? (void *) tv_str (tvs, &arg_idx) : __builtin_va_arg (ap, void *);
                        if (ptr_arg != ((void *) 0)) arg_sign = 1;
                    }
                    else if (fmt_spec == 'd') {
                        switch (length_modifier) {
                        case '\0' :
                        case 'h' :
                            int_arg = tvs != ((void *) 0) ? tv_nr (tvs, &arg_idx) : __builtin_va_arg (ap, int);
                            if (int_arg > 0) arg_sign = 1;
                            else if (int_arg < 0) arg_sign = -1;
                            break;
                        case 'l' :
                            long_arg = tvs != ((void *) 0) ? tv_nr (tvs, &arg_idx) : __builtin_va_arg (ap, long int);
                        ...
                        case '\0' :
                        case 'h' :
                            uint_arg = tvs != ((void *) 0) ? (unsigned) tv_nr (tvs, &arg_idx) : __builtin_va_arg (ap, unsigned int);
                            if (uint_arg != 0) arg_sign = 1;
                            break;
                        case 'l' :
                            ulong_arg = tvs != ((void *) 0) ? (unsigned long) tv_nr (tvs, &arg_idx) : __builtin_va_arg (ap, unsigned long int);
                    ...
                    if (precision == 0 && arg_sign == 0) {
                        ...
                        f [f_l ++] = fmt_spec;
                        f [f_l ++] = '\0';
                        if (fmt_spec == 'p') str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f,
                          ptr_arg);
                        else if (fmt_spec == 'd') {
                            switch (length_modifier) {
                            case '\0' :
                            case 'h' :
                                str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, int_arg);
                                break;
                            case 'l' :
                                str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, long_arg);
                                break;
                            }
                        }
                        else {
                            ...
                            case '\0' :
                            case 'h' :
                                str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, uint_arg);
                                break;
                            case 'l' :
                                str_arg_l += __builtin___sprintf_chk (tmp + str_arg_l, 0, __builtin_object_size (tmp + str_arg_l, 1 > 1), f, ulong_arg);
                                break;
                            }
                        }
                        if (zero_padding_insertion_ind < str_arg_l && tmp [zero_padding_insertion_ind] == '-') zero_padding_insertion_ind ++;
                        if (zero_padding_insertion_ind + 1 < str_arg_l && tmp [zero_padding_insertion_ind] == '0' && (tmp [zero_padding_insertion_ind + 1] ==
                          'x' || tmp [zero_padding_insertion_ind + 1] == 'X')) zero_padding_insertion_ind += 2;
                    }
                    {
            ...
            case 'G' :
                {
                    ...
                    f = tvs != ((void *) 0) ? tv_float (tvs, &arg_idx) : __builtin_va_arg (ap, double);
                    abs_f = f < 0 ? -f : f;
                    if (fmt_spec == 'g' || fmt_spec == 'G') {
                        if ((abs_f >= 0.001 && abs_f < 10000000.0) || abs_f == 0.0) fmt_spec = 'f';
                        else fmt_spec = fmt_spec == 'g' ? 'e' : 'E';
                        remove_trailing_zeroes = 1;
                    }
                    if (fmt_spec == 'f' && abs_f > 1.0e307) {
                        ((__builtin_object_size (tmp, 0) != (size_t) - 1) ? __builtin___strcpy_chk (tmp, "inf", __builtin_object_size (tmp, 1 > 1)) :
                          __inline_strcpy_chk (tmp, "inf"));
                        str_arg_l = 3;
                    }
                    else {
                        format [0] = '%';
                        ...
                        if (precision_specified) {
                            ...
                            if (fmt_spec == 'f' && abs_f > 1.0) max_prec -= (size_t) log10 (abs_f);
                            if (precision > max_prec) precision = max_prec;
                            l += __builtin___sprintf_chk (format + 1, 0, __builtin_object_size (format + 1, 1 > 1), ".%d", (int) precision);
                        }
                        format [l] = fmt_spec;
                        format [l + 1] = '\000';
                        str_arg_l = __builtin___sprintf_chk (tmp, 0, __builtin_object_size (tmp, 1 > 1), format, f);
                        if (remove_trailing_zeroes) {
                            int i;
                            char * tp;
                            if (fmt_spec == 'f') tp = tmp + str_arg_l - 1;
                            else {
                                tp = (char *) vim_strchr ((char_u *) tmp, fmt_spec == 'e' ? 'e' : 'E');
                                if (tp != ((void *) 0)) {
                                    if (tp [1] == '+') {
                                        ((__builtin_object_size ((char *) ((tp + 1)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((tp + 1)), (char
                                          *) ((tp + 2)), strlen ((char *) (tp + 2)) + 1, __builtin_object_size ((char *) ((tp + 1)), 0)) : __inline_memmove_chk
                                          ((char *) ((tp + 1)), (char *) ((tp + 2)), strlen ((char *) (tp + 2)) + 1));
                                        --str_arg_l;
                                    }
                                    i = (tp [1] == '-') ? 2 : 1;
                                    while (tp [i] == '0') {
                                        ((__builtin_object_size ((char *) ((tp + i)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((tp + i)), (char
                                          *) ((tp + i + 1)), strlen ((char *) (tp + i + 1)) + 1, __builtin_object_size ((char *) ((tp + i)), 0)) :
                                          __inline_memmove_chk ((char *) ((tp + i)), (char *) ((tp + i + 1)), strlen ((char *) (tp + i + 1)) + 1));
                                        --str_arg_l;
                                    }
                                    --tp;
                                }
                            }
                            if (tp != ((void *) 0) && !precision_specified) while (tp > tmp + 2 && *tp == '0' && tp [-1] != '.') {
                                ((__builtin_object_size ((char *) ((tp)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((tp)), (char *) ((tp + 1)),
                                  strlen ((char *) (tp + 1)) + 1, __builtin_object_size ((char *) ((tp)), 0)) : __inline_memmove_chk ((char *) ((tp)), (char *)
                                  ((tp + 1)), strlen ((char *) (tp + 1)) + 1));
                                --tp;
                                --str_arg_l;
                            }
                        }
                            ...
                            char * tp;
                            tp = (char *) vim_strchr ((char_u *) tmp, fmt_spec == 'e' ? 'e' : 'E');
                            if (tp != ((void *) 0) && (tp [1] == '+' || tp [1] == '-') && tp [2] == '0' && vim_isdigit (tp [3]) && vim_isdigit (tp [4])) {
                                ((__builtin_object_size ((char *) ((tp + 2)), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) ((tp + 2)), (char *) ((tp
                                  + 3)), strlen ((char *) (tp + 3)) + 1, __builtin_object_size ((char *) ((tp + 2)), 0)) : __inline_memmove_chk ((char *) ((tp +
                                  2)), (char *) ((tp + 3)), strlen ((char *) (tp + 3)) + 1));
                                --str_arg_l;
                            }
                        }
                    }
            ...
            if (!justify_left) {
                ...
                if (pn > 0) {
                    if (str_l < str_m) {
                        size_t avail = str_m - str_l;
                        ((__builtin_object_size ((str + str_l), 0) != (size_t) - 1) ? __builtin___memset_chk ((str + str_l), (zero_padding ? '0' : ' '), ((
                          size_t) pn > avail ? avail : (size_t) pn), __builtin_object_size ((str + str_l), 0)) : __inline_memset_chk ((str + str_l), (
                          zero_padding ? '0' : ' '), ((size_t) pn > avail ? avail : (size_t) pn)));
                    }
                    str_l += pn;
                }
            }
            if (number_of_zeros_to_pad == 0) {
                ...
                if (zn > 0) {
                    if (str_l < str_m) {
                        size_t avail = str_m - str_l;
                        ((__builtin_object_size ((char *) (str + str_l), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (str + str_l), (char *) (
                          str_arg), (size_t) zn > avail ? avail : (size_t) zn, __builtin_object_size ((char *) (str + str_l), 0)) : __inline_memmove_chk ((char
                          *) (str + str_l), (char *) (str_arg), (size_t) zn > avail ? avail : (size_t) zn));
                    }
                    str_l += zn;
                }
                ...
                if (zn > 0) {
                    if (str_l < str_m) {
                        size_t avail = str_m - str_l;
                        ((__builtin_object_size ((str + str_l), 0) != (size_t) - 1) ? __builtin___memset_chk ((str + str_l), ('0'), ((size_t) zn > avail ? avail
                          : (size_t) zn), __builtin_object_size ((str + str_l), 0)) : __inline_memset_chk ((str + str_l), ('0'), ((size_t) zn > avail ? avail :
                          (size_t) zn)));
                    }
                    str_l += zn;
                }
            }
            {
                ...
                if (sn > 0) {
                    if (str_l < str_m) {
                        size_t avail = str_m - str_l;
                        ((__builtin_object_size ((char *) (str + str_l), 0) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (str + str_l), (char *) (
                          str_arg + zero_padding_insertion_ind), (size_t) sn > avail ? avail : (size_t) sn, __builtin_object_size ((char *) (str + str_l), 0)) :
                          __inline_memmove_chk ((char *) (str + str_l), (char *) (str_arg + zero_padding_insertion_ind), (size_t) sn > avail ? avail : (size_t)
                          sn));
                    }
                    str_l += sn;
                }
            ...
            if (justify_left) {
                ...
                if (pn > 0) {
                    if (str_l < str_m) {
                        size_t avail = str_m - str_l;
                        ((__builtin_object_size ((str + str_l), 0) != (size_t) - 1) ? __builtin___memset_chk ((str + str_l), (' '), ((size_t) pn > avail ? avail
                          : (size_t) pn), __builtin_object_size ((str + str_l), 0)) : __inline_memset_chk ((str + str_l), (' '), ((size_t) pn > avail ? avail :
                          (size_t) pn)));
                    }
                    str_l += pn;
                }
    ...
    if (tvs != ((void *) 0) && tvs [arg_idx - 1].v_type != 0) emsg ((char_u *) (((char *) ("E767: Too many arguments to printf()"))));
    return (int) str_l;
}

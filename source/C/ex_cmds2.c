...
{0, 0, sizeof (scriptitem_T), 4, ((void *) 0)};
    ...
    char_u * cmd;
{
    ...
    redir_off = 1;
    State = 0x01;
    if (!debug_did_msg) msg ((char_u *) (((char *) ("Entering Debug mode.  Type \"cont\" to continue."))));
    if (sourcing_name != ((void *) 0)) msg (sourcing_name);
    if (sourcing_lnum != 0) smsg ((char_u *) ((char *) ("line %ld: %s")), (long) sourcing_lnum, cmd);
    else smsg ((char_u *) ((char *) ("cmd: %s")), cmd);
    for (;;) {
        msg_scroll = 1;
        need_wait_return = 0;
        ...
        cmdline = getcmdline_prompt ('>', ((void *) 0), 0, 0, ((void *) 0));
        if (typeahead_saved) {
        ...
        if (cmdline != ((void *) 0)) {
            ...
            if (*p != '\000') {
                ...
                if (last_cmd != 0) {
                    ...
                    if (((*p) < 0x7f && isalpha (*p))) last_cmd = 0;
                }
            }
            if (last_cmd != 0) {
                switch (last_cmd) {
    ...
    exarg_T * eap;
{
    ...
    if (debug_breakpoint_name != ((void *) 0)) {
        if (!eap->skip) {
            if (debug_breakpoint_name [0] == (0x80) && debug_breakpoint_name [1] == 253 && debug_breakpoint_name [2] == (int) KE_SNR) p = (char_u *) "<SNR>";
            else p = (char_u *) "";
            smsg ((char_u *) ((char *) ("Breakpoint in \"%s%s\" line %ld")), p, debug_breakpoint_name + (*p == '\000' ? 0 : 3), (long) debug_breakpoint_lnum);
...
static garray_T dbg_breakp =
{0, 0, sizeof (struct debuggy), 4, ((void *) 0)};
    ...
    garray_T * gap;
{
    ...
    bp = &(((structdebuggy*)gap->ga_data)[gap->ga_len]);
    if (strncmp ((char *) (p), (char *) ("func"), (size_t) (4)) == 0) bp -> dbg_type = 1;
    else if (strncmp ((char *) (p), (char *) ("file"), (size_t) (4)) == 0) bp -> dbg_type = 2;
    else if (strncmp ((char *) (p), (char *) ("here"), (size_t) (4)) == 0) {
    ...
    p = skipwhite (p + 4);
    if (here) bp -> dbg_lnum = curwin -> w_cursor.lnum;
    else if (((*p) >= '0' && (*p) <= '9')) {
        bp -> dbg_lnum = getdigits (&p);
        p = skipwhite (p);
    }
    else bp -> dbg_lnum = 0;
    if ((!here && *p == '\000') || (here && *p != '\000') || (bp -> dbg_type == 1 && strstr ((char *) p, "()") != ((void *) 0))) {
        emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (arg));
        return 0;
    }
    if (bp -> dbg_type == 1) bp -> dbg_name = vim_strsave (p);
    else if (here) bp -> dbg_name = vim_strsave (curbuf -> b_ffname);
    else {
        q = expand_env_save (p);
    ...
    if (bp -> dbg_name == ((void *) 0)) return 0;
    return 1;
}
    ...
    exarg_T * eap;
{
    ...
    if (dbg_parsearg (eap -> arg, gap) == 1) {
        ...
        if (pat == ((void *) 0) || bp -> dbg_prog == ((void *) 0)) vim_free (bp -> dbg_name);
        else {
            if (bp -> dbg_lnum == 0) bp -> dbg_lnum = 1;
            {
...
void ex_debuggreedy (eap)
    exarg_T * eap;
{
    if (eap -> addr_count == 0 || eap -> line2 != 0) debug_greedy = 1;
    else debug_greedy = 0;
}
    ...
    exarg_T * eap;
{
    ...
    if (vim_isdigit (*eap->arg)) {
        ...
        for (i = 0; i < gap -> ga_len; ++i) if ((((struct debuggy *) gap -> ga_data) [i]).dbg_nr == nr) {
            todel = i;
            break;
        }
    }
        ...
        if (dbg_parsearg (eap -> arg, gap) == 0) return;
        bp = &(((structdebuggy*)gap->ga_data)[gap->ga_len]);
        for (i = 0; i < gap -> ga_len; ++i) {
            bpi = &(((structdebuggy*)gap->ga_data)[i]);
            if (bp -> dbg_type == bpi -> dbg_type && strcmp ((char *) (bp -> dbg_name), (char *) (bpi -> dbg_name)) == 0 && (bp -> dbg_lnum == bpi -> dbg_lnum
    ...
    if (todel < 0) emsg2 ((char_u *) (((char *) ("E161: Breakpoint not found: %s"))), (char_u *) (eap -> arg));
    else {
        while (gap -> ga_len > 0) {
            vim_free ((((struct debuggy *) gap -> ga_data) [todel]).dbg_name);
            vim_free ((((struct debuggy *) gap -> ga_data) [todel]).dbg_prog);
            --gap->ga_len;
            if (todel < gap -> ga_len) ((__builtin_object_size ((char *) (&(((structdebuggy*)gap->ga_data)[todel])), 0) != (size_t) - 1) ?
              __builtin___memmove_chk ((char *) (&(((structdebuggy*)gap->ga_data)[todel])), (char *) (&(((structdebuggy*)gap->ga_data)[todel+1])), (gap ->
              ga_len - todel) * sizeof (struct debuggy), __builtin_object_size ((char *) (&(((structdebuggy*)gap->ga_data)[todel])), 0)) : __inline_memmove_chk
              ((char *) (&(((structdebuggy*)gap->ga_data)[todel])), (char *) (&(((structdebuggy*)gap->ga_data)[todel+1])), (gap -> ga_len - todel) * sizeof (
              struct debuggy)));
            ++debug_tick;
            if (!del_all) break;
        }
        if (gap -> ga_len == 0) ga_clear (gap);
    }
}
    ...
    exarg_T * eap __attribute__ ((unused));
{
    struct debuggy * bp;
    int i;
    if (dbg_breakp.ga_len == 0) msg ((char_u *) (((char *) ("No breakpoints defined"))));
    else for (i = 0; i < dbg_breakp.ga_len; ++i) {
        bp = &(((structdebuggy*)dbg_breakp.ga_data)[i]);
        smsg ((char_u *) ((char *) ("%3d  %s %s  line %ld")), bp -> dbg_nr, bp -> dbg_type == 1 ? "func" : "file", bp -> dbg_name, (long) bp -> dbg_lnum);
    }
}
    ...
    int * fp;
{
    ...
    char_u * name = fname;
    int prev_got_int;
    if (gap -> ga_len == 0) return (linenr_T) 0;
    if (!file && fname [0] == (0x80)) {
        name = alloc ((unsigned) strlen ((char *) (fname)) + 3);
        if (name == ((void *) 0)) name = fname;
        else {
            ((__builtin_object_size ((char *) (name), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (name), (char *) ("<SNR>"), __builtin_object_size (
              (char *) (name), 1 > 1)) : __inline_strcpy_chk ((char *) (name), (char *) ("<SNR>")));
            ((__builtin_object_size ((char *) (name + 5), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (name + 5), (char *) (fname + 3),
              __builtin_object_size ((char *) (name + 5), 1 > 1)) : __inline_strcpy_chk ((char *) (name + 5), (char *) (fname + 3)));
        }
    }
    for (i = 0; i < gap -> ga_len; ++i) {
        bp = &(((structdebuggy*)gap->ga_data)[i]);
        if (((bp -> dbg_type == 2) == file && ((bp -> dbg_lnum > after && (lnum == 0 || bp -> dbg_lnum < lnum))))) {
            ...
            if (vim_regexec (&regmatch, name, (colnr_T) 0)) {
                lnum = bp -> dbg_lnum;
                if (fp != ((void *) 0)) *fp = bp -> dbg_forceit;
            }
            got_int |= prev_got_int;
        }
    }
    if (name != fname) vim_free (name);
    return lnum;
}
...
{
    static char buf [50];
    __builtin___sprintf_chk (buf, 0, __builtin_object_size (buf, 1 > 1), "%3ld.%06ld", (long) tm -> tv_sec, (long) tm -> tv_usec);
    return buf;
}
...
{
    int r;
    if (!(p_aw||p_awa) || !p_write || bt_dontwrite (buf) || (!forceit && buf -> b_p_ro) || buf -> b_ffname == ((void *) 0)) return 0;
    r = buf_write_all (buf, forceit);
    if (buf_valid (buf) && bufIsChanged (buf)) r = 0;
    return r;
}

void autowrite_all () {
    buf_T * buf;
    if (!(p_aw||p_awa) || !p_write) return;
    for (buf = firstbuf; buf; buf = buf -> b_next) if (bufIsChanged (buf) && !buf->b_p_ro) {
        (void) buf_write_all (buf, 0);
        if (!buf_valid(buf)) buf = firstbuf;
    }
}

int check_changed (buf, checkaw, mult_win, forceit, allbuf)
    buf_T * buf;
    int checkaw;
    int mult_win;
    int forceit;
    int allbuf __attribute__ ((unused));
{
    if (!forceit && bufIsChanged (buf) && (mult_win || buf -> b_nwindows <= 1) && (!checkaw || autowrite (buf, forceit) == 0)) {
        if ((p_confirm || cmdmod.confirm) && p_write) {
            buf_T * buf2;
            int count = 0;
            if (allbuf) for (buf2 = firstbuf; buf2 != ((void *) 0); buf2 = buf2 -> b_next) if (bufIsChanged (buf2) && (buf2 -> b_ffname != ((void *) 0))) 
              ++count;
            if (!buf_valid(buf)) return 0;
    ...
    int checkall;
{
    ...
    int ret;
    buf_T * buf2;
    dialog_msg (buff, ((char *) ("Save changes to \"%s\"?")), (buf -> b_fname != ((void *) 0)) ? buf -> b_fname : (char_u *) ((char *) ("Untitled")));
    if (checkall) ret = vim_dialog_yesnoallcancel (4, ((void *) 0), buff, 1);
    else ret = vim_dialog_yesnocancel (4, ((void *) 0), buff, 1);
    if (ret == 2) {
        if (buf -> b_fname != ((void *) 0)) (void) buf_write_all (buf, 0);
    }
    else if (ret == 3) {
        unchanged (buf, 1);
    }
    else if (ret == 5) {
        for (buf2 = firstbuf; buf2 != ((void *) 0); buf2 = buf2 -> b_next) {
            if (bufIsChanged (buf2) && (buf2 -> b_ffname != ((void *) 0)) && !buf2->b_p_ro) {
                if (buf2 -> b_fname != ((void *) 0)) (void) buf_write_all (buf2, 0);
                if (!buf_valid(buf2)) buf2 = firstbuf;
            }
        }
    }
    else if (ret == 6) {
        for (buf2 = firstbuf; buf2 != ((void *) 0); buf2 = buf2 -> b_next) unchanged (buf2, 1);
    }
}
...
int can_abandon (buf, forceit)
    ...
    int forceit;
{
    return ((buf_hide (buf)) || !bufIsChanged(buf) || buf -> b_nwindows > 1 || autowrite (buf, forceit) == 1 || forceit);
}
    ...
    int hidden;
{
    ...
    win_T * wp;
    for (;;) {
        if (!hidden && curbufIsChanged ()) buf = curbuf;
        else {
            for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) if ((!hidden || buf -> b_nwindows == 0) && bufIsChanged (buf)) break;
        }
        if (buf == ((void *) 0)) return 0;
        if (check_changed (buf, p_awa, 1, 0, 1) && buf_valid (buf)) break;
    }
    exiting = 0;
    if (!(p_confirm||cmdmod.confirm)) {
        ...
        if (emsg2 ((char_u *) (((char *) ("E162: No write since last change for buffer \"%s\""))), (char_u *) (buf_spname (buf) != ((void *) 0) ? (char_u *)
    ...
    if (buf != curbuf) for (wp = firstwin; wp != ((void *) 0); wp = wp -> w_next) if (wp -> w_buffer == buf) {
        win_goto (wp);
        if (!buf_valid(buf)) return 1;
        break;
    }
    if (buf != curbuf) set_curbuf (buf, 0);
    return 1;
}
    ...
    int forceit;
{
    ...
    retval = (buf_write (buf, buf -> b_ffname, buf -> b_fname, (linenr_T) 1, buf -> b_ml.ml_line_count, ((void *) 0), 0, forceit, 1, 0));
    if (curbuf != old_curbuf) {
        msg_source (highlight_attr [(int) (HLF_W)]);
        msg ((char_u *) (((char *) ("Warning: Entered other buffer unexpectedly (check autocommands)"))));
    }
    return retval;
}
    ...
    for (p = str; *str; ++str) {
        if (rem_backslash (str)) {
            ...
            *p++ = *str;
            ...
            if (!inbacktick && vim_isspace (*str)) break;
            if (*str == '`') inbacktick ^= 1;
            *p++ = *str;
        }
    }
...
int get_arglist_exp (str, fcountp, fnamesp)
    char_u * str;
    int * fcountp;
    char_u * * * fnamesp;
{
    garray_T ga;
    int i;
    if (get_arglist (&ga, str) == 0) return 0;
    i = gen_expand_wildcards (ga.ga_len, (char_u * *) ga.ga_data, fcountp, fnamesp, 0x02 | 0x04);
    ga_clear (&ga);
    return i;
}
    ...
    int after __attribute__ ((unused));
{
    ...
    char_u * p;
    int match;
    if (get_arglist (&new_ga, str) == 0) return 0;
    if (what == 3) {
        regmatch_T regmatch;
        int didone;
        regmatch.rm_ic = 1;
        for (i = 0; i < new_ga.ga_len && !got_int; ++i) {
            ...
            didone = 0;
            for (match = 0; match < ((curwin) -> w_alist -> al_ga.ga_len); ++match) if (vim_regexec (&regmatch, alist_name 
              (&((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[match]), (colnr_T) 0)) {
                didone = 1;
                vim_free (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) [match].ae_fname);
                ((__builtin_object_size ((char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + match), 0) != (size_t) - 1) ? __builtin___memmove_chk (
                  (char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + match), (char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + match
                  + 1), (((curwin) -> w_alist -> al_ga.ga_len) - match - 1) * sizeof (aentry_T), __builtin_object_size ((char *) (((aentry_T *) (curwin) ->
                  w_alist -> al_ga.ga_data) + match), 0)) : __inline_memmove_chk ((char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + match), (char
                  *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + match + 1), (((curwin) -> w_alist -> al_ga.ga_len) - match - 1) * sizeof (aentry_T)
                  ));
                --(curwin)->w_alist->al_ga.ga_len;
                if (curwin -> w_arg_idx > match) --curwin->w_arg_idx;
                --match;
            }
            vim_free (regmatch.regprog);
            vim_free (p);
            if (!didone) emsg2 ((char_u *) (((char *) (e_nomatch2))), (char_u *) (((char_u * *) new_ga.ga_data) [i]));
        }
        ga_clear (&new_ga);
    }
    else {
        i = expand_wildcards (new_ga.ga_len, (char_u * *) new_ga.ga_data, &exp_count, &exp_files, 0x01 | 0x02 | 0x08 | 0x04);
        ga_clear (&new_ga);
        if (i == 0) return 0;
        if (exp_count == 0) {
        ...
        else alist_set ((curwin) -> w_alist, exp_count, exp_files, 0, ((void *) 0), 0);
    }
    alist_check_arg_idx ();
    return 1;
}
...
static void alist_check_arg_idx () {
    ...
    for ((tp) = first_tabpage; (tp) != ((void *) 0); (tp) = (tp) -> tp_next) for ((win) = ((tp) == curtab) ? firstwin : (tp) -> tp_firstwin; (win); (win) = (
      win) -> w_next) if (win -> w_alist == curwin -> w_alist) check_arg_idx (win);
}

static int editing_arg_idx (win)
    win_T * win;
{
    return !(win->w_arg_idx>=((win)->w_alist->al_ga.ga_len)||(win->w_buffer->b_fnum!=((aentry_T*)(win)->w_alist->al_ga.ga_data)[win->w_arg_idx].ae_fnum&&(win->
      w_buffer->b_ffname==((void*)0)||!(fullpathcmp(alist_name(&((aentry_T*)(win)->w_alist->al_ga.ga_data)[win->w_arg_idx]), win -> w_buffer -> b_ffname, 1) & 1
      ))));
}
    ...
    win_T * win;
{
    if (((win) -> w_alist -> al_ga.ga_len) > 1 && !editing_arg_idx(win)) {
        ...
        if (win -> w_arg_idx != ((win) -> w_alist -> al_ga.ga_len) - 1 && arg_had_last == 0 && (win) -> w_alist == &global_alist && (global_alist.al_ga.ga_len)
          > 0 && win -> w_arg_idx < (global_alist.al_ga.ga_len) && (win -> w_buffer -> b_fnum == ((aentry_T *) global_alist.al_ga.ga_data) [(global_alist.al_ga
          .ga_len) - 1].ae_fnum || (win -> w_buffer -> b_ffname != ((void *) 0) && (fullpathcmp (alist_name 
          (&((aentry_T*)global_alist.al_ga.ga_data)[(global_alist.al_ga.ga_len)-1]), win -> w_buffer -> b_ffname, 1) & 1)))) arg_had_last = 1;
    }
    else {
        win -> w_arg_idx_invalid = 0;
        if (win -> w_arg_idx == ((win) -> w_alist -> al_ga.ga_len) - 1 && win -> w_alist == &global_alist) arg_had_last = 1;
    }
}
    ...
    exarg_T * eap;
{
    ...
    if (eap -> cmdidx != CMD_args) {
        ...
        if (eap -> cmdidx == CMD_argglobal) (curwin) -> w_alist = &global_alist;
        else alist_new ();
    }
    if (!ends_excmd(*eap->arg)) {
        ...
        if (((curwin) -> w_alist -> al_ga.ga_len) > 0) {
            ...
            for (i = 0; i < ((curwin) -> w_alist -> al_ga.ga_len); ++i) {
                if (i == curwin -> w_arg_idx) msg_putchar ('[');
        ...
        if (ga_grow (gap, (global_alist.al_ga.ga_len)) == 1) for (i = 0; i < (global_alist.al_ga.ga_len); ++i) if (((aentry_T *) global_alist.al_ga.ga_data) [i
          ].ae_fname != ((void *) 0)) {
            ((aentry_T *) ((curwin -> w_alist) -> al_ga.ga_data)) [gap -> ga_len].ae_fname = vim_strsave (((aentry_T *) global_alist.al_ga.ga_data) [i].
              ae_fname);
...
void ex_previous (eap)
    exarg_T * eap;
{
    if (curwin -> w_arg_idx - (int) eap -> line2 >= ((curwin) -> w_alist -> al_ga.ga_len)) do_argfile (eap, ((curwin) -> w_alist -> al_ga.ga_len) - 1);
    else do_argfile (eap, curwin -> w_arg_idx - (int) eap -> line2);
}
...
{
    int i;
    if (eap -> addr_count > 0) i = eap -> line2 - 1;
    else i = curwin -> w_arg_idx;
    do_argfile (eap, i);
}
    ...
    int argn;
{
    ...
    if (argn < 0 || argn >= ((curwin) -> w_alist -> al_ga.ga_len)) {
        if (((curwin) -> w_alist -> al_ga.ga_len) <= 1) emsg ((char_u *) (((char *) ("E163: There is only one file to edit"))));
        else if (argn < 0) emsg ((char_u *) (((char *) ("E164: Cannot go before first file"))));
        else emsg ((char_u *) (((char *) ("E165: Cannot go beyond last file"))));
    }
    else {
        setpcmark ();
        if (*eap->cmd == 's' || cmdmod.tab != 0) {
            if (win_split (0, 0) == 0) return;
            ...
            if ((!(buf_hide(curbuf)) || !other) && check_changed (curbuf, 1, !other, eap -> forceit, 0)) return;
        }
        curwin -> w_arg_idx = argn;
        if (argn == ((curwin) -> w_alist -> al_ga.ga_len) - 1 && curwin -> w_alist == &global_alist) arg_had_last = 1;
        if (do_ecmd (0, alist_name (&((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[curwin->w_arg_idx]), ((void *) 0), eap, (linenr_T) - 1, ((buf_hide (curwin ->
          w_buffer)) ? 0x01 : 0) + (eap -> forceit ? 0x08 : 0), curwin) == 0) curwin -> w_arg_idx = old_arg_idx;
        else if (eap -> cmdidx != CMD_argdo) setmark ('\'');
    }
}
...
{
    int i;
    if ((buf_hide (curbuf)) || eap -> cmdidx == CMD_snext || !check_changed(curbuf,1,0,eap->forceit,0)) {
        if (*eap->arg != '\000') {
            if (do_arglist (eap -> arg, 1, 0) == 0) return;
            i = 0;
        }
    ...
    exarg_T * eap;
{
    ...
    int i;
    char_u * s;
    fnum = buflist_add (eap -> arg, 2);
    for (i = 0; i < ((curwin) -> w_alist -> al_ga.ga_len); ++i) if (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) [i].ae_fnum == fnum) break;
    if (i == ((curwin) -> w_alist -> al_ga.ga_len)) {
        s = vim_strsave (eap -> arg);
        if (s == ((void *) 0)) return;
        i = alist_add_list (1, &s, eap -> addr_count > 0 ? (int) eap -> line2 : curwin -> w_arg_idx + 1);
        if (i < 0) return;
        curwin -> w_arg_idx = i;
    }
    alist_check_arg_idx ();
...
void ex_argadd (eap)
    exarg_T * eap;
{
    do_arglist (eap -> arg, 2, eap -> addr_count > 0 ? (int) eap -> line2 : curwin -> w_arg_idx + 1);
    maketitle ();
}
    ...
    exarg_T * eap;
{
    ...
    int n;
    if (eap -> addr_count > 0) {
        if (eap -> line2 > ((curwin) -> w_alist -> al_ga.ga_len)) eap -> line2 = ((curwin) -> w_alist -> al_ga.ga_len);
        n = eap -> line2 - eap -> line1 + 1;
        if (*eap->arg != '\000' || n <= 0) emsg ((char_u *) (((char *) (e_invarg))));
        else {
            for (i = eap -> line1; i <= eap -> line2; ++i) vim_free (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) [i - 1].ae_fname);
            ((__builtin_object_size ((char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + eap -> line1 - 1), 0) != (size_t) - 1) ?
              __builtin___memmove_chk ((char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + eap -> line1 - 1), (char *) (((aentry_T *) (curwin) ->
              w_alist -> al_ga.ga_data) + eap -> line2), (size_t) ((((curwin) -> w_alist -> al_ga.ga_len) - eap -> line2) * sizeof (aentry_T)),
              __builtin_object_size ((char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + eap -> line1 - 1), 0)) : __inline_memmove_chk ((char *) ((
              (aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + eap -> line1 - 1), (char *) (((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) + eap ->
              line2), (size_t) ((((curwin) -> w_alist -> al_ga.ga_len) - eap -> line2) * sizeof (aentry_T))));
            (curwin) -> w_alist -> al_ga.ga_len -= n;
            if (curwin -> w_arg_idx >= eap -> line2) curwin -> w_arg_idx -= n;
            else if (curwin -> w_arg_idx > eap -> line1) curwin -> w_arg_idx = eap -> line1;
        }
    }
    else if (*eap->arg == '\000') emsg ((char_u *) (((char *) (e_argreq))));
    else do_arglist (eap -> arg, 3, 0);
    maketitle ();
}
    ...
    exarg_T * eap;
{
    ...
    char_u * p_shm_save;
    if (eap -> cmdidx != CMD_windo && eap -> cmdidx != CMD_tabdo) save_ei = au_event_disable (",Syntax");
    if (eap -> cmdidx == CMD_windo || eap -> cmdidx == CMD_tabdo || (buf_hide (curbuf)) || !check_changed(curbuf,1,0,eap->forceit,0)) {
        i = 0;
        wp = firstwin;
        tp = first_tabpage;
        if (eap -> cmdidx == CMD_bufdo) goto_buffer (eap, 1, 1, 0);
        else setpcmark ();
        listcmd_busy = 1;
        while (!got_int) {
            if (eap -> cmdidx == CMD_argdo) {
                if (i == ((curwin) -> w_alist -> al_ga.ga_len)) break;
                ...
                if (curwin -> w_arg_idx != i) break;
                ++i;
            }
            else if (eap -> cmdidx == CMD_windo) {
                if (!win_valid(wp)) break;
                win_goto (wp);
                if (curwin != wp) break;
                wp = curwin -> w_next;
            }
                ...
                next_fnum = -1;
                for (buf = curbuf -> b_next; buf != ((void *) 0); buf = buf -> b_next) if (buf -> b_p_bl) {
            ...
            if (eap -> cmdidx == CMD_bufdo) {
                if (next_fnum < 0) break;
                for (buf = firstbuf; buf != ((void *) 0); buf = buf -> b_next) if (buf -> b_fnum == next_fnum) break;
                if (buf == ((void *) 0)) break;
                p_shm_save = vim_strsave (p_shm);
                set_option_value ((char_u *) "shm", 0L, (char_u *) "", 0);
                goto_buffer (eap, 1, 1, next_fnum);
                set_option_value ((char_u *) "shm", 0L, p_shm_save, 0);
                vim_free (p_shm_save);
                if (curbuf -> b_fnum != next_fnum) break;
            }
...
{
    int i;
    if (ga_grow (&(curwin)->w_alist->al_ga, count) == 1) {
        if (after < 0) after = 0;
        if (after > ((curwin) -> w_alist -> al_ga.ga_len)) after = ((curwin) -> w_alist -> al_ga.ga_len);
        if (after < ((curwin) -> w_alist -> al_ga.ga_len)) ((__builtin_object_size ((char *) (&(((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[after+count])), 0
          ) != (size_t) - 1) ? __builtin___memmove_chk ((char *) (&(((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[after+count])), (char *) 
          (&(((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[after])), (((curwin) -> w_alist -> al_ga.ga_len) - after) * sizeof (aentry_T), __builtin_object_size
          ((char *) (&(((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[after+count])), 0)) : __inline_memmove_chk ((char *) 
          (&(((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[after+count])), (char *) (&(((aentry_T*)(curwin)->w_alist->al_ga.ga_data)[after])), (((curwin) ->
          w_alist -> al_ga.ga_len) - after) * sizeof (aentry_T)));
        for (i = 0; i < count; ++i) {
            ((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) [after + i].ae_fname = files [i];
            ((aentry_T *) (curwin) -> w_alist -> al_ga.ga_data) [after + i].ae_fnum = buflist_add (files [i], 2);
        }
        (curwin) -> w_alist -> al_ga.ga_len += count;
        if (curwin -> w_arg_idx >= after) ++curwin->w_arg_idx;
        return after;
    }
    for (i = 0; i < count; ++i) vim_free (files [i]);
    return -1;
}
    ...
    exarg_T * eap;
{
    ...
    if (*eap->arg == '\000') {
        ...
        buf = alloc ((unsigned) (strlen ((char *) (eap -> arg)) + 14));
        if (buf != ((void *) 0)) {
            if (eap -> forceit) {
                ...
                if (old_cur_comp != ((void *) 0)) old_cur_comp = vim_strsave (old_cur_comp);
            ...
            __builtin___sprintf_chk ((char *) buf, 0, __builtin_object_size ((char *) buf, 1 > 1), "compiler/%s.vim", eap -> arg);
            if (source_runtime (buf, 1) == 0) emsg2 ((char_u *) (((char *) ("E666: compiler not supported: %s"))), (char_u *) (eap -> arg));
            vim_free (buf);
            do_cmdline_cmd ((char_u *) ":delcommand CompilerSet");
            p = get_var_value ((char_u *) "g:current_compiler");
            if (p != ((void *) 0)) set_internal_string_var ((char_u *) "b:current_compiler", p);
            if (!eap->forceit) {
                if (old_cur_comp != ((void *) 0)) {
                    set_internal_string_var ((char_u *) "g:current_compiler", old_cur_comp);
                    vim_free (old_cur_comp);
                }
                else do_unlet ((char_u *) "g:current_compiler", 1);
            }
        }
    }
}
    ...
    void * cookie;
{
    ...
    buf = alloc (1024);
    if (buf != ((void *) 0) && rtp_copy != ((void *) 0)) {
        if (p_verbose > 1) {
            verbose_enter ();
            smsg ((char_u *) ((char *) ("Searching for \"%s\" in \"%s\"")), (char *) name, (char *) p_rtp);
            verbose_leave ();
        }
        rtp = rtp_copy;
        while (*rtp != '\000' && (all || !did_one)) {
            copy_option_part (&rtp, buf, 1024, ",");
            if (strlen ((char *) (buf)) + strlen ((char *) (name)) + 2 < 1024) {
                add_pathsep (buf);
                tail = buf + strlen ((char *) (buf));
                np = name;
                while (*np != '\000' && (all || !did_one)) {
                    copy_option_part (&np, tail, (int) (1024 - (tail - buf)), "\t ");
                    if (p_verbose > 2) {
                        verbose_enter ();
                        smsg ((char_u *) ((char *) ("Searching for \"%s\"")), buf);
                        verbose_leave ();
                    }
                    if (gen_expand_wildcards (1, &buf, &num_files, &files, 0x02) == 1) {
    ...
    if (p_verbose > 0 && !did_one) {
        verbose_enter ();
        smsg ((char_u *) ((char *) ("not found in 'runtimepath': \"%s\"")), name);
        verbose_leave ();
    }
    return did_one ? 1 : 0;
}
...
static void cmd_source (fname, eap)
    ...
    exarg_T * eap;
{
    if (*fname == '\000') emsg ((char_u *) (((char *) (e_argreq))));
    else if (eap != ((void *) 0) && eap -> forceit) openscript (fname, global_busy || listcmd_busy || eap -> nextcmd != ((void *) 0) || eap -> cstack -> cs_idx
      >= 0);
    else if (do_source (fname, 0, 0) == 0) emsg2 ((char_u *) (((char *) (e_notopen))), (char_u *) (fname));
}
...
linenr_T * source_breakpoint (cookie)
    void * cookie;
{
    return &((structsource_cookie*)cookie)->breakpoint;
}

int * source_dbg_tick (cookie)
    void * cookie;
{
    return &((structsource_cookie*)cookie)->dbg_tick;
}
...
static FILE * fopen_noinh_readbin (filename)
    char * filename;
{
    int fd_tmp = open ((filename), (0x0000), (0));
    if (fd_tmp == -1) return ((void *) 0);
    {
        int fdflags = fcntl (fd_tmp, 1);
        if (fdflags >= 0 && (fdflags & 1) == 0) fcntl (fd_tmp, 2, fdflags | 1);
    }
    ...
    int is_vimrc;
{
    ...
    if (p == ((void *) 0)) return retval;
    fname_exp = fix_fname (p);
    vim_free (p);
    if (fname_exp == ((void *) 0)) return retval;
    if (mch_isdir (fname_exp)) {
        smsg ((char_u *) ((char *) ("Cannot source a directory: \"%s\"")), fname);
        goto theend;
    }
    if (has_autocmd (EVENT_SOURCECMD, fname_exp, ((void *) 0)) && apply_autocmds (EVENT_SOURCECMD, fname_exp, fname_exp, 0, curbuf)) {
        retval = aborting () ? 0 : 1;
        goto theend;
    }
    ...
    if (cookie.fp == ((void *) 0) && check_other) {
        p = gettail (fname_exp);
        if ((*p == '.' || *p == '_') && (strcasecmp ((char *) (p + 1), (char *) ("vimrc")) == 0 || strcasecmp ((char *) (p + 1), (char *) ("gvimrc")) == 0 ||
    ...
    if (cookie.fp == ((void *) 0)) {
        if (p_verbose > 0) {
            verbose_enter ();
            if (sourcing_name == ((void *) 0)) smsg ((char_u *) ((char *) ("could not source \"%s\"")), fname);
            else smsg ((char_u *) ((char *) ("line %ld: could not source \"%s\"")), sourcing_lnum, fname);
            verbose_leave ();
        }
        goto theend;
    }
    if (p_verbose > 1) {
        verbose_enter ();
        if (sourcing_name == ((void *) 0)) smsg ((char_u *) ((char *) ("sourcing \"%s\"")), fname);
        else smsg ((char_u *) ((char *) ("line %ld: sourcing \"%s\"")), sourcing_lnum, fname);
        verbose_leave ();
    }
    if (is_vimrc == 1) vimrc_found (fname_exp, (char_u *) "MYVIMRC");
    else if (is_vimrc == 2) vimrc_found (fname_exp, (char_u *) "MYGVIMRC");
    ...
    sourcing_lnum = 0;
    if (time_fd != ((void *) 0)) time_push (&tv_rel, &tv_start);
    save_funccalp = save_funccal ();
    save_current_SID = current_SID;
    stat_ok = (stat (((char *) fname_exp), (&st)) >= 0);
    for (current_SID = script_items.ga_len; current_SID > 0; --current_SID) {
        si = &(((scriptitem_T*)script_items.ga_data)[(current_SID)-1]);
        if (si -> sn_name != ((void *) 0) && (((stat_ok && si -> sn_dev_valid) && (si -> sn_dev == st.st_dev && si -> sn_ino == st.st_ino)) || strcasecmp ((
          char *) (((si -> sn_name))), (char *) (((fname_exp)))) == 0)) break;
    }
    if (current_SID == 0) {
        current_SID = ++last_current_SID;
        if (ga_grow (&script_items, (int) (current_SID - script_items.ga_len)) == 0) goto almosttheend;
        ...
        else si -> sn_dev_valid = 0;
        new_script_vars (current_SID);
    }
    do_cmdline (firstline, getsourceline, (void *) &cookie, 0x01 | 0x02 | 0x04);
    retval = 1;
    ...
    if (p_verbose > 1) {
        verbose_enter ();
        smsg ((char_u *) ((char *) ("finished sourcing %s")), fname);
        if (sourcing_name != ((void *) 0)) smsg ((char_u *) ((char *) ("continuing in %s")), sourcing_name);
        verbose_leave ();
    }
    if (time_fd != ((void *) 0)) {
    ...
    if (save_debug_break_level > ex_nesting_level && debug_break_level == ex_nesting_level) ++debug_break_level;
    almosttheend : current_SID = save_current_SID;
    restore_funccal (save_funccalp);
    fclose (cookie.fp);
    vim_free (cookie.nextline);
    vim_free (firstline);
    theend : vim_free (fname_exp);
    return retval;
}
...
{
    int i;
    for (i = 1; i <= script_items.ga_len && !got_int; ++i) if ((((scriptitem_T *) script_items.ga_data) [(i) - 1]).sn_name != ((void *) 0)) smsg ((char_u *)
      "%3d: %s", i, (((scriptitem_T *) script_items.ga_data) [(i) - 1]).sn_name);
}

char_u * get_scriptname (id)
    scid_T id;
{
    if (id == -1) return (char_u *) ((char *) ("modeline"));
    if (id == -2) return (char_u *) ((char *) ("--cmd argument"));
    if (id == -3) return (char_u *) ((char *) ("-c argument"));
    if (id == -4) return (char_u *) ((char *) ("environment variable"));
    if (id == -5) return (char_u *) ((char *) ("error handler"));
    ...
    int indent __attribute__ ((unused));
{
    ...
    if (sp -> finished) line = ((void *) 0);
    else if (sp -> nextline == ((void *) 0)) line = get_one_sourceline (sp);
    else {
        line = sp -> nextline;
        sp -> nextline = ((void *) 0);
        ++sourcing_lnum;
    ...
    if (line != ((void *) 0) && (vim_strchr (p_cpo, 'C') == ((void *) 0))) {
        ...
        for (;;) {
            ...
            if (sp -> nextline == ((void *) 0)) break;
            p = skipwhite (sp -> nextline);
            if (*p != '\\') break;
            s = alloc ((unsigned) (strlen ((char *) (line)) + strlen ((char *) (p))));
            if (s == ((void *) 0)) break;
            ((__builtin_object_size ((char *) (s), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (s), (char *) (line), __builtin_object_size ((char *)
              (s), 1 > 1)) : __inline_strcpy_chk ((char *) (s), (char *) (line)));
            ((__builtin_object_size ((char *) (s), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (s), (char *) (p + 1), __builtin_object_size ((char *
              ) (s), 1 > 1)) : __inline_strcat_chk ((char *) (s), (char *) (p + 1)));
            vim_free (line);
            line = s;
    ...
    struct source_cookie * sp;
{
    ...
    sourcing_lnum ++;
    for (;;) {
        if (ga_grow (&ga, 120) == 0) break;
        buf = (char_u *) ga.ga_data;
        if (fgets ((char *) buf + ga.ga_len, ga.ga_maxlen - ga.ga_len, sp -> fp) == ((void *) 0)) break;
    ...
    if (have_read) return (char_u *) ga.ga_data;
    vim_free (ga.ga_data);
    return ((void *) 0);
}
...
void ex_finish (eap)
    exarg_T * eap;
{
    if (getline_equal (eap -> getline, eap -> cookie, getsourceline)) do_finish (eap, 0);
    else emsg ((char_u *) (((char *) ("E168: :finish used outside of a sourced file"))));
}
...
{
    int idx;
    if (reanimate) ((struct source_cookie *) getline_cookie (eap -> getline, eap -> cookie)) -> finished = 0;
    idx = cleanup_conditionals (eap -> cstack, 0, 1);
    if (idx >= 0) {
        eap -> cstack -> cs_pending [idx] = 32;
        report_make_pending (32, ((void *) 0));
    }
    else ((struct source_cookie *) getline_cookie (eap -> getline, eap -> cookie)) -> finished = 1;
}
    ...
    exarg_T * eap;
{
    ...
    if (eap -> addr_count == 0) check_timestamps (0);
    else {
        buf = buflist_findnr ((int) eap -> line2);
        if (buf != ((void *) 0)) (void) buf_check_timestamp (buf, 0);
    }
...
{
    char * loc;
    loc = setlocale (what, ((void *) 0));
    return loc;
}

char_u * get_mess_lang () {
    char_u * p;
    p = (char_u *) get_locale_val (6);
    return p;
}
...
void set_lang_var () {
    ...
    set_vim_var_string (14, loc, -1);
    loc = (char_u *) get_locale_val (6);
    set_vim_var_string (12, loc, -1);
    loc = (char_u *) get_locale_val (5);
    set_vim_var_string (13, loc, -1);
}

    ...
    int * ignore;
{
    ...
    if (suppress_errthrow) return 0;
    if (!did_emsg) {
        cause_abort = force_abort;
        force_abort = 0;
    }
    if (((trylevel == 0 && !cause_abort) || emsg_silent) && !did_throw) return 0;
    if (mesg == (char_u *) ((char *) (e_interr))) {
        * ignore = 1;
        return 1;
    }
    cause_abort = 1;
    if (did_throw) {
        if (current_exception -> type == 2) got_int = 0;
        discard_current_exception ();
    }
    {
        if (msg_list != ((void *) 0)) {
            plist = msg_list;
            while (*plist != ((void *) 0)) plist = &(*plist) -> next;
                ...
                if (elem -> msg == ((void *) 0)) {
                    ...
                    * plist = elem;
                    if (plist == msg_list || severe) {
                        char_u * tmsg;
                        tmsg = elem -> msg;
                        if (strncmp ((char *) (tmsg), (char *) ("Vim E"), (size_t) (5)) == 0 && ((tmsg [5]) >= '0' && (tmsg [5]) <= '9') && ((tmsg [6]) >= '0'
                          && (tmsg [6]) <= '9') && ((tmsg [7]) >= '0' && (tmsg [7]) <= '9') && tmsg [8] == ':' && tmsg [9] == ' ') (*msg_list) -> throw_msg = 
                          &tmsg[4];
                        else (*msg_list) -> throw_msg = tmsg;
                    }
                }
            }
        }
    ...
    char_u * cmdname;
{
    ...
    if (msg_list == ((void *) 0) || *msg_list == ((void *) 0)) return;
    if (throw_exception (*msg_list, 1, cmdname) == 0) free_msglist (*msg_list);
    else {
        if (cstack != ((void *) 0)) do_throw (cstack);
        else need_rethrow = 1;
    }
    * msg_list = ((void *) 0);
}
...
int do_intthrow (cstack)
    struct condstack * cstack;
{
    if (!got_int || (trylevel == 0 && !did_throw)) return 0;
    {
        if (did_throw) {
            if (current_exception -> type == 2) return 0;
            discard_current_exception ();
        }
        if (throw_exception ("Vim:Interrupt", 2, ((void *) 0)) != 0) do_throw (cstack);
    }
    return 1;
}
    ...
    char_u * cmdname;
{
    ...
    int cmdlen;
    if (type == 0) {
        if (strncmp ((char *) ((char_u *) value), (char *) ("Vim"), (size_t) (3)) == 0 && (((char_u *) value) [3] == '\000' || ((char_u *) value) [3] == ':' ||
          ((char_u *) value) [3] == '(')) {
            emsg ((char_u *) (((char *) ("E608: Cannot :throw exceptions with 'Vim' prefix"))));
            goto fail;
        }
    }
    excp = (except_T *) alloc ((unsigned) sizeof (except_T));
    if (excp == ((void *) 0)) goto nomem;
    if (type == 1) {
        excp -> messages = (struct msglist *) value;
        mesg = excp -> messages -> throw_msg;
        if (cmdname != ((void *) 0) && *cmdname != '\000') {
            cmdlen = (int) strlen ((char *) (cmdname));
            excp -> value = vim_strnsave ((char_u *) "Vim(", 4 + cmdlen + 2 + (int) strlen ((char *) (mesg)));
            if (excp -> value == ((void *) 0)) goto nomem;
            ((__builtin_object_size ((char *) (&excp->value[4]), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (&excp->value[4]), (char *) (cmdname),
              __builtin_object_size ((char *) (&excp->value[4]), 1 > 1)) : __inline_strcpy_chk ((char *) (&excp->value[4]), (char *) (cmdname)));
            ((__builtin_object_size ((char *) (&excp->value[4+cmdlen]), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (&excp->value[4+cmdlen]), (char *
              ) ("):"), __builtin_object_size ((char *) (&excp->value[4+cmdlen]), 1 > 1)) : __inline_strcpy_chk ((char *) (&excp->value[4+cmdlen]), (char *) (
              "):")));
            val = excp -> value + 4 + cmdlen + 2;
        }
        else {
            excp -> value = vim_strnsave ((char_u *) "Vim:", 4 + (int) strlen ((char *) (mesg)));
            if (excp -> value == ((void *) 0)) goto nomem;
            val = excp -> value + 4;
        }
        for (p = mesg;; p ++) {
            if (*p == '\000' || (*p == 'E' && ((p [1]) >= '0' && (p [1]) <= '9') && (p [2] == ':' || (((p [2]) >= '0' && (p [2]) <= '9') && (p [3] == ':' || ((
              (p [3]) >= '0' && (p [3]) <= '9') && p [4] == ':')))))) {
                if (*p == '\000' || p == mesg) ((__builtin_object_size ((char *) (val), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (val), (char *) (
                  mesg), __builtin_object_size ((char *) (val), 1 > 1)) : __inline_strcat_chk ((char *) (val), (char *) (mesg)));
                else {
                    if (mesg [0] != '"' || p - 2 < &mesg[1] || p [-2] != '"' || p [-1] != ' ') continue;
                    ((__builtin_object_size ((char *) (val), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (val), (char *) (p), __builtin_object_size (
                      (char *) (val), 1 > 1)) : __inline_strcat_chk ((char *) (val), (char *) (p)));
                    p [-2] = '\000';
                    __builtin___sprintf_chk ((char *) (val + strlen ((char *) (p))), 0, __builtin_object_size ((char *) (val + strlen ((char *) (p))), 1 > 1),
                      " (%s)", &mesg[1]);
                    p [-2] = '"';
                }
                break;
    ...
    else excp -> value = value;
    excp -> type = type;
    excp -> throw_name = vim_strsave (sourcing_name == ((void *) 0) ? (char_u *) "" : sourcing_name);
    if (excp -> throw_name == ((void *) 0)) {
        if (type == 1) vim_free (excp -> value);
        goto nomem;
    }
    excp -> throw_lnum = sourcing_lnum;
    if (p_verbose >= 13 || debug_break_level > 0) {
        int save_msg_silent = msg_silent;
        if (debug_break_level > 0) msg_silent = 0;
        else verbose_enter ();
        ++no_wait_return;
        if (debug_break_level > 0 || *p_vfile == '\000') msg_scroll = 1;
        smsg ((char_u *) ((char *) ("Exception thrown: %s")), excp -> value);
        msg_puts ((char_u *) "\n");
        if (debug_break_level > 0 || *p_vfile == '\000') cmdline_row = msg_row;
        --no_wait_return;
        if (debug_break_level > 0) msg_silent = save_msg_silent;
        else verbose_leave ();
    }
    ...
    int was_finished;
{
    ...
    if (p_verbose >= 13 || debug_break_level > 0) {
        ...
        ++no_wait_return;
        if (debug_break_level > 0 || *p_vfile == '\000') msg_scroll = 1;
        smsg (was_finished ? (char_u *) ((char *) ("Exception finished: %s")) : (char_u *) ((char *) ("Exception discarded: %s")), excp -> value);
        msg_puts ((char_u *) "\n");
        if (debug_break_level > 0 || *p_vfile == '\000') cmdline_row = msg_row;
        --no_wait_return;
        if (debug_break_level > 0) msg_silent = save_msg_silent;
        else verbose_leave ();
        ((__builtin_object_size ((char *) (IObuff), 0) != (size_t) - 1) ? __builtin___strcpy_chk ((char *) (IObuff), (char *) (saved_IObuff),
          __builtin_object_size ((char *) (IObuff), 1 > 1)) : __inline_strcpy_chk ((char *) (IObuff), (char *) (saved_IObuff)));
        vim_free (saved_IObuff);
    }
    if (excp -> type != 2) vim_free (excp -> value);
    if (excp -> type == 1) free_msglist (excp -> messages);
    ...
    except_T * excp;
{
    ...
    caught_stack = excp;
    set_vim_var_string (29, excp -> value, -1);
    if (*excp->throw_name != '\000') {
        if (excp -> throw_lnum != 0) vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) ("%s, line %ld")), excp -> throw_name, (long) excp -> throw_lnum);
        else vim_snprintf ((char *) IObuff, (1024 + 1), "%s", excp -> throw_name);
        set_vim_var_string (30, IObuff, -1);
    }
    else set_vim_var_string (30, ((void *) 0), -1);
    if (p_verbose >= 13 || debug_break_level > 0) {
        int save_msg_silent = msg_silent;
        if (debug_break_level > 0) msg_silent = 0;
        else verbose_enter ();
        ++no_wait_return;
        if (debug_break_level > 0 || *p_vfile == '\000') msg_scroll = 1;
        smsg ((char_u *) ((char *) ("Exception caught: %s")), excp -> value);
        msg_puts ((char_u *) "\n");
        if (debug_break_level > 0 || *p_vfile == '\000') cmdline_row = msg_row;
        --no_wait_return;
        if (debug_break_level > 0) msg_silent = save_msg_silent;
...
static void finish_exception (excp)
    except_T * excp;
{
    if (excp != caught_stack) emsg ((char_u *) (((char *) (e_internal))));
    caught_stack = caught_stack -> caught;
    if (caught_stack != ((void *) 0)) {
        set_vim_var_string (29, caught_stack -> value, -1);
        if (*caught_stack->throw_name != '\000') {
            if (caught_stack -> throw_lnum != 0) vim_snprintf ((char *) IObuff, (1024 + 1), ((char *) ("%s, line %ld")), caught_stack -> throw_name, (long)
              caught_stack -> throw_lnum);
            else vim_snprintf ((char *) IObuff, (1024 + 1), "%s", caught_stack -> throw_name);
            set_vim_var_string (30, IObuff, -1);
        }
        else set_vim_var_string (30, ((void *) 0), -1);
    }
    else {
        set_vim_var_string (29, ((void *) 0), -1);
        set_vim_var_string (30, ((void *) 0), -1);
    }
    ...
    void * value;
{
    ...
    switch (action) {
    case 0 :
        mesg = (char_u *) ((char *) ("%s made pending"));
        break;
    case 1 :
        mesg = (char_u *) ((char *) ("%s resumed"));
        break;
    default :
        mesg = (char_u *) ((char *) ("%s discarded"));
        break;
    }
    switch (pending) {
    case 0 :
    ...
    default :
        if (pending & 4) {
            vim_snprintf ((char *) IObuff, (1024 + 1), (char *) mesg, ((char *) ("Exception")));
            mesg = vim_strnsave (IObuff, (int) strlen ((char *) (IObuff)) + 4);
            ((__builtin_object_size ((char *) (mesg), 0) != (size_t) - 1) ? __builtin___strcat_chk ((char *) (mesg), (char *) (": %s"), __builtin_object_size (
              (char *) (mesg), 1 > 1)) : __inline_strcat_chk ((char *) (mesg), (char *) (": %s")));
            s = (char *) ((except_T *) value) -> value;
        }
        else if ((pending & 1) && (pending & 2)) s = ((char *) ("Error and interrupt"));
        else if (pending & 1) s = ((char *) ("Error"));
        else s = ((char *) ("Interrupt"));
    }
    ...
    --no_wait_return;
    if (debug_break_level > 0) msg_silent = save_msg_silent;
    if (pending == 24) vim_free (s);
    else if (pending & 4) vim_free (mesg);
}
    ...
    void * value;
{
    if (p_verbose >= 14 || debug_break_level > 0) {
        if (debug_break_level <= 0) verbose_enter ();
        report_pending (0, pending, value);
        if (debug_break_level <= 0) verbose_leave ();
    }
}
    ...
    exarg_T * eap;
{
    ...
    if (cstack -> cs_idx == 50 - 1) eap -> errmsg = (char_u *) "E579: :if nesting too deep";
    else {
        ++cstack->cs_idx;
        cstack -> cs_flags [cstack -> cs_idx] = 0;
        skip = did_emsg || got_int || did_throw || (cstack -> cs_idx > 0 && !(cstack->cs_flags[cstack->cs_idx-1]&0x0002));
        result = eval_to_bool (eap -> arg, &error, &eap->nextcmd, skip);
        if (!skip && !error) {
            if (result) cstack -> cs_flags [cstack -> cs_idx] = 0x0002 | 0x0001;
        }
        else cstack -> cs_flags [cstack -> cs_idx] = 0x0001;
    }
}
...
{
    did_endif = 1;
    if (eap -> cstack -> cs_idx < 0 || (eap -> cstack -> cs_flags [eap -> cstack -> cs_idx] & (0x0008 | 0x0010 | 0x0100))) eap -> errmsg = (char_u *)
      "E580: :endif without :if";
    else {
        if (!(eap->cstack->cs_flags[eap->cstack->cs_idx]&0x0001) && dbg_check_skipped (eap)) (void) do_intthrow (eap -> cstack);
        --eap->cstack->cs_idx;
    }
}
    ...
    exarg_T * eap;
{
    ...
    struct condstack * cstack = eap -> cstack;
    skip = did_emsg || got_int || did_throw || (cstack -> cs_idx > 0 && !(cstack->cs_flags[cstack->cs_idx-1]&0x0002));
    if (cstack -> cs_idx < 0 || (cstack -> cs_flags [cstack -> cs_idx] & (0x0008 | 0x0010 | 0x0100))) {
    ...
    if (skip || cstack -> cs_flags [cstack -> cs_idx] & 0x0001) {
        if (eap -> errmsg == ((void *) 0)) cstack -> cs_flags [cstack -> cs_idx] = 0x0001;
        skip = 1;
    }
    else cstack -> cs_flags [cstack -> cs_idx] = 0x0002;
    ...
    if (eap -> cmdidx == CMD_elseif) {
        ...
        if (!skip && !error) {
            if (result) cstack -> cs_flags [cstack -> cs_idx] = 0x0002 | 0x0001;
            else cstack -> cs_flags [cstack -> cs_idx] = 0;
        }
        else if (eap -> errmsg == ((void *) 0)) cstack -> cs_flags [cstack -> cs_idx] = 0x0001;
    }
    else cstack -> cs_flags [cstack -> cs_idx] |= 0x0004;
}
    ...
    exarg_T * eap;
{
    ...
    int result;
    struct condstack * cstack = eap -> cstack;
    if (cstack -> cs_idx == 50 - 1) eap -> errmsg = (char_u *) "E585: :while/:for nesting too deep";
    else {
        ...
        cstack -> cs_flags [cstack -> cs_idx] = eap -> cmdidx == CMD_while ? 0x0008 : 0x0010;
        skip = did_emsg || got_int || did_throw || (cstack -> cs_idx > 0 && !(cstack->cs_flags[cstack->cs_idx-1]&0x0002));
        if (eap -> cmdidx == CMD_while) {
            ...
            if (!error && fi != ((void *) 0) && !skip) result = next_for_item (fi, eap -> arg);
            else result = 0;
            if (!result) {
                free_for_info (fi);
        ...
        if (!skip && !error && result) {
            ...
            cstack -> cs_lflags &= ~1;
            if (!skip && !error) cstack -> cs_flags [cstack -> cs_idx] |= 0x0001;
        }
    }
}
    ...
    exarg_T * eap;
{
    int idx;
    struct condstack * cstack = eap -> cstack;
    if (cstack -> cs_looplevel <= 0 || cstack -> cs_idx < 0) eap -> errmsg = (char_u *) "E586: :continue without :while or :for";
    else {
    ...
    exarg_T * eap;
{
    int idx;
    struct condstack * cstack = eap -> cstack;
    if (cstack -> cs_looplevel <= 0 || cstack -> cs_idx < 0) eap -> errmsg = (char_u *) "E587: :break without :while or :for";
    else {
    ...
    exarg_T * eap;
{
    ...
    if (cstack -> cs_looplevel <= 0 || cstack -> cs_idx < 0) eap -> errmsg = err;
    else {
        fl = cstack -> cs_flags [cstack -> cs_idx];
        if (!(fl&csf)) {
            if (fl & 0x0008) eap -> errmsg = (char_u *) ((char *) ("E732: Using :endfor with :while"));
            else if (fl & 0x0010) eap -> errmsg = (char_u *) ((char *) ("E733: Using :endwhile with :for"));
        }
        if (!(fl&(0x0008|0x0010))) {
            if (!(fl&0x0100)) eap -> errmsg = e_endif;
            else if (fl & 0x0200) eap -> errmsg = e_endtry;
        ...
        else if (cstack -> cs_flags [cstack -> cs_idx] & 0x0001 && !(cstack->cs_flags[cstack->cs_idx]&0x0002) && dbg_check_skipped (eap)) (void) do_intthrow (
          cstack);
        cstack -> cs_lflags |= 2;
    }
}
    ...
    exarg_T * eap;
{
    ...
    if (!eap->skip && value != ((void *) 0)) {
        if (throw_exception (value, 0, ((void *) 0)) == 0) vim_free (value);
        else do_throw (eap -> cstack);
    }
}
    ...
    struct condstack * cstack;
{
    ...
    if (idx >= 0) {
        if (!(cstack->cs_flags[idx]&0x0800)) {
            if (cstack -> cs_flags [idx] & 0x0002) cstack -> cs_flags [idx] |= 0x0400;
            else cstack -> cs_flags [idx] &= ~0x0400;
        }
    ...
    exarg_T * eap;
{
    int skip;
    struct condstack * cstack = eap -> cstack;
    if (cstack -> cs_idx == 50 - 1) eap -> errmsg = (char_u *) "E601: :try nesting too deep";
    else {
        ++cstack->cs_idx;
        ++cstack->cs_trylevel;
        ...
        if (!skip) {
            ...
            if (emsg_silent) {
                ...
                if (elem == ((void *) 0)) emsg ((char_u *) (((char *) (e_outofmem))));
                else {
    ...
    exarg_T * eap;
{
    ...
    if (cstack -> cs_trylevel <= 0 || cstack -> cs_idx < 0) {
        ...
        for (idx = cstack -> cs_idx; idx > 0; --idx) if (cstack -> cs_flags [idx] & 0x0100) break;
        if (cstack -> cs_flags [idx] & 0x0200) {
            eap -> errmsg = (char_u *) "E604: :catch after :finally";
            give_up = 1;
        }
        else rewind_conditionals (cstack, idx, 0x0008 | 0x0010, &cstack->cs_looplevel);
    }
    ...
    if (!give_up) {
        if (!did_throw || !(cstack->cs_flags[idx]&0x0001)) skip = 1;
        if (!skip && (cstack -> cs_flags [idx] & 0x0400) && !(cstack->cs_flags[idx]&0x0800)) {
            ...
            if (!dbg_check_skipped(eap) || !do_intthrow(cstack)) {
                ...
                regmatch.rm_ic = 0;
                if (end != ((void *) 0)) *end = save_char;
                p_cpo = save_cpo;
                if (regmatch.regprog == ((void *) 0)) emsg2 ((char_u *) (((char *) (e_invarg2))), (char_u *) (pat));
                else {
        ...
        if (caught) {
            ...
            if (cstack -> cs_pend.csp_ex [cstack -> cs_idx] != current_exception) emsg ((char_u *) (((char *) (e_internal))));
        }
        else {
            cleanup_conditionals (cstack, 0x0100, 1);
        }
    }
    if (end != ((void *) 0)) eap -> nextcmd = find_nextcmd (end);
}
    ...
    exarg_T * eap;
{
    ...
    int pending = 0;
    struct condstack * cstack = eap -> cstack;
    if (cstack -> cs_trylevel <= 0 || cstack -> cs_idx < 0) eap -> errmsg = (char_u *) "E606: :finally without :try";
    else {
        if (!(cstack->cs_flags[cstack->cs_idx]&0x0100)) {
            eap -> errmsg = get_end_emsg (cstack);
            for (idx = cstack -> cs_idx - 1; idx > 0; --idx) if (cstack -> cs_flags [idx] & 0x0100) break;
            pending = 1;
        }
        else idx = cstack -> cs_idx;
        if (cstack -> cs_flags [idx] & 0x0200) {
        ...
        if (!skip) {
            ...
            if (pending == 1 || did_emsg || got_int || did_throw) {
                if (cstack -> cs_pending [cstack -> cs_idx] == 24) {
                    report_discard_pending (24, cstack -> cs_pend.csp_rv [cstack -> cs_idx]);
                    discard_pending_return (cstack -> cs_pend.csp_rv [cstack -> cs_idx]);
                }
                if (pending == 1 && !did_emsg) pending |= (1) ? 4 : 0;
                else pending |= did_throw ? 4 : 0;
                pending |= did_emsg ? 1 : 0;
                pending |= got_int ? 2 : 0;
                cstack -> cs_pending [cstack -> cs_idx] = pending;
                if (did_throw && cstack -> cs_pend.csp_ex [cstack -> cs_idx] != current_exception) emsg ((char_u *) (((char *) (e_internal))));
            }
            cstack -> cs_lflags |= 8;
        }
    }
    ...
    exarg_T * eap;
{
    ...
    void * rettv = ((void *) 0);
    struct condstack * cstack = eap -> cstack;
    if (cstack -> cs_trylevel <= 0 || cstack -> cs_idx < 0) eap -> errmsg = (char_u *) "E602: :endtry without :try";
    else {
        skip = did_emsg || got_int || did_throw || !(cstack->cs_flags[cstack->cs_idx]&0x0001);
        if (!(cstack->cs_flags[cstack->cs_idx]&0x0100)) {
            eap -> errmsg = get_end_emsg (cstack);
            idx = cstack -> cs_idx;
            do --idx;
            ...
            rewind_conditionals (cstack, idx, 0x0008 | 0x0010, &cstack->cs_looplevel);
            skip = 1;
            if (did_throw) discard_current_exception ();
        }
        else {
            idx = cstack -> cs_idx;
            if (did_throw && (cstack -> cs_flags [idx] & 0x0001) && !(cstack->cs_flags[idx]&0x0200)) rethrow = 1;
        }
        if ((rethrow || (!skip && !(cstack->cs_flags[idx]&0x0200) && !cstack->cs_pending[idx])) && dbg_check_skipped (eap)) {
            if (got_int) {
                skip = 1;
                (void) do_intthrow (cstack);
                rethrow = 0;
                if (did_throw && !(cstack->cs_flags[idx]&0x0200)) rethrow = 1;
            }
        }
        if (!skip) {
            pending = cstack -> cs_pending [idx];
            cstack -> cs_pending [idx] = 0;
            if (pending == 24) rettv = cstack -> cs_pend.csp_rv [idx];
            else if (pending & 4) current_exception = cstack -> cs_pend.csp_ex [idx];
        }
        (void) cleanup_conditionals (cstack, 0x0100 | 0x1000, 1);
        --cstack->cs_idx;
        --cstack->cs_trylevel;
        if (!skip) {
            report_resume_pending (pending, (pending == 24) ? rettv : (pending & 4) ? (void *) current_exception : ((void *) 0));
            switch (pending) {
            case 0 :
                break;
            case 16 :
            ...
            case 32 :
                ...
                break;
            default :
                if (pending & 1) did_emsg = 1;
                if (pending & 2) got_int = 1;
                if (pending & 4) rethrow = 1;
                break;
            }
        }
        if (rethrow) do_throw (cstack);
    }
}
    ...
    cleanup_T * csp;
{
    ...
    if (did_emsg || got_int || did_throw || need_rethrow) {
        csp -> pending = (did_emsg ? 1 : 0) | (got_int ? 2 : 0) | (did_throw ? 4 : 0) | (need_rethrow ? 4 : 0);
        if (did_throw || need_rethrow) csp -> exception = current_exception;
        else {
    ...
    cleanup_T * csp;
{
    ...
    if (aborting () || need_rethrow) {
        if (pending & 4) discard_exception ((except_T *) csp -> exception, 0);
        else report_discard_pending (pending, ((void *) 0));
        if (msg_list != ((void *) 0)) {
        ...
        if (pending & 4) current_exception = csp -> exception;
        else if (pending & 1) {
            cause_abort = force_abort;
            force_abort = 0;
        }
        if (pending & 1) did_emsg = 1;
        if (pending & 2) got_int = 1;
        if (pending & 4) need_rethrow = 1;
        report_resume_pending (pending, (pending & 4) ? (void *) current_exception : ((void *) 0));
    }
}
    ...
    int inclusive;
{
    ...
    for (idx = cstack -> cs_idx; idx >= 0; --idx) {
        if (cstack -> cs_flags [idx] & 0x0100) {
            if (did_emsg || got_int || (cstack -> cs_flags [idx] & 0x0200)) {
                ...
                case 32 :
                    ...
                    break;
                case 24 :
                    report_discard_pending (24, cstack -> cs_pend.csp_rv [idx]);
                ...
                default :
                    if (cstack -> cs_flags [idx] & 0x0200) {
                        ...
                        else report_discard_pending (cstack -> cs_pending [idx], ((void *) 0));
                        cstack -> cs_pending [idx] = 0;
                    }
                    break;
                }
            ...
            if (!(cstack->cs_flags[idx]&0x0200)) {
                if ((cstack -> cs_flags [idx] & 0x0002) && (cstack -> cs_flags [idx] & 0x0800)) finish_exception ((except_T *) cstack -> cs_pend.csp_ex [idx]);
                if (cstack -> cs_flags [idx] & 0x0001) {
                    if (searched_cond == 0 && !inclusive) break;
                    stop = 1;
                }
            }
        }
        ...
        cstack -> cs_flags [idx] &= ~0x0002;
        if (stop && searched_cond != (0x0100 | 0x1000)) break;
        if ((cstack -> cs_flags [idx] & 0x0100) && (cstack -> cs_flags [idx] & 0x1000)) {
            eslist_T * elem;
...
static char_u * get_end_emsg (cstack)
    struct condstack * cstack;
{
    if (cstack -> cs_flags [cstack -> cs_idx] & 0x0008) return e_endwhile;
    if (cstack -> cs_flags [cstack -> cs_idx] & 0x0010) return e_endfor;
    return e_endif;
}
    ...
    int * cond_level;
{
    while (cstack -> cs_idx > idx) {
        if (cstack -> cs_flags [cstack -> cs_idx] & cond_type) --*cond_level;
        if (cstack -> cs_flags [cstack -> cs_idx] & 0x0010) free_for_info (cstack -> cs_forinfo [cstack -> cs_idx]);
        --cstack->cs_idx;
    }
}
...
{
    emsg ((char_u *) (((char *) ("E193: :endfunction not inside a function"))));
}
    ...
    char_u * p;
{
    ...
    if ((p [0] == 'w' && p [1] == 'h') || (p [0] == 'f' && p [1] == 'o' && p [2] == 'r')) return 1;
    return 0;
}

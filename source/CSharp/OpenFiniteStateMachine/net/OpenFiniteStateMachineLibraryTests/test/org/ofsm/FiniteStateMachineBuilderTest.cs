...
namespace test.org.ofsm
{
	...
	{		
		/// <seealso cref="FiniteStateMachineFactory.getInstance()">
		/// </seealso>
        [Test]
		public virtual void  testGetInstance()
		{
			Assert.NotNull(FiniteStateMachineFactory.getInstance());
		}
		
		/// <seealso cref="FiniteStateMachineFactory.newBuilder()">
		/// </seealso>
        [Test]
